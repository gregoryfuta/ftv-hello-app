...
public class ComplexpPack1Impl593 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl593.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl593 INSTANCE;

    public static ComplexpPack1Impl593 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl593();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl593(){
