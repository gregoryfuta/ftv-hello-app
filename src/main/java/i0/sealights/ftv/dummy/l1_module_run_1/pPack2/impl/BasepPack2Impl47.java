...
public class BasepPack2Impl47 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl47.class);
    private static BasepPack2Impl47 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl47 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl47();
        }
        return INSTANCE;
    }

    private BasepPack2Impl47(){
