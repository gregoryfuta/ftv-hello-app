...
public class BasepPack1Impl202 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl202.class);
    private static BasepPack1Impl202 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl202 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl202();
        }
        return INSTANCE;
    }

    private BasepPack1Impl202(){
