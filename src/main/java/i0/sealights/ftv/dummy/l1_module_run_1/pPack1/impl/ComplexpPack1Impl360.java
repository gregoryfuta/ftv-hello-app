...
public class ComplexpPack1Impl360 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl360.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl360 INSTANCE;

    public static ComplexpPack1Impl360 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl360();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl360(){
