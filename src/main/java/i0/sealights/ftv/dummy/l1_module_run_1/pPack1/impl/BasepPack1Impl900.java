...
public class BasepPack1Impl900 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl900.class);
    private static BasepPack1Impl900 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl900 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl900();
        }
        return INSTANCE;
    }

    private BasepPack1Impl900(){
