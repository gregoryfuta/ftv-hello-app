...
public class ComplexpPack2Impl401 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl401.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl401 INSTANCE;

    public static ComplexpPack2Impl401 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl401();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl401(){
