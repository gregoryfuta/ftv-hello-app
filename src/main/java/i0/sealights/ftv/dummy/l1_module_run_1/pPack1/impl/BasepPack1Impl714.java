...
public class BasepPack1Impl714 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl714.class);
    private static BasepPack1Impl714 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl714 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl714();
        }
        return INSTANCE;
    }

    private BasepPack1Impl714(){
