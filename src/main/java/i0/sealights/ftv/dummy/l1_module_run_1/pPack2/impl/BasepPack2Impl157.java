...
public class BasepPack2Impl157 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl157.class);
    private static BasepPack2Impl157 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl157 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl157();
        }
        return INSTANCE;
    }

    private BasepPack2Impl157(){
