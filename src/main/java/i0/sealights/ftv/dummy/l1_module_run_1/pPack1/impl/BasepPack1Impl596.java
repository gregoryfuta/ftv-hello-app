...
public class BasepPack1Impl596 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl596.class);
    private static BasepPack1Impl596 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl596 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl596();
        }
        return INSTANCE;
    }

    private BasepPack1Impl596(){
