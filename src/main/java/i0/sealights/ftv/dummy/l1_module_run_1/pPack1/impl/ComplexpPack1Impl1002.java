...
public class ComplexpPack1Impl1002 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1002.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1002 INSTANCE;

    public static ComplexpPack1Impl1002 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1002();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1002(){
