...
public class ComplexpPack1Impl49 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl49.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl49 INSTANCE;

    public static ComplexpPack1Impl49 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl49();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl49(){
