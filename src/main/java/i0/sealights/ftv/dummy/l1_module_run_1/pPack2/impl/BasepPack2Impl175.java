...
public class BasepPack2Impl175 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl175.class);
    private static BasepPack2Impl175 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl175 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl175();
        }
        return INSTANCE;
    }

    private BasepPack2Impl175(){
