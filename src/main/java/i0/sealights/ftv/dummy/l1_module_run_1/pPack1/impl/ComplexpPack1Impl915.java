...
public class ComplexpPack1Impl915 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl915.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl915 INSTANCE;

    public static ComplexpPack1Impl915 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl915();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl915(){
