...
public class BasepPack2Impl438 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl438.class);
    private static BasepPack2Impl438 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl438 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl438();
        }
        return INSTANCE;
    }

    private BasepPack2Impl438(){
