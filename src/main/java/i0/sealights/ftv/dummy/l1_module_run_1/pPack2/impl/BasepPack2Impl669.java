...
public class BasepPack2Impl669 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl669.class);
    private static BasepPack2Impl669 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl669 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl669();
        }
        return INSTANCE;
    }

    private BasepPack2Impl669(){
