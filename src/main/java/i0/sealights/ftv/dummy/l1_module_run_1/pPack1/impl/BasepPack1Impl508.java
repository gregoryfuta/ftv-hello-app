...
public class BasepPack1Impl508 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl508.class);
    private static BasepPack1Impl508 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl508 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl508();
        }
        return INSTANCE;
    }

    private BasepPack1Impl508(){
