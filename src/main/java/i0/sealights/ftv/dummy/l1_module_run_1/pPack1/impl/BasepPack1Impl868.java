...
public class BasepPack1Impl868 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl868.class);
    private static BasepPack1Impl868 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl868 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl868();
        }
        return INSTANCE;
    }

    private BasepPack1Impl868(){
