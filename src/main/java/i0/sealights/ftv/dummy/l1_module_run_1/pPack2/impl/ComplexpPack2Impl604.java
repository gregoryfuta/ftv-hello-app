...
public class ComplexpPack2Impl604 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl604.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl604 INSTANCE;

    public static ComplexpPack2Impl604 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl604();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl604(){
