...
public class BasepPack2Impl694 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl694.class);
    private static BasepPack2Impl694 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl694 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl694();
        }
        return INSTANCE;
    }

    private BasepPack2Impl694(){
