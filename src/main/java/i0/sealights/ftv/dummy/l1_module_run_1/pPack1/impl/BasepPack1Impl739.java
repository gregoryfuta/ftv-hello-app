...
public class BasepPack1Impl739 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl739.class);
    private static BasepPack1Impl739 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl739 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl739();
        }
        return INSTANCE;
    }

    private BasepPack1Impl739(){
