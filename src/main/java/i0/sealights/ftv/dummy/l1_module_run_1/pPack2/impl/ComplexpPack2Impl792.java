...
public class ComplexpPack2Impl792 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl792.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl792 INSTANCE;

    public static ComplexpPack2Impl792 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl792();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl792(){
