...
public class BasepPack2Impl36 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl36.class);
    private static BasepPack2Impl36 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl36 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl36();
        }
        return INSTANCE;
    }

    private BasepPack2Impl36(){
