...
public class BasepPack2Impl870 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl870.class);
    private static BasepPack2Impl870 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl870 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl870();
        }
        return INSTANCE;
    }

    private BasepPack2Impl870(){
