...
public class BasepPack1Impl651 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl651.class);
    private static BasepPack1Impl651 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl651 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl651();
        }
        return INSTANCE;
    }

    private BasepPack1Impl651(){
