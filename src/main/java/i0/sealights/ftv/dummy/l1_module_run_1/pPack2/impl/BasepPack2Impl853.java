...
public class BasepPack2Impl853 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl853.class);
    private static BasepPack2Impl853 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl853 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl853();
        }
        return INSTANCE;
    }

    private BasepPack2Impl853(){
