...
public class BasepPack2Impl988 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl988.class);
    private static BasepPack2Impl988 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl988 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl988();
        }
        return INSTANCE;
    }

    private BasepPack2Impl988(){
