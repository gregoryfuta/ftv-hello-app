...
public class BasepPack1Impl605 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl605.class);
    private static BasepPack1Impl605 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl605 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl605();
        }
        return INSTANCE;
    }

    private BasepPack1Impl605(){
