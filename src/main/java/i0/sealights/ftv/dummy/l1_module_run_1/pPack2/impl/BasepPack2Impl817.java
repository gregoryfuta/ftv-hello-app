...
public class BasepPack2Impl817 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl817.class);
    private static BasepPack2Impl817 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl817 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl817();
        }
        return INSTANCE;
    }

    private BasepPack2Impl817(){
