...
public class ComplexpPack1Impl547 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl547.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl547 INSTANCE;

    public static ComplexpPack1Impl547 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl547();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl547(){
