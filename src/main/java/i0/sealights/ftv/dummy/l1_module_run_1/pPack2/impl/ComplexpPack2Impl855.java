...
public class ComplexpPack2Impl855 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl855.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl855 INSTANCE;

    public static ComplexpPack2Impl855 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl855();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl855(){
