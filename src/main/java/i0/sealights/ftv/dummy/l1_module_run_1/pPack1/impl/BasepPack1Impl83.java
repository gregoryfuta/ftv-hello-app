...
public class BasepPack1Impl83 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl83.class);
    private static BasepPack1Impl83 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl83 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl83();
        }
        return INSTANCE;
    }

    private BasepPack1Impl83(){
