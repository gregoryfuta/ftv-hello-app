...
public class ComplexpPack2Impl893 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl893.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl893 INSTANCE;

    public static ComplexpPack2Impl893 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl893();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl893(){
