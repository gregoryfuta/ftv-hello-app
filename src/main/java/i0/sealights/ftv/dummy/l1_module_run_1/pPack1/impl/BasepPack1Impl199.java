...
public class BasepPack1Impl199 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl199.class);
    private static BasepPack1Impl199 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl199 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl199();
        }
        return INSTANCE;
    }

    private BasepPack1Impl199(){
