...
public class ComplexpPack1Impl27 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl27.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl27 INSTANCE;

    public static ComplexpPack1Impl27 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl27();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl27(){
