...
public class BasepPack2Impl305 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl305.class);
    private static BasepPack2Impl305 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl305 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl305();
        }
        return INSTANCE;
    }

    private BasepPack2Impl305(){
