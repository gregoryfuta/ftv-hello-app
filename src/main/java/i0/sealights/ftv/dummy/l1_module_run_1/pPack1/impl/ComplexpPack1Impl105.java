...
public class ComplexpPack1Impl105 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl105.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl105 INSTANCE;

    public static ComplexpPack1Impl105 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl105();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl105(){
