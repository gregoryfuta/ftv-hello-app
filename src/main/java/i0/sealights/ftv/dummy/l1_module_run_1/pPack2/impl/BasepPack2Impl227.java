...
public class BasepPack2Impl227 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl227.class);
    private static BasepPack2Impl227 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl227 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl227();
        }
        return INSTANCE;
    }

    private BasepPack2Impl227(){
