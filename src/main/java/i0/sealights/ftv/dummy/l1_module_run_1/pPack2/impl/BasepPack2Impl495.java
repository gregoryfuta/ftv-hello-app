...
public class BasepPack2Impl495 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl495.class);
    private static BasepPack2Impl495 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl495 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl495();
        }
        return INSTANCE;
    }

    private BasepPack2Impl495(){
