...
public class ComplexpPack1Impl352 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl352.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl352 INSTANCE;

    public static ComplexpPack1Impl352 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl352();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl352(){
