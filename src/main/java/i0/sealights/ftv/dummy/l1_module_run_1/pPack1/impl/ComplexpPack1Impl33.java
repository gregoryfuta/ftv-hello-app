...
public class ComplexpPack1Impl33 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl33.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl33 INSTANCE;

    public static ComplexpPack1Impl33 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl33();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl33(){
