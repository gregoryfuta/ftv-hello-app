...
public class BasepPack2Impl430 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl430.class);
    private static BasepPack2Impl430 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl430 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl430();
        }
        return INSTANCE;
    }

    private BasepPack2Impl430(){
