...
public class ComplexpPack2Impl203 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl203.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl203 INSTANCE;

    public static ComplexpPack2Impl203 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl203();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl203(){
