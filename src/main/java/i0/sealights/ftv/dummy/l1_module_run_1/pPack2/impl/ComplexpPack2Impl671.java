...
public class ComplexpPack2Impl671 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl671.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl671 INSTANCE;

    public static ComplexpPack2Impl671 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl671();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl671(){
