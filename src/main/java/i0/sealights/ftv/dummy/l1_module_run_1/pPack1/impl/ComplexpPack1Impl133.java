...
public class ComplexpPack1Impl133 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl133.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl133 INSTANCE;

    public static ComplexpPack1Impl133 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl133();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl133(){
