...
public class BasepPack2Impl910 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl910.class);
    private static BasepPack2Impl910 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl910 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl910();
        }
        return INSTANCE;
    }

    private BasepPack2Impl910(){
