...
public class BasepPack2Impl533 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl533.class);
    private static BasepPack2Impl533 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl533 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl533();
        }
        return INSTANCE;
    }

    private BasepPack2Impl533(){
