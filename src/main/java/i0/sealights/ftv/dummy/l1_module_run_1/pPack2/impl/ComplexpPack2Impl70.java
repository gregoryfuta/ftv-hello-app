...
public class ComplexpPack2Impl70 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl70.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl70 INSTANCE;

    public static ComplexpPack2Impl70 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl70();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl70(){
