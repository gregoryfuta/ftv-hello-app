...
public class BasepPack2Impl592 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl592.class);
    private static BasepPack2Impl592 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl592 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl592();
        }
        return INSTANCE;
    }

    private BasepPack2Impl592(){
