...
public class ComplexpPack1Impl742 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl742.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl742 INSTANCE;

    public static ComplexpPack1Impl742 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl742();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl742(){
