...
public class ComplexpPack1Impl154 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl154.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl154 INSTANCE;

    public static ComplexpPack1Impl154 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl154();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl154(){
