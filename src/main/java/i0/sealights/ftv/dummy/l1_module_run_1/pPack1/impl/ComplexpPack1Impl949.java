...
public class ComplexpPack1Impl949 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl949.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl949 INSTANCE;

    public static ComplexpPack1Impl949 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl949();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl949(){
