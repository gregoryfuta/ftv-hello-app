...
public class BasepPack2Impl290 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl290.class);
    private static BasepPack2Impl290 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl290 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl290();
        }
        return INSTANCE;
    }

    private BasepPack2Impl290(){
