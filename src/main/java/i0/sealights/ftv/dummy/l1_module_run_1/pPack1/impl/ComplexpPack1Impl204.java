...
public class ComplexpPack1Impl204 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl204.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl204 INSTANCE;

    public static ComplexpPack1Impl204 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl204();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl204(){
