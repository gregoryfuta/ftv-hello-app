...
public class ComplexpPack2Impl373 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl373.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl373 INSTANCE;

    public static ComplexpPack2Impl373 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl373();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl373(){
