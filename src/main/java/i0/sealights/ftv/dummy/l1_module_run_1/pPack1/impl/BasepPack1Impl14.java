...
public class BasepPack1Impl14 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl14.class);
    private static BasepPack1Impl14 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl14 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl14();
        }
        return INSTANCE;
    }

    private BasepPack1Impl14(){
