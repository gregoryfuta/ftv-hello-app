...
public class BasepPack2Impl650 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl650.class);
    private static BasepPack2Impl650 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl650 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl650();
        }
        return INSTANCE;
    }

    private BasepPack2Impl650(){
