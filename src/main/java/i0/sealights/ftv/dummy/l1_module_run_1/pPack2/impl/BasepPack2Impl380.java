...
public class BasepPack2Impl380 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl380.class);
    private static BasepPack2Impl380 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl380 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl380();
        }
        return INSTANCE;
    }

    private BasepPack2Impl380(){
