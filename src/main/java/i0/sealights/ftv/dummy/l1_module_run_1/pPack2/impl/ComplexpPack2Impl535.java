...
public class ComplexpPack2Impl535 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl535.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl535 INSTANCE;

    public static ComplexpPack2Impl535 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl535();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl535(){
