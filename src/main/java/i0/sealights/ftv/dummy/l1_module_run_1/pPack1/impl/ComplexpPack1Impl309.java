...
public class ComplexpPack1Impl309 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl309.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl309 INSTANCE;

    public static ComplexpPack1Impl309 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl309();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl309(){
