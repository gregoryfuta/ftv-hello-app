...
public class ComplexpPack2Impl599 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl599.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl599 INSTANCE;

    public static ComplexpPack2Impl599 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl599();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl599(){
