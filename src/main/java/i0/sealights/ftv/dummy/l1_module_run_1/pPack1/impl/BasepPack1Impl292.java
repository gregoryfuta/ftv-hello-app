...
public class BasepPack1Impl292 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl292.class);
    private static BasepPack1Impl292 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl292 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl292();
        }
        return INSTANCE;
    }

    private BasepPack1Impl292(){
