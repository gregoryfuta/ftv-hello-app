...
public class BasepPack1Impl90 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl90.class);
    private static BasepPack1Impl90 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl90 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl90();
        }
        return INSTANCE;
    }

    private BasepPack1Impl90(){
