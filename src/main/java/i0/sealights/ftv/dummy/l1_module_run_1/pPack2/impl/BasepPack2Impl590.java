...
public class BasepPack2Impl590 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl590.class);
    private static BasepPack2Impl590 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl590 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl590();
        }
        return INSTANCE;
    }

    private BasepPack2Impl590(){
