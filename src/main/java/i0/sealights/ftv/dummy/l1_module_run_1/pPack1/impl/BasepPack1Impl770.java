...
public class BasepPack1Impl770 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl770.class);
    private static BasepPack1Impl770 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl770 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl770();
        }
        return INSTANCE;
    }

    private BasepPack1Impl770(){
