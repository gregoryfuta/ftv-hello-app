...
public class ComplexpPack2Impl639 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl639.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl639 INSTANCE;

    public static ComplexpPack2Impl639 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl639();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl639(){
