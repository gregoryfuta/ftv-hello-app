...
public class ComplexpPack2Impl117 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl117.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl117 INSTANCE;

    public static ComplexpPack2Impl117 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl117();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl117(){
