...
public class BasepPack2Impl591 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl591.class);
    private static BasepPack2Impl591 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl591 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl591();
        }
        return INSTANCE;
    }

    private BasepPack2Impl591(){
