...
public class ComplexpPack1Impl918 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl918.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl918 INSTANCE;

    public static ComplexpPack1Impl918 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl918();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl918(){
