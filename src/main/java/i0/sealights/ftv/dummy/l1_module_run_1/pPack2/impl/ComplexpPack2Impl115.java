...
public class ComplexpPack2Impl115 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl115.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl115 INSTANCE;

    public static ComplexpPack2Impl115 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl115();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl115(){
