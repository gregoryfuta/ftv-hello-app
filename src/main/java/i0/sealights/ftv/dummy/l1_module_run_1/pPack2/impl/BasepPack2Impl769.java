...
public class BasepPack2Impl769 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl769.class);
    private static BasepPack2Impl769 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl769 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl769();
        }
        return INSTANCE;
    }

    private BasepPack2Impl769(){
