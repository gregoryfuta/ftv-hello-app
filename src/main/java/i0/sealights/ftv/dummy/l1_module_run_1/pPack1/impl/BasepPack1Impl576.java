...
public class BasepPack1Impl576 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl576.class);
    private static BasepPack1Impl576 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl576 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl576();
        }
        return INSTANCE;
    }

    private BasepPack1Impl576(){
