...
public class BasepPack1Impl614 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl614.class);
    private static BasepPack1Impl614 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl614 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl614();
        }
        return INSTANCE;
    }

    private BasepPack1Impl614(){
