...
public class ComplexpPack2Impl444 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl444.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl444 INSTANCE;

    public static ComplexpPack2Impl444 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl444();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl444(){
