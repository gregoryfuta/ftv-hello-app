...
public class ComplexpPack2Impl637 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl637.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl637 INSTANCE;

    public static ComplexpPack2Impl637 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl637();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl637(){
