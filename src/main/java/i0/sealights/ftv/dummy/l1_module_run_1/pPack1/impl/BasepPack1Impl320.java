...
public class BasepPack1Impl320 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl320.class);
    private static BasepPack1Impl320 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl320 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl320();
        }
        return INSTANCE;
    }

    private BasepPack1Impl320(){
