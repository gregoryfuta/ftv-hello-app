...
public class BasepPack1Impl763 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl763.class);
    private static BasepPack1Impl763 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl763 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl763();
        }
        return INSTANCE;
    }

    private BasepPack1Impl763(){
