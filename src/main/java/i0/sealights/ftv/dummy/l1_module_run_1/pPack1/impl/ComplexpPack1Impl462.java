...
public class ComplexpPack1Impl462 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl462.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl462 INSTANCE;

    public static ComplexpPack1Impl462 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl462();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl462(){
