...
public class ComplexpPack1Impl554 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl554.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl554 INSTANCE;

    public static ComplexpPack1Impl554 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl554();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl554(){
