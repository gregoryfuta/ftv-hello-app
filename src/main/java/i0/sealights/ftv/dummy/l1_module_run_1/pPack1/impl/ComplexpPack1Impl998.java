...
public class ComplexpPack1Impl998 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl998.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl998 INSTANCE;

    public static ComplexpPack1Impl998 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl998();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl998(){
