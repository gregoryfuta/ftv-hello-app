...
public class ComplexpPack2Impl224 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl224.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl224 INSTANCE;

    public static ComplexpPack2Impl224 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl224();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl224(){
