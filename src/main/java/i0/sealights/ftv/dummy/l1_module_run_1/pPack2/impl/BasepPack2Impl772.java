...
public class BasepPack2Impl772 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl772.class);
    private static BasepPack2Impl772 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl772 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl772();
        }
        return INSTANCE;
    }

    private BasepPack2Impl772(){
