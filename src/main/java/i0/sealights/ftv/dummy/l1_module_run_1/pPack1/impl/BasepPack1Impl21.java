...
public class BasepPack1Impl21 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl21.class);
    private static BasepPack1Impl21 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl21 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl21();
        }
        return INSTANCE;
    }

    private BasepPack1Impl21(){
