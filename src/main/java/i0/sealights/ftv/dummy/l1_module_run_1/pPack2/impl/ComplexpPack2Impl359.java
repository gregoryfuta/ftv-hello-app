...
public class ComplexpPack2Impl359 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl359.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl359 INSTANCE;

    public static ComplexpPack2Impl359 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl359();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl359(){
