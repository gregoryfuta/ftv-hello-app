...
public class BasepPack1Impl479 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl479.class);
    private static BasepPack1Impl479 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl479 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl479();
        }
        return INSTANCE;
    }

    private BasepPack1Impl479(){
