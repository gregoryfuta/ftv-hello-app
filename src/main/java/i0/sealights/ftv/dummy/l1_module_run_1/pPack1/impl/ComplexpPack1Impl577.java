...
public class ComplexpPack1Impl577 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl577.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl577 INSTANCE;

    public static ComplexpPack1Impl577 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl577();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl577(){
