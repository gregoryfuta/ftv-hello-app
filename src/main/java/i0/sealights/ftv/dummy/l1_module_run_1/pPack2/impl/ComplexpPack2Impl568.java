...
public class ComplexpPack2Impl568 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl568.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl568 INSTANCE;

    public static ComplexpPack2Impl568 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl568();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl568(){
