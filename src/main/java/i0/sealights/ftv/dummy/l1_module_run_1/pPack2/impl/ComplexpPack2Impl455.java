...
public class ComplexpPack2Impl455 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl455.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl455 INSTANCE;

    public static ComplexpPack2Impl455 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl455();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl455(){
