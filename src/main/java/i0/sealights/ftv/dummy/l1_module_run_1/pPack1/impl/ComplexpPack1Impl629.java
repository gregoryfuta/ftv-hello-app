...
public class ComplexpPack1Impl629 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl629.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl629 INSTANCE;

    public static ComplexpPack1Impl629 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl629();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl629(){
