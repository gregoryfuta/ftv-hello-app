...
public class BasepPack2Impl584 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl584.class);
    private static BasepPack2Impl584 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl584 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl584();
        }
        return INSTANCE;
    }

    private BasepPack2Impl584(){
