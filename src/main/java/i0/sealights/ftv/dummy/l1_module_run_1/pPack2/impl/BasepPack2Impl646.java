...
public class BasepPack2Impl646 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl646.class);
    private static BasepPack2Impl646 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl646 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl646();
        }
        return INSTANCE;
    }

    private BasepPack2Impl646(){
