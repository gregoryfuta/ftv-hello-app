...
public class BasepPack1Impl379 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl379.class);
    private static BasepPack1Impl379 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl379 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl379();
        }
        return INSTANCE;
    }

    private BasepPack1Impl379(){
