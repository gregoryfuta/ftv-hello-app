...
public class BasepPack2Impl705 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl705.class);
    private static BasepPack2Impl705 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl705 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl705();
        }
        return INSTANCE;
    }

    private BasepPack2Impl705(){
