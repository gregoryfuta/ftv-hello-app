...
public class BasepPack1Impl928 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl928.class);
    private static BasepPack1Impl928 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl928 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl928();
        }
        return INSTANCE;
    }

    private BasepPack1Impl928(){
