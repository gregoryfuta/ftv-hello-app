...
public class BasepPack2Impl878 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl878.class);
    private static BasepPack2Impl878 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl878 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl878();
        }
        return INSTANCE;
    }

    private BasepPack2Impl878(){
