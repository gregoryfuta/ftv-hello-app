...
public class BasepPack2Impl762 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl762.class);
    private static BasepPack2Impl762 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl762 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl762();
        }
        return INSTANCE;
    }

    private BasepPack2Impl762(){
