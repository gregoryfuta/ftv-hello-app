...
public class BasepPack1Impl184 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl184.class);
    private static BasepPack1Impl184 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl184 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl184();
        }
        return INSTANCE;
    }

    private BasepPack1Impl184(){
