...
public class ComplexpPack2Impl722 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl722.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl722 INSTANCE;

    public static ComplexpPack2Impl722 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl722();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl722(){
