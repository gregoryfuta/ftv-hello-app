...
public class BasepPack2Impl164 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl164.class);
    private static BasepPack2Impl164 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl164 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl164();
        }
        return INSTANCE;
    }

    private BasepPack2Impl164(){
