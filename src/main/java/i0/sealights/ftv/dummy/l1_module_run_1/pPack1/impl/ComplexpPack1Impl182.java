...
public class ComplexpPack1Impl182 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl182.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl182 INSTANCE;

    public static ComplexpPack1Impl182 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl182();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl182(){
