...
public class ComplexpPack1Impl847 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl847.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl847 INSTANCE;

    public static ComplexpPack1Impl847 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl847();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl847(){
