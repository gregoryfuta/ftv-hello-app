...
public class ComplexpPack1Impl862 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl862.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl862 INSTANCE;

    public static ComplexpPack1Impl862 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl862();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl862(){
