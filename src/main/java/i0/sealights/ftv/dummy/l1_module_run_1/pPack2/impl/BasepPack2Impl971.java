...
public class BasepPack2Impl971 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl971.class);
    private static BasepPack2Impl971 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl971 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl971();
        }
        return INSTANCE;
    }

    private BasepPack2Impl971(){
