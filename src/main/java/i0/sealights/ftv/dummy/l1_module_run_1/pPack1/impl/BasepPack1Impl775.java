...
public class BasepPack1Impl775 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl775.class);
    private static BasepPack1Impl775 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl775 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl775();
        }
        return INSTANCE;
    }

    private BasepPack1Impl775(){
