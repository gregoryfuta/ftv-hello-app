...
public class ComplexpPack2Impl911 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl911.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl911 INSTANCE;

    public static ComplexpPack2Impl911 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl911();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl911(){
