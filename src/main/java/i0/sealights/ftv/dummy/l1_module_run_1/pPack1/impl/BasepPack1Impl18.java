...
public class BasepPack1Impl18 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl18.class);
    private static BasepPack1Impl18 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl18 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl18();
        }
        return INSTANCE;
    }

    private BasepPack1Impl18(){
