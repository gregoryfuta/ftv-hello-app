...
public class ComplexpPack1Impl956 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl956.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl956 INSTANCE;

    public static ComplexpPack1Impl956 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl956();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl956(){
