...
public class ComplexpPack1Impl692 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl692.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl692 INSTANCE;

    public static ComplexpPack1Impl692 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl692();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl692(){
