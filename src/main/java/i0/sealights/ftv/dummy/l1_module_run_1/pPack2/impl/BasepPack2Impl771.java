...
public class BasepPack2Impl771 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl771.class);
    private static BasepPack2Impl771 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl771 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl771();
        }
        return INSTANCE;
    }

    private BasepPack2Impl771(){
