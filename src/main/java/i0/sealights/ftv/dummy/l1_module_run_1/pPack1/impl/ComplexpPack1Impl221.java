...
public class ComplexpPack1Impl221 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl221.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl221 INSTANCE;

    public static ComplexpPack1Impl221 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl221();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl221(){
