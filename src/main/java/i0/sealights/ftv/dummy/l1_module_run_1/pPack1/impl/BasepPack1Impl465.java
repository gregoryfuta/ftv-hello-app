...
public class BasepPack1Impl465 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl465.class);
    private static BasepPack1Impl465 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl465 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl465();
        }
        return INSTANCE;
    }

    private BasepPack1Impl465(){
