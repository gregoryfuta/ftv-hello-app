...
public class ComplexpPack1Impl732 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl732.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl732 INSTANCE;

    public static ComplexpPack1Impl732 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl732();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl732(){
