...
public class BasepPack2Impl155 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl155.class);
    private static BasepPack2Impl155 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl155 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl155();
        }
        return INSTANCE;
    }

    private BasepPack2Impl155(){
