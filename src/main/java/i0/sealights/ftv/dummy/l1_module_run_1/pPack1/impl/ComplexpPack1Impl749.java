...
public class ComplexpPack1Impl749 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl749.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl749 INSTANCE;

    public static ComplexpPack1Impl749 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl749();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl749(){
