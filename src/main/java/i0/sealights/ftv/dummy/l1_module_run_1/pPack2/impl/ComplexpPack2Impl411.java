...
public class ComplexpPack2Impl411 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl411.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl411 INSTANCE;

    public static ComplexpPack2Impl411 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl411();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl411(){
