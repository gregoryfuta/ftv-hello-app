...
public class BasepPack1Impl440 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl440.class);
    private static BasepPack1Impl440 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl440 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl440();
        }
        return INSTANCE;
    }

    private BasepPack1Impl440(){
