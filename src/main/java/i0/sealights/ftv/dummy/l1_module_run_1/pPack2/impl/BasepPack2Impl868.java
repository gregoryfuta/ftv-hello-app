...
public class BasepPack2Impl868 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl868.class);
    private static BasepPack2Impl868 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl868 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl868();
        }
        return INSTANCE;
    }

    private BasepPack2Impl868(){
