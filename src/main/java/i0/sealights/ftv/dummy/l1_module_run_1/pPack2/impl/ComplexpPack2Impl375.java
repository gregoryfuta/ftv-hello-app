...
public class ComplexpPack2Impl375 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl375.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl375 INSTANCE;

    public static ComplexpPack2Impl375 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl375();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl375(){
