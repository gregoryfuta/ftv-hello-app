...
public class BasepPack1Impl168 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl168.class);
    private static BasepPack1Impl168 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl168 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl168();
        }
        return INSTANCE;
    }

    private BasepPack1Impl168(){
