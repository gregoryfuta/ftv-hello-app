...
public class ComplexpPack1Impl265 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl265.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl265 INSTANCE;

    public static ComplexpPack1Impl265 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl265();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl265(){
