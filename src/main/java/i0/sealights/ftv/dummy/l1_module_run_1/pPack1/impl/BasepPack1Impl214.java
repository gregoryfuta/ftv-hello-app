...
public class BasepPack1Impl214 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl214.class);
    private static BasepPack1Impl214 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl214 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl214();
        }
        return INSTANCE;
    }

    private BasepPack1Impl214(){
