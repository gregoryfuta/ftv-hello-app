...
public class BasepPack2Impl640 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl640.class);
    private static BasepPack2Impl640 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl640 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl640();
        }
        return INSTANCE;
    }

    private BasepPack2Impl640(){
