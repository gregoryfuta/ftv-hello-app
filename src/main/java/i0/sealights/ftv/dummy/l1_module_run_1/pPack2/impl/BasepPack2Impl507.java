...
public class BasepPack2Impl507 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl507.class);
    private static BasepPack2Impl507 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl507 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl507();
        }
        return INSTANCE;
    }

    private BasepPack2Impl507(){
