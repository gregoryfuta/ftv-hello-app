...
public class BasepPack2Impl384 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl384.class);
    private static BasepPack2Impl384 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl384 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl384();
        }
        return INSTANCE;
    }

    private BasepPack2Impl384(){
