...
public class BasepPack2Impl529 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl529.class);
    private static BasepPack2Impl529 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl529 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl529();
        }
        return INSTANCE;
    }

    private BasepPack2Impl529(){
