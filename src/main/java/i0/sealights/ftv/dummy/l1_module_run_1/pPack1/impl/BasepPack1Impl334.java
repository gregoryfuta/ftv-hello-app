...
public class BasepPack1Impl334 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl334.class);
    private static BasepPack1Impl334 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl334 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl334();
        }
        return INSTANCE;
    }

    private BasepPack1Impl334(){
