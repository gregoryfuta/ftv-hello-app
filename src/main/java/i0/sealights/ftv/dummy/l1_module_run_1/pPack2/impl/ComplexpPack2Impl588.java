...
public class ComplexpPack2Impl588 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl588.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl588 INSTANCE;

    public static ComplexpPack2Impl588 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl588();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl588(){
