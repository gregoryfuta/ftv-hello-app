...
public class ComplexpPack1Impl29 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl29.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl29 INSTANCE;

    public static ComplexpPack1Impl29 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl29();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl29(){
