...
public class ComplexpPack1Impl568 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl568.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl568 INSTANCE;

    public static ComplexpPack1Impl568 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl568();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl568(){
