...
public class BasepPack2Impl269 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl269.class);
    private static BasepPack2Impl269 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl269 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl269();
        }
        return INSTANCE;
    }

    private BasepPack2Impl269(){
