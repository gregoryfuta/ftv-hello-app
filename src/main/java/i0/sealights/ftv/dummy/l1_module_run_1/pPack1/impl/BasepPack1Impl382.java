...
public class BasepPack1Impl382 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl382.class);
    private static BasepPack1Impl382 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl382 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl382();
        }
        return INSTANCE;
    }

    private BasepPack1Impl382(){
