...
public class BasepPack1Impl361 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl361.class);
    private static BasepPack1Impl361 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl361 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl361();
        }
        return INSTANCE;
    }

    private BasepPack1Impl361(){
