...
public class ComplexpPack2Impl865 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl865.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl865 INSTANCE;

    public static ComplexpPack2Impl865 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl865();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl865(){
