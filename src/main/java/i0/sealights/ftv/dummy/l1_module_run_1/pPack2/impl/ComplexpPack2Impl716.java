...
public class ComplexpPack2Impl716 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl716.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl716 INSTANCE;

    public static ComplexpPack2Impl716 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl716();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl716(){
