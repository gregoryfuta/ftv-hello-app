...
public class BasepPack2Impl789 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl789.class);
    private static BasepPack2Impl789 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl789 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl789();
        }
        return INSTANCE;
    }

    private BasepPack2Impl789(){
