...
public class ComplexpPack1Impl922 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl922.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl922 INSTANCE;

    public static ComplexpPack1Impl922 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl922();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl922(){
