...
public class BasepPack2Impl351 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl351.class);
    private static BasepPack2Impl351 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl351 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl351();
        }
        return INSTANCE;
    }

    private BasepPack2Impl351(){
