...
public class BasepPack1Impl973 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl973.class);
    private static BasepPack1Impl973 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl973 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl973();
        }
        return INSTANCE;
    }

    private BasepPack1Impl973(){
