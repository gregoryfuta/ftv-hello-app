...
public class ComplexpPack2Impl360 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl360.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl360 INSTANCE;

    public static ComplexpPack2Impl360 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl360();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl360(){
