...
public class BasepPack2Impl541 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl541.class);
    private static BasepPack2Impl541 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl541 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl541();
        }
        return INSTANCE;
    }

    private BasepPack2Impl541(){
