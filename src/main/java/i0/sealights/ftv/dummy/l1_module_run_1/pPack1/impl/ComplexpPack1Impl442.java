...
public class ComplexpPack1Impl442 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl442.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl442 INSTANCE;

    public static ComplexpPack1Impl442 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl442();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl442(){
