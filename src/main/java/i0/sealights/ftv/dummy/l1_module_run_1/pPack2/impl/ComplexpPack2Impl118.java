...
public class ComplexpPack2Impl118 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl118.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl118 INSTANCE;

    public static ComplexpPack2Impl118 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl118();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl118(){
