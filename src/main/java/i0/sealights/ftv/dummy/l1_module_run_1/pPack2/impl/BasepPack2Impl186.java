...
public class BasepPack2Impl186 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl186.class);
    private static BasepPack2Impl186 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl186 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl186();
        }
        return INSTANCE;
    }

    private BasepPack2Impl186(){
