...
public class BasepPack1Impl414 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl414.class);
    private static BasepPack1Impl414 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl414 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl414();
        }
        return INSTANCE;
    }

    private BasepPack1Impl414(){
