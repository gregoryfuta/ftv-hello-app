...
public class ComplexpPack2Impl711 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl711.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl711 INSTANCE;

    public static ComplexpPack2Impl711 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl711();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl711(){
