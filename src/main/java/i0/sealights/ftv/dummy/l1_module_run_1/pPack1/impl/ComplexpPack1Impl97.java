...
public class ComplexpPack1Impl97 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl97.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl97 INSTANCE;

    public static ComplexpPack1Impl97 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl97();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl97(){
