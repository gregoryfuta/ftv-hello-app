...
public class BasepPack2Impl33 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl33.class);
    private static BasepPack2Impl33 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl33 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl33();
        }
        return INSTANCE;
    }

    private BasepPack2Impl33(){
