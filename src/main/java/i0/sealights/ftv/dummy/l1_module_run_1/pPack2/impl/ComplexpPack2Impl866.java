...
public class ComplexpPack2Impl866 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl866.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl866 INSTANCE;

    public static ComplexpPack2Impl866 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl866();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl866(){
