...
public class ComplexpPack1Impl1047 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1047.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1047 INSTANCE;

    public static ComplexpPack1Impl1047 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1047();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1047(){
