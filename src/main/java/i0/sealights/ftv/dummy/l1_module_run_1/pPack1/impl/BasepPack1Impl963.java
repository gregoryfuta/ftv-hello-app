...
public class BasepPack1Impl963 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl963.class);
    private static BasepPack1Impl963 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl963 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl963();
        }
        return INSTANCE;
    }

    private BasepPack1Impl963(){
