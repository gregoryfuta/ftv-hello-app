...
public class BasepPack1Impl164 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl164.class);
    private static BasepPack1Impl164 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl164 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl164();
        }
        return INSTANCE;
    }

    private BasepPack1Impl164(){
