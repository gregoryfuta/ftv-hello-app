...
public class BasepPack1Impl296 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl296.class);
    private static BasepPack1Impl296 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl296 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl296();
        }
        return INSTANCE;
    }

    private BasepPack1Impl296(){
