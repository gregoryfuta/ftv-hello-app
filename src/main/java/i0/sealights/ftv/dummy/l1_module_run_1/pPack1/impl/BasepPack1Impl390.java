...
public class BasepPack1Impl390 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl390.class);
    private static BasepPack1Impl390 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl390 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl390();
        }
        return INSTANCE;
    }

    private BasepPack1Impl390(){
