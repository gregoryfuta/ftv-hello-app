...
public class ComplexpPack2Impl553 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl553.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl553 INSTANCE;

    public static ComplexpPack2Impl553 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl553();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl553(){
