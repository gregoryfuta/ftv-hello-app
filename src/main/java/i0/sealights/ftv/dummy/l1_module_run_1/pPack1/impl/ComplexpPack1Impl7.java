...
public class ComplexpPack1Impl7 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl7.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl7 INSTANCE;

    public static ComplexpPack1Impl7 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl7();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl7(){
