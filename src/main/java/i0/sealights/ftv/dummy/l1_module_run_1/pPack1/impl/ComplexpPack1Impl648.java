...
public class ComplexpPack1Impl648 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl648.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl648 INSTANCE;

    public static ComplexpPack1Impl648 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl648();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl648(){
