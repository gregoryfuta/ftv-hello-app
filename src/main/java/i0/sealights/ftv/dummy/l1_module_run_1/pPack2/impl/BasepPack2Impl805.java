...
public class BasepPack2Impl805 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl805.class);
    private static BasepPack2Impl805 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl805 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl805();
        }
        return INSTANCE;
    }

    private BasepPack2Impl805(){
