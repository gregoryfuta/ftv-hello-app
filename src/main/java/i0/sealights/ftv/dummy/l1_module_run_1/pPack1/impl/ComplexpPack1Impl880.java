...
public class ComplexpPack1Impl880 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl880.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl880 INSTANCE;

    public static ComplexpPack1Impl880 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl880();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl880(){
