...
public class ComplexpPack2Impl322 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl322.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl322 INSTANCE;

    public static ComplexpPack2Impl322 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl322();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl322(){
