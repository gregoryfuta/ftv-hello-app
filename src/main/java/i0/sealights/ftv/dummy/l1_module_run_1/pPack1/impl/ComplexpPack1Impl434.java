...
public class ComplexpPack1Impl434 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl434.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl434 INSTANCE;

    public static ComplexpPack1Impl434 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl434();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl434(){
