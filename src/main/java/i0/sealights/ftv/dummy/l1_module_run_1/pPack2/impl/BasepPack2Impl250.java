...
public class BasepPack2Impl250 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl250.class);
    private static BasepPack2Impl250 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl250 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl250();
        }
        return INSTANCE;
    }

    private BasepPack2Impl250(){
