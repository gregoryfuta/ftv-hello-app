...
public class BasepPack2Impl488 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl488.class);
    private static BasepPack2Impl488 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl488 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl488();
        }
        return INSTANCE;
    }

    private BasepPack2Impl488(){
