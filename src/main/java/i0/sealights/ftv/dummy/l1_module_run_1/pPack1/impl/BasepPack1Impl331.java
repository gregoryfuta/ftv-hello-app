...
public class BasepPack1Impl331 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl331.class);
    private static BasepPack1Impl331 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl331 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl331();
        }
        return INSTANCE;
    }

    private BasepPack1Impl331(){
