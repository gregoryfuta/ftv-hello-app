...
public class ComplexpPack2Impl418 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl418.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl418 INSTANCE;

    public static ComplexpPack2Impl418 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl418();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl418(){
