...
public class BasepPack2Impl834 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl834.class);
    private static BasepPack2Impl834 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl834 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl834();
        }
        return INSTANCE;
    }

    private BasepPack2Impl834(){
