...
public class BasepPack1Impl813 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl813.class);
    private static BasepPack1Impl813 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl813 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl813();
        }
        return INSTANCE;
    }

    private BasepPack1Impl813(){
