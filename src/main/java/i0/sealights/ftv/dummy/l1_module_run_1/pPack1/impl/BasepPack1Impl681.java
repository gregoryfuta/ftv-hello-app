...
public class BasepPack1Impl681 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl681.class);
    private static BasepPack1Impl681 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl681 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl681();
        }
        return INSTANCE;
    }

    private BasepPack1Impl681(){
