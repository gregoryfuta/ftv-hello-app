...
public class ComplexpPack2Impl153 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl153.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl153 INSTANCE;

    public static ComplexpPack2Impl153 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl153();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl153(){
