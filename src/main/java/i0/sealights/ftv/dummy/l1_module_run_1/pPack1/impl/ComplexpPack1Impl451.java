...
public class ComplexpPack1Impl451 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl451.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl451 INSTANCE;

    public static ComplexpPack1Impl451 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl451();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl451(){
