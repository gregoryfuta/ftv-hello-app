...
public class BasepPack1Impl403 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl403.class);
    private static BasepPack1Impl403 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl403 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl403();
        }
        return INSTANCE;
    }

    private BasepPack1Impl403(){
