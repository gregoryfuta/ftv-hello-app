...
public class ComplexpPack1Impl746 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl746.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl746 INSTANCE;

    public static ComplexpPack1Impl746 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl746();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl746(){
