...
public class ComplexpPack1Impl191 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl191.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl191 INSTANCE;

    public static ComplexpPack1Impl191 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl191();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl191(){
