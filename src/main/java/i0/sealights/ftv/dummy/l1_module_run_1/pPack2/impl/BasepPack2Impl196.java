...
public class BasepPack2Impl196 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl196.class);
    private static BasepPack2Impl196 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl196 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl196();
        }
        return INSTANCE;
    }

    private BasepPack2Impl196(){
