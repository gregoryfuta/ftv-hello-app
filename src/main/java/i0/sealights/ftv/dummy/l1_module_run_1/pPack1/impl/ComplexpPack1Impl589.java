...
public class ComplexpPack1Impl589 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl589.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl589 INSTANCE;

    public static ComplexpPack1Impl589 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl589();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl589(){
