...
public class ComplexpPack2Impl789 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl789.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl789 INSTANCE;

    public static ComplexpPack2Impl789 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl789();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl789(){
