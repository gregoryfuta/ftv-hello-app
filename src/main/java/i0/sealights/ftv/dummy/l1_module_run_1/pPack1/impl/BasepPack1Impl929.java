...
public class BasepPack1Impl929 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl929.class);
    private static BasepPack1Impl929 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl929 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl929();
        }
        return INSTANCE;
    }

    private BasepPack1Impl929(){
