...
public class BasepPack2Impl381 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl381.class);
    private static BasepPack2Impl381 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl381 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl381();
        }
        return INSTANCE;
    }

    private BasepPack2Impl381(){
