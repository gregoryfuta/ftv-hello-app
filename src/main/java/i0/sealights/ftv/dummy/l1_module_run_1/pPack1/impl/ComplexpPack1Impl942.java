...
public class ComplexpPack1Impl942 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl942.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl942 INSTANCE;

    public static ComplexpPack1Impl942 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl942();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl942(){
