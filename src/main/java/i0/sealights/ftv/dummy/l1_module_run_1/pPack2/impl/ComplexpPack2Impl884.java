...
public class ComplexpPack2Impl884 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl884.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl884 INSTANCE;

    public static ComplexpPack2Impl884 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl884();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl884(){
