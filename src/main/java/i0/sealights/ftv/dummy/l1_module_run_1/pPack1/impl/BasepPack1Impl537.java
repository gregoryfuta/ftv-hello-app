...
public class BasepPack1Impl537 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl537.class);
    private static BasepPack1Impl537 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl537 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl537();
        }
        return INSTANCE;
    }

    private BasepPack1Impl537(){
