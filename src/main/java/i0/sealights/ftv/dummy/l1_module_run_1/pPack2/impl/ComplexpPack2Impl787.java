...
public class ComplexpPack2Impl787 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl787.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl787 INSTANCE;

    public static ComplexpPack2Impl787 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl787();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl787(){
