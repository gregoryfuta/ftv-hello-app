...
public class ComplexpPack1Impl871 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl871.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl871 INSTANCE;

    public static ComplexpPack1Impl871 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl871();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl871(){
