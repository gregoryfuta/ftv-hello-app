...
public class ComplexpPack1Impl633 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl633.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl633 INSTANCE;

    public static ComplexpPack1Impl633 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl633();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl633(){
