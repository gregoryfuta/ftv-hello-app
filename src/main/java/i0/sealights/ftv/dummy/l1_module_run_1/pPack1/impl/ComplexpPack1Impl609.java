...
public class ComplexpPack1Impl609 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl609.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl609 INSTANCE;

    public static ComplexpPack1Impl609 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl609();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl609(){
