...
public class BasepPack2Impl978 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl978.class);
    private static BasepPack2Impl978 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl978 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl978();
        }
        return INSTANCE;
    }

    private BasepPack2Impl978(){
