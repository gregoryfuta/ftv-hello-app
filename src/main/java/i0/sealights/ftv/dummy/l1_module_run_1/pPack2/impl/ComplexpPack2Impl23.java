...
public class ComplexpPack2Impl23 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl23.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl23 INSTANCE;

    public static ComplexpPack2Impl23 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl23();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl23(){
