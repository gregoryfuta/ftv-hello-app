...
public class ComplexpPack2Impl712 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl712.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl712 INSTANCE;

    public static ComplexpPack2Impl712 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl712();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl712(){
