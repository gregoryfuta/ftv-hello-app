...
public class ComplexpPack1Impl805 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl805.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl805 INSTANCE;

    public static ComplexpPack1Impl805 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl805();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl805(){
