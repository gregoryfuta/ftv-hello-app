...
public class ComplexpPack2Impl48 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl48.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl48 INSTANCE;

    public static ComplexpPack2Impl48 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl48();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl48(){
