...
public class ComplexpPack2Impl969 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl969.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl969 INSTANCE;

    public static ComplexpPack2Impl969 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl969();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl969(){
