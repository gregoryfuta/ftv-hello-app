...
public class ComplexpPack1Impl1062 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1062.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1062 INSTANCE;

    public static ComplexpPack1Impl1062 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1062();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1062(){
