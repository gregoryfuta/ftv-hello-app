...
public class BasepPack2Impl184 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl184.class);
    private static BasepPack2Impl184 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl184 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl184();
        }
        return INSTANCE;
    }

    private BasepPack2Impl184(){
