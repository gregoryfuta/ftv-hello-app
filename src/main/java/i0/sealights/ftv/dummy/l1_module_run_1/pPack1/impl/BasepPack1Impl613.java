...
public class BasepPack1Impl613 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl613.class);
    private static BasepPack1Impl613 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl613 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl613();
        }
        return INSTANCE;
    }

    private BasepPack1Impl613(){
