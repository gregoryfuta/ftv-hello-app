...
public class ComplexpPack1Impl868 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl868.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl868 INSTANCE;

    public static ComplexpPack1Impl868 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl868();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl868(){
