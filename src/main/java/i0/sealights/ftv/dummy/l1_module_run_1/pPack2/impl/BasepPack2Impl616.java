...
public class BasepPack2Impl616 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl616.class);
    private static BasepPack2Impl616 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl616 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl616();
        }
        return INSTANCE;
    }

    private BasepPack2Impl616(){
