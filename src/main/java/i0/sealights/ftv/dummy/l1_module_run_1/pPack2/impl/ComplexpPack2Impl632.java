...
public class ComplexpPack2Impl632 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl632.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl632 INSTANCE;

    public static ComplexpPack2Impl632 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl632();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl632(){
