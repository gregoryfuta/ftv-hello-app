...
public class ComplexpPack1Impl13 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl13.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl13 INSTANCE;

    public static ComplexpPack1Impl13 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl13();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl13(){
