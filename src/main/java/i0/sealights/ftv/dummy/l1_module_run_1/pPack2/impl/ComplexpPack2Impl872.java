...
public class ComplexpPack2Impl872 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl872.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl872 INSTANCE;

    public static ComplexpPack2Impl872 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl872();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl872(){
