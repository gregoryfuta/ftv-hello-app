...
public class BasepPack1Impl38 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl38.class);
    private static BasepPack1Impl38 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl38 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl38();
        }
        return INSTANCE;
    }

    private BasepPack1Impl38(){
