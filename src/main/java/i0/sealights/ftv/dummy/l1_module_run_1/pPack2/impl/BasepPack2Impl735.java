...
public class BasepPack2Impl735 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl735.class);
    private static BasepPack2Impl735 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl735 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl735();
        }
        return INSTANCE;
    }

    private BasepPack2Impl735(){
