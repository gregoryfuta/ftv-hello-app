...
public class ComplexpPack1Impl251 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl251.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl251 INSTANCE;

    public static ComplexpPack1Impl251 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl251();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl251(){
