...
public class ComplexpPack2Impl638 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl638.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl638 INSTANCE;

    public static ComplexpPack2Impl638 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl638();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl638(){
