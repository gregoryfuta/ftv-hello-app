...
public class BasepPack1Impl786 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl786.class);
    private static BasepPack1Impl786 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl786 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl786();
        }
        return INSTANCE;
    }

    private BasepPack1Impl786(){
