...
public class ComplexpPack1Impl739 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl739.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl739 INSTANCE;

    public static ComplexpPack1Impl739 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl739();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl739(){
