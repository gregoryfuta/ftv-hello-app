...
public class BasepPack1Impl753 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl753.class);
    private static BasepPack1Impl753 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl753 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl753();
        }
        return INSTANCE;
    }

    private BasepPack1Impl753(){
