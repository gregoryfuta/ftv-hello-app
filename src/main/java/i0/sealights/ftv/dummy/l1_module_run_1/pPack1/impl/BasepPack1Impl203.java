...
public class BasepPack1Impl203 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl203.class);
    private static BasepPack1Impl203 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl203 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl203();
        }
        return INSTANCE;
    }

    private BasepPack1Impl203(){
