...
public class ComplexpPack1Impl241 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl241.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl241 INSTANCE;

    public static ComplexpPack1Impl241 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl241();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl241(){
