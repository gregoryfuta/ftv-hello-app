...
public class BasepPack2Impl916 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl916.class);
    private static BasepPack2Impl916 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl916 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl916();
        }
        return INSTANCE;
    }

    private BasepPack2Impl916(){
