...
public class ComplexpPack2Impl449 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl449.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl449 INSTANCE;

    public static ComplexpPack2Impl449 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl449();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl449(){
