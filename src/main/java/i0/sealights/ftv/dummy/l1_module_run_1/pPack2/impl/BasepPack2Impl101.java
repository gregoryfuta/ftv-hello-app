...
public class BasepPack2Impl101 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl101.class);
    private static BasepPack2Impl101 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl101 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl101();
        }
        return INSTANCE;
    }

    private BasepPack2Impl101(){
