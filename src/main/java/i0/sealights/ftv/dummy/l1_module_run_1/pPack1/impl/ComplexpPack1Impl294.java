...
public class ComplexpPack1Impl294 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl294.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl294 INSTANCE;

    public static ComplexpPack1Impl294 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl294();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl294(){
