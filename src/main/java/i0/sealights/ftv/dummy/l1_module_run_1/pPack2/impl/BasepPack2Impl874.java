...
public class BasepPack2Impl874 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl874.class);
    private static BasepPack2Impl874 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl874 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl874();
        }
        return INSTANCE;
    }

    private BasepPack2Impl874(){
