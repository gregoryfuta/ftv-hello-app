...
public class BasepPack1Impl230 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl230.class);
    private static BasepPack1Impl230 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl230 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl230();
        }
        return INSTANCE;
    }

    private BasepPack1Impl230(){
