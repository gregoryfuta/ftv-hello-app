...
public class ComplexpPack1Impl514 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl514.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl514 INSTANCE;

    public static ComplexpPack1Impl514 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl514();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl514(){
