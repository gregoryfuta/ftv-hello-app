...
public class BasepPack2Impl77 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl77.class);
    private static BasepPack2Impl77 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl77 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl77();
        }
        return INSTANCE;
    }

    private BasepPack2Impl77(){
