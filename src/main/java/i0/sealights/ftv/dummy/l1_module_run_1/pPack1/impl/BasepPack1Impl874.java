...
public class BasepPack1Impl874 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl874.class);
    private static BasepPack1Impl874 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl874 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl874();
        }
        return INSTANCE;
    }

    private BasepPack1Impl874(){
