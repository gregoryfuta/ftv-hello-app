...
public class ComplexpPack2Impl258 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl258.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl258 INSTANCE;

    public static ComplexpPack2Impl258 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl258();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl258(){
