...
public class BasepPack1Impl57 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl57.class);
    private static BasepPack1Impl57 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl57 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl57();
        }
        return INSTANCE;
    }

    private BasepPack1Impl57(){
