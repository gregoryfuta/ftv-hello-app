...
public class BasepPack2Impl469 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl469.class);
    private static BasepPack2Impl469 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl469 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl469();
        }
        return INSTANCE;
    }

    private BasepPack2Impl469(){
