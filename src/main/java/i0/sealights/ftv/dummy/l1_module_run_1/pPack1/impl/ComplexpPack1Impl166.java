...
public class ComplexpPack1Impl166 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl166.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl166 INSTANCE;

    public static ComplexpPack1Impl166 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl166();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl166(){
