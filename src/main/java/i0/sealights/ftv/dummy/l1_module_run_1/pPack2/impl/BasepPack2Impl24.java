...
public class BasepPack2Impl24 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl24.class);
    private static BasepPack2Impl24 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl24 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl24();
        }
        return INSTANCE;
    }

    private BasepPack2Impl24(){
