...
public class BasepPack2Impl264 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl264.class);
    private static BasepPack2Impl264 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl264 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl264();
        }
        return INSTANCE;
    }

    private BasepPack2Impl264(){
