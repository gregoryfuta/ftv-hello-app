...
public class BasepPack2Impl963 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl963.class);
    private static BasepPack2Impl963 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl963 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl963();
        }
        return INSTANCE;
    }

    private BasepPack2Impl963(){
