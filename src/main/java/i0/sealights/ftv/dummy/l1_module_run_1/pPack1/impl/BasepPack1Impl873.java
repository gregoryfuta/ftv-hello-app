...
public class BasepPack1Impl873 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl873.class);
    private static BasepPack1Impl873 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl873 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl873();
        }
        return INSTANCE;
    }

    private BasepPack1Impl873(){
