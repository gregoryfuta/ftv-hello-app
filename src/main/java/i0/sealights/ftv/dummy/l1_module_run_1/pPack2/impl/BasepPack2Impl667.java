...
public class BasepPack2Impl667 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl667.class);
    private static BasepPack2Impl667 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl667 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl667();
        }
        return INSTANCE;
    }

    private BasepPack2Impl667(){
