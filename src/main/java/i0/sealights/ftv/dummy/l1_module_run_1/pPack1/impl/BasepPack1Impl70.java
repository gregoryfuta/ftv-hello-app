...
public class BasepPack1Impl70 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl70.class);
    private static BasepPack1Impl70 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl70 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl70();
        }
        return INSTANCE;
    }

    private BasepPack1Impl70(){
