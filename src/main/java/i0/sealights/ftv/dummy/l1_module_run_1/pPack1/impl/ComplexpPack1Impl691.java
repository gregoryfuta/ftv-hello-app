...
public class ComplexpPack1Impl691 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl691.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl691 INSTANCE;

    public static ComplexpPack1Impl691 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl691();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl691(){
