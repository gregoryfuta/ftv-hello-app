...
public class ComplexpPack1Impl967 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl967.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl967 INSTANCE;

    public static ComplexpPack1Impl967 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl967();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl967(){
