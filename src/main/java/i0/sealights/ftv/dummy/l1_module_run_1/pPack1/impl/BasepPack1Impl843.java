...
public class BasepPack1Impl843 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl843.class);
    private static BasepPack1Impl843 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl843 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl843();
        }
        return INSTANCE;
    }

    private BasepPack1Impl843(){
