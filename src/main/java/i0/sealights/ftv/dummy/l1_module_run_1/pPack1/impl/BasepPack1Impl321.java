...
public class BasepPack1Impl321 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl321.class);
    private static BasepPack1Impl321 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl321 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl321();
        }
        return INSTANCE;
    }

    private BasepPack1Impl321(){
