...
public class ComplexpPack1Impl564 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl564.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl564 INSTANCE;

    public static ComplexpPack1Impl564 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl564();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl564(){
