...
public class ComplexpPack2Impl407 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl407.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl407 INSTANCE;

    public static ComplexpPack2Impl407 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl407();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl407(){
