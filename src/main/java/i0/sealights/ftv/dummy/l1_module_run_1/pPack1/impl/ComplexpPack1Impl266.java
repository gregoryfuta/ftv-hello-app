...
public class ComplexpPack1Impl266 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl266.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl266 INSTANCE;

    public static ComplexpPack1Impl266 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl266();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl266(){
