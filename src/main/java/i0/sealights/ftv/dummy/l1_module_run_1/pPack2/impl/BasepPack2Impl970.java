...
public class BasepPack2Impl970 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl970.class);
    private static BasepPack2Impl970 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl970 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl970();
        }
        return INSTANCE;
    }

    private BasepPack2Impl970(){
