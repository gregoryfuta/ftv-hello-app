...
public class ComplexpPack2Impl200 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl200.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl200 INSTANCE;

    public static ComplexpPack2Impl200 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl200();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl200(){
