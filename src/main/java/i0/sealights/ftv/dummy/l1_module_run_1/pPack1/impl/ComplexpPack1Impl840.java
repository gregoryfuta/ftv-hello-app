...
public class ComplexpPack1Impl840 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl840.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl840 INSTANCE;

    public static ComplexpPack1Impl840 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl840();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl840(){
