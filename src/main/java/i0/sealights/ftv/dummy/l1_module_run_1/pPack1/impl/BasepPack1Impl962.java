...
public class BasepPack1Impl962 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl962.class);
    private static BasepPack1Impl962 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl962 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl962();
        }
        return INSTANCE;
    }

    private BasepPack1Impl962(){
