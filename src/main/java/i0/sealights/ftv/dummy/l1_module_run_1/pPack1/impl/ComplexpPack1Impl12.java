...
public class ComplexpPack1Impl12 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl12.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl12 INSTANCE;

    public static ComplexpPack1Impl12 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl12();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl12(){
