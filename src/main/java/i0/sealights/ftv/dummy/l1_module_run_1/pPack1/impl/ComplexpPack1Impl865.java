...
public class ComplexpPack1Impl865 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl865.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl865 INSTANCE;

    public static ComplexpPack1Impl865 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl865();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl865(){
