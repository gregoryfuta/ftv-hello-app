...
public class ComplexpPack1Impl212 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl212.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl212 INSTANCE;

    public static ComplexpPack1Impl212 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl212();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl212(){
