...
public class BasepPack2Impl697 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl697.class);
    private static BasepPack2Impl697 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl697 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl697();
        }
        return INSTANCE;
    }

    private BasepPack2Impl697(){
