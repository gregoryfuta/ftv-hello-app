...
public class BasepPack2Impl137 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl137.class);
    private static BasepPack2Impl137 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl137 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl137();
        }
        return INSTANCE;
    }

    private BasepPack2Impl137(){
