...
public class ComplexpPack2Impl406 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl406.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl406 INSTANCE;

    public static ComplexpPack2Impl406 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl406();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl406(){
