...
public class BasepPack1Impl399 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl399.class);
    private static BasepPack1Impl399 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl399 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl399();
        }
        return INSTANCE;
    }

    private BasepPack1Impl399(){
