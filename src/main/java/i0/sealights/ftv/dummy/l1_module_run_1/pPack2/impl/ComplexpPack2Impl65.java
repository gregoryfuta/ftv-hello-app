...
public class ComplexpPack2Impl65 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl65.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl65 INSTANCE;

    public static ComplexpPack2Impl65 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl65();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl65(){
