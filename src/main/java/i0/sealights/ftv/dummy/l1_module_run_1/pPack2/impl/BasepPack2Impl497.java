...
public class BasepPack2Impl497 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl497.class);
    private static BasepPack2Impl497 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl497 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl497();
        }
        return INSTANCE;
    }

    private BasepPack2Impl497(){
