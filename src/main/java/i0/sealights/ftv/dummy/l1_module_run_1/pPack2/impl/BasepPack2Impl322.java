...
public class BasepPack2Impl322 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl322.class);
    private static BasepPack2Impl322 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl322 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl322();
        }
        return INSTANCE;
    }

    private BasepPack2Impl322(){
