...
public class ComplexpPack2Impl361 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl361.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl361 INSTANCE;

    public static ComplexpPack2Impl361 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl361();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl361(){
