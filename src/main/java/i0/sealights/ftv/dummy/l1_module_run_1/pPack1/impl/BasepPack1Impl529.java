...
public class BasepPack1Impl529 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl529.class);
    private static BasepPack1Impl529 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl529 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl529();
        }
        return INSTANCE;
    }

    private BasepPack1Impl529(){
