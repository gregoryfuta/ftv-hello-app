...
public class BasepPack1Impl712 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl712.class);
    private static BasepPack1Impl712 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl712 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl712();
        }
        return INSTANCE;
    }

    private BasepPack1Impl712(){
