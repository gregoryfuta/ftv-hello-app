...
public class ComplexpPack2Impl36 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl36.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl36 INSTANCE;

    public static ComplexpPack2Impl36 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl36();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl36(){
