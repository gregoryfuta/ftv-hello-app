...
public class BasepPack2Impl525 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl525.class);
    private static BasepPack2Impl525 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl525 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl525();
        }
        return INSTANCE;
    }

    private BasepPack2Impl525(){
