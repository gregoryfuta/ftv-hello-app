...
public class ComplexpPack2Impl460 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl460.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl460 INSTANCE;

    public static ComplexpPack2Impl460 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl460();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl460(){
