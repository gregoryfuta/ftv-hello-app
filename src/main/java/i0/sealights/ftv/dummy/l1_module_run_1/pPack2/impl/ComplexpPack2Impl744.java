...
public class ComplexpPack2Impl744 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl744.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl744 INSTANCE;

    public static ComplexpPack2Impl744 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl744();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl744(){
