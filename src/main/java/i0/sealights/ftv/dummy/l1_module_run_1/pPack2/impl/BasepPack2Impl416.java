...
public class BasepPack2Impl416 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl416.class);
    private static BasepPack2Impl416 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl416 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl416();
        }
        return INSTANCE;
    }

    private BasepPack2Impl416(){
