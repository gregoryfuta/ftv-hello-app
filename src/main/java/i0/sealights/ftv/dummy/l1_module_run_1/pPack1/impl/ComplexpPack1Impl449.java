...
public class ComplexpPack1Impl449 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl449.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl449 INSTANCE;

    public static ComplexpPack1Impl449 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl449();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl449(){
