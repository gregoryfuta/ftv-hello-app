...
public class ComplexpPack2Impl172 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl172.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl172 INSTANCE;

    public static ComplexpPack2Impl172 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl172();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl172(){
