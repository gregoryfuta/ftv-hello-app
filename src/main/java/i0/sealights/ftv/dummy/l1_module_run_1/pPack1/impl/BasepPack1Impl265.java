...
public class BasepPack1Impl265 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl265.class);
    private static BasepPack1Impl265 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl265 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl265();
        }
        return INSTANCE;
    }

    private BasepPack1Impl265(){
