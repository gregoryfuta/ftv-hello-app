...
public class BasepPack2Impl354 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl354.class);
    private static BasepPack2Impl354 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl354 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl354();
        }
        return INSTANCE;
    }

    private BasepPack2Impl354(){
