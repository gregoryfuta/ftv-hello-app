...
public class ComplexpPack1Impl368 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl368.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl368 INSTANCE;

    public static ComplexpPack1Impl368 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl368();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl368(){
