...
public class BasepPack1Impl835 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl835.class);
    private static BasepPack1Impl835 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl835 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl835();
        }
        return INSTANCE;
    }

    private BasepPack1Impl835(){
