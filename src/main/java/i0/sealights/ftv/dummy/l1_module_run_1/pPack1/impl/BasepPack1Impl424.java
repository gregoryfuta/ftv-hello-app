...
public class BasepPack1Impl424 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl424.class);
    private static BasepPack1Impl424 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl424 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl424();
        }
        return INSTANCE;
    }

    private BasepPack1Impl424(){
