...
public class ComplexpPack2Impl959 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl959.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl959 INSTANCE;

    public static ComplexpPack2Impl959 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl959();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl959(){
