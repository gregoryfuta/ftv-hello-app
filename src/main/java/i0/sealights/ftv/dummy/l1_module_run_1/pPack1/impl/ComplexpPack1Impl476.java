...
public class ComplexpPack1Impl476 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl476.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl476 INSTANCE;

    public static ComplexpPack1Impl476 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl476();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl476(){
