...
public class ComplexpPack1Impl276 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl276.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl276 INSTANCE;

    public static ComplexpPack1Impl276 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl276();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl276(){
