...
public class BasepPack2Impl829 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl829.class);
    private static BasepPack2Impl829 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl829 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl829();
        }
        return INSTANCE;
    }

    private BasepPack2Impl829(){
