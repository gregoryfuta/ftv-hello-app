...
public class BasepPack1Impl126 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl126.class);
    private static BasepPack1Impl126 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl126 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl126();
        }
        return INSTANCE;
    }

    private BasepPack1Impl126(){
