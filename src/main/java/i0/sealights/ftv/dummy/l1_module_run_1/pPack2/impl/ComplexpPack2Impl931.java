...
public class ComplexpPack2Impl931 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl931.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl931 INSTANCE;

    public static ComplexpPack2Impl931 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl931();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl931(){
