...
public class BasepPack1Impl497 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl497.class);
    private static BasepPack1Impl497 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl497 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl497();
        }
        return INSTANCE;
    }

    private BasepPack1Impl497(){
