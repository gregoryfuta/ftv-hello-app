...
public class ComplexpPack1Impl984 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl984.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl984 INSTANCE;

    public static ComplexpPack1Impl984 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl984();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl984(){
