...
public class BasepPack1Impl283 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl283.class);
    private static BasepPack1Impl283 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl283 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl283();
        }
        return INSTANCE;
    }

    private BasepPack1Impl283(){
