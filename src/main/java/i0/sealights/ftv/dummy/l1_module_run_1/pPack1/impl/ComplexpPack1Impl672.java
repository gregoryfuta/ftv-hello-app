...
public class ComplexpPack1Impl672 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl672.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl672 INSTANCE;

    public static ComplexpPack1Impl672 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl672();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl672(){
