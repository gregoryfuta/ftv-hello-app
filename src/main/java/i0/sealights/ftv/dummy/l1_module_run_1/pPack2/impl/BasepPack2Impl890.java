...
public class BasepPack2Impl890 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl890.class);
    private static BasepPack2Impl890 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl890 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl890();
        }
        return INSTANCE;
    }

    private BasepPack2Impl890(){
