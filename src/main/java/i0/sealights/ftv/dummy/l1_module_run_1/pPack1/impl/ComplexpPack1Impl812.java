...
public class ComplexpPack1Impl812 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl812.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl812 INSTANCE;

    public static ComplexpPack1Impl812 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl812();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl812(){
