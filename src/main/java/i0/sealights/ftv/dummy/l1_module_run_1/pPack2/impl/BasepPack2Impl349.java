...
public class BasepPack2Impl349 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl349.class);
    private static BasepPack2Impl349 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl349 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl349();
        }
        return INSTANCE;
    }

    private BasepPack2Impl349(){
