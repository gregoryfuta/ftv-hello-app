...
public class BasepPack1Impl467 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl467.class);
    private static BasepPack1Impl467 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl467 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl467();
        }
        return INSTANCE;
    }

    private BasepPack1Impl467(){
