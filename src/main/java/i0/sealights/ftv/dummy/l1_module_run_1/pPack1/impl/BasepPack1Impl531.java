...
public class BasepPack1Impl531 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl531.class);
    private static BasepPack1Impl531 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl531 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl531();
        }
        return INSTANCE;
    }

    private BasepPack1Impl531(){
