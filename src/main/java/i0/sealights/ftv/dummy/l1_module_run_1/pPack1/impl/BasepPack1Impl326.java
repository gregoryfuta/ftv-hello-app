...
public class BasepPack1Impl326 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl326.class);
    private static BasepPack1Impl326 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl326 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl326();
        }
        return INSTANCE;
    }

    private BasepPack1Impl326(){
