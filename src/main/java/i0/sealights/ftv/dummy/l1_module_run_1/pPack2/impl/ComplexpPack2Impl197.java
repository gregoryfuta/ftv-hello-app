...
public class ComplexpPack2Impl197 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl197.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl197 INSTANCE;

    public static ComplexpPack2Impl197 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl197();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl197(){
