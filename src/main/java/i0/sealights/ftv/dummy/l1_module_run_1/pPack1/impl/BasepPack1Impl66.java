...
public class BasepPack1Impl66 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl66.class);
    private static BasepPack1Impl66 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl66 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl66();
        }
        return INSTANCE;
    }

    private BasepPack1Impl66(){
