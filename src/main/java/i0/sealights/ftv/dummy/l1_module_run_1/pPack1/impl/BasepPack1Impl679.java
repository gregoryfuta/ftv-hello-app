...
public class BasepPack1Impl679 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl679.class);
    private static BasepPack1Impl679 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl679 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl679();
        }
        return INSTANCE;
    }

    private BasepPack1Impl679(){
