...
public class ComplexpPack2Impl357 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl357.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl357 INSTANCE;

    public static ComplexpPack2Impl357 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl357();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl357(){
