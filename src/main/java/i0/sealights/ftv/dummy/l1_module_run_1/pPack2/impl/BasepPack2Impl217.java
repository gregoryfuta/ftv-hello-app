...
public class BasepPack2Impl217 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl217.class);
    private static BasepPack2Impl217 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl217 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl217();
        }
        return INSTANCE;
    }

    private BasepPack2Impl217(){
