...
public class ComplexpPack1Impl988 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl988.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl988 INSTANCE;

    public static ComplexpPack1Impl988 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl988();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl988(){
