...
public class BasepPack2Impl566 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl566.class);
    private static BasepPack2Impl566 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl566 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl566();
        }
        return INSTANCE;
    }

    private BasepPack2Impl566(){
