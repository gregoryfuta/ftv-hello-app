...
public class ComplexpPack1Impl540 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl540.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl540 INSTANCE;

    public static ComplexpPack1Impl540 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl540();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl540(){
