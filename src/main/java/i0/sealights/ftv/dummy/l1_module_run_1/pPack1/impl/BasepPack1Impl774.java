...
public class BasepPack1Impl774 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl774.class);
    private static BasepPack1Impl774 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl774 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl774();
        }
        return INSTANCE;
    }

    private BasepPack1Impl774(){
