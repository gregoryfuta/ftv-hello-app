...
public class BasepPack2Impl180 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl180.class);
    private static BasepPack2Impl180 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl180 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl180();
        }
        return INSTANCE;
    }

    private BasepPack2Impl180(){
