...
public class BasepPack2Impl99 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl99.class);
    private static BasepPack2Impl99 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl99 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl99();
        }
        return INSTANCE;
    }

    private BasepPack2Impl99(){
