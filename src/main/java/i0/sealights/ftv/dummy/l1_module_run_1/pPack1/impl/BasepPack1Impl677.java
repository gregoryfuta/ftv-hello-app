...
public class BasepPack1Impl677 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl677.class);
    private static BasepPack1Impl677 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl677 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl677();
        }
        return INSTANCE;
    }

    private BasepPack1Impl677(){
