...
public class ComplexpPack1Impl794 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl794.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl794 INSTANCE;

    public static ComplexpPack1Impl794 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl794();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl794(){
