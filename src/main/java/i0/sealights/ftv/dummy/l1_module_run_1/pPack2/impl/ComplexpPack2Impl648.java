...
public class ComplexpPack2Impl648 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl648.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl648 INSTANCE;

    public static ComplexpPack2Impl648 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl648();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl648(){
