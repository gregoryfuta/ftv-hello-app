...
public class BasepPack2Impl783 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl783.class);
    private static BasepPack2Impl783 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl783 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl783();
        }
        return INSTANCE;
    }

    private BasepPack2Impl783(){
