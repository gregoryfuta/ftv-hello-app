...
public class ComplexpPack1Impl901 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl901.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl901 INSTANCE;

    public static ComplexpPack1Impl901 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl901();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl901(){
