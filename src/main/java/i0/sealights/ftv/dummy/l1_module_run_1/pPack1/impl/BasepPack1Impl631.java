...
public class BasepPack1Impl631 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl631.class);
    private static BasepPack1Impl631 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl631 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl631();
        }
        return INSTANCE;
    }

    private BasepPack1Impl631(){
