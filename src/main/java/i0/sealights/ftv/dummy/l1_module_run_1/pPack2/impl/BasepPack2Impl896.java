...
public class BasepPack2Impl896 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl896.class);
    private static BasepPack2Impl896 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl896 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl896();
        }
        return INSTANCE;
    }

    private BasepPack2Impl896(){
