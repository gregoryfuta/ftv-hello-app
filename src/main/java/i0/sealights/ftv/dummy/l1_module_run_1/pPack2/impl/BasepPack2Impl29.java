...
public class BasepPack2Impl29 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl29.class);
    private static BasepPack2Impl29 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl29 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl29();
        }
        return INSTANCE;
    }

    private BasepPack2Impl29(){
