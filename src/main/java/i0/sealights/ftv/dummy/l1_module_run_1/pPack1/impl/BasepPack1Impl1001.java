...
public class BasepPack1Impl1001 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1001.class);
    private static BasepPack1Impl1001 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1001 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1001();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1001(){
