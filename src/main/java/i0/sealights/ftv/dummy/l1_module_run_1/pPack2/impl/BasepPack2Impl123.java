...
public class BasepPack2Impl123 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl123.class);
    private static BasepPack2Impl123 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl123 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl123();
        }
        return INSTANCE;
    }

    private BasepPack2Impl123(){
