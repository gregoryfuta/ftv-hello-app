...
public class BasepPack1Impl393 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl393.class);
    private static BasepPack1Impl393 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl393 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl393();
        }
        return INSTANCE;
    }

    private BasepPack1Impl393(){
