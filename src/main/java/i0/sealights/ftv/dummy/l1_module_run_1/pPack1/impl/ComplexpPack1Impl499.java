...
public class ComplexpPack1Impl499 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl499.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl499 INSTANCE;

    public static ComplexpPack1Impl499 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl499();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl499(){
