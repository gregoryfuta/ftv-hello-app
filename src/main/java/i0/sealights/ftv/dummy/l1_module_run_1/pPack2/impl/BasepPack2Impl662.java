...
public class BasepPack2Impl662 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl662.class);
    private static BasepPack2Impl662 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl662 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl662();
        }
        return INSTANCE;
    }

    private BasepPack2Impl662(){
