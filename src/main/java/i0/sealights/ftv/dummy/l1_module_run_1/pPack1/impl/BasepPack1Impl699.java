...
public class BasepPack1Impl699 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl699.class);
    private static BasepPack1Impl699 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl699 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl699();
        }
        return INSTANCE;
    }

    private BasepPack1Impl699(){
