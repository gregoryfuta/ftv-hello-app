...
public class BasepPack1Impl947 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl947.class);
    private static BasepPack1Impl947 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl947 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl947();
        }
        return INSTANCE;
    }

    private BasepPack1Impl947(){
