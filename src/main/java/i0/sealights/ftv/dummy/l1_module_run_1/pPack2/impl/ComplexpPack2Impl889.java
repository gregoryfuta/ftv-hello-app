...
public class ComplexpPack2Impl889 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl889.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl889 INSTANCE;

    public static ComplexpPack2Impl889 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl889();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl889(){
