...
public class BasepPack1Impl118 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl118.class);
    private static BasepPack1Impl118 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl118 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl118();
        }
        return INSTANCE;
    }

    private BasepPack1Impl118(){
