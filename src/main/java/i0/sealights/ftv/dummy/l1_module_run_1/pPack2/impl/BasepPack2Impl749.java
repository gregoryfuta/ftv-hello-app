...
public class BasepPack2Impl749 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl749.class);
    private static BasepPack2Impl749 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl749 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl749();
        }
        return INSTANCE;
    }

    private BasepPack2Impl749(){
