...
public class ComplexpPack1Impl567 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl567.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl567 INSTANCE;

    public static ComplexpPack1Impl567 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl567();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl567(){
