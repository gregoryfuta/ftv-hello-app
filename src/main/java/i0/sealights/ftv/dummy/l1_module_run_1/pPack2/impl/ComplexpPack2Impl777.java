...
public class ComplexpPack2Impl777 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl777.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl777 INSTANCE;

    public static ComplexpPack2Impl777 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl777();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl777(){
