...
public class BasepPack2Impl402 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl402.class);
    private static BasepPack2Impl402 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl402 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl402();
        }
        return INSTANCE;
    }

    private BasepPack2Impl402(){
