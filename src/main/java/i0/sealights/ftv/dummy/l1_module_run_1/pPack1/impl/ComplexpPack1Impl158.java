...
public class ComplexpPack1Impl158 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl158.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl158 INSTANCE;

    public static ComplexpPack1Impl158 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl158();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl158(){
