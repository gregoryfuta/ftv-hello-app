...
public class BasepPack2Impl797 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl797.class);
    private static BasepPack2Impl797 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl797 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl797();
        }
        return INSTANCE;
    }

    private BasepPack2Impl797(){
