...
public class ComplexpPack2Impl40 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl40.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl40 INSTANCE;

    public static ComplexpPack2Impl40 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl40();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl40(){
