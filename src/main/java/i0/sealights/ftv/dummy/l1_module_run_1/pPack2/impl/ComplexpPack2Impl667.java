...
public class ComplexpPack2Impl667 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl667.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl667 INSTANCE;

    public static ComplexpPack2Impl667 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl667();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl667(){
