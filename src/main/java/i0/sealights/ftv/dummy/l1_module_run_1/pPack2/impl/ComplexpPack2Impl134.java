...
public class ComplexpPack2Impl134 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl134.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl134 INSTANCE;

    public static ComplexpPack2Impl134 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl134();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl134(){
