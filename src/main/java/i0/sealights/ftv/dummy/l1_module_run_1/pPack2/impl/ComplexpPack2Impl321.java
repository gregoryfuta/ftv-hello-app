...
public class ComplexpPack2Impl321 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl321.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl321 INSTANCE;

    public static ComplexpPack2Impl321 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl321();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl321(){
