...
public class ComplexpPack2Impl420 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl420.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl420 INSTANCE;

    public static ComplexpPack2Impl420 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl420();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl420(){
