...
public class BasepPack2Impl46 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl46.class);
    private static BasepPack2Impl46 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl46 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl46();
        }
        return INSTANCE;
    }

    private BasepPack2Impl46(){
