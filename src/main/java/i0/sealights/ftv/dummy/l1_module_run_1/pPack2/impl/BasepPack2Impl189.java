...
public class BasepPack2Impl189 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl189.class);
    private static BasepPack2Impl189 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl189 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl189();
        }
        return INSTANCE;
    }

    private BasepPack2Impl189(){
