...
public class ComplexpPack2Impl10 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl10.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl10 INSTANCE;

    public static ComplexpPack2Impl10 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl10();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl10(){
