...
public class BasepPack2Impl624 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl624.class);
    private static BasepPack2Impl624 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl624 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl624();
        }
        return INSTANCE;
    }

    private BasepPack2Impl624(){
