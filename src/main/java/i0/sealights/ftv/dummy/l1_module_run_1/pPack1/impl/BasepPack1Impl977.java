...
public class BasepPack1Impl977 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl977.class);
    private static BasepPack1Impl977 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl977 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl977();
        }
        return INSTANCE;
    }

    private BasepPack1Impl977(){
