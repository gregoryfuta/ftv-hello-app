...
public class BasepPack2Impl645 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl645.class);
    private static BasepPack2Impl645 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl645 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl645();
        }
        return INSTANCE;
    }

    private BasepPack2Impl645(){
