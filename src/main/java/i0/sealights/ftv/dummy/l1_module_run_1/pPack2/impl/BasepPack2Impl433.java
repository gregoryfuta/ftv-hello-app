...
public class BasepPack2Impl433 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl433.class);
    private static BasepPack2Impl433 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl433 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl433();
        }
        return INSTANCE;
    }

    private BasepPack2Impl433(){
