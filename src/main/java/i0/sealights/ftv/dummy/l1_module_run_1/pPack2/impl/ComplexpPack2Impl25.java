...
public class ComplexpPack2Impl25 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl25.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl25 INSTANCE;

    public static ComplexpPack2Impl25 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl25();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl25(){
