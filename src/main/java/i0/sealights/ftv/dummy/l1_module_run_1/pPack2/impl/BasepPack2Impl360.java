...
public class BasepPack2Impl360 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl360.class);
    private static BasepPack2Impl360 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl360 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl360();
        }
        return INSTANCE;
    }

    private BasepPack2Impl360(){
