...
public class ComplexpPack2Impl552 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl552.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl552 INSTANCE;

    public static ComplexpPack2Impl552 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl552();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl552(){
