...
public class ComplexpPack1Impl771 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl771.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl771 INSTANCE;

    public static ComplexpPack1Impl771 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl771();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl771(){
