...
public class BasepPack2Impl709 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl709.class);
    private static BasepPack2Impl709 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl709 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl709();
        }
        return INSTANCE;
    }

    private BasepPack2Impl709(){
