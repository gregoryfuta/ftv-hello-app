...
public class ComplexpPack1Impl982 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl982.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl982 INSTANCE;

    public static ComplexpPack1Impl982 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl982();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl982(){
