...
public class ComplexpPack2Impl429 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl429.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl429 INSTANCE;

    public static ComplexpPack2Impl429 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl429();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl429(){
