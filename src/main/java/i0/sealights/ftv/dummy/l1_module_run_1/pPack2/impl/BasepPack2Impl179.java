...
public class BasepPack2Impl179 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl179.class);
    private static BasepPack2Impl179 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl179 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl179();
        }
        return INSTANCE;
    }

    private BasepPack2Impl179(){
