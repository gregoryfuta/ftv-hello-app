...
public class BasepPack2Impl876 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl876.class);
    private static BasepPack2Impl876 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl876 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl876();
        }
        return INSTANCE;
    }

    private BasepPack2Impl876(){
