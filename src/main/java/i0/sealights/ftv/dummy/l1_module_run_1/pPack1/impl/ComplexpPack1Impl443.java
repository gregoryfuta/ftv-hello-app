...
public class ComplexpPack1Impl443 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl443.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl443 INSTANCE;

    public static ComplexpPack1Impl443 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl443();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl443(){
