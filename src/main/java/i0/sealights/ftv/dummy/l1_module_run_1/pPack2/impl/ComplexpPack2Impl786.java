...
public class ComplexpPack2Impl786 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl786.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl786 INSTANCE;

    public static ComplexpPack2Impl786 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl786();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl786(){
