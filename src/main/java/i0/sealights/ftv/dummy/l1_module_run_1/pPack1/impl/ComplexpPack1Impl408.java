...
public class ComplexpPack1Impl408 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl408.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl408 INSTANCE;

    public static ComplexpPack1Impl408 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl408();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl408(){
