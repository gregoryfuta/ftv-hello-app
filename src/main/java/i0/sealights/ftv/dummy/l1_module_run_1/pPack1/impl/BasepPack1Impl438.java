...
public class BasepPack1Impl438 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl438.class);
    private static BasepPack1Impl438 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl438 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl438();
        }
        return INSTANCE;
    }

    private BasepPack1Impl438(){
