...
public class ComplexpPack1Impl747 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl747.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl747 INSTANCE;

    public static ComplexpPack1Impl747 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl747();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl747(){
