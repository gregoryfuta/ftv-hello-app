...
public class BasepPack1Impl146 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl146.class);
    private static BasepPack1Impl146 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl146 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl146();
        }
        return INSTANCE;
    }

    private BasepPack1Impl146(){
