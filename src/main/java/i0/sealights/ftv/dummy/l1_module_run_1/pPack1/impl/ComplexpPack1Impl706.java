...
public class ComplexpPack1Impl706 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl706.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl706 INSTANCE;

    public static ComplexpPack1Impl706 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl706();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl706(){
