...
public class BasepPack1Impl952 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl952.class);
    private static BasepPack1Impl952 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl952 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl952();
        }
        return INSTANCE;
    }

    private BasepPack1Impl952(){
