...
public class BasepPack2Impl654 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl654.class);
    private static BasepPack2Impl654 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl654 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl654();
        }
        return INSTANCE;
    }

    private BasepPack2Impl654(){
