...
public class ComplexpPack2Impl459 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl459.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl459 INSTANCE;

    public static ComplexpPack2Impl459 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl459();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl459(){
