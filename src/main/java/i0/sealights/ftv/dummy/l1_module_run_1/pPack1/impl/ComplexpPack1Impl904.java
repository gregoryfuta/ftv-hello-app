...
public class ComplexpPack1Impl904 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl904.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl904 INSTANCE;

    public static ComplexpPack1Impl904 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl904();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl904(){
