...
public class BasepPack1Impl242 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl242.class);
    private static BasepPack1Impl242 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl242 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl242();
        }
        return INSTANCE;
    }

    private BasepPack1Impl242(){
