...
public class BasepPack1Impl119 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl119.class);
    private static BasepPack1Impl119 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl119 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl119();
        }
        return INSTANCE;
    }

    private BasepPack1Impl119(){
