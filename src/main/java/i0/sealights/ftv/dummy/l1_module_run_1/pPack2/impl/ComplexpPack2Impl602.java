...
public class ComplexpPack2Impl602 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl602.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl602 INSTANCE;

    public static ComplexpPack2Impl602 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl602();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl602(){
