...
public class ComplexpPack2Impl862 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl862.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl862 INSTANCE;

    public static ComplexpPack2Impl862 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl862();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl862(){
