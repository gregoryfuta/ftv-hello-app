...
public class ComplexpPack2Impl319 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl319.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl319 INSTANCE;

    public static ComplexpPack2Impl319 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl319();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl319(){
