...
public class BasepPack1Impl754 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl754.class);
    private static BasepPack1Impl754 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl754 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl754();
        }
        return INSTANCE;
    }

    private BasepPack1Impl754(){
