...
public class BasepPack2Impl413 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl413.class);
    private static BasepPack2Impl413 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl413 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl413();
        }
        return INSTANCE;
    }

    private BasepPack2Impl413(){
