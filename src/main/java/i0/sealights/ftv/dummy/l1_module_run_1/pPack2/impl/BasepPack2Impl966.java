...
public class BasepPack2Impl966 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl966.class);
    private static BasepPack2Impl966 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl966 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl966();
        }
        return INSTANCE;
    }

    private BasepPack2Impl966(){
