...
public class ComplexpPack2Impl784 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl784.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl784 INSTANCE;

    public static ComplexpPack2Impl784 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl784();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl784(){
