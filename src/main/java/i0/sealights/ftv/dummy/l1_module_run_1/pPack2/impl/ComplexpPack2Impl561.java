...
public class ComplexpPack2Impl561 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl561.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl561 INSTANCE;

    public static ComplexpPack2Impl561 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl561();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl561(){
