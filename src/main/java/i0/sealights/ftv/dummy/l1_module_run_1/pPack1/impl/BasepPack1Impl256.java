...
public class BasepPack1Impl256 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl256.class);
    private static BasepPack1Impl256 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl256 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl256();
        }
        return INSTANCE;
    }

    private BasepPack1Impl256(){
