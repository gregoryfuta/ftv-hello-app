...
public class ComplexpPack1Impl644 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl644.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl644 INSTANCE;

    public static ComplexpPack1Impl644 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl644();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl644(){
