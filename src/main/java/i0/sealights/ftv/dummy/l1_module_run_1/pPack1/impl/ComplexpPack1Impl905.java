...
public class ComplexpPack1Impl905 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl905.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl905 INSTANCE;

    public static ComplexpPack1Impl905 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl905();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl905(){
