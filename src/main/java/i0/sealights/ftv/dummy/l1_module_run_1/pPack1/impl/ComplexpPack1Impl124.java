...
public class ComplexpPack1Impl124 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl124.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl124 INSTANCE;

    public static ComplexpPack1Impl124 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl124();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl124(){
