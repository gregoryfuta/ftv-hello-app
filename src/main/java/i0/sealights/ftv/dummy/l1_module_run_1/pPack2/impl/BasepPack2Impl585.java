...
public class BasepPack2Impl585 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl585.class);
    private static BasepPack2Impl585 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl585 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl585();
        }
        return INSTANCE;
    }

    private BasepPack2Impl585(){
