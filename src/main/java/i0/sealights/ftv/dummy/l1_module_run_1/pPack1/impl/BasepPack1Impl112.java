...
public class BasepPack1Impl112 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl112.class);
    private static BasepPack1Impl112 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl112 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl112();
        }
        return INSTANCE;
    }

    private BasepPack1Impl112(){
