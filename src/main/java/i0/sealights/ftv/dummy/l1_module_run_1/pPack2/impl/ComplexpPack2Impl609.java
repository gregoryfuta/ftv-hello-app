...
public class ComplexpPack2Impl609 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl609.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl609 INSTANCE;

    public static ComplexpPack2Impl609 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl609();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl609(){
