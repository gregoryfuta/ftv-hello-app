...
public class ComplexpPack2Impl524 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl524.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl524 INSTANCE;

    public static ComplexpPack2Impl524 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl524();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl524(){
