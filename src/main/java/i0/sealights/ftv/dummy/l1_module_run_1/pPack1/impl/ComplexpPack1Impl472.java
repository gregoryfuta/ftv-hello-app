...
public class ComplexpPack1Impl472 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl472.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl472 INSTANCE;

    public static ComplexpPack1Impl472 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl472();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl472(){
