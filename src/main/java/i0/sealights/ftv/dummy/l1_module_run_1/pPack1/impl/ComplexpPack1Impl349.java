...
public class ComplexpPack1Impl349 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl349.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl349 INSTANCE;

    public static ComplexpPack1Impl349 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl349();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl349(){
