...
public class ComplexpPack2Impl629 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl629.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl629 INSTANCE;

    public static ComplexpPack2Impl629 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl629();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl629(){
