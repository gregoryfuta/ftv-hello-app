...
public class BasepPack1Impl846 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl846.class);
    private static BasepPack1Impl846 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl846 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl846();
        }
        return INSTANCE;
    }

    private BasepPack1Impl846(){
