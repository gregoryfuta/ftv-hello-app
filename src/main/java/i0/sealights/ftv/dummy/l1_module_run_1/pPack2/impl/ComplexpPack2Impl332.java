...
public class ComplexpPack2Impl332 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl332.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl332 INSTANCE;

    public static ComplexpPack2Impl332 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl332();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl332(){
