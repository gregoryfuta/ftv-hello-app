...
public class ComplexpPack2Impl555 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl555.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl555 INSTANCE;

    public static ComplexpPack2Impl555 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl555();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl555(){
