...
public class ComplexpPack1Impl176 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl176.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl176 INSTANCE;

    public static ComplexpPack1Impl176 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl176();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl176(){
