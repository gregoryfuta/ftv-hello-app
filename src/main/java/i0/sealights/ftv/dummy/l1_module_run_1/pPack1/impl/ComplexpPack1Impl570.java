...
public class ComplexpPack1Impl570 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl570.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl570 INSTANCE;

    public static ComplexpPack1Impl570 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl570();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl570(){
