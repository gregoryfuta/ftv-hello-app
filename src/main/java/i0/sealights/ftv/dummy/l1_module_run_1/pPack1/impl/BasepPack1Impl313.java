...
public class BasepPack1Impl313 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl313.class);
    private static BasepPack1Impl313 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl313 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl313();
        }
        return INSTANCE;
    }

    private BasepPack1Impl313(){
