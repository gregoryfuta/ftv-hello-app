...
public class BasepPack1Impl84 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl84.class);
    private static BasepPack1Impl84 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl84 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl84();
        }
        return INSTANCE;
    }

    private BasepPack1Impl84(){
