...
public class BasepPack2Impl503 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl503.class);
    private static BasepPack2Impl503 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl503 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl503();
        }
        return INSTANCE;
    }

    private BasepPack2Impl503(){
