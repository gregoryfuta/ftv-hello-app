...
public class ComplexpPack1Impl416 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl416.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl416 INSTANCE;

    public static ComplexpPack1Impl416 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl416();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl416(){
