...
public class ComplexpPack2Impl489 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl489.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl489 INSTANCE;

    public static ComplexpPack2Impl489 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl489();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl489(){
