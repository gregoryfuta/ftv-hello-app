...
public class BasepPack2Impl3 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl3.class);
    private static BasepPack2Impl3 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl3 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl3();
        }
        return INSTANCE;
    }

    private BasepPack2Impl3(){
