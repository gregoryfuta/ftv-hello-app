...
public class ComplexpPack1Impl891 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl891.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl891 INSTANCE;

    public static ComplexpPack1Impl891 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl891();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl891(){
