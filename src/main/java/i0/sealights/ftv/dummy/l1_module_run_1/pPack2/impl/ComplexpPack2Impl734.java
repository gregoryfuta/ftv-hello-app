...
public class ComplexpPack2Impl734 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl734.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl734 INSTANCE;

    public static ComplexpPack2Impl734 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl734();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl734(){
