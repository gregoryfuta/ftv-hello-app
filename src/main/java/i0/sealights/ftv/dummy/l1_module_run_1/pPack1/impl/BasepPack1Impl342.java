...
public class BasepPack1Impl342 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl342.class);
    private static BasepPack1Impl342 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl342 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl342();
        }
        return INSTANCE;
    }

    private BasepPack1Impl342(){
