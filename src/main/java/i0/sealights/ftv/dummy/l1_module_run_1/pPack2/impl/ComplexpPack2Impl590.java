...
public class ComplexpPack2Impl590 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl590.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl590 INSTANCE;

    public static ComplexpPack2Impl590 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl590();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl590(){
