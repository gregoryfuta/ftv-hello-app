...
public class ComplexpPack2Impl28 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl28.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl28 INSTANCE;

    public static ComplexpPack2Impl28 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl28();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl28(){
