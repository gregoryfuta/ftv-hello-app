...
public class ComplexpPack1Impl439 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl439.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl439 INSTANCE;

    public static ComplexpPack1Impl439 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl439();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl439(){
