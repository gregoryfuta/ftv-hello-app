...
public class ComplexpPack1Impl588 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl588.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl588 INSTANCE;

    public static ComplexpPack1Impl588 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl588();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl588(){
