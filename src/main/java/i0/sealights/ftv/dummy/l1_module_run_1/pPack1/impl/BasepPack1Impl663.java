...
public class BasepPack1Impl663 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl663.class);
    private static BasepPack1Impl663 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl663 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl663();
        }
        return INSTANCE;
    }

    private BasepPack1Impl663(){
