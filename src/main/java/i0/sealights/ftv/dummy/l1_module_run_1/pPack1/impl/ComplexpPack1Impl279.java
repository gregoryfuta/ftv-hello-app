...
public class ComplexpPack1Impl279 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl279.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl279 INSTANCE;

    public static ComplexpPack1Impl279 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl279();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl279(){
