...
public class ComplexpPack1Impl893 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl893.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl893 INSTANCE;

    public static ComplexpPack1Impl893 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl893();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl893(){
