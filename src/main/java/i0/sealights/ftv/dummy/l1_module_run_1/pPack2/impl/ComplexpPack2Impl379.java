...
public class ComplexpPack2Impl379 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl379.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl379 INSTANCE;

    public static ComplexpPack2Impl379 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl379();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl379(){
