...
public class ComplexpPack2Impl943 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl943.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl943 INSTANCE;

    public static ComplexpPack2Impl943 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl943();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl943(){
