...
public class ComplexpPack1Impl690 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl690.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl690 INSTANCE;

    public static ComplexpPack1Impl690 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl690();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl690(){
