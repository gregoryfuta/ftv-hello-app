...
public class ComplexpPack2Impl82 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl82.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl82 INSTANCE;

    public static ComplexpPack2Impl82 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl82();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl82(){
