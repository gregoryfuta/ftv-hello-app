...
public class BasepPack2Impl59 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl59.class);
    private static BasepPack2Impl59 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl59 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl59();
        }
        return INSTANCE;
    }

    private BasepPack2Impl59(){
