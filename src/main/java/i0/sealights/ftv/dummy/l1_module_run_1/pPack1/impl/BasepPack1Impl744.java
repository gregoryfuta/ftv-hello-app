...
public class BasepPack1Impl744 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl744.class);
    private static BasepPack1Impl744 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl744 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl744();
        }
        return INSTANCE;
    }

    private BasepPack1Impl744(){
