...
public class ComplexpPack2Impl160 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl160.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl160 INSTANCE;

    public static ComplexpPack2Impl160 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl160();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl160(){
