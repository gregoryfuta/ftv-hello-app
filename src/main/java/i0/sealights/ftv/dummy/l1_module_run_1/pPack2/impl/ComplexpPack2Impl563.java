...
public class ComplexpPack2Impl563 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl563.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl563 INSTANCE;

    public static ComplexpPack2Impl563 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl563();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl563(){
