...
public class BasepPack1Impl234 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl234.class);
    private static BasepPack1Impl234 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl234 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl234();
        }
        return INSTANCE;
    }

    private BasepPack1Impl234(){
