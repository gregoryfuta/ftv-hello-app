...
public class BasepPack2Impl491 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl491.class);
    private static BasepPack2Impl491 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl491 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl491();
        }
        return INSTANCE;
    }

    private BasepPack2Impl491(){
