...
public class BasepPack1Impl540 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl540.class);
    private static BasepPack1Impl540 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl540 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl540();
        }
        return INSTANCE;
    }

    private BasepPack1Impl540(){
