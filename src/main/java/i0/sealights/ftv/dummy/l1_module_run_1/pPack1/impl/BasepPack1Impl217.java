...
public class BasepPack1Impl217 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl217.class);
    private static BasepPack1Impl217 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl217 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl217();
        }
        return INSTANCE;
    }

    private BasepPack1Impl217(){
