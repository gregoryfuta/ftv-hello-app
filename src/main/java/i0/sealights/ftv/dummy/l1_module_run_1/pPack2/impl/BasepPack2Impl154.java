...
public class BasepPack2Impl154 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl154.class);
    private static BasepPack2Impl154 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl154 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl154();
        }
        return INSTANCE;
    }

    private BasepPack2Impl154(){
