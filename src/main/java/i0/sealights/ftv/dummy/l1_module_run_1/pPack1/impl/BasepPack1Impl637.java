...
public class BasepPack1Impl637 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl637.class);
    private static BasepPack1Impl637 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl637 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl637();
        }
        return INSTANCE;
    }

    private BasepPack1Impl637(){
