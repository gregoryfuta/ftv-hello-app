...
public class BasepPack2Impl465 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl465.class);
    private static BasepPack2Impl465 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl465 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl465();
        }
        return INSTANCE;
    }

    private BasepPack2Impl465(){
