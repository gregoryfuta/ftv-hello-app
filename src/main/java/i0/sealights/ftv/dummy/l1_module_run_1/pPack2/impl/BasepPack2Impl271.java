...
public class BasepPack2Impl271 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl271.class);
    private static BasepPack2Impl271 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl271 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl271();
        }
        return INSTANCE;
    }

    private BasepPack2Impl271(){
