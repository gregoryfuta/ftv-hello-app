...
public class ComplexpPack2Impl388 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl388.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl388 INSTANCE;

    public static ComplexpPack2Impl388 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl388();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl388(){
