...
public class BasepPack2Impl216 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl216.class);
    private static BasepPack2Impl216 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl216 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl216();
        }
        return INSTANCE;
    }

    private BasepPack2Impl216(){
