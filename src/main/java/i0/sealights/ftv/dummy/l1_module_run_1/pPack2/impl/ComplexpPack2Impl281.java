...
public class ComplexpPack2Impl281 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl281.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl281 INSTANCE;

    public static ComplexpPack2Impl281 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl281();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl281(){
