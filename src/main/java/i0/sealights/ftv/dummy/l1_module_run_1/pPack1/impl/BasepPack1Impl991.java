...
public class BasepPack1Impl991 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl991.class);
    private static BasepPack1Impl991 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl991 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl991();
        }
        return INSTANCE;
    }

    private BasepPack1Impl991(){
