...
public class ComplexpPack1Impl978 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl978.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl978 INSTANCE;

    public static ComplexpPack1Impl978 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl978();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl978(){
