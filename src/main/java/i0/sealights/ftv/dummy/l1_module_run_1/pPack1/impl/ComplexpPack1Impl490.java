...
public class ComplexpPack1Impl490 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl490.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl490 INSTANCE;

    public static ComplexpPack1Impl490 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl490();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl490(){
