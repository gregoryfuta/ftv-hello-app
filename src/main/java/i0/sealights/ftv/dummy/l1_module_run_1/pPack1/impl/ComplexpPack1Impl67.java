...
public class ComplexpPack1Impl67 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl67.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl67 INSTANCE;

    public static ComplexpPack1Impl67 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl67();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl67(){
