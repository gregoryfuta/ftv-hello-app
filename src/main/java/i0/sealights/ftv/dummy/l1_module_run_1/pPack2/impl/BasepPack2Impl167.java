...
public class BasepPack2Impl167 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl167.class);
    private static BasepPack2Impl167 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl167 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl167();
        }
        return INSTANCE;
    }

    private BasepPack2Impl167(){
