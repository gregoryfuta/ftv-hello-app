...
public class ComplexpPack1Impl970 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl970.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl970 INSTANCE;

    public static ComplexpPack1Impl970 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl970();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl970(){
