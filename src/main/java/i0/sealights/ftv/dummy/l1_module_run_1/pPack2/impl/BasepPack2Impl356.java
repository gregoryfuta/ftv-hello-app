...
public class BasepPack2Impl356 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl356.class);
    private static BasepPack2Impl356 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl356 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl356();
        }
        return INSTANCE;
    }

    private BasepPack2Impl356(){
