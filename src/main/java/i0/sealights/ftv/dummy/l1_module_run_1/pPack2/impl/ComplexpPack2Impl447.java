...
public class ComplexpPack2Impl447 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl447.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl447 INSTANCE;

    public static ComplexpPack2Impl447 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl447();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl447(){
