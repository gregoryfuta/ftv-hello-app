...
public class BasepPack2Impl766 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl766.class);
    private static BasepPack2Impl766 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl766 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl766();
        }
        return INSTANCE;
    }

    private BasepPack2Impl766(){
