...
public class ComplexpPack1Impl895 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl895.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl895 INSTANCE;

    public static ComplexpPack1Impl895 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl895();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl895(){
