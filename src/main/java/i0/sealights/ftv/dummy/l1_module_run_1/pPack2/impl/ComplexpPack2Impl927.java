...
public class ComplexpPack2Impl927 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl927.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl927 INSTANCE;

    public static ComplexpPack2Impl927 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl927();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl927(){
