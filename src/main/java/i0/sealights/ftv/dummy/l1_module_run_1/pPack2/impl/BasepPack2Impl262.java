...
public class BasepPack2Impl262 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl262.class);
    private static BasepPack2Impl262 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl262 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl262();
        }
        return INSTANCE;
    }

    private BasepPack2Impl262(){
