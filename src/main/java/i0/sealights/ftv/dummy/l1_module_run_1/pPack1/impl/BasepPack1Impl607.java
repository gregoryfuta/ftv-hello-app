...
public class BasepPack1Impl607 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl607.class);
    private static BasepPack1Impl607 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl607 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl607();
        }
        return INSTANCE;
    }

    private BasepPack1Impl607(){
