...
public class BasepPack2Impl483 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl483.class);
    private static BasepPack2Impl483 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl483 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl483();
        }
        return INSTANCE;
    }

    private BasepPack2Impl483(){
