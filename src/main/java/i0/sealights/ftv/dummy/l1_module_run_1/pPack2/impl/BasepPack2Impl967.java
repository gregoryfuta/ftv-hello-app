...
public class BasepPack2Impl967 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl967.class);
    private static BasepPack2Impl967 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl967 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl967();
        }
        return INSTANCE;
    }

    private BasepPack2Impl967(){
