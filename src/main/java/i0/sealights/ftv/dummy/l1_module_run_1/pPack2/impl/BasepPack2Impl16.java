...
public class BasepPack2Impl16 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl16.class);
    private static BasepPack2Impl16 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl16 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl16();
        }
        return INSTANCE;
    }

    private BasepPack2Impl16(){
