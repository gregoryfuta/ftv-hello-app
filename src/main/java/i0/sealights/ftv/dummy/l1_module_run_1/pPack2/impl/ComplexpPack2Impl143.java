...
public class ComplexpPack2Impl143 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl143.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl143 INSTANCE;

    public static ComplexpPack2Impl143 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl143();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl143(){
