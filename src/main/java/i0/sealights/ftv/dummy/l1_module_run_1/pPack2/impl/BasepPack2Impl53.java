...
public class BasepPack2Impl53 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl53.class);
    private static BasepPack2Impl53 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl53 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl53();
        }
        return INSTANCE;
    }

    private BasepPack2Impl53(){
