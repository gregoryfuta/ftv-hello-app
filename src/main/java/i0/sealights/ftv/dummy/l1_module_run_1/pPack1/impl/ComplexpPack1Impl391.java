...
public class ComplexpPack1Impl391 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl391.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl391 INSTANCE;

    public static ComplexpPack1Impl391 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl391();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl391(){
