...
public class ComplexpPack1Impl975 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl975.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl975 INSTANCE;

    public static ComplexpPack1Impl975 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl975();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl975(){
