...
public class BasepPack2Impl251 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl251.class);
    private static BasepPack2Impl251 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl251 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl251();
        }
        return INSTANCE;
    }

    private BasepPack2Impl251(){
