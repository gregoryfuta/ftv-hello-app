...
public class BasepPack2Impl508 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl508.class);
    private static BasepPack2Impl508 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl508 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl508();
        }
        return INSTANCE;
    }

    private BasepPack2Impl508(){
