...
public class BasepPack1Impl48 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl48.class);
    private static BasepPack1Impl48 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl48 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl48();
        }
        return INSTANCE;
    }

    private BasepPack1Impl48(){
