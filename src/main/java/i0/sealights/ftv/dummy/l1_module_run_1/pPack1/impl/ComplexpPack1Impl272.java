...
public class ComplexpPack1Impl272 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl272.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl272 INSTANCE;

    public static ComplexpPack1Impl272 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl272();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl272(){
