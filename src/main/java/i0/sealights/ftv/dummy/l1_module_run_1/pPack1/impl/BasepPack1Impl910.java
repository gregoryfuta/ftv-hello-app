...
public class BasepPack1Impl910 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl910.class);
    private static BasepPack1Impl910 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl910 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl910();
        }
        return INSTANCE;
    }

    private BasepPack1Impl910(){
