...
public class BasepPack1Impl2 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl2.class);
    private static BasepPack1Impl2 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl2 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl2();
        }
        return INSTANCE;
    }

    private BasepPack1Impl2(){
