...
public class BasepPack1Impl921 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl921.class);
    private static BasepPack1Impl921 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl921 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl921();
        }
        return INSTANCE;
    }

    private BasepPack1Impl921(){
