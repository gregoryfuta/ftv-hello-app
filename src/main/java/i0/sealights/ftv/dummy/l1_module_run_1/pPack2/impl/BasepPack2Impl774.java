...
public class BasepPack2Impl774 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl774.class);
    private static BasepPack2Impl774 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl774 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl774();
        }
        return INSTANCE;
    }

    private BasepPack2Impl774(){
