...
public class ComplexpPack2Impl184 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl184.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl184 INSTANCE;

    public static ComplexpPack2Impl184 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl184();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl184(){
