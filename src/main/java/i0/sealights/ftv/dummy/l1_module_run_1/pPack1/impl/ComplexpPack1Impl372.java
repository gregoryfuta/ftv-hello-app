...
public class ComplexpPack1Impl372 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl372.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl372 INSTANCE;

    public static ComplexpPack1Impl372 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl372();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl372(){
