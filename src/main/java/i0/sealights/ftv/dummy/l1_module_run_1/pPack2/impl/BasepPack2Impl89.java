...
public class BasepPack2Impl89 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl89.class);
    private static BasepPack2Impl89 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl89 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl89();
        }
        return INSTANCE;
    }

    private BasepPack2Impl89(){
