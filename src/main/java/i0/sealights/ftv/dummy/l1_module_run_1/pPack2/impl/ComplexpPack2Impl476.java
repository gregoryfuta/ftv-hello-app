...
public class ComplexpPack2Impl476 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl476.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl476 INSTANCE;

    public static ComplexpPack2Impl476 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl476();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl476(){
