...
public class ComplexpPack1Impl461 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl461.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl461 INSTANCE;

    public static ComplexpPack1Impl461 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl461();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl461(){
