...
public class BasepPack1Impl61 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl61.class);
    private static BasepPack1Impl61 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl61 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl61();
        }
        return INSTANCE;
    }

    private BasepPack1Impl61(){
