...
public class BasepPack2Impl574 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl574.class);
    private static BasepPack2Impl574 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl574 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl574();
        }
        return INSTANCE;
    }

    private BasepPack2Impl574(){
