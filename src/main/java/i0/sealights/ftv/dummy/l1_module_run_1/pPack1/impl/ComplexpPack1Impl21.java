...
public class ComplexpPack1Impl21 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl21.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl21 INSTANCE;

    public static ComplexpPack1Impl21 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl21();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl21(){
