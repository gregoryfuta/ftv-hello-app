...
public class ComplexpPack1Impl907 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl907.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl907 INSTANCE;

    public static ComplexpPack1Impl907 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl907();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl907(){
