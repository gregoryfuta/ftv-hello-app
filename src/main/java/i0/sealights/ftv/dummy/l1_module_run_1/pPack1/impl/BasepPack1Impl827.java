...
public class BasepPack1Impl827 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl827.class);
    private static BasepPack1Impl827 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl827 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl827();
        }
        return INSTANCE;
    }

    private BasepPack1Impl827(){
