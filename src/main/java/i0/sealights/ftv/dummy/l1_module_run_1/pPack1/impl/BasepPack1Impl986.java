...
public class BasepPack1Impl986 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl986.class);
    private static BasepPack1Impl986 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl986 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl986();
        }
        return INSTANCE;
    }

    private BasepPack1Impl986(){
