...
public class ComplexpPack1Impl966 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl966.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl966 INSTANCE;

    public static ComplexpPack1Impl966 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl966();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl966(){
