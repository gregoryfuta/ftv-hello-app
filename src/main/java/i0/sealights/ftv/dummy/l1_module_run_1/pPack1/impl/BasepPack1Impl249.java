...
public class BasepPack1Impl249 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl249.class);
    private static BasepPack1Impl249 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl249 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl249();
        }
        return INSTANCE;
    }

    private BasepPack1Impl249(){
