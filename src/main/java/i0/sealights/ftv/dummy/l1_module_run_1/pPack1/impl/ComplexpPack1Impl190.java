...
public class ComplexpPack1Impl190 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl190.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl190 INSTANCE;

    public static ComplexpPack1Impl190 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl190();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl190(){
