...
public class BasepPack2Impl2 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl2.class);
    private static BasepPack2Impl2 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl2 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl2();
        }
        return INSTANCE;
    }

    private BasepPack2Impl2(){
