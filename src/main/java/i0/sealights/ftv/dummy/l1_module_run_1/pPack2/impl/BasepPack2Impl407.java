...
public class BasepPack2Impl407 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl407.class);
    private static BasepPack2Impl407 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl407 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl407();
        }
        return INSTANCE;
    }

    private BasepPack2Impl407(){
