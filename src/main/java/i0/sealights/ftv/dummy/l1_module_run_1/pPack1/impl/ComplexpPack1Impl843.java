...
public class ComplexpPack1Impl843 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl843.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl843 INSTANCE;

    public static ComplexpPack1Impl843 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl843();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl843(){
