...
public class BasepPack2Impl493 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl493.class);
    private static BasepPack2Impl493 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl493 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl493();
        }
        return INSTANCE;
    }

    private BasepPack2Impl493(){
