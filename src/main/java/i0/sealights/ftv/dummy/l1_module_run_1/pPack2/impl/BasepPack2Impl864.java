...
public class BasepPack2Impl864 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl864.class);
    private static BasepPack2Impl864 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl864 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl864();
        }
        return INSTANCE;
    }

    private BasepPack2Impl864(){
