...
public class ComplexpPack1Impl849 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl849.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl849 INSTANCE;

    public static ComplexpPack1Impl849 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl849();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl849(){
