...
public class ComplexpPack2Impl490 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl490.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl490 INSTANCE;

    public static ComplexpPack2Impl490 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl490();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl490(){
