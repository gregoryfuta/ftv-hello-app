...
public class ComplexpPack1Impl9 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl9.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl9 INSTANCE;

    public static ComplexpPack1Impl9 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl9();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl9(){
