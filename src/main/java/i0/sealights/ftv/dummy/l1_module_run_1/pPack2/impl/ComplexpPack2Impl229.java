...
public class ComplexpPack2Impl229 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl229.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl229 INSTANCE;

    public static ComplexpPack2Impl229 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl229();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl229(){
