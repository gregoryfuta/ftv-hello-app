...
public class ComplexpPack1Impl944 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl944.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl944 INSTANCE;

    public static ComplexpPack1Impl944 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl944();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl944(){
