...
public class BasepPack1Impl4 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl4.class);
    private static BasepPack1Impl4 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl4 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl4();
        }
        return INSTANCE;
    }

    private BasepPack1Impl4(){
