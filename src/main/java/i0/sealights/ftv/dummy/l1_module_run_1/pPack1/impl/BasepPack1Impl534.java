...
public class BasepPack1Impl534 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl534.class);
    private static BasepPack1Impl534 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl534 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl534();
        }
        return INSTANCE;
    }

    private BasepPack1Impl534(){
