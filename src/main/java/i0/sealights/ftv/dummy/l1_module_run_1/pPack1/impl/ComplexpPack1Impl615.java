...
public class ComplexpPack1Impl615 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl615.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl615 INSTANCE;

    public static ComplexpPack1Impl615 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl615();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl615(){
