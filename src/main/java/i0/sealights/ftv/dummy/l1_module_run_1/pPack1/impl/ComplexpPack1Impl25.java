...
public class ComplexpPack1Impl25 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl25.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl25 INSTANCE;

    public static ComplexpPack1Impl25 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl25();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl25(){
