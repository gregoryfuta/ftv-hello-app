...
public class ComplexpPack1Impl557 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl557.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl557 INSTANCE;

    public static ComplexpPack1Impl557 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl557();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl557(){
