...
public class ComplexpPack1Impl210 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl210.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl210 INSTANCE;

    public static ComplexpPack1Impl210 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl210();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl210(){
