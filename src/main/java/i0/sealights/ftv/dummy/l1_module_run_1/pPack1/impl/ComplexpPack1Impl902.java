...
public class ComplexpPack1Impl902 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl902.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl902 INSTANCE;

    public static ComplexpPack1Impl902 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl902();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl902(){
