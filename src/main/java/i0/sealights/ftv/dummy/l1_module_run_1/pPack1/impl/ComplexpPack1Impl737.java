...
public class ComplexpPack1Impl737 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl737.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl737 INSTANCE;

    public static ComplexpPack1Impl737 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl737();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl737(){
