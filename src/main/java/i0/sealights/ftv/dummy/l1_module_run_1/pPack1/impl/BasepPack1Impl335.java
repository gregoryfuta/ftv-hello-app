...
public class BasepPack1Impl335 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl335.class);
    private static BasepPack1Impl335 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl335 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl335();
        }
        return INSTANCE;
    }

    private BasepPack1Impl335(){
