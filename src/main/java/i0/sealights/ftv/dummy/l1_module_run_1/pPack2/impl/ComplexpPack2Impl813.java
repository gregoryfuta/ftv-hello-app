...
public class ComplexpPack2Impl813 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl813.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl813 INSTANCE;

    public static ComplexpPack2Impl813 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl813();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl813(){
