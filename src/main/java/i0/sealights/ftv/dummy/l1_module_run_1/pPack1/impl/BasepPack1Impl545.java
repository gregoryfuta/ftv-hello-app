...
public class BasepPack1Impl545 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl545.class);
    private static BasepPack1Impl545 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl545 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl545();
        }
        return INSTANCE;
    }

    private BasepPack1Impl545(){
