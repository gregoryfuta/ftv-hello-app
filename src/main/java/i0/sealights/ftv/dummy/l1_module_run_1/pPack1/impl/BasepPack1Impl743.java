...
public class BasepPack1Impl743 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl743.class);
    private static BasepPack1Impl743 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl743 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl743();
        }
        return INSTANCE;
    }

    private BasepPack1Impl743(){
