...
public class ComplexpPack1Impl640 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl640.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl640 INSTANCE;

    public static ComplexpPack1Impl640 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl640();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl640(){
