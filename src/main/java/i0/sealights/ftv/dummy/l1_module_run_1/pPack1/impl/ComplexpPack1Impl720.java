...
public class ComplexpPack1Impl720 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl720.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl720 INSTANCE;

    public static ComplexpPack1Impl720 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl720();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl720(){
