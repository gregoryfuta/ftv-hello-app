...
public class BasepPack1Impl645 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl645.class);
    private static BasepPack1Impl645 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl645 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl645();
        }
        return INSTANCE;
    }

    private BasepPack1Impl645(){
