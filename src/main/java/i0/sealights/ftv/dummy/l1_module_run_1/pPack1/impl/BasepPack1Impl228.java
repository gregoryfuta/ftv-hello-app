...
public class BasepPack1Impl228 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl228.class);
    private static BasepPack1Impl228 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl228 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl228();
        }
        return INSTANCE;
    }

    private BasepPack1Impl228(){
