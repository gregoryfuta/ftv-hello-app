...
public class BasepPack2Impl366 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl366.class);
    private static BasepPack2Impl366 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl366 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl366();
        }
        return INSTANCE;
    }

    private BasepPack2Impl366(){
