...
public class BasepPack2Impl796 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl796.class);
    private static BasepPack2Impl796 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl796 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl796();
        }
        return INSTANCE;
    }

    private BasepPack2Impl796(){
