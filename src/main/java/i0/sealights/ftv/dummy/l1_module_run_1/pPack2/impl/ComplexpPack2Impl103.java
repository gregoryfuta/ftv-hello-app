...
public class ComplexpPack2Impl103 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl103.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl103 INSTANCE;

    public static ComplexpPack2Impl103 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl103();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl103(){
