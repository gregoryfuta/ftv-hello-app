...
public class ComplexpPack2Impl52 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl52.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl52 INSTANCE;

    public static ComplexpPack2Impl52 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl52();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl52(){
