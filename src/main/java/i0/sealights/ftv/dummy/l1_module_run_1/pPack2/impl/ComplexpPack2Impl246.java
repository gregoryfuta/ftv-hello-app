...
public class ComplexpPack2Impl246 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl246.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl246 INSTANCE;

    public static ComplexpPack2Impl246 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl246();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl246(){
