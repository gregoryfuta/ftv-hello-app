...
public class BasepPack1Impl601 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl601.class);
    private static BasepPack1Impl601 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl601 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl601();
        }
        return INSTANCE;
    }

    private BasepPack1Impl601(){
