...
public class ComplexpPack2Impl299 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl299.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl299 INSTANCE;

    public static ComplexpPack2Impl299 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl299();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl299(){
