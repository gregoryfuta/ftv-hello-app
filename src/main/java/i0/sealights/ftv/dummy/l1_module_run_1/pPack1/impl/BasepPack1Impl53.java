...
public class BasepPack1Impl53 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl53.class);
    private static BasepPack1Impl53 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl53 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl53();
        }
        return INSTANCE;
    }

    private BasepPack1Impl53(){
