...
public class ComplexpPack2Impl431 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl431.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl431 INSTANCE;

    public static ComplexpPack2Impl431 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl431();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl431(){
