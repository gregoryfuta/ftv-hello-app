...
public class ComplexpPack1Impl171 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl171.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl171 INSTANCE;

    public static ComplexpPack1Impl171 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl171();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl171(){
