...
public class BasepPack1Impl916 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl916.class);
    private static BasepPack1Impl916 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl916 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl916();
        }
        return INSTANCE;
    }

    private BasepPack1Impl916(){
