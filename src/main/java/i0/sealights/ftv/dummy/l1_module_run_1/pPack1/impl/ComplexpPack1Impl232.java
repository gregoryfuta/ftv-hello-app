...
public class ComplexpPack1Impl232 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl232.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl232 INSTANCE;

    public static ComplexpPack1Impl232 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl232();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl232(){
