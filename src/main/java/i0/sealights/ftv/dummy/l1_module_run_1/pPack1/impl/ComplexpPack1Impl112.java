...
public class ComplexpPack1Impl112 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl112.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl112 INSTANCE;

    public static ComplexpPack1Impl112 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl112();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl112(){
