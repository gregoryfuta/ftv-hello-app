...
public class ComplexpPack1Impl882 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl882.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl882 INSTANCE;

    public static ComplexpPack1Impl882 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl882();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl882(){
