...
public class ComplexpPack1Impl179 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl179.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl179 INSTANCE;

    public static ComplexpPack1Impl179 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl179();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl179(){
