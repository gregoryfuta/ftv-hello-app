...
public class ComplexpPack1Impl662 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl662.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl662 INSTANCE;

    public static ComplexpPack1Impl662 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl662();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl662(){
