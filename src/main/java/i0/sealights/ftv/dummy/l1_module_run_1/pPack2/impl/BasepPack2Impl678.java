...
public class BasepPack2Impl678 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl678.class);
    private static BasepPack2Impl678 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl678 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl678();
        }
        return INSTANCE;
    }

    private BasepPack2Impl678(){
