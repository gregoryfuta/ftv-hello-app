...
public class ComplexpPack2Impl32 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl32.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl32 INSTANCE;

    public static ComplexpPack2Impl32 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl32();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl32(){
