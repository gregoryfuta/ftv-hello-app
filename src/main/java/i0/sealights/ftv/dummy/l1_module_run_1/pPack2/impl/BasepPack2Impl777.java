...
public class BasepPack2Impl777 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl777.class);
    private static BasepPack2Impl777 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl777 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl777();
        }
        return INSTANCE;
    }

    private BasepPack2Impl777(){
