...
public class BasepPack1Impl227 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl227.class);
    private static BasepPack1Impl227 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl227 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl227();
        }
        return INSTANCE;
    }

    private BasepPack1Impl227(){
