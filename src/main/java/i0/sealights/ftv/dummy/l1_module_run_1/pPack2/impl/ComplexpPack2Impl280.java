...
public class ComplexpPack2Impl280 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl280.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl280 INSTANCE;

    public static ComplexpPack2Impl280 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl280();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl280(){
