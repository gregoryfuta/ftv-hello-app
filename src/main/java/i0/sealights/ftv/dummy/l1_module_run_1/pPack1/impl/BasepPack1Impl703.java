...
public class BasepPack1Impl703 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl703.class);
    private static BasepPack1Impl703 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl703 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl703();
        }
        return INSTANCE;
    }

    private BasepPack1Impl703(){
