...
public class BasepPack1Impl586 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl586.class);
    private static BasepPack1Impl586 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl586 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl586();
        }
        return INSTANCE;
    }

    private BasepPack1Impl586(){
