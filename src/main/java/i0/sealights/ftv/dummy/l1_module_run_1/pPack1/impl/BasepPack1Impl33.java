...
public class BasepPack1Impl33 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl33.class);
    private static BasepPack1Impl33 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl33 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl33();
        }
        return INSTANCE;
    }

    private BasepPack1Impl33(){
