...
public class BasepPack2Impl950 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl950.class);
    private static BasepPack2Impl950 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl950 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl950();
        }
        return INSTANCE;
    }

    private BasepPack2Impl950(){
