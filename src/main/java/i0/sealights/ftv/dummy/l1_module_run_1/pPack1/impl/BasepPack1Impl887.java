...
public class BasepPack1Impl887 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl887.class);
    private static BasepPack1Impl887 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl887 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl887();
        }
        return INSTANCE;
    }

    private BasepPack1Impl887(){
