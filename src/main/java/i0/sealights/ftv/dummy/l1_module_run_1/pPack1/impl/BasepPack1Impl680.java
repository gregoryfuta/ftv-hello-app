...
public class BasepPack1Impl680 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl680.class);
    private static BasepPack1Impl680 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl680 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl680();
        }
        return INSTANCE;
    }

    private BasepPack1Impl680(){
