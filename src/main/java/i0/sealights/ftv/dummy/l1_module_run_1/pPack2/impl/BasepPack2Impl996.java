...
public class BasepPack2Impl996 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl996.class);
    private static BasepPack2Impl996 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl996 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl996();
        }
        return INSTANCE;
    }

    private BasepPack2Impl996(){
