...
public class BasepPack1Impl624 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl624.class);
    private static BasepPack1Impl624 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl624 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl624();
        }
        return INSTANCE;
    }

    private BasepPack1Impl624(){
