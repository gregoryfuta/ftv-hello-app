...
public class ComplexpPack2Impl92 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl92.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl92 INSTANCE;

    public static ComplexpPack2Impl92 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl92();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl92(){
