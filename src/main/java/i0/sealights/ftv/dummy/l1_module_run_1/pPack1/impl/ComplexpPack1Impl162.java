...
public class ComplexpPack1Impl162 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl162.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl162 INSTANCE;

    public static ComplexpPack1Impl162 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl162();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl162(){
