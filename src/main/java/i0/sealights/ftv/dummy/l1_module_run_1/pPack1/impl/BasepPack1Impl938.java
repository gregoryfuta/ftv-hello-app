...
public class BasepPack1Impl938 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl938.class);
    private static BasepPack1Impl938 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl938 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl938();
        }
        return INSTANCE;
    }

    private BasepPack1Impl938(){
