...
public class BasepPack1Impl110 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl110.class);
    private static BasepPack1Impl110 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl110 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl110();
        }
        return INSTANCE;
    }

    private BasepPack1Impl110(){
