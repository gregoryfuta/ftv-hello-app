...
public class ComplexpPack1Impl410 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl410.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl410 INSTANCE;

    public static ComplexpPack1Impl410 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl410();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl410(){
