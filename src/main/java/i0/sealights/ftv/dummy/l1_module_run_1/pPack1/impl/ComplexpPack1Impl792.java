...
public class ComplexpPack1Impl792 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl792.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl792 INSTANCE;

    public static ComplexpPack1Impl792 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl792();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl792(){
