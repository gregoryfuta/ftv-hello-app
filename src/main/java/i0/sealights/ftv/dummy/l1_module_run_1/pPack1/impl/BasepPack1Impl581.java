...
public class BasepPack1Impl581 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl581.class);
    private static BasepPack1Impl581 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl581 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl581();
        }
        return INSTANCE;
    }

    private BasepPack1Impl581(){
