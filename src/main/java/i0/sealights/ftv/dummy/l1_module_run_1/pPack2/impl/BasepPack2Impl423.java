...
public class BasepPack2Impl423 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl423.class);
    private static BasepPack2Impl423 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl423 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl423();
        }
        return INSTANCE;
    }

    private BasepPack2Impl423(){
