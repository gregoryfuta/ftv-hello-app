...
public class ComplexpPack2Impl592 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl592.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl592 INSTANCE;

    public static ComplexpPack2Impl592 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl592();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl592(){
