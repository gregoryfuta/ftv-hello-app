...
public class ComplexpPack1Impl211 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl211.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl211 INSTANCE;

    public static ComplexpPack1Impl211 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl211();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl211(){
