...
public class ComplexpPack1Impl70 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl70.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl70 INSTANCE;

    public static ComplexpPack1Impl70 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl70();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl70(){
