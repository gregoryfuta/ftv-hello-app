...
public class ComplexpPack1Impl909 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl909.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl909 INSTANCE;

    public static ComplexpPack1Impl909 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl909();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl909(){
