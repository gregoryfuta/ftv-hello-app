...
public class BasepPack2Impl602 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl602.class);
    private static BasepPack2Impl602 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl602 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl602();
        }
        return INSTANCE;
    }

    private BasepPack2Impl602(){
