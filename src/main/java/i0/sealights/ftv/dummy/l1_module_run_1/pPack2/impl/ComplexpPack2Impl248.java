...
public class ComplexpPack2Impl248 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl248.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl248 INSTANCE;

    public static ComplexpPack2Impl248 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl248();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl248(){
