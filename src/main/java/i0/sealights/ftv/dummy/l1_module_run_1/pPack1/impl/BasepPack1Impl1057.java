...
public class BasepPack1Impl1057 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1057.class);
    private static BasepPack1Impl1057 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1057 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1057();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1057(){
