...
public class BasepPack1Impl92 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl92.class);
    private static BasepPack1Impl92 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl92 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl92();
        }
        return INSTANCE;
    }

    private BasepPack1Impl92(){
