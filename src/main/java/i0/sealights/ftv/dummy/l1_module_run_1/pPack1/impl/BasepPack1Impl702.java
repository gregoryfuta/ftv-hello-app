...
public class BasepPack1Impl702 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl702.class);
    private static BasepPack1Impl702 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl702 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl702();
        }
        return INSTANCE;
    }

    private BasepPack1Impl702(){
