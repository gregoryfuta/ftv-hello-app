...
public class ComplexpPack2Impl944 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl944.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl944 INSTANCE;

    public static ComplexpPack2Impl944 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl944();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl944(){
