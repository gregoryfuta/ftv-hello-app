...
public class ComplexpPack2Impl945 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl945.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl945 INSTANCE;

    public static ComplexpPack2Impl945 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl945();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl945(){
