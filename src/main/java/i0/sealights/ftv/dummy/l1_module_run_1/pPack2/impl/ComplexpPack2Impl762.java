...
public class ComplexpPack2Impl762 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl762.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl762 INSTANCE;

    public static ComplexpPack2Impl762 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl762();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl762(){
