...
public class BasepPack2Impl115 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl115.class);
    private static BasepPack2Impl115 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl115 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl115();
        }
        return INSTANCE;
    }

    private BasepPack2Impl115(){
