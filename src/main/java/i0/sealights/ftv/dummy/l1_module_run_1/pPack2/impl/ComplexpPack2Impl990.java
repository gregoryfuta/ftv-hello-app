...
public class ComplexpPack2Impl990 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl990.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl990 INSTANCE;

    public static ComplexpPack2Impl990 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl990();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl990(){
