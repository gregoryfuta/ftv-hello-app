...
public class ComplexpPack2Impl57 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl57.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl57 INSTANCE;

    public static ComplexpPack2Impl57 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl57();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl57(){
