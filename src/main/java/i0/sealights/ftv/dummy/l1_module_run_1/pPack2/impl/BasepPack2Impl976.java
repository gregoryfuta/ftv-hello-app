...
public class BasepPack2Impl976 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl976.class);
    private static BasepPack2Impl976 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl976 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl976();
        }
        return INSTANCE;
    }

    private BasepPack2Impl976(){
