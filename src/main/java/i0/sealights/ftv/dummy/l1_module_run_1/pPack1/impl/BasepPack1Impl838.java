...
public class BasepPack1Impl838 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl838.class);
    private static BasepPack1Impl838 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl838 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl838();
        }
        return INSTANCE;
    }

    private BasepPack1Impl838(){
