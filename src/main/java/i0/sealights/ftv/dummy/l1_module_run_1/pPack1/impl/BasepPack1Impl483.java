...
public class BasepPack1Impl483 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl483.class);
    private static BasepPack1Impl483 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl483 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl483();
        }
        return INSTANCE;
    }

    private BasepPack1Impl483(){
