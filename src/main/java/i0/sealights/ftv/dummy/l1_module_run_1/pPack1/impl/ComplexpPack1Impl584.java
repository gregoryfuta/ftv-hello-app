...
public class ComplexpPack1Impl584 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl584.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl584 INSTANCE;

    public static ComplexpPack1Impl584 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl584();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl584(){
