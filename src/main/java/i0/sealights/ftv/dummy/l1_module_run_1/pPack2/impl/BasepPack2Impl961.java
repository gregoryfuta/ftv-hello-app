...
public class BasepPack2Impl961 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl961.class);
    private static BasepPack2Impl961 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl961 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl961();
        }
        return INSTANCE;
    }

    private BasepPack2Impl961(){
