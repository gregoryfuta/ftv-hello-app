...
public class BasepPack2Impl905 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl905.class);
    private static BasepPack2Impl905 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl905 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl905();
        }
        return INSTANCE;
    }

    private BasepPack2Impl905(){
