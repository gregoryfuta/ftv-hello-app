...
public class ComplexpPack2Impl953 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl953.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl953 INSTANCE;

    public static ComplexpPack2Impl953 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl953();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl953(){
