...
public class BasepPack1Impl426 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl426.class);
    private static BasepPack1Impl426 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl426 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl426();
        }
        return INSTANCE;
    }

    private BasepPack1Impl426(){
