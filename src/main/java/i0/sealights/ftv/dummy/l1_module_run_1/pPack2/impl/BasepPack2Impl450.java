...
public class BasepPack2Impl450 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl450.class);
    private static BasepPack2Impl450 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl450 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl450();
        }
        return INSTANCE;
    }

    private BasepPack2Impl450(){
