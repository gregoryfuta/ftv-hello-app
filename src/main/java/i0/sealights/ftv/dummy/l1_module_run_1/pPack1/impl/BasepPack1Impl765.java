...
public class BasepPack1Impl765 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl765.class);
    private static BasepPack1Impl765 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl765 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl765();
        }
        return INSTANCE;
    }

    private BasepPack1Impl765(){
