...
public class ComplexpPack1Impl398 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl398.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl398 INSTANCE;

    public static ComplexpPack1Impl398 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl398();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl398(){
