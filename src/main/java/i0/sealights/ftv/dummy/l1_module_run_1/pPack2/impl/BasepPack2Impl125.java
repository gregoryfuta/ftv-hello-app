...
public class BasepPack2Impl125 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl125.class);
    private static BasepPack2Impl125 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl125 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl125();
        }
        return INSTANCE;
    }

    private BasepPack2Impl125(){
