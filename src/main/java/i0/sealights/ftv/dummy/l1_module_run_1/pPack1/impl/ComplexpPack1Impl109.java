...
public class ComplexpPack1Impl109 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl109.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl109 INSTANCE;

    public static ComplexpPack1Impl109 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl109();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl109(){
