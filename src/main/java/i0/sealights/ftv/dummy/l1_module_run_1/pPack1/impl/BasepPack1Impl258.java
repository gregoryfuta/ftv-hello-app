...
public class BasepPack1Impl258 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl258.class);
    private static BasepPack1Impl258 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl258 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl258();
        }
        return INSTANCE;
    }

    private BasepPack1Impl258(){
