...
public class BasepPack2Impl321 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl321.class);
    private static BasepPack2Impl321 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl321 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl321();
        }
        return INSTANCE;
    }

    private BasepPack2Impl321(){
