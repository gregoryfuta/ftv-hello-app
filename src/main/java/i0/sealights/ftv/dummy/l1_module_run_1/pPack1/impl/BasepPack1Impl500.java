...
public class BasepPack1Impl500 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl500.class);
    private static BasepPack1Impl500 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl500 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl500();
        }
        return INSTANCE;
    }

    private BasepPack1Impl500(){
