...
public class BasepPack1Impl696 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl696.class);
    private static BasepPack1Impl696 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl696 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl696();
        }
        return INSTANCE;
    }

    private BasepPack1Impl696(){
