...
public class ComplexpPack1Impl655 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl655.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl655 INSTANCE;

    public static ComplexpPack1Impl655 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl655();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl655(){
