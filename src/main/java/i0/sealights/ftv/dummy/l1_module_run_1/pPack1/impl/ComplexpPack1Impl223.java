...
public class ComplexpPack1Impl223 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl223.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl223 INSTANCE;

    public static ComplexpPack1Impl223 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl223();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl223(){
