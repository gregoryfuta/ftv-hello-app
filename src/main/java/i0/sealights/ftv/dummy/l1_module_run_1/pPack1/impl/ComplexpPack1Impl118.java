...
public class ComplexpPack1Impl118 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl118.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl118 INSTANCE;

    public static ComplexpPack1Impl118 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl118();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl118(){
