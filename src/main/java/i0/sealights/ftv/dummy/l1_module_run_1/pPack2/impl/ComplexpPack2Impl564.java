...
public class ComplexpPack2Impl564 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl564.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl564 INSTANCE;

    public static ComplexpPack2Impl564 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl564();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl564(){
