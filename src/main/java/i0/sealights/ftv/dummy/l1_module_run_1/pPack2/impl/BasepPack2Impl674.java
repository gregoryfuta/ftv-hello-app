...
public class BasepPack2Impl674 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl674.class);
    private static BasepPack2Impl674 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl674 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl674();
        }
        return INSTANCE;
    }

    private BasepPack2Impl674(){
