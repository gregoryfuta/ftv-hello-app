...
public class BasepPack2Impl373 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl373.class);
    private static BasepPack2Impl373 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl373 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl373();
        }
        return INSTANCE;
    }

    private BasepPack2Impl373(){
