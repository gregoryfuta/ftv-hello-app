...
public class ComplexpPack1Impl167 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl167.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl167 INSTANCE;

    public static ComplexpPack1Impl167 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl167();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl167(){
