...
public class ComplexpPack2Impl621 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl621.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl621 INSTANCE;

    public static ComplexpPack2Impl621 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl621();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl621(){
