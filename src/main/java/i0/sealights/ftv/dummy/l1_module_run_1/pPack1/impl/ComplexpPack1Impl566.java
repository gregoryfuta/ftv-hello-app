...
public class ComplexpPack1Impl566 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl566.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl566 INSTANCE;

    public static ComplexpPack1Impl566 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl566();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl566(){
