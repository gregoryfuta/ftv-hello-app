...
public class ComplexpPack2Impl874 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl874.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl874 INSTANCE;

    public static ComplexpPack2Impl874 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl874();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl874(){
