...
public class BasepPack1Impl715 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl715.class);
    private static BasepPack1Impl715 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl715 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl715();
        }
        return INSTANCE;
    }

    private BasepPack1Impl715(){
