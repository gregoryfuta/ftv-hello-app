...
public class ComplexpPack2Impl972 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl972.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl972 INSTANCE;

    public static ComplexpPack2Impl972 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl972();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl972(){
