...
public class ComplexpPack2Impl131 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl131.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl131 INSTANCE;

    public static ComplexpPack2Impl131 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl131();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl131(){
