...
public class ComplexpPack2Impl958 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl958.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl958 INSTANCE;

    public static ComplexpPack2Impl958 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl958();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl958(){
