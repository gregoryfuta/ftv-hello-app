...
public class ComplexpPack1Impl729 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl729.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl729 INSTANCE;

    public static ComplexpPack1Impl729 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl729();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl729(){
