...
public class ComplexpPack2Impl668 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl668.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl668 INSTANCE;

    public static ComplexpPack2Impl668 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl668();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl668(){
