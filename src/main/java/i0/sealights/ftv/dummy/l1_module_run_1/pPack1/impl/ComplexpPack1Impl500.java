...
public class ComplexpPack1Impl500 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl500.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl500 INSTANCE;

    public static ComplexpPack1Impl500 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl500();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl500(){
