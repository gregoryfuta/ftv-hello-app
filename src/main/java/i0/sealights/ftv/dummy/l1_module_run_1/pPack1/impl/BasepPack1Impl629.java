...
public class BasepPack1Impl629 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl629.class);
    private static BasepPack1Impl629 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl629 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl629();
        }
        return INSTANCE;
    }

    private BasepPack1Impl629(){
