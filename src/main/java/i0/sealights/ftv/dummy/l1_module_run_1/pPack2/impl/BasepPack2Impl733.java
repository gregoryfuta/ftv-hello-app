...
public class BasepPack2Impl733 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl733.class);
    private static BasepPack2Impl733 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl733 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl733();
        }
        return INSTANCE;
    }

    private BasepPack2Impl733(){
