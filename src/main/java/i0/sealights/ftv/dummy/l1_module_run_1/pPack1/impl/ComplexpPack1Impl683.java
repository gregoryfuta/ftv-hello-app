...
public class ComplexpPack1Impl683 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl683.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl683 INSTANCE;

    public static ComplexpPack1Impl683 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl683();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl683(){
