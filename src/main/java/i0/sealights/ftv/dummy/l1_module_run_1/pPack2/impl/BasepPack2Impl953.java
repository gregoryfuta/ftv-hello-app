...
public class BasepPack2Impl953 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl953.class);
    private static BasepPack2Impl953 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl953 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl953();
        }
        return INSTANCE;
    }

    private BasepPack2Impl953(){
