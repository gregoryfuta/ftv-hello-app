...
public class BasepPack1Impl560 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl560.class);
    private static BasepPack1Impl560 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl560 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl560();
        }
        return INSTANCE;
    }

    private BasepPack1Impl560(){
