...
public class BasepPack1Impl686 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl686.class);
    private static BasepPack1Impl686 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl686 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl686();
        }
        return INSTANCE;
    }

    private BasepPack1Impl686(){
