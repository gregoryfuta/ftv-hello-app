...
public class ComplexpPack1Impl381 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl381.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl381 INSTANCE;

    public static ComplexpPack1Impl381 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl381();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl381(){
