...
public class BasepPack1Impl87 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl87.class);
    private static BasepPack1Impl87 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl87 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl87();
        }
        return INSTANCE;
    }

    private BasepPack1Impl87(){
