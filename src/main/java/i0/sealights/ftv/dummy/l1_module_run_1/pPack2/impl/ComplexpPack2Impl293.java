...
public class ComplexpPack2Impl293 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl293.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl293 INSTANCE;

    public static ComplexpPack2Impl293 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl293();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl293(){
