...
public class ComplexpPack1Impl769 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl769.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl769 INSTANCE;

    public static ComplexpPack1Impl769 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl769();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl769(){
