...
public class BasepPack1Impl453 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl453.class);
    private static BasepPack1Impl453 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl453 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl453();
        }
        return INSTANCE;
    }

    private BasepPack1Impl453(){
