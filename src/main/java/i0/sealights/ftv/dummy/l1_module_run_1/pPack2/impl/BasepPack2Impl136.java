...
public class BasepPack2Impl136 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl136.class);
    private static BasepPack2Impl136 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl136 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl136();
        }
        return INSTANCE;
    }

    private BasepPack2Impl136(){
