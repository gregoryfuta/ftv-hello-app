...
public class ComplexpPack2Impl483 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl483.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl483 INSTANCE;

    public static ComplexpPack2Impl483 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl483();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl483(){
