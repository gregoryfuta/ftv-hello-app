...
public class ComplexpPack2Impl233 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl233.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl233 INSTANCE;

    public static ComplexpPack2Impl233 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl233();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl233(){
