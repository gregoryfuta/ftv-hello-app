...
public class BasepPack2Impl535 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl535.class);
    private static BasepPack2Impl535 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl535 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl535();
        }
        return INSTANCE;
    }

    private BasepPack2Impl535(){
