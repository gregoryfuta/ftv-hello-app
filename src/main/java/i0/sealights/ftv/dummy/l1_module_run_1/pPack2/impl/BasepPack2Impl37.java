...
public class BasepPack2Impl37 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl37.class);
    private static BasepPack2Impl37 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl37 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl37();
        }
        return INSTANCE;
    }

    private BasepPack2Impl37(){
