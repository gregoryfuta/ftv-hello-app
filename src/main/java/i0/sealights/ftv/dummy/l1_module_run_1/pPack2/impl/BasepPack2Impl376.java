...
public class BasepPack2Impl376 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl376.class);
    private static BasepPack2Impl376 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl376 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl376();
        }
        return INSTANCE;
    }

    private BasepPack2Impl376(){
