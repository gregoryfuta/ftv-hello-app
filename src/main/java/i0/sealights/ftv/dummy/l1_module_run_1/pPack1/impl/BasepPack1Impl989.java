...
public class BasepPack1Impl989 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl989.class);
    private static BasepPack1Impl989 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl989 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl989();
        }
        return INSTANCE;
    }

    private BasepPack1Impl989(){
