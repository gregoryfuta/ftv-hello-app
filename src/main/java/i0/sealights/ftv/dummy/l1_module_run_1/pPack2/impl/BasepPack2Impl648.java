...
public class BasepPack2Impl648 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl648.class);
    private static BasepPack2Impl648 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl648 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl648();
        }
        return INSTANCE;
    }

    private BasepPack2Impl648(){
