...
public class ComplexpPack2Impl481 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl481.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl481 INSTANCE;

    public static ComplexpPack2Impl481 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl481();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl481(){
