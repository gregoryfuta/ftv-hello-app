...
public class BasepPack1Impl450 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl450.class);
    private static BasepPack1Impl450 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl450 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl450();
        }
        return INSTANCE;
    }

    private BasepPack1Impl450(){
