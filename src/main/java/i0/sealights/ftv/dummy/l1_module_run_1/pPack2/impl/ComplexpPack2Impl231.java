...
public class ComplexpPack2Impl231 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl231.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl231 INSTANCE;

    public static ComplexpPack2Impl231 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl231();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl231(){
