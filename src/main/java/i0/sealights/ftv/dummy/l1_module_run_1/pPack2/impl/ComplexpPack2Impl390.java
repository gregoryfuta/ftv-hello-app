...
public class ComplexpPack2Impl390 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl390.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl390 INSTANCE;

    public static ComplexpPack2Impl390 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl390();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl390(){
