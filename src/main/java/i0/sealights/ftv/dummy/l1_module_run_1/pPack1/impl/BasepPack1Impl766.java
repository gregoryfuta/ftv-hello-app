...
public class BasepPack1Impl766 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl766.class);
    private static BasepPack1Impl766 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl766 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl766();
        }
        return INSTANCE;
    }

    private BasepPack1Impl766(){
