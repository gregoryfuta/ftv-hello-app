...
public class BasepPack2Impl955 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl955.class);
    private static BasepPack2Impl955 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl955 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl955();
        }
        return INSTANCE;
    }

    private BasepPack2Impl955(){
