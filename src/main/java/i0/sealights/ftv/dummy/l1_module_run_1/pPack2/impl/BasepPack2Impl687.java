...
public class BasepPack2Impl687 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl687.class);
    private static BasepPack2Impl687 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl687 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl687();
        }
        return INSTANCE;
    }

    private BasepPack2Impl687(){
