...
public class BasepPack1Impl104 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl104.class);
    private static BasepPack1Impl104 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl104 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl104();
        }
        return INSTANCE;
    }

    private BasepPack1Impl104(){
