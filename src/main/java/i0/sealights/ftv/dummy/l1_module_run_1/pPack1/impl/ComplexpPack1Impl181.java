...
public class ComplexpPack1Impl181 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl181.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl181 INSTANCE;

    public static ComplexpPack1Impl181 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl181();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl181(){
