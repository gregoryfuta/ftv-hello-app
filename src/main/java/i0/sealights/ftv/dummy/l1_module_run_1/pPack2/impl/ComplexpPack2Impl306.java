...
public class ComplexpPack2Impl306 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl306.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl306 INSTANCE;

    public static ComplexpPack2Impl306 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl306();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl306(){
