...
public class BasepPack2Impl241 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl241.class);
    private static BasepPack2Impl241 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl241 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl241();
        }
        return INSTANCE;
    }

    private BasepPack2Impl241(){
