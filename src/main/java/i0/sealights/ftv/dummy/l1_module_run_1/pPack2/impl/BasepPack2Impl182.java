...
public class BasepPack2Impl182 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl182.class);
    private static BasepPack2Impl182 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl182 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl182();
        }
        return INSTANCE;
    }

    private BasepPack2Impl182(){
