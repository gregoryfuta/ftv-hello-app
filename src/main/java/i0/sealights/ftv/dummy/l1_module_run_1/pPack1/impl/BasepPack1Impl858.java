...
public class BasepPack1Impl858 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl858.class);
    private static BasepPack1Impl858 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl858 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl858();
        }
        return INSTANCE;
    }

    private BasepPack1Impl858(){
