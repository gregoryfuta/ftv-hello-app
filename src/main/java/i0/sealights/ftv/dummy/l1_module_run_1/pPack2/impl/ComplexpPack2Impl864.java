...
public class ComplexpPack2Impl864 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl864.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl864 INSTANCE;

    public static ComplexpPack2Impl864 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl864();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl864(){
