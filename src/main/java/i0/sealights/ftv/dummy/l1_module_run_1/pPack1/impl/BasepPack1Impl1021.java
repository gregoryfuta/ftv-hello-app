...
public class BasepPack1Impl1021 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1021.class);
    private static BasepPack1Impl1021 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1021 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1021();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1021(){
