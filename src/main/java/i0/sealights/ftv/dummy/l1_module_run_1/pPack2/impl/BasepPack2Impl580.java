...
public class BasepPack2Impl580 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl580.class);
    private static BasepPack2Impl580 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl580 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl580();
        }
        return INSTANCE;
    }

    private BasepPack2Impl580(){
