...
public class BasepPack2Impl361 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl361.class);
    private static BasepPack2Impl361 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl361 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl361();
        }
        return INSTANCE;
    }

    private BasepPack2Impl361(){
