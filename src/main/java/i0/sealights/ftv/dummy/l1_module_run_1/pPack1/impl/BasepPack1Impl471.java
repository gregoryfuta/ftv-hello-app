...
public class BasepPack1Impl471 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl471.class);
    private static BasepPack1Impl471 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl471 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl471();
        }
        return INSTANCE;
    }

    private BasepPack1Impl471(){
