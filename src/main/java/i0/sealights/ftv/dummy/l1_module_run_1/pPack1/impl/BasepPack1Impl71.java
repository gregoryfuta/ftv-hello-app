...
public class BasepPack1Impl71 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl71.class);
    private static BasepPack1Impl71 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl71 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl71();
        }
        return INSTANCE;
    }

    private BasepPack1Impl71(){
