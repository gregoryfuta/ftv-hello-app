...
public class BasepPack2Impl326 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl326.class);
    private static BasepPack2Impl326 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl326 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl326();
        }
        return INSTANCE;
    }

    private BasepPack2Impl326(){
