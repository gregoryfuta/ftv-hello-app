...
public class ComplexpPack2Impl971 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl971.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl971 INSTANCE;

    public static ComplexpPack2Impl971 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl971();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl971(){
