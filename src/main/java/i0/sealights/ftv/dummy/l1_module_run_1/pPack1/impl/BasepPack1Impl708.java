...
public class BasepPack1Impl708 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl708.class);
    private static BasepPack1Impl708 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl708 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl708();
        }
        return INSTANCE;
    }

    private BasepPack1Impl708(){
