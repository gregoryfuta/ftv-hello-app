...
public class ComplexpPack1Impl761 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl761.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl761 INSTANCE;

    public static ComplexpPack1Impl761 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl761();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl761(){
