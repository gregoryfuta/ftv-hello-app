...
public class ComplexpPack2Impl1005 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1005.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1005 INSTANCE;

    public static ComplexpPack2Impl1005 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1005();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1005(){
