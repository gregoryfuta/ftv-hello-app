...
public class ComplexpPack2Impl586 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl586.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl586 INSTANCE;

    public static ComplexpPack2Impl586 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl586();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl586(){
