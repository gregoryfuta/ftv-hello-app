...
public class BasepPack1Impl452 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl452.class);
    private static BasepPack1Impl452 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl452 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl452();
        }
        return INSTANCE;
    }

    private BasepPack1Impl452(){
