...
public class ComplexpPack2Impl1016 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1016.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1016 INSTANCE;

    public static ComplexpPack2Impl1016 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1016();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1016(){
