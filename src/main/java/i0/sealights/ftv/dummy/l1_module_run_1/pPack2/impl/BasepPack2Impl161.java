...
public class BasepPack2Impl161 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl161.class);
    private static BasepPack2Impl161 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl161 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl161();
        }
        return INSTANCE;
    }

    private BasepPack2Impl161(){
