...
public class ComplexpPack1Impl216 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl216.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl216 INSTANCE;

    public static ComplexpPack1Impl216 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl216();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl216(){
