...
public class BasepPack1Impl363 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl363.class);
    private static BasepPack1Impl363 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl363 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl363();
        }
        return INSTANCE;
    }

    private BasepPack1Impl363(){
