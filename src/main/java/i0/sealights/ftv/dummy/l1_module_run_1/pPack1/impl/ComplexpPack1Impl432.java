...
public class ComplexpPack1Impl432 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl432.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl432 INSTANCE;

    public static ComplexpPack1Impl432 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl432();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl432(){
