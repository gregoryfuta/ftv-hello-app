...
public class BasepPack2Impl661 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl661.class);
    private static BasepPack2Impl661 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl661 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl661();
        }
        return INSTANCE;
    }

    private BasepPack2Impl661(){
