...
public class ComplexpPack1Impl760 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl760.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl760 INSTANCE;

    public static ComplexpPack1Impl760 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl760();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl760(){
