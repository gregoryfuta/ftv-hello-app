...
public class BasepPack2Impl307 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl307.class);
    private static BasepPack2Impl307 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl307 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl307();
        }
        return INSTANCE;
    }

    private BasepPack2Impl307(){
