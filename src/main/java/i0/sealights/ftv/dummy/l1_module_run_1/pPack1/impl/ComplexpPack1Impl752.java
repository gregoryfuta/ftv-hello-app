...
public class ComplexpPack1Impl752 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl752.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl752 INSTANCE;

    public static ComplexpPack1Impl752 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl752();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl752(){
