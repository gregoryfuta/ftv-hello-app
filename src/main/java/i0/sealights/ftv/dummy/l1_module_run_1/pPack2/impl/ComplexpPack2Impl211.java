...
public class ComplexpPack2Impl211 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl211.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl211 INSTANCE;

    public static ComplexpPack2Impl211 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl211();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl211(){
