...
public class BasepPack1Impl498 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl498.class);
    private static BasepPack1Impl498 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl498 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl498();
        }
        return INSTANCE;
    }

    private BasepPack1Impl498(){
