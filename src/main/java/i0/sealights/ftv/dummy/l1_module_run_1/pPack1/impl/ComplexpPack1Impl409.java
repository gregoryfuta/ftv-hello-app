...
public class ComplexpPack1Impl409 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl409.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl409 INSTANCE;

    public static ComplexpPack1Impl409 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl409();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl409(){
