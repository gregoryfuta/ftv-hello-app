...
public class ComplexpPack2Impl207 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl207.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl207 INSTANCE;

    public static ComplexpPack2Impl207 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl207();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl207(){
