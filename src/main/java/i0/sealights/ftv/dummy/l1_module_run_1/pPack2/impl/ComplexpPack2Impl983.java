...
public class ComplexpPack2Impl983 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl983.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl983 INSTANCE;

    public static ComplexpPack2Impl983 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl983();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl983(){
