...
public class BasepPack1Impl514 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl514.class);
    private static BasepPack1Impl514 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl514 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl514();
        }
        return INSTANCE;
    }

    private BasepPack1Impl514(){
