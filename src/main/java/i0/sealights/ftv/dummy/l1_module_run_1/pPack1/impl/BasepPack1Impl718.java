...
public class BasepPack1Impl718 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl718.class);
    private static BasepPack1Impl718 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl718 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl718();
        }
        return INSTANCE;
    }

    private BasepPack1Impl718(){
