...
public class BasepPack1Impl96 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl96.class);
    private static BasepPack1Impl96 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl96 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl96();
        }
        return INSTANCE;
    }

    private BasepPack1Impl96(){
