...
public class ComplexpPack1Impl155 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl155.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl155 INSTANCE;

    public static ComplexpPack1Impl155 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl155();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl155(){
