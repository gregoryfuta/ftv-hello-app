...
public class ComplexpPack2Impl252 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl252.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl252 INSTANCE;

    public static ComplexpPack2Impl252 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl252();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl252(){
