...
public class ComplexpPack1Impl374 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl374.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl374 INSTANCE;

    public static ComplexpPack1Impl374 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl374();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl374(){
