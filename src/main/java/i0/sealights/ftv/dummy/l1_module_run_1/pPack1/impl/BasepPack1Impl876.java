...
public class BasepPack1Impl876 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl876.class);
    private static BasepPack1Impl876 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl876 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl876();
        }
        return INSTANCE;
    }

    private BasepPack1Impl876(){
