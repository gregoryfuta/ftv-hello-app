...
public class ComplexpPack2Impl186 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl186.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl186 INSTANCE;

    public static ComplexpPack2Impl186 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl186();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl186(){
