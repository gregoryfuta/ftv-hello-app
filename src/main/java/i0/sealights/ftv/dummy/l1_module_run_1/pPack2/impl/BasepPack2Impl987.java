...
public class BasepPack2Impl987 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl987.class);
    private static BasepPack2Impl987 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl987 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl987();
        }
        return INSTANCE;
    }

    private BasepPack2Impl987(){
