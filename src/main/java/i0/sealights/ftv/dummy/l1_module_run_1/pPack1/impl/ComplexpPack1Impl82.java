...
public class ComplexpPack1Impl82 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl82.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl82 INSTANCE;

    public static ComplexpPack1Impl82 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl82();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl82(){
