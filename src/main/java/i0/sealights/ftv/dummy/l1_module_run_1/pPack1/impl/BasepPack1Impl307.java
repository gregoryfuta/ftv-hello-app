...
public class BasepPack1Impl307 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl307.class);
    private static BasepPack1Impl307 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl307 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl307();
        }
        return INSTANCE;
    }

    private BasepPack1Impl307(){
