...
public class ComplexpPack2Impl698 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl698.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl698 INSTANCE;

    public static ComplexpPack2Impl698 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl698();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl698(){
