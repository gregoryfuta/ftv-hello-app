...
public class BasepPack1Impl717 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl717.class);
    private static BasepPack1Impl717 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl717 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl717();
        }
        return INSTANCE;
    }

    private BasepPack1Impl717(){
