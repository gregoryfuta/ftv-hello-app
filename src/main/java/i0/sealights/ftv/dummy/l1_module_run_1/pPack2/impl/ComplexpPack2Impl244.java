...
public class ComplexpPack2Impl244 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl244.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl244 INSTANCE;

    public static ComplexpPack2Impl244 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl244();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl244(){
