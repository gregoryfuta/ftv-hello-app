...
public class ComplexpPack2Impl803 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl803.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl803 INSTANCE;

    public static ComplexpPack2Impl803 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl803();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl803(){
