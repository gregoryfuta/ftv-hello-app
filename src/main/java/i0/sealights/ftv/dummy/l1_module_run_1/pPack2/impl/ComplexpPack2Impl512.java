...
public class ComplexpPack2Impl512 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl512.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl512 INSTANCE;

    public static ComplexpPack2Impl512 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl512();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl512(){
