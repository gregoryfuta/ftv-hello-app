...
public class ComplexpPack1Impl885 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl885.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl885 INSTANCE;

    public static ComplexpPack1Impl885 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl885();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl885(){
