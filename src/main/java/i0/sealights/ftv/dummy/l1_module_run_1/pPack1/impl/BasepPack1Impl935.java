...
public class BasepPack1Impl935 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl935.class);
    private static BasepPack1Impl935 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl935 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl935();
        }
        return INSTANCE;
    }

    private BasepPack1Impl935(){
