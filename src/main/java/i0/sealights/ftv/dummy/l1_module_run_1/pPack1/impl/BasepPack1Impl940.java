...
public class BasepPack1Impl940 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl940.class);
    private static BasepPack1Impl940 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl940 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl940();
        }
        return INSTANCE;
    }

    private BasepPack1Impl940(){
