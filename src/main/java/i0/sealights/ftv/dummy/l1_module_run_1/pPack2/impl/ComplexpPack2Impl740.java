...
public class ComplexpPack2Impl740 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl740.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl740 INSTANCE;

    public static ComplexpPack2Impl740 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl740();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl740(){
