...
public class BasepPack2Impl22 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl22.class);
    private static BasepPack2Impl22 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl22 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl22();
        }
        return INSTANCE;
    }

    private BasepPack2Impl22(){
