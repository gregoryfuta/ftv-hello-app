...
public class ComplexpPack1Impl718 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl718.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl718 INSTANCE;

    public static ComplexpPack1Impl718 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl718();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl718(){
