...
public class BasepPack1Impl19 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl19.class);
    private static BasepPack1Impl19 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl19 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl19();
        }
        return INSTANCE;
    }

    private BasepPack1Impl19(){
