...
public class BasepPack2Impl739 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl739.class);
    private static BasepPack2Impl739 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl739 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl739();
        }
        return INSTANCE;
    }

    private BasepPack2Impl739(){
