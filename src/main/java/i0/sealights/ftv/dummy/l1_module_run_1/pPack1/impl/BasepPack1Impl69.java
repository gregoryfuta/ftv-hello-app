...
public class BasepPack1Impl69 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl69.class);
    private static BasepPack1Impl69 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl69 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl69();
        }
        return INSTANCE;
    }

    private BasepPack1Impl69(){
