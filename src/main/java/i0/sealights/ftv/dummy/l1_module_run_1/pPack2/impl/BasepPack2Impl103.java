...
public class BasepPack2Impl103 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl103.class);
    private static BasepPack2Impl103 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl103 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl103();
        }
        return INSTANCE;
    }

    private BasepPack2Impl103(){
