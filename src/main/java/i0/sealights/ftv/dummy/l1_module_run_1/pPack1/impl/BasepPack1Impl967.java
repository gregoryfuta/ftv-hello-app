...
public class BasepPack1Impl967 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl967.class);
    private static BasepPack1Impl967 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl967 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl967();
        }
        return INSTANCE;
    }

    private BasepPack1Impl967(){
