...
public class BasepPack2Impl713 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl713.class);
    private static BasepPack2Impl713 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl713 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl713();
        }
        return INSTANCE;
    }

    private BasepPack2Impl713(){
