...
public class BasepPack1Impl77 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl77.class);
    private static BasepPack1Impl77 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl77 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl77();
        }
        return INSTANCE;
    }

    private BasepPack1Impl77(){
