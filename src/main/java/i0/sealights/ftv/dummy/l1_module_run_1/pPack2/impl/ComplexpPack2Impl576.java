...
public class ComplexpPack2Impl576 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl576.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl576 INSTANCE;

    public static ComplexpPack2Impl576 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl576();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl576(){
