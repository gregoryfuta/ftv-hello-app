...
public class BasepPack1Impl306 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl306.class);
    private static BasepPack1Impl306 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl306 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl306();
        }
        return INSTANCE;
    }

    private BasepPack1Impl306(){
