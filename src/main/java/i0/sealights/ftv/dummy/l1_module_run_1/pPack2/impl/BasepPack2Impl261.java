...
public class BasepPack2Impl261 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl261.class);
    private static BasepPack2Impl261 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl261 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl261();
        }
        return INSTANCE;
    }

    private BasepPack2Impl261(){
