...
public class BasepPack2Impl638 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl638.class);
    private static BasepPack2Impl638 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl638 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl638();
        }
        return INSTANCE;
    }

    private BasepPack2Impl638(){
