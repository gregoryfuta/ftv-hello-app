...
public class BasepPack1Impl806 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl806.class);
    private static BasepPack1Impl806 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl806 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl806();
        }
        return INSTANCE;
    }

    private BasepPack1Impl806(){
