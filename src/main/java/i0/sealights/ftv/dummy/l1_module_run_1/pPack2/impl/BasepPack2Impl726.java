...
public class BasepPack2Impl726 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl726.class);
    private static BasepPack2Impl726 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl726 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl726();
        }
        return INSTANCE;
    }

    private BasepPack2Impl726(){
