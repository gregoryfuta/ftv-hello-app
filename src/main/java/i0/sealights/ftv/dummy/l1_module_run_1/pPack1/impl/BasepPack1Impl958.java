...
public class BasepPack1Impl958 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl958.class);
    private static BasepPack1Impl958 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl958 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl958();
        }
        return INSTANCE;
    }

    private BasepPack1Impl958(){
