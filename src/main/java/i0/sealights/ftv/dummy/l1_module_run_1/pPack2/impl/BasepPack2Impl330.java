...
public class BasepPack2Impl330 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl330.class);
    private static BasepPack2Impl330 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl330 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl330();
        }
        return INSTANCE;
    }

    private BasepPack2Impl330(){
