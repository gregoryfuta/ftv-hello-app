...
public class ComplexpPack1Impl471 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl471.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl471 INSTANCE;

    public static ComplexpPack1Impl471 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl471();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl471(){
