...
public class ComplexpPack2Impl549 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl549.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl549 INSTANCE;

    public static ComplexpPack2Impl549 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl549();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl549(){
