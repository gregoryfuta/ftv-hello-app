...
public class BasepPack1Impl578 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl578.class);
    private static BasepPack1Impl578 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl578 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl578();
        }
        return INSTANCE;
    }

    private BasepPack1Impl578(){
