...
public class ComplexpPack1Impl542 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl542.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl542 INSTANCE;

    public static ComplexpPack1Impl542 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl542();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl542(){
