...
public class ComplexpPack2Impl680 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl680.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl680 INSTANCE;

    public static ComplexpPack2Impl680 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl680();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl680(){
