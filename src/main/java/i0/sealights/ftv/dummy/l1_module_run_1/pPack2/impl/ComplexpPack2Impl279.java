...
public class ComplexpPack2Impl279 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl279.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl279 INSTANCE;

    public static ComplexpPack2Impl279 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl279();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl279(){
