...
public class ComplexpPack2Impl572 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl572.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl572 INSTANCE;

    public static ComplexpPack2Impl572 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl572();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl572(){
