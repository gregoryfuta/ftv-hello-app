...
public class BasepPack2Impl754 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl754.class);
    private static BasepPack2Impl754 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl754 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl754();
        }
        return INSTANCE;
    }

    private BasepPack2Impl754(){
