...
public class BasepPack2Impl176 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl176.class);
    private static BasepPack2Impl176 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl176 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl176();
        }
        return INSTANCE;
    }

    private BasepPack2Impl176(){
