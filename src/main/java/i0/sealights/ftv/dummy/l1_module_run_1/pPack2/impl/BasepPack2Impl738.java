...
public class BasepPack2Impl738 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl738.class);
    private static BasepPack2Impl738 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl738 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl738();
        }
        return INSTANCE;
    }

    private BasepPack2Impl738(){
