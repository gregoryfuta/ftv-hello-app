...
public class BasepPack1Impl330 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl330.class);
    private static BasepPack1Impl330 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl330 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl330();
        }
        return INSTANCE;
    }

    private BasepPack1Impl330(){
