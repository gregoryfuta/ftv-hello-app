...
public class ComplexpPack2Impl715 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl715.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl715 INSTANCE;

    public static ComplexpPack2Impl715 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl715();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl715(){
