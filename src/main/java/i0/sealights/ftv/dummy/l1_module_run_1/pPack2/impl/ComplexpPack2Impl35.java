...
public class ComplexpPack2Impl35 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl35.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl35 INSTANCE;

    public static ComplexpPack2Impl35 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl35();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl35(){
