...
public class ComplexpPack1Impl934 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl934.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl934 INSTANCE;

    public static ComplexpPack1Impl934 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl934();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl934(){
