...
public class BasepPack2Impl942 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl942.class);
    private static BasepPack2Impl942 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl942 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl942();
        }
        return INSTANCE;
    }

    private BasepPack2Impl942(){
