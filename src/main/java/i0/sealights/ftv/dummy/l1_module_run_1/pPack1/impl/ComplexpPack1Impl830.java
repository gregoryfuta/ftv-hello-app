...
public class ComplexpPack1Impl830 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl830.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl830 INSTANCE;

    public static ComplexpPack1Impl830 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl830();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl830(){
