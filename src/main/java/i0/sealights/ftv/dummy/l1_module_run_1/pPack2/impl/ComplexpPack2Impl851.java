...
public class ComplexpPack2Impl851 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl851.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl851 INSTANCE;

    public static ComplexpPack2Impl851 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl851();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl851(){
