...
public class BasepPack2Impl105 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl105.class);
    private static BasepPack2Impl105 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl105 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl105();
        }
        return INSTANCE;
    }

    private BasepPack2Impl105(){
