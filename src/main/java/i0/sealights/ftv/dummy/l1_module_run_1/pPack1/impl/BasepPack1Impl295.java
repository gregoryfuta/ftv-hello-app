...
public class BasepPack1Impl295 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl295.class);
    private static BasepPack1Impl295 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl295 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl295();
        }
        return INSTANCE;
    }

    private BasepPack1Impl295(){
