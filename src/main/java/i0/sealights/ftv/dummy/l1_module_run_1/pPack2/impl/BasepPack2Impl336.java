...
public class BasepPack2Impl336 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl336.class);
    private static BasepPack2Impl336 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl336 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl336();
        }
        return INSTANCE;
    }

    private BasepPack2Impl336(){
