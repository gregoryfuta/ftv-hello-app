...
public class ComplexpPack1Impl595 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl595.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl595 INSTANCE;

    public static ComplexpPack1Impl595 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl595();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl595(){
