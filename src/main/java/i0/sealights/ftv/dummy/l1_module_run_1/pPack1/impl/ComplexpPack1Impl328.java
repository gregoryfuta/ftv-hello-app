...
public class ComplexpPack1Impl328 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl328.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl328 INSTANCE;

    public static ComplexpPack1Impl328 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl328();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl328(){
