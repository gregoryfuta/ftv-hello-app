...
public class BasepPack1Impl982 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl982.class);
    private static BasepPack1Impl982 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl982 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl982();
        }
        return INSTANCE;
    }

    private BasepPack1Impl982(){
