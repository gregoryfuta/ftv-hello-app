...
public class ComplexpPack2Impl506 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl506.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl506 INSTANCE;

    public static ComplexpPack2Impl506 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl506();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl506(){
