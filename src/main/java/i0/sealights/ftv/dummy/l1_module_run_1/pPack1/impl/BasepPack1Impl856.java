...
public class BasepPack1Impl856 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl856.class);
    private static BasepPack1Impl856 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl856 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl856();
        }
        return INSTANCE;
    }

    private BasepPack1Impl856(){
