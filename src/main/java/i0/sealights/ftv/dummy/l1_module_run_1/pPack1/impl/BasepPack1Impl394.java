...
public class BasepPack1Impl394 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl394.class);
    private static BasepPack1Impl394 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl394 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl394();
        }
        return INSTANCE;
    }

    private BasepPack1Impl394(){
