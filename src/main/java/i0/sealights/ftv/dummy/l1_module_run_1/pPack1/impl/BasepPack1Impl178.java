...
public class BasepPack1Impl178 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl178.class);
    private static BasepPack1Impl178 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl178 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl178();
        }
        return INSTANCE;
    }

    private BasepPack1Impl178(){
