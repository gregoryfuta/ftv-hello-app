...
public class BasepPack2Impl365 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl365.class);
    private static BasepPack2Impl365 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl365 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl365();
        }
        return INSTANCE;
    }

    private BasepPack2Impl365(){
