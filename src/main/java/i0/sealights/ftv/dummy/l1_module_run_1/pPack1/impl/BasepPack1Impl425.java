...
public class BasepPack1Impl425 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl425.class);
    private static BasepPack1Impl425 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl425 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl425();
        }
        return INSTANCE;
    }

    private BasepPack1Impl425(){
