...
public class ComplexpPack1Impl90 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl90.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl90 INSTANCE;

    public static ComplexpPack1Impl90 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl90();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl90(){
