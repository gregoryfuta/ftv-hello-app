...
public class BasepPack2Impl212 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl212.class);
    private static BasepPack2Impl212 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl212 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl212();
        }
        return INSTANCE;
    }

    private BasepPack2Impl212(){
