...
public class BasepPack1Impl50 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl50.class);
    private static BasepPack1Impl50 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl50 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl50();
        }
        return INSTANCE;
    }

    private BasepPack1Impl50(){
