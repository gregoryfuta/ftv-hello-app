...
public class ComplexpPack2Impl695 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl695.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl695 INSTANCE;

    public static ComplexpPack2Impl695 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl695();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl695(){
