...
public class BasepPack1Impl241 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl241.class);
    private static BasepPack1Impl241 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl241 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl241();
        }
        return INSTANCE;
    }

    private BasepPack1Impl241(){
