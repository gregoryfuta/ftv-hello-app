...
public class BasepPack1Impl849 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl849.class);
    private static BasepPack1Impl849 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl849 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl849();
        }
        return INSTANCE;
    }

    private BasepPack1Impl849(){
