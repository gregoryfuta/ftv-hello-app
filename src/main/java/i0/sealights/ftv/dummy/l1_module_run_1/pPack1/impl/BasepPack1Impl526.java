...
public class BasepPack1Impl526 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl526.class);
    private static BasepPack1Impl526 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl526 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl526();
        }
        return INSTANCE;
    }

    private BasepPack1Impl526(){
