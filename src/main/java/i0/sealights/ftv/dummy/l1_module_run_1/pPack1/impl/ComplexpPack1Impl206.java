...
public class ComplexpPack1Impl206 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl206.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl206 INSTANCE;

    public static ComplexpPack1Impl206 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl206();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl206(){
