...
public class BasepPack1Impl755 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl755.class);
    private static BasepPack1Impl755 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl755 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl755();
        }
        return INSTANCE;
    }

    private BasepPack1Impl755(){
