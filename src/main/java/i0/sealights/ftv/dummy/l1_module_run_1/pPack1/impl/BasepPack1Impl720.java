...
public class BasepPack1Impl720 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl720.class);
    private static BasepPack1Impl720 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl720 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl720();
        }
        return INSTANCE;
    }

    private BasepPack1Impl720(){
