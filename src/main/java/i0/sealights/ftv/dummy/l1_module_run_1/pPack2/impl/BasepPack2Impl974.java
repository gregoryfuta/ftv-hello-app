...
public class BasepPack2Impl974 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl974.class);
    private static BasepPack2Impl974 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl974 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl974();
        }
        return INSTANCE;
    }

    private BasepPack2Impl974(){
