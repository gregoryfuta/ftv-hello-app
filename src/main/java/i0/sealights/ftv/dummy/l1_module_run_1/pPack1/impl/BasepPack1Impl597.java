...
public class BasepPack1Impl597 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl597.class);
    private static BasepPack1Impl597 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl597 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl597();
        }
        return INSTANCE;
    }

    private BasepPack1Impl597(){
