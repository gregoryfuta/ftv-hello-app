...
public class BasepPack2Impl317 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl317.class);
    private static BasepPack2Impl317 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl317 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl317();
        }
        return INSTANCE;
    }

    private BasepPack2Impl317(){
