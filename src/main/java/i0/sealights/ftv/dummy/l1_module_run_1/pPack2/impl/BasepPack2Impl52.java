...
public class BasepPack2Impl52 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl52.class);
    private static BasepPack2Impl52 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl52 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl52();
        }
        return INSTANCE;
    }

    private BasepPack2Impl52(){
