...
public class ComplexpPack2Impl703 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl703.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl703 INSTANCE;

    public static ComplexpPack2Impl703 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl703();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl703(){
