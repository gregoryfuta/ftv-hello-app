...
public class ComplexpPack1Impl602 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl602.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl602 INSTANCE;

    public static ComplexpPack1Impl602 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl602();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl602(){
