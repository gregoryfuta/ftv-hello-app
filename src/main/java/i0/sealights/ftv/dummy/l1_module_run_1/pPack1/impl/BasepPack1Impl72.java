...
public class BasepPack1Impl72 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl72.class);
    private static BasepPack1Impl72 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl72 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl72();
        }
        return INSTANCE;
    }

    private BasepPack1Impl72(){
