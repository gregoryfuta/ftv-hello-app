...
public class BasepPack1Impl115 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl115.class);
    private static BasepPack1Impl115 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl115 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl115();
        }
        return INSTANCE;
    }

    private BasepPack1Impl115(){
