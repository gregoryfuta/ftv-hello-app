...
public class ComplexpPack2Impl38 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl38.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl38 INSTANCE;

    public static ComplexpPack2Impl38 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl38();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl38(){
