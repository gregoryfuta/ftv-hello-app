...
public class ComplexpPack2Impl151 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl151.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl151 INSTANCE;

    public static ComplexpPack2Impl151 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl151();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl151(){
