...
public class ComplexpPack2Impl159 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl159.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl159 INSTANCE;

    public static ComplexpPack2Impl159 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl159();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl159(){
