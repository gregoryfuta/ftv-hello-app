...
public class ComplexpPack2Impl182 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl182.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl182 INSTANCE;

    public static ComplexpPack2Impl182 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl182();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl182(){
