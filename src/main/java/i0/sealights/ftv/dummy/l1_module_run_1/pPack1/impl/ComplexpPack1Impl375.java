...
public class ComplexpPack1Impl375 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl375.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl375 INSTANCE;

    public static ComplexpPack1Impl375 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl375();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl375(){
