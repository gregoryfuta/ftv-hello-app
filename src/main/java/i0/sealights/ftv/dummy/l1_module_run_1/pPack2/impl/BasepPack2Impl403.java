...
public class BasepPack2Impl403 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl403.class);
    private static BasepPack2Impl403 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl403 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl403();
        }
        return INSTANCE;
    }

    private BasepPack2Impl403(){
