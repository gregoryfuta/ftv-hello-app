...
public class ComplexpPack1Impl116 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl116.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl116 INSTANCE;

    public static ComplexpPack1Impl116 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl116();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl116(){
