...
public class BasepPack1Impl563 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl563.class);
    private static BasepPack1Impl563 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl563 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl563();
        }
        return INSTANCE;
    }

    private BasepPack1Impl563(){
