...
public class BasepPack2Impl957 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl957.class);
    private static BasepPack2Impl957 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl957 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl957();
        }
        return INSTANCE;
    }

    private BasepPack2Impl957(){
