...
public class BasepPack1Impl252 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl252.class);
    private static BasepPack1Impl252 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl252 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl252();
        }
        return INSTANCE;
    }

    private BasepPack1Impl252(){
