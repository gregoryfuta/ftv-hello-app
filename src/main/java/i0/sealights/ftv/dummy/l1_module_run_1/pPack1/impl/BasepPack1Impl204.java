...
public class BasepPack1Impl204 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl204.class);
    private static BasepPack1Impl204 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl204 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl204();
        }
        return INSTANCE;
    }

    private BasepPack1Impl204(){
