...
public class BasepPack2Impl763 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl763.class);
    private static BasepPack2Impl763 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl763 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl763();
        }
        return INSTANCE;
    }

    private BasepPack2Impl763(){
