...
public class ComplexpPack1Impl643 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl643.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl643 INSTANCE;

    public static ComplexpPack1Impl643 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl643();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl643(){
