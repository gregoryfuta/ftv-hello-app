...
public class BasepPack2Impl432 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl432.class);
    private static BasepPack2Impl432 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl432 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl432();
        }
        return INSTANCE;
    }

    private BasepPack2Impl432(){
