...
public class BasepPack2Impl615 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl615.class);
    private static BasepPack2Impl615 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl615 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl615();
        }
        return INSTANCE;
    }

    private BasepPack2Impl615(){
