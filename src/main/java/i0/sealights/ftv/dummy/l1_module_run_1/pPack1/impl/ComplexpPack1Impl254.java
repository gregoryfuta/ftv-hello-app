...
public class ComplexpPack1Impl254 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl254.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl254 INSTANCE;

    public static ComplexpPack1Impl254 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl254();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl254(){
