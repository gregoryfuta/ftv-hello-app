...
public class ComplexpPack2Impl795 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl795.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl795 INSTANCE;

    public static ComplexpPack2Impl795 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl795();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl795(){
