...
public class BasepPack2Impl197 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl197.class);
    private static BasepPack2Impl197 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl197 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl197();
        }
        return INSTANCE;
    }

    private BasepPack2Impl197(){
