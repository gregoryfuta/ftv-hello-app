...
public class BasepPack2Impl188 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl188.class);
    private static BasepPack2Impl188 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl188 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl188();
        }
        return INSTANCE;
    }

    private BasepPack2Impl188(){
