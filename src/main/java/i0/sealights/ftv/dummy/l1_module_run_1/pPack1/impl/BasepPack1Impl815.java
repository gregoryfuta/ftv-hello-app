...
public class BasepPack1Impl815 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl815.class);
    private static BasepPack1Impl815 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl815 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl815();
        }
        return INSTANCE;
    }

    private BasepPack1Impl815(){
