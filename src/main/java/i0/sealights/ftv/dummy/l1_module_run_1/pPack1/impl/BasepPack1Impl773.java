...
public class BasepPack1Impl773 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl773.class);
    private static BasepPack1Impl773 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl773 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl773();
        }
        return INSTANCE;
    }

    private BasepPack1Impl773(){
