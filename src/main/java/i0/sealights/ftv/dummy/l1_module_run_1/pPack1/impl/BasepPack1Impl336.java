...
public class BasepPack1Impl336 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl336.class);
    private static BasepPack1Impl336 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl336 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl336();
        }
        return INSTANCE;
    }

    private BasepPack1Impl336(){
