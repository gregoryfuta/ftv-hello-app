...
public class BasepPack2Impl618 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl618.class);
    private static BasepPack2Impl618 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl618 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl618();
        }
        return INSTANCE;
    }

    private BasepPack2Impl618(){
