...
public class ComplexpPack1Impl869 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl869.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl869 INSTANCE;

    public static ComplexpPack1Impl869 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl869();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl869(){
