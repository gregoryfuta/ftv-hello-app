...
public class ComplexpPack2Impl498 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl498.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl498 INSTANCE;

    public static ComplexpPack2Impl498 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl498();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl498(){
