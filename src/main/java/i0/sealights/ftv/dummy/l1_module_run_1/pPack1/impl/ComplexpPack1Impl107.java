...
public class ComplexpPack1Impl107 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl107.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl107 INSTANCE;

    public static ComplexpPack1Impl107 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl107();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl107(){
