...
public class ComplexpPack1Impl774 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl774.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl774 INSTANCE;

    public static ComplexpPack1Impl774 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl774();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl774(){
