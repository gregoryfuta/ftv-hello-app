...
public class ComplexpPack1Impl841 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl841.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl841 INSTANCE;

    public static ComplexpPack1Impl841 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl841();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl841(){
