...
public class ComplexpPack2Impl701 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl701.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl701 INSTANCE;

    public static ComplexpPack2Impl701 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl701();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl701(){
