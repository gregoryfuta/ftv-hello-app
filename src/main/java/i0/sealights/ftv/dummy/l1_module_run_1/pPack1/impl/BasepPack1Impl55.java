...
public class BasepPack1Impl55 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl55.class);
    private static BasepPack1Impl55 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl55 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl55();
        }
        return INSTANCE;
    }

    private BasepPack1Impl55(){
