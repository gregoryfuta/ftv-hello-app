...
public class ComplexpPack2Impl56 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl56.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl56 INSTANCE;

    public static ComplexpPack2Impl56 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl56();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl56(){
