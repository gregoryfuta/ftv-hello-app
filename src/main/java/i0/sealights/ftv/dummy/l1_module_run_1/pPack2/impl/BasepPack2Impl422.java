...
public class BasepPack2Impl422 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl422.class);
    private static BasepPack2Impl422 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl422 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl422();
        }
        return INSTANCE;
    }

    private BasepPack2Impl422(){
