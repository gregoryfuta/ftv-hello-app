...
public class ComplexpPack1Impl237 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl237.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl237 INSTANCE;

    public static ComplexpPack1Impl237 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl237();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl237(){
