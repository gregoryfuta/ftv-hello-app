...
public class ComplexpPack1Impl164 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl164.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl164 INSTANCE;

    public static ComplexpPack1Impl164 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl164();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl164(){
