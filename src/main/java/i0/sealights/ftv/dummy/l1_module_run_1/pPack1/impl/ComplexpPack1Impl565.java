...
public class ComplexpPack1Impl565 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl565.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl565 INSTANCE;

    public static ComplexpPack1Impl565 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl565();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl565(){
