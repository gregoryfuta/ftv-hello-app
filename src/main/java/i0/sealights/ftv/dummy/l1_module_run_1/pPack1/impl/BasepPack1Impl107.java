...
public class BasepPack1Impl107 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl107.class);
    private static BasepPack1Impl107 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl107 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl107();
        }
        return INSTANCE;
    }

    private BasepPack1Impl107(){
