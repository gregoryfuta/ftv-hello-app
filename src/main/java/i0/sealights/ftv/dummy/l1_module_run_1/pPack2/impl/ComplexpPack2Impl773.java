...
public class ComplexpPack2Impl773 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl773.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl773 INSTANCE;

    public static ComplexpPack2Impl773 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl773();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl773(){
