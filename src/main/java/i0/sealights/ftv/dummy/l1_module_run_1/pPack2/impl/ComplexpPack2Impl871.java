...
public class ComplexpPack2Impl871 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl871.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl871 INSTANCE;

    public static ComplexpPack2Impl871 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl871();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl871(){
