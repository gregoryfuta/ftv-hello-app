...
public class BasepPack1Impl862 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl862.class);
    private static BasepPack1Impl862 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl862 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl862();
        }
        return INSTANCE;
    }

    private BasepPack1Impl862(){
