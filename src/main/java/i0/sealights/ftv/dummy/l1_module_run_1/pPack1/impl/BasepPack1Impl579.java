...
public class BasepPack1Impl579 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl579.class);
    private static BasepPack1Impl579 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl579 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl579();
        }
        return INSTANCE;
    }

    private BasepPack1Impl579(){
