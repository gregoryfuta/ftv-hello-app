...
public class BasepPack2Impl122 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl122.class);
    private static BasepPack2Impl122 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl122 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl122();
        }
        return INSTANCE;
    }

    private BasepPack2Impl122(){
