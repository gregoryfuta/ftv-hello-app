...
public class BasepPack1Impl535 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl535.class);
    private static BasepPack1Impl535 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl535 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl535();
        }
        return INSTANCE;
    }

    private BasepPack1Impl535(){
