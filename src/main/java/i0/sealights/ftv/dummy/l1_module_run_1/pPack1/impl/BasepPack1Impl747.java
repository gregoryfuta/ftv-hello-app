...
public class BasepPack1Impl747 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl747.class);
    private static BasepPack1Impl747 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl747 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl747();
        }
        return INSTANCE;
    }

    private BasepPack1Impl747(){
