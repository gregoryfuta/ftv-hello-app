...
public class ComplexpPack2Impl776 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl776.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl776 INSTANCE;

    public static ComplexpPack2Impl776 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl776();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl776(){
