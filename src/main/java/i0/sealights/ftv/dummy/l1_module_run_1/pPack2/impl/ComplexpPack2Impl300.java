...
public class ComplexpPack2Impl300 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl300.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl300 INSTANCE;

    public static ComplexpPack2Impl300 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl300();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl300(){
