...
public class BasepPack2Impl833 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl833.class);
    private static BasepPack2Impl833 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl833 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl833();
        }
        return INSTANCE;
    }

    private BasepPack2Impl833(){
