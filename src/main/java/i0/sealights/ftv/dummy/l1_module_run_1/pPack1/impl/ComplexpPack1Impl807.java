...
public class ComplexpPack1Impl807 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl807.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl807 INSTANCE;

    public static ComplexpPack1Impl807 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl807();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl807(){
