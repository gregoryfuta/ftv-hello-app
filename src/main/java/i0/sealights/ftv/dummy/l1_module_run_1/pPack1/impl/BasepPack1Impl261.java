...
public class BasepPack1Impl261 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl261.class);
    private static BasepPack1Impl261 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl261 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl261();
        }
        return INSTANCE;
    }

    private BasepPack1Impl261(){
