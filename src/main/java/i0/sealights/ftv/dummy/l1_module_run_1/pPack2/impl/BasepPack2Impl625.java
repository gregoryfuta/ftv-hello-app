...
public class BasepPack2Impl625 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl625.class);
    private static BasepPack2Impl625 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl625 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl625();
        }
        return INSTANCE;
    }

    private BasepPack2Impl625(){
