...
public class BasepPack2Impl929 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl929.class);
    private static BasepPack2Impl929 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl929 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl929();
        }
        return INSTANCE;
    }

    private BasepPack2Impl929(){
