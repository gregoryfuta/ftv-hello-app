...
public class ComplexpPack2Impl333 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl333.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl333 INSTANCE;

    public static ComplexpPack2Impl333 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl333();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl333(){
