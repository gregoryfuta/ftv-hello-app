...
public class ComplexpPack2Impl897 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl897.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl897 INSTANCE;

    public static ComplexpPack2Impl897 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl897();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl897(){
