...
public class ComplexpPack2Impl779 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl779.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl779 INSTANCE;

    public static ComplexpPack2Impl779 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl779();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl779(){
