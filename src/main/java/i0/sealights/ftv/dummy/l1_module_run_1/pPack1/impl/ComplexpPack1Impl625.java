...
public class ComplexpPack1Impl625 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl625.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl625 INSTANCE;

    public static ComplexpPack1Impl625 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl625();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl625(){
