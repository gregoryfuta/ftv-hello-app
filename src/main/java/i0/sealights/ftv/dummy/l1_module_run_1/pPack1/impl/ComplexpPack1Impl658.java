...
public class ComplexpPack1Impl658 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl658.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl658 INSTANCE;

    public static ComplexpPack1Impl658 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl658();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl658(){
