...
public class BasepPack2Impl357 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl357.class);
    private static BasepPack2Impl357 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl357 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl357();
        }
        return INSTANCE;
    }

    private BasepPack2Impl357(){
