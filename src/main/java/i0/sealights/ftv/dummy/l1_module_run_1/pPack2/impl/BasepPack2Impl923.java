...
public class BasepPack2Impl923 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl923.class);
    private static BasepPack2Impl923 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl923 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl923();
        }
        return INSTANCE;
    }

    private BasepPack2Impl923(){
