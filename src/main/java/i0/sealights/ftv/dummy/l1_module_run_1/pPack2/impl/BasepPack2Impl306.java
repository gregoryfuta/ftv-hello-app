...
public class BasepPack2Impl306 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl306.class);
    private static BasepPack2Impl306 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl306 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl306();
        }
        return INSTANCE;
    }

    private BasepPack2Impl306(){
