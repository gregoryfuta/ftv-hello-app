...
public class ComplexpPack1Impl753 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl753.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl753 INSTANCE;

    public static ComplexpPack1Impl753 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl753();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl753(){
