...
public class ComplexpPack1Impl527 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl527.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl527 INSTANCE;

    public static ComplexpPack1Impl527 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl527();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl527(){
