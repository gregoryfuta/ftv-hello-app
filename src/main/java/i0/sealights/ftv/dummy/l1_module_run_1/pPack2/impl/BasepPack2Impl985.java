...
public class BasepPack2Impl985 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl985.class);
    private static BasepPack2Impl985 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl985 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl985();
        }
        return INSTANCE;
    }

    private BasepPack2Impl985(){
