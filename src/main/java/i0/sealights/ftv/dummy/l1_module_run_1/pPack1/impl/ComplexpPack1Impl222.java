...
public class ComplexpPack1Impl222 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl222.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl222 INSTANCE;

    public static ComplexpPack1Impl222 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl222();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl222(){
