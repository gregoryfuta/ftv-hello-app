...
public class BasepPack2Impl71 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl71.class);
    private static BasepPack2Impl71 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl71 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl71();
        }
        return INSTANCE;
    }

    private BasepPack2Impl71(){
