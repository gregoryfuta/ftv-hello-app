...
public class ComplexpPack1Impl80 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl80.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl80 INSTANCE;

    public static ComplexpPack1Impl80 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl80();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl80(){
