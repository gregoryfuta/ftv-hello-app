...
public class BasepPack1Impl507 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl507.class);
    private static BasepPack1Impl507 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl507 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl507();
        }
        return INSTANCE;
    }

    private BasepPack1Impl507(){
