...
public class ComplexpPack2Impl721 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl721.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl721 INSTANCE;

    public static ComplexpPack2Impl721 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl721();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl721(){
