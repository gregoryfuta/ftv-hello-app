...
public class ComplexpPack2Impl320 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl320.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl320 INSTANCE;

    public static ComplexpPack2Impl320 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl320();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl320(){
