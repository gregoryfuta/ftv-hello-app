...
public class BasepPack1Impl861 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl861.class);
    private static BasepPack1Impl861 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl861 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl861();
        }
        return INSTANCE;
    }

    private BasepPack1Impl861(){
