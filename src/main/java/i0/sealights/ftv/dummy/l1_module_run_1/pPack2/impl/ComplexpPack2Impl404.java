...
public class ComplexpPack2Impl404 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl404.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl404 INSTANCE;

    public static ComplexpPack2Impl404 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl404();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl404(){
