...
public class BasepPack2Impl314 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl314.class);
    private static BasepPack2Impl314 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl314 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl314();
        }
        return INSTANCE;
    }

    private BasepPack2Impl314(){
