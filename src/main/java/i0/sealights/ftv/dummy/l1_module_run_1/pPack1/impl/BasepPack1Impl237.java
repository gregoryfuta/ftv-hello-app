...
public class BasepPack1Impl237 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl237.class);
    private static BasepPack1Impl237 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl237 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl237();
        }
        return INSTANCE;
    }

    private BasepPack1Impl237(){
