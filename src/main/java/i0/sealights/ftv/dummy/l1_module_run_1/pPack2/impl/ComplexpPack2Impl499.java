...
public class ComplexpPack2Impl499 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl499.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl499 INSTANCE;

    public static ComplexpPack2Impl499 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl499();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl499(){
