...
public class BasepPack2Impl231 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl231.class);
    private static BasepPack2Impl231 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl231 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl231();
        }
        return INSTANCE;
    }

    private BasepPack2Impl231(){
