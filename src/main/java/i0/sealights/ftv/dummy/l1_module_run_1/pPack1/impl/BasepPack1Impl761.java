...
public class BasepPack1Impl761 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl761.class);
    private static BasepPack1Impl761 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl761 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl761();
        }
        return INSTANCE;
    }

    private BasepPack1Impl761(){
