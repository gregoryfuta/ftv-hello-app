...
public class ComplexpPack1Impl149 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl149.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl149 INSTANCE;

    public static ComplexpPack1Impl149 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl149();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl149(){
