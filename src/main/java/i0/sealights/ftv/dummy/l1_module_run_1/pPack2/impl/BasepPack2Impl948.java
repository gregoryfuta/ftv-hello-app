...
public class BasepPack2Impl948 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl948.class);
    private static BasepPack2Impl948 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl948 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl948();
        }
        return INSTANCE;
    }

    private BasepPack2Impl948(){
