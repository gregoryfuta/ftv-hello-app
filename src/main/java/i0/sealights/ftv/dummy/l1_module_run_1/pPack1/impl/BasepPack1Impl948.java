...
public class BasepPack1Impl948 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl948.class);
    private static BasepPack1Impl948 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl948 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl948();
        }
        return INSTANCE;
    }

    private BasepPack1Impl948(){
