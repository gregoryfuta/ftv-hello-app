...
public class BasepPack2Impl983 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl983.class);
    private static BasepPack2Impl983 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl983 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl983();
        }
        return INSTANCE;
    }

    private BasepPack2Impl983(){
