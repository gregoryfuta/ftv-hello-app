...
public class ComplexpPack2Impl956 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl956.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl956 INSTANCE;

    public static ComplexpPack2Impl956 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl956();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl956(){
