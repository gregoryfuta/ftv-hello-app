...
public class ComplexpPack1Impl608 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl608.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl608 INSTANCE;

    public static ComplexpPack1Impl608 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl608();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl608(){
