...
public class ComplexpPack2Impl256 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl256.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl256 INSTANCE;

    public static ComplexpPack2Impl256 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl256();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl256(){
