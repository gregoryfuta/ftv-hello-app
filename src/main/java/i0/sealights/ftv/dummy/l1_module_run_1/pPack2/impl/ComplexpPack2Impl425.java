...
public class ComplexpPack2Impl425 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl425.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl425 INSTANCE;

    public static ComplexpPack2Impl425 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl425();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl425(){
