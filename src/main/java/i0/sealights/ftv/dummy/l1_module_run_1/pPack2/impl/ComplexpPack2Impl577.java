...
public class ComplexpPack2Impl577 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl577.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl577 INSTANCE;

    public static ComplexpPack2Impl577 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl577();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl577(){
