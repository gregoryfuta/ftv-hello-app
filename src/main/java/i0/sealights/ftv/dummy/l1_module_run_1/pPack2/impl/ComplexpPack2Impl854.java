...
public class ComplexpPack2Impl854 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl854.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl854 INSTANCE;

    public static ComplexpPack2Impl854 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl854();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl854(){
