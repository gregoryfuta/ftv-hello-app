...
public class ComplexpPack2Impl526 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl526.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl526 INSTANCE;

    public static ComplexpPack2Impl526 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl526();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl526(){
