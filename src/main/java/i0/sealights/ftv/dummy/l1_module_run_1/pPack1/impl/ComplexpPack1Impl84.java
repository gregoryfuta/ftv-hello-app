...
public class ComplexpPack1Impl84 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl84.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl84 INSTANCE;

    public static ComplexpPack1Impl84 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl84();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl84(){
