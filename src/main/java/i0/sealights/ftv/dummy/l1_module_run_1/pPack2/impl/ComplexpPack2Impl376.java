...
public class ComplexpPack2Impl376 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl376.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl376 INSTANCE;

    public static ComplexpPack2Impl376 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl376();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl376(){
