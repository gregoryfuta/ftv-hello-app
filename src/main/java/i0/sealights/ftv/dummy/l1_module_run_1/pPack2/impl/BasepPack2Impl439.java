...
public class BasepPack2Impl439 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl439.class);
    private static BasepPack2Impl439 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl439 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl439();
        }
        return INSTANCE;
    }

    private BasepPack2Impl439(){
