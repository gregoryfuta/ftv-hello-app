...
public class BasepPack2Impl1016 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl1016.class);
    private static BasepPack2Impl1016 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl1016 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl1016();
        }
        return INSTANCE;
    }

    private BasepPack2Impl1016(){
