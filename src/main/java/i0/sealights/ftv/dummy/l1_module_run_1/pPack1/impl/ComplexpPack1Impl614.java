...
public class ComplexpPack1Impl614 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl614.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl614 INSTANCE;

    public static ComplexpPack1Impl614 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl614();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl614(){
