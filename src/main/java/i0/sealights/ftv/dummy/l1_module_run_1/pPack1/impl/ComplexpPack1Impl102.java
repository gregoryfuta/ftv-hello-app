...
public class ComplexpPack1Impl102 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl102.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl102 INSTANCE;

    public static ComplexpPack1Impl102 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl102();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl102(){
