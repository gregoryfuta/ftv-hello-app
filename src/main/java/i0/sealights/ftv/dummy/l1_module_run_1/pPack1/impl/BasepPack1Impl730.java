...
public class BasepPack1Impl730 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl730.class);
    private static BasepPack1Impl730 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl730 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl730();
        }
        return INSTANCE;
    }

    private BasepPack1Impl730(){
