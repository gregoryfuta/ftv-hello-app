...
public class ComplexpPack2Impl916 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl916.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl916 INSTANCE;

    public static ComplexpPack2Impl916 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl916();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl916(){
