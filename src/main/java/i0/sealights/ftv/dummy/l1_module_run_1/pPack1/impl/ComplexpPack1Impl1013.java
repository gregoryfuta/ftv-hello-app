...
public class ComplexpPack1Impl1013 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1013.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1013 INSTANCE;

    public static ComplexpPack1Impl1013 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1013();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1013(){
