...
public class BasepPack2Impl211 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl211.class);
    private static BasepPack2Impl211 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl211 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl211();
        }
        return INSTANCE;
    }

    private BasepPack2Impl211(){
