...
public class BasepPack1Impl138 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl138.class);
    private static BasepPack1Impl138 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl138 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl138();
        }
        return INSTANCE;
    }

    private BasepPack1Impl138(){
