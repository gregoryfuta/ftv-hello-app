...
public class ComplexpPack1Impl362 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl362.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl362 INSTANCE;

    public static ComplexpPack1Impl362 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl362();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl362(){
