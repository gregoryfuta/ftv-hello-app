...
public class BasepPack2Impl63 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl63.class);
    private static BasepPack2Impl63 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl63 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl63();
        }
        return INSTANCE;
    }

    private BasepPack2Impl63(){
