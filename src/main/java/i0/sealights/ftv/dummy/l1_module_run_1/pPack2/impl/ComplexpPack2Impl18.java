...
public class ComplexpPack2Impl18 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl18.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl18 INSTANCE;

    public static ComplexpPack2Impl18 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl18();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl18(){
