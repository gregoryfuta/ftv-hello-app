...
public class BasepPack2Impl621 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl621.class);
    private static BasepPack2Impl621 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl621 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl621();
        }
        return INSTANCE;
    }

    private BasepPack2Impl621(){
