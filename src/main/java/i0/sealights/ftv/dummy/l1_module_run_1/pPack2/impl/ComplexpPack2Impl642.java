...
public class ComplexpPack2Impl642 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl642.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl642 INSTANCE;

    public static ComplexpPack2Impl642 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl642();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl642(){
