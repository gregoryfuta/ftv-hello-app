...
public class ComplexpPack2Impl417 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl417.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl417 INSTANCE;

    public static ComplexpPack2Impl417 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl417();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl417(){
