...
import i0.sealights.ftv.dummy.l1_module_run_1.pPack2.BaseAbstractpPack2;
...
public class BasepPack2Impl1020 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl1020.class);
    private static BasepPack2Impl1020 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl1020 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl1020();
        }
        return INSTANCE;
    }

    private BasepPack2Impl1020(){
        this.parent = BaseAbstractpPack2.getInstance();
    }
