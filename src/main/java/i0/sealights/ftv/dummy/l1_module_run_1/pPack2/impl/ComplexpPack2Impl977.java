...
public class ComplexpPack2Impl977 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl977.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl977 INSTANCE;

    public static ComplexpPack2Impl977 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl977();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl977(){
