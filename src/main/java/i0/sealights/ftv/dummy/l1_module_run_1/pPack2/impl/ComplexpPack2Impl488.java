...
public class ComplexpPack2Impl488 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl488.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl488 INSTANCE;

    public static ComplexpPack2Impl488 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl488();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl488(){
