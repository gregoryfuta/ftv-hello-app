...
public class BasepPack2Impl478 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl478.class);
    private static BasepPack2Impl478 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl478 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl478();
        }
        return INSTANCE;
    }

    private BasepPack2Impl478(){
