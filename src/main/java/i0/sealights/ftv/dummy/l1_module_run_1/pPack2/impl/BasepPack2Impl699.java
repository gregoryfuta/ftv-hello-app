...
public class BasepPack2Impl699 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl699.class);
    private static BasepPack2Impl699 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl699 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl699();
        }
        return INSTANCE;
    }

    private BasepPack2Impl699(){
