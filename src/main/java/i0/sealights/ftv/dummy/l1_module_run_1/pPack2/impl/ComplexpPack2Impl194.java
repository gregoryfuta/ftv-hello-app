...
public class ComplexpPack2Impl194 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl194.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl194 INSTANCE;

    public static ComplexpPack2Impl194 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl194();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl194(){
