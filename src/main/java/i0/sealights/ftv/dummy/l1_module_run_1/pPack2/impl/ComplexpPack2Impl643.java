...
public class ComplexpPack2Impl643 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl643.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl643 INSTANCE;

    public static ComplexpPack2Impl643 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl643();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl643(){
