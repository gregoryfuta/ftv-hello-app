...
public class ComplexpPack1Impl98 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl98.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl98 INSTANCE;

    public static ComplexpPack1Impl98 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl98();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl98(){
