...
public class ComplexpPack2Impl75 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl75.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl75 INSTANCE;

    public static ComplexpPack2Impl75 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl75();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl75(){
