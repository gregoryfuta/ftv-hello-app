...
public class ComplexpPack2Impl210 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl210.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl210 INSTANCE;

    public static ComplexpPack2Impl210 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl210();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl210(){
