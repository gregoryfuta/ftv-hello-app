...
public class BasepPack1Impl255 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl255.class);
    private static BasepPack1Impl255 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl255 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl255();
        }
        return INSTANCE;
    }

    private BasepPack1Impl255(){
