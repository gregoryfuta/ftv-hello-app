...
public class BasepPack1Impl851 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl851.class);
    private static BasepPack1Impl851 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl851 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl851();
        }
        return INSTANCE;
    }

    private BasepPack1Impl851(){
