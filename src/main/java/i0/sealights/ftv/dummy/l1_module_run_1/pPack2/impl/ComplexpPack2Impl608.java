...
public class ComplexpPack2Impl608 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl608.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl608 INSTANCE;

    public static ComplexpPack2Impl608 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl608();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl608(){
