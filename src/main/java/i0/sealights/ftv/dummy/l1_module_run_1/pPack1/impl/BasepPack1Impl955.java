...
public class BasepPack1Impl955 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl955.class);
    private static BasepPack1Impl955 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl955 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl955();
        }
        return INSTANCE;
    }

    private BasepPack1Impl955(){
