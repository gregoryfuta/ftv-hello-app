...
public class BasepPack2Impl472 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl472.class);
    private static BasepPack2Impl472 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl472 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl472();
        }
        return INSTANCE;
    }

    private BasepPack2Impl472(){
