...
public class ComplexpPack2Impl961 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl961.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl961 INSTANCE;

    public static ComplexpPack2Impl961 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl961();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl961(){
