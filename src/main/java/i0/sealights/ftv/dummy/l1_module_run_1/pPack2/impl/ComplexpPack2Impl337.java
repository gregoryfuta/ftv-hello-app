...
public class ComplexpPack2Impl337 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl337.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl337 INSTANCE;

    public static ComplexpPack2Impl337 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl337();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl337(){
