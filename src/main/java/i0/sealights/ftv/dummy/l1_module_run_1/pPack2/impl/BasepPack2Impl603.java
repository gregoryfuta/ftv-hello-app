...
public class BasepPack2Impl603 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl603.class);
    private static BasepPack2Impl603 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl603 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl603();
        }
        return INSTANCE;
    }

    private BasepPack2Impl603(){
