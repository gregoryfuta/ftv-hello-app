...
public class ComplexpPack2Impl839 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl839.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl839 INSTANCE;

    public static ComplexpPack2Impl839 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl839();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl839(){
