...
public class ComplexpPack1Impl635 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl635.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl635 INSTANCE;

    public static ComplexpPack1Impl635 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl635();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl635(){
