...
public class ComplexpPack1Impl11 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl11.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl11 INSTANCE;

    public static ComplexpPack1Impl11 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl11();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl11(){
