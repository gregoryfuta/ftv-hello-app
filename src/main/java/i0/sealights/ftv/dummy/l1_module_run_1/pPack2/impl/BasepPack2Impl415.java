...
public class BasepPack2Impl415 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl415.class);
    private static BasepPack2Impl415 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl415 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl415();
        }
        return INSTANCE;
    }

    private BasepPack2Impl415(){
