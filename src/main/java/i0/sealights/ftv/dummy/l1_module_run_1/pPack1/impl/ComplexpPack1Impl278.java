...
public class ComplexpPack1Impl278 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl278.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl278 INSTANCE;

    public static ComplexpPack1Impl278 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl278();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl278(){
