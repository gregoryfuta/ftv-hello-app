...
public class BasepPack2Impl223 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl223.class);
    private static BasepPack2Impl223 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl223 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl223();
        }
        return INSTANCE;
    }

    private BasepPack2Impl223(){
