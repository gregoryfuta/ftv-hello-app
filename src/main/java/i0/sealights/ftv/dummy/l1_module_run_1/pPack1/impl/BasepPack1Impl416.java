...
public class BasepPack1Impl416 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl416.class);
    private static BasepPack1Impl416 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl416 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl416();
        }
        return INSTANCE;
    }

    private BasepPack1Impl416(){
