...
public class ComplexpPack2Impl189 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl189.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl189 INSTANCE;

    public static ComplexpPack2Impl189 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl189();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl189(){
