...
public class BasepPack1Impl829 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl829.class);
    private static BasepPack1Impl829 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl829 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl829();
        }
        return INSTANCE;
    }

    private BasepPack1Impl829(){
