...
public class ComplexpPack2Impl533 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl533.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl533 INSTANCE;

    public static ComplexpPack2Impl533 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl533();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl533(){
