...
public class BasepPack2Impl41 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl41.class);
    private static BasepPack2Impl41 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl41 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl41();
        }
        return INSTANCE;
    }

    private BasepPack2Impl41(){
