...
public class BasepPack1Impl11 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl11.class);
    private static BasepPack1Impl11 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl11 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl11();
        }
        return INSTANCE;
    }

    private BasepPack1Impl11(){
