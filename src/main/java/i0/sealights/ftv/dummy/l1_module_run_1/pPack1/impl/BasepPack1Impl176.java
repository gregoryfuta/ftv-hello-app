...
public class BasepPack1Impl176 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl176.class);
    private static BasepPack1Impl176 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl176 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl176();
        }
        return INSTANCE;
    }

    private BasepPack1Impl176(){
