...
public class BasepPack1Impl285 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl285.class);
    private static BasepPack1Impl285 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl285 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl285();
        }
        return INSTANCE;
    }

    private BasepPack1Impl285(){
