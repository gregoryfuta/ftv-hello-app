...
public class ComplexpPack1Impl130 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl130.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl130 INSTANCE;

    public static ComplexpPack1Impl130 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl130();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl130(){
