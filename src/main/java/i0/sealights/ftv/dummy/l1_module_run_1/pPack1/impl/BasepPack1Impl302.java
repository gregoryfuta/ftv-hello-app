...
public class BasepPack1Impl302 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl302.class);
    private static BasepPack1Impl302 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl302 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl302();
        }
        return INSTANCE;
    }

    private BasepPack1Impl302(){
