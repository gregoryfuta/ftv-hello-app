...
public class ComplexpPack2Impl111 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl111.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl111 INSTANCE;

    public static ComplexpPack2Impl111 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl111();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl111(){
