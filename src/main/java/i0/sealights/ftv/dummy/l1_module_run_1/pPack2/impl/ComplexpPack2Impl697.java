...
public class ComplexpPack2Impl697 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl697.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl697 INSTANCE;

    public static ComplexpPack2Impl697 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl697();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl697(){
