...
public class ComplexpPack2Impl797 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl797.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl797 INSTANCE;

    public static ComplexpPack2Impl797 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl797();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl797(){
