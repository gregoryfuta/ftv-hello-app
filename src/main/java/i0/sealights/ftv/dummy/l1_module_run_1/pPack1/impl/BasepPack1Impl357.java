...
public class BasepPack1Impl357 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl357.class);
    private static BasepPack1Impl357 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl357 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl357();
        }
        return INSTANCE;
    }

    private BasepPack1Impl357(){
