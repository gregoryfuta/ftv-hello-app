...
public class ComplexpPack2Impl22 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl22.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl22 INSTANCE;

    public static ComplexpPack2Impl22 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl22();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl22(){
