...
public class BasepPack1Impl700 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl700.class);
    private static BasepPack1Impl700 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl700 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl700();
        }
        return INSTANCE;
    }

    private BasepPack1Impl700(){
