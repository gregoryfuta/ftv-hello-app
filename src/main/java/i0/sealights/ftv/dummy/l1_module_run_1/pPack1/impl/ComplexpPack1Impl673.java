...
public class ComplexpPack1Impl673 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl673.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl673 INSTANCE;

    public static ComplexpPack1Impl673 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl673();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl673(){
