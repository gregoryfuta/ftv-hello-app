...
public class BasepPack1Impl745 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl745.class);
    private static BasepPack1Impl745 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl745 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl745();
        }
        return INSTANCE;
    }

    private BasepPack1Impl745(){
