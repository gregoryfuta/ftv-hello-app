...
public class BasepPack1Impl894 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl894.class);
    private static BasepPack1Impl894 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl894 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl894();
        }
        return INSTANCE;
    }

    private BasepPack1Impl894(){
