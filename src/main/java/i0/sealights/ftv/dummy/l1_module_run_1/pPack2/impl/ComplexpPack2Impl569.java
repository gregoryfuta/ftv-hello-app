...
public class ComplexpPack2Impl569 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl569.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl569 INSTANCE;

    public static ComplexpPack2Impl569 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl569();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl569(){
