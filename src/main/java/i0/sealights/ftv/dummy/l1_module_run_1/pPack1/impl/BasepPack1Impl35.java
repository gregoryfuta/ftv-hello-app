...
public class BasepPack1Impl35 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl35.class);
    private static BasepPack1Impl35 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl35 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl35();
        }
        return INSTANCE;
    }

    private BasepPack1Impl35(){
