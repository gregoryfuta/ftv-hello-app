...
public class ComplexpPack1Impl114 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl114.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl114 INSTANCE;

    public static ComplexpPack1Impl114 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl114();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl114(){
