...
public class BasepPack2Impl398 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl398.class);
    private static BasepPack2Impl398 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl398 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl398();
        }
        return INSTANCE;
    }

    private BasepPack2Impl398(){
