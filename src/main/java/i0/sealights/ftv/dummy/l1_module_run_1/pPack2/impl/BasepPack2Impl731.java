...
public class BasepPack2Impl731 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl731.class);
    private static BasepPack2Impl731 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl731 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl731();
        }
        return INSTANCE;
    }

    private BasepPack2Impl731(){
