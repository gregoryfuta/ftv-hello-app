...
public class ComplexpPack2Impl1062 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1062.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1062 INSTANCE;

    public static ComplexpPack2Impl1062 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1062();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1062(){
