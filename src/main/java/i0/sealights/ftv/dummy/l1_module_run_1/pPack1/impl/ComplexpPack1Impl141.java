...
public class ComplexpPack1Impl141 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl141.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl141 INSTANCE;

    public static ComplexpPack1Impl141 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl141();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl141(){
