...
public class BasepPack1Impl890 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl890.class);
    private static BasepPack1Impl890 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl890 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl890();
        }
        return INSTANCE;
    }

    private BasepPack1Impl890(){
