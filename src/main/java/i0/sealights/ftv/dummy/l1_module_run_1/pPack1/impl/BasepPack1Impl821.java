...
public class BasepPack1Impl821 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl821.class);
    private static BasepPack1Impl821 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl821 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl821();
        }
        return INSTANCE;
    }

    private BasepPack1Impl821(){
