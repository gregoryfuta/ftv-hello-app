...
public class BasepPack1Impl912 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl912.class);
    private static BasepPack1Impl912 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl912 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl912();
        }
        return INSTANCE;
    }

    private BasepPack1Impl912(){
