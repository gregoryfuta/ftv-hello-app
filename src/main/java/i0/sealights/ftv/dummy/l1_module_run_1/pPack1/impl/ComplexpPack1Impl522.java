...
public class ComplexpPack1Impl522 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl522.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl522 INSTANCE;

    public static ComplexpPack1Impl522 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl522();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl522(){
