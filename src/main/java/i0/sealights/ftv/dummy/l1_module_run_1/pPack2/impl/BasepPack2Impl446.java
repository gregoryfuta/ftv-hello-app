...
public class BasepPack2Impl446 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl446.class);
    private static BasepPack2Impl446 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl446 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl446();
        }
        return INSTANCE;
    }

    private BasepPack2Impl446(){
