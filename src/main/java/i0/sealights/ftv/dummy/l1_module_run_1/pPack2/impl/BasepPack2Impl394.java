...
public class BasepPack2Impl394 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl394.class);
    private static BasepPack2Impl394 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl394 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl394();
        }
        return INSTANCE;
    }

    private BasepPack2Impl394(){
