...
public class ComplexpPack2Impl204 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl204.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl204 INSTANCE;

    public static ComplexpPack2Impl204 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl204();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl204(){
