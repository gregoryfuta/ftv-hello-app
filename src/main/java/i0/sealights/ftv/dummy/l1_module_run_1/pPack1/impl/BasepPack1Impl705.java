...
public class BasepPack1Impl705 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl705.class);
    private static BasepPack1Impl705 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl705 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl705();
        }
        return INSTANCE;
    }

    private BasepPack1Impl705(){
