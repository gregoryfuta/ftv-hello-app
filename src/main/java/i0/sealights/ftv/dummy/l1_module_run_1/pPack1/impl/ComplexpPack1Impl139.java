...
public class ComplexpPack1Impl139 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl139.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl139 INSTANCE;

    public static ComplexpPack1Impl139 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl139();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl139(){
