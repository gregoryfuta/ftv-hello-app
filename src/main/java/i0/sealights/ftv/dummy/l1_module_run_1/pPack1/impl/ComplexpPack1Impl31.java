...
public class ComplexpPack1Impl31 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl31.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl31 INSTANCE;

    public static ComplexpPack1Impl31 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl31();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl31(){
