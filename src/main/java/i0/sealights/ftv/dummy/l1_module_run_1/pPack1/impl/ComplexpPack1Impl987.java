...
public class ComplexpPack1Impl987 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl987.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl987 INSTANCE;

    public static ComplexpPack1Impl987 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl987();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl987(){
