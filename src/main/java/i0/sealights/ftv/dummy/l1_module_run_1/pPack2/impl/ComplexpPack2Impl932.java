...
public class ComplexpPack2Impl932 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl932.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl932 INSTANCE;

    public static ComplexpPack2Impl932 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl932();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl932(){
