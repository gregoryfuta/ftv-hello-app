...
public class BasepPack1Impl373 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl373.class);
    private static BasepPack1Impl373 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl373 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl373();
        }
        return INSTANCE;
    }

    private BasepPack1Impl373(){
