...
public class ComplexpPack2Impl769 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl769.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl769 INSTANCE;

    public static ComplexpPack2Impl769 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl769();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl769(){
