...
public class ComplexpPack2Impl699 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl699.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl699 INSTANCE;

    public static ComplexpPack2Impl699 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl699();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl699(){
