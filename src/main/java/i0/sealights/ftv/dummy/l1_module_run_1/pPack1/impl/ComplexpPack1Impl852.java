...
public class ComplexpPack1Impl852 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl852.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl852 INSTANCE;

    public static ComplexpPack1Impl852 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl852();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl852(){
