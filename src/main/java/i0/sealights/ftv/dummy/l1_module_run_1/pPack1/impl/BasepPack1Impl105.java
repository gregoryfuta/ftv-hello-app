...
public class BasepPack1Impl105 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl105.class);
    private static BasepPack1Impl105 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl105 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl105();
        }
        return INSTANCE;
    }

    private BasepPack1Impl105(){
