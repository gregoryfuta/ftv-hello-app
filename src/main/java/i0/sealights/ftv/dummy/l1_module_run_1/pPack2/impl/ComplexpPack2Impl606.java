...
public class ComplexpPack2Impl606 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl606.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl606 INSTANCE;

    public static ComplexpPack2Impl606 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl606();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl606(){
