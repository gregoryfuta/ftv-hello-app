...
public class ComplexpPack2Impl482 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl482.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl482 INSTANCE;

    public static ComplexpPack2Impl482 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl482();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl482(){
