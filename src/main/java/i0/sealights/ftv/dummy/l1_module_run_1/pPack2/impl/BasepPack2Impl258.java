...
public class BasepPack2Impl258 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl258.class);
    private static BasepPack2Impl258 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl258 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl258();
        }
        return INSTANCE;
    }

    private BasepPack2Impl258(){
