...
public class BasepPack2Impl119 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl119.class);
    private static BasepPack2Impl119 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl119 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl119();
        }
        return INSTANCE;
    }

    private BasepPack2Impl119(){
