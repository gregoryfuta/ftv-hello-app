...
public class BasepPack1Impl737 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl737.class);
    private static BasepPack1Impl737 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl737 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl737();
        }
        return INSTANCE;
    }

    private BasepPack1Impl737(){
