...
public class BasepPack1Impl641 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl641.class);
    private static BasepPack1Impl641 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl641 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl641();
        }
        return INSTANCE;
    }

    private BasepPack1Impl641(){
