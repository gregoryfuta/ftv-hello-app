...
public class ComplexpPack2Impl808 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl808.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl808 INSTANCE;

    public static ComplexpPack2Impl808 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl808();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl808(){
