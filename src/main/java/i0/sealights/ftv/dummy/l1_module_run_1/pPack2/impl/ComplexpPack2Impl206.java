...
public class ComplexpPack2Impl206 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl206.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl206 INSTANCE;

    public static ComplexpPack2Impl206 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl206();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl206(){
