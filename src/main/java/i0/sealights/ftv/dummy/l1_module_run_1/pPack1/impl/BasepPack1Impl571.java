...
public class BasepPack1Impl571 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl571.class);
    private static BasepPack1Impl571 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl571 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl571();
        }
        return INSTANCE;
    }

    private BasepPack1Impl571(){
