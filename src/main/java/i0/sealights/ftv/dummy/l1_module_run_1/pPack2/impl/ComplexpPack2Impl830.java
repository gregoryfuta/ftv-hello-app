...
public class ComplexpPack2Impl830 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl830.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl830 INSTANCE;

    public static ComplexpPack2Impl830 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl830();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl830(){
