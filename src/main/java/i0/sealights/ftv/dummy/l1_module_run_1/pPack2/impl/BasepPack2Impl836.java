...
public class BasepPack2Impl836 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl836.class);
    private static BasepPack2Impl836 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl836 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl836();
        }
        return INSTANCE;
    }

    private BasepPack2Impl836(){
