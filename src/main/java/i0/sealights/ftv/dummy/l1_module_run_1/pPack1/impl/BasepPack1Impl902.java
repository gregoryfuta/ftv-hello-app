...
public class BasepPack1Impl902 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl902.class);
    private static BasepPack1Impl902 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl902 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl902();
        }
        return INSTANCE;
    }

    private BasepPack1Impl902(){
