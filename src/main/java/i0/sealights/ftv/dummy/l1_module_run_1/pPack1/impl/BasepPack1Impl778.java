...
public class BasepPack1Impl778 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl778.class);
    private static BasepPack1Impl778 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl778 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl778();
        }
        return INSTANCE;
    }

    private BasepPack1Impl778(){
