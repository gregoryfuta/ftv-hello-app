...
public class ComplexpPack2Impl906 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl906.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl906 INSTANCE;

    public static ComplexpPack2Impl906 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl906();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl906(){
