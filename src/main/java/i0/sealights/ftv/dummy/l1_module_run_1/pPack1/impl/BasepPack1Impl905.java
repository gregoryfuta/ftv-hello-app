...
public class BasepPack1Impl905 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl905.class);
    private static BasepPack1Impl905 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl905 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl905();
        }
        return INSTANCE;
    }

    private BasepPack1Impl905(){
