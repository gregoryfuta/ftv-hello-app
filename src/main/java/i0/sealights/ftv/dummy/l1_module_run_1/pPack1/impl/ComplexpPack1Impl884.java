...
public class ComplexpPack1Impl884 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl884.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl884 INSTANCE;

    public static ComplexpPack1Impl884 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl884();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl884(){
