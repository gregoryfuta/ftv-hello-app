...
public class ComplexpPack1Impl696 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl696.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl696 INSTANCE;

    public static ComplexpPack1Impl696 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl696();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl696(){
