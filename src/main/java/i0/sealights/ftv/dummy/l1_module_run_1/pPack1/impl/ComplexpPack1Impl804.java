...
public class ComplexpPack1Impl804 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl804.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl804 INSTANCE;

    public static ComplexpPack1Impl804 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl804();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl804(){
