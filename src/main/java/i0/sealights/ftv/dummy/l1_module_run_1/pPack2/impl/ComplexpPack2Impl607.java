...
public class ComplexpPack2Impl607 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl607.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl607 INSTANCE;

    public static ComplexpPack2Impl607 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl607();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl607(){
