...
public class BasepPack2Impl841 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl841.class);
    private static BasepPack2Impl841 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl841 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl841();
        }
        return INSTANCE;
    }

    private BasepPack2Impl841(){
