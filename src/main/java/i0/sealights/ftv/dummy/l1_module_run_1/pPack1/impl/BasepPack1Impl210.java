...
public class BasepPack1Impl210 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl210.class);
    private static BasepPack1Impl210 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl210 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl210();
        }
        return INSTANCE;
    }

    private BasepPack1Impl210(){
