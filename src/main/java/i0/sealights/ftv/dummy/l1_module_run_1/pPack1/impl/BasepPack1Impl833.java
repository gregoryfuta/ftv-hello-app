...
public class BasepPack1Impl833 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl833.class);
    private static BasepPack1Impl833 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl833 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl833();
        }
        return INSTANCE;
    }

    private BasepPack1Impl833(){
