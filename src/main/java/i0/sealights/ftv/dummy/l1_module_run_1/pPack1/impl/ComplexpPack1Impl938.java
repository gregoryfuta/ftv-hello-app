...
public class ComplexpPack1Impl938 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl938.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl938 INSTANCE;

    public static ComplexpPack1Impl938 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl938();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl938(){
