...
public class ComplexpPack2Impl196 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl196.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl196 INSTANCE;

    public static ComplexpPack2Impl196 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl196();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl196(){
