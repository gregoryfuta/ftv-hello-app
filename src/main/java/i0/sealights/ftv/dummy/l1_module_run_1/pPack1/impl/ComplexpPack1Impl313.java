...
public class ComplexpPack1Impl313 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl313.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl313 INSTANCE;

    public static ComplexpPack1Impl313 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl313();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl313(){
