...
public class BasepPack1Impl406 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl406.class);
    private static BasepPack1Impl406 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl406 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl406();
        }
        return INSTANCE;
    }

    private BasepPack1Impl406(){
