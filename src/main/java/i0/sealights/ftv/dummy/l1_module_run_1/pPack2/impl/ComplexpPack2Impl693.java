...
public class ComplexpPack2Impl693 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl693.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl693 INSTANCE;

    public static ComplexpPack2Impl693 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl693();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl693(){
