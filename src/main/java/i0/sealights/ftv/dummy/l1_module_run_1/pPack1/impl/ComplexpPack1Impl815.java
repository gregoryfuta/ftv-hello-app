...
public class ComplexpPack1Impl815 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl815.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl815 INSTANCE;

    public static ComplexpPack1Impl815 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl815();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl815(){
