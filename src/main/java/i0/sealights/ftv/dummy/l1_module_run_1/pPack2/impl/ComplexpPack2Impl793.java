...
public class ComplexpPack2Impl793 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl793.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl793 INSTANCE;

    public static ComplexpPack2Impl793 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl793();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl793(){
