...
public class ComplexpPack1Impl128 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl128.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl128 INSTANCE;

    public static ComplexpPack1Impl128 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl128();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl128(){
