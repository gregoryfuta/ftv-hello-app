...
public class BasepPack1Impl404 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl404.class);
    private static BasepPack1Impl404 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl404 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl404();
        }
        return INSTANCE;
    }

    private BasepPack1Impl404(){
