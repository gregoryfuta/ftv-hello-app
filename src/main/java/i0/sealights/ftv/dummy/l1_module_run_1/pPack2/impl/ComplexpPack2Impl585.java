...
public class ComplexpPack2Impl585 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl585.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl585 INSTANCE;

    public static ComplexpPack2Impl585 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl585();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl585(){
