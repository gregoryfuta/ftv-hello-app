...
public class BasepPack1Impl28 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl28.class);
    private static BasepPack1Impl28 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl28 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl28();
        }
        return INSTANCE;
    }

    private BasepPack1Impl28(){
