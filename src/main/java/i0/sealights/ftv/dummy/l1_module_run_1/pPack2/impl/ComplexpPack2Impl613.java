...
public class ComplexpPack2Impl613 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl613.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl613 INSTANCE;

    public static ComplexpPack2Impl613 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl613();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl613(){
