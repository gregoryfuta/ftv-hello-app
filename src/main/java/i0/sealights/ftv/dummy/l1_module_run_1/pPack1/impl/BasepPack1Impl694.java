...
public class BasepPack1Impl694 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl694.class);
    private static BasepPack1Impl694 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl694 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl694();
        }
        return INSTANCE;
    }

    private BasepPack1Impl694(){
