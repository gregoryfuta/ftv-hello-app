...
public class BasepPack1Impl385 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl385.class);
    private static BasepPack1Impl385 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl385 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl385();
        }
        return INSTANCE;
    }

    private BasepPack1Impl385(){
