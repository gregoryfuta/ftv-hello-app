...
public class ComplexpPack1Impl187 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl187.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl187 INSTANCE;

    public static ComplexpPack1Impl187 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl187();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl187(){
