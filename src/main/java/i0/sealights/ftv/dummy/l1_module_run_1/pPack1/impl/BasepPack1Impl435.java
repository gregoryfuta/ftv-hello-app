...
public class BasepPack1Impl435 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl435.class);
    private static BasepPack1Impl435 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl435 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl435();
        }
        return INSTANCE;
    }

    private BasepPack1Impl435(){
