...
public class ComplexpPack1Impl342 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl342.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl342 INSTANCE;

    public static ComplexpPack1Impl342 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl342();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl342(){
