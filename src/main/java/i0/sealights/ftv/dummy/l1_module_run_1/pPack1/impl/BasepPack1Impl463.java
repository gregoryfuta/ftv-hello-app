...
public class BasepPack1Impl463 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl463.class);
    private static BasepPack1Impl463 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl463 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl463();
        }
        return INSTANCE;
    }

    private BasepPack1Impl463(){
