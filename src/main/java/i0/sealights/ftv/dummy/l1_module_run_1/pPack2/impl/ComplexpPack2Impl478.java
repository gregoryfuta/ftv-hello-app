...
public class ComplexpPack2Impl478 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl478.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl478 INSTANCE;

    public static ComplexpPack2Impl478 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl478();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl478(){
