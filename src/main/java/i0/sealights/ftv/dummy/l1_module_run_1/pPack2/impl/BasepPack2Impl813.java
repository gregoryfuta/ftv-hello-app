...
public class BasepPack2Impl813 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl813.class);
    private static BasepPack2Impl813 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl813 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl813();
        }
        return INSTANCE;
    }

    private BasepPack2Impl813(){
