...
public class BasepPack1Impl992 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl992.class);
    private static BasepPack1Impl992 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl992 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl992();
        }
        return INSTANCE;
    }

    private BasepPack1Impl992(){
