...
public class ComplexpPack2Impl215 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl215.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl215 INSTANCE;

    public static ComplexpPack2Impl215 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl215();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl215(){
