...
public class ComplexpPack1Impl226 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl226.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl226 INSTANCE;

    public static ComplexpPack1Impl226 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl226();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl226(){
