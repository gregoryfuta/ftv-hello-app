...
public class ComplexpPack2Impl623 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl623.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl623 INSTANCE;

    public static ComplexpPack2Impl623 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl623();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl623(){
