...
public class ComplexpPack2Impl879 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl879.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl879 INSTANCE;

    public static ComplexpPack2Impl879 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl879();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl879(){
