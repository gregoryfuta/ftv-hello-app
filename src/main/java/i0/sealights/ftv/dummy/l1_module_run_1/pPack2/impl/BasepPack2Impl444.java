...
public class BasepPack2Impl444 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl444.class);
    private static BasepPack2Impl444 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl444 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl444();
        }
        return INSTANCE;
    }

    private BasepPack2Impl444(){
