...
public class ComplexpPack1Impl517 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl517.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl517 INSTANCE;

    public static ComplexpPack1Impl517 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl517();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl517(){
