...
public class ComplexpPack2Impl334 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl334.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl334 INSTANCE;

    public static ComplexpPack2Impl334 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl334();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl334(){
