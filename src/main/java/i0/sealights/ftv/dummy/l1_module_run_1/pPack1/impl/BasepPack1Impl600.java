...
public class BasepPack1Impl600 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl600.class);
    private static BasepPack1Impl600 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl600 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl600();
        }
        return INSTANCE;
    }

    private BasepPack1Impl600(){
