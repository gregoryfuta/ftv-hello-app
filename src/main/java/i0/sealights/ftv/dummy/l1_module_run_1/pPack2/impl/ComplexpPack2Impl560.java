...
public class ComplexpPack2Impl560 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl560.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl560 INSTANCE;

    public static ComplexpPack2Impl560 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl560();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl560(){
