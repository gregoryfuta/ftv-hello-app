...
public class ComplexpPack1Impl103 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl103.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl103 INSTANCE;

    public static ComplexpPack1Impl103 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl103();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl103(){
