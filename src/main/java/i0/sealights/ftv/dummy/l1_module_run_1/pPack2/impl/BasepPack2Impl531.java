...
public class BasepPack2Impl531 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl531.class);
    private static BasepPack2Impl531 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl531 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl531();
        }
        return INSTANCE;
    }

    private BasepPack2Impl531(){
