...
public class BasepPack2Impl1049 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl1049.class);
    private static BasepPack2Impl1049 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl1049 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl1049();
        }
        return INSTANCE;
    }

    private BasepPack2Impl1049(){
