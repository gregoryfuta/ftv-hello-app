...
public class BasepPack2Impl526 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl526.class);
    private static BasepPack2Impl526 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl526 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl526();
        }
        return INSTANCE;
    }

    private BasepPack2Impl526(){
