...
public class BasepPack2Impl883 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl883.class);
    private static BasepPack2Impl883 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl883 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl883();
        }
        return INSTANCE;
    }

    private BasepPack2Impl883(){
