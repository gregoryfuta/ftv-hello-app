...
public class BasepPack1Impl911 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl911.class);
    private static BasepPack1Impl911 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl911 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl911();
        }
        return INSTANCE;
    }

    private BasepPack1Impl911(){
