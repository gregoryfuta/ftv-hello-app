...
public class BasepPack2Impl902 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl902.class);
    private static BasepPack2Impl902 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl902 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl902();
        }
        return INSTANCE;
    }

    private BasepPack2Impl902(){
