...
public class BasepPack2Impl224 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl224.class);
    private static BasepPack2Impl224 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl224 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl224();
        }
        return INSTANCE;
    }

    private BasepPack2Impl224(){
