...
public class BasepPack1Impl922 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl922.class);
    private static BasepPack1Impl922 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl922 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl922();
        }
        return INSTANCE;
    }

    private BasepPack1Impl922(){
