...
public class ComplexpPack2Impl171 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl171.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl171 INSTANCE;

    public static ComplexpPack2Impl171 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl171();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl171(){
