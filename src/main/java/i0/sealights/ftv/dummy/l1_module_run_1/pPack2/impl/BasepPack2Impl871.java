...
public class BasepPack2Impl871 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl871.class);
    private static BasepPack2Impl871 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl871 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl871();
        }
        return INSTANCE;
    }

    private BasepPack2Impl871(){
