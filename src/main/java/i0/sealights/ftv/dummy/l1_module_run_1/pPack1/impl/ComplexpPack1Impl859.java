...
public class ComplexpPack1Impl859 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl859.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl859 INSTANCE;

    public static ComplexpPack1Impl859 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl859();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl859(){
