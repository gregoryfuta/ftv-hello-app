...
public class BasepPack1Impl405 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl405.class);
    private static BasepPack1Impl405 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl405 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl405();
        }
        return INSTANCE;
    }

    private BasepPack1Impl405(){
