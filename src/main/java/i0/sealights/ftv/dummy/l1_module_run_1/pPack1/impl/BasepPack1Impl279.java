...
public class BasepPack1Impl279 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl279.class);
    private static BasepPack1Impl279 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl279 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl279();
        }
        return INSTANCE;
    }

    private BasepPack1Impl279(){
