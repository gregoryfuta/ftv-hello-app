...
public class BasepPack2Impl185 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl185.class);
    private static BasepPack2Impl185 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl185 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl185();
        }
        return INSTANCE;
    }

    private BasepPack2Impl185(){
