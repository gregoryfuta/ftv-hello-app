...
public class BasepPack1Impl59 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl59.class);
    private static BasepPack1Impl59 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl59 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl59();
        }
        return INSTANCE;
    }

    private BasepPack1Impl59(){
