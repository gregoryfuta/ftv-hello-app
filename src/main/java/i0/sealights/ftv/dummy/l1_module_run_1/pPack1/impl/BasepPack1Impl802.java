...
public class BasepPack1Impl802 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl802.class);
    private static BasepPack1Impl802 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl802 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl802();
        }
        return INSTANCE;
    }

    private BasepPack1Impl802(){
