...
public class ComplexpPack2Impl827 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl827.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl827 INSTANCE;

    public static ComplexpPack2Impl827 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl827();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl827(){
