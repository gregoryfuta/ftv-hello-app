...
public class ComplexpPack2Impl122 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl122.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl122 INSTANCE;

    public static ComplexpPack2Impl122 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl122();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl122(){
