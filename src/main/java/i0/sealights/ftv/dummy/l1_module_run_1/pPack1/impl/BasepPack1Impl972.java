...
public class BasepPack1Impl972 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl972.class);
    private static BasepPack1Impl972 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl972 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl972();
        }
        return INSTANCE;
    }

    private BasepPack1Impl972(){
