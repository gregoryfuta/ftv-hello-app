...
public class BasepPack1Impl884 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl884.class);
    private static BasepPack1Impl884 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl884 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl884();
        }
        return INSTANCE;
    }

    private BasepPack1Impl884(){
