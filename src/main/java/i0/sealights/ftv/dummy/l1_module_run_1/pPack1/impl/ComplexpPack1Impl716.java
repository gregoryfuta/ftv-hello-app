...
public class ComplexpPack1Impl716 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl716.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl716 INSTANCE;

    public static ComplexpPack1Impl716 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl716();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl716(){
