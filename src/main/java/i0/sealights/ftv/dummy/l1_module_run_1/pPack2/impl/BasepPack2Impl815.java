...
public class BasepPack2Impl815 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl815.class);
    private static BasepPack2Impl815 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl815 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl815();
        }
        return INSTANCE;
    }

    private BasepPack2Impl815(){
