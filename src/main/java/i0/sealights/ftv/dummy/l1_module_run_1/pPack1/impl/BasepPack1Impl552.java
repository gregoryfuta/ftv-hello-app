...
public class BasepPack1Impl552 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl552.class);
    private static BasepPack1Impl552 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl552 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl552();
        }
        return INSTANCE;
    }

    private BasepPack1Impl552(){
