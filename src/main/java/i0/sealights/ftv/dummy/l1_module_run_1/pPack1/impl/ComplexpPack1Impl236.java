...
public class ComplexpPack1Impl236 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl236.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl236 INSTANCE;

    public static ComplexpPack1Impl236 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl236();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl236(){
