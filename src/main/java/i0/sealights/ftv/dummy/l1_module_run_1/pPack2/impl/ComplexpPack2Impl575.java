...
public class ComplexpPack2Impl575 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl575.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl575 INSTANCE;

    public static ComplexpPack2Impl575 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl575();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl575(){
