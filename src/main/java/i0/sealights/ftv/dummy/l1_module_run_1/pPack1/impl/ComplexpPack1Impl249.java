...
public class ComplexpPack1Impl249 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl249.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl249 INSTANCE;

    public static ComplexpPack1Impl249 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl249();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl249(){
