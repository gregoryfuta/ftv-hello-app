...
public class ComplexpPack1Impl346 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl346.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl346 INSTANCE;

    public static ComplexpPack1Impl346 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl346();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl346(){
