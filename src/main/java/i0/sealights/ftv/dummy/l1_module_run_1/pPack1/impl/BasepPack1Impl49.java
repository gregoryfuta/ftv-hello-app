...
public class BasepPack1Impl49 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl49.class);
    private static BasepPack1Impl49 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl49 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl49();
        }
        return INSTANCE;
    }

    private BasepPack1Impl49(){
