...
public class ComplexpPack1Impl883 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl883.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl883 INSTANCE;

    public static ComplexpPack1Impl883 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl883();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl883(){
