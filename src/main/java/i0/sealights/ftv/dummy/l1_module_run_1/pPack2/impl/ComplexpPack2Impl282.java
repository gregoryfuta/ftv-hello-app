...
public class ComplexpPack2Impl282 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl282.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl282 INSTANCE;

    public static ComplexpPack2Impl282 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl282();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl282(){
