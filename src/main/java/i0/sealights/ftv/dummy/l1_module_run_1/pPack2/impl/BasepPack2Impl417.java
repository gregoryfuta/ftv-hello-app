...
public class BasepPack2Impl417 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl417.class);
    private static BasepPack2Impl417 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl417 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl417();
        }
        return INSTANCE;
    }

    private BasepPack2Impl417(){
