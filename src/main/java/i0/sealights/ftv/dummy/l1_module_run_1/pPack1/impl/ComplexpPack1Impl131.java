...
public class ComplexpPack1Impl131 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl131.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl131 INSTANCE;

    public static ComplexpPack1Impl131 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl131();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl131(){
