...
public class BasepPack2Impl75 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl75.class);
    private static BasepPack2Impl75 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl75 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl75();
        }
        return INSTANCE;
    }

    private BasepPack2Impl75(){
