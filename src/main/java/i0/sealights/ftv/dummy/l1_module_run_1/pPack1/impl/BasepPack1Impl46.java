...
public class BasepPack1Impl46 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl46.class);
    private static BasepPack1Impl46 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl46 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl46();
        }
        return INSTANCE;
    }

    private BasepPack1Impl46(){
