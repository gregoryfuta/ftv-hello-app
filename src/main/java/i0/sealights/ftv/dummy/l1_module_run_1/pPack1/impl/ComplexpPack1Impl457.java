...
public class ComplexpPack1Impl457 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl457.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl457 INSTANCE;

    public static ComplexpPack1Impl457 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl457();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl457(){
