...
public class ComplexpPack1Impl784 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl784.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl784 INSTANCE;

    public static ComplexpPack1Impl784 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl784();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl784(){
