...
public class BasepPack2Impl5 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl5.class);
    private static BasepPack2Impl5 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl5 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl5();
        }
        return INSTANCE;
    }

    private BasepPack2Impl5(){
