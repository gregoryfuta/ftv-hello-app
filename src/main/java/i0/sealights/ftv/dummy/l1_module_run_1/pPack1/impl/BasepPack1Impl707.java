...
public class BasepPack1Impl707 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl707.class);
    private static BasepPack1Impl707 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl707 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl707();
        }
        return INSTANCE;
    }

    private BasepPack1Impl707(){
