...
public class ComplexpPack1Impl482 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl482.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl482 INSTANCE;

    public static ComplexpPack1Impl482 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl482();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl482(){
