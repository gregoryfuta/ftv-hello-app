...
public class BasepPack2Impl564 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl564.class);
    private static BasepPack2Impl564 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl564 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl564();
        }
        return INSTANCE;
    }

    private BasepPack2Impl564(){
