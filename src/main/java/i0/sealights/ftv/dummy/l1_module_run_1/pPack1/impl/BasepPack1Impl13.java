...
public class BasepPack1Impl13 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl13.class);
    private static BasepPack1Impl13 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl13 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl13();
        }
        return INSTANCE;
    }

    private BasepPack1Impl13(){
