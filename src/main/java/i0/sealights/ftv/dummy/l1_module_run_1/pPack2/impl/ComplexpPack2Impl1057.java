...
public class ComplexpPack2Impl1057 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1057.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1057 INSTANCE;

    public static ComplexpPack2Impl1057 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1057();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1057(){
