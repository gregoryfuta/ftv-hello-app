...
public class BasepPack1Impl247 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl247.class);
    private static BasepPack1Impl247 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl247 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl247();
        }
        return INSTANCE;
    }

    private BasepPack1Impl247(){
