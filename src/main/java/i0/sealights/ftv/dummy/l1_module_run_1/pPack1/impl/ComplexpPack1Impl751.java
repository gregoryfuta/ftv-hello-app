...
public class ComplexpPack1Impl751 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl751.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl751 INSTANCE;

    public static ComplexpPack1Impl751 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl751();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl751(){
