...
public class BasepPack1Impl688 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl688.class);
    private static BasepPack1Impl688 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl688 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl688();
        }
        return INSTANCE;
    }

    private BasepPack1Impl688(){
