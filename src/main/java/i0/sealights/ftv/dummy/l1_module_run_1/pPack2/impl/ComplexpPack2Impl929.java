...
public class ComplexpPack2Impl929 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl929.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl929 INSTANCE;

    public static ComplexpPack2Impl929 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl929();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl929(){
