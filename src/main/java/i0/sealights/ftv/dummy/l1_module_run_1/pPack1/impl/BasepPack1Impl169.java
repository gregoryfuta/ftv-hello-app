...
public class BasepPack1Impl169 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl169.class);
    private static BasepPack1Impl169 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl169 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl169();
        }
        return INSTANCE;
    }

    private BasepPack1Impl169(){
