...
public class BasepPack1Impl220 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl220.class);
    private static BasepPack1Impl220 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl220 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl220();
        }
        return INSTANCE;
    }

    private BasepPack1Impl220(){
