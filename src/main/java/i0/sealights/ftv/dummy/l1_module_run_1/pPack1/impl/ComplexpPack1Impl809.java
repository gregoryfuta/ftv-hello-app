...
public class ComplexpPack1Impl809 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl809.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl809 INSTANCE;

    public static ComplexpPack1Impl809 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl809();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl809(){
