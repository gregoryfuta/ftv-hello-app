...
public class BasepPack2Impl445 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl445.class);
    private static BasepPack2Impl445 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl445 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl445();
        }
        return INSTANCE;
    }

    private BasepPack2Impl445(){
