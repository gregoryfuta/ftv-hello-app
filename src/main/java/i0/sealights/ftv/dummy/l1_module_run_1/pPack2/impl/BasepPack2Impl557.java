...
public class BasepPack2Impl557 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl557.class);
    private static BasepPack2Impl557 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl557 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl557();
        }
        return INSTANCE;
    }

    private BasepPack2Impl557(){
