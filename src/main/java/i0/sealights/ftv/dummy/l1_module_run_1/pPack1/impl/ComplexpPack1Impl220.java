...
public class ComplexpPack1Impl220 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl220.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl220 INSTANCE;

    public static ComplexpPack1Impl220 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl220();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl220(){
