...
public class BasepPack1Impl661 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl661.class);
    private static BasepPack1Impl661 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl661 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl661();
        }
        return INSTANCE;
    }

    private BasepPack1Impl661(){
