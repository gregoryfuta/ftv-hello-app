...
public class ComplexpPack2Impl691 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl691.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl691 INSTANCE;

    public static ComplexpPack2Impl691 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl691();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl691(){
