...
public class BasepPack2Impl548 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl548.class);
    private static BasepPack2Impl548 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl548 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl548();
        }
        return INSTANCE;
    }

    private BasepPack2Impl548(){
