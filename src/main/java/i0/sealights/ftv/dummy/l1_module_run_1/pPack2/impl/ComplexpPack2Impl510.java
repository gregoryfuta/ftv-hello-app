...
public class ComplexpPack2Impl510 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl510.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl510 INSTANCE;

    public static ComplexpPack2Impl510 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl510();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl510(){
