...
public class BasepPack2Impl743 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl743.class);
    private static BasepPack2Impl743 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl743 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl743();
        }
        return INSTANCE;
    }

    private BasepPack2Impl743(){
