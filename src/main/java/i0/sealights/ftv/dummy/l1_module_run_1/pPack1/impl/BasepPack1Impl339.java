...
public class BasepPack1Impl339 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl339.class);
    private static BasepPack1Impl339 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl339 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl339();
        }
        return INSTANCE;
    }

    private BasepPack1Impl339(){
