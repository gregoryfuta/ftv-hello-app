...
public class ComplexpPack2Impl272 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl272.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl272 INSTANCE;

    public static ComplexpPack2Impl272 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl272();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl272(){
