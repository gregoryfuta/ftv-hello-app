...
public class ComplexpPack1Impl215 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl215.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl215 INSTANCE;

    public static ComplexpPack1Impl215 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl215();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl215(){
