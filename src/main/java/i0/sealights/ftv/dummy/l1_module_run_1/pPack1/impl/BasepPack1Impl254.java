...
public class BasepPack1Impl254 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl254.class);
    private static BasepPack1Impl254 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl254 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl254();
        }
        return INSTANCE;
    }

    private BasepPack1Impl254(){
