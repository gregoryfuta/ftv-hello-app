...
public class BasepPack2Impl486 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl486.class);
    private static BasepPack2Impl486 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl486 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl486();
        }
        return INSTANCE;
    }

    private BasepPack2Impl486(){
