...
public class BasepPack2Impl337 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl337.class);
    private static BasepPack2Impl337 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl337 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl337();
        }
        return INSTANCE;
    }

    private BasepPack2Impl337(){
