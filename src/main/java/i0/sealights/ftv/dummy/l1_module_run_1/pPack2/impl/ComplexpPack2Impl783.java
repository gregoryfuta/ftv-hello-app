...
public class ComplexpPack2Impl783 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl783.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl783 INSTANCE;

    public static ComplexpPack2Impl783 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl783();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl783(){
