...
public class BasepPack2Impl447 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl447.class);
    private static BasepPack2Impl447 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl447 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl447();
        }
        return INSTANCE;
    }

    private BasepPack2Impl447(){
