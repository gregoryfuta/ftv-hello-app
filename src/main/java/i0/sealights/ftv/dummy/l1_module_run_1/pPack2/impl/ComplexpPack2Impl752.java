...
public class ComplexpPack2Impl752 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl752.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl752 INSTANCE;

    public static ComplexpPack2Impl752 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl752();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl752(){
