...
public class BasepPack1Impl93 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl93.class);
    private static BasepPack1Impl93 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl93 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl93();
        }
        return INSTANCE;
    }

    private BasepPack1Impl93(){
