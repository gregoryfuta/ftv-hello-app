...
public class ComplexpPack2Impl507 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl507.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl507 INSTANCE;

    public static ComplexpPack2Impl507 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl507();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl507(){
