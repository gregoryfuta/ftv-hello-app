...
public class ComplexpPack1Impl745 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl745.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl745 INSTANCE;

    public static ComplexpPack1Impl745 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl745();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl745(){
