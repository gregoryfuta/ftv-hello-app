...
public class BasepPack2Impl628 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl628.class);
    private static BasepPack2Impl628 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl628 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl628();
        }
        return INSTANCE;
    }

    private BasepPack2Impl628(){
