...
public class BasepPack1Impl525 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl525.class);
    private static BasepPack1Impl525 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl525 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl525();
        }
        return INSTANCE;
    }

    private BasepPack1Impl525(){
