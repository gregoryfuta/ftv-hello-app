...
public class ComplexpPack1Impl999 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl999.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl999 INSTANCE;

    public static ComplexpPack1Impl999 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl999();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl999(){
