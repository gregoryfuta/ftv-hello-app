...
public class BasepPack1Impl58 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl58.class);
    private static BasepPack1Impl58 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl58 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl58();
        }
        return INSTANCE;
    }

    private BasepPack1Impl58(){
