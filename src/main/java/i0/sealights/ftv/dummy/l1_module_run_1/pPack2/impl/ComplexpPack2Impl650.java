...
public class ComplexpPack2Impl650 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl650.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl650 INSTANCE;

    public static ComplexpPack2Impl650 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl650();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl650(){
