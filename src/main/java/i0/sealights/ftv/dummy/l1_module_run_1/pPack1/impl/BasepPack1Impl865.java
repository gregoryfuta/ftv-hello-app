...
public class BasepPack1Impl865 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl865.class);
    private static BasepPack1Impl865 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl865 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl865();
        }
        return INSTANCE;
    }

    private BasepPack1Impl865(){
