...
public class ComplexpPack2Impl11 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl11.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl11 INSTANCE;

    public static ComplexpPack2Impl11 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl11();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl11(){
