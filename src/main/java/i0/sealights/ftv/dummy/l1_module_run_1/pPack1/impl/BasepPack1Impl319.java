...
public class BasepPack1Impl319 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl319.class);
    private static BasepPack1Impl319 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl319 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl319();
        }
        return INSTANCE;
    }

    private BasepPack1Impl319(){
