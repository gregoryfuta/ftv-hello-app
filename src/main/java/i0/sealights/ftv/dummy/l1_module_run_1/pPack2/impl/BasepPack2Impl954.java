...
public class BasepPack2Impl954 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl954.class);
    private static BasepPack2Impl954 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl954 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl954();
        }
        return INSTANCE;
    }

    private BasepPack2Impl954(){
