...
public class BasepPack2Impl765 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl765.class);
    private static BasepPack2Impl765 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl765 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl765();
        }
        return INSTANCE;
    }

    private BasepPack2Impl765(){
