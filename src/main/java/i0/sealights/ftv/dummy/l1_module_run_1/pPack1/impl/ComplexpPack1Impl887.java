...
public class ComplexpPack1Impl887 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl887.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl887 INSTANCE;

    public static ComplexpPack1Impl887 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl887();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl887(){
