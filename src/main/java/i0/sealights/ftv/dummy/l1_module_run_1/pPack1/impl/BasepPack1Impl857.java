...
public class BasepPack1Impl857 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl857.class);
    private static BasepPack1Impl857 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl857 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl857();
        }
        return INSTANCE;
    }

    private BasepPack1Impl857(){
