...
public class BasepPack2Impl187 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl187.class);
    private static BasepPack2Impl187 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl187 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl187();
        }
        return INSTANCE;
    }

    private BasepPack2Impl187(){
