...
public class ComplexpPack2Impl62 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl62.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl62 INSTANCE;

    public static ComplexpPack2Impl62 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl62();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl62(){
