...
public class BasepPack2Impl9 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl9.class);
    private static BasepPack2Impl9 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl9 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl9();
        }
        return INSTANCE;
    }

    private BasepPack2Impl9(){
