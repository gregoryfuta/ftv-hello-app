...
public class BasepPack1Impl978 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl978.class);
    private static BasepPack1Impl978 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl978 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl978();
        }
        return INSTANCE;
    }

    private BasepPack1Impl978(){
