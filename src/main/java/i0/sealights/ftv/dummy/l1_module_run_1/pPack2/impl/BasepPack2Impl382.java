...
public class BasepPack2Impl382 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl382.class);
    private static BasepPack2Impl382 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl382 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl382();
        }
        return INSTANCE;
    }

    private BasepPack2Impl382(){
