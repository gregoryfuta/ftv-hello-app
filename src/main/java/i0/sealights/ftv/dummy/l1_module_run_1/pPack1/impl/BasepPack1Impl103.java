...
public class BasepPack1Impl103 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl103.class);
    private static BasepPack1Impl103 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl103 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl103();
        }
        return INSTANCE;
    }

    private BasepPack1Impl103(){
