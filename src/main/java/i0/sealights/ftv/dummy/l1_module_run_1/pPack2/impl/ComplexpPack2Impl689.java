...
public class ComplexpPack2Impl689 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl689.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl689 INSTANCE;

    public static ComplexpPack2Impl689 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl689();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl689(){
