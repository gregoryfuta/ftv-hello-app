...
public class ComplexpPack2Impl949 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl949.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl949 INSTANCE;

    public static ComplexpPack2Impl949 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl949();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl949(){
