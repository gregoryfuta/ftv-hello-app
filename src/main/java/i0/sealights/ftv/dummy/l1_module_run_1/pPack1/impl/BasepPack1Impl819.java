...
public class BasepPack1Impl819 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl819.class);
    private static BasepPack1Impl819 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl819 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl819();
        }
        return INSTANCE;
    }

    private BasepPack1Impl819(){
