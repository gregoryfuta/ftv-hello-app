...
public class BasepPack1Impl740 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl740.class);
    private static BasepPack1Impl740 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl740 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl740();
        }
        return INSTANCE;
    }

    private BasepPack1Impl740(){
