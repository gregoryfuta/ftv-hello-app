...
public class ComplexpPack2Impl528 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl528.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl528 INSTANCE;

    public static ComplexpPack2Impl528 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl528();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl528(){
