...
public class BasepPack1Impl860 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl860.class);
    private static BasepPack1Impl860 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl860 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl860();
        }
        return INSTANCE;
    }

    private BasepPack1Impl860(){
