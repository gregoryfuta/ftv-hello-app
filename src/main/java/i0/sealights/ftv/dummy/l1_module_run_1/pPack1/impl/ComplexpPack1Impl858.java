...
public class ComplexpPack1Impl858 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl858.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl858 INSTANCE;

    public static ComplexpPack1Impl858 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl858();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl858(){
