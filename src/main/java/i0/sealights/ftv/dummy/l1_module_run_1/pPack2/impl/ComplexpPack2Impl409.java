...
public class ComplexpPack2Impl409 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl409.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl409 INSTANCE;

    public static ComplexpPack2Impl409 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl409();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl409(){
