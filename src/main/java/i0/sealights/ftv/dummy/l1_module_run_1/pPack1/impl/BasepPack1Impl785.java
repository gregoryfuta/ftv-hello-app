...
public class BasepPack1Impl785 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl785.class);
    private static BasepPack1Impl785 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl785 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl785();
        }
        return INSTANCE;
    }

    private BasepPack1Impl785(){
