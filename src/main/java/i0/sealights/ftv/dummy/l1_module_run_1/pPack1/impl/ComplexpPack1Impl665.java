...
public class ComplexpPack1Impl665 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl665.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl665 INSTANCE;

    public static ComplexpPack1Impl665 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl665();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl665(){
