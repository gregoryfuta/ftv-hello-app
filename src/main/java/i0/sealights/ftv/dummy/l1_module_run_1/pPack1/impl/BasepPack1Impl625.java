...
public class BasepPack1Impl625 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl625.class);
    private static BasepPack1Impl625 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl625 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl625();
        }
        return INSTANCE;
    }

    private BasepPack1Impl625(){
