...
public class BasepPack1Impl593 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl593.class);
    private static BasepPack1Impl593 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl593 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl593();
        }
        return INSTANCE;
    }

    private BasepPack1Impl593(){
