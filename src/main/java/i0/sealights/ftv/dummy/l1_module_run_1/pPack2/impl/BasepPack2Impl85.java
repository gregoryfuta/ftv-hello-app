...
public class BasepPack2Impl85 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl85.class);
    private static BasepPack2Impl85 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl85 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl85();
        }
        return INSTANCE;
    }

    private BasepPack2Impl85(){
