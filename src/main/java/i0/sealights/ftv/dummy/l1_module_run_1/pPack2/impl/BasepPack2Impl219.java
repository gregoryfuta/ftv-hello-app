...
public class BasepPack2Impl219 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl219.class);
    private static BasepPack2Impl219 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl219 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl219();
        }
        return INSTANCE;
    }

    private BasepPack2Impl219(){
