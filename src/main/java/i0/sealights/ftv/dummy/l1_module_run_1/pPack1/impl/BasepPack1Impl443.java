...
public class BasepPack1Impl443 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl443.class);
    private static BasepPack1Impl443 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl443 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl443();
        }
        return INSTANCE;
    }

    private BasepPack1Impl443(){
