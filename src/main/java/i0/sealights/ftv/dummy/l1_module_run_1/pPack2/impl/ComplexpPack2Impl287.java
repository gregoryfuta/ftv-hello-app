...
public class ComplexpPack2Impl287 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl287.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl287 INSTANCE;

    public static ComplexpPack2Impl287 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl287();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl287(){
