...
public class ComplexpPack1Impl425 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl425.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl425 INSTANCE;

    public static ComplexpPack1Impl425 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl425();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl425(){
