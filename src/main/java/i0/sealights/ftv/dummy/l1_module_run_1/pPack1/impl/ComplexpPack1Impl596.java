...
public class ComplexpPack1Impl596 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl596.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl596 INSTANCE;

    public static ComplexpPack1Impl596 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl596();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl596(){
