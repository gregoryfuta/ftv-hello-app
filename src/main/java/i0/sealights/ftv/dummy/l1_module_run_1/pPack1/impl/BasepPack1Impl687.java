...
public class BasepPack1Impl687 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl687.class);
    private static BasepPack1Impl687 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl687 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl687();
        }
        return INSTANCE;
    }

    private BasepPack1Impl687(){
