...
public class BasepPack2Impl141 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl141.class);
    private static BasepPack2Impl141 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl141 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl141();
        }
        return INSTANCE;
    }

    private BasepPack2Impl141(){
