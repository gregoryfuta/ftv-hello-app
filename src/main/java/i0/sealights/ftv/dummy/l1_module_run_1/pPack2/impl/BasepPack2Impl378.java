...
public class BasepPack2Impl378 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl378.class);
    private static BasepPack2Impl378 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl378 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl378();
        }
        return INSTANCE;
    }

    private BasepPack2Impl378(){
