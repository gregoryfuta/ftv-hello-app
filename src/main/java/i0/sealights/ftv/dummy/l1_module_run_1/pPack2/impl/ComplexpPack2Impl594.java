...
public class ComplexpPack2Impl594 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl594.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl594 INSTANCE;

    public static ComplexpPack2Impl594 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl594();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl594(){
