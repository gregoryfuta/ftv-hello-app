...
public class BasepPack1Impl380 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl380.class);
    private static BasepPack1Impl380 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl380 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl380();
        }
        return INSTANCE;
    }

    private BasepPack1Impl380(){
