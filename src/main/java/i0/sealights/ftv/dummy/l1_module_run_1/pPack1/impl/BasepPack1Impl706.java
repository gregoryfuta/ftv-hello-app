...
public class BasepPack1Impl706 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl706.class);
    private static BasepPack1Impl706 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl706 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl706();
        }
        return INSTANCE;
    }

    private BasepPack1Impl706(){
