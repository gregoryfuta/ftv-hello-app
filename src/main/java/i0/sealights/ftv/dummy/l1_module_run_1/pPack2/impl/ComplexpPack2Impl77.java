...
public class ComplexpPack2Impl77 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl77.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl77 INSTANCE;

    public static ComplexpPack2Impl77 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl77();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl77(){
