...
public class BasepPack1Impl532 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl532.class);
    private static BasepPack1Impl532 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl532 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl532();
        }
        return INSTANCE;
    }

    private BasepPack1Impl532(){
