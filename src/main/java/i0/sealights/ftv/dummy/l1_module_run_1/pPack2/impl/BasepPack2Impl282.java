...
public class BasepPack2Impl282 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl282.class);
    private static BasepPack2Impl282 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl282 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl282();
        }
        return INSTANCE;
    }

    private BasepPack2Impl282(){
