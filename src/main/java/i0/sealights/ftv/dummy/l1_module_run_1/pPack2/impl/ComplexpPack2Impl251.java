...
public class ComplexpPack2Impl251 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl251.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl251 INSTANCE;

    public static ComplexpPack2Impl251 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl251();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl251(){
