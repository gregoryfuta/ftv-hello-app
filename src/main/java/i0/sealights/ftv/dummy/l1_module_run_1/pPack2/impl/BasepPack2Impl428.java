...
public class BasepPack2Impl428 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl428.class);
    private static BasepPack2Impl428 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl428 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl428();
        }
        return INSTANCE;
    }

    private BasepPack2Impl428(){
