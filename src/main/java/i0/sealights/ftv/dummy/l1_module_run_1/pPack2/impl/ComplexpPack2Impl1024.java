...
public class ComplexpPack2Impl1024 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1024.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1024 INSTANCE;

    public static ComplexpPack2Impl1024 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1024();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1024(){
