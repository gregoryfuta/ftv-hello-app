...
public class BasepPack1Impl95 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl95.class);
    private static BasepPack1Impl95 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl95 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl95();
        }
        return INSTANCE;
    }

    private BasepPack1Impl95(){
