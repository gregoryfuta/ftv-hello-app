...
public class ComplexpPack1Impl81 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl81.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl81 INSTANCE;

    public static ComplexpPack1Impl81 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl81();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl81(){
