...
public class ComplexpPack2Impl139 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl139.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl139 INSTANCE;

    public static ComplexpPack2Impl139 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl139();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl139(){
