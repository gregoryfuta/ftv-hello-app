...
public class BasepPack2Impl653 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl653.class);
    private static BasepPack2Impl653 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl653 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl653();
        }
        return INSTANCE;
    }

    private BasepPack2Impl653(){
