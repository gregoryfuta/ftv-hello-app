...
public class ComplexpPack1Impl531 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl531.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl531 INSTANCE;

    public static ComplexpPack1Impl531 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl531();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl531(){
