...
public class BasepPack1Impl246 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl246.class);
    private static BasepPack1Impl246 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl246 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl246();
        }
        return INSTANCE;
    }

    private BasepPack1Impl246(){
