...
public class ComplexpPack2Impl582 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl582.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl582 INSTANCE;

    public static ComplexpPack2Impl582 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl582();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl582(){
