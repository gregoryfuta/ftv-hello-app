...
public class BasepPack1Impl470 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl470.class);
    private static BasepPack1Impl470 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl470 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl470();
        }
        return INSTANCE;
    }

    private BasepPack1Impl470(){
