...
public class BasepPack2Impl144 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl144.class);
    private static BasepPack2Impl144 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl144 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl144();
        }
        return INSTANCE;
    }

    private BasepPack2Impl144(){
