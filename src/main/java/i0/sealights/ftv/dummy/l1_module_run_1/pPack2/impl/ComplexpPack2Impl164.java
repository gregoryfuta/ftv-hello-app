...
public class ComplexpPack2Impl164 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl164.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl164 INSTANCE;

    public static ComplexpPack2Impl164 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl164();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl164(){
