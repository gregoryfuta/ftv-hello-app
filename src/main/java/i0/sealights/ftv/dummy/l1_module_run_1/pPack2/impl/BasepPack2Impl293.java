...
public class BasepPack2Impl293 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl293.class);
    private static BasepPack2Impl293 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl293 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl293();
        }
        return INSTANCE;
    }

    private BasepPack2Impl293(){
