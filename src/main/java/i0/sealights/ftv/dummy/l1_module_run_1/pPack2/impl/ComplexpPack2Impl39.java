...
public class ComplexpPack2Impl39 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl39.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl39 INSTANCE;

    public static ComplexpPack2Impl39 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl39();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl39(){
