...
public class ComplexpPack1Impl534 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl534.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl534 INSTANCE;

    public static ComplexpPack1Impl534 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl534();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl534(){
