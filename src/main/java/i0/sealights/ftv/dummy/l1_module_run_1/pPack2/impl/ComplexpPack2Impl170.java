...
public class ComplexpPack2Impl170 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl170.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl170 INSTANCE;

    public static ComplexpPack2Impl170 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl170();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl170(){
