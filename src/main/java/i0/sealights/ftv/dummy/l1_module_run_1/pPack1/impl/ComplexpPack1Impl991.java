...
public class ComplexpPack1Impl991 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl991.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl991 INSTANCE;

    public static ComplexpPack1Impl991 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl991();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl991(){
