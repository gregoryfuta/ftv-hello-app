...
public class BasepPack1Impl678 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl678.class);
    private static BasepPack1Impl678 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl678 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl678();
        }
        return INSTANCE;
    }

    private BasepPack1Impl678(){
