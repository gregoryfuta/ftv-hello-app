...
public class BasepPack2Impl205 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl205.class);
    private static BasepPack2Impl205 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl205 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl205();
        }
        return INSTANCE;
    }

    private BasepPack2Impl205(){
