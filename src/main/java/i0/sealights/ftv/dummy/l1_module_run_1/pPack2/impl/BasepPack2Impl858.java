...
public class BasepPack2Impl858 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl858.class);
    private static BasepPack2Impl858 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl858 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl858();
        }
        return INSTANCE;
    }

    private BasepPack2Impl858(){
