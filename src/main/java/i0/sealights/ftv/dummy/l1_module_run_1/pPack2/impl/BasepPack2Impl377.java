...
public class BasepPack2Impl377 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl377.class);
    private static BasepPack2Impl377 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl377 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl377();
        }
        return INSTANCE;
    }

    private BasepPack2Impl377(){
