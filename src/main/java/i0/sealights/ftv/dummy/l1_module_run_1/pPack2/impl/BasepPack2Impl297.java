...
public class BasepPack2Impl297 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl297.class);
    private static BasepPack2Impl297 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl297 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl297();
        }
        return INSTANCE;
    }

    private BasepPack2Impl297(){
