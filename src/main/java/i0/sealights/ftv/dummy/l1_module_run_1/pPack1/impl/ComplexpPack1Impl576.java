...
public class ComplexpPack1Impl576 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl576.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl576 INSTANCE;

    public static ComplexpPack1Impl576 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl576();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl576(){
