...
public class ComplexpPack2Impl51 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl51.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl51 INSTANCE;

    public static ComplexpPack2Impl51 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl51();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl51(){
