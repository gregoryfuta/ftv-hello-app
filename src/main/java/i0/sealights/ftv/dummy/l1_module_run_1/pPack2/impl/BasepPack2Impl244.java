...
public class BasepPack2Impl244 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl244.class);
    private static BasepPack2Impl244 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl244 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl244();
        }
        return INSTANCE;
    }

    private BasepPack2Impl244(){
