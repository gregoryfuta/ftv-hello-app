...
public class BasepPack2Impl551 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl551.class);
    private static BasepPack2Impl551 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl551 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl551();
        }
        return INSTANCE;
    }

    private BasepPack2Impl551(){
