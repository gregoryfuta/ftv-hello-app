...
public class BasepPack2Impl27 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl27.class);
    private static BasepPack2Impl27 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl27 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl27();
        }
        return INSTANCE;
    }

    private BasepPack2Impl27(){
