...
public class BasepPack2Impl806 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl806.class);
    private static BasepPack2Impl806 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl806 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl806();
        }
        return INSTANCE;
    }

    private BasepPack2Impl806(){
