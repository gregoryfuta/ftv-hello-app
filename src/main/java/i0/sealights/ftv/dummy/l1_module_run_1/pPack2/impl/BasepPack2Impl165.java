...
public class BasepPack2Impl165 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl165.class);
    private static BasepPack2Impl165 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl165 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl165();
        }
        return INSTANCE;
    }

    private BasepPack2Impl165(){
