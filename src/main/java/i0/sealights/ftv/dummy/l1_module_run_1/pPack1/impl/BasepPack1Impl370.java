...
public class BasepPack1Impl370 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl370.class);
    private static BasepPack1Impl370 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl370 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl370();
        }
        return INSTANCE;
    }

    private BasepPack1Impl370(){
