...
public class ComplexpPack1Impl781 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl781.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl781 INSTANCE;

    public static ComplexpPack1Impl781 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl781();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl781(){
