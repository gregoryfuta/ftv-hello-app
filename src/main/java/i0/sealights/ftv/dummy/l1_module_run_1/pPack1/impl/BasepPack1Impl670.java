...
public class BasepPack1Impl670 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl670.class);
    private static BasepPack1Impl670 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl670 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl670();
        }
        return INSTANCE;
    }

    private BasepPack1Impl670(){
