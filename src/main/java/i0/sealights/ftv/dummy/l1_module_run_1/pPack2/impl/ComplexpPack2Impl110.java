...
public class ComplexpPack2Impl110 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl110.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl110 INSTANCE;

    public static ComplexpPack2Impl110 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl110();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl110(){
