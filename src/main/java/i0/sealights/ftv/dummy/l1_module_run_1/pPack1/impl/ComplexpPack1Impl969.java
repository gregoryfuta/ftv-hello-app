...
public class ComplexpPack1Impl969 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl969.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl969 INSTANCE;

    public static ComplexpPack1Impl969 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl969();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl969(){
