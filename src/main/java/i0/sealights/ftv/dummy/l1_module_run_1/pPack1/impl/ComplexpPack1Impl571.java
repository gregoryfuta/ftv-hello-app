...
public class ComplexpPack1Impl571 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl571.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl571 INSTANCE;

    public static ComplexpPack1Impl571 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl571();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl571(){
