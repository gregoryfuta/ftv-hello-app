...
public class BasepPack1Impl652 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl652.class);
    private static BasepPack1Impl652 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl652 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl652();
        }
        return INSTANCE;
    }

    private BasepPack1Impl652(){
