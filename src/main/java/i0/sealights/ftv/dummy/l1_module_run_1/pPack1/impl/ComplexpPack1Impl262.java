...
public class ComplexpPack1Impl262 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl262.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl262 INSTANCE;

    public static ComplexpPack1Impl262 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl262();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl262(){
