...
public class BasepPack1Impl542 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl542.class);
    private static BasepPack1Impl542 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl542 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl542();
        }
        return INSTANCE;
    }

    private BasepPack1Impl542(){
