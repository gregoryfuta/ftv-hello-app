...
public class ComplexpPack2Impl856 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl856.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl856 INSTANCE;

    public static ComplexpPack2Impl856 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl856();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl856(){
