...
public class BasepPack1Impl621 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl621.class);
    private static BasepPack1Impl621 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl621 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl621();
        }
        return INSTANCE;
    }

    private BasepPack1Impl621(){
