...
public class BasepPack1Impl183 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl183.class);
    private static BasepPack1Impl183 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl183 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl183();
        }
        return INSTANCE;
    }

    private BasepPack1Impl183(){
