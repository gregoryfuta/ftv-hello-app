...
public class ComplexpPack1Impl599 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl599.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl599 INSTANCE;

    public static ComplexpPack1Impl599 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl599();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl599(){
