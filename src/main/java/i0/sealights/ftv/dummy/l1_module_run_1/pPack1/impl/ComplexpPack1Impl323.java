...
public class ComplexpPack1Impl323 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl323.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl323 INSTANCE;

    public static ComplexpPack1Impl323 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl323();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl323(){
