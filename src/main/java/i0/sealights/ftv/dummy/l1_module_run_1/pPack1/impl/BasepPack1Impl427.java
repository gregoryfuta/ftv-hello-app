...
public class BasepPack1Impl427 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl427.class);
    private static BasepPack1Impl427 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl427 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl427();
        }
        return INSTANCE;
    }

    private BasepPack1Impl427(){
