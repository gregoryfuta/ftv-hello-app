...
public class BasepPack1Impl777 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl777.class);
    private static BasepPack1Impl777 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl777 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl777();
        }
        return INSTANCE;
    }

    private BasepPack1Impl777(){
