...
public class ComplexpPack1Impl545 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl545.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl545 INSTANCE;

    public static ComplexpPack1Impl545 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl545();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl545(){
