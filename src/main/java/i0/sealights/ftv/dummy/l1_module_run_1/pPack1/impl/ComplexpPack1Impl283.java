...
public class ComplexpPack1Impl283 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl283.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl283 INSTANCE;

    public static ComplexpPack1Impl283 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl283();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl283(){
