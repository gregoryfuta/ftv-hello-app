...
public class BasepPack2Impl613 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl613.class);
    private static BasepPack2Impl613 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl613 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl613();
        }
        return INSTANCE;
    }

    private BasepPack2Impl613(){
