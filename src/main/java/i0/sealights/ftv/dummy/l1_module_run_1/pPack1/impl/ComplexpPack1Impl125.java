...
public class ComplexpPack1Impl125 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl125.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl125 INSTANCE;

    public static ComplexpPack1Impl125 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl125();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl125(){
