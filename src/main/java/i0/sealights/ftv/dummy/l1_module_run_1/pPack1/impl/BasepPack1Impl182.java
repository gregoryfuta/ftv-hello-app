...
public class BasepPack1Impl182 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl182.class);
    private static BasepPack1Impl182 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl182 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl182();
        }
        return INSTANCE;
    }

    private BasepPack1Impl182(){
