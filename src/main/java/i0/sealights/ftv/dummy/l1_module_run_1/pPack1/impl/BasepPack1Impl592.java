...
public class BasepPack1Impl592 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl592.class);
    private static BasepPack1Impl592 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl592 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl592();
        }
        return INSTANCE;
    }

    private BasepPack1Impl592(){
