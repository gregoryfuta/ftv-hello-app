...
public class ComplexpPack2Impl530 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl530.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl530 INSTANCE;

    public static ComplexpPack2Impl530 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl530();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl530(){
