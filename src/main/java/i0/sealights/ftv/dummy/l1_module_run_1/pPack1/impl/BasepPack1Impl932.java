...
public class BasepPack1Impl932 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl932.class);
    private static BasepPack1Impl932 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl932 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl932();
        }
        return INSTANCE;
    }

    private BasepPack1Impl932(){
