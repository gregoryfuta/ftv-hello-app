...
public class ComplexpPack1Impl172 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl172.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl172 INSTANCE;

    public static ComplexpPack1Impl172 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl172();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl172(){
