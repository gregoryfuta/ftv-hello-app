...
public class ComplexpPack1Impl930 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl930.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl930 INSTANCE;

    public static ComplexpPack1Impl930 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl930();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl930(){
