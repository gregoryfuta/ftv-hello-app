...
public class BasepPack1Impl423 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl423.class);
    private static BasepPack1Impl423 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl423 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl423();
        }
        return INSTANCE;
    }

    private BasepPack1Impl423(){
