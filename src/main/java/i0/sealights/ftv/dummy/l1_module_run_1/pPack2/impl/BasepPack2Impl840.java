...
public class BasepPack2Impl840 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl840.class);
    private static BasepPack2Impl840 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl840 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl840();
        }
        return INSTANCE;
    }

    private BasepPack2Impl840(){
