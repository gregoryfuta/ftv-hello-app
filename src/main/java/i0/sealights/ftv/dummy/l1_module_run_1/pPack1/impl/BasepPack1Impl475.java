...
public class BasepPack1Impl475 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl475.class);
    private static BasepPack1Impl475 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl475 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl475();
        }
        return INSTANCE;
    }

    private BasepPack1Impl475(){
