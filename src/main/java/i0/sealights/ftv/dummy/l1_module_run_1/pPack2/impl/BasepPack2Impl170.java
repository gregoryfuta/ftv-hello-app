...
public class BasepPack2Impl170 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl170.class);
    private static BasepPack2Impl170 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl170 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl170();
        }
        return INSTANCE;
    }

    private BasepPack2Impl170(){
