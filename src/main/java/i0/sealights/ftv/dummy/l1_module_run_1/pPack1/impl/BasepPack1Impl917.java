...
public class BasepPack1Impl917 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl917.class);
    private static BasepPack1Impl917 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl917 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl917();
        }
        return INSTANCE;
    }

    private BasepPack1Impl917(){
