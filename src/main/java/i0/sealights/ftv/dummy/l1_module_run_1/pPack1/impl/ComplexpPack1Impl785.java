...
public class ComplexpPack1Impl785 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl785.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl785 INSTANCE;

    public static ComplexpPack1Impl785 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl785();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl785(){
