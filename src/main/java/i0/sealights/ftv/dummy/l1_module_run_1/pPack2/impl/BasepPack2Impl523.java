...
public class BasepPack2Impl523 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl523.class);
    private static BasepPack2Impl523 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl523 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl523();
        }
        return INSTANCE;
    }

    private BasepPack2Impl523(){
