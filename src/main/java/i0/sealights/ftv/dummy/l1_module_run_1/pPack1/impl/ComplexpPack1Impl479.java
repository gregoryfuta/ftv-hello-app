...
public class ComplexpPack1Impl479 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl479.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl479 INSTANCE;

    public static ComplexpPack1Impl479 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl479();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl479(){
