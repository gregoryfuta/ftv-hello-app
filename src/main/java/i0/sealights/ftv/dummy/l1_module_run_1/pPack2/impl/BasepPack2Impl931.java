...
public class BasepPack2Impl931 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl931.class);
    private static BasepPack2Impl931 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl931 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl931();
        }
        return INSTANCE;
    }

    private BasepPack2Impl931(){
