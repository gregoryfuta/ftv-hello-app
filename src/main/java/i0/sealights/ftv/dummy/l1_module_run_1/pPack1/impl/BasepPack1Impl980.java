...
public class BasepPack1Impl980 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl980.class);
    private static BasepPack1Impl980 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl980 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl980();
        }
        return INSTANCE;
    }

    private BasepPack1Impl980(){
