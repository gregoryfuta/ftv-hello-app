...
public class BasepPack2Impl463 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl463.class);
    private static BasepPack2Impl463 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl463 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl463();
        }
        return INSTANCE;
    }

    private BasepPack2Impl463(){
