...
public class ComplexpPack2Impl941 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl941.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl941 INSTANCE;

    public static ComplexpPack2Impl941 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl941();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl941(){
