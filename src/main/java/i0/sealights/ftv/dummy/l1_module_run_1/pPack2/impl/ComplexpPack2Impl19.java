...
public class ComplexpPack2Impl19 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl19.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl19 INSTANCE;

    public static ComplexpPack2Impl19 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl19();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl19(){
