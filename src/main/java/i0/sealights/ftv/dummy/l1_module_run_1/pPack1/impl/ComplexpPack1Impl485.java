...
public class ComplexpPack1Impl485 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl485.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl485 INSTANCE;

    public static ComplexpPack1Impl485 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl485();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl485(){
