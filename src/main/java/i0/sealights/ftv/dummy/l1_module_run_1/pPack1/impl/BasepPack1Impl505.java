...
public class BasepPack1Impl505 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl505.class);
    private static BasepPack1Impl505 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl505 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl505();
        }
        return INSTANCE;
    }

    private BasepPack1Impl505(){
