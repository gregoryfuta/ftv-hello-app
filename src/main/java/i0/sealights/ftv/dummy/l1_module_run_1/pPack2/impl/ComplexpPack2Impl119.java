...
public class ComplexpPack2Impl119 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl119.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl119 INSTANCE;

    public static ComplexpPack2Impl119 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl119();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl119(){
