...
public class ComplexpPack1Impl890 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl890.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl890 INSTANCE;

    public static ComplexpPack1Impl890 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl890();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl890(){
