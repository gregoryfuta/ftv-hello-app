...
public class ComplexpPack1Impl826 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl826.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl826 INSTANCE;

    public static ComplexpPack1Impl826 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl826();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl826(){
