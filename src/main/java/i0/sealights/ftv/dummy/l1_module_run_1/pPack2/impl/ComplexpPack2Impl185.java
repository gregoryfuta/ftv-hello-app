...
public class ComplexpPack2Impl185 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl185.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl185 INSTANCE;

    public static ComplexpPack2Impl185 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl185();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl185(){
