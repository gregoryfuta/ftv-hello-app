...
public class ComplexpPack1Impl42 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl42.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl42 INSTANCE;

    public static ComplexpPack1Impl42 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl42();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl42(){
