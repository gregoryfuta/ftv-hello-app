...
public class ComplexpPack1Impl406 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl406.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl406 INSTANCE;

    public static ComplexpPack1Impl406 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl406();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl406(){
