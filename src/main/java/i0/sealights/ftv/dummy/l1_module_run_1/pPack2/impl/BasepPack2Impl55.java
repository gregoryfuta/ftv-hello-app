...
public class BasepPack2Impl55 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl55.class);
    private static BasepPack2Impl55 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl55 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl55();
        }
        return INSTANCE;
    }

    private BasepPack2Impl55(){
