...
public class BasepPack1Impl434 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl434.class);
    private static BasepPack1Impl434 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl434 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl434();
        }
        return INSTANCE;
    }

    private BasepPack1Impl434(){
