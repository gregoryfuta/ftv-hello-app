...
public class ComplexpPack1Impl304 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl304.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl304 INSTANCE;

    public static ComplexpPack1Impl304 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl304();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl304(){
