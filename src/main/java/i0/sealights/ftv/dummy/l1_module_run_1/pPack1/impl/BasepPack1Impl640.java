...
public class BasepPack1Impl640 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl640.class);
    private static BasepPack1Impl640 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl640 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl640();
        }
        return INSTANCE;
    }

    private BasepPack1Impl640(){
