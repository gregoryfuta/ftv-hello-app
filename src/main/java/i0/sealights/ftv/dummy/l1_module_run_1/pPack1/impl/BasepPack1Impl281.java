...
public class BasepPack1Impl281 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl281.class);
    private static BasepPack1Impl281 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl281 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl281();
        }
        return INSTANCE;
    }

    private BasepPack1Impl281(){
