...
public class ComplexpPack1Impl888 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl888.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl888 INSTANCE;

    public static ComplexpPack1Impl888 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl888();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl888(){
