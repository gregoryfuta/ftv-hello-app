...
public class BasepPack2Impl335 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl335.class);
    private static BasepPack2Impl335 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl335 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl335();
        }
        return INSTANCE;
    }

    private BasepPack2Impl335(){
