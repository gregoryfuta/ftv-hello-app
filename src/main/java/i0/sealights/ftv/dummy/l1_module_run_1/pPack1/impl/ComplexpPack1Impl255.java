...
public class ComplexpPack1Impl255 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl255.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl255 INSTANCE;

    public static ComplexpPack1Impl255 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl255();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl255(){
