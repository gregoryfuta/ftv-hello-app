...
public class ComplexpPack1Impl85 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl85.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl85 INSTANCE;

    public static ComplexpPack1Impl85 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl85();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl85(){
