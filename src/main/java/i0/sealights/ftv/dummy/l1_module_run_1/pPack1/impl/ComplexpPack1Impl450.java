...
public class ComplexpPack1Impl450 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl450.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl450 INSTANCE;

    public static ComplexpPack1Impl450 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl450();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl450(){
