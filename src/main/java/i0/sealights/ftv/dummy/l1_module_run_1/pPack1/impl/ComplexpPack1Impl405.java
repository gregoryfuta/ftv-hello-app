...
public class ComplexpPack1Impl405 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl405.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl405 INSTANCE;

    public static ComplexpPack1Impl405 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl405();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl405(){
