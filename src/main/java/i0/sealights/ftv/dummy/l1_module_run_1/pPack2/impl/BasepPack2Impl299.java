...
public class BasepPack2Impl299 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl299.class);
    private static BasepPack2Impl299 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl299 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl299();
        }
        return INSTANCE;
    }

    private BasepPack2Impl299(){
