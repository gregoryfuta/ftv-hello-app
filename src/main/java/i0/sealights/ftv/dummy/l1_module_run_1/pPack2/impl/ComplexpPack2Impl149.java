...
public class ComplexpPack2Impl149 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl149.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl149 INSTANCE;

    public static ComplexpPack2Impl149 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl149();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl149(){
