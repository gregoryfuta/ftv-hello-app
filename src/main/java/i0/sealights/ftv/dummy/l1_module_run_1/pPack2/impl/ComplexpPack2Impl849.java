...
public class ComplexpPack2Impl849 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl849.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl849 INSTANCE;

    public static ComplexpPack2Impl849 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl849();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl849(){
