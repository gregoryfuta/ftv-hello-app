...
public class ComplexpPack1Impl820 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl820.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl820 INSTANCE;

    public static ComplexpPack1Impl820 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl820();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl820(){
