...
public class ComplexpPack2Impl263 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl263.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl263 INSTANCE;

    public static ComplexpPack2Impl263 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl263();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl263(){
