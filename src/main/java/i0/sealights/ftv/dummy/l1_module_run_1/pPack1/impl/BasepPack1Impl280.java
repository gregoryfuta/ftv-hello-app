...
public class BasepPack1Impl280 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl280.class);
    private static BasepPack1Impl280 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl280 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl280();
        }
        return INSTANCE;
    }

    private BasepPack1Impl280(){
