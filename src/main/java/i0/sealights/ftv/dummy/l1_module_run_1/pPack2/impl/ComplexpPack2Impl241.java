...
public class ComplexpPack2Impl241 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl241.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl241 INSTANCE;

    public static ComplexpPack2Impl241 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl241();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl241(){
