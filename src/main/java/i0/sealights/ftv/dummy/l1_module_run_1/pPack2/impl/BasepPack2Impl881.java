...
public class BasepPack2Impl881 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl881.class);
    private static BasepPack2Impl881 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl881 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl881();
        }
        return INSTANCE;
    }

    private BasepPack2Impl881(){
