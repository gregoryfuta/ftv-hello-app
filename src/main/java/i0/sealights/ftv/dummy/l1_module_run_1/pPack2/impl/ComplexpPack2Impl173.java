...
public class ComplexpPack2Impl173 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl173.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl173 INSTANCE;

    public static ComplexpPack2Impl173 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl173();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl173(){
