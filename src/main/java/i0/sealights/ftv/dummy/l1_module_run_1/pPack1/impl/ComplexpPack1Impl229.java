...
public class ComplexpPack1Impl229 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl229.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl229 INSTANCE;

    public static ComplexpPack1Impl229 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl229();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl229(){
