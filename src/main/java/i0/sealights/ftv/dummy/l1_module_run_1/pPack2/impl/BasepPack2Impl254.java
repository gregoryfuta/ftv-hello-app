...
public class BasepPack2Impl254 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl254.class);
    private static BasepPack2Impl254 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl254 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl254();
        }
        return INSTANCE;
    }

    private BasepPack2Impl254(){
