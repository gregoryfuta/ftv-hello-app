...
public class BasepPack1Impl548 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl548.class);
    private static BasepPack1Impl548 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl548 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl548();
        }
        return INSTANCE;
    }

    private BasepPack1Impl548(){
