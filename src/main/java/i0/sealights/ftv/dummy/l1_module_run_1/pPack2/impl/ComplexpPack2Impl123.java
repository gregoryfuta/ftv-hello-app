...
public class ComplexpPack2Impl123 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl123.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl123 INSTANCE;

    public static ComplexpPack2Impl123 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl123();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl123(){
