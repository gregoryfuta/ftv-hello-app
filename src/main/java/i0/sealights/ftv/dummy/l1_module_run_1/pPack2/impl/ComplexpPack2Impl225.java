...
public class ComplexpPack2Impl225 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl225.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl225 INSTANCE;

    public static ComplexpPack2Impl225 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl225();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl225(){
