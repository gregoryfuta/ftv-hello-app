...
public class BasepPack1Impl847 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl847.class);
    private static BasepPack1Impl847 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl847 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl847();
        }
        return INSTANCE;
    }

    private BasepPack1Impl847(){
