...
public class BasepPack1Impl682 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl682.class);
    private static BasepPack1Impl682 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl682 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl682();
        }
        return INSTANCE;
    }

    private BasepPack1Impl682(){
