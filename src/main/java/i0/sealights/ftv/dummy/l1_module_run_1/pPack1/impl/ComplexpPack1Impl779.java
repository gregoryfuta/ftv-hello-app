...
public class ComplexpPack1Impl779 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl779.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl779 INSTANCE;

    public static ComplexpPack1Impl779 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl779();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl779(){
