...
public class ComplexpPack1Impl559 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl559.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl559 INSTANCE;

    public static ComplexpPack1Impl559 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl559();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl559(){
