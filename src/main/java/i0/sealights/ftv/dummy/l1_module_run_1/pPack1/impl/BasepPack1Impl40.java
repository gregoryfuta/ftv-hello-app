...
public class BasepPack1Impl40 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl40.class);
    private static BasepPack1Impl40 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl40 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl40();
        }
        return INSTANCE;
    }

    private BasepPack1Impl40(){
