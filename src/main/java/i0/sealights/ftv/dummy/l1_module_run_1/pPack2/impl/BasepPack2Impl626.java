...
public class BasepPack2Impl626 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl626.class);
    private static BasepPack2Impl626 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl626 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl626();
        }
        return INSTANCE;
    }

    private BasepPack2Impl626(){
