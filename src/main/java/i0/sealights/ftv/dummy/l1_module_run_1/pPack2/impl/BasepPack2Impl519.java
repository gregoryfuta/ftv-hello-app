...
public class BasepPack2Impl519 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl519.class);
    private static BasepPack2Impl519 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl519 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl519();
        }
        return INSTANCE;
    }

    private BasepPack2Impl519(){
