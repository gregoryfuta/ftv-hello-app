...
public class ComplexpPack2Impl399 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl399.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl399 INSTANCE;

    public static ComplexpPack2Impl399 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl399();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl399(){
