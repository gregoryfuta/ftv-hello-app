...
public class ComplexpPack1Impl756 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl756.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl756 INSTANCE;

    public static ComplexpPack1Impl756 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl756();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl756(){
