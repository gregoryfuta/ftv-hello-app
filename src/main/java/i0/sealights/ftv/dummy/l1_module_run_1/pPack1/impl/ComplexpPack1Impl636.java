...
public class ComplexpPack1Impl636 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl636.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl636 INSTANCE;

    public static ComplexpPack1Impl636 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl636();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl636(){
