...
public class ComplexpPack2Impl391 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl391.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl391 INSTANCE;

    public static ComplexpPack2Impl391 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl391();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl391(){
