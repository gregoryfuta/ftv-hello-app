...
public class BasepPack1Impl132 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl132.class);
    private static BasepPack1Impl132 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl132 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl132();
        }
        return INSTANCE;
    }

    private BasepPack1Impl132(){
