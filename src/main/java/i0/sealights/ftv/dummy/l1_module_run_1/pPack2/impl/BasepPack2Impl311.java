...
public class BasepPack2Impl311 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl311.class);
    private static BasepPack2Impl311 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl311 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl311();
        }
        return INSTANCE;
    }

    private BasepPack2Impl311(){
