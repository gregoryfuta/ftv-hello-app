...
public class ComplexpPack2Impl887 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl887.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl887 INSTANCE;

    public static ComplexpPack2Impl887 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl887();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl887(){
