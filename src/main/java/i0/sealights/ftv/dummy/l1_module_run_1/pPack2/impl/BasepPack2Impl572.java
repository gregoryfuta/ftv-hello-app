...
public class BasepPack2Impl572 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl572.class);
    private static BasepPack2Impl572 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl572 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl572();
        }
        return INSTANCE;
    }

    private BasepPack2Impl572(){
