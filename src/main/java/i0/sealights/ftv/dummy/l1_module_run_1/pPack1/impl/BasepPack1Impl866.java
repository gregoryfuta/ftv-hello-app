...
public class BasepPack1Impl866 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl866.class);
    private static BasepPack1Impl866 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl866 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl866();
        }
        return INSTANCE;
    }

    private BasepPack1Impl866(){
