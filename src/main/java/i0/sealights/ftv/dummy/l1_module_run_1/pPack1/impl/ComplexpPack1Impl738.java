...
public class ComplexpPack1Impl738 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl738.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl738 INSTANCE;

    public static ComplexpPack1Impl738 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl738();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl738(){
