...
public class BasepPack1Impl198 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl198.class);
    private static BasepPack1Impl198 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl198 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl198();
        }
        return INSTANCE;
    }

    private BasepPack1Impl198(){
