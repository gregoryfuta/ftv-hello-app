...
public class ComplexpPack2Impl464 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl464.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl464 INSTANCE;

    public static ComplexpPack2Impl464 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl464();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl464(){
