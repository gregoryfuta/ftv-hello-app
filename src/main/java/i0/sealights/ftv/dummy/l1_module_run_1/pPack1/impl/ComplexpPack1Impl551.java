...
public class ComplexpPack1Impl551 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl551.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl551 INSTANCE;

    public static ComplexpPack1Impl551 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl551();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl551(){
