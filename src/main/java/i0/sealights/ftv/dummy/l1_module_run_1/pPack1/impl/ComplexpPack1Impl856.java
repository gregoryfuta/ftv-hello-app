...
public class ComplexpPack1Impl856 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl856.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl856 INSTANCE;

    public static ComplexpPack1Impl856 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl856();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl856(){
