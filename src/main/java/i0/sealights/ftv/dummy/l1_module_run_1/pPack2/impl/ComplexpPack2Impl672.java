...
public class ComplexpPack2Impl672 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl672.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl672 INSTANCE;

    public static ComplexpPack2Impl672 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl672();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl672(){
