...
public class BasepPack2Impl300 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl300.class);
    private static BasepPack2Impl300 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl300 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl300();
        }
        return INSTANCE;
    }

    private BasepPack2Impl300(){
