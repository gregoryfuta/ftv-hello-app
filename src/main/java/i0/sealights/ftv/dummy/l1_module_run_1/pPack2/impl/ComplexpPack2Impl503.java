...
public class ComplexpPack2Impl503 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl503.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl503 INSTANCE;

    public static ComplexpPack2Impl503 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl503();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl503(){
