...
public class BasepPack1Impl419 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl419.class);
    private static BasepPack1Impl419 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl419 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl419();
        }
        return INSTANCE;
    }

    private BasepPack1Impl419(){
