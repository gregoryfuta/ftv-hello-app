...
public class BasepPack1Impl844 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl844.class);
    private static BasepPack1Impl844 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl844 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl844();
        }
        return INSTANCE;
    }

    private BasepPack1Impl844(){
