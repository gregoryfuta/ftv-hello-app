...
public class BasepPack1Impl145 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl145.class);
    private static BasepPack1Impl145 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl145 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl145();
        }
        return INSTANCE;
    }

    private BasepPack1Impl145(){
