...
public class BasepPack1Impl436 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl436.class);
    private static BasepPack1Impl436 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl436 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl436();
        }
        return INSTANCE;
    }

    private BasepPack1Impl436(){
