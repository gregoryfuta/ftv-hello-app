...
public class ComplexpPack2Impl798 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl798.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl798 INSTANCE;

    public static ComplexpPack2Impl798 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl798();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl798(){
