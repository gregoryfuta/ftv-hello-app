...
public class ComplexpPack1Impl194 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl194.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl194 INSTANCE;

    public static ComplexpPack1Impl194 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl194();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl194(){
