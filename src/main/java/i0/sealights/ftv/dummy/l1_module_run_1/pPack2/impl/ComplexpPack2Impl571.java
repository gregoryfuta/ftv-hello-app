...
public class ComplexpPack2Impl571 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl571.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl571 INSTANCE;

    public static ComplexpPack2Impl571 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl571();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl571(){
