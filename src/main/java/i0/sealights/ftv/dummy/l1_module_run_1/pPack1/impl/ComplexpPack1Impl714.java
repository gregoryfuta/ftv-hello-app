...
public class ComplexpPack1Impl714 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl714.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl714 INSTANCE;

    public static ComplexpPack1Impl714 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl714();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl714(){
