...
public class BasepPack2Impl202 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl202.class);
    private static BasepPack2Impl202 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl202 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl202();
        }
        return INSTANCE;
    }

    private BasepPack2Impl202(){
