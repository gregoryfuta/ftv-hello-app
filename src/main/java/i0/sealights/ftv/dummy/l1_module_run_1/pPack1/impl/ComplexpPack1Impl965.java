...
public class ComplexpPack1Impl965 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl965.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl965 INSTANCE;

    public static ComplexpPack1Impl965 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl965();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl965(){
