...
public class ComplexpPack1Impl281 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl281.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl281 INSTANCE;

    public static ComplexpPack1Impl281 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl281();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl281(){
