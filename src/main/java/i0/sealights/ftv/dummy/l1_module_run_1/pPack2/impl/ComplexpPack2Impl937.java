...
public class ComplexpPack2Impl937 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl937.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl937 INSTANCE;

    public static ComplexpPack2Impl937 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl937();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl937(){
