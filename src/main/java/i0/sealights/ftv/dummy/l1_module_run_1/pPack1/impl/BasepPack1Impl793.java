...
public class BasepPack1Impl793 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl793.class);
    private static BasepPack1Impl793 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl793 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl793();
        }
        return INSTANCE;
    }

    private BasepPack1Impl793(){
