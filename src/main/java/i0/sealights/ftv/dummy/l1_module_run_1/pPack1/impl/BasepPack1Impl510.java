...
public class BasepPack1Impl510 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl510.class);
    private static BasepPack1Impl510 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl510 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl510();
        }
        return INSTANCE;
    }

    private BasepPack1Impl510(){
