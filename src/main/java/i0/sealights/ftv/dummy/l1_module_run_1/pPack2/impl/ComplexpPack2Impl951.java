...
public class ComplexpPack2Impl951 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl951.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl951 INSTANCE;

    public static ComplexpPack2Impl951 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl951();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl951(){
