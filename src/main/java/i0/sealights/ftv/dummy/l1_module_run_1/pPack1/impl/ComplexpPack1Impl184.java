...
public class ComplexpPack1Impl184 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl184.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl184 INSTANCE;

    public static ComplexpPack1Impl184 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl184();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl184(){
