...
public class BasepPack2Impl64 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl64.class);
    private static BasepPack2Impl64 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl64 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl64();
        }
        return INSTANCE;
    }

    private BasepPack2Impl64(){
