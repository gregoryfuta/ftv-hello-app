...
public class BasepPack1Impl673 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl673.class);
    private static BasepPack1Impl673 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl673 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl673();
        }
        return INSTANCE;
    }

    private BasepPack1Impl673(){
