...
public class BasepPack1Impl781 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl781.class);
    private static BasepPack1Impl781 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl781 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl781();
        }
        return INSTANCE;
    }

    private BasepPack1Impl781(){
