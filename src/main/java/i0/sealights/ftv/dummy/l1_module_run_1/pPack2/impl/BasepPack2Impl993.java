...
public class BasepPack2Impl993 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl993.class);
    private static BasepPack2Impl993 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl993 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl993();
        }
        return INSTANCE;
    }

    private BasepPack2Impl993(){
