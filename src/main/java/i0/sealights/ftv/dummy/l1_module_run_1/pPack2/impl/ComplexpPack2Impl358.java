...
public class ComplexpPack2Impl358 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl358.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl358 INSTANCE;

    public static ComplexpPack2Impl358 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl358();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl358(){
