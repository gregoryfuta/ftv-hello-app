...
public class ComplexpPack2Impl142 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl142.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl142 INSTANCE;

    public static ComplexpPack2Impl142 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl142();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl142(){
