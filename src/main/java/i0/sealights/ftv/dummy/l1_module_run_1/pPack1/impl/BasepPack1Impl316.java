...
public class BasepPack1Impl316 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl316.class);
    private static BasepPack1Impl316 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl316 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl316();
        }
        return INSTANCE;
    }

    private BasepPack1Impl316(){
