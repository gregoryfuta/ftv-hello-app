...
public class BasepPack2Impl838 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl838.class);
    private static BasepPack2Impl838 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl838 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl838();
        }
        return INSTANCE;
    }

    private BasepPack2Impl838(){
