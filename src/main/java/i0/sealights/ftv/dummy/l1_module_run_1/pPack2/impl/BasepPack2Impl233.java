...
public class BasepPack2Impl233 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl233.class);
    private static BasepPack2Impl233 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl233 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl233();
        }
        return INSTANCE;
    }

    private BasepPack2Impl233(){
