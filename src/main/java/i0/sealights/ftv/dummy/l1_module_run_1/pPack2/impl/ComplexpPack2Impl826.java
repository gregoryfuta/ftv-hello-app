...
public class ComplexpPack2Impl826 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl826.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl826 INSTANCE;

    public static ComplexpPack2Impl826 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl826();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl826(){
