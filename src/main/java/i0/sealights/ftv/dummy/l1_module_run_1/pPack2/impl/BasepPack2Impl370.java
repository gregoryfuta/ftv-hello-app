...
public class BasepPack2Impl370 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl370.class);
    private static BasepPack2Impl370 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl370 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl370();
        }
        return INSTANCE;
    }

    private BasepPack2Impl370(){
