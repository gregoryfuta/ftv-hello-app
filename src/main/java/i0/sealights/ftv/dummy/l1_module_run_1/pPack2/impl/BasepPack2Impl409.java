...
public class BasepPack2Impl409 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl409.class);
    private static BasepPack2Impl409 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl409 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl409();
        }
        return INSTANCE;
    }

    private BasepPack2Impl409(){
