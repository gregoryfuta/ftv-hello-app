...
public class BasepPack2Impl779 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl779.class);
    private static BasepPack2Impl779 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl779 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl779();
        }
        return INSTANCE;
    }

    private BasepPack2Impl779(){
