...
public class BasepPack2Impl973 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl973.class);
    private static BasepPack2Impl973 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl973 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl973();
        }
        return INSTANCE;
    }

    private BasepPack2Impl973(){
