...
public class BasepPack1Impl812 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl812.class);
    private static BasepPack1Impl812 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl812 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl812();
        }
        return INSTANCE;
    }

    private BasepPack1Impl812(){
