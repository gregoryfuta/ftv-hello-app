...
public class ComplexpPack1Impl58 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl58.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl58 INSTANCE;

    public static ComplexpPack1Impl58 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl58();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl58(){
