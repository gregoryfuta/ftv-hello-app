...
public class BasepPack2Impl140 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl140.class);
    private static BasepPack2Impl140 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl140 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl140();
        }
        return INSTANCE;
    }

    private BasepPack2Impl140(){
