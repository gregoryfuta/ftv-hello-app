...
public class ComplexpPack1Impl94 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl94.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl94 INSTANCE;

    public static ComplexpPack1Impl94 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl94();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl94(){
