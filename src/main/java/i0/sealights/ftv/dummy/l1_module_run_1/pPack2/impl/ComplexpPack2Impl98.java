...
public class ComplexpPack2Impl98 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl98.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl98 INSTANCE;

    public static ComplexpPack2Impl98 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl98();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl98(){
