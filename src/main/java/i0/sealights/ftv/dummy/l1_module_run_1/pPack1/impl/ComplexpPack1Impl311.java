...
public class ComplexpPack1Impl311 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl311.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl311 INSTANCE;

    public static ComplexpPack1Impl311 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl311();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl311(){
