...
public class ComplexpPack2Impl664 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl664.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl664 INSTANCE;

    public static ComplexpPack2Impl664 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl664();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl664(){
