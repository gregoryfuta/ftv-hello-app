...
public class ComplexpPack1Impl906 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl906.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl906 INSTANCE;

    public static ComplexpPack1Impl906 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl906();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl906(){
