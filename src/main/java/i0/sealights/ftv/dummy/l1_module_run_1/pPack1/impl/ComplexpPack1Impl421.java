...
public class ComplexpPack1Impl421 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl421.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl421 INSTANCE;

    public static ComplexpPack1Impl421 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl421();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl421(){
