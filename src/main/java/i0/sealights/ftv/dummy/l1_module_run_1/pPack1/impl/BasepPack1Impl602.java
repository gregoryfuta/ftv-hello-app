...
public class BasepPack1Impl602 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl602.class);
    private static BasepPack1Impl602 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl602 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl602();
        }
        return INSTANCE;
    }

    private BasepPack1Impl602(){
