...
public class BasepPack1Impl1030 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1030.class);
    private static BasepPack1Impl1030 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1030 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1030();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1030(){
