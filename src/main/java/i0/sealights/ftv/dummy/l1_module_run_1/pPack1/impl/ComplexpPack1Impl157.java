...
public class ComplexpPack1Impl157 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl157.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl157 INSTANCE;

    public static ComplexpPack1Impl157 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl157();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl157(){
