...
public class BasepPack1Impl344 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl344.class);
    private static BasepPack1Impl344 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl344 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl344();
        }
        return INSTANCE;
    }

    private BasepPack1Impl344(){
