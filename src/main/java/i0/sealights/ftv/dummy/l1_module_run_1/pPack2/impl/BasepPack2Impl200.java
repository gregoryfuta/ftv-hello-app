...
public class BasepPack2Impl200 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl200.class);
    private static BasepPack2Impl200 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl200 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl200();
        }
        return INSTANCE;
    }

    private BasepPack2Impl200(){
