...
public class BasepPack1Impl196 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl196.class);
    private static BasepPack1Impl196 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl196 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl196();
        }
        return INSTANCE;
    }

    private BasepPack1Impl196(){
