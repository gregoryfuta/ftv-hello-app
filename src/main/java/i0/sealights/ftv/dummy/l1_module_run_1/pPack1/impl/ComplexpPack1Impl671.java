...
public class ComplexpPack1Impl671 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl671.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl671 INSTANCE;

    public static ComplexpPack1Impl671 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl671();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl671(){
