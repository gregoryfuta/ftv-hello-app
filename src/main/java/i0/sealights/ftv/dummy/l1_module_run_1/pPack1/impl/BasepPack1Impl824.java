...
public class BasepPack1Impl824 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl824.class);
    private static BasepPack1Impl824 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl824 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl824();
        }
        return INSTANCE;
    }

    private BasepPack1Impl824(){
