...
public class BasepPack2Impl710 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl710.class);
    private static BasepPack2Impl710 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl710 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl710();
        }
        return INSTANCE;
    }

    private BasepPack2Impl710(){
