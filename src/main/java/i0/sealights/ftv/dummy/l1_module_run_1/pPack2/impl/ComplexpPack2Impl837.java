...
public class ComplexpPack2Impl837 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl837.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl837 INSTANCE;

    public static ComplexpPack2Impl837 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl837();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl837(){
