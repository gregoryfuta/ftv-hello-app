...
public class BasepPack1Impl367 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl367.class);
    private static BasepPack1Impl367 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl367 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl367();
        }
        return INSTANCE;
    }

    private BasepPack1Impl367(){
