...
public class ComplexpPack1Impl786 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl786.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl786 INSTANCE;

    public static ComplexpPack1Impl786 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl786();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl786(){
