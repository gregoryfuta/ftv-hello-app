...
public class ComplexpPack1Impl889 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl889.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl889 INSTANCE;

    public static ComplexpPack1Impl889 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl889();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl889(){
