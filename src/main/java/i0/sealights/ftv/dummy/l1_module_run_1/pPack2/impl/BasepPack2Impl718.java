...
public class BasepPack2Impl718 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl718.class);
    private static BasepPack2Impl718 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl718 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl718();
        }
        return INSTANCE;
    }

    private BasepPack2Impl718(){
