...
public class ComplexpPack1Impl392 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl392.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl392 INSTANCE;

    public static ComplexpPack1Impl392 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl392();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl392(){
