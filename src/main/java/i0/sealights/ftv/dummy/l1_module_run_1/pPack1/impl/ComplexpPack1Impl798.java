...
public class ComplexpPack1Impl798 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl798.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl798 INSTANCE;

    public static ComplexpPack1Impl798 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl798();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl798(){
