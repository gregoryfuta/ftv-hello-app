...
public class BasepPack2Impl470 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl470.class);
    private static BasepPack2Impl470 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl470 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl470();
        }
        return INSTANCE;
    }

    private BasepPack2Impl470(){
