...
public class ComplexpPack1Impl117 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl117.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl117 INSTANCE;

    public static ComplexpPack1Impl117 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl117();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl117(){
