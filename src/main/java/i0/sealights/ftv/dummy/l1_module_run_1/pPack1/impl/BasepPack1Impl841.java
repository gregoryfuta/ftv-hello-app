...
public class BasepPack1Impl841 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl841.class);
    private static BasepPack1Impl841 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl841 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl841();
        }
        return INSTANCE;
    }

    private BasepPack1Impl841(){
