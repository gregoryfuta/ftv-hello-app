...
public class BasepPack1Impl584 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl584.class);
    private static BasepPack1Impl584 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl584 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl584();
        }
        return INSTANCE;
    }

    private BasepPack1Impl584(){
