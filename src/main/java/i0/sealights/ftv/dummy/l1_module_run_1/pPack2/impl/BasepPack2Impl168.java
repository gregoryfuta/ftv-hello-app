...
public class BasepPack2Impl168 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl168.class);
    private static BasepPack2Impl168 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl168 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl168();
        }
        return INSTANCE;
    }

    private BasepPack2Impl168(){
