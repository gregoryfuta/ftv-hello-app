...
public class ComplexpPack1Impl669 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl669.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl669 INSTANCE;

    public static ComplexpPack1Impl669 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl669();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl669(){
