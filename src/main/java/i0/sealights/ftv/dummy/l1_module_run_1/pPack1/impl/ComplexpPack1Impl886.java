...
public class ComplexpPack1Impl886 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl886.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl886 INSTANCE;

    public static ComplexpPack1Impl886 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl886();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl886(){
