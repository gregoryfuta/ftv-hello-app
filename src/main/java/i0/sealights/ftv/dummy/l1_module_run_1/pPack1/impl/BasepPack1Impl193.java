...
public class BasepPack1Impl193 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl193.class);
    private static BasepPack1Impl193 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl193 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl193();
        }
        return INSTANCE;
    }

    private BasepPack1Impl193(){
