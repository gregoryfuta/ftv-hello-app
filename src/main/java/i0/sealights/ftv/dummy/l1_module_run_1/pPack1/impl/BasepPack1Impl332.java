...
public class BasepPack1Impl332 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl332.class);
    private static BasepPack1Impl332 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl332 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl332();
        }
        return INSTANCE;
    }

    private BasepPack1Impl332(){
