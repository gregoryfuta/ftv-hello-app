...
public class ComplexpPack2Impl708 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl708.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl708 INSTANCE;

    public static ComplexpPack2Impl708 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl708();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl708(){
