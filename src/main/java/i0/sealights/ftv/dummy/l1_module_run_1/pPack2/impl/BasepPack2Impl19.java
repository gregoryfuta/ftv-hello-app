...
public class BasepPack2Impl19 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl19.class);
    private static BasepPack2Impl19 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl19 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl19();
        }
        return INSTANCE;
    }

    private BasepPack2Impl19(){
