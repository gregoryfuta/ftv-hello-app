...
public class ComplexpPack1Impl699 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl699.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl699 INSTANCE;

    public static ComplexpPack1Impl699 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl699();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl699(){
