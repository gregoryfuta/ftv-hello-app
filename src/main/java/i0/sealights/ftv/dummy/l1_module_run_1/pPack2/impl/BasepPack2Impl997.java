...
public class BasepPack2Impl997 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl997.class);
    private static BasepPack2Impl997 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl997 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl997();
        }
        return INSTANCE;
    }

    private BasepPack2Impl997(){
