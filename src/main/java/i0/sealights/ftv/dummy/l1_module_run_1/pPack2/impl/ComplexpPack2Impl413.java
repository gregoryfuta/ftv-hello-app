...
public class ComplexpPack2Impl413 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl413.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl413 INSTANCE;

    public static ComplexpPack2Impl413 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl413();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl413(){
