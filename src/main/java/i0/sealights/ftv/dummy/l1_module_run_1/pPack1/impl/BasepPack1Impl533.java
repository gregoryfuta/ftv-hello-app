...
public class BasepPack1Impl533 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl533.class);
    private static BasepPack1Impl533 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl533 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl533();
        }
        return INSTANCE;
    }

    private BasepPack1Impl533(){
