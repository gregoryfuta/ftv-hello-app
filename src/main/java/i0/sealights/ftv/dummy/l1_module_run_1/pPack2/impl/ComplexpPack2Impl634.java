...
public class ComplexpPack2Impl634 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl634.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl634 INSTANCE;

    public static ComplexpPack2Impl634 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl634();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl634(){
