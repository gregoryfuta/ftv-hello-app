...
public class BasepPack1Impl323 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl323.class);
    private static BasepPack1Impl323 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl323 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl323();
        }
        return INSTANCE;
    }

    private BasepPack1Impl323(){
