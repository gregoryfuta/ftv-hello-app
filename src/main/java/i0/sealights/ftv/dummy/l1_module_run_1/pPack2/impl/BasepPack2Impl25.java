...
public class BasepPack2Impl25 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl25.class);
    private static BasepPack2Impl25 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl25 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl25();
        }
        return INSTANCE;
    }

    private BasepPack2Impl25(){
