...
public class ComplexpPack2Impl892 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl892.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl892 INSTANCE;

    public static ComplexpPack2Impl892 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl892();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl892(){
