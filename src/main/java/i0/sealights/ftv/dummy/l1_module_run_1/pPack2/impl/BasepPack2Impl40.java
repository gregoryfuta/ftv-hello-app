...
public class BasepPack2Impl40 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl40.class);
    private static BasepPack2Impl40 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl40 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl40();
        }
        return INSTANCE;
    }

    private BasepPack2Impl40(){
