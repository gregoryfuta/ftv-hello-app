...
public class ComplexpPack1Impl261 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl261.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl261 INSTANCE;

    public static ComplexpPack1Impl261 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl261();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl261(){
