...
public class BasepPack2Impl579 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl579.class);
    private static BasepPack2Impl579 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl579 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl579();
        }
        return INSTANCE;
    }

    private BasepPack2Impl579(){
