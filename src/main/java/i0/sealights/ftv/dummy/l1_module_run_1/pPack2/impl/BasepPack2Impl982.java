...
public class BasepPack2Impl982 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl982.class);
    private static BasepPack2Impl982 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl982 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl982();
        }
        return INSTANCE;
    }

    private BasepPack2Impl982(){
