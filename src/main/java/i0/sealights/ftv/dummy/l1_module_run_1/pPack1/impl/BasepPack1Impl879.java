...
public class BasepPack1Impl879 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl879.class);
    private static BasepPack1Impl879 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl879 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl879();
        }
        return INSTANCE;
    }

    private BasepPack1Impl879(){
