...
public class BasepPack2Impl587 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl587.class);
    private static BasepPack2Impl587 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl587 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl587();
        }
        return INSTANCE;
    }

    private BasepPack2Impl587(){
