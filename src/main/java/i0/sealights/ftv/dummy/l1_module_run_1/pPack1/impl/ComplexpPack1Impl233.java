...
public class ComplexpPack1Impl233 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl233.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl233 INSTANCE;

    public static ComplexpPack1Impl233 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl233();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl233(){
