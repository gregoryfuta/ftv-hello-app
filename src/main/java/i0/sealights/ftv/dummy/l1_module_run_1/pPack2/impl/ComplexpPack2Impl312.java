...
public class ComplexpPack2Impl312 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl312.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl312 INSTANCE;

    public static ComplexpPack2Impl312 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl312();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl312(){
