...
public class BasepPack1Impl354 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl354.class);
    private static BasepPack1Impl354 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl354 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl354();
        }
        return INSTANCE;
    }

    private BasepPack1Impl354(){
