...
public class BasepPack1Impl561 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl561.class);
    private static BasepPack1Impl561 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl561 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl561();
        }
        return INSTANCE;
    }

    private BasepPack1Impl561(){
