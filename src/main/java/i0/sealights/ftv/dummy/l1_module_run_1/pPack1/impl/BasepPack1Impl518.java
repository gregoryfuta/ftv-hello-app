...
public class BasepPack1Impl518 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl518.class);
    private static BasepPack1Impl518 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl518 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl518();
        }
        return INSTANCE;
    }

    private BasepPack1Impl518(){
