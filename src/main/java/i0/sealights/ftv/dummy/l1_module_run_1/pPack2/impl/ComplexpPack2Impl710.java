...
public class ComplexpPack2Impl710 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl710.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl710 INSTANCE;

    public static ComplexpPack2Impl710 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl710();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl710(){
