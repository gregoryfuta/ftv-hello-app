...
public class ComplexpPack1Impl684 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl684.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl684 INSTANCE;

    public static ComplexpPack1Impl684 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl684();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl684(){
