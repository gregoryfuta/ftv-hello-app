...
public class BasepPack1Impl212 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl212.class);
    private static BasepPack1Impl212 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl212 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl212();
        }
        return INSTANCE;
    }

    private BasepPack1Impl212(){
