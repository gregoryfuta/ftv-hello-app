...
public class BasepPack2Impl304 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl304.class);
    private static BasepPack2Impl304 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl304 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl304();
        }
        return INSTANCE;
    }

    private BasepPack2Impl304(){
