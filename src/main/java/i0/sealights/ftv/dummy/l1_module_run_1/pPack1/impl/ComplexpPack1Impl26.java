...
public class ComplexpPack1Impl26 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl26.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl26 INSTANCE;

    public static ComplexpPack1Impl26 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl26();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl26(){
