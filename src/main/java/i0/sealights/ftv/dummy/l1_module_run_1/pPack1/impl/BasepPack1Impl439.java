...
public class BasepPack1Impl439 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl439.class);
    private static BasepPack1Impl439 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl439 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl439();
        }
        return INSTANCE;
    }

    private BasepPack1Impl439(){
