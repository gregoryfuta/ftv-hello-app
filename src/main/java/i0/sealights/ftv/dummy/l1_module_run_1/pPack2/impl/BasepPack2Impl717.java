...
public class BasepPack2Impl717 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl717.class);
    private static BasepPack2Impl717 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl717 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl717();
        }
        return INSTANCE;
    }

    private BasepPack2Impl717(){
