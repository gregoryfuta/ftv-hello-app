...
public class BasepPack1Impl895 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl895.class);
    private static BasepPack1Impl895 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl895 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl895();
        }
        return INSTANCE;
    }

    private BasepPack1Impl895(){
