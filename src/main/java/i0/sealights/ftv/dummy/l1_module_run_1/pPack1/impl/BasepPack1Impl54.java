...
public class BasepPack1Impl54 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl54.class);
    private static BasepPack1Impl54 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl54 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl54();
        }
        return INSTANCE;
    }

    private BasepPack1Impl54(){
