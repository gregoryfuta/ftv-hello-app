...
public class ComplexpPack2Impl580 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl580.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl580 INSTANCE;

    public static ComplexpPack2Impl580 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl580();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl580(){
