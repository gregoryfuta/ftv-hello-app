...
public class BasepPack1Impl559 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl559.class);
    private static BasepPack1Impl559 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl559 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl559();
        }
        return INSTANCE;
    }

    private BasepPack1Impl559(){
