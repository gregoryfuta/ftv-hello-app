...
public class BasepPack1Impl974 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl974.class);
    private static BasepPack1Impl974 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl974 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl974();
        }
        return INSTANCE;
    }

    private BasepPack1Impl974(){
