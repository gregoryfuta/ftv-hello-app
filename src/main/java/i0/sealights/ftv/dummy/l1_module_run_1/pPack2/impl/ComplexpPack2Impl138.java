...
public class ComplexpPack2Impl138 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl138.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl138 INSTANCE;

    public static ComplexpPack2Impl138 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl138();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl138(){
