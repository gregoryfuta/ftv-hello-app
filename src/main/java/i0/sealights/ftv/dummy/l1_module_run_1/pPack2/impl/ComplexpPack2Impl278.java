...
public class ComplexpPack2Impl278 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl278.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl278 INSTANCE;

    public static ComplexpPack2Impl278 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl278();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl278(){
