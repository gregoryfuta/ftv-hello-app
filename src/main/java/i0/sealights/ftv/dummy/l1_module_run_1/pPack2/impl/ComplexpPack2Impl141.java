...
public class ComplexpPack2Impl141 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl141.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl141 INSTANCE;

    public static ComplexpPack2Impl141 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl141();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl141(){
