...
public class BasepPack1Impl713 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl713.class);
    private static BasepPack1Impl713 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl713 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl713();
        }
        return INSTANCE;
    }

    private BasepPack1Impl713(){
