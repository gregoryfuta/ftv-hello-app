...
public class ComplexpPack1Impl592 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl592.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl592 INSTANCE;

    public static ComplexpPack1Impl592 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl592();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl592(){
