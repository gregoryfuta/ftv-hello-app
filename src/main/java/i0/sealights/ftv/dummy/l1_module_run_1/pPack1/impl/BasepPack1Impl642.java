...
public class BasepPack1Impl642 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl642.class);
    private static BasepPack1Impl642 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl642 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl642();
        }
        return INSTANCE;
    }

    private BasepPack1Impl642(){
