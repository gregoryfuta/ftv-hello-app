...
public class ComplexpPack1Impl920 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl920.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl920 INSTANCE;

    public static ComplexpPack1Impl920 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl920();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl920(){
