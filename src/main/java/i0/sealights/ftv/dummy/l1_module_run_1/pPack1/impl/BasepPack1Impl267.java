...
public class BasepPack1Impl267 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl267.class);
    private static BasepPack1Impl267 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl267 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl267();
        }
        return INSTANCE;
    }

    private BasepPack1Impl267(){
