...
public class BasepPack1Impl266 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl266.class);
    private static BasepPack1Impl266 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl266 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl266();
        }
        return INSTANCE;
    }

    private BasepPack1Impl266(){
