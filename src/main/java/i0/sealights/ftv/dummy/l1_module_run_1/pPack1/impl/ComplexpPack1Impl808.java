...
public class ComplexpPack1Impl808 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl808.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl808 INSTANCE;

    public static ComplexpPack1Impl808 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl808();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl808(){
