...
public class ComplexpPack1Impl772 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl772.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl772 INSTANCE;

    public static ComplexpPack1Impl772 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl772();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl772(){
