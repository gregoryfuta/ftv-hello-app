...
public class ComplexpPack2Impl199 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl199.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl199 INSTANCE;

    public static ComplexpPack2Impl199 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl199();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl199(){
