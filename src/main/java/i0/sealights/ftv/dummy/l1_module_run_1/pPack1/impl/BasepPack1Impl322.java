...
public class BasepPack1Impl322 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl322.class);
    private static BasepPack1Impl322 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl322 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl322();
        }
        return INSTANCE;
    }

    private BasepPack1Impl322(){
