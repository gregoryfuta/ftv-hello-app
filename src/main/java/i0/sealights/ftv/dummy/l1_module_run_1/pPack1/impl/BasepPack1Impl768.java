...
public class BasepPack1Impl768 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl768.class);
    private static BasepPack1Impl768 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl768 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl768();
        }
        return INSTANCE;
    }

    private BasepPack1Impl768(){
