...
public class ComplexpPack1Impl354 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl354.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl354 INSTANCE;

    public static ComplexpPack1Impl354 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl354();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl354(){
