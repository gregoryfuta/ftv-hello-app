...
public class ComplexpPack2Impl7 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl7.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl7 INSTANCE;

    public static ComplexpPack2Impl7 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl7();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl7(){
