...
public class BasepPack1Impl139 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl139.class);
    private static BasepPack1Impl139 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl139 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl139();
        }
        return INSTANCE;
    }

    private BasepPack1Impl139(){
