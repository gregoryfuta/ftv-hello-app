...
public class BasepPack2Impl644 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl644.class);
    private static BasepPack2Impl644 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl644 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl644();
        }
        return INSTANCE;
    }

    private BasepPack2Impl644(){
