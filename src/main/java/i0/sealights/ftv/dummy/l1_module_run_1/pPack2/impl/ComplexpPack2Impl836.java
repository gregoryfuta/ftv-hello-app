...
public class ComplexpPack2Impl836 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl836.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl836 INSTANCE;

    public static ComplexpPack2Impl836 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl836();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl836(){
