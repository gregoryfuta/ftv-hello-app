...
public class ComplexpPack1Impl594 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl594.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl594 INSTANCE;

    public static ComplexpPack1Impl594 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl594();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl594(){
