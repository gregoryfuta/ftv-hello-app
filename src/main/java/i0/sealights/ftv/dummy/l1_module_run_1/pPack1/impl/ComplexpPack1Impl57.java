...
public class ComplexpPack1Impl57 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl57.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl57 INSTANCE;

    public static ComplexpPack1Impl57 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl57();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl57(){
