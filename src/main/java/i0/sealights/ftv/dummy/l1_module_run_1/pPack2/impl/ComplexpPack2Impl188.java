...
public class ComplexpPack2Impl188 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl188.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl188 INSTANCE;

    public static ComplexpPack2Impl188 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl188();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl188(){
