...
public class BasepPack1Impl988 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl988.class);
    private static BasepPack1Impl988 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl988 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl988();
        }
        return INSTANCE;
    }

    private BasepPack1Impl988(){
