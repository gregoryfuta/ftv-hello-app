...
public class BasepPack1Impl750 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl750.class);
    private static BasepPack1Impl750 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl750 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl750();
        }
        return INSTANCE;
    }

    private BasepPack1Impl750(){
