...
public class ComplexpPack1Impl274 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl274.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl274 INSTANCE;

    public static ComplexpPack1Impl274 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl274();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl274(){
