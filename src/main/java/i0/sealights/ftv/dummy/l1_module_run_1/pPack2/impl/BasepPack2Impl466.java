...
public class BasepPack2Impl466 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl466.class);
    private static BasepPack2Impl466 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl466 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl466();
        }
        return INSTANCE;
    }

    private BasepPack2Impl466(){
