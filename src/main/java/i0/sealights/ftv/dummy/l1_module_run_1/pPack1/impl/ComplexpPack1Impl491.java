...
public class ComplexpPack1Impl491 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl491.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl491 INSTANCE;

    public static ComplexpPack1Impl491 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl491();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl491(){
