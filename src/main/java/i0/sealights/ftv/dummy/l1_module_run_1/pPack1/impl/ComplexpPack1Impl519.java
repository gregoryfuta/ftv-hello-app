...
public class ComplexpPack1Impl519 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl519.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl519 INSTANCE;

    public static ComplexpPack1Impl519 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl519();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl519(){
