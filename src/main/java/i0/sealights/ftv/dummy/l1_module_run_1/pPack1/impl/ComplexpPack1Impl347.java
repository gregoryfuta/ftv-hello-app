...
public class ComplexpPack1Impl347 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl347.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl347 INSTANCE;

    public static ComplexpPack1Impl347 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl347();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl347(){
