...
public class BasepPack1Impl372 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl372.class);
    private static BasepPack1Impl372 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl372 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl372();
        }
        return INSTANCE;
    }

    private BasepPack1Impl372(){
