...
public class ComplexpPack2Impl73 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl73.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl73 INSTANCE;

    public static ComplexpPack2Impl73 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl73();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl73(){
