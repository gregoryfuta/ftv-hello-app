...
public class BasepPack1Impl499 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl499.class);
    private static BasepPack1Impl499 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl499 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl499();
        }
        return INSTANCE;
    }

    private BasepPack1Impl499(){
