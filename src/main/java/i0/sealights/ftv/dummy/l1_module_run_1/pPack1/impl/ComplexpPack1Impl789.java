...
public class ComplexpPack1Impl789 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl789.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl789 INSTANCE;

    public static ComplexpPack1Impl789 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl789();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl789(){
