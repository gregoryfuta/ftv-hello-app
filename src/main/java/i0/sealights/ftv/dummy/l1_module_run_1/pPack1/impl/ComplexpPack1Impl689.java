...
public class ComplexpPack1Impl689 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl689.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl689 INSTANCE;

    public static ComplexpPack1Impl689 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl689();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl689(){
