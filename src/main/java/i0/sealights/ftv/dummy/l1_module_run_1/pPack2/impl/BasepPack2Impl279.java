...
public class BasepPack2Impl279 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl279.class);
    private static BasepPack2Impl279 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl279 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl279();
        }
        return INSTANCE;
    }

    private BasepPack2Impl279(){
