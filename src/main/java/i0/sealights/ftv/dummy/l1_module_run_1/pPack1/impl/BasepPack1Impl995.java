...
public class BasepPack1Impl995 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl995.class);
    private static BasepPack1Impl995 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl995 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl995();
        }
        return INSTANCE;
    }

    private BasepPack1Impl995(){
