...
public class ComplexpPack2Impl930 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl930.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl930 INSTANCE;

    public static ComplexpPack2Impl930 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl930();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl930(){
