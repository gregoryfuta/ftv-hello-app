...
public class BasepPack2Impl225 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl225.class);
    private static BasepPack2Impl225 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl225 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl225();
        }
        return INSTANCE;
    }

    private BasepPack2Impl225(){
