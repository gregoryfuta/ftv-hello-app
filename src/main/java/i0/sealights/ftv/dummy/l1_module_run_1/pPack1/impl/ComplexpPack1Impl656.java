...
public class ComplexpPack1Impl656 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl656.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl656 INSTANCE;

    public static ComplexpPack1Impl656 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl656();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl656(){
