...
public class BasepPack2Impl383 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl383.class);
    private static BasepPack2Impl383 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl383 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl383();
        }
        return INSTANCE;
    }

    private BasepPack2Impl383(){
