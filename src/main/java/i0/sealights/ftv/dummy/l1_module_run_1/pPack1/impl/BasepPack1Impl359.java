...
public class BasepPack1Impl359 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl359.class);
    private static BasepPack1Impl359 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl359 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl359();
        }
        return INSTANCE;
    }

    private BasepPack1Impl359(){
