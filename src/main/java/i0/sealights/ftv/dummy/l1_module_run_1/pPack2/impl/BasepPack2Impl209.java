...
public class BasepPack2Impl209 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl209.class);
    private static BasepPack2Impl209 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl209 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl209();
        }
        return INSTANCE;
    }

    private BasepPack2Impl209(){
