...
public class ComplexpPack1Impl120 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl120.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl120 INSTANCE;

    public static ComplexpPack1Impl120 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl120();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl120(){
