...
public class ComplexpPack2Impl94 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl94.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl94 INSTANCE;

    public static ComplexpPack2Impl94 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl94();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl94(){
