...
public class ComplexpPack1Impl723 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl723.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl723 INSTANCE;

    public static ComplexpPack1Impl723 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl723();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl723(){
