...
public class ComplexpPack2Impl484 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl484.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl484 INSTANCE;

    public static ComplexpPack2Impl484 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl484();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl484(){
