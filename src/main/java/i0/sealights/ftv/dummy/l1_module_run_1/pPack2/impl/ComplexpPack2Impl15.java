...
public class ComplexpPack2Impl15 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl15.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl15 INSTANCE;

    public static ComplexpPack2Impl15 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl15();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl15(){
