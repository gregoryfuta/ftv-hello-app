...
public class BasepPack2Impl934 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl934.class);
    private static BasepPack2Impl934 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl934 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl934();
        }
        return INSTANCE;
    }

    private BasepPack2Impl934(){
