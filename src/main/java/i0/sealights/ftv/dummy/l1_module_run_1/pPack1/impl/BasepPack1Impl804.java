...
public class BasepPack1Impl804 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl804.class);
    private static BasepPack1Impl804 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl804 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl804();
        }
        return INSTANCE;
    }

    private BasepPack1Impl804(){
