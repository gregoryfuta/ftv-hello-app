...
public class BasepPack2Impl854 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl854.class);
    private static BasepPack2Impl854 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl854 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl854();
        }
        return INSTANCE;
    }

    private BasepPack2Impl854(){
