...
public class ComplexpPack2Impl49 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl49.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl49 INSTANCE;

    public static ComplexpPack2Impl49 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl49();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl49(){
