...
public class ComplexpPack2Impl24 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl24.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl24 INSTANCE;

    public static ComplexpPack2Impl24 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl24();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl24(){
