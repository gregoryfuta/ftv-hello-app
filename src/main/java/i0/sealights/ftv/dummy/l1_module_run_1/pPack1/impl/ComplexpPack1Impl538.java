...
public class ComplexpPack1Impl538 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl538.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl538 INSTANCE;

    public static ComplexpPack1Impl538 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl538();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl538(){
