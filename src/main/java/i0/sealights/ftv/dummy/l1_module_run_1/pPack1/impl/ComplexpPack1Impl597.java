...
public class ComplexpPack1Impl597 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl597.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl597 INSTANCE;

    public static ComplexpPack1Impl597 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl597();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl597(){
