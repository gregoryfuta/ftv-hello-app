...
public class BasepPack1Impl626 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl626.class);
    private static BasepPack1Impl626 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl626 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl626();
        }
        return INSTANCE;
    }

    private BasepPack1Impl626(){
