...
public class ComplexpPack1Impl32 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl32.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl32 INSTANCE;

    public static ComplexpPack1Impl32 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl32();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl32(){
