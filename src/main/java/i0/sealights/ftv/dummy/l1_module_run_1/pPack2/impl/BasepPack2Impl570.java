...
public class BasepPack2Impl570 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl570.class);
    private static BasepPack2Impl570 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl570 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl570();
        }
        return INSTANCE;
    }

    private BasepPack2Impl570(){
