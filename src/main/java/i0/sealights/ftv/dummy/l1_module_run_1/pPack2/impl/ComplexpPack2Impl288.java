...
public class ComplexpPack2Impl288 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl288.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl288 INSTANCE;

    public static ComplexpPack2Impl288 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl288();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl288(){
