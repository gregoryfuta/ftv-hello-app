...
public class ComplexpPack1Impl990 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl990.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl990 INSTANCE;

    public static ComplexpPack1Impl990 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl990();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl990(){
