...
public class BasepPack2Impl146 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl146.class);
    private static BasepPack2Impl146 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl146 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl146();
        }
        return INSTANCE;
    }

    private BasepPack2Impl146(){
