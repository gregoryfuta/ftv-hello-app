...
public class ComplexpPack2Impl515 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl515.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl515 INSTANCE;

    public static ComplexpPack2Impl515 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl515();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl515(){
