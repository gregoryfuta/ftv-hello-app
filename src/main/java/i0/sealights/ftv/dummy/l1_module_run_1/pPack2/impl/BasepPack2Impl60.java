...
public class BasepPack2Impl60 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl60.class);
    private static BasepPack2Impl60 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl60 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl60();
        }
        return INSTANCE;
    }

    private BasepPack2Impl60(){
