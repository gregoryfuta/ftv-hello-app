...
public class ComplexpPack1Impl369 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl369.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl369 INSTANCE;

    public static ComplexpPack1Impl369 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl369();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl369(){
