...
public class ComplexpPack2Impl520 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl520.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl520 INSTANCE;

    public static ComplexpPack2Impl520 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl520();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl520(){
