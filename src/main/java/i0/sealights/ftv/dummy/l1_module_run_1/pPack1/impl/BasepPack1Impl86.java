...
public class BasepPack1Impl86 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl86.class);
    private static BasepPack1Impl86 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl86 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl86();
        }
        return INSTANCE;
    }

    private BasepPack1Impl86(){
