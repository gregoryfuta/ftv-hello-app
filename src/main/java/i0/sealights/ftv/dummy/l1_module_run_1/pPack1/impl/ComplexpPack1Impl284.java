...
public class ComplexpPack1Impl284 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl284.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl284 INSTANCE;

    public static ComplexpPack1Impl284 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl284();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl284(){
