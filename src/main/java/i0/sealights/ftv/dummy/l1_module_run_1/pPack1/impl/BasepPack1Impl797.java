...
public class BasepPack1Impl797 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl797.class);
    private static BasepPack1Impl797 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl797 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl797();
        }
        return INSTANCE;
    }

    private BasepPack1Impl797(){
