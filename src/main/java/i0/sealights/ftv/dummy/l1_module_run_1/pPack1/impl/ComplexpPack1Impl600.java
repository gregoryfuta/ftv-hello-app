...
public class ComplexpPack1Impl600 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl600.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl600 INSTANCE;

    public static ComplexpPack1Impl600 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl600();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl600(){
