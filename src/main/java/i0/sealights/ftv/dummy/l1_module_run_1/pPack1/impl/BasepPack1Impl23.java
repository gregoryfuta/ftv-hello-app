...
public class BasepPack1Impl23 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl23.class);
    private static BasepPack1Impl23 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl23 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl23();
        }
        return INSTANCE;
    }

    private BasepPack1Impl23(){
