...
public class BasepPack2Impl753 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl753.class);
    private static BasepPack2Impl753 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl753 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl753();
        }
        return INSTANCE;
    }

    private BasepPack2Impl753(){
