...
public class BasepPack2Impl986 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl986.class);
    private static BasepPack2Impl986 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl986 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl986();
        }
        return INSTANCE;
    }

    private BasepPack2Impl986(){
