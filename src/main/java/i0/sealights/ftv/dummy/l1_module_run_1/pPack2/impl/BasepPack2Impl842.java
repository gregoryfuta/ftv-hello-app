...
public class BasepPack2Impl842 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl842.class);
    private static BasepPack2Impl842 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl842 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl842();
        }
        return INSTANCE;
    }

    private BasepPack2Impl842(){
