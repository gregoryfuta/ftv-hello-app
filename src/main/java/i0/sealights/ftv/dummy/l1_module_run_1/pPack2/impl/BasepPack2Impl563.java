...
public class BasepPack2Impl563 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl563.class);
    private static BasepPack2Impl563 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl563 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl563();
        }
        return INSTANCE;
    }

    private BasepPack2Impl563(){
