...
public class ComplexpPack2Impl799 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl799.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl799 INSTANCE;

    public static ComplexpPack2Impl799 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl799();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl799(){
