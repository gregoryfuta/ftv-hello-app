...
public class BasepPack1Impl503 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl503.class);
    private static BasepPack1Impl503 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl503 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl503();
        }
        return INSTANCE;
    }

    private BasepPack1Impl503(){
