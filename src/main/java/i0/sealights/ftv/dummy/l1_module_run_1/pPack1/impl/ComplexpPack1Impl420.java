...
public class ComplexpPack1Impl420 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl420.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl420 INSTANCE;

    public static ComplexpPack1Impl420 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl420();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl420(){
