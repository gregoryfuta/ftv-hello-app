...
public class ComplexpPack2Impl757 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl757.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl757 INSTANCE;

    public static ComplexpPack2Impl757 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl757();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl757(){
