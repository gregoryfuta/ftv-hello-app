...
public class BasepPack2Impl296 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl296.class);
    private static BasepPack2Impl296 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl296 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl296();
        }
        return INSTANCE;
    }

    private BasepPack2Impl296(){
