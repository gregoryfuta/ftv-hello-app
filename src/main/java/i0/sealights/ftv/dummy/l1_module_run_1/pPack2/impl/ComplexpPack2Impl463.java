...
public class ComplexpPack2Impl463 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl463.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl463 INSTANCE;

    public static ComplexpPack2Impl463 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl463();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl463(){
