...
public class BasepPack2Impl238 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl238.class);
    private static BasepPack2Impl238 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl238 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl238();
        }
        return INSTANCE;
    }

    private BasepPack2Impl238(){
