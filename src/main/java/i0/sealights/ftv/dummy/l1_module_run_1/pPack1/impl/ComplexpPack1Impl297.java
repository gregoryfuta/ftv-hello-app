...
public class ComplexpPack1Impl297 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl297.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl297 INSTANCE;

    public static ComplexpPack1Impl297 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl297();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl297(){
