...
public class BasepPack2Impl819 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl819.class);
    private static BasepPack2Impl819 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl819 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl819();
        }
        return INSTANCE;
    }

    private BasepPack2Impl819(){
