...
public class ComplexpPack1Impl44 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl44.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl44 INSTANCE;

    public static ComplexpPack1Impl44 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl44();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl44(){
