...
public class ComplexpPack2Impl624 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl624.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl624 INSTANCE;

    public static ComplexpPack2Impl624 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl624();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl624(){
