...
public class ComplexpPack2Impl308 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl308.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl308 INSTANCE;

    public static ComplexpPack2Impl308 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl308();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl308(){
