...
public class ComplexpPack2Impl853 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl853.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl853 INSTANCE;

    public static ComplexpPack2Impl853 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl853();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl853(){
