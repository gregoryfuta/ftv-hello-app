...
public class ComplexpPack1Impl68 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl68.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl68 INSTANCE;

    public static ComplexpPack1Impl68 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl68();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl68(){
