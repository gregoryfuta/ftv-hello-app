...
public class ComplexpPack1Impl897 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl897.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl897 INSTANCE;

    public static ComplexpPack1Impl897 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl897();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl897(){
