...
public class BasepPack1Impl125 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl125.class);
    private static BasepPack1Impl125 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl125 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl125();
        }
        return INSTANCE;
    }

    private BasepPack1Impl125(){
