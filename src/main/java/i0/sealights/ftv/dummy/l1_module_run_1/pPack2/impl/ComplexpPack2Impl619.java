...
public class ComplexpPack2Impl619 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl619.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl619 INSTANCE;

    public static ComplexpPack2Impl619 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl619();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl619(){
