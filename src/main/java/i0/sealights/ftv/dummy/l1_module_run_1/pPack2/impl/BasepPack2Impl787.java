...
public class BasepPack2Impl787 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl787.class);
    private static BasepPack2Impl787 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl787 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl787();
        }
        return INSTANCE;
    }

    private BasepPack2Impl787(){
