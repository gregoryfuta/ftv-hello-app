...
public class BasepPack1Impl88 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl88.class);
    private static BasepPack1Impl88 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl88 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl88();
        }
        return INSTANCE;
    }

    private BasepPack1Impl88(){
