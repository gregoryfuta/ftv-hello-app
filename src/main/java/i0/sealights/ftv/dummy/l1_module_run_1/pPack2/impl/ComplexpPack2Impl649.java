...
public class ComplexpPack2Impl649 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl649.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl649 INSTANCE;

    public static ComplexpPack2Impl649 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl649();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl649(){
