...
public class ComplexpPack1Impl590 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl590.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl590 INSTANCE;

    public static ComplexpPack1Impl590 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl590();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl590(){
