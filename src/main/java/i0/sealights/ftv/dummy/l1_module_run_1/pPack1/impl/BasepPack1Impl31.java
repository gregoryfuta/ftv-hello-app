...
public class BasepPack1Impl31 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl31.class);
    private static BasepPack1Impl31 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl31 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl31();
        }
        return INSTANCE;
    }

    private BasepPack1Impl31(){
