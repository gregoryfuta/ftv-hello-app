...
public class BasepPack2Impl964 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl964.class);
    private static BasepPack2Impl964 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl964 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl964();
        }
        return INSTANCE;
    }

    private BasepPack2Impl964(){
