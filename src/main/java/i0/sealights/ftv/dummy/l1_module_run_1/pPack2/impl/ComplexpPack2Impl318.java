...
public class ComplexpPack2Impl318 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl318.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl318 INSTANCE;

    public static ComplexpPack2Impl318 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl318();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl318(){
