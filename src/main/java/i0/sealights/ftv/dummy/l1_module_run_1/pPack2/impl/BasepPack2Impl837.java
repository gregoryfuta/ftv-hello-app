...
public class BasepPack2Impl837 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl837.class);
    private static BasepPack2Impl837 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl837 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl837();
        }
        return INSTANCE;
    }

    private BasepPack2Impl837(){
