...
public class ComplexpPack1Impl503 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl503.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl503 INSTANCE;

    public static ComplexpPack1Impl503 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl503();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl503(){
