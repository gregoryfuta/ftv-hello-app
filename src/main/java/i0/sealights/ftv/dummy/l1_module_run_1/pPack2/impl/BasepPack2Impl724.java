...
public class BasepPack2Impl724 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl724.class);
    private static BasepPack2Impl724 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl724 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl724();
        }
        return INSTANCE;
    }

    private BasepPack2Impl724(){
