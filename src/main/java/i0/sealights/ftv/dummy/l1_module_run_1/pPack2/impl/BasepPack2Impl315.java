...
public class BasepPack2Impl315 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl315.class);
    private static BasepPack2Impl315 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl315 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl315();
        }
        return INSTANCE;
    }

    private BasepPack2Impl315(){
