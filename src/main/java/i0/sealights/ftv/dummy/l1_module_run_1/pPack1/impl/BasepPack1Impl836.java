...
public class BasepPack1Impl836 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl836.class);
    private static BasepPack1Impl836 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl836 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl836();
        }
        return INSTANCE;
    }

    private BasepPack1Impl836(){
