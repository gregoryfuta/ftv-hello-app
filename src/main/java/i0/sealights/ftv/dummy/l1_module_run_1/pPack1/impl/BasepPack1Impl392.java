...
public class BasepPack1Impl392 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl392.class);
    private static BasepPack1Impl392 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl392 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl392();
        }
        return INSTANCE;
    }

    private BasepPack1Impl392(){
