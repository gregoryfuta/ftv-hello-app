...
public class ComplexpPack2Impl193 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl193.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl193 INSTANCE;

    public static ComplexpPack2Impl193 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl193();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl193(){
