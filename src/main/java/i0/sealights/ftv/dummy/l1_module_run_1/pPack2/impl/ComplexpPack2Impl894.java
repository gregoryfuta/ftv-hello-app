...
public class ComplexpPack2Impl894 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl894.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl894 INSTANCE;

    public static ComplexpPack2Impl894 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl894();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl894(){
