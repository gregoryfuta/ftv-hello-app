...
public class ComplexpPack2Impl349 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl349.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl349 INSTANCE;

    public static ComplexpPack2Impl349 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl349();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl349(){
