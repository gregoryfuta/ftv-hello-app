...
public class BasepPack1Impl695 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl695.class);
    private static BasepPack1Impl695 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl695 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl695();
        }
        return INSTANCE;
    }

    private BasepPack1Impl695(){
