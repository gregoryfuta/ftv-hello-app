...
public class BasepPack2Impl887 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl887.class);
    private static BasepPack2Impl887 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl887 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl887();
        }
        return INSTANCE;
    }

    private BasepPack2Impl887(){
