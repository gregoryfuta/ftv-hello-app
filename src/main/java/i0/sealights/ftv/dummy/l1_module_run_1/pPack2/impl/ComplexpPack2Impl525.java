...
public class ComplexpPack2Impl525 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl525.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl525 INSTANCE;

    public static ComplexpPack2Impl525 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl525();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl525(){
