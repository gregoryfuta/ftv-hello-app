...
public class BasepPack2Impl744 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl744.class);
    private static BasepPack2Impl744 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl744 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl744();
        }
        return INSTANCE;
    }

    private BasepPack2Impl744(){
