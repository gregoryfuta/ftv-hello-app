...
public class BasepPack1Impl187 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl187.class);
    private static BasepPack1Impl187 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl187 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl187();
        }
        return INSTANCE;
    }

    private BasepPack1Impl187(){
