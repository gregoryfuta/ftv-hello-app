...
public class ComplexpPack1Impl147 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl147.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl147 INSTANCE;

    public static ComplexpPack1Impl147 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl147();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl147(){
