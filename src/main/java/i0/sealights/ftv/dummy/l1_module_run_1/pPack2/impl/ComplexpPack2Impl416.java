...
public class ComplexpPack2Impl416 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl416.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl416 INSTANCE;

    public static ComplexpPack2Impl416 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl416();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl416(){
