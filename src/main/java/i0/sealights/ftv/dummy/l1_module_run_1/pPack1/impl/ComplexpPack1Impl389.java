...
public class ComplexpPack1Impl389 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl389.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl389 INSTANCE;

    public static ComplexpPack1Impl389 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl389();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl389(){
