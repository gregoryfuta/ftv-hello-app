...
public class BasepPack2Impl573 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl573.class);
    private static BasepPack2Impl573 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl573 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl573();
        }
        return INSTANCE;
    }

    private BasepPack2Impl573(){
