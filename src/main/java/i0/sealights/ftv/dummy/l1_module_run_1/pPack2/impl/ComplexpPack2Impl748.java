...
public class ComplexpPack2Impl748 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl748.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl748 INSTANCE;

    public static ComplexpPack2Impl748 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl748();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl748(){
