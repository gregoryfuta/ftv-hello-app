...
public class BasepPack1Impl400 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl400.class);
    private static BasepPack1Impl400 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl400 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl400();
        }
        return INSTANCE;
    }

    private BasepPack1Impl400(){
