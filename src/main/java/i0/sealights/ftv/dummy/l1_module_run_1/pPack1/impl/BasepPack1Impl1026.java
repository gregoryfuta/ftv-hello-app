...
public class BasepPack1Impl1026 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1026.class);
    private static BasepPack1Impl1026 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1026 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1026();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1026(){
