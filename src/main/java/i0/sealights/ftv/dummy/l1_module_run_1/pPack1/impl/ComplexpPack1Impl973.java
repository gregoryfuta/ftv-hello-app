...
public class ComplexpPack1Impl973 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl973.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl973 INSTANCE;

    public static ComplexpPack1Impl973 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl973();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl973(){
