...
public class ComplexpPack1Impl1041 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1041.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1041 INSTANCE;

    public static ComplexpPack1Impl1041 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1041();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1041(){
