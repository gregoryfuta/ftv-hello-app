...
public class ComplexpPack2Impl443 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl443.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl443 INSTANCE;

    public static ComplexpPack2Impl443 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl443();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl443(){
