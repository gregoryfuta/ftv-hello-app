...
public class ComplexpPack2Impl750 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl750.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl750 INSTANCE;

    public static ComplexpPack2Impl750 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl750();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl750(){
