...
public class BasepPack1Impl389 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl389.class);
    private static BasepPack1Impl389 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl389 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl389();
        }
        return INSTANCE;
    }

    private BasepPack1Impl389(){
