...
public class ComplexpPack2Impl591 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl591.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl591 INSTANCE;

    public static ComplexpPack2Impl591 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl591();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl591(){
