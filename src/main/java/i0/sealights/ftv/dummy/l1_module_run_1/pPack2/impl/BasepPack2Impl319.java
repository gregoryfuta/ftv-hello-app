...
public class BasepPack2Impl319 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl319.class);
    private static BasepPack2Impl319 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl319 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl319();
        }
        return INSTANCE;
    }

    private BasepPack2Impl319(){
