...
public class ComplexpPack1Impl516 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl516.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl516 INSTANCE;

    public static ComplexpPack1Impl516 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl516();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl516(){
