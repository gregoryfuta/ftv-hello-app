...
public class BasepPack1Impl622 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl622.class);
    private static BasepPack1Impl622 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl622 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl622();
        }
        return INSTANCE;
    }

    private BasepPack1Impl622(){
