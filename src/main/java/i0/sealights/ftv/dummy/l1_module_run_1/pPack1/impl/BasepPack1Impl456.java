...
public class BasepPack1Impl456 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl456.class);
    private static BasepPack1Impl456 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl456 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl456();
        }
        return INSTANCE;
    }

    private BasepPack1Impl456(){
