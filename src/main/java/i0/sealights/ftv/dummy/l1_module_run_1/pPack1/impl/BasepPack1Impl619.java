...
public class BasepPack1Impl619 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl619.class);
    private static BasepPack1Impl619 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl619 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl619();
        }
        return INSTANCE;
    }

    private BasepPack1Impl619(){
