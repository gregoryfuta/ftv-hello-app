...
public class ComplexpPack2Impl387 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl387.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl387 INSTANCE;

    public static ComplexpPack2Impl387 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl387();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl387(){
