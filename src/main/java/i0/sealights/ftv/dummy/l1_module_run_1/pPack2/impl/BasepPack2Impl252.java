...
public class BasepPack2Impl252 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl252.class);
    private static BasepPack2Impl252 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl252 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl252();
        }
        return INSTANCE;
    }

    private BasepPack2Impl252(){
