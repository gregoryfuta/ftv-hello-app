...
public class ComplexpPack1Impl688 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl688.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl688 INSTANCE;

    public static ComplexpPack1Impl688 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl688();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl688(){
