...
public class ComplexpPack2Impl502 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl502.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl502 INSTANCE;

    public static ComplexpPack2Impl502 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl502();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl502(){
