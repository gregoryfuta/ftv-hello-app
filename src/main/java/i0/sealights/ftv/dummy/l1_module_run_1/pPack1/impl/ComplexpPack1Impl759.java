...
public class ComplexpPack1Impl759 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl759.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl759 INSTANCE;

    public static ComplexpPack1Impl759 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl759();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl759(){
