...
public class ComplexpPack2Impl966 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl966.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl966 INSTANCE;

    public static ComplexpPack2Impl966 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl966();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl966(){
