...
public class ComplexpPack2Impl130 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl130.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl130 INSTANCE;

    public static ComplexpPack2Impl130 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl130();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl130(){
