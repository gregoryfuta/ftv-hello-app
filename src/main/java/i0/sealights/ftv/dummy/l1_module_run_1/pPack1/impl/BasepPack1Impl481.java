...
public class BasepPack1Impl481 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl481.class);
    private static BasepPack1Impl481 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl481 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl481();
        }
        return INSTANCE;
    }

    private BasepPack1Impl481(){
