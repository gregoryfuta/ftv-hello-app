...
public class BasepPack2Impl781 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl781.class);
    private static BasepPack2Impl781 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl781 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl781();
        }
        return INSTANCE;
    }

    private BasepPack2Impl781(){
