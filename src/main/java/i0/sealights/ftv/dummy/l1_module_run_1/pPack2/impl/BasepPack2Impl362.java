...
public class BasepPack2Impl362 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl362.class);
    private static BasepPack2Impl362 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl362 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl362();
        }
        return INSTANCE;
    }

    private BasepPack2Impl362(){
