...
public class BasepPack1Impl251 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl251.class);
    private static BasepPack1Impl251 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl251 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl251();
        }
        return INSTANCE;
    }

    private BasepPack1Impl251(){
