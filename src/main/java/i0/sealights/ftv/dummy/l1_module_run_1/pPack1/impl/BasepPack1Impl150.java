...
public class BasepPack1Impl150 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl150.class);
    private static BasepPack1Impl150 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl150 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl150();
        }
        return INSTANCE;
    }

    private BasepPack1Impl150(){
