...
public class ComplexpPack1Impl55 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl55.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl55 INSTANCE;

    public static ComplexpPack1Impl55 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl55();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl55(){
