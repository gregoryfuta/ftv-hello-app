...
public class BasepPack2Impl773 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl773.class);
    private static BasepPack2Impl773 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl773 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl773();
        }
        return INSTANCE;
    }

    private BasepPack2Impl773(){
