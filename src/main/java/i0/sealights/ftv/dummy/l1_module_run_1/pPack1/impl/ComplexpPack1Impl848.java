...
public class ComplexpPack1Impl848 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl848.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl848 INSTANCE;

    public static ComplexpPack1Impl848 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl848();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl848(){
