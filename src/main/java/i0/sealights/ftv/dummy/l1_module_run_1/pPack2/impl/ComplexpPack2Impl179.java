...
public class ComplexpPack2Impl179 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl179.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl179 INSTANCE;

    public static ComplexpPack2Impl179 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl179();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl179(){
