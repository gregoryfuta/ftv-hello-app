...
public class BasepPack1Impl764 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl764.class);
    private static BasepPack1Impl764 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl764 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl764();
        }
        return INSTANCE;
    }

    private BasepPack1Impl764(){
