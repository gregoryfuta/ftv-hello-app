...
public class BasepPack2Impl274 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl274.class);
    private static BasepPack2Impl274 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl274 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl274();
        }
        return INSTANCE;
    }

    private BasepPack2Impl274(){
