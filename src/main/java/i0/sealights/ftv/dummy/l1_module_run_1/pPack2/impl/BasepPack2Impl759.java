...
public class BasepPack2Impl759 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl759.class);
    private static BasepPack2Impl759 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl759 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl759();
        }
        return INSTANCE;
    }

    private BasepPack2Impl759(){
