...
public class ComplexpPack2Impl485 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl485.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl485 INSTANCE;

    public static ComplexpPack2Impl485 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl485();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl485(){
