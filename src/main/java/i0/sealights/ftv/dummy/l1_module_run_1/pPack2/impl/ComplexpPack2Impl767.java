...
public class ComplexpPack2Impl767 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl767.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl767 INSTANCE;

    public static ComplexpPack2Impl767 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl767();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl767(){
