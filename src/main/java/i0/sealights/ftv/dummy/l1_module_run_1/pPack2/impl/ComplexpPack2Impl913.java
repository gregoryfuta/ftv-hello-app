...
public class ComplexpPack2Impl913 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl913.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl913 INSTANCE;

    public static ComplexpPack2Impl913 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl913();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl913(){
