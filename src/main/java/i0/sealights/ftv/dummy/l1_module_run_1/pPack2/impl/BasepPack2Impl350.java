...
public class BasepPack2Impl350 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl350.class);
    private static BasepPack2Impl350 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl350 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl350();
        }
        return INSTANCE;
    }

    private BasepPack2Impl350(){
