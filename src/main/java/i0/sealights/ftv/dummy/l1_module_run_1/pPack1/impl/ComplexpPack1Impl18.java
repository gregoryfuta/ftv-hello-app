...
public class ComplexpPack1Impl18 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl18.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl18 INSTANCE;

    public static ComplexpPack1Impl18 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl18();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl18(){
