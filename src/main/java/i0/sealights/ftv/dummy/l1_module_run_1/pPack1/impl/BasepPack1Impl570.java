...
public class BasepPack1Impl570 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl570.class);
    private static BasepPack1Impl570 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl570 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl570();
        }
        return INSTANCE;
    }

    private BasepPack1Impl570(){
