...
public class BasepPack1Impl482 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl482.class);
    private static BasepPack1Impl482 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl482 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl482();
        }
        return INSTANCE;
    }

    private BasepPack1Impl482(){
