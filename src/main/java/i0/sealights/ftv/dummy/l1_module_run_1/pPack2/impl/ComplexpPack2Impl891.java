...
public class ComplexpPack2Impl891 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl891.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl891 INSTANCE;

    public static ComplexpPack2Impl891 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl891();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl891(){
