...
public class ComplexpPack1Impl38 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl38.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl38 INSTANCE;

    public static ComplexpPack1Impl38 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl38();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl38(){
