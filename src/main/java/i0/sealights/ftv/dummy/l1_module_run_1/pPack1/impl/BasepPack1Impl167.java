...
public class BasepPack1Impl167 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl167.class);
    private static BasepPack1Impl167 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl167 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl167();
        }
        return INSTANCE;
    }

    private BasepPack1Impl167(){
