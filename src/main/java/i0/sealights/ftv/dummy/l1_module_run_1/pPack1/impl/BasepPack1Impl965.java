...
public class BasepPack1Impl965 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl965.class);
    private static BasepPack1Impl965 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl965 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl965();
        }
        return INSTANCE;
    }

    private BasepPack1Impl965(){
