...
public class BasepPack2Impl143 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl143.class);
    private static BasepPack2Impl143 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl143 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl143();
        }
        return INSTANCE;
    }

    private BasepPack2Impl143(){
