...
public class BasepPack1Impl811 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl811.class);
    private static BasepPack1Impl811 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl811 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl811();
        }
        return INSTANCE;
    }

    private BasepPack1Impl811(){
