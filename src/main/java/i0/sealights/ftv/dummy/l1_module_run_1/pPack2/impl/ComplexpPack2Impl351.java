...
public class ComplexpPack2Impl351 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl351.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl351 INSTANCE;

    public static ComplexpPack2Impl351 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl351();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl351(){
