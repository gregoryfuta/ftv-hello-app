...
public class BasepPack2Impl421 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl421.class);
    private static BasepPack2Impl421 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl421 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl421();
        }
        return INSTANCE;
    }

    private BasepPack2Impl421(){
