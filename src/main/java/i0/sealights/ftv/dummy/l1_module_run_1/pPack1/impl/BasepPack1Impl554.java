...
public class BasepPack1Impl554 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl554.class);
    private static BasepPack1Impl554 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl554 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl554();
        }
        return INSTANCE;
    }

    private BasepPack1Impl554(){
