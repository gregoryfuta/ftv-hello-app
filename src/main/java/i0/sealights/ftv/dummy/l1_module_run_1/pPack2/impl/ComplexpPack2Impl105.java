...
public class ComplexpPack2Impl105 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl105.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl105 INSTANCE;

    public static ComplexpPack2Impl105 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl105();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl105(){
