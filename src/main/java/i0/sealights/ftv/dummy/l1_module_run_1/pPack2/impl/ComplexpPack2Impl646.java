...
public class ComplexpPack2Impl646 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl646.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl646 INSTANCE;

    public static ComplexpPack2Impl646 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl646();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl646(){
