...
public class BasepPack2Impl845 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl845.class);
    private static BasepPack2Impl845 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl845 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl845();
        }
        return INSTANCE;
    }

    private BasepPack2Impl845(){
