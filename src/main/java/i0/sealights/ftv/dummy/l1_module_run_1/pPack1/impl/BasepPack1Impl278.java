...
public class BasepPack1Impl278 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl278.class);
    private static BasepPack1Impl278 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl278 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl278();
        }
        return INSTANCE;
    }

    private BasepPack1Impl278(){
