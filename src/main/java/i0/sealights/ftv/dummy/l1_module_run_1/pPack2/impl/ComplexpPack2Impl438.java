...
public class ComplexpPack2Impl438 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl438.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl438 INSTANCE;

    public static ComplexpPack2Impl438 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl438();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl438(){
