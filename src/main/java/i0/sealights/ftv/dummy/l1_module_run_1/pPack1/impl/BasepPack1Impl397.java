...
public class BasepPack1Impl397 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl397.class);
    private static BasepPack1Impl397 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl397 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl397();
        }
        return INSTANCE;
    }

    private BasepPack1Impl397(){
