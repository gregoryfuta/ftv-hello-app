...
public class BasepPack1Impl270 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl270.class);
    private static BasepPack1Impl270 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl270 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl270();
        }
        return INSTANCE;
    }

    private BasepPack1Impl270(){
