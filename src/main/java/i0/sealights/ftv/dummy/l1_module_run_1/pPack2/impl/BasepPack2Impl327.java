...
public class BasepPack2Impl327 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl327.class);
    private static BasepPack2Impl327 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl327 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl327();
        }
        return INSTANCE;
    }

    private BasepPack2Impl327(){
