...
public class ComplexpPack1Impl140 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl140.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl140 INSTANCE;

    public static ComplexpPack1Impl140 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl140();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl140(){
