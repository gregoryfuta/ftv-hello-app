...
public class BasepPack2Impl935 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl935.class);
    private static BasepPack2Impl935 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl935 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl935();
        }
        return INSTANCE;
    }

    private BasepPack2Impl935(){
