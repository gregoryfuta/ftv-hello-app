...
public class ComplexpPack2Impl523 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl523.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl523 INSTANCE;

    public static ComplexpPack2Impl523 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl523();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl523(){
