...
public class BasepPack1Impl816 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl816.class);
    private static BasepPack1Impl816 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl816 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl816();
        }
        return INSTANCE;
    }

    private BasepPack1Impl816(){
