...
public class ComplexpPack1Impl724 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl724.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl724 INSTANCE;

    public static ComplexpPack1Impl724 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl724();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl724(){
