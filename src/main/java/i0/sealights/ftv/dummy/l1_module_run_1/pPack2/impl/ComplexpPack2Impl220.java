...
public class ComplexpPack2Impl220 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl220.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl220 INSTANCE;

    public static ComplexpPack2Impl220 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl220();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl220(){
