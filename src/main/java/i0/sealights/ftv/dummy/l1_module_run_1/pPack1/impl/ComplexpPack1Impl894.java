...
public class ComplexpPack1Impl894 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl894.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl894 INSTANCE;

    public static ComplexpPack1Impl894 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl894();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl894(){
