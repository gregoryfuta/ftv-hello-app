...
public class BasepPack2Impl199 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl199.class);
    private static BasepPack2Impl199 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl199 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl199();
        }
        return INSTANCE;
    }

    private BasepPack2Impl199(){
