...
public class BasepPack1Impl710 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl710.class);
    private static BasepPack1Impl710 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl710 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl710();
        }
        return INSTANCE;
    }

    private BasepPack1Impl710(){
