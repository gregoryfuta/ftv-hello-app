...
public class BasepPack1Impl364 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl364.class);
    private static BasepPack1Impl364 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl364 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl364();
        }
        return INSTANCE;
    }

    private BasepPack1Impl364(){
