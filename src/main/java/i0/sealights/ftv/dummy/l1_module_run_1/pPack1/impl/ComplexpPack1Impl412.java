...
public class ComplexpPack1Impl412 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl412.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl412 INSTANCE;

    public static ComplexpPack1Impl412 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl412();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl412(){
