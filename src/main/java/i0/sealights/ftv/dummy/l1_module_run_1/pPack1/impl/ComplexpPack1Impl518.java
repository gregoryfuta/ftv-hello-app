...
public class ComplexpPack1Impl518 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl518.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl518 INSTANCE;

    public static ComplexpPack1Impl518 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl518();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl518(){
