...
public class ComplexpPack1Impl355 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl355.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl355 INSTANCE;

    public static ComplexpPack1Impl355 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl355();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl355(){
