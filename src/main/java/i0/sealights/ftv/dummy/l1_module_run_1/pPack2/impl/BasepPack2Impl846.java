...
public class BasepPack2Impl846 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl846.class);
    private static BasepPack2Impl846 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl846 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl846();
        }
        return INSTANCE;
    }

    private BasepPack2Impl846(){
