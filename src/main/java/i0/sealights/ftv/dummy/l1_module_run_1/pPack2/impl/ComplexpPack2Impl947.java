...
public class ComplexpPack2Impl947 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl947.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl947 INSTANCE;

    public static ComplexpPack2Impl947 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl947();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl947(){
