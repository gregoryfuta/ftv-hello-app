...
public class ComplexpPack1Impl62 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl62.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl62 INSTANCE;

    public static ComplexpPack1Impl62 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl62();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl62(){
