...
public class ComplexpPack1Impl413 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl413.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl413 INSTANCE;

    public static ComplexpPack1Impl413 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl413();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl413(){
