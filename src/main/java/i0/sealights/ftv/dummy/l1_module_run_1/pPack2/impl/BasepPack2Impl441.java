...
public class BasepPack2Impl441 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl441.class);
    private static BasepPack2Impl441 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl441 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl441();
        }
        return INSTANCE;
    }

    private BasepPack2Impl441(){
