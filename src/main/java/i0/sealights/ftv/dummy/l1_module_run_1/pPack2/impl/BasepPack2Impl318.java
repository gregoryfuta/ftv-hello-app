...
public class BasepPack2Impl318 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl318.class);
    private static BasepPack2Impl318 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl318 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl318();
        }
        return INSTANCE;
    }

    private BasepPack2Impl318(){
