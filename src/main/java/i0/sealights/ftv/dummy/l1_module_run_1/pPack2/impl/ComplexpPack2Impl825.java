...
public class ComplexpPack2Impl825 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl825.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl825 INSTANCE;

    public static ComplexpPack2Impl825 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl825();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl825(){
