...
public class BasepPack1Impl603 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl603.class);
    private static BasepPack1Impl603 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl603 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl603();
        }
        return INSTANCE;
    }

    private BasepPack1Impl603(){
