...
public class ComplexpPack1Impl637 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl637.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl637 INSTANCE;

    public static ComplexpPack1Impl637 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl637();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl637(){
