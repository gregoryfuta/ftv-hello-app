...
public class ComplexpPack2Impl424 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl424.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl424 INSTANCE;

    public static ComplexpPack2Impl424 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl424();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl424(){
