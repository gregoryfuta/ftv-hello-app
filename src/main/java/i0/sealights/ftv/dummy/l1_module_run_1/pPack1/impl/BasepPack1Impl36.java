...
public class BasepPack1Impl36 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl36.class);
    private static BasepPack1Impl36 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl36 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl36();
        }
        return INSTANCE;
    }

    private BasepPack1Impl36(){
