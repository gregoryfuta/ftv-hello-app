...
public class ComplexpPack1Impl132 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl132.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl132 INSTANCE;

    public static ComplexpPack1Impl132 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl132();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl132(){
