...
public class ComplexpPack2Impl53 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl53.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl53 INSTANCE;

    public static ComplexpPack2Impl53 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl53();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl53(){
