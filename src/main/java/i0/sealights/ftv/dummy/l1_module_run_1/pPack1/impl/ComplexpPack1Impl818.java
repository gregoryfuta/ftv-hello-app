...
public class ComplexpPack1Impl818 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl818.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl818 INSTANCE;

    public static ComplexpPack1Impl818 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl818();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl818(){
