...
public class BasepPack1Impl137 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl137.class);
    private static BasepPack1Impl137 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl137 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl137();
        }
        return INSTANCE;
    }

    private BasepPack1Impl137(){
