...
public class ComplexpPack2Impl610 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl610.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl610 INSTANCE;

    public static ComplexpPack2Impl610 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl610();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl610(){
