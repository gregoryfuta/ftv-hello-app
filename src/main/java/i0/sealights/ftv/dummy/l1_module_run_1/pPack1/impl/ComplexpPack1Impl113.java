...
public class ComplexpPack1Impl113 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl113.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl113 INSTANCE;

    public static ComplexpPack1Impl113 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl113();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl113(){
