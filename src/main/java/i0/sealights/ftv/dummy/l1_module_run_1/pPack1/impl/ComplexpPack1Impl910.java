...
public class ComplexpPack1Impl910 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl910.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl910 INSTANCE;

    public static ComplexpPack1Impl910 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl910();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl910(){
