...
public class ComplexpPack2Impl202 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl202.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl202 INSTANCE;

    public static ComplexpPack2Impl202 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl202();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl202(){
