...
public class ComplexpPack1Impl801 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl801.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl801 INSTANCE;

    public static ComplexpPack1Impl801 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl801();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl801(){
