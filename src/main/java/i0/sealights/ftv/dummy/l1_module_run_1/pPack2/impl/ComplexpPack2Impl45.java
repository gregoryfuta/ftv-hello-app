...
public class ComplexpPack2Impl45 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl45.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl45 INSTANCE;

    public static ComplexpPack2Impl45 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl45();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl45(){
