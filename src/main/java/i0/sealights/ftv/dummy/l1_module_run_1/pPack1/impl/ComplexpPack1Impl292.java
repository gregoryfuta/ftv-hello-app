...
public class ComplexpPack1Impl292 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl292.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl292 INSTANCE;

    public static ComplexpPack1Impl292 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl292();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl292(){
