...
public class ComplexpPack1Impl28 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl28.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl28 INSTANCE;

    public static ComplexpPack1Impl28 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl28();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl28(){
