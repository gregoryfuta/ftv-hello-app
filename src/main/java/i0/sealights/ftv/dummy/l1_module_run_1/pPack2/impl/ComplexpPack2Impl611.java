...
public class ComplexpPack2Impl611 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl611.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl611 INSTANCE;

    public static ComplexpPack2Impl611 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl611();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl611(){
