...
public class BasepPack1Impl318 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl318.class);
    private static BasepPack1Impl318 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl318 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl318();
        }
        return INSTANCE;
    }

    private BasepPack1Impl318(){
