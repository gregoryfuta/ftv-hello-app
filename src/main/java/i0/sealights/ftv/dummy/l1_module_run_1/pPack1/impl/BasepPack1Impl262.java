...
public class BasepPack1Impl262 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl262.class);
    private static BasepPack1Impl262 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl262 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl262();
        }
        return INSTANCE;
    }

    private BasepPack1Impl262(){
