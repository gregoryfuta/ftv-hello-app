...
public class ComplexpPack1Impl546 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl546.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl546 INSTANCE;

    public static ComplexpPack1Impl546 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl546();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl546(){
