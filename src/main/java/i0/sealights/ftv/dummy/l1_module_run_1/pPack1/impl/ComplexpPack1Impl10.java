...
public class ComplexpPack1Impl10 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl10.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl10 INSTANCE;

    public static ComplexpPack1Impl10 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl10();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl10(){
