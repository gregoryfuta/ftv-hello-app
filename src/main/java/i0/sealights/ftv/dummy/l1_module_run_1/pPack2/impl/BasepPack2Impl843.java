...
public class BasepPack2Impl843 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl843.class);
    private static BasepPack2Impl843 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl843 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl843();
        }
        return INSTANCE;
    }

    private BasepPack2Impl843(){
