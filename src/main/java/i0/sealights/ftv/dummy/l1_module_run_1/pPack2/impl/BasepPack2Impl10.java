...
public class BasepPack2Impl10 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl10.class);
    private static BasepPack2Impl10 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl10 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl10();
        }
        return INSTANCE;
    }

    private BasepPack2Impl10(){
