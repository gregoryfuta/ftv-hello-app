...
public class BasepPack2Impl181 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl181.class);
    private static BasepPack2Impl181 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl181 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl181();
        }
        return INSTANCE;
    }

    private BasepPack2Impl181(){
