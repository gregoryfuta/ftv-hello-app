...
public class ComplexpPack2Impl620 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl620.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl620 INSTANCE;

    public static ComplexpPack2Impl620 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl620();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl620(){
