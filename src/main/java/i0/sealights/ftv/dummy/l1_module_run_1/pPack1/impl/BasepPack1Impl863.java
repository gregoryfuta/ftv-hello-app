...
public class BasepPack1Impl863 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl863.class);
    private static BasepPack1Impl863 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl863 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl863();
        }
        return INSTANCE;
    }

    private BasepPack1Impl863(){
