...
public class ComplexpPack1Impl899 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl899.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl899 INSTANCE;

    public static ComplexpPack1Impl899 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl899();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl899(){
