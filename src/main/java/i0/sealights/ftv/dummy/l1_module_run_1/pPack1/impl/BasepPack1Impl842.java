...
public class BasepPack1Impl842 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl842.class);
    private static BasepPack1Impl842 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl842 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl842();
        }
        return INSTANCE;
    }

    private BasepPack1Impl842(){
