...
public class ComplexpPack2Impl442 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl442.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl442 INSTANCE;

    public static ComplexpPack2Impl442 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl442();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl442(){
