...
public class BasepPack2Impl391 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl391.class);
    private static BasepPack2Impl391 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl391 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl391();
        }
        return INSTANCE;
    }

    private BasepPack2Impl391(){
