...
public class BasepPack2Impl612 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl612.class);
    private static BasepPack2Impl612 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl612 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl612();
        }
        return INSTANCE;
    }

    private BasepPack2Impl612(){
