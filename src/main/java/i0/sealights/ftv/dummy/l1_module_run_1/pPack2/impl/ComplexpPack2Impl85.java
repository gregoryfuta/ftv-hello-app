...
public class ComplexpPack2Impl85 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl85.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl85 INSTANCE;

    public static ComplexpPack2Impl85 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl85();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl85(){
