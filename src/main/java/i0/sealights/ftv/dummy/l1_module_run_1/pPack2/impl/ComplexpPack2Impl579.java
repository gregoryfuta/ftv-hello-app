...
public class ComplexpPack2Impl579 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl579.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl579 INSTANCE;

    public static ComplexpPack2Impl579 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl579();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl579(){
