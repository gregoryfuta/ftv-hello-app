...
public class BasepPack1Impl76 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl76.class);
    private static BasepPack1Impl76 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl76 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl76();
        }
        return INSTANCE;
    }

    private BasepPack1Impl76(){
