...
public class BasepPack2Impl921 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl921.class);
    private static BasepPack2Impl921 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl921 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl921();
        }
        return INSTANCE;
    }

    private BasepPack2Impl921(){
