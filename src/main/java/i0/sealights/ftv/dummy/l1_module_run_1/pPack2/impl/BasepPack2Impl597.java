...
public class BasepPack2Impl597 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl597.class);
    private static BasepPack2Impl597 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl597 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl597();
        }
        return INSTANCE;
    }

    private BasepPack2Impl597(){
