...
public class BasepPack2Impl174 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl174.class);
    private static BasepPack2Impl174 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl174 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl174();
        }
        return INSTANCE;
    }

    private BasepPack2Impl174(){
