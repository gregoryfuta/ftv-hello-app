...
public class BasepPack2Impl820 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl820.class);
    private static BasepPack2Impl820 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl820 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl820();
        }
        return INSTANCE;
    }

    private BasepPack2Impl820(){
