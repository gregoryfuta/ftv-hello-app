...
public class BasepPack2Impl151 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl151.class);
    private static BasepPack2Impl151 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl151 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl151();
        }
        return INSTANCE;
    }

    private BasepPack2Impl151(){
