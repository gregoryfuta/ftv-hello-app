...
public class ComplexpPack1Impl695 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl695.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl695 INSTANCE;

    public static ComplexpPack1Impl695 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl695();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl695(){
