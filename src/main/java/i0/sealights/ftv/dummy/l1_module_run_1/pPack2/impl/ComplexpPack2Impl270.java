...
public class ComplexpPack2Impl270 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl270.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl270 INSTANCE;

    public static ComplexpPack2Impl270 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl270();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl270(){
