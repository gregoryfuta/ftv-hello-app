...
public class ComplexpPack1Impl238 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl238.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl238 INSTANCE;

    public static ComplexpPack1Impl238 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl238();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl238(){
