...
public class ComplexpPack2Impl441 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl441.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl441 INSTANCE;

    public static ComplexpPack2Impl441 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl441();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl441(){
