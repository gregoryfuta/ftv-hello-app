...
public class BasepPack1Impl346 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl346.class);
    private static BasepPack1Impl346 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl346 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl346();
        }
        return INSTANCE;
    }

    private BasepPack1Impl346(){
