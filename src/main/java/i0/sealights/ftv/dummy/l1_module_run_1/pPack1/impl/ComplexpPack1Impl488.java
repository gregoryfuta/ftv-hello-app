...
public class ComplexpPack1Impl488 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl488.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl488 INSTANCE;

    public static ComplexpPack1Impl488 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl488();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl488(){
