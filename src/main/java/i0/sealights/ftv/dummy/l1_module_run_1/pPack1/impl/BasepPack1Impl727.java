...
public class BasepPack1Impl727 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl727.class);
    private static BasepPack1Impl727 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl727 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl727();
        }
        return INSTANCE;
    }

    private BasepPack1Impl727(){
