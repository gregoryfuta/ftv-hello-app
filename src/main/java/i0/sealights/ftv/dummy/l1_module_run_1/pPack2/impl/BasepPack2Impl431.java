...
public class BasepPack2Impl431 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl431.class);
    private static BasepPack2Impl431 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl431 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl431();
        }
        return INSTANCE;
    }

    private BasepPack2Impl431(){
