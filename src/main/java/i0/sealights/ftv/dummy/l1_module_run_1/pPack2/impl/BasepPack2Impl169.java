...
public class BasepPack2Impl169 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl169.class);
    private static BasepPack2Impl169 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl169 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl169();
        }
        return INSTANCE;
    }

    private BasepPack2Impl169(){
