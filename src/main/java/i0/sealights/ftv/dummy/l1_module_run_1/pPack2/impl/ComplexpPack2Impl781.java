...
public class ComplexpPack2Impl781 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl781.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl781 INSTANCE;

    public static ComplexpPack2Impl781 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl781();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl781(){
