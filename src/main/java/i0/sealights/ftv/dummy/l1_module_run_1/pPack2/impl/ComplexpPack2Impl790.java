...
public class ComplexpPack2Impl790 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl790.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl790 INSTANCE;

    public static ComplexpPack2Impl790 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl790();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl790(){
