...
public class BasepPack2Impl622 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl622.class);
    private static BasepPack2Impl622 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl622 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl622();
        }
        return INSTANCE;
    }

    private BasepPack2Impl622(){
