...
public class ComplexpPack2Impl37 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl37.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl37 INSTANCE;

    public static ComplexpPack2Impl37 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl37();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl37(){
