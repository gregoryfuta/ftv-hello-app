...
public class BasepPack1Impl800 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl800.class);
    private static BasepPack1Impl800 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl800 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl800();
        }
        return INSTANCE;
    }

    private BasepPack1Impl800(){
