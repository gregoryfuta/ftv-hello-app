...
public class BasepPack1Impl448 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl448.class);
    private static BasepPack1Impl448 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl448 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl448();
        }
        return INSTANCE;
    }

    private BasepPack1Impl448(){
