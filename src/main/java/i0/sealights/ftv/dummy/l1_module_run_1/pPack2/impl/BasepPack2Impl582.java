...
public class BasepPack2Impl582 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl582.class);
    private static BasepPack2Impl582 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl582 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl582();
        }
        return INSTANCE;
    }

    private BasepPack2Impl582(){
