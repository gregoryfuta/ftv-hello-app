...
public class ComplexpPack2Impl727 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl727.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl727 INSTANCE;

    public static ComplexpPack2Impl727 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl727();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl727(){
