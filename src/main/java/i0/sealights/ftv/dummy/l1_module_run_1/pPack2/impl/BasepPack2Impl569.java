...
public class BasepPack2Impl569 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl569.class);
    private static BasepPack2Impl569 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl569 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl569();
        }
        return INSTANCE;
    }

    private BasepPack2Impl569(){
