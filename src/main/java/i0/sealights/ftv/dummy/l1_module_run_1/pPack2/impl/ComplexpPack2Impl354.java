...
public class ComplexpPack2Impl354 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl354.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl354 INSTANCE;

    public static ComplexpPack2Impl354 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl354();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl354(){
