...
public class ComplexpPack1Impl650 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl650.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl650 INSTANCE;

    public static ComplexpPack1Impl650 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl650();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl650(){
