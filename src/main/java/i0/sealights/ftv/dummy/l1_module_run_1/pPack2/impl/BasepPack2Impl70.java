...
public class BasepPack2Impl70 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl70.class);
    private static BasepPack2Impl70 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl70 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl70();
        }
        return INSTANCE;
    }

    private BasepPack2Impl70(){
