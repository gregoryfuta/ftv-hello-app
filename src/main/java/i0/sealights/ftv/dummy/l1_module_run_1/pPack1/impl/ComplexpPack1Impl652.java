...
public class ComplexpPack1Impl652 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl652.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl652 INSTANCE;

    public static ComplexpPack1Impl652 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl652();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl652(){
