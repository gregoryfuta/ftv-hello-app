...
public class BasepPack1Impl564 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl564.class);
    private static BasepPack1Impl564 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl564 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl564();
        }
        return INSTANCE;
    }

    private BasepPack1Impl564(){
