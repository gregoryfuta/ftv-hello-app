...
public class BasepPack1Impl666 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl666.class);
    private static BasepPack1Impl666 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl666 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl666();
        }
        return INSTANCE;
    }

    private BasepPack1Impl666(){
