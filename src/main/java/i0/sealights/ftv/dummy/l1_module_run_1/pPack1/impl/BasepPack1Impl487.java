...
public class BasepPack1Impl487 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl487.class);
    private static BasepPack1Impl487 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl487 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl487();
        }
        return INSTANCE;
    }

    private BasepPack1Impl487(){
