...
public class ComplexpPack1Impl952 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl952.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl952 INSTANCE;

    public static ComplexpPack1Impl952 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl952();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl952(){
