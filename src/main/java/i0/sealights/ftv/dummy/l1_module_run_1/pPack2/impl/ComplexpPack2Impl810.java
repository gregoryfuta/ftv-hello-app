...
public class ComplexpPack2Impl810 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl810.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl810 INSTANCE;

    public static ComplexpPack2Impl810 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl810();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl810(){
