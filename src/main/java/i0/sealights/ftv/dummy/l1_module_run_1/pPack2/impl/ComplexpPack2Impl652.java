...
public class ComplexpPack2Impl652 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl652.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl652 INSTANCE;

    public static ComplexpPack2Impl652 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl652();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl652(){
