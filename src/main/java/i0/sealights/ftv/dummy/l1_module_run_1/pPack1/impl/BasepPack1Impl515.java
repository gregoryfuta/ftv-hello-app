...
public class BasepPack1Impl515 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl515.class);
    private static BasepPack1Impl515 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl515 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl515();
        }
        return INSTANCE;
    }

    private BasepPack1Impl515(){
