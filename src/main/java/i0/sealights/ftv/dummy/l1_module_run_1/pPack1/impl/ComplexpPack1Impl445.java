...
public class ComplexpPack1Impl445 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl445.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl445 INSTANCE;

    public static ComplexpPack1Impl445 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl445();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl445(){
