...
public class BasepPack1Impl447 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl447.class);
    private static BasepPack1Impl447 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl447 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl447();
        }
        return INSTANCE;
    }

    private BasepPack1Impl447(){
