...
public class ComplexpPack1Impl316 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl316.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl316 INSTANCE;

    public static ComplexpPack1Impl316 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl316();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl316(){
