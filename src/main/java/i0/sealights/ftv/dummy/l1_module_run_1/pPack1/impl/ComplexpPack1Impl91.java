...
public class ComplexpPack1Impl91 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl91.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl91 INSTANCE;

    public static ComplexpPack1Impl91 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl91();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl91(){
