...
public class BasepPack2Impl851 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl851.class);
    private static BasepPack2Impl851 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl851 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl851();
        }
        return INSTANCE;
    }

    private BasepPack2Impl851(){
