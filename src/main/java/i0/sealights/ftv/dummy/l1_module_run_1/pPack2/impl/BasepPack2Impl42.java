...
public class BasepPack2Impl42 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl42.class);
    private static BasepPack2Impl42 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl42 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl42();
        }
        return INSTANCE;
    }

    private BasepPack2Impl42(){
