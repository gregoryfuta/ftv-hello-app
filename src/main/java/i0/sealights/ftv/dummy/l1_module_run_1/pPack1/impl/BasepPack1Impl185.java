...
public class BasepPack1Impl185 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl185.class);
    private static BasepPack1Impl185 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl185 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl185();
        }
        return INSTANCE;
    }

    private BasepPack1Impl185(){
