...
public class BasepPack2Impl895 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl895.class);
    private static BasepPack2Impl895 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl895 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl895();
        }
        return INSTANCE;
    }

    private BasepPack2Impl895(){
