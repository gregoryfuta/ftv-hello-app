...
public class BasepPack1Impl455 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl455.class);
    private static BasepPack1Impl455 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl455 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl455();
        }
        return INSTANCE;
    }

    private BasepPack1Impl455(){
