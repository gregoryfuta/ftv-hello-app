...
public class BasepPack2Impl401 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl401.class);
    private static BasepPack2Impl401 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl401 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl401();
        }
        return INSTANCE;
    }

    private BasepPack2Impl401(){
