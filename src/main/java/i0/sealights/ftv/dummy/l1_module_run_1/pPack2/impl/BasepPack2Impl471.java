...
public class BasepPack2Impl471 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl471.class);
    private static BasepPack2Impl471 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl471 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl471();
        }
        return INSTANCE;
    }

    private BasepPack2Impl471(){
