...
public class BasepPack1Impl290 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl290.class);
    private static BasepPack1Impl290 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl290 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl290();
        }
        return INSTANCE;
    }

    private BasepPack1Impl290(){
