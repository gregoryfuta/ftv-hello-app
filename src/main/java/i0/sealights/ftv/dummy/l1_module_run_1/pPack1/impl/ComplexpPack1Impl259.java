...
public class ComplexpPack1Impl259 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl259.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl259 INSTANCE;

    public static ComplexpPack1Impl259 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl259();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl259(){
