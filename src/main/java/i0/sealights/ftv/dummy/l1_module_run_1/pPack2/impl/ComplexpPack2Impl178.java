...
public class ComplexpPack2Impl178 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl178.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl178 INSTANCE;

    public static ComplexpPack2Impl178 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl178();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl178(){
