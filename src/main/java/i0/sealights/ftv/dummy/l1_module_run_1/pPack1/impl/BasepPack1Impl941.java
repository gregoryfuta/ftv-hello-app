...
public class BasepPack1Impl941 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl941.class);
    private static BasepPack1Impl941 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl941 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl941();
        }
        return INSTANCE;
    }

    private BasepPack1Impl941(){
