...
public class ComplexpPack1Impl379 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl379.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl379 INSTANCE;

    public static ComplexpPack1Impl379 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl379();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl379(){
