...
public class ComplexpPack2Impl600 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl600.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl600 INSTANCE;

    public static ComplexpPack2Impl600 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl600();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl600(){
