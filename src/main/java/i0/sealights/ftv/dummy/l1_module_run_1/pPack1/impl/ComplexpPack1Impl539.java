...
public class ComplexpPack1Impl539 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl539.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl539 INSTANCE;

    public static ComplexpPack1Impl539 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl539();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl539(){
