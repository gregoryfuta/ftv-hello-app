...
public class ComplexpPack2Impl486 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl486.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl486 INSTANCE;

    public static ComplexpPack2Impl486 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl486();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl486(){
