...
public class BasepPack1Impl976 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl976.class);
    private static BasepPack1Impl976 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl976 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl976();
        }
        return INSTANCE;
    }

    private BasepPack1Impl976(){
