...
public class BasepPack2Impl656 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl656.class);
    private static BasepPack2Impl656 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl656 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl656();
        }
        return INSTANCE;
    }

    private BasepPack2Impl656(){
