...
public class BasepPack1Impl368 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl368.class);
    private static BasepPack1Impl368 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl368 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl368();
        }
        return INSTANCE;
    }

    private BasepPack1Impl368(){
