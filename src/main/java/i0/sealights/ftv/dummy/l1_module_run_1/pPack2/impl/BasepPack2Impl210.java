...
public class BasepPack2Impl210 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl210.class);
    private static BasepPack2Impl210 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl210 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl210();
        }
        return INSTANCE;
    }

    private BasepPack2Impl210(){
