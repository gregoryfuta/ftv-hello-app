...
public class BasepPack2Impl727 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl727.class);
    private static BasepPack2Impl727 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl727 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl727();
        }
        return INSTANCE;
    }

    private BasepPack2Impl727(){
