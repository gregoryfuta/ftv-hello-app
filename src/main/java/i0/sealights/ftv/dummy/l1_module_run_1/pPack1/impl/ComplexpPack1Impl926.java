...
public class ComplexpPack1Impl926 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl926.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl926 INSTANCE;

    public static ComplexpPack1Impl926 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl926();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl926(){
