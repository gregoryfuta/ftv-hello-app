...
public class ComplexpPack1Impl573 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl573.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl573 INSTANCE;

    public static ComplexpPack1Impl573 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl573();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl573(){
