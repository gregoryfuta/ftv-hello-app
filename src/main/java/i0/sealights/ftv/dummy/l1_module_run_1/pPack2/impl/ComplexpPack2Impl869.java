...
public class ComplexpPack2Impl869 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl869.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl869 INSTANCE;

    public static ComplexpPack2Impl869 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl869();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl869(){
