...
public class ComplexpPack1Impl528 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl528.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl528 INSTANCE;

    public static ComplexpPack1Impl528 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl528();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl528(){
