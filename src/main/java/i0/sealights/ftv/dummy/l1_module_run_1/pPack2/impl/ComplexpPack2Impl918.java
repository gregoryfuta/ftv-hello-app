...
public class ComplexpPack2Impl918 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl918.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl918 INSTANCE;

    public static ComplexpPack2Impl918 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl918();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl918(){
