...
public class BasepPack1Impl415 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl415.class);
    private static BasepPack1Impl415 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl415 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl415();
        }
        return INSTANCE;
    }

    private BasepPack1Impl415(){
