...
public class ComplexpPack2Impl454 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl454.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl454 INSTANCE;

    public static ComplexpPack2Impl454 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl454();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl454(){
