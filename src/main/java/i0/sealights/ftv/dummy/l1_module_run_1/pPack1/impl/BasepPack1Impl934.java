...
public class BasepPack1Impl934 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl934.class);
    private static BasepPack1Impl934 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl934 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl934();
        }
        return INSTANCE;
    }

    private BasepPack1Impl934(){
