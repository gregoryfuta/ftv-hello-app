...
public class ComplexpPack2Impl754 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl754.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl754 INSTANCE;

    public static ComplexpPack2Impl754 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl754();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl754(){
