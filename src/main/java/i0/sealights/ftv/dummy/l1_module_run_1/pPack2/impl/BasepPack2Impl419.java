...
public class BasepPack2Impl419 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl419.class);
    private static BasepPack2Impl419 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl419 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl419();
        }
        return INSTANCE;
    }

    private BasepPack2Impl419(){
