...
public class ComplexpPack2Impl538 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl538.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl538 INSTANCE;

    public static ComplexpPack2Impl538 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl538();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl538(){
