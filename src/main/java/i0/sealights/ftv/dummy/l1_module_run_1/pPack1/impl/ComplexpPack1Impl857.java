...
public class ComplexpPack1Impl857 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl857.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl857 INSTANCE;

    public static ComplexpPack1Impl857 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl857();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl857(){
