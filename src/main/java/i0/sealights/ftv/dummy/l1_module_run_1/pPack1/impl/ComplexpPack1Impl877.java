...
public class ComplexpPack1Impl877 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl877.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl877 INSTANCE;

    public static ComplexpPack1Impl877 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl877();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl877(){
