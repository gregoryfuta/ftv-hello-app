...
public class BasepPack1Impl820 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl820.class);
    private static BasepPack1Impl820 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl820 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl820();
        }
        return INSTANCE;
    }

    private BasepPack1Impl820(){
