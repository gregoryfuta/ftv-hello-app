...
public class ComplexpPack1Impl872 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl872.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl872 INSTANCE;

    public static ComplexpPack1Impl872 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl872();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl872(){
