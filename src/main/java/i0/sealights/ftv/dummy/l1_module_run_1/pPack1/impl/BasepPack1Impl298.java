...
public class BasepPack1Impl298 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl298.class);
    private static BasepPack1Impl298 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl298 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl298();
        }
        return INSTANCE;
    }

    private BasepPack1Impl298(){
