...
public class ComplexpPack1Impl537 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl537.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl537 INSTANCE;

    public static ComplexpPack1Impl537 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl537();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl537(){
