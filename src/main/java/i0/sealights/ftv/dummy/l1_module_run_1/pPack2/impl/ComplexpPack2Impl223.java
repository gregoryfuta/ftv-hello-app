...
public class ComplexpPack2Impl223 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl223.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl223 INSTANCE;

    public static ComplexpPack2Impl223 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl223();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl223(){
