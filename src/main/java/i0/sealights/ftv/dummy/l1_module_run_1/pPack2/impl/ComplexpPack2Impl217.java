...
public class ComplexpPack2Impl217 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl217.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl217 INSTANCE;

    public static ComplexpPack2Impl217 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl217();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl217(){
