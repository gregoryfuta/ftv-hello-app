...
public class ComplexpPack2Impl1055 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1055.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1055 INSTANCE;

    public static ComplexpPack2Impl1055 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1055();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1055(){
