...
public class ComplexpPack2Impl238 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl238.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl238 INSTANCE;

    public static ComplexpPack2Impl238 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl238();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl238(){
