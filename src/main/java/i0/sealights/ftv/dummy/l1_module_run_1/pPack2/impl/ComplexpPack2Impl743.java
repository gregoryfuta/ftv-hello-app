...
public class ComplexpPack2Impl743 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl743.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl743 INSTANCE;

    public static ComplexpPack2Impl743 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl743();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl743(){
