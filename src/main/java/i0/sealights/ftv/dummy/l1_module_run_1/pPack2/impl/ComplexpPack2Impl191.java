...
public class ComplexpPack2Impl191 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl191.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl191 INSTANCE;

    public static ComplexpPack2Impl191 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl191();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl191(){
