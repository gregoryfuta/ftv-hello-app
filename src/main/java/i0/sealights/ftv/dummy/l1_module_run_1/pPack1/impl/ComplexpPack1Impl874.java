...
public class ComplexpPack1Impl874 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl874.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl874 INSTANCE;

    public static ComplexpPack1Impl874 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl874();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl874(){
