...
public class ComplexpPack1Impl839 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl839.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl839 INSTANCE;

    public static ComplexpPack1Impl839 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl839();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl839(){
