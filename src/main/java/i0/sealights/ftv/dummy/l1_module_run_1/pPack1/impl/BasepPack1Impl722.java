...
public class BasepPack1Impl722 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl722.class);
    private static BasepPack1Impl722 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl722 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl722();
        }
        return INSTANCE;
    }

    private BasepPack1Impl722(){
