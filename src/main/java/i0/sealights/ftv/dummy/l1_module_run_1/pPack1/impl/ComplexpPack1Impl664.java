...
public class ComplexpPack1Impl664 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl664.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl664 INSTANCE;

    public static ComplexpPack1Impl664 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl664();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl664(){
