...
public class ComplexpPack1Impl78 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl78.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl78 INSTANCE;

    public static ComplexpPack1Impl78 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl78();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl78(){
