...
public class ComplexpPack2Impl423 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl423.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl423 INSTANCE;

    public static ComplexpPack2Impl423 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl423();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl423(){
