...
public class BasepPack1Impl859 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl859.class);
    private static BasepPack1Impl859 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl859 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl859();
        }
        return INSTANCE;
    }

    private BasepPack1Impl859(){
