...
public class BasepPack1Impl263 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl263.class);
    private static BasepPack1Impl263 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl263 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl263();
        }
        return INSTANCE;
    }

    private BasepPack1Impl263(){
