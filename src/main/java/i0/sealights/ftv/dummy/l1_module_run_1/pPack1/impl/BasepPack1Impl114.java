...
public class BasepPack1Impl114 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl114.class);
    private static BasepPack1Impl114 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl114 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl114();
        }
        return INSTANCE;
    }

    private BasepPack1Impl114(){
