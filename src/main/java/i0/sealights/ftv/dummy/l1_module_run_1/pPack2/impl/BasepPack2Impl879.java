...
public class BasepPack2Impl879 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl879.class);
    private static BasepPack2Impl879 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl879 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl879();
        }
        return INSTANCE;
    }

    private BasepPack2Impl879(){
