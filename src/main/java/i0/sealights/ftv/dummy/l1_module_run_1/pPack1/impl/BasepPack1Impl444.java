...
public class BasepPack1Impl444 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl444.class);
    private static BasepPack1Impl444 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl444 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl444();
        }
        return INSTANCE;
    }

    private BasepPack1Impl444(){
