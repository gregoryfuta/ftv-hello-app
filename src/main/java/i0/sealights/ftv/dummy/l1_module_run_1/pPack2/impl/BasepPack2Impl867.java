...
public class BasepPack2Impl867 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl867.class);
    private static BasepPack2Impl867 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl867 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl867();
        }
        return INSTANCE;
    }

    private BasepPack2Impl867(){
