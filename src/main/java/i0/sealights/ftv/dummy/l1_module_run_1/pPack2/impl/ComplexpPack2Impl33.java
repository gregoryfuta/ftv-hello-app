...
public class ComplexpPack2Impl33 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl33.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl33 INSTANCE;

    public static ComplexpPack2Impl33 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl33();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl33(){
