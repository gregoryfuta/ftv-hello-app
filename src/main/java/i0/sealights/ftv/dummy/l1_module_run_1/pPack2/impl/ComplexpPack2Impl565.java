...
public class ComplexpPack2Impl565 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl565.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl565 INSTANCE;

    public static ComplexpPack2Impl565 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl565();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl565(){
