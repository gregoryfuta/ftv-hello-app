...
public class ComplexpPack2Impl59 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl59.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl59 INSTANCE;

    public static ComplexpPack2Impl59 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl59();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl59(){
