...
public class BasepPack1Impl630 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl630.class);
    private static BasepPack1Impl630 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl630 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl630();
        }
        return INSTANCE;
    }

    private BasepPack1Impl630(){
