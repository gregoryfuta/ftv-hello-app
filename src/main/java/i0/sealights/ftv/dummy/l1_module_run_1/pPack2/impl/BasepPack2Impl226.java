...
public class BasepPack2Impl226 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl226.class);
    private static BasepPack2Impl226 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl226 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl226();
        }
        return INSTANCE;
    }

    private BasepPack2Impl226(){
