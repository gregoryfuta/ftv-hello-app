...
public class BasepPack1Impl648 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl648.class);
    private static BasepPack1Impl648 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl648 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl648();
        }
        return INSTANCE;
    }

    private BasepPack1Impl648(){
