...
public class ComplexpPack2Impl907 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl907.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl907 INSTANCE;

    public static ComplexpPack2Impl907 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl907();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl907(){
