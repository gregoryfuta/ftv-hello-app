...
public class BasepPack1Impl924 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl924.class);
    private static BasepPack1Impl924 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl924 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl924();
        }
        return INSTANCE;
    }

    private BasepPack1Impl924(){
