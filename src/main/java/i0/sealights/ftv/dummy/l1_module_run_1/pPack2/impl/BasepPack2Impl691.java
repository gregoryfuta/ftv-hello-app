...
public class BasepPack2Impl691 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl691.class);
    private static BasepPack2Impl691 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl691 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl691();
        }
        return INSTANCE;
    }

    private BasepPack2Impl691(){
