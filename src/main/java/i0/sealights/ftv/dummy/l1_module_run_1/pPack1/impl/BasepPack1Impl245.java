...
public class BasepPack1Impl245 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl245.class);
    private static BasepPack1Impl245 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl245 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl245();
        }
        return INSTANCE;
    }

    private BasepPack1Impl245(){
