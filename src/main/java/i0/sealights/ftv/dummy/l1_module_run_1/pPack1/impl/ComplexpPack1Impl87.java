...
public class ComplexpPack1Impl87 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl87.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl87 INSTANCE;

    public static ComplexpPack1Impl87 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl87();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl87(){
