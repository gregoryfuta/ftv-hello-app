...
public class ComplexpPack1Impl765 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl765.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl765 INSTANCE;

    public static ComplexpPack1Impl765 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl765();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl765(){
