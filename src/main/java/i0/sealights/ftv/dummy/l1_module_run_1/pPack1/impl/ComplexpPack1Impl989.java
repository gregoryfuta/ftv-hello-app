...
public class ComplexpPack1Impl989 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl989.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl989 INSTANCE;

    public static ComplexpPack1Impl989 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl989();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl989(){
