...
public class ComplexpPack1Impl192 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl192.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl192 INSTANCE;

    public static ComplexpPack1Impl192 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl192();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl192(){
