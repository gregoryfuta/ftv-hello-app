...
public class BasepPack2Impl528 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl528.class);
    private static BasepPack2Impl528 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl528 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl528();
        }
        return INSTANCE;
    }

    private BasepPack2Impl528(){
