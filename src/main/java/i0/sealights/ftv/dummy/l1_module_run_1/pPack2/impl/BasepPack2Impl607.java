...
public class BasepPack2Impl607 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl607.class);
    private static BasepPack2Impl607 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl607 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl607();
        }
        return INSTANCE;
    }

    private BasepPack2Impl607(){
