...
public class ComplexpPack2Impl368 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl368.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl368 INSTANCE;

    public static ComplexpPack2Impl368 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl368();
        }
        return INSTANCE;
    }
