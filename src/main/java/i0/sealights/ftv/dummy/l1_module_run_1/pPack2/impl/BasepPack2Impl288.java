...
public class BasepPack2Impl288 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl288.class);
    private static BasepPack2Impl288 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl288 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl288();
        }
        return INSTANCE;
    }

    private BasepPack2Impl288(){
