...
public class ComplexpPack2Impl58 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl58.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl58 INSTANCE;

    public static ComplexpPack2Impl58 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl58();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl58(){
