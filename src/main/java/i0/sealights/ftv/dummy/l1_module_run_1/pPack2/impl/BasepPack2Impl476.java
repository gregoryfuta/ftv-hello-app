...
public class BasepPack2Impl476 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl476.class);
    private static BasepPack2Impl476 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl476 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl476();
        }
        return INSTANCE;
    }

    private BasepPack2Impl476(){
