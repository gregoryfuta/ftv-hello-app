...
public class BasepPack2Impl920 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl920.class);
    private static BasepPack2Impl920 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl920 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl920();
        }
        return INSTANCE;
    }

    private BasepPack2Impl920(){
