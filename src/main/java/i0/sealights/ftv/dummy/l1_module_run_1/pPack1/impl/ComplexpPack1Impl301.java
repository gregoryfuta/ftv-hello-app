...
public class ComplexpPack1Impl301 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl301.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl301 INSTANCE;

    public static ComplexpPack1Impl301 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl301();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl301(){
