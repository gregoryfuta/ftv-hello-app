...
public class BasepPack1Impl839 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl839.class);
    private static BasepPack1Impl839 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl839 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl839();
        }
        return INSTANCE;
    }

    private BasepPack1Impl839(){
