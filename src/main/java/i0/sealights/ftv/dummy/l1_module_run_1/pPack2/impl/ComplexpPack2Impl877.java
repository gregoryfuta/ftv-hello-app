...
public class ComplexpPack2Impl877 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl877.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl877 INSTANCE;

    public static ComplexpPack2Impl877 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl877();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl877(){
