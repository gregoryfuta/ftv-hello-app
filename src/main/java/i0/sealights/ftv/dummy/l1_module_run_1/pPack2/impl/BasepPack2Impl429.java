...
public class BasepPack2Impl429 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl429.class);
    private static BasepPack2Impl429 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl429 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl429();
        }
        return INSTANCE;
    }

    private BasepPack2Impl429(){
