...
public class BasepPack2Impl49 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl49.class);
    private static BasepPack2Impl49 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl49 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl49();
        }
        return INSTANCE;
    }

    private BasepPack2Impl49(){
