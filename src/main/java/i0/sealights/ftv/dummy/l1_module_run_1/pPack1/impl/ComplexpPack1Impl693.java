...
public class ComplexpPack1Impl693 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl693.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl693 INSTANCE;

    public static ComplexpPack1Impl693 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl693();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl693(){
