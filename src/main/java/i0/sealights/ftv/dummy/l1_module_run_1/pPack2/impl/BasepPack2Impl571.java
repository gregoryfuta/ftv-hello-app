...
public class BasepPack2Impl571 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl571.class);
    private static BasepPack2Impl571 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl571 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl571();
        }
        return INSTANCE;
    }

    private BasepPack2Impl571(){
