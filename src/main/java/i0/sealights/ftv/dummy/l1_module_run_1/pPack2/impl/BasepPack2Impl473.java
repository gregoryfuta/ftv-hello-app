...
public class BasepPack2Impl473 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl473.class);
    private static BasepPack2Impl473 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl473 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl473();
        }
        return INSTANCE;
    }

    private BasepPack2Impl473(){
