...
public class ComplexpPack2Impl587 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl587.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl587 INSTANCE;

    public static ComplexpPack2Impl587 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl587();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl587(){
