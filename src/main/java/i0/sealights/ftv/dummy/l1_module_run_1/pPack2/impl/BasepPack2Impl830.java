...
public class BasepPack2Impl830 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl830.class);
    private static BasepPack2Impl830 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl830 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl830();
        }
        return INSTANCE;
    }

    private BasepPack2Impl830(){
