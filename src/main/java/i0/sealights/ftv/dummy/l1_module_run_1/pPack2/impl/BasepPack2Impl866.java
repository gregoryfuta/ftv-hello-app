...
public class BasepPack2Impl866 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl866.class);
    private static BasepPack2Impl866 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl866 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl866();
        }
        return INSTANCE;
    }

    private BasepPack2Impl866(){
