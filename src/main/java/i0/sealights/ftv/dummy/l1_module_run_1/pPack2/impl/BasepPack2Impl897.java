...
public class BasepPack2Impl897 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl897.class);
    private static BasepPack2Impl897 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl897 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl897();
        }
        return INSTANCE;
    }

    private BasepPack2Impl897(){
