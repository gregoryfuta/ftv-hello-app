...
public class ComplexpPack2Impl984 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl984.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl984 INSTANCE;

    public static ComplexpPack2Impl984 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl984();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl984(){
