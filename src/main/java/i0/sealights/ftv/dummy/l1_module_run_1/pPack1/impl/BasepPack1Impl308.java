...
public class BasepPack1Impl308 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl308.class);
    private static BasepPack1Impl308 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl308 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl308();
        }
        return INSTANCE;
    }

    private BasepPack1Impl308(){
