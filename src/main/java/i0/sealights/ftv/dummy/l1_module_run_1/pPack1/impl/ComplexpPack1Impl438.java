...
public class ComplexpPack1Impl438 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl438.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl438 INSTANCE;

    public static ComplexpPack1Impl438 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl438();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl438(){
