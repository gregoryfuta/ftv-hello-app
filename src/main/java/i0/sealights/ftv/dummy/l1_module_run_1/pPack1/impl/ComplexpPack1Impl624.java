...
public class ComplexpPack1Impl624 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl624.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl624 INSTANCE;

    public static ComplexpPack1Impl624 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl624();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl624(){
