...
public class BasepPack2Impl707 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl707.class);
    private static BasepPack2Impl707 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl707 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl707();
        }
        return INSTANCE;
    }

    private BasepPack2Impl707(){
