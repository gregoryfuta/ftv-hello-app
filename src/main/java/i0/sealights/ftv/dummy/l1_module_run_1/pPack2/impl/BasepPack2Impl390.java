...
public class BasepPack2Impl390 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl390.class);
    private static BasepPack2Impl390 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl390 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl390();
        }
        return INSTANCE;
    }

    private BasepPack2Impl390(){
