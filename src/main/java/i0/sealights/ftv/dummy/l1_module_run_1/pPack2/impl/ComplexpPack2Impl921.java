...
public class ComplexpPack2Impl921 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl921.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl921 INSTANCE;

    public static ComplexpPack2Impl921 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl921();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl921(){
