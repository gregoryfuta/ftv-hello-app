...
public class BasepPack2Impl745 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl745.class);
    private static BasepPack2Impl745 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl745 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl745();
        }
        return INSTANCE;
    }

    private BasepPack2Impl745(){
