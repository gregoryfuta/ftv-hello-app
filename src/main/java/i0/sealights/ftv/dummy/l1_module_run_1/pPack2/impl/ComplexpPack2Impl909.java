...
public class ComplexpPack2Impl909 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl909.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl909 INSTANCE;

    public static ComplexpPack2Impl909 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl909();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl909(){
