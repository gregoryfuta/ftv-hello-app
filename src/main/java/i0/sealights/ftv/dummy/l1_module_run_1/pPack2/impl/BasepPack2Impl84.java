...
public class BasepPack2Impl84 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl84.class);
    private static BasepPack2Impl84 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl84 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl84();
        }
        return INSTANCE;
    }

    private BasepPack2Impl84(){
