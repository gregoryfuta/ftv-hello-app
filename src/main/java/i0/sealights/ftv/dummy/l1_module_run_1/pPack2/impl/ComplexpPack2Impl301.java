...
public class ComplexpPack2Impl301 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl301.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl301 INSTANCE;

    public static ComplexpPack2Impl301 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl301();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl301(){
