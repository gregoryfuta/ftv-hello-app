...
public class ComplexpPack2Impl91 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl91.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl91 INSTANCE;

    public static ComplexpPack2Impl91 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl91();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl91(){
