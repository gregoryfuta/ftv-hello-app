...
public class ComplexpPack2Impl325 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl325.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl325 INSTANCE;

    public static ComplexpPack2Impl325 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl325();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl325(){
