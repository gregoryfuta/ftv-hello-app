...
public class ComplexpPack2Impl472 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl472.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl472 INSTANCE;

    public static ComplexpPack2Impl472 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl472();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl472(){
