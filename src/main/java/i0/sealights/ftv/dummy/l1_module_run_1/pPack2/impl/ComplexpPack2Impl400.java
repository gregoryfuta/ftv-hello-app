...
public class ComplexpPack2Impl400 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl400.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl400 INSTANCE;

    public static ComplexpPack2Impl400 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl400();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl400(){
