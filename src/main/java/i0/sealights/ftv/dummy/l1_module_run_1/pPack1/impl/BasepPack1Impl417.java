...
public class BasepPack1Impl417 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl417.class);
    private static BasepPack1Impl417 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl417 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl417();
        }
        return INSTANCE;
    }

    private BasepPack1Impl417(){
