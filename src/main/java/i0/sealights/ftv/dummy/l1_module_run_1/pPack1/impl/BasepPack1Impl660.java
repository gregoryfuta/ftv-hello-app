...
public class BasepPack1Impl660 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl660.class);
    private static BasepPack1Impl660 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl660 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl660();
        }
        return INSTANCE;
    }

    private BasepPack1Impl660(){
