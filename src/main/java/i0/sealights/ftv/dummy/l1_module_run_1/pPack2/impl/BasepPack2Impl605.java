...
public class BasepPack2Impl605 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl605.class);
    private static BasepPack2Impl605 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl605 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl605();
        }
        return INSTANCE;
    }

    private BasepPack2Impl605(){
