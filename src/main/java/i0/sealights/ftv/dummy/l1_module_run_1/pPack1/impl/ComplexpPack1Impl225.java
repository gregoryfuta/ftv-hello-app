...
public class ComplexpPack1Impl225 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl225.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl225 INSTANCE;

    public static ComplexpPack1Impl225 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl225();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl225(){
