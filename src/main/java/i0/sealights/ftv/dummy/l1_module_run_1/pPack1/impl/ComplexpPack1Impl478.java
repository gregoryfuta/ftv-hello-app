...
public class ComplexpPack1Impl478 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl478.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl478 INSTANCE;

    public static ComplexpPack1Impl478 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl478();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl478(){
