...
public class ComplexpPack1Impl846 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl846.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl846 INSTANCE;

    public static ComplexpPack1Impl846 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl846();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl846(){
