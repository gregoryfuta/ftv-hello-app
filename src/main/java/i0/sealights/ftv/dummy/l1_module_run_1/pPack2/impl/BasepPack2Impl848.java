...
public class BasepPack2Impl848 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl848.class);
    private static BasepPack2Impl848 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl848 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl848();
        }
        return INSTANCE;
    }

    private BasepPack2Impl848(){
