...
public class ComplexpPack2Impl527 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl527.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl527 INSTANCE;

    public static ComplexpPack2Impl527 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl527();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl527(){
