...
public class BasepPack2Impl97 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl97.class);
    private static BasepPack2Impl97 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl97 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl97();
        }
        return INSTANCE;
    }

    private BasepPack2Impl97(){
