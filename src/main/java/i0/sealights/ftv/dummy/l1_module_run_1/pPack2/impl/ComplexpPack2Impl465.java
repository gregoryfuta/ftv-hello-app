...
public class ComplexpPack2Impl465 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl465.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl465 INSTANCE;

    public static ComplexpPack2Impl465 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl465();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl465(){
