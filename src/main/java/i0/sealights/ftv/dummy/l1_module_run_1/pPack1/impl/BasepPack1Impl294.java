...
public class BasepPack1Impl294 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl294.class);
    private static BasepPack1Impl294 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl294 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl294();
        }
        return INSTANCE;
    }

    private BasepPack1Impl294(){
