...
public class BasepPack1Impl431 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl431.class);
    private static BasepPack1Impl431 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl431 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl431();
        }
        return INSTANCE;
    }

    private BasepPack1Impl431(){
