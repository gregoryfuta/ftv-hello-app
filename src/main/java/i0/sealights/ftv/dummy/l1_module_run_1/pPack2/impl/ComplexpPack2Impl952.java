...
public class ComplexpPack2Impl952 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl952.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl952 INSTANCE;

    public static ComplexpPack2Impl952 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl952();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl952(){
