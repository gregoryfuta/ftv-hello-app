...
public class BasepPack2Impl128 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl128.class);
    private static BasepPack2Impl128 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl128 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl128();
        }
        return INSTANCE;
    }

    private BasepPack2Impl128(){
