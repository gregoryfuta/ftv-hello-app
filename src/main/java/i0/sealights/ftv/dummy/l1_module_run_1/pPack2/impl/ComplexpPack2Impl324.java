...
public class ComplexpPack2Impl324 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl324.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl324 INSTANCE;

    public static ComplexpPack2Impl324 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl324();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl324(){
