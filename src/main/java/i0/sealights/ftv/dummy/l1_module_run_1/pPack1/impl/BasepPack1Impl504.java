...
public class BasepPack1Impl504 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl504.class);
    private static BasepPack1Impl504 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl504 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl504();
        }
        return INSTANCE;
    }

    private BasepPack1Impl504(){
