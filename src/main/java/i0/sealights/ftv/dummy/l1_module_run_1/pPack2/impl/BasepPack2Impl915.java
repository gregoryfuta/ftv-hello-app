...
public class BasepPack2Impl915 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl915.class);
    private static BasepPack2Impl915 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl915 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl915();
        }
        return INSTANCE;
    }

    private BasepPack2Impl915(){
