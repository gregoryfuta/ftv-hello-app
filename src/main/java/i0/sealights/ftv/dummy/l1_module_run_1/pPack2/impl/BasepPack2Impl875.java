...
public class BasepPack2Impl875 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl875.class);
    private static BasepPack2Impl875 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl875 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl875();
        }
        return INSTANCE;
    }

    private BasepPack2Impl875(){
