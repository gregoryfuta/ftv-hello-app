...
public class BasepPack2Impl268 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl268.class);
    private static BasepPack2Impl268 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl268 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl268();
        }
        return INSTANCE;
    }

    private BasepPack2Impl268(){
