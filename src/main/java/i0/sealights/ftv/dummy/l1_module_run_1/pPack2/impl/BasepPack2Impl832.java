...
public class BasepPack2Impl832 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl832.class);
    private static BasepPack2Impl832 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl832 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl832();
        }
        return INSTANCE;
    }

    private BasepPack2Impl832(){
