...
public class ComplexpPack2Impl780 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl780.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl780 INSTANCE;

    public static ComplexpPack2Impl780 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl780();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl780(){
