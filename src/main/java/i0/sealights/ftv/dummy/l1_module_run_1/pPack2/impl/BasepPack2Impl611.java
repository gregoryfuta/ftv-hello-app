...
public class BasepPack2Impl611 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl611.class);
    private static BasepPack2Impl611 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl611 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl611();
        }
        return INSTANCE;
    }

    private BasepPack2Impl611(){
