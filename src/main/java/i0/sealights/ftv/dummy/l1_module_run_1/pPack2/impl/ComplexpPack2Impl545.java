...
public class ComplexpPack2Impl545 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl545.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl545 INSTANCE;

    public static ComplexpPack2Impl545 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl545();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl545(){
