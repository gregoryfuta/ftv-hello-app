...
public class ComplexpPack2Impl965 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl965.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl965 INSTANCE;

    public static ComplexpPack2Impl965 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl965();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl965(){
