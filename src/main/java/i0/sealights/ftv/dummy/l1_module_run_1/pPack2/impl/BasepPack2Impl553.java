...
public class BasepPack2Impl553 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl553.class);
    private static BasepPack2Impl553 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl553 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl553();
        }
        return INSTANCE;
    }

    private BasepPack2Impl553(){
