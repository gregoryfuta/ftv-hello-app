...
public class BasepPack2Impl532 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl532.class);
    private static BasepPack2Impl532 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl532 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl532();
        }
        return INSTANCE;
    }

    private BasepPack2Impl532(){
