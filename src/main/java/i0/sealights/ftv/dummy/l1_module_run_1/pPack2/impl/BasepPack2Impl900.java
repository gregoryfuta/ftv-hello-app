...
public class BasepPack2Impl900 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl900.class);
    private static BasepPack2Impl900 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl900 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl900();
        }
        return INSTANCE;
    }

    private BasepPack2Impl900(){
