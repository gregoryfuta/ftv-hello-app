...
public class BasepPack2Impl984 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl984.class);
    private static BasepPack2Impl984 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl984 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl984();
        }
        return INSTANCE;
    }

    private BasepPack2Impl984(){
