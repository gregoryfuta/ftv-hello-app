...
public class BasepPack2Impl702 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl702.class);
    private static BasepPack2Impl702 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl702 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl702();
        }
        return INSTANCE;
    }

    private BasepPack2Impl702(){
