...
public class BasepPack1Impl981 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl981.class);
    private static BasepPack1Impl981 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl981 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl981();
        }
        return INSTANCE;
    }

    private BasepPack1Impl981(){
