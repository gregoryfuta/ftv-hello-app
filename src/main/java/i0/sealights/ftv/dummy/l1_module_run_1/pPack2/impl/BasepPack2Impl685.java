...
public class BasepPack2Impl685 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl685.class);
    private static BasepPack2Impl685 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl685 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl685();
        }
        return INSTANCE;
    }

    private BasepPack2Impl685(){
