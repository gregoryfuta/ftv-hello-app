...
public class ComplexpPack2Impl922 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl922.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl922 INSTANCE;

    public static ComplexpPack2Impl922 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl922();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl922(){
