...
public class BasepPack2Impl324 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl324.class);
    private static BasepPack2Impl324 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl324 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl324();
        }
        return INSTANCE;
    }

    private BasepPack2Impl324(){
