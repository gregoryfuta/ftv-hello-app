...
public class ComplexpPack1Impl502 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl502.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl502 INSTANCE;

    public static ComplexpPack1Impl502 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl502();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl502(){
