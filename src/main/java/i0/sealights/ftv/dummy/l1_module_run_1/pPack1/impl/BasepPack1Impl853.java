...
public class BasepPack1Impl853 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl853.class);
    private static BasepPack1Impl853 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl853 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl853();
        }
        return INSTANCE;
    }

    private BasepPack1Impl853(){
