...
public class ComplexpPack1Impl814 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl814.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl814 INSTANCE;

    public static ComplexpPack1Impl814 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl814();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl814(){
