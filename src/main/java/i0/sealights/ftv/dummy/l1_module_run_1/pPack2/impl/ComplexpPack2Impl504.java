...
public class ComplexpPack2Impl504 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl504.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl504 INSTANCE;

    public static ComplexpPack2Impl504 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl504();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl504(){
