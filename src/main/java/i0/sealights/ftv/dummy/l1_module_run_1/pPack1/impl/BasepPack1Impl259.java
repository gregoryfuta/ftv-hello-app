...
public class BasepPack1Impl259 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl259.class);
    private static BasepPack1Impl259 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl259 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl259();
        }
        return INSTANCE;
    }

    private BasepPack1Impl259(){
