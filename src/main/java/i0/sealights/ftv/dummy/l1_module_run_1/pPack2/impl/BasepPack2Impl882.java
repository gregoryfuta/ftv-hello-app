...
public class BasepPack2Impl882 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl882.class);
    private static BasepPack2Impl882 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl882 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl882();
        }
        return INSTANCE;
    }

    private BasepPack2Impl882(){
