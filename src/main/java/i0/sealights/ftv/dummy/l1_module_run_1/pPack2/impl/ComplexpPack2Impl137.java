...
public class ComplexpPack2Impl137 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl137.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl137 INSTANCE;

    public static ComplexpPack2Impl137 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl137();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl137(){
