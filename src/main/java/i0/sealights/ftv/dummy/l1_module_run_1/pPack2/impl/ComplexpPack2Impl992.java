...
public class ComplexpPack2Impl992 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl992.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl992 INSTANCE;

    public static ComplexpPack2Impl992 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl992();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl992(){
