...
public class BasepPack1Impl908 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl908.class);
    private static BasepPack1Impl908 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl908 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl908();
        }
        return INSTANCE;
    }

    private BasepPack1Impl908(){
