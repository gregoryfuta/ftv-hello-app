...
public class ComplexpPack2Impl735 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl735.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl735 INSTANCE;

    public static ComplexpPack2Impl735 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl735();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl735(){
