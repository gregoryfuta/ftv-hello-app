...
public class BasepPack1Impl355 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl355.class);
    private static BasepPack1Impl355 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl355 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl355();
        }
        return INSTANCE;
    }

    private BasepPack1Impl355(){
