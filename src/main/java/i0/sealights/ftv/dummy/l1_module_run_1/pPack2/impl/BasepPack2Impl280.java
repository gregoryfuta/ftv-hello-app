...
public class BasepPack2Impl280 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl280.class);
    private static BasepPack2Impl280 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl280 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl280();
        }
        return INSTANCE;
    }

    private BasepPack2Impl280(){
