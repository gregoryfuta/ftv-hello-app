...
public class BasepPack2Impl619 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl619.class);
    private static BasepPack2Impl619 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl619 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl619();
        }
        return INSTANCE;
    }

    private BasepPack2Impl619(){
