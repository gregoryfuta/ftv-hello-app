...
public class BasepPack1Impl197 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl197.class);
    private static BasepPack1Impl197 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl197 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl197();
        }
        return INSTANCE;
    }

    private BasepPack1Impl197(){
