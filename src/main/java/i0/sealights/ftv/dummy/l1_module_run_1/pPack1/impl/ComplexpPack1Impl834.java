...
public class ComplexpPack1Impl834 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl834.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl834 INSTANCE;

    public static ComplexpPack1Impl834 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl834();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl834(){
