...
public class ComplexpPack1Impl325 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl325.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl325 INSTANCE;

    public static ComplexpPack1Impl325 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl325();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl325(){
