...
public class ComplexpPack1Impl4 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl4.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl4 INSTANCE;

    public static ComplexpPack1Impl4 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl4();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl4(){
