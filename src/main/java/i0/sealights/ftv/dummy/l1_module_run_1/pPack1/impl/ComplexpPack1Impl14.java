...
public class ComplexpPack1Impl14 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl14.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl14 INSTANCE;

    public static ComplexpPack1Impl14 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl14();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl14(){
