...
public class ComplexpPack2Impl86 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl86.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl86 INSTANCE;

    public static ComplexpPack2Impl86 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl86();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl86(){
