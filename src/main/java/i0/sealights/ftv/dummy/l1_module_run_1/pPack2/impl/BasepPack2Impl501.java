...
public class BasepPack2Impl501 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl501.class);
    private static BasepPack2Impl501 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl501 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl501();
        }
        return INSTANCE;
    }

    private BasepPack2Impl501(){
