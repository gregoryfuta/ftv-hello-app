...
public class BasepPack1Impl944 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl944.class);
    private static BasepPack1Impl944 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl944 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl944();
        }
        return INSTANCE;
    }

    private BasepPack1Impl944(){
