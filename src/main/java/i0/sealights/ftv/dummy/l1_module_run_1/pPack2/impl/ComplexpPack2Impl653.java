...
public class ComplexpPack2Impl653 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl653.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl653 INSTANCE;

    public static ComplexpPack2Impl653 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl653();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl653(){
