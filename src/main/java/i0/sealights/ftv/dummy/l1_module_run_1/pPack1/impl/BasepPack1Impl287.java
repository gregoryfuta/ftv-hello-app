...
public class BasepPack1Impl287 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl287.class);
    private static BasepPack1Impl287 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl287 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl287();
        }
        return INSTANCE;
    }

    private BasepPack1Impl287(){
