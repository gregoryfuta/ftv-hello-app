...
public class BasepPack1Impl684 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl684.class);
    private static BasepPack1Impl684 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl684 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl684();
        }
        return INSTANCE;
    }

    private BasepPack1Impl684(){
