...
public class ComplexpPack2Impl14 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl14.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl14 INSTANCE;

    public static ComplexpPack2Impl14 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl14();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl14(){
