...
public class ComplexpPack2Impl882 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl882.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl882 INSTANCE;

    public static ComplexpPack2Impl882 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl882();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl882(){
