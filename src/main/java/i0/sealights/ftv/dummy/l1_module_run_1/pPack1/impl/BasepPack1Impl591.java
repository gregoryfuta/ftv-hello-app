...
public class BasepPack1Impl591 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl591.class);
    private static BasepPack1Impl591 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl591 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl591();
        }
        return INSTANCE;
    }

    private BasepPack1Impl591(){
