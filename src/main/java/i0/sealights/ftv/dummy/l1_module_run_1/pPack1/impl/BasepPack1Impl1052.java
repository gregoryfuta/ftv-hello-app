...
public class BasepPack1Impl1052 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1052.class);
    private static BasepPack1Impl1052 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1052 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1052();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1052(){
