...
public class BasepPack2Impl788 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl788.class);
    private static BasepPack2Impl788 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl788 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl788();
        }
        return INSTANCE;
    }

    private BasepPack2Impl788(){
