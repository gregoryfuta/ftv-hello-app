...
public class ComplexpPack2Impl804 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl804.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl804 INSTANCE;

    public static ComplexpPack2Impl804 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl804();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl804(){
