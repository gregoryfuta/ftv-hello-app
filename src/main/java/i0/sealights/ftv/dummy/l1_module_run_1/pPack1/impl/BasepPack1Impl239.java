...
public class BasepPack1Impl239 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl239.class);
    private static BasepPack1Impl239 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl239 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl239();
        }
        return INSTANCE;
    }

    private BasepPack1Impl239(){
