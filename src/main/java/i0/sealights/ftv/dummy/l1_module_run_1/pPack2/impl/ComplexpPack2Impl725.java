...
public class ComplexpPack2Impl725 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl725.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl725 INSTANCE;

    public static ComplexpPack2Impl725 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl725();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl725(){
