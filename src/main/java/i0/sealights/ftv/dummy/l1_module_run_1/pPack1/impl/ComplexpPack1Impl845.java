...
public class ComplexpPack1Impl845 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl845.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl845 INSTANCE;

    public static ComplexpPack1Impl845 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl845();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl845(){
