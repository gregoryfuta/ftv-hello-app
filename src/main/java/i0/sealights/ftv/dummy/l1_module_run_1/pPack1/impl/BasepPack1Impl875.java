...
public class BasepPack1Impl875 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl875.class);
    private static BasepPack1Impl875 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl875 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl875();
        }
        return INSTANCE;
    }

    private BasepPack1Impl875(){
