...
public class BasepPack1Impl509 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl509.class);
    private static BasepPack1Impl509 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl509 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl509();
        }
        return INSTANCE;
    }

    private BasepPack1Impl509(){
