...
public class ComplexpPack2Impl802 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl802.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl802 INSTANCE;

    public static ComplexpPack2Impl802 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl802();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl802(){
