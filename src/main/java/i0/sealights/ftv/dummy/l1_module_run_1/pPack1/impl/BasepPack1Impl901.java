...
public class BasepPack1Impl901 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl901.class);
    private static BasepPack1Impl901 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl901 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl901();
        }
        return INSTANCE;
    }

    private BasepPack1Impl901(){
