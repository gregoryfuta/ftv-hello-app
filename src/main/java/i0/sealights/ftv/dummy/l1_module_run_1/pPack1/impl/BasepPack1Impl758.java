...
public class BasepPack1Impl758 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl758.class);
    private static BasepPack1Impl758 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl758 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl758();
        }
        return INSTANCE;
    }

    private BasepPack1Impl758(){
