...
public class ComplexpPack2Impl812 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl812.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl812 INSTANCE;

    public static ComplexpPack2Impl812 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl812();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl812(){
