...
public class BasepPack2Impl695 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl695.class);
    private static BasepPack2Impl695 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl695 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl695();
        }
        return INSTANCE;
    }

    private BasepPack2Impl695(){
