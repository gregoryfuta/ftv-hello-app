...
public class ComplexpPack1Impl273 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl273.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl273 INSTANCE;

    public static ComplexpPack1Impl273 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl273();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl273(){
