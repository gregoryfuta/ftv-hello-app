...
public class BasepPack2Impl675 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl675.class);
    private static BasepPack2Impl675 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl675 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl675();
        }
        return INSTANCE;
    }

    private BasepPack2Impl675(){
