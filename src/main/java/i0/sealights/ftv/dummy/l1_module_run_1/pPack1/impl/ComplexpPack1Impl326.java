...
public class ComplexpPack1Impl326 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl326.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl326 INSTANCE;

    public static ComplexpPack1Impl326 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl326();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl326(){
