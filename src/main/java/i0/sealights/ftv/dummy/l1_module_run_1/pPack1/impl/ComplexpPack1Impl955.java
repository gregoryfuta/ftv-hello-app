...
public class ComplexpPack1Impl955 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl955.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl955 INSTANCE;

    public static ComplexpPack1Impl955 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl955();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl955(){
