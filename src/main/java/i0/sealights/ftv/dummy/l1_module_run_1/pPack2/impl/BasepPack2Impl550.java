...
public class BasepPack2Impl550 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl550.class);
    private static BasepPack2Impl550 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl550 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl550();
        }
        return INSTANCE;
    }

    private BasepPack2Impl550(){
