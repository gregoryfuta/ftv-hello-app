...
public class BasepPack2Impl12 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl12.class);
    private static BasepPack2Impl12 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl12 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl12();
        }
        return INSTANCE;
    }

    private BasepPack2Impl12(){
