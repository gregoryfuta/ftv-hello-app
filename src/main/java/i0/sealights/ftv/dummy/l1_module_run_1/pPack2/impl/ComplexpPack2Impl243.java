...
public class ComplexpPack2Impl243 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl243.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl243 INSTANCE;

    public static ComplexpPack2Impl243 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl243();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl243(){
