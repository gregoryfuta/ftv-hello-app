...
public class ComplexpPack1Impl100 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl100.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl100 INSTANCE;

    public static ComplexpPack1Impl100 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl100();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl100(){
