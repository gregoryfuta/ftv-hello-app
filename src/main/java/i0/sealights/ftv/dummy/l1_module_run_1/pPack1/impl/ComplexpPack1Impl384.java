...
public class ComplexpPack1Impl384 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl384.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl384 INSTANCE;

    public static ComplexpPack1Impl384 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl384();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl384(){
