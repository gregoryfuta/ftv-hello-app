...
public class BasepPack1Impl223 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl223.class);
    private static BasepPack1Impl223 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl223 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl223();
        }
        return INSTANCE;
    }

    private BasepPack1Impl223(){
