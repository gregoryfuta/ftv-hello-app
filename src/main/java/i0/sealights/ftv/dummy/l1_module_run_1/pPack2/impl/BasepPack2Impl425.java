...
public class BasepPack2Impl425 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl425.class);
    private static BasepPack2Impl425 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl425 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl425();
        }
        return INSTANCE;
    }

    private BasepPack2Impl425(){
