...
public class ComplexpPack1Impl687 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl687.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl687 INSTANCE;

    public static ComplexpPack1Impl687 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl687();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl687(){
