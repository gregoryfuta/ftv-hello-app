...
public class ComplexpPack2Impl982 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl982.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl982 INSTANCE;

    public static ComplexpPack2Impl982 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl982();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl982(){
