...
public class ComplexpPack1Impl1031 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1031.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1031 INSTANCE;

    public static ComplexpPack1Impl1031 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1031();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1031(){
