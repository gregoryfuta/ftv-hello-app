...
public class ComplexpPack2Impl213 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl213.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl213 INSTANCE;

    public static ComplexpPack2Impl213 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl213();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl213(){
