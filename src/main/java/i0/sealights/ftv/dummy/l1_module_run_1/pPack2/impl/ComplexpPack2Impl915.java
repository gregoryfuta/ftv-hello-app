...
public class ComplexpPack2Impl915 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl915.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl915 INSTANCE;

    public static ComplexpPack2Impl915 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl915();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl915(){
