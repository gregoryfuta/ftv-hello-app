...
public class ComplexpPack1Impl404 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl404.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl404 INSTANCE;

    public static ComplexpPack1Impl404 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl404();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl404(){
