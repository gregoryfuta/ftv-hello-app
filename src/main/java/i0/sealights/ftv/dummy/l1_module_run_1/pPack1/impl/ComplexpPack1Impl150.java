...
public class ComplexpPack1Impl150 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl150.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl150 INSTANCE;

    public static ComplexpPack1Impl150 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl150();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl150(){
