...
public class BasepPack1Impl801 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl801.class);
    private static BasepPack1Impl801 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl801 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl801();
        }
        return INSTANCE;
    }

    private BasepPack1Impl801(){
