...
public class BasepPack1Impl116 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl116.class);
    private static BasepPack1Impl116 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl116 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl116();
        }
        return INSTANCE;
    }

    private BasepPack1Impl116(){
