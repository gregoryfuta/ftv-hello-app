...
public class BasepPack2Impl162 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl162.class);
    private static BasepPack2Impl162 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl162 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl162();
        }
        return INSTANCE;
    }

    private BasepPack2Impl162(){
