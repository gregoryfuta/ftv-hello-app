...
public class BasepPack2Impl800 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl800.class);
    private static BasepPack2Impl800 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl800 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl800();
        }
        return INSTANCE;
    }

    private BasepPack2Impl800(){
