...
public class BasepPack2Impl67 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl67.class);
    private static BasepPack2Impl67 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl67 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl67();
        }
        return INSTANCE;
    }

    private BasepPack2Impl67(){
