...
public class ComplexpPack1Impl1048 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1048.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1048 INSTANCE;

    public static ComplexpPack1Impl1048 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1048();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1048(){
