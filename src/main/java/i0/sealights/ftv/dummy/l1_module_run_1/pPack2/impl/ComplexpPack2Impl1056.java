...
public class ComplexpPack2Impl1056 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1056.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1056 INSTANCE;

    public static ComplexpPack2Impl1056 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1056();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1056(){
