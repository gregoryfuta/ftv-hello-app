...
public class BasepPack1Impl30 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl30.class);
    private static BasepPack1Impl30 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl30 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl30();
        }
        return INSTANCE;
    }

    private BasepPack1Impl30(){
