...
public class BasepPack1Impl101 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl101.class);
    private static BasepPack1Impl101 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl101 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl101();
        }
        return INSTANCE;
    }

    private BasepPack1Impl101(){
