...
public class ComplexpPack1Impl981 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl981.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl981 INSTANCE;

    public static ComplexpPack1Impl981 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl981();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl981(){
