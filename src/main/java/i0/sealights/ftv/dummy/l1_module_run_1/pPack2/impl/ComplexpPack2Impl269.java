...
public class ComplexpPack2Impl269 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl269.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl269 INSTANCE;

    public static ComplexpPack2Impl269 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl269();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl269(){
