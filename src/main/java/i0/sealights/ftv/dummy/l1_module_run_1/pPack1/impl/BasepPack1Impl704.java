...
public class BasepPack1Impl704 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl704.class);
    private static BasepPack1Impl704 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl704 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl704();
        }
        return INSTANCE;
    }

    private BasepPack1Impl704(){
