...
public class BasepPack2Impl494 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl494.class);
    private static BasepPack2Impl494 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl494 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl494();
        }
        return INSTANCE;
    }

    private BasepPack2Impl494(){
