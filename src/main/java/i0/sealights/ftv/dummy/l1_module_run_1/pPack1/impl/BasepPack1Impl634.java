...
public class BasepPack1Impl634 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl634.class);
    private static BasepPack1Impl634 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl634 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl634();
        }
        return INSTANCE;
    }

    private BasepPack1Impl634(){
