...
public class BasepPack2Impl861 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl861.class);
    private static BasepPack2Impl861 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl861 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl861();
        }
        return INSTANCE;
    }

    private BasepPack2Impl861(){
