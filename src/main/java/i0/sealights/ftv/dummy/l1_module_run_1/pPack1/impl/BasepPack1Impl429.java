...
public class BasepPack1Impl429 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl429.class);
    private static BasepPack1Impl429 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl429 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl429();
        }
        return INSTANCE;
    }

    private BasepPack1Impl429(){
