...
public class BasepPack1Impl190 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl190.class);
    private static BasepPack1Impl190 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl190 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl190();
        }
        return INSTANCE;
    }

    private BasepPack1Impl190(){
