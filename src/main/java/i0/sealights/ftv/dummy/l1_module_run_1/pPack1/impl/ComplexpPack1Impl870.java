...
public class ComplexpPack1Impl870 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl870.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl870 INSTANCE;

    public static ComplexpPack1Impl870 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl870();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl870(){
