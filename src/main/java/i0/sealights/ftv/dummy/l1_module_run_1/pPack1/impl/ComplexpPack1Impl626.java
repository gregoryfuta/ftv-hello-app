...
public class ComplexpPack1Impl626 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl626.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl626 INSTANCE;

    public static ComplexpPack1Impl626 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl626();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl626(){
