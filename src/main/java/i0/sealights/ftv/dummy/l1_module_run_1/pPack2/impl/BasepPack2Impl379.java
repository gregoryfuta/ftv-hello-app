...
public class BasepPack2Impl379 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl379.class);
    private static BasepPack2Impl379 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl379 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl379();
        }
        return INSTANCE;
    }

    private BasepPack2Impl379(){
