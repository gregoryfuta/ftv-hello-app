...
public class BasepPack1Impl551 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl551.class);
    private static BasepPack1Impl551 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl551 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl551();
        }
        return INSTANCE;
    }

    private BasepPack1Impl551(){
