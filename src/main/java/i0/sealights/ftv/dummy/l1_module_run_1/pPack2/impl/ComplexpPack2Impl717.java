...
public class ComplexpPack2Impl717 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl717.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl717 INSTANCE;

    public static ComplexpPack2Impl717 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl717();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl717(){
