...
public class ComplexpPack1Impl555 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl555.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl555 INSTANCE;

    public static ComplexpPack1Impl555 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl555();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl555(){
