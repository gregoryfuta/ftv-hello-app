...
public class ComplexpPack1Impl766 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl766.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl766 INSTANCE;

    public static ComplexpPack1Impl766 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl766();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl766(){
