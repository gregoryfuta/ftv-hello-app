...
public class ComplexpPack1Impl106 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl106.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl106 INSTANCE;

    public static ComplexpPack1Impl106 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl106();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl106(){
