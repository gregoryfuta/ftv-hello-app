...
public class BasepPack1Impl612 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl612.class);
    private static BasepPack1Impl612 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl612 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl612();
        }
        return INSTANCE;
    }

    private BasepPack1Impl612(){
