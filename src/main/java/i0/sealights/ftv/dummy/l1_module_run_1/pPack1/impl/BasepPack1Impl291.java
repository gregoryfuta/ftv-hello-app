...
public class BasepPack1Impl291 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl291.class);
    private static BasepPack1Impl291 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl291 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl291();
        }
        return INSTANCE;
    }

    private BasepPack1Impl291(){
