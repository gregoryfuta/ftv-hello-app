...
public class BasepPack2Impl643 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl643.class);
    private static BasepPack2Impl643 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl643 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl643();
        }
        return INSTANCE;
    }

    private BasepPack2Impl643(){
