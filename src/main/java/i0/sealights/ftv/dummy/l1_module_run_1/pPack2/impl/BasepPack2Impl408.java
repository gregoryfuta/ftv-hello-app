...
public class BasepPack2Impl408 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl408.class);
    private static BasepPack2Impl408 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl408 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl408();
        }
        return INSTANCE;
    }

    private BasepPack2Impl408(){
