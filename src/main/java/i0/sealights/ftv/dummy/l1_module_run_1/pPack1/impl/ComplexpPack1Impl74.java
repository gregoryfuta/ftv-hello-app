...
public class ComplexpPack1Impl74 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl74.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl74 INSTANCE;

    public static ComplexpPack1Impl74 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl74();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl74(){
