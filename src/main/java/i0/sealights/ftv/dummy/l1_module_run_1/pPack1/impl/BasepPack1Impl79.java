...
public class BasepPack1Impl79 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl79.class);
    private static BasepPack1Impl79 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl79 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl79();
        }
        return INSTANCE;
    }

    private BasepPack1Impl79(){
