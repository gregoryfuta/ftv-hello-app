...
public class ComplexpPack1Impl3 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl3.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl3 INSTANCE;

    public static ComplexpPack1Impl3 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl3();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl3(){
