...
public class BasepPack2Impl940 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl940.class);
    private static BasepPack2Impl940 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl940 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl940();
        }
        return INSTANCE;
    }

    private BasepPack2Impl940(){
