...
public class ComplexpPack2Impl863 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl863.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl863 INSTANCE;

    public static ComplexpPack2Impl863 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl863();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl863(){
