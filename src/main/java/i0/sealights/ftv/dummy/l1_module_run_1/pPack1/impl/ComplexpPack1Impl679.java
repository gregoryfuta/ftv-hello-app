...
public class ComplexpPack1Impl679 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl679.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl679 INSTANCE;

    public static ComplexpPack1Impl679 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl679();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl679(){
