...
public class ComplexpPack2Impl612 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl612.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl612 INSTANCE;

    public static ComplexpPack2Impl612 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl612();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl612(){
