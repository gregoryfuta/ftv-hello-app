...
public class ComplexpPack2Impl684 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl684.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl684 INSTANCE;

    public static ComplexpPack2Impl684 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl684();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl684(){
