...
public class ComplexpPack1Impl734 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl734.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl734 INSTANCE;

    public static ComplexpPack1Impl734 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl734();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl734(){
