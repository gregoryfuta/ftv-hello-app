...
public class BasepPack2Impl758 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl758.class);
    private static BasepPack2Impl758 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl758 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl758();
        }
        return INSTANCE;
    }

    private BasepPack2Impl758(){
