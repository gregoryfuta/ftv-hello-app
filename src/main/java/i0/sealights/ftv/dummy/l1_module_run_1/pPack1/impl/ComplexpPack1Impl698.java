...
public class ComplexpPack1Impl698 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl698.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl698 INSTANCE;

    public static ComplexpPack1Impl698 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl698();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl698(){
