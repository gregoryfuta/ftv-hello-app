...
public class ComplexpPack1Impl836 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl836.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl836 INSTANCE;

    public static ComplexpPack1Impl836 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl836();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl836(){
