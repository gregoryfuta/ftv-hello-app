...
public class ComplexpPack2Impl705 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl705.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl705 INSTANCE;

    public static ComplexpPack2Impl705 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl705();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl705(){
