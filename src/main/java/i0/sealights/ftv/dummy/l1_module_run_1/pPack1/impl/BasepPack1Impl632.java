...
public class BasepPack1Impl632 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl632.class);
    private static BasepPack1Impl632 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl632 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl632();
        }
        return INSTANCE;
    }

    private BasepPack1Impl632(){
