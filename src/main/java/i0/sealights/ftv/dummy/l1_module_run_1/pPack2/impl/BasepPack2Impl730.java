...
public class BasepPack2Impl730 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl730.class);
    private static BasepPack2Impl730 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl730 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl730();
        }
        return INSTANCE;
    }

    private BasepPack2Impl730(){
