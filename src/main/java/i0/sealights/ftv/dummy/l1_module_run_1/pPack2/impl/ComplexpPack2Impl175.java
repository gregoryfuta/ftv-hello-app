...
public class ComplexpPack2Impl175 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl175.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl175 INSTANCE;

    public static ComplexpPack2Impl175 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl175();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl175(){
