...
public class ComplexpPack1Impl227 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl227.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl227 INSTANCE;

    public static ComplexpPack1Impl227 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl227();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl227(){
