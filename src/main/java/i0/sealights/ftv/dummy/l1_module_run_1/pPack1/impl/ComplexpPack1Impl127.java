...
public class ComplexpPack1Impl127 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl127.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl127 INSTANCE;

    public static ComplexpPack1Impl127 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl127();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl127(){
