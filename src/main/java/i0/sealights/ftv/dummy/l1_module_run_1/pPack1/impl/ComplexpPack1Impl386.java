...
public class ComplexpPack1Impl386 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl386.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl386 INSTANCE;

    public static ComplexpPack1Impl386 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl386();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl386(){
