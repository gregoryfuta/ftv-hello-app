...
public class BasepPack2Impl562 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl562.class);
    private static BasepPack2Impl562 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl562 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl562();
        }
        return INSTANCE;
    }

    private BasepPack2Impl562(){
