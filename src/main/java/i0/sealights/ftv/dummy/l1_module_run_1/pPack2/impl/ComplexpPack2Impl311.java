...
public class ComplexpPack2Impl311 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl311.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl311 INSTANCE;

    public static ComplexpPack2Impl311 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl311();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl311(){
