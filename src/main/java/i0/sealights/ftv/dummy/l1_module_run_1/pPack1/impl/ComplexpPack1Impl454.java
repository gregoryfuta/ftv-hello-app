...
public class ComplexpPack1Impl454 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl454.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl454 INSTANCE;

    public static ComplexpPack1Impl454 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl454();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl454(){
