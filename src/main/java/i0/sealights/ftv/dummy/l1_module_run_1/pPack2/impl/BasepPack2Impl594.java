...
public class BasepPack2Impl594 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl594.class);
    private static BasepPack2Impl594 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl594 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl594();
        }
        return INSTANCE;
    }

    private BasepPack2Impl594(){
