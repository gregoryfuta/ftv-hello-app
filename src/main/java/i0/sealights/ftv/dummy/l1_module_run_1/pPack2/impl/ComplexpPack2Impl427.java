...
public class ComplexpPack2Impl427 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl427.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl427 INSTANCE;

    public static ComplexpPack2Impl427 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl427();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl427(){
