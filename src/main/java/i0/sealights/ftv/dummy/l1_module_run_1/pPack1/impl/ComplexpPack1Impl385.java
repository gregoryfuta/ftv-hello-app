...
public class ComplexpPack1Impl385 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl385.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl385 INSTANCE;

    public static ComplexpPack1Impl385 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl385();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl385(){
