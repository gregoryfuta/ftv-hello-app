...
public class ComplexpPack1Impl622 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl622.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl622 INSTANCE;

    public static ComplexpPack1Impl622 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl622();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl622(){
