...
public class ComplexpPack2Impl559 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl559.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl559 INSTANCE;

    public static ComplexpPack2Impl559 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl559();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl559(){
