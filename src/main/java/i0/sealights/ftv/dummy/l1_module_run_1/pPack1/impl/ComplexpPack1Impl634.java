...
public class ComplexpPack1Impl634 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl634.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl634 INSTANCE;

    public static ComplexpPack1Impl634 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl634();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl634(){
