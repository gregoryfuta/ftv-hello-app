...
public class BasepPack1Impl943 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl943.class);
    private static BasepPack1Impl943 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl943 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl943();
        }
        return INSTANCE;
    }

    private BasepPack1Impl943(){
