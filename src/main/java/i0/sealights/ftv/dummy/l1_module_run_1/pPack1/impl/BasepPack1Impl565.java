...
public class BasepPack1Impl565 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl565.class);
    private static BasepPack1Impl565 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl565 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl565();
        }
        return INSTANCE;
    }

    private BasepPack1Impl565(){
