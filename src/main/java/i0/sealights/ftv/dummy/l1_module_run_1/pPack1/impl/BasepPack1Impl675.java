...
public class BasepPack1Impl675 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl675.class);
    private static BasepPack1Impl675 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl675 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl675();
        }
        return INSTANCE;
    }

    private BasepPack1Impl675(){
