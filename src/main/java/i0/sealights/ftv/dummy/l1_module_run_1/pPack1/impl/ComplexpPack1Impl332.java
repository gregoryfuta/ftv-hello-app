...
public class ComplexpPack1Impl332 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl332.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl332 INSTANCE;

    public static ComplexpPack1Impl332 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl332();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl332(){
