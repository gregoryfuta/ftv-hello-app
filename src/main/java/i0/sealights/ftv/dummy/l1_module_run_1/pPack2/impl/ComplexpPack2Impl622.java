...
public class ComplexpPack2Impl622 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl622.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl622 INSTANCE;

    public static ComplexpPack2Impl622 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl622();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl622(){
