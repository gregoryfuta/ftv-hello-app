...
public class BasepPack1Impl477 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl477.class);
    private static BasepPack1Impl477 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl477 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl477();
        }
        return INSTANCE;
    }

    private BasepPack1Impl477(){
