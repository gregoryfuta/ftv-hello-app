...
public class BasepPack2Impl435 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl435.class);
    private static BasepPack2Impl435 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl435 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl435();
        }
        return INSTANCE;
    }

    private BasepPack2Impl435(){
