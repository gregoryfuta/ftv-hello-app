...
public class BasepPack2Impl152 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl152.class);
    private static BasepPack2Impl152 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl152 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl152();
        }
        return INSTANCE;
    }

    private BasepPack2Impl152(){
