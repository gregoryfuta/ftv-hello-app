...
public class BasepPack1Impl235 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl235.class);
    private static BasepPack1Impl235 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl235 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl235();
        }
        return INSTANCE;
    }

    private BasepPack1Impl235(){
