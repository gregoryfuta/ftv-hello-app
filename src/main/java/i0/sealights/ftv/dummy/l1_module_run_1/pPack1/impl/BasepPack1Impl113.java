...
public class BasepPack1Impl113 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl113.class);
    private static BasepPack1Impl113 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl113 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl113();
        }
        return INSTANCE;
    }

    private BasepPack1Impl113(){
