...
public class ComplexpPack1Impl898 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl898.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl898 INSTANCE;

    public static ComplexpPack1Impl898 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl898();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl898(){
