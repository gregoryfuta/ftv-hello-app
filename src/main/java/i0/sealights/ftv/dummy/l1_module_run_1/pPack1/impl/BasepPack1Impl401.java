...
public class BasepPack1Impl401 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl401.class);
    private static BasepPack1Impl401 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl401 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl401();
        }
        return INSTANCE;
    }

    private BasepPack1Impl401(){
