...
public class BasepPack1Impl457 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl457.class);
    private static BasepPack1Impl457 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl457 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl457();
        }
        return INSTANCE;
    }

    private BasepPack1Impl457(){
