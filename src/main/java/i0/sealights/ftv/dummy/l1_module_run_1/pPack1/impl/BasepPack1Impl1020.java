...
public class BasepPack1Impl1020 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1020.class);
    private static BasepPack1Impl1020 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1020 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1020();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1020(){
