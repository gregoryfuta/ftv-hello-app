...
public class BasepPack2Impl636 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl636.class);
    private static BasepPack2Impl636 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl636 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl636();
        }
        return INSTANCE;
    }

    private BasepPack2Impl636(){
