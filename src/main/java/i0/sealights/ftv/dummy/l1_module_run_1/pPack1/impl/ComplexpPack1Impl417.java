...
public class ComplexpPack1Impl417 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl417.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl417 INSTANCE;

    public static ComplexpPack1Impl417 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl417();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl417(){
