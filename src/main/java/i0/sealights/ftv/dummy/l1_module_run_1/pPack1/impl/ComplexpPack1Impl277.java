...
public class ComplexpPack1Impl277 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl277.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl277 INSTANCE;

    public static ComplexpPack1Impl277 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl277();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl277(){
