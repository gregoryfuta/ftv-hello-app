...
public class ComplexpPack2Impl730 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl730.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl730 INSTANCE;

    public static ComplexpPack2Impl730 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl730();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl730(){
