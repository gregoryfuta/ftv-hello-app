...
public class BasepPack2Impl552 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl552.class);
    private static BasepPack2Impl552 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl552 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl552();
        }
        return INSTANCE;
    }

    private BasepPack2Impl552(){
