...
public class BasepPack2Impl972 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl972.class);
    private static BasepPack2Impl972 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl972 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl972();
        }
        return INSTANCE;
    }

    private BasepPack2Impl972(){
