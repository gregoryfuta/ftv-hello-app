...
public class BasepPack2Impl927 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl927.class);
    private static BasepPack2Impl927 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl927 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl927();
        }
        return INSTANCE;
    }

    private BasepPack2Impl927(){
