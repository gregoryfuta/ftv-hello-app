...
public class BasepPack1Impl547 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl547.class);
    private static BasepPack1Impl547 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl547 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl547();
        }
        return INSTANCE;
    }

    private BasepPack1Impl547(){
