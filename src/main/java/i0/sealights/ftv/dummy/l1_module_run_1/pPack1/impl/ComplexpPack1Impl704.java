...
public class ComplexpPack1Impl704 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl704.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl704 INSTANCE;

    public static ComplexpPack1Impl704 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl704();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl704(){
