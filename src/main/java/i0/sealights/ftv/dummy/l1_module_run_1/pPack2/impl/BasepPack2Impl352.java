...
public class BasepPack2Impl352 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl352.class);
    private static BasepPack2Impl352 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl352 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl352();
        }
        return INSTANCE;
    }

    private BasepPack2Impl352(){
