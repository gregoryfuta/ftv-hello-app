...
public class BasepPack1Impl888 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl888.class);
    private static BasepPack1Impl888 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl888 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl888();
        }
        return INSTANCE;
    }

    private BasepPack1Impl888(){
