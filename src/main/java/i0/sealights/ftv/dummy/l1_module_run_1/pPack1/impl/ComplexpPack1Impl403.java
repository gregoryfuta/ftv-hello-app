...
public class ComplexpPack1Impl403 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl403.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl403 INSTANCE;

    public static ComplexpPack1Impl403 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl403();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl403(){
