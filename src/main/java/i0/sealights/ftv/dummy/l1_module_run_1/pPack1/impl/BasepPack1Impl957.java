...
public class BasepPack1Impl957 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl957.class);
    private static BasepPack1Impl957 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl957 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl957();
        }
        return INSTANCE;
    }

    private BasepPack1Impl957(){
