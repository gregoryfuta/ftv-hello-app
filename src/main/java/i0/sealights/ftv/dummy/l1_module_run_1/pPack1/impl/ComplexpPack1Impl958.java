...
public class ComplexpPack1Impl958 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl958.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl958 INSTANCE;

    public static ComplexpPack1Impl958 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl958();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl958(){
