...
public class ComplexpPack2Impl64 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl64.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl64 INSTANCE;

    public static ComplexpPack2Impl64 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl64();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl64(){
