...
public class ComplexpPack2Impl205 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl205.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl205 INSTANCE;

    public static ComplexpPack2Impl205 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl205();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl205(){
