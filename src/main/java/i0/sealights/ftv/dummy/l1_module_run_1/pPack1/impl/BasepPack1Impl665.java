...
public class BasepPack1Impl665 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl665.class);
    private static BasepPack1Impl665 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl665 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl665();
        }
        return INSTANCE;
    }

    private BasepPack1Impl665(){
