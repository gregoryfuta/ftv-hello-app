...
public class ComplexpPack2Impl284 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl284.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl284 INSTANCE;

    public static ComplexpPack2Impl284 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl284();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl284(){
