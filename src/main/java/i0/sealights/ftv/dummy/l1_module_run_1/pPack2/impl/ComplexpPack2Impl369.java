...
public class ComplexpPack2Impl369 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl369.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl369 INSTANCE;

    public static ComplexpPack2Impl369 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl369();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl369(){
