...
public class BasepPack2Impl857 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl857.class);
    private static BasepPack2Impl857 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl857 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl857();
        }
        return INSTANCE;
    }

    private BasepPack2Impl857(){
