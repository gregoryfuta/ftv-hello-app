...
public class ComplexpPack1Impl1012 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1012.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1012 INSTANCE;

    public static ComplexpPack1Impl1012 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1012();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1012(){
