...
public class ComplexpPack1Impl931 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl931.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl931 INSTANCE;

    public static ComplexpPack1Impl931 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl931();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl931(){
