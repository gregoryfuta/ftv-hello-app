...
public class ComplexpPack2Impl659 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl659.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl659 INSTANCE;

    public static ComplexpPack2Impl659 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl659();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl659(){
