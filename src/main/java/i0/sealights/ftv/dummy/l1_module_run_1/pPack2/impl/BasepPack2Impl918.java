...
public class BasepPack2Impl918 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl918.class);
    private static BasepPack2Impl918 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl918 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl918();
        }
        return INSTANCE;
    }

    private BasepPack2Impl918(){
