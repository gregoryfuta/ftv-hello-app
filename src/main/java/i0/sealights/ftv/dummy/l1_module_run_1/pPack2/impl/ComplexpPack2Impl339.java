...
public class ComplexpPack2Impl339 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl339.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl339 INSTANCE;

    public static ComplexpPack2Impl339 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl339();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl339(){
