...
public class BasepPack2Impl880 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl880.class);
    private static BasepPack2Impl880 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl880 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl880();
        }
        return INSTANCE;
    }

    private BasepPack2Impl880(){
