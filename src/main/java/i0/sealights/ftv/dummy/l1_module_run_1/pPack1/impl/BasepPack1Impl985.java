...
public class BasepPack1Impl985 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl985.class);
    private static BasepPack1Impl985 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl985 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl985();
        }
        return INSTANCE;
    }

    private BasepPack1Impl985(){
