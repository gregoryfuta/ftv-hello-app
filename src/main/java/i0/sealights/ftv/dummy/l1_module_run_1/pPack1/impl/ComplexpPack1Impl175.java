...
public class ComplexpPack1Impl175 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl175.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl175 INSTANCE;

    public static ComplexpPack1Impl175 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl175();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl175(){
