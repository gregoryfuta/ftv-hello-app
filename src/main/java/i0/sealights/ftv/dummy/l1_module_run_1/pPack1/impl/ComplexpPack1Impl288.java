...
public class ComplexpPack1Impl288 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl288.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl288 INSTANCE;

    public static ComplexpPack1Impl288 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl288();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl288(){
