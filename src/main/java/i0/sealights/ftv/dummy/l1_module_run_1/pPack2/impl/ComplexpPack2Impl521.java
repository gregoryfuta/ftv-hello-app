...
public class ComplexpPack2Impl521 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl521.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl521 INSTANCE;

    public static ComplexpPack2Impl521 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl521();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl521(){
