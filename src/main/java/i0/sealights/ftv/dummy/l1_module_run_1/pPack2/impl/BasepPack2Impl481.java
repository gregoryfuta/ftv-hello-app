...
public class BasepPack2Impl481 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl481.class);
    private static BasepPack2Impl481 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl481 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl481();
        }
        return INSTANCE;
    }

    private BasepPack2Impl481(){
