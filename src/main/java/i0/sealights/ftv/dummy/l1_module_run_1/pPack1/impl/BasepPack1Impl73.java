...
public class BasepPack1Impl73 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl73.class);
    private static BasepPack1Impl73 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl73 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl73();
        }
        return INSTANCE;
    }

    private BasepPack1Impl73(){
