...
public class BasepPack2Impl73 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl73.class);
    private static BasepPack2Impl73 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl73 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl73();
        }
        return INSTANCE;
    }

    private BasepPack2Impl73(){
