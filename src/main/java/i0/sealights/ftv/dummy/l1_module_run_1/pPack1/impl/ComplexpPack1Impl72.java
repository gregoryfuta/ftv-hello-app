...
public class ComplexpPack1Impl72 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl72.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl72 INSTANCE;

    public static ComplexpPack1Impl72 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl72();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl72(){
