...
public class BasepPack2Impl126 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl126.class);
    private static BasepPack2Impl126 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl126 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl126();
        }
        return INSTANCE;
    }

    private BasepPack2Impl126(){
