...
public class ComplexpPack1Impl344 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl344.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl344 INSTANCE;

    public static ComplexpPack1Impl344 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl344();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl344(){
