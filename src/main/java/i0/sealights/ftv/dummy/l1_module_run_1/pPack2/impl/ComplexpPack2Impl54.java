...
public class ComplexpPack2Impl54 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl54.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl54 INSTANCE;

    public static ComplexpPack2Impl54 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl54();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl54(){
