...
public class BasepPack1Impl906 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl906.class);
    private static BasepPack1Impl906 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl906 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl906();
        }
        return INSTANCE;
    }

    private BasepPack1Impl906(){
