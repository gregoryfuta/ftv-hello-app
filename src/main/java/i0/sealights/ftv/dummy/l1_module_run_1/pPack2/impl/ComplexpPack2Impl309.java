...
public class ComplexpPack2Impl309 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl309.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl309 INSTANCE;

    public static ComplexpPack2Impl309 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl309();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl309(){
