...
public class BasepPack2Impl31 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl31.class);
    private static BasepPack2Impl31 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl31 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl31();
        }
        return INSTANCE;
    }

    private BasepPack2Impl31(){
