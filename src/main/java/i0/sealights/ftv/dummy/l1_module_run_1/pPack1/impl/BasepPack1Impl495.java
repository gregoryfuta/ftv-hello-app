...
public class BasepPack1Impl495 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl495.class);
    private static BasepPack1Impl495 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl495 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl495();
        }
        return INSTANCE;
    }

    private BasepPack1Impl495(){
