...
public class BasepPack2Impl660 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl660.class);
    private static BasepPack2Impl660 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl660 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl660();
        }
        return INSTANCE;
    }

    private BasepPack2Impl660(){
