...
public class ComplexpPack2Impl72 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl72.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl72 INSTANCE;

    public static ComplexpPack2Impl72 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl72();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl72(){
