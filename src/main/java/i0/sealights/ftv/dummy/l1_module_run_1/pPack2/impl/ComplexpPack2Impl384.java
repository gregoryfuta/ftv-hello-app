...
public class ComplexpPack2Impl384 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl384.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl384 INSTANCE;

    public static ComplexpPack2Impl384 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl384();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl384(){
