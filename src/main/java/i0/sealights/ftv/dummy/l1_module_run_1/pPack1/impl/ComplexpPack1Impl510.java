...
public class ComplexpPack1Impl510 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl510.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl510 INSTANCE;

    public static ComplexpPack1Impl510 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl510();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl510(){
