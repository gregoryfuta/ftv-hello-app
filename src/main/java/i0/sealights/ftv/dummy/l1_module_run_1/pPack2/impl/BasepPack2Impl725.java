...
public class BasepPack2Impl725 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl725.class);
    private static BasepPack2Impl725 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl725 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl725();
        }
        return INSTANCE;
    }

    private BasepPack2Impl725(){
