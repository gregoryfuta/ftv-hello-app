...
public class ComplexpPack1Impl632 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl632.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl632 INSTANCE;

    public static ComplexpPack1Impl632 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl632();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl632(){
