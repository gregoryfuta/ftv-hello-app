...
public class BasepPack2Impl793 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl793.class);
    private static BasepPack2Impl793 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl793 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl793();
        }
        return INSTANCE;
    }

    private BasepPack2Impl793(){
