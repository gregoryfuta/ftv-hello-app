...
public class BasepPack1Impl971 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl971.class);
    private static BasepPack1Impl971 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl971 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl971();
        }
        return INSTANCE;
    }

    private BasepPack1Impl971(){
