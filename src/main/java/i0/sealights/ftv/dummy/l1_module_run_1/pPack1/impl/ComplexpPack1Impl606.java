...
public class ComplexpPack1Impl606 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl606.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl606 INSTANCE;

    public static ComplexpPack1Impl606 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl606();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl606(){
