...
public class BasepPack1Impl899 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl899.class);
    private static BasepPack1Impl899 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl899 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl899();
        }
        return INSTANCE;
    }

    private BasepPack1Impl899(){
