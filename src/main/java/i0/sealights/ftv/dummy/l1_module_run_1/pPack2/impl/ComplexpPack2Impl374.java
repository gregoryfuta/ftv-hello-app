...
public class ComplexpPack2Impl374 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl374.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl374 INSTANCE;

    public static ComplexpPack2Impl374 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl374();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl374(){
