...
public class ComplexpPack2Impl688 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl688.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl688 INSTANCE;

    public static ComplexpPack2Impl688 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl688();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl688(){
