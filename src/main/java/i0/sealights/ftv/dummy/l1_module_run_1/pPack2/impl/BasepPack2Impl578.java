...
public class BasepPack2Impl578 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl578.class);
    private static BasepPack2Impl578 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl578 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl578();
        }
        return INSTANCE;
    }

    private BasepPack2Impl578(){
