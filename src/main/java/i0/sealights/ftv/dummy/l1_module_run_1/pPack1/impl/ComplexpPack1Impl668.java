...
public class ComplexpPack1Impl668 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl668.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl668 INSTANCE;

    public static ComplexpPack1Impl668 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl668();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl668(){
