...
public class ComplexpPack1Impl169 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl169.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl169 INSTANCE;

    public static ComplexpPack1Impl169 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl169();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl169(){
