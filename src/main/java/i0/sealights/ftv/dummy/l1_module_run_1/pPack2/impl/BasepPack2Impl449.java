...
public class BasepPack2Impl449 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl449.class);
    private static BasepPack2Impl449 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl449 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl449();
        }
        return INSTANCE;
    }

    private BasepPack2Impl449(){
