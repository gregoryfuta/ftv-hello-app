...
public class BasepPack1Impl375 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl375.class);
    private static BasepPack1Impl375 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl375 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl375();
        }
        return INSTANCE;
    }

    private BasepPack1Impl375(){
