...
public class BasepPack1Impl767 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl767.class);
    private static BasepPack1Impl767 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl767 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl767();
        }
        return INSTANCE;
    }

    private BasepPack1Impl767(){
