...
public class ComplexpPack1Impl282 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl282.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl282 INSTANCE;

    public static ComplexpPack1Impl282 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl282();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl282(){
