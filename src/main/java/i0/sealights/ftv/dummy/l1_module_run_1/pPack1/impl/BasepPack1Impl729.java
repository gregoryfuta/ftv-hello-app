...
public class BasepPack1Impl729 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl729.class);
    private static BasepPack1Impl729 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl729 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl729();
        }
        return INSTANCE;
    }

    private BasepPack1Impl729(){
