...
public class BasepPack1Impl889 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl889.class);
    private static BasepPack1Impl889 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl889 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl889();
        }
        return INSTANCE;
    }

    private BasepPack1Impl889(){
