...
public class BasepPack1Impl496 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl496.class);
    private static BasepPack1Impl496 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl496 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl496();
        }
        return INSTANCE;
    }

    private BasepPack1Impl496(){
