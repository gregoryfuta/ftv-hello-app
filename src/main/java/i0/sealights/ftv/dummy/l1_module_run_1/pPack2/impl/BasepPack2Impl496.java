...
public class BasepPack2Impl496 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl496.class);
    private static BasepPack2Impl496 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl496 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl496();
        }
        return INSTANCE;
    }

    private BasepPack2Impl496(){
