...
public class BasepPack2Impl658 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl658.class);
    private static BasepPack2Impl658 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl658 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl658();
        }
        return INSTANCE;
    }

    private BasepPack2Impl658(){
