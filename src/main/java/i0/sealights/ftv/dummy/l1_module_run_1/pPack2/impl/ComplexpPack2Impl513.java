...
public class ComplexpPack2Impl513 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl513.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl513 INSTANCE;

    public static ComplexpPack2Impl513 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl513();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl513(){
