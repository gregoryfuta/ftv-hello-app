...
public class ComplexpPack1Impl431 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl431.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl431 INSTANCE;

    public static ComplexpPack1Impl431 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl431();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl431(){
