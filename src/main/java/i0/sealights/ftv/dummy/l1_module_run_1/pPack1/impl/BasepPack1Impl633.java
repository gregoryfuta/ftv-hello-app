...
public class BasepPack1Impl633 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl633.class);
    private static BasepPack1Impl633 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl633 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl633();
        }
        return INSTANCE;
    }

    private BasepPack1Impl633(){
