...
public class BasepPack1Impl783 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl783.class);
    private static BasepPack1Impl783 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl783 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl783();
        }
        return INSTANCE;
    }

    private BasepPack1Impl783(){
