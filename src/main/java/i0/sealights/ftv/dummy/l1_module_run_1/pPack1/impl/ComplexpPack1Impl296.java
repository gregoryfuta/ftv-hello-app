...
public class ComplexpPack1Impl296 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl296.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl296 INSTANCE;

    public static ComplexpPack1Impl296 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl296();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl296(){
