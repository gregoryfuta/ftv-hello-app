...
public class ComplexpPack2Impl933 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl933.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl933 INSTANCE;

    public static ComplexpPack2Impl933 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl933();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl933(){
