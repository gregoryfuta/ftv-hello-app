...
public class ComplexpPack2Impl226 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl226.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl226 INSTANCE;

    public static ComplexpPack2Impl226 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl226();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl226(){
