...
public class BasepPack2Impl112 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl112.class);
    private static BasepPack2Impl112 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl112 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl112();
        }
        return INSTANCE;
    }

    private BasepPack2Impl112(){
