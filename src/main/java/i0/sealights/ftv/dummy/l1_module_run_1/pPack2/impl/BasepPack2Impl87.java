...
public class BasepPack2Impl87 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl87.class);
    private static BasepPack2Impl87 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl87 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl87();
        }
        return INSTANCE;
    }

    private BasepPack2Impl87(){
