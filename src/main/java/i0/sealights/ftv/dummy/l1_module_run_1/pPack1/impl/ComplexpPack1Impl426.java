...
public class ComplexpPack1Impl426 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl426.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl426 INSTANCE;

    public static ComplexpPack1Impl426 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl426();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl426(){
