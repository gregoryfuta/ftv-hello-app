...
public class ComplexpPack1Impl202 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl202.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl202 INSTANCE;

    public static ComplexpPack1Impl202 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl202();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl202(){
