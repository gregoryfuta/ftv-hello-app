...
public class BasepPack2Impl479 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl479.class);
    private static BasepPack2Impl479 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl479 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl479();
        }
        return INSTANCE;
    }

    private BasepPack2Impl479(){
