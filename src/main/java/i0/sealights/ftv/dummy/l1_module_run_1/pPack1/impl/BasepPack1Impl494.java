...
public class BasepPack1Impl494 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl494.class);
    private static BasepPack1Impl494 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl494 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl494();
        }
        return INSTANCE;
    }

    private BasepPack1Impl494(){
