...
public class ComplexpPack1Impl585 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl585.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl585 INSTANCE;

    public static ComplexpPack1Impl585 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl585();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl585(){
