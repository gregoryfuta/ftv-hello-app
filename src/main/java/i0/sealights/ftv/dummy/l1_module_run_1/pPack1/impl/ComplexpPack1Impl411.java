...
public class ComplexpPack1Impl411 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl411.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl411 INSTANCE;

    public static ComplexpPack1Impl411 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl411();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl411(){
