...
public class ComplexpPack2Impl158 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl158.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl158 INSTANCE;

    public static ComplexpPack2Impl158 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl158();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl158(){
