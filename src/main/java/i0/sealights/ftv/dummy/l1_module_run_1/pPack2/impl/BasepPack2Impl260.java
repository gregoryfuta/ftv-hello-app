...
public class BasepPack2Impl260 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl260.class);
    private static BasepPack2Impl260 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl260 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl260();
        }
        return INSTANCE;
    }

    private BasepPack2Impl260(){
