...
public class BasepPack2Impl213 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl213.class);
    private static BasepPack2Impl213 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl213 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl213();
        }
        return INSTANCE;
    }

    private BasepPack2Impl213(){
