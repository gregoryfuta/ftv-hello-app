...
public class BasepPack2Impl810 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl810.class);
    private static BasepPack2Impl810 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl810 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl810();
        }
        return INSTANCE;
    }

    private BasepPack2Impl810(){
