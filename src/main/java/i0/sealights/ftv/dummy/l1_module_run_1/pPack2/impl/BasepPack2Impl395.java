...
public class BasepPack2Impl395 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl395.class);
    private static BasepPack2Impl395 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl395 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl395();
        }
        return INSTANCE;
    }

    private BasepPack2Impl395(){
