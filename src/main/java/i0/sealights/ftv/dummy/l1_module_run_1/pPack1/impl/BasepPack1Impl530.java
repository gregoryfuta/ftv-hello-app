...
public class BasepPack1Impl530 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl530.class);
    private static BasepPack1Impl530 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl530 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl530();
        }
        return INSTANCE;
    }

    private BasepPack1Impl530(){
