...
public class BasepPack2Impl107 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl107.class);
    private static BasepPack2Impl107 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl107 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl107();
        }
        return INSTANCE;
    }

    private BasepPack2Impl107(){
