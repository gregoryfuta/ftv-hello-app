...
public class BasepPack2Impl786 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl786.class);
    private static BasepPack2Impl786 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl786 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl786();
        }
        return INSTANCE;
    }

    private BasepPack2Impl786(){
