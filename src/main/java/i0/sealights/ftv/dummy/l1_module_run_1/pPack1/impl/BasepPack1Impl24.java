...
public class BasepPack1Impl24 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl24.class);
    private static BasepPack1Impl24 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl24 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl24();
        }
        return INSTANCE;
    }

    private BasepPack1Impl24(){
