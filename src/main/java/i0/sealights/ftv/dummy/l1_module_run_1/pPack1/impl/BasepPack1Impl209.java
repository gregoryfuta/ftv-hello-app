...
public class BasepPack1Impl209 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl209.class);
    private static BasepPack1Impl209 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl209 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl209();
        }
        return INSTANCE;
    }

    private BasepPack1Impl209(){
