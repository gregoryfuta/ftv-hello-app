...
public class ComplexpPack1Impl842 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl842.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl842 INSTANCE;

    public static ComplexpPack1Impl842 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl842();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl842(){
