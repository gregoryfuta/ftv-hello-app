...
public class BasepPack1Impl360 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl360.class);
    private static BasepPack1Impl360 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl360 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl360();
        }
        return INSTANCE;
    }

    private BasepPack1Impl360(){
