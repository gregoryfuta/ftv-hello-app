...
public class BasepPack1Impl845 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl845.class);
    private static BasepPack1Impl845 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl845 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl845();
        }
        return INSTANCE;
    }

    private BasepPack1Impl845(){
