...
public class BasepPack2Impl44 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl44.class);
    private static BasepPack2Impl44 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl44 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl44();
        }
        return INSTANCE;
    }

    private BasepPack2Impl44(){
