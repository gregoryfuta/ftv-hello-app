...
public class BasepPack2Impl369 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl369.class);
    private static BasepPack2Impl369 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl369 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl369();
        }
        return INSTANCE;
    }

    private BasepPack2Impl369(){
