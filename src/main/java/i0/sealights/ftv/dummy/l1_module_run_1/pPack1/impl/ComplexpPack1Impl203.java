...
public class ComplexpPack1Impl203 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl203.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl203 INSTANCE;

    public static ComplexpPack1Impl203 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl203();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl203(){
