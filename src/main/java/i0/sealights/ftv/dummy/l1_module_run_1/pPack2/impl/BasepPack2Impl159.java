...
public class BasepPack2Impl159 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl159.class);
    private static BasepPack2Impl159 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl159 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl159();
        }
        return INSTANCE;
    }

    private BasepPack2Impl159(){
