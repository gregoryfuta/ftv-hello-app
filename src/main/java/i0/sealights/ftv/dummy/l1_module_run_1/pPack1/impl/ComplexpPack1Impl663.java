...
public class ComplexpPack1Impl663 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl663.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl663 INSTANCE;

    public static ComplexpPack1Impl663 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl663();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl663(){
