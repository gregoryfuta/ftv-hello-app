...
public class BasepPack2Impl598 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl598.class);
    private static BasepPack2Impl598 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl598 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl598();
        }
        return INSTANCE;
    }

    private BasepPack2Impl598(){
