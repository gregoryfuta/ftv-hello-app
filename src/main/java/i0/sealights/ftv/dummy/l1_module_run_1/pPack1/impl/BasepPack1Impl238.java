...
public class BasepPack1Impl238 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl238.class);
    private static BasepPack1Impl238 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl238 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl238();
        }
        return INSTANCE;
    }

    private BasepPack1Impl238(){
