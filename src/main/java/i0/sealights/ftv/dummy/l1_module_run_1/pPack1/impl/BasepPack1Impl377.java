...
public class BasepPack1Impl377 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl377.class);
    private static BasepPack1Impl377 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl377 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl377();
        }
        return INSTANCE;
    }

    private BasepPack1Impl377(){
