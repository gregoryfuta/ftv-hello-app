...
public class BasepPack2Impl156 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl156.class);
    private static BasepPack2Impl156 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl156 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl156();
        }
        return INSTANCE;
    }

    private BasepPack2Impl156(){
