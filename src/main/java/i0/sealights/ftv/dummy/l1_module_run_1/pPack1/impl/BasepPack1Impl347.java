...
public class BasepPack1Impl347 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl347.class);
    private static BasepPack1Impl347 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl347 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl347();
        }
        return INSTANCE;
    }

    private BasepPack1Impl347(){
