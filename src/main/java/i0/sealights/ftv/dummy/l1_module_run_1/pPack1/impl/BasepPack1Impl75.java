...
public class BasepPack1Impl75 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl75.class);
    private static BasepPack1Impl75 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl75 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl75();
        }
        return INSTANCE;
    }

    private BasepPack1Impl75(){
