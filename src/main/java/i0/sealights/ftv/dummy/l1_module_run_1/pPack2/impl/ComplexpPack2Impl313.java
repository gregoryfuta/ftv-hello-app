...
public class ComplexpPack2Impl313 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl313.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl313 INSTANCE;

    public static ComplexpPack2Impl313 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl313();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl313(){
