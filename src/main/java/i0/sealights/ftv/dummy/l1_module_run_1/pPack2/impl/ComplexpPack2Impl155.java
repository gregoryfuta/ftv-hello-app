...
public class ComplexpPack2Impl155 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl155.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl155 INSTANCE;

    public static ComplexpPack2Impl155 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl155();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl155(){
