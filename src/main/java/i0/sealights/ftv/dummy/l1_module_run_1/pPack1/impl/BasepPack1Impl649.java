...
public class BasepPack1Impl649 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl649.class);
    private static BasepPack1Impl649 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl649 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl649();
        }
        return INSTANCE;
    }

    private BasepPack1Impl649(){
