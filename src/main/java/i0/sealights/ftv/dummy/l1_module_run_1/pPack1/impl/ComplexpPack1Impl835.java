...
public class ComplexpPack1Impl835 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl835.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl835 INSTANCE;

    public static ComplexpPack1Impl835 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl835();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl835(){
