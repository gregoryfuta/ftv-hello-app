...
public class ComplexpPack2Impl457 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl457.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl457 INSTANCE;

    public static ComplexpPack2Impl457 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl457();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl457(){
