...
public class BasepPack1Impl272 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl272.class);
    private static BasepPack1Impl272 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl272 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl272();
        }
        return INSTANCE;
    }

    private BasepPack1Impl272(){
