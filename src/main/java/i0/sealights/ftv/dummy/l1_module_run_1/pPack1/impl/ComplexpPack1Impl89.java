...
public class ComplexpPack1Impl89 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl89.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl89 INSTANCE;

    public static ComplexpPack1Impl89 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl89();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl89(){
