...
public class ComplexpPack2Impl434 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl434.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl434 INSTANCE;

    public static ComplexpPack2Impl434 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl434();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl434(){
