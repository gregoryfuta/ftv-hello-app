...
public class BasepPack1Impl143 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl143.class);
    private static BasepPack1Impl143 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl143 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl143();
        }
        return INSTANCE;
    }

    private BasepPack1Impl143(){
