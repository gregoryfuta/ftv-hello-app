...
public class ComplexpPack1Impl104 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl104.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl104 INSTANCE;

    public static ComplexpPack1Impl104 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl104();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl104(){
