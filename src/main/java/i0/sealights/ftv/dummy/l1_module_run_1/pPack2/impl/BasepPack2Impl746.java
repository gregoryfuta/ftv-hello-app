...
public class BasepPack2Impl746 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl746.class);
    private static BasepPack2Impl746 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl746 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl746();
        }
        return INSTANCE;
    }

    private BasepPack2Impl746(){
