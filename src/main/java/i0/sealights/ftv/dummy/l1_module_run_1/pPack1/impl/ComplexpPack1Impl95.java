...
public class ComplexpPack1Impl95 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl95.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl95 INSTANCE;

    public static ComplexpPack1Impl95 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl95();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl95(){
