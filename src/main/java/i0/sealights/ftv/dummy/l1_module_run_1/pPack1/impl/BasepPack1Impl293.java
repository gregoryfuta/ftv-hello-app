...
public class BasepPack1Impl293 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl293.class);
    private static BasepPack1Impl293 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl293 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl293();
        }
        return INSTANCE;
    }

    private BasepPack1Impl293(){
