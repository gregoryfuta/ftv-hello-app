...
public class ComplexpPack1Impl863 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl863.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl863 INSTANCE;

    public static ComplexpPack1Impl863 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl863();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl863(){
