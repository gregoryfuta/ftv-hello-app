...
public class BasepPack1Impl608 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl608.class);
    private static BasepPack1Impl608 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl608 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl608();
        }
        return INSTANCE;
    }

    private BasepPack1Impl608(){
