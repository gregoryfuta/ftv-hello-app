...
public class ComplexpPack2Impl474 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl474.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl474 INSTANCE;

    public static ComplexpPack2Impl474 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl474();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl474(){
