...
public class BasepPack2Impl388 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl388.class);
    private static BasepPack2Impl388 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl388 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl388();
        }
        return INSTANCE;
    }

    private BasepPack2Impl388(){
