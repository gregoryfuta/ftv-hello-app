...
public class ComplexpPack1Impl562 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl562.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl562 INSTANCE;

    public static ComplexpPack1Impl562 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl562();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl562(){
