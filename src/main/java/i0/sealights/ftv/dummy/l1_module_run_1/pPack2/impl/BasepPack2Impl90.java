...
public class BasepPack2Impl90 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl90.class);
    private static BasepPack2Impl90 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl90 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl90();
        }
        return INSTANCE;
    }

    private BasepPack2Impl90(){
