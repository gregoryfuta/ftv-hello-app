...
public class BasepPack2Impl716 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl716.class);
    private static BasepPack2Impl716 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl716 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl716();
        }
        return INSTANCE;
    }

    private BasepPack2Impl716(){
