...
public class BasepPack2Impl932 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl932.class);
    private static BasepPack2Impl932 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl932 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl932();
        }
        return INSTANCE;
    }

    private BasepPack2Impl932(){
