...
public class BasepPack1Impl250 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl250.class);
    private static BasepPack1Impl250 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl250 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl250();
        }
        return INSTANCE;
    }

    private BasepPack1Impl250(){
