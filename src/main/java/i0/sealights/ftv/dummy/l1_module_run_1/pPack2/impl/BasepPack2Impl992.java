...
public class BasepPack2Impl992 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl992.class);
    private static BasepPack2Impl992 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl992 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl992();
        }
        return INSTANCE;
    }

    private BasepPack2Impl992(){
