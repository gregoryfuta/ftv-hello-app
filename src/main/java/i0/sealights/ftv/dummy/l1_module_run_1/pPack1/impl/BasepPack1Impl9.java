...
public class BasepPack1Impl9 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl9.class);
    private static BasepPack1Impl9 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl9 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl9();
        }
        return INSTANCE;
    }

    private BasepPack1Impl9(){
