...
public class ComplexpPack1Impl56 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl56.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl56 INSTANCE;

    public static ComplexpPack1Impl56 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl56();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl56(){
