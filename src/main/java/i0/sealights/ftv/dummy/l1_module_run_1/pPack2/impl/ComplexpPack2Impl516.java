...
public class ComplexpPack2Impl516 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl516.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl516 INSTANCE;

    public static ComplexpPack2Impl516 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl516();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl516(){
