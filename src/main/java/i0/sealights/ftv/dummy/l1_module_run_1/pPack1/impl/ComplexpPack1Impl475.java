...
public class ComplexpPack1Impl475 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl475.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl475 INSTANCE;

    public static ComplexpPack1Impl475 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl475();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl475(){
