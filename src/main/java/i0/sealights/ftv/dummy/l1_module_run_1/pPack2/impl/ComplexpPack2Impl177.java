...
public class ComplexpPack2Impl177 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl177.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl177 INSTANCE;

    public static ComplexpPack2Impl177 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl177();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl177(){
