...
public class BasepPack1Impl942 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl942.class);
    private static BasepPack1Impl942 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl942 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl942();
        }
        return INSTANCE;
    }

    private BasepPack1Impl942(){
