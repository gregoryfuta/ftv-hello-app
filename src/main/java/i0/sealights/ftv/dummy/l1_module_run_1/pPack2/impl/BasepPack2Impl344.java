...
public class BasepPack2Impl344 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl344.class);
    private static BasepPack2Impl344 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl344 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl344();
        }
        return INSTANCE;
    }

    private BasepPack2Impl344(){
