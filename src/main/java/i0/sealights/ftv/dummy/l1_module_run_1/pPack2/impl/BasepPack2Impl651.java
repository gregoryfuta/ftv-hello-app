...
public class BasepPack2Impl651 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl651.class);
    private static BasepPack2Impl651 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl651 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl651();
        }
        return INSTANCE;
    }

    private BasepPack2Impl651(){
