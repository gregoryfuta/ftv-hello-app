...
public class BasepPack1Impl795 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl795.class);
    private static BasepPack1Impl795 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl795 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl795();
        }
        return INSTANCE;
    }

    private BasepPack1Impl795(){
