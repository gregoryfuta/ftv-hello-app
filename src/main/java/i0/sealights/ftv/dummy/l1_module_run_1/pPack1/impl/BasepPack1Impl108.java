...
public class BasepPack1Impl108 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl108.class);
    private static BasepPack1Impl108 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl108 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl108();
        }
        return INSTANCE;
    }

    private BasepPack1Impl108(){
