...
public class ComplexpPack1Impl736 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl736.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl736 INSTANCE;

    public static ComplexpPack1Impl736 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl736();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl736(){
