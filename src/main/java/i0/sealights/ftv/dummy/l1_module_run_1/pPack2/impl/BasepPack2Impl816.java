...
public class BasepPack2Impl816 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl816.class);
    private static BasepPack2Impl816 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl816 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl816();
        }
        return INSTANCE;
    }

    private BasepPack2Impl816(){
