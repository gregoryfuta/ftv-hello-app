...
public class ComplexpPack2Impl880 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl880.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl880 INSTANCE;

    public static ComplexpPack2Impl880 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl880();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl880(){
