...
public class ComplexpPack2Impl348 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl348.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl348 INSTANCE;

    public static ComplexpPack2Impl348 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl348();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl348(){
