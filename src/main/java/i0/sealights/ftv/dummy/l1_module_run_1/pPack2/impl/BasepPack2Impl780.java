...
public class BasepPack2Impl780 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl780.class);
    private static BasepPack2Impl780 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl780 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl780();
        }
        return INSTANCE;
    }

    private BasepPack2Impl780(){
