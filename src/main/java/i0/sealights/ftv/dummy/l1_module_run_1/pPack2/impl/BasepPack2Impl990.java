...
public class BasepPack2Impl990 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl990.class);
    private static BasepPack2Impl990 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl990 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl990();
        }
        return INSTANCE;
    }

    private BasepPack2Impl990(){
