...
public class BasepPack1Impl172 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl172.class);
    private static BasepPack1Impl172 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl172 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl172();
        }
        return INSTANCE;
    }

    private BasepPack1Impl172(){
