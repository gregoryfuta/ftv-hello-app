...
public class BasepPack2Impl568 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl568.class);
    private static BasepPack2Impl568 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl568 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl568();
        }
        return INSTANCE;
    }

    private BasepPack2Impl568(){
