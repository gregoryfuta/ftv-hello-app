...
public class BasepPack2Impl65 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl65.class);
    private static BasepPack2Impl65 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl65 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl65();
        }
        return INSTANCE;
    }

    private BasepPack2Impl65(){
