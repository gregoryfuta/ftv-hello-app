...
public class BasepPack2Impl358 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl358.class);
    private static BasepPack2Impl358 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl358 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl358();
        }
        return INSTANCE;
    }

    private BasepPack2Impl358(){
