...
public class ComplexpPack2Impl381 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl381.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl381 INSTANCE;

    public static ComplexpPack2Impl381 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl381();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl381(){
