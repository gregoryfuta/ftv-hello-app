...
public class ComplexpPack1Impl318 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl318.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl318 INSTANCE;

    public static ComplexpPack1Impl318 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl318();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl318(){
