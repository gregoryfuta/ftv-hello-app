...
public class BasepPack1Impl759 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl759.class);
    private static BasepPack1Impl759 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl759 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl759();
        }
        return INSTANCE;
    }

    private BasepPack1Impl759(){
