...
public class BasepPack2Impl767 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl767.class);
    private static BasepPack2Impl767 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl767 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl767();
        }
        return INSTANCE;
    }

    private BasepPack2Impl767(){
