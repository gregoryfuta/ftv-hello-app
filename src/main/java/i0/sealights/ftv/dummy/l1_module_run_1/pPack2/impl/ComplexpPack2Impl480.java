...
public class ComplexpPack2Impl480 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl480.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl480 INSTANCE;

    public static ComplexpPack2Impl480 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl480();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl480(){
