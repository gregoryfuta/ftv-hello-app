...
public class BasepPack2Impl627 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl627.class);
    private static BasepPack2Impl627 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl627 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl627();
        }
        return INSTANCE;
    }

    private BasepPack2Impl627(){
