...
public class BasepPack2Impl556 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl556.class);
    private static BasepPack2Impl556 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl556 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl556();
        }
        return INSTANCE;
    }

    private BasepPack2Impl556(){
