...
public class BasepPack1Impl733 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl733.class);
    private static BasepPack1Impl733 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl733 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl733();
        }
        return INSTANCE;
    }

    private BasepPack1Impl733(){
