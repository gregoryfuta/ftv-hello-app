...
public class ComplexpPack2Impl268 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl268.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl268 INSTANCE;

    public static ComplexpPack2Impl268 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl268();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl268(){
