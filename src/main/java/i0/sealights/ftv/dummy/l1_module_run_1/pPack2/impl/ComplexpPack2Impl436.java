...
public class ComplexpPack2Impl436 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl436.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl436 INSTANCE;

    public static ComplexpPack2Impl436 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl436();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl436(){
