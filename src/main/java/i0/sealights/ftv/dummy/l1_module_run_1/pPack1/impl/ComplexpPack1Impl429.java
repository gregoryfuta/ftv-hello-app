...
public class ComplexpPack1Impl429 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl429.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl429 INSTANCE;

    public static ComplexpPack1Impl429 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl429();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl429(){
