...
public class ComplexpPack1Impl521 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl521.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl521 INSTANCE;

    public static ComplexpPack1Impl521 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl521();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl521(){
