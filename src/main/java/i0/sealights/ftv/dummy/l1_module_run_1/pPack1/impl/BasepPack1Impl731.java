...
public class BasepPack1Impl731 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl731.class);
    private static BasepPack1Impl731 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl731 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl731();
        }
        return INSTANCE;
    }

    private BasepPack1Impl731(){
