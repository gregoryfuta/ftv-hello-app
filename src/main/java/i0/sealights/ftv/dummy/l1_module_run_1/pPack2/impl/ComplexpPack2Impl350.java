...
public class ComplexpPack2Impl350 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl350.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl350 INSTANCE;

    public static ComplexpPack2Impl350 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl350();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl350(){
