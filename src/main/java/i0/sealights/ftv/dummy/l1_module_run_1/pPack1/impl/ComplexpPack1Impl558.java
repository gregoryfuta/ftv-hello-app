...
public class ComplexpPack1Impl558 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl558.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl558 INSTANCE;

    public static ComplexpPack1Impl558 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl558();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl558(){
