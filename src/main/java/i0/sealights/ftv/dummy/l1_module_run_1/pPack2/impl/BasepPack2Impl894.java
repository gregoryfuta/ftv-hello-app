...
public class BasepPack2Impl894 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl894.class);
    private static BasepPack2Impl894 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl894 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl894();
        }
        return INSTANCE;
    }

    private BasepPack2Impl894(){
