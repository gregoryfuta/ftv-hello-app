...
public class BasepPack2Impl426 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl426.class);
    private static BasepPack2Impl426 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl426 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl426();
        }
        return INSTANCE;
    }

    private BasepPack2Impl426(){
