...
public class BasepPack2Impl235 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl235.class);
    private static BasepPack2Impl235 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl235 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl235();
        }
        return INSTANCE;
    }

    private BasepPack2Impl235(){
