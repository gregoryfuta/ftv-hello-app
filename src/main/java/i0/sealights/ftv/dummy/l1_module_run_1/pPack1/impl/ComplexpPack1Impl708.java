...
public class ComplexpPack1Impl708 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl708.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl708 INSTANCE;

    public static ComplexpPack1Impl708 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl708();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl708(){
