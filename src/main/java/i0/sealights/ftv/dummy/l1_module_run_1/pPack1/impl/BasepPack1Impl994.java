...
public class BasepPack1Impl994 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl994.class);
    private static BasepPack1Impl994 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl994 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl994();
        }
        return INSTANCE;
    }

    private BasepPack1Impl994(){
