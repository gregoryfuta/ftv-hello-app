...
public class BasepPack2Impl757 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl757.class);
    private static BasepPack2Impl757 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl757 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl757();
        }
        return INSTANCE;
    }

    private BasepPack2Impl757(){
