...
public class BasepPack1Impl12 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl12.class);
    private static BasepPack1Impl12 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl12 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl12();
        }
        return INSTANCE;
    }

    private BasepPack1Impl12(){
