...
public class BasepPack1Impl446 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl446.class);
    private static BasepPack1Impl446 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl446 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl446();
        }
        return INSTANCE;
    }

    private BasepPack1Impl446(){
