...
public class ComplexpPack1Impl217 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl217.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl217 INSTANCE;

    public static ComplexpPack1Impl217 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl217();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl217(){
