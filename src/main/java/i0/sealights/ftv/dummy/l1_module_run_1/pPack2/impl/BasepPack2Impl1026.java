...
public class BasepPack2Impl1026 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl1026.class);
    private static BasepPack2Impl1026 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl1026 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl1026();
        }
        return INSTANCE;
    }

    private BasepPack2Impl1026(){
