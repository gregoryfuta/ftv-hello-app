...
public class ComplexpPack1Impl467 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl467.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl467 INSTANCE;

    public static ComplexpPack1Impl467 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl467();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl467(){
