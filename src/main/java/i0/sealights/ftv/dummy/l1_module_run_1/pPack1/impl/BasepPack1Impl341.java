...
public class BasepPack1Impl341 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl341.class);
    private static BasepPack1Impl341 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl341 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl341();
        }
        return INSTANCE;
    }

    private BasepPack1Impl341(){
