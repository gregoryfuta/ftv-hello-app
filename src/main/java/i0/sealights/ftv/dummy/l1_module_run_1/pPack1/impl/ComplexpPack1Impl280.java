...
public class ComplexpPack1Impl280 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl280.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl280 INSTANCE;

    public static ComplexpPack1Impl280 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl280();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl280(){
