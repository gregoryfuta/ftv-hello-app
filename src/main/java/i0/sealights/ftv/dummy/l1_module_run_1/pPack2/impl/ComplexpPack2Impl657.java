...
public class ComplexpPack2Impl657 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl657.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl657 INSTANCE;

    public static ComplexpPack2Impl657 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl657();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl657(){
