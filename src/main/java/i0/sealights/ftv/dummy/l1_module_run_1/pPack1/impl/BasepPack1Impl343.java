...
public class BasepPack1Impl343 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl343.class);
    private static BasepPack1Impl343 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl343 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl343();
        }
        return INSTANCE;
    }

    private BasepPack1Impl343(){
