...
public class BasepPack2Impl334 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl334.class);
    private static BasepPack2Impl334 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl334 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl334();
        }
        return INSTANCE;
    }

    private BasepPack2Impl334(){
