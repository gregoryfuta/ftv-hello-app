...
public class BasepPack1Impl808 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl808.class);
    private static BasepPack1Impl808 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl808 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl808();
        }
        return INSTANCE;
    }

    private BasepPack1Impl808(){
