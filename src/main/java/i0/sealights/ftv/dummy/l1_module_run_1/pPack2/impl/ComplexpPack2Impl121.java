...
public class ComplexpPack2Impl121 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl121.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl121 INSTANCE;

    public static ComplexpPack2Impl121 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl121();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl121(){
