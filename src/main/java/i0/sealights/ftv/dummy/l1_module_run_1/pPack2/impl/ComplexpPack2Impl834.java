...
public class ComplexpPack2Impl834 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl834.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl834 INSTANCE;

    public static ComplexpPack2Impl834 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl834();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl834(){
