...
public class BasepPack1Impl100 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl100.class);
    private static BasepPack1Impl100 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl100 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl100();
        }
        return INSTANCE;
    }

    private BasepPack1Impl100(){
