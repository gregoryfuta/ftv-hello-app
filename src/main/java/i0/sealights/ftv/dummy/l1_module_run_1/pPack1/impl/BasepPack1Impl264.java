...
public class BasepPack1Impl264 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl264.class);
    private static BasepPack1Impl264 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl264 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl264();
        }
        return INSTANCE;
    }

    private BasepPack1Impl264(){
