...
public class BasepPack1Impl181 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl181.class);
    private static BasepPack1Impl181 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl181 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl181();
        }
        return INSTANCE;
    }

    private BasepPack1Impl181(){
