...
public class ComplexpPack2Impl617 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl617.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl617 INSTANCE;

    public static ComplexpPack2Impl617 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl617();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl617(){
