...
public class BasepPack2Impl236 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl236.class);
    private static BasepPack2Impl236 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl236 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl236();
        }
        return INSTANCE;
    }

    private BasepPack2Impl236(){
