...
public class BasepPack1Impl936 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl936.class);
    private static BasepPack1Impl936 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl936 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl936();
        }
        return INSTANCE;
    }

    private BasepPack1Impl936(){
