...
public class BasepPack2Impl802 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl802.class);
    private static BasepPack2Impl802 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl802 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl802();
        }
        return INSTANCE;
    }

    private BasepPack2Impl802(){
