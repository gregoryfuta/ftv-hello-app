...
public class BasepPack1Impl698 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl698.class);
    private static BasepPack1Impl698 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl698 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl698();
        }
        return INSTANCE;
    }

    private BasepPack1Impl698(){
