...
public class ComplexpPack1Impl20 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl20.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl20 INSTANCE;

    public static ComplexpPack1Impl20 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl20();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl20(){
