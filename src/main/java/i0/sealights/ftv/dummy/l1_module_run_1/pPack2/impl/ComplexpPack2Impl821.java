...
public class ComplexpPack2Impl821 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl821.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl821 INSTANCE;

    public static ComplexpPack2Impl821 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl821();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl821(){
