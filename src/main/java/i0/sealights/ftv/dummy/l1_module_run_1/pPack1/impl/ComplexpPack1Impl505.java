...
public class ComplexpPack1Impl505 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl505.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl505 INSTANCE;

    public static ComplexpPack1Impl505 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl505();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl505(){
