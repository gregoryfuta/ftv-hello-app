...
public class ComplexpPack1Impl552 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl552.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl552 INSTANCE;

    public static ComplexpPack1Impl552 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl552();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl552(){
