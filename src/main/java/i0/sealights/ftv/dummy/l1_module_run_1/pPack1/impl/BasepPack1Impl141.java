...
public class BasepPack1Impl141 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl141.class);
    private static BasepPack1Impl141 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl141 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl141();
        }
        return INSTANCE;
    }

    private BasepPack1Impl141(){
