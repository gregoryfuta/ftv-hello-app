...
public class BasepPack1Impl398 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl398.class);
    private static BasepPack1Impl398 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl398 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl398();
        }
        return INSTANCE;
    }

    private BasepPack1Impl398(){
