...
public class ComplexpPack2Impl271 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl271.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl271 INSTANCE;

    public static ComplexpPack2Impl271 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl271();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl271(){
