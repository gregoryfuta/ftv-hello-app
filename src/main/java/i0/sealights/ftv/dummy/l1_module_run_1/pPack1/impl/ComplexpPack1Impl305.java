...
public class ComplexpPack1Impl305 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl305.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl305 INSTANCE;

    public static ComplexpPack1Impl305 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl305();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl305(){
