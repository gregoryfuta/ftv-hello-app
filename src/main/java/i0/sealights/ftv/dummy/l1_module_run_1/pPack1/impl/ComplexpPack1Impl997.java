...
public class ComplexpPack1Impl997 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl997.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl997 INSTANCE;

    public static ComplexpPack1Impl997 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl997();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl997(){
