...
public class BasepPack2Impl701 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl701.class);
    private static BasepPack2Impl701 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl701 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl701();
        }
        return INSTANCE;
    }

    private BasepPack2Impl701(){
