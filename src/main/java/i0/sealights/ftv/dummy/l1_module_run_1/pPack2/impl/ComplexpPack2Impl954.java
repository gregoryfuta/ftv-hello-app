...
public class ComplexpPack2Impl954 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl954.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl954 INSTANCE;

    public static ComplexpPack2Impl954 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl954();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl954(){
