...
public class BasepPack2Impl278 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl278.class);
    private static BasepPack2Impl278 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl278 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl278();
        }
        return INSTANCE;
    }

    private BasepPack2Impl278(){
