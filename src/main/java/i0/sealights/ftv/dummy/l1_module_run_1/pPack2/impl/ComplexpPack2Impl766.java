...
public class ComplexpPack2Impl766 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl766.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl766 INSTANCE;

    public static ComplexpPack2Impl766 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl766();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl766(){
