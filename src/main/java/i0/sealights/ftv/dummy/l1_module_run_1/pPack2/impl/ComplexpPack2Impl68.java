...
public class ComplexpPack2Impl68 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl68.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl68 INSTANCE;

    public static ComplexpPack2Impl68 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl68();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl68(){
