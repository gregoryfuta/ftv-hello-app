...
public class BasepPack1Impl1041 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1041.class);
    private static BasepPack1Impl1041 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1041 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1041();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1041(){
