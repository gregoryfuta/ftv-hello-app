...
public class ComplexpPack1Impl484 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl484.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl484 INSTANCE;

    public static ComplexpPack1Impl484 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl484();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl484(){
