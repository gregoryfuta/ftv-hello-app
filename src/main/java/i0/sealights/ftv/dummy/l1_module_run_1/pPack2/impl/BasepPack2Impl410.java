...
public class BasepPack2Impl410 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl410.class);
    private static BasepPack2Impl410 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl410 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl410();
        }
        return INSTANCE;
    }

    private BasepPack2Impl410(){
