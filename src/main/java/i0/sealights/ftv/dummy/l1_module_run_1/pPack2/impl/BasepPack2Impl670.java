...
public class BasepPack2Impl670 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl670.class);
    private static BasepPack2Impl670 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl670 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl670();
        }
        return INSTANCE;
    }

    private BasepPack2Impl670(){
