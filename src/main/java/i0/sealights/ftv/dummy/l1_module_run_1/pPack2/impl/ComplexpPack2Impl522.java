...
public class ComplexpPack2Impl522 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl522.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl522 INSTANCE;

    public static ComplexpPack2Impl522 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl522();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl522(){
