...
public class ComplexpPack1Impl66 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl66.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl66 INSTANCE;

    public static ComplexpPack1Impl66 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl66();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl66(){
