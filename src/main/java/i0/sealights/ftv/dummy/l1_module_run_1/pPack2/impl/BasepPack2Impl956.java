...
public class BasepPack2Impl956 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl956.class);
    private static BasepPack2Impl956 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl956 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl956();
        }
        return INSTANCE;
    }

    private BasepPack2Impl956(){
