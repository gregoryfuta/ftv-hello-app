...
public class ComplexpPack1Impl971 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl971.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl971 INSTANCE;

    public static ComplexpPack1Impl971 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl971();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl971(){
