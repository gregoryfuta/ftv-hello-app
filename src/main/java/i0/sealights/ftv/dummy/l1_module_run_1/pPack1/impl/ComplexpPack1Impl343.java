...
public class ComplexpPack1Impl343 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl343.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl343 INSTANCE;

    public static ComplexpPack1Impl343 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl343();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl343(){
