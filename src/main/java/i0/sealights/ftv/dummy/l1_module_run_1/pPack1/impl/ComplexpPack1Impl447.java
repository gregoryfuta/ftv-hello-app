...
public class ComplexpPack1Impl447 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl447.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl447 INSTANCE;

    public static ComplexpPack1Impl447 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl447();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl447(){
