...
public class ComplexpPack1Impl823 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl823.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl823 INSTANCE;

    public static ComplexpPack1Impl823 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl823();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl823(){
