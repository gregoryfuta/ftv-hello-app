...
public class BasepPack2Impl1053 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl1053.class);
    private static BasepPack2Impl1053 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl1053 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl1053();
        }
        return INSTANCE;
    }

    private BasepPack2Impl1053(){
