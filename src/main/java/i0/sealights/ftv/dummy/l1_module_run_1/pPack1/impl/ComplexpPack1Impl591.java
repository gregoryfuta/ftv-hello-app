...
public class ComplexpPack1Impl591 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl591.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl591 INSTANCE;

    public static ComplexpPack1Impl591 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl591();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl591(){
