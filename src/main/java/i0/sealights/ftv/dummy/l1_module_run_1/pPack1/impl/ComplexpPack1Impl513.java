...
public class ComplexpPack1Impl513 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl513.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl513 INSTANCE;

    public static ComplexpPack1Impl513 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl513();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl513(){
