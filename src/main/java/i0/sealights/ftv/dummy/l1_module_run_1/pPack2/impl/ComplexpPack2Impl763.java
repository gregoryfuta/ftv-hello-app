...
public class ComplexpPack2Impl763 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl763.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl763 INSTANCE;

    public static ComplexpPack2Impl763 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl763();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl763(){
