...
public class BasepPack1Impl277 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl277.class);
    private static BasepPack1Impl277 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl277 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl277();
        }
        return INSTANCE;
    }

    private BasepPack1Impl277(){
