...
public class ComplexpPack1Impl813 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl813.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl813 INSTANCE;

    public static ComplexpPack1Impl813 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl813();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl813(){
