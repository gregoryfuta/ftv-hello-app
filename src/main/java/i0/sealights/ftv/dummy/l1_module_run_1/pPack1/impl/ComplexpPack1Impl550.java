...
public class ComplexpPack1Impl550 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl550.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl550 INSTANCE;

    public static ComplexpPack1Impl550 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl550();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl550(){
