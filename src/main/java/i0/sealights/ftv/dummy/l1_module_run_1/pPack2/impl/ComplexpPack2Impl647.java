...
public class ComplexpPack2Impl647 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl647.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl647 INSTANCE;

    public static ComplexpPack2Impl647 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl647();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl647(){
