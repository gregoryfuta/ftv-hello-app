...
public class BasepPack1Impl870 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl870.class);
    private static BasepPack1Impl870 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl870 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl870();
        }
        return INSTANCE;
    }

    private BasepPack1Impl870(){
