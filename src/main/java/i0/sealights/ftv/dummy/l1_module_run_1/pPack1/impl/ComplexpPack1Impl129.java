...
public class ComplexpPack1Impl129 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl129.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl129 INSTANCE;

    public static ComplexpPack1Impl129 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl129();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl129(){
