...
public class ComplexpPack2Impl240 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl240.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl240 INSTANCE;

    public static ComplexpPack2Impl240 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl240();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl240(){
