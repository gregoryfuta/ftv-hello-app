...
public class ComplexpPack1Impl359 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl359.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl359 INSTANCE;

    public static ComplexpPack1Impl359 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl359();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl359(){
