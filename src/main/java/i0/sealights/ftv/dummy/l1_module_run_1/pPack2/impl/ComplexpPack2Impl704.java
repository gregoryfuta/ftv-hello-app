...
public class ComplexpPack2Impl704 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl704.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl704 INSTANCE;

    public static ComplexpPack2Impl704 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl704();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl704(){
