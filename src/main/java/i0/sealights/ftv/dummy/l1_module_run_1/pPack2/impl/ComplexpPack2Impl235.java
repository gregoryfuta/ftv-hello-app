...
public class ComplexpPack2Impl235 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl235.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl235 INSTANCE;

    public static ComplexpPack2Impl235 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl235();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl235(){
