...
public class ComplexpPack1Impl337 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl337.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl337 INSTANCE;

    public static ComplexpPack1Impl337 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl337();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl337(){
