...
public class ComplexpPack1Impl494 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl494.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl494 INSTANCE;

    public static ComplexpPack1Impl494 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl494();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl494(){
