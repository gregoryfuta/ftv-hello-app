...
public class ComplexpPack1Impl481 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl481.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl481 INSTANCE;

    public static ComplexpPack1Impl481 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl481();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl481(){
