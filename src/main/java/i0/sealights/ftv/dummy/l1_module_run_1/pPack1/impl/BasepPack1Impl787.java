...
public class BasepPack1Impl787 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl787.class);
    private static BasepPack1Impl787 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl787 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl787();
        }
        return INSTANCE;
    }

    private BasepPack1Impl787(){
