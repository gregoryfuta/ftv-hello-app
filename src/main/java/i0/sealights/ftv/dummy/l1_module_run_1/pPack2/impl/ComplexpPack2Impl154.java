...
public class ComplexpPack2Impl154 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl154.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl154 INSTANCE;

    public static ComplexpPack2Impl154 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl154();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl154(){
