...
public class ComplexpPack1Impl1022 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1022.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1022 INSTANCE;

    public static ComplexpPack1Impl1022 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1022();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1022(){
