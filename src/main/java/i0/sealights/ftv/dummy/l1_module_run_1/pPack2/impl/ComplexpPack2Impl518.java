...
public class ComplexpPack2Impl518 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl518.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl518 INSTANCE;

    public static ComplexpPack2Impl518 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl518();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl518(){
