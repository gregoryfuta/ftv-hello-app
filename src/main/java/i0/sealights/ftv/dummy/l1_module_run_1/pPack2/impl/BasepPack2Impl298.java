...
public class BasepPack2Impl298 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl298.class);
    private static BasepPack2Impl298 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl298 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl298();
        }
        return INSTANCE;
    }

    private BasepPack2Impl298(){
