...
public class BasepPack1Impl418 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl418.class);
    private static BasepPack1Impl418 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl418 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl418();
        }
        return INSTANCE;
    }

    private BasepPack1Impl418(){
