...
public class ComplexpPack2Impl257 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl257.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl257 INSTANCE;

    public static ComplexpPack2Impl257 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl257();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl257(){
