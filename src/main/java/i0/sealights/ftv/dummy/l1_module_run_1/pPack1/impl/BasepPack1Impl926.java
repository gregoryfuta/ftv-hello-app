...
public class BasepPack1Impl926 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl926.class);
    private static BasepPack1Impl926 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl926 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl926();
        }
        return INSTANCE;
    }

    private BasepPack1Impl926(){
