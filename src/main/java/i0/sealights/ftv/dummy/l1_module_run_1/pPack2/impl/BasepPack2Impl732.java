...
public class BasepPack2Impl732 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl732.class);
    private static BasepPack2Impl732 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl732 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl732();
        }
        return INSTANCE;
    }

    private BasepPack2Impl732(){
