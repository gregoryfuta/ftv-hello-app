...
public class ComplexpPack2Impl823 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl823.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl823 INSTANCE;

    public static ComplexpPack2Impl823 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl823();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl823(){
