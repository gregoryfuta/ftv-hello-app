...
public class ComplexpPack1Impl101 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl101.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl101 INSTANCE;

    public static ComplexpPack1Impl101 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl101();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl101(){
