...
public class ComplexpPack1Impl524 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl524.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl524 INSTANCE;

    public static ComplexpPack1Impl524 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl524();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl524(){
