...
public class BasepPack1Impl826 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl826.class);
    private static BasepPack1Impl826 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl826 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl826();
        }
        return INSTANCE;
    }

    private BasepPack1Impl826(){
