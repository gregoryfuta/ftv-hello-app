...
public class BasepPack1Impl269 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl269.class);
    private static BasepPack1Impl269 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl269 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl269();
        }
        return INSTANCE;
    }

    private BasepPack1Impl269(){
