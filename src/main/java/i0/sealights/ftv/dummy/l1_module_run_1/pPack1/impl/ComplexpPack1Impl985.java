...
public class ComplexpPack1Impl985 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl985.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl985 INSTANCE;

    public static ComplexpPack1Impl985 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl985();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl985(){
