...
public class ComplexpPack2Impl493 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl493.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl493 INSTANCE;

    public static ComplexpPack2Impl493 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl493();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl493(){
