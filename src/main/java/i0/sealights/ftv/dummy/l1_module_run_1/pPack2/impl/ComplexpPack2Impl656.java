...
public class ComplexpPack2Impl656 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl656.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl656 INSTANCE;

    public static ComplexpPack2Impl656 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl656();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl656(){
