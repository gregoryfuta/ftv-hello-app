...
public class BasepPack1Impl964 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl964.class);
    private static BasepPack1Impl964 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl964 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl964();
        }
        return INSTANCE;
    }

    private BasepPack1Impl964(){
