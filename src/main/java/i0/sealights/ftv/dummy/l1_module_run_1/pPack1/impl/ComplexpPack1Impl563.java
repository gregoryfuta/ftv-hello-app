...
public class ComplexpPack1Impl563 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl563.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl563 INSTANCE;

    public static ComplexpPack1Impl563 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl563();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl563(){
