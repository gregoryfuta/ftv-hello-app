...
public class ComplexpPack1Impl923 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl923.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl923 INSTANCE;

    public static ComplexpPack1Impl923 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl923();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl923(){
