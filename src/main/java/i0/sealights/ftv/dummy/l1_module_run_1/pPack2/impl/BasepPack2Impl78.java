...
public class BasepPack2Impl78 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl78.class);
    private static BasepPack2Impl78 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl78 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl78();
        }
        return INSTANCE;
    }

    private BasepPack2Impl78(){
