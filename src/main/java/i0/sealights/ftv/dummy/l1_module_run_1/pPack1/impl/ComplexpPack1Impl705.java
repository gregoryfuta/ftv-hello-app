...
public class ComplexpPack1Impl705 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl705.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl705 INSTANCE;

    public static ComplexpPack1Impl705 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl705();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl705(){
