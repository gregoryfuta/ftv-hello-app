...
public class ComplexpPack2Impl297 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl297.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl297 INSTANCE;

    public static ComplexpPack2Impl297 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl297();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl297(){
