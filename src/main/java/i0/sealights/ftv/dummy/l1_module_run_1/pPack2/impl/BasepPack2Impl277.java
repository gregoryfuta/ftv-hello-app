...
public class BasepPack2Impl277 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl277.class);
    private static BasepPack2Impl277 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl277 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl277();
        }
        return INSTANCE;
    }

    private BasepPack2Impl277(){
