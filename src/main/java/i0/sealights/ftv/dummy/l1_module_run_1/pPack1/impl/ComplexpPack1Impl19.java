...
public class ComplexpPack1Impl19 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl19.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl19 INSTANCE;

    public static ComplexpPack1Impl19 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl19();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl19(){
