...
public class BasepPack1Impl383 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl383.class);
    private static BasepPack1Impl383 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl383 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl383();
        }
        return INSTANCE;
    }

    private BasepPack1Impl383(){
