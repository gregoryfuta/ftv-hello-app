...
public class BasepPack2Impl623 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl623.class);
    private static BasepPack2Impl623 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl623 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl623();
        }
        return INSTANCE;
    }

    private BasepPack2Impl623(){
