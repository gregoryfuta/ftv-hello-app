...
public class BasepPack2Impl499 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl499.class);
    private static BasepPack2Impl499 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl499 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl499();
        }
        return INSTANCE;
    }

    private BasepPack2Impl499(){
