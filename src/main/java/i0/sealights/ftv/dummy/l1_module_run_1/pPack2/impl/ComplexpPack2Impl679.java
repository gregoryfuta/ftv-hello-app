...
public class ComplexpPack2Impl679 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl679.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl679 INSTANCE;

    public static ComplexpPack2Impl679 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl679();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl679(){
