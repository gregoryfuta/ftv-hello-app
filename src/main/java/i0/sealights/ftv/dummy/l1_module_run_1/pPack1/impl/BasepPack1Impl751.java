...
public class BasepPack1Impl751 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl751.class);
    private static BasepPack1Impl751 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl751 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl751();
        }
        return INSTANCE;
    }

    private BasepPack1Impl751(){
