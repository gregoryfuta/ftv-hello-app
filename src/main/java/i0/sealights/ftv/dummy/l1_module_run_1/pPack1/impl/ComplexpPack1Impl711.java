...
public class ComplexpPack1Impl711 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl711.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl711 INSTANCE;

    public static ComplexpPack1Impl711 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl711();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl711(){
