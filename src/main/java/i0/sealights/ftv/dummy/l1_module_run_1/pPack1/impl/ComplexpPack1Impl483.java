...
public class ComplexpPack1Impl483 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl483.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl483 INSTANCE;

    public static ComplexpPack1Impl483 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl483();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl483(){
