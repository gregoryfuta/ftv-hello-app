...
public class ComplexpPack1Impl825 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl825.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl825 INSTANCE;

    public static ComplexpPack1Impl825 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl825();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl825(){
