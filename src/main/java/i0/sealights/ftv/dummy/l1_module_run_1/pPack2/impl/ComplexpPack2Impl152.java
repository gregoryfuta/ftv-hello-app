...
public class ComplexpPack2Impl152 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl152.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl152 INSTANCE;

    public static ComplexpPack2Impl152 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl152();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl152(){
