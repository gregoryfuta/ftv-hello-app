...
public class ComplexpPack2Impl702 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl702.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl702 INSTANCE;

    public static ComplexpPack2Impl702 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl702();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl702(){
