...
public class BasepPack1Impl147 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl147.class);
    private static BasepPack1Impl147 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl147 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl147();
        }
        return INSTANCE;
    }

    private BasepPack1Impl147(){
