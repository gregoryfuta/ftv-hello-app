...
public class BasepPack1Impl970 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl970.class);
    private static BasepPack1Impl970 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl970 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl970();
        }
        return INSTANCE;
    }

    private BasepPack1Impl970(){
