...
public class BasepPack2Impl453 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl453.class);
    private static BasepPack2Impl453 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl453 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl453();
        }
        return INSTANCE;
    }

    private BasepPack2Impl453(){
