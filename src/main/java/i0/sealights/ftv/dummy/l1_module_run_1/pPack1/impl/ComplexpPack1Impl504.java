...
public class ComplexpPack1Impl504 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl504.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl504 INSTANCE;

    public static ComplexpPack1Impl504 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl504();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl504(){
