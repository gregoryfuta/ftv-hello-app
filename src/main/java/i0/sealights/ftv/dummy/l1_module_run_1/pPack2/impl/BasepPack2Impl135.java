...
public class BasepPack2Impl135 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl135.class);
    private static BasepPack2Impl135 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl135 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl135();
        }
        return INSTANCE;
    }

    private BasepPack2Impl135(){
