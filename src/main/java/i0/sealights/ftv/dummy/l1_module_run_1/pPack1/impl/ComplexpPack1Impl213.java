...
public class ComplexpPack1Impl213 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl213.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl213 INSTANCE;

    public static ComplexpPack1Impl213 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl213();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl213(){
