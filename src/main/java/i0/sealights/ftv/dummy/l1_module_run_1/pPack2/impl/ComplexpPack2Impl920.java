...
public class ComplexpPack2Impl920 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl920.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl920 INSTANCE;

    public static ComplexpPack2Impl920 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl920();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl920(){
