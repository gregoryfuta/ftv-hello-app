...
public class ComplexpPack1Impl574 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl574.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl574 INSTANCE;

    public static ComplexpPack1Impl574 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl574();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl574(){
