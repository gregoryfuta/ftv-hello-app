...
public class ComplexpPack1Impl924 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl924.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl924 INSTANCE;

    public static ComplexpPack1Impl924 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl924();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl924(){
