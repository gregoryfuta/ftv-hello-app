...
public class BasepPack2Impl86 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl86.class);
    private static BasepPack2Impl86 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl86 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl86();
        }
        return INSTANCE;
    }

    private BasepPack2Impl86(){
