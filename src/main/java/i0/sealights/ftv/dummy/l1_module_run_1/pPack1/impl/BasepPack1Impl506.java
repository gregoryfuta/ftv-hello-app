...
public class BasepPack1Impl506 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl506.class);
    private static BasepPack1Impl506 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl506 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl506();
        }
        return INSTANCE;
    }

    private BasepPack1Impl506(){
