...
public class BasepPack2Impl287 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl287.class);
    private static BasepPack2Impl287 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl287 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl287();
        }
        return INSTANCE;
    }

    private BasepPack2Impl287(){
