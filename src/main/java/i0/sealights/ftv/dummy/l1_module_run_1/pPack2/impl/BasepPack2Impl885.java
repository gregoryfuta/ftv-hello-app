...
public class BasepPack2Impl885 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl885.class);
    private static BasepPack2Impl885 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl885 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl885();
        }
        return INSTANCE;
    }

    private BasepPack2Impl885(){
