...
public class ComplexpPack1Impl979 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl979.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl979 INSTANCE;

    public static ComplexpPack1Impl979 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl979();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl979(){
