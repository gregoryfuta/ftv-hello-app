...
public class ComplexpPack1Impl395 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl395.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl395 INSTANCE;

    public static ComplexpPack1Impl395 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl395();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl395(){
