...
public class BasepPack1Impl646 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl646.class);
    private static BasepPack1Impl646 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl646 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl646();
        }
        return INSTANCE;
    }

    private BasepPack1Impl646(){
