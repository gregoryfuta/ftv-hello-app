...
public class ComplexpPack1Impl383 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl383.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl383 INSTANCE;

    public static ComplexpPack1Impl383 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl383();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl383(){
