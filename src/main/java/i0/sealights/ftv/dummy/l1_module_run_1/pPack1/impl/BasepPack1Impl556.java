...
public class BasepPack1Impl556 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl556.class);
    private static BasepPack1Impl556 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl556 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl556();
        }
        return INSTANCE;
    }

    private BasepPack1Impl556(){
