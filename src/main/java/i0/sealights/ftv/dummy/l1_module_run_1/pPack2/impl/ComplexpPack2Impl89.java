...
public class ComplexpPack2Impl89 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl89.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl89 INSTANCE;

    public static ComplexpPack2Impl89 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl89();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl89(){
