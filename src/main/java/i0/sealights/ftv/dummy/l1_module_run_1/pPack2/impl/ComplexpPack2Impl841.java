...
public class ComplexpPack2Impl841 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl841.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl841 INSTANCE;

    public static ComplexpPack2Impl841 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl841();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl841(){
