...
public class BasepPack2Impl346 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl346.class);
    private static BasepPack2Impl346 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl346 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl346();
        }
        return INSTANCE;
    }

    private BasepPack2Impl346(){
