...
public class BasepPack1Impl201 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl201.class);
    private static BasepPack1Impl201 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl201 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl201();
        }
        return INSTANCE;
    }

    private BasepPack1Impl201(){
