...
public class BasepPack2Impl639 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl639.class);
    private static BasepPack2Impl639 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl639 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl639();
        }
        return INSTANCE;
    }

    private BasepPack2Impl639(){
