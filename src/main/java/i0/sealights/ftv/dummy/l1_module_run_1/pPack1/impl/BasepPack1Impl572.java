...
public class BasepPack1Impl572 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl572.class);
    private static BasepPack1Impl572 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl572 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl572();
        }
        return INSTANCE;
    }

    private BasepPack1Impl572(){
