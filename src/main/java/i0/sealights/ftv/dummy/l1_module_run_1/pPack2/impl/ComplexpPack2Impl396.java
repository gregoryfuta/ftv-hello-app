...
public class ComplexpPack2Impl396 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl396.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl396 INSTANCE;

    public static ComplexpPack2Impl396 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl396();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl396(){
