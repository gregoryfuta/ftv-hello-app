...
public class BasepPack2Impl396 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl396.class);
    private static BasepPack2Impl396 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl396 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl396();
        }
        return INSTANCE;
    }

    private BasepPack2Impl396(){
