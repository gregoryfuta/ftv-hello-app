...
public class ComplexpPack1Impl712 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl712.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl712 INSTANCE;

    public static ComplexpPack1Impl712 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl712();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl712(){
