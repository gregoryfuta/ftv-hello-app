...
public class BasepPack1Impl430 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl430.class);
    private static BasepPack1Impl430 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl430 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl430();
        }
        return INSTANCE;
    }

    private BasepPack1Impl430(){
