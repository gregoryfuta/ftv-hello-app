...
public class ComplexpPack2Impl84 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl84.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl84 INSTANCE;

    public static ComplexpPack2Impl84 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl84();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl84(){
