...
public class ComplexpPack1Impl925 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl925.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl925 INSTANCE;

    public static ComplexpPack1Impl925 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl925();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl925(){
