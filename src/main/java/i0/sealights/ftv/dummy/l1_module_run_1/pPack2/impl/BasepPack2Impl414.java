...
public class BasepPack2Impl414 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl414.class);
    private static BasepPack2Impl414 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl414 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl414();
        }
        return INSTANCE;
    }

    private BasepPack2Impl414(){
