...
public class ComplexpPack1Impl448 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl448.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl448 INSTANCE;

    public static ComplexpPack1Impl448 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl448();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl448(){
