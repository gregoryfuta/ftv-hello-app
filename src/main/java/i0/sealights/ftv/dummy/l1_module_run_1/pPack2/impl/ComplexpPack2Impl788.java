...
public class ComplexpPack2Impl788 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl788.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl788 INSTANCE;

    public static ComplexpPack2Impl788 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl788();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl788(){
