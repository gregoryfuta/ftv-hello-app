...
public class ComplexpPack1Impl541 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl541.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl541 INSTANCE;

    public static ComplexpPack1Impl541 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl541();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl541(){
