...
public class BasepPack2Impl308 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl308.class);
    private static BasepPack2Impl308 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl308 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl308();
        }
        return INSTANCE;
    }

    private BasepPack2Impl308(){
