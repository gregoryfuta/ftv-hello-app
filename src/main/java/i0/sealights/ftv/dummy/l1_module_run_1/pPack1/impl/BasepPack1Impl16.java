...
public class BasepPack1Impl16 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl16.class);
    private static BasepPack1Impl16 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl16 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl16();
        }
        return INSTANCE;
    }

    private BasepPack1Impl16(){
