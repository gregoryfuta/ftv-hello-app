...
public class BasepPack1Impl329 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl329.class);
    private static BasepPack1Impl329 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl329 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl329();
        }
        return INSTANCE;
    }

    private BasepPack1Impl329(){
