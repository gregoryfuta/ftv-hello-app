...
public class ComplexpPack2Impl844 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl844.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl844 INSTANCE;

    public static ComplexpPack2Impl844 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl844();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl844(){
