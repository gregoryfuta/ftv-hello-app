...
public class BasepPack2Impl462 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl462.class);
    private static BasepPack2Impl462 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl462 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl462();
        }
        return INSTANCE;
    }

    private BasepPack2Impl462(){
