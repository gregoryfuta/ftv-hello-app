...
public class ComplexpPack1Impl974 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl974.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl974 INSTANCE;

    public static ComplexpPack1Impl974 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl974();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl974(){
