...
public class ComplexpPack2Impl66 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl66.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl66 INSTANCE;

    public static ComplexpPack2Impl66 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl66();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl66(){
