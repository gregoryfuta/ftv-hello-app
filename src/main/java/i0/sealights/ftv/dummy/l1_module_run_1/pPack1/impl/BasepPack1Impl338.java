...
public class BasepPack1Impl338 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl338.class);
    private static BasepPack1Impl338 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl338 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl338();
        }
        return INSTANCE;
    }

    private BasepPack1Impl338(){
