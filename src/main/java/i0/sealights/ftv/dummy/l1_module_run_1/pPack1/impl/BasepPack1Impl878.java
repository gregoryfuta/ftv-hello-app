...
public class BasepPack1Impl878 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl878.class);
    private static BasepPack1Impl878 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl878 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl878();
        }
        return INSTANCE;
    }

    private BasepPack1Impl878(){
