...
public class BasepPack2Impl884 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl884.class);
    private static BasepPack2Impl884 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl884 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl884();
        }
        return INSTANCE;
    }

    private BasepPack2Impl884(){
