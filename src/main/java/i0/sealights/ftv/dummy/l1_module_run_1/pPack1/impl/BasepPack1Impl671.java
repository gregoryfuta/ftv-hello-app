...
public class BasepPack1Impl671 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl671.class);
    private static BasepPack1Impl671 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl671 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl671();
        }
        return INSTANCE;
    }

    private BasepPack1Impl671(){
