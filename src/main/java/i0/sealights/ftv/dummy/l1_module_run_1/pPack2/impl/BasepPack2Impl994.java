...
public class BasepPack2Impl994 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl994.class);
    private static BasepPack2Impl994 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl994 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl994();
        }
        return INSTANCE;
    }

    private BasepPack2Impl994(){
