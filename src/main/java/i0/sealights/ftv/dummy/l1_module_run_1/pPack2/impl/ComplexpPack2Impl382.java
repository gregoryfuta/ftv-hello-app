...
public class ComplexpPack2Impl382 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl382.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl382 INSTANCE;

    public static ComplexpPack2Impl382 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl382();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl382(){
