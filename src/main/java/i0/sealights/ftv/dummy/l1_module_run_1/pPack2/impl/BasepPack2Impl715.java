...
public class BasepPack2Impl715 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl715.class);
    private static BasepPack2Impl715 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl715 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl715();
        }
        return INSTANCE;
    }

    private BasepPack2Impl715(){
