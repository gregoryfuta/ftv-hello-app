...
public class ComplexpPack1Impl953 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl953.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl953 INSTANCE;

    public static ComplexpPack1Impl953 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl953();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl953(){
