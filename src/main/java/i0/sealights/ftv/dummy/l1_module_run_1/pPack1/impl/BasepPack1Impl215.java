...
public class BasepPack1Impl215 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl215.class);
    private static BasepPack1Impl215 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl215 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl215();
        }
        return INSTANCE;
    }

    private BasepPack1Impl215(){
