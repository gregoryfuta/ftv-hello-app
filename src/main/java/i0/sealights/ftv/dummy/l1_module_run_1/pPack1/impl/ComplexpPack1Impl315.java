...
public class ComplexpPack1Impl315 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl315.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl315 INSTANCE;

    public static ComplexpPack1Impl315 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl315();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl315(){
