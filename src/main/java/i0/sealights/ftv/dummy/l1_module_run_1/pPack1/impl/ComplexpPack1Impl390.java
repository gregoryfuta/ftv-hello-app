...
public class ComplexpPack1Impl390 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl390.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl390 INSTANCE;

    public static ComplexpPack1Impl390 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl390();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl390(){
