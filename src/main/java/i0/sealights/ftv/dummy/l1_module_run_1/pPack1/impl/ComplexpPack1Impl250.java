...
public class ComplexpPack1Impl250 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl250.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl250 INSTANCE;

    public static ComplexpPack1Impl250 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl250();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl250(){
