...
public class BasepPack2Impl516 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl516.class);
    private static BasepPack2Impl516 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl516 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl516();
        }
        return INSTANCE;
    }

    private BasepPack2Impl516(){
