...
public class BasepPack2Impl663 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl663.class);
    private static BasepPack2Impl663 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl663 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl663();
        }
        return INSTANCE;
    }

    private BasepPack2Impl663(){
