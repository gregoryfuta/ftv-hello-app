...
public class BasepPack1Impl674 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl674.class);
    private static BasepPack1Impl674 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl674 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl674();
        }
        return INSTANCE;
    }

    private BasepPack1Impl674(){
