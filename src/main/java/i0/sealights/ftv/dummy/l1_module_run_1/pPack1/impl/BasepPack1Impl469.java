...
public class BasepPack1Impl469 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl469.class);
    private static BasepPack1Impl469 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl469 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl469();
        }
        return INSTANCE;
    }

    private BasepPack1Impl469(){
