...
public class ComplexpPack1Impl623 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl623.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl623 INSTANCE;

    public static ComplexpPack1Impl623 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl623();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl623(){
