...
public class BasepPack1Impl595 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl595.class);
    private static BasepPack1Impl595 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl595 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl595();
        }
        return INSTANCE;
    }

    private BasepPack1Impl595(){
