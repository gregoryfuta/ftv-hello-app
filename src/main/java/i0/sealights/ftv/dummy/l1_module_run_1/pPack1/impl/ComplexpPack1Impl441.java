...
public class ComplexpPack1Impl441 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl441.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl441 INSTANCE;

    public static ComplexpPack1Impl441 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl441();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl441(){
