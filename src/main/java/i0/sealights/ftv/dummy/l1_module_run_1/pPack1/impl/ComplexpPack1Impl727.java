...
public class ComplexpPack1Impl727 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl727.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl727 INSTANCE;

    public static ComplexpPack1Impl727 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl727();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl727(){
