...
public class ComplexpPack1Impl334 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl334.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl334 INSTANCE;

    public static ComplexpPack1Impl334 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl334();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl334(){
