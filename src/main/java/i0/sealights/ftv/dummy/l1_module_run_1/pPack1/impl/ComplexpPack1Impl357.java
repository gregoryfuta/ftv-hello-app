...
public class ComplexpPack1Impl357 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl357.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl357 INSTANCE;

    public static ComplexpPack1Impl357 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl357();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl357(){
