...
public class BasepPack1Impl305 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl305.class);
    private static BasepPack1Impl305 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl305 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl305();
        }
        return INSTANCE;
    }

    private BasepPack1Impl305(){
