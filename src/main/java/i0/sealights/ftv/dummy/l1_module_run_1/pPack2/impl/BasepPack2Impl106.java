...
public class BasepPack2Impl106 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl106.class);
    private static BasepPack2Impl106 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl106 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl106();
        }
        return INSTANCE;
    }

    private BasepPack2Impl106(){
