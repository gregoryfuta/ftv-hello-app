...
public class ComplexpPack1Impl977 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl977.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl977 INSTANCE;

    public static ComplexpPack1Impl977 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl977();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl977(){
