...
public class ComplexpPack2Impl216 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl216.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl216 INSTANCE;

    public static ComplexpPack2Impl216 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl216();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl216(){
