...
public class BasepPack1Impl29 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl29.class);
    private static BasepPack1Impl29 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl29 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl29();
        }
        return INSTANCE;
    }

    private BasepPack1Impl29(){
