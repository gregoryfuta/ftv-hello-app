...
public class BasepPack1Impl830 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl830.class);
    private static BasepPack1Impl830 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl830 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl830();
        }
        return INSTANCE;
    }

    private BasepPack1Impl830(){
