...
public class ComplexpPack1Impl717 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl717.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl717 INSTANCE;

    public static ComplexpPack1Impl717 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl717();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl717(){
