...
public class ComplexpPack1Impl778 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl778.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl778 INSTANCE;

    public static ComplexpPack1Impl778 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl778();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl778(){
