...
public class ComplexpPack2Impl694 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl694.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl694 INSTANCE;

    public static ComplexpPack2Impl694 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl694();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl694(){
