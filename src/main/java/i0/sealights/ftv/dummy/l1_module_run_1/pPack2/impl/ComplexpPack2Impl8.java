...
public class ComplexpPack2Impl8 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl8.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl8 INSTANCE;

    public static ComplexpPack2Impl8 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl8();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl8(){
