...
public class BasepPack1Impl897 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl897.class);
    private static BasepPack1Impl897 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl897 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl897();
        }
        return INSTANCE;
    }

    private BasepPack1Impl897(){
