...
public class BasepPack2Impl294 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl294.class);
    private static BasepPack2Impl294 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl294 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl294();
        }
        return INSTANCE;
    }

    private BasepPack2Impl294(){
