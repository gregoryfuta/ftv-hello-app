...
public class ComplexpPack1Impl641 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl641.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl641 INSTANCE;

    public static ComplexpPack1Impl641 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl641();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl641(){
