...
public class ComplexpPack2Impl860 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl860.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl860 INSTANCE;

    public static ComplexpPack2Impl860 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl860();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl860(){
