...
public class BasepPack1Impl324 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl324.class);
    private static BasepPack1Impl324 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl324 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl324();
        }
        return INSTANCE;
    }

    private BasepPack1Impl324(){
