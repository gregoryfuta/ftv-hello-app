...
public class BasepPack2Impl198 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl198.class);
    private static BasepPack2Impl198 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl198 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl198();
        }
        return INSTANCE;
    }

    private BasepPack2Impl198(){
