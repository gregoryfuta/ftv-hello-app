...
public class ComplexpPack1Impl728 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl728.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl728 INSTANCE;

    public static ComplexpPack1Impl728 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl728();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl728(){
