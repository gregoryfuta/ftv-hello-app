...
public class BasepPack1Impl492 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl492.class);
    private static BasepPack1Impl492 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl492 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl492();
        }
        return INSTANCE;
    }

    private BasepPack1Impl492(){
