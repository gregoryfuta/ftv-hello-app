...
public class BasepPack2Impl489 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl489.class);
    private static BasepPack2Impl489 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl489 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl489();
        }
        return INSTANCE;
    }

    private BasepPack2Impl489(){
