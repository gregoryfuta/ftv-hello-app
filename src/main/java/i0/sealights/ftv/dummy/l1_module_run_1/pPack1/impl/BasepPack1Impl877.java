...
public class BasepPack1Impl877 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl877.class);
    private static BasepPack1Impl877 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl877 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl877();
        }
        return INSTANCE;
    }

    private BasepPack1Impl877(){
