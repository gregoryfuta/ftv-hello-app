...
public class BasepPack1Impl222 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl222.class);
    private static BasepPack1Impl222 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl222 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl222();
        }
        return INSTANCE;
    }

    private BasepPack1Impl222(){
