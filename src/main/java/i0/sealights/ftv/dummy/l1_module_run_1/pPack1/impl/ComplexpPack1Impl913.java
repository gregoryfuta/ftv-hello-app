...
public class ComplexpPack1Impl913 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl913.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl913 INSTANCE;

    public static ComplexpPack1Impl913 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl913();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl913(){
