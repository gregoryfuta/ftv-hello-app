...
public class ComplexpPack2Impl456 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl456.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl456 INSTANCE;

    public static ComplexpPack2Impl456 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl456();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl456(){
