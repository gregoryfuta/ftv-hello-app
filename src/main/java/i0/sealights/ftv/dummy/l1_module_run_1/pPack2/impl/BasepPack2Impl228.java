...
public class BasepPack2Impl228 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl228.class);
    private static BasepPack2Impl228 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl228 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl228();
        }
        return INSTANCE;
    }

    private BasepPack2Impl228(){
