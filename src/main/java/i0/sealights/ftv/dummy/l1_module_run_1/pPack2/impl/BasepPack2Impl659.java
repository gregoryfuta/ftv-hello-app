...
public class BasepPack2Impl659 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl659.class);
    private static BasepPack2Impl659 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl659 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl659();
        }
        return INSTANCE;
    }

    private BasepPack2Impl659(){
