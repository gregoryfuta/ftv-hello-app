...
public class ComplexpPack1Impl642 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl642.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl642 INSTANCE;

    public static ComplexpPack1Impl642 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl642();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl642(){
