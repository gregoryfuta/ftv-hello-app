...
public class ComplexpPack1Impl400 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl400.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl400 INSTANCE;

    public static ComplexpPack1Impl400 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl400();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl400(){
