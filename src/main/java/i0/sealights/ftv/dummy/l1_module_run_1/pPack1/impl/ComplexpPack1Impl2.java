...
public class ComplexpPack1Impl2 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl2.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl2 INSTANCE;

    public static ComplexpPack1Impl2 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl2();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl2(){
