...
public class ComplexpPack1Impl612 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl612.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl612 INSTANCE;

    public static ComplexpPack1Impl612 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl612();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl612(){
