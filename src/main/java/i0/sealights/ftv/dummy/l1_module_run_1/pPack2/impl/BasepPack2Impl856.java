...
public class BasepPack2Impl856 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl856.class);
    private static BasepPack2Impl856 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl856 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl856();
        }
        return INSTANCE;
    }

    private BasepPack2Impl856(){
