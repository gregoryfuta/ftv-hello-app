...
public class ComplexpPack1Impl832 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl832.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl832 INSTANCE;

    public static ComplexpPack1Impl832 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl832();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl832(){
