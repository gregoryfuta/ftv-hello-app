...
public class BasepPack1Impl1059 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1059.class);
    private static BasepPack1Impl1059 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1059 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1059();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1059(){
