...
public class BasepPack1Impl381 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl381.class);
    private static BasepPack1Impl381 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl381 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl381();
        }
        return INSTANCE;
    }

    private BasepPack1Impl381(){
