...
public class BasepPack2Impl7 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl7.class);
    private static BasepPack2Impl7 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl7 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl7();
        }
        return INSTANCE;
    }

    private BasepPack2Impl7(){
