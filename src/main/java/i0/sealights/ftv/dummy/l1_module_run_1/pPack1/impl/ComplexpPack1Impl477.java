...
public class ComplexpPack1Impl477 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl477.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl477 INSTANCE;

    public static ComplexpPack1Impl477 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl477();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl477(){
