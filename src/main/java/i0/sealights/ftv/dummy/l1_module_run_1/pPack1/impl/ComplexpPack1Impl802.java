...
public class ComplexpPack1Impl802 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl802.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl802 INSTANCE;

    public static ComplexpPack1Impl802 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl802();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl802(){
