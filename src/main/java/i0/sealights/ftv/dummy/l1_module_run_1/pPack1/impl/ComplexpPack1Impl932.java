...
public class ComplexpPack1Impl932 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl932.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl932 INSTANCE;

    public static ComplexpPack1Impl932 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl932();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl932(){
