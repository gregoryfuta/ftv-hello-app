...
public class BasepPack1Impl374 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl374.class);
    private static BasepPack1Impl374 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl374 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl374();
        }
        return INSTANCE;
    }

    private BasepPack1Impl374(){
