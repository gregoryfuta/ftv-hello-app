...
public class ComplexpPack1Impl5 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl5.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl5 INSTANCE;

    public static ComplexpPack1Impl5 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl5();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl5(){
