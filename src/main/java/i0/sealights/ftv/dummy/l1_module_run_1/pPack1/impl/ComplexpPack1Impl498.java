...
public class ComplexpPack1Impl498 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl498.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl498 INSTANCE;

    public static ComplexpPack1Impl498 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl498();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl498(){
