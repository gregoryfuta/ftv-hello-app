...
public class BasepPack1Impl121 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl121.class);
    private static BasepPack1Impl121 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl121 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl121();
        }
        return INSTANCE;
    }

    private BasepPack1Impl121(){
