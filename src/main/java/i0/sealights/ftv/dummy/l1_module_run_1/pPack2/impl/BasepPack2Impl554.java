...
public class BasepPack2Impl554 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl554.class);
    private static BasepPack2Impl554 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl554 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl554();
        }
        return INSTANCE;
    }

    private BasepPack2Impl554(){
