...
public class BasepPack1Impl568 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl568.class);
    private static BasepPack1Impl568 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl568 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl568();
        }
        return INSTANCE;
    }

    private BasepPack1Impl568(){
