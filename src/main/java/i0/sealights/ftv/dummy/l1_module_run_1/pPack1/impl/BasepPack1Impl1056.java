...
public class BasepPack1Impl1056 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1056.class);
    private static BasepPack1Impl1056 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1056 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1056();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1056(){
