...
public class ComplexpPack2Impl380 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl380.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl380 INSTANCE;

    public static ComplexpPack2Impl380 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl380();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl380(){
