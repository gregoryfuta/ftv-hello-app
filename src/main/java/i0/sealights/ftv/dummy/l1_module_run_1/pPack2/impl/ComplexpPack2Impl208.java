...
public class ComplexpPack2Impl208 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl208.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl208 INSTANCE;

    public static ComplexpPack2Impl208 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl208();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl208(){
