...
public class BasepPack1Impl1063 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1063.class);
    private static BasepPack1Impl1063 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1063 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1063();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1063(){
