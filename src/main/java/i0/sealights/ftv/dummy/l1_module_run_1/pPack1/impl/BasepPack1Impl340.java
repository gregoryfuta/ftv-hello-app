...
public class BasepPack1Impl340 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl340.class);
    private static BasepPack1Impl340 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl340 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl340();
        }
        return INSTANCE;
    }

    private BasepPack1Impl340(){
