...
public class ComplexpPack1Impl654 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl654.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl654 INSTANCE;

    public static ComplexpPack1Impl654 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl654();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl654(){
