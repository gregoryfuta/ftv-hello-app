...
public class BasepPack2Impl13 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl13.class);
    private static BasepPack2Impl13 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl13 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl13();
        }
        return INSTANCE;
    }

    private BasepPack2Impl13(){
