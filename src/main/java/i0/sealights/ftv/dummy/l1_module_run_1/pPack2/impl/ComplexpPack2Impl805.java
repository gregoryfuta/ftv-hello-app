...
public class ComplexpPack2Impl805 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl805.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl805 INSTANCE;

    public static ComplexpPack2Impl805 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl805();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl805(){
