...
public class BasepPack2Impl534 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl534.class);
    private static BasepPack2Impl534 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl534 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl534();
        }
        return INSTANCE;
    }

    private BasepPack2Impl534(){
