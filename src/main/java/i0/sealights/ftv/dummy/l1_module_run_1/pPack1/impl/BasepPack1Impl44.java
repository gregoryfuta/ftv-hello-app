...
public class BasepPack1Impl44 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl44.class);
    private static BasepPack1Impl44 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl44 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl44();
        }
        return INSTANCE;
    }

    private BasepPack1Impl44(){
