...
public class ComplexpPack1Impl731 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl731.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl731 INSTANCE;

    public static ComplexpPack1Impl731 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl731();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl731(){
