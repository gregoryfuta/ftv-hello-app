...
public class ComplexpPack1Impl630 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl630.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl630 INSTANCE;

    public static ComplexpPack1Impl630 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl630();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl630(){
