...
public class ComplexpPack1Impl358 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl358.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl358 INSTANCE;

    public static ComplexpPack1Impl358 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl358();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl358(){
