...
public class BasepPack2Impl313 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl313.class);
    private static BasepPack2Impl313 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl313 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl313();
        }
        return INSTANCE;
    }

    private BasepPack2Impl313(){
