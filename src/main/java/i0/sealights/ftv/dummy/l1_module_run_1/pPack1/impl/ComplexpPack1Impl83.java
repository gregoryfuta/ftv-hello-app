...
public class ComplexpPack1Impl83 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl83.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl83 INSTANCE;

    public static ComplexpPack1Impl83 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl83();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl83(){
