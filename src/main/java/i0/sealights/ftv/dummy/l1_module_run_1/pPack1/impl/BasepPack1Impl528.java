...
public class BasepPack1Impl528 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl528.class);
    private static BasepPack1Impl528 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl528 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl528();
        }
        return INSTANCE;
    }

    private BasepPack1Impl528(){
