...
public class ComplexpPack2Impl389 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl389.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl389 INSTANCE;

    public static ComplexpPack2Impl389 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl389();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl389(){
