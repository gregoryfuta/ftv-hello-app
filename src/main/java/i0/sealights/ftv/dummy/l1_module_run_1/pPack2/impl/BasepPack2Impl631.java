...
public class BasepPack2Impl631 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl631.class);
    private static BasepPack2Impl631 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl631 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl631();
        }
        return INSTANCE;
    }

    private BasepPack2Impl631(){
