...
public class BasepPack2Impl922 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl922.class);
    private static BasepPack2Impl922 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl922 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl922();
        }
        return INSTANCE;
    }

    private BasepPack2Impl922(){
