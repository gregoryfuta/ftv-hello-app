...
public class BasepPack1Impl817 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl817.class);
    private static BasepPack1Impl817 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl817 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl817();
        }
        return INSTANCE;
    }

    private BasepPack1Impl817(){
