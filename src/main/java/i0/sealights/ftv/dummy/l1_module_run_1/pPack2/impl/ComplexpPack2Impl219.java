...
public class ComplexpPack2Impl219 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl219.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl219 INSTANCE;

    public static ComplexpPack2Impl219 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl219();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl219(){
