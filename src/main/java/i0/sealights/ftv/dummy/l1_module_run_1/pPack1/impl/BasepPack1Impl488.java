...
public class BasepPack1Impl488 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl488.class);
    private static BasepPack1Impl488 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl488 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl488();
        }
        return INSTANCE;
    }

    private BasepPack1Impl488(){
