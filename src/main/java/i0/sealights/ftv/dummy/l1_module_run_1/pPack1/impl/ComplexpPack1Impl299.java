...
public class ComplexpPack1Impl299 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl299.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl299 INSTANCE;

    public static ComplexpPack1Impl299 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl299();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl299(){
