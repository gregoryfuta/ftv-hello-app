...
public class ComplexpPack2Impl640 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl640.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl640 INSTANCE;

    public static ComplexpPack2Impl640 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl640();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl640(){
