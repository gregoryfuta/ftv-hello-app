...
public class ComplexpPack2Impl314 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl314.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl314 INSTANCE;

    public static ComplexpPack2Impl314 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl314();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl314(){
