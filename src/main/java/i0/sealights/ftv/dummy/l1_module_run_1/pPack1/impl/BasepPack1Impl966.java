...
public class BasepPack1Impl966 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl966.class);
    private static BasepPack1Impl966 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl966 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl966();
        }
        return INSTANCE;
    }

    private BasepPack1Impl966(){
