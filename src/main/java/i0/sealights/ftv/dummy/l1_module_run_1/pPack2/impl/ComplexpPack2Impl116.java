...
public class ComplexpPack2Impl116 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl116.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl116 INSTANCE;

    public static ComplexpPack2Impl116 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl116();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl116(){
