...
public class ComplexpPack2Impl888 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl888.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl888 INSTANCE;

    public static ComplexpPack2Impl888 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl888();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl888(){
