...
public class BasepPack1Impl805 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl805.class);
    private static BasepPack1Impl805 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl805 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl805();
        }
        return INSTANCE;
    }

    private BasepPack1Impl805(){
