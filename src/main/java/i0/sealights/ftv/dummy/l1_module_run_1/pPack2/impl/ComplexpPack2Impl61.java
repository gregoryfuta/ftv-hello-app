...
public class ComplexpPack2Impl61 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl61.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl61 INSTANCE;

    public static ComplexpPack2Impl61 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl61();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl61(){
