...
public class ComplexpPack1Impl160 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl160.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl160 INSTANCE;

    public static ComplexpPack1Impl160 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl160();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl160(){
