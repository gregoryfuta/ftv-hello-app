...
public class BasepPack2Impl6 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl6.class);
    private static BasepPack2Impl6 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl6 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl6();
        }
        return INSTANCE;
    }

    private BasepPack2Impl6(){
