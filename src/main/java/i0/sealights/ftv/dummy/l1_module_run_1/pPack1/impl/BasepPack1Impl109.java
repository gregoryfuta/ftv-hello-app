...
public class BasepPack1Impl109 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl109.class);
    private static BasepPack1Impl109 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl109 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl109();
        }
        return INSTANCE;
    }

    private BasepPack1Impl109(){
