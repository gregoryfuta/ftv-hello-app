...
public class ComplexpPack2Impl946 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl946.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl946 INSTANCE;

    public static ComplexpPack2Impl946 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl946();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl946(){
