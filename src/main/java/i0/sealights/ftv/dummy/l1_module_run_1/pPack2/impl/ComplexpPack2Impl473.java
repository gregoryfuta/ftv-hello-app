...
public class ComplexpPack2Impl473 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl473.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl473 INSTANCE;

    public static ComplexpPack2Impl473 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl473();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl473(){
