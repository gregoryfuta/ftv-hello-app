...
public class ComplexpPack1Impl795 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl795.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl795 INSTANCE;

    public static ComplexpPack1Impl795 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl795();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl795(){
