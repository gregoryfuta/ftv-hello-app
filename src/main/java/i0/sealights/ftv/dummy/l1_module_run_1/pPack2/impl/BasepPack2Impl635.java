...
public class BasepPack2Impl635 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl635.class);
    private static BasepPack2Impl635 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl635 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl635();
        }
        return INSTANCE;
    }

    private BasepPack2Impl635(){
