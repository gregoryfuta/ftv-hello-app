...
public class ComplexpPack2Impl917 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl917.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl917 INSTANCE;

    public static ComplexpPack2Impl917 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl917();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl917(){
