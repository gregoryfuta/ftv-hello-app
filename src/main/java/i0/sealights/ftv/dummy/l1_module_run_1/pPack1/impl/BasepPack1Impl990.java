...
public class BasepPack1Impl990 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl990.class);
    private static BasepPack1Impl990 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl990 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl990();
        }
        return INSTANCE;
    }

    private BasepPack1Impl990(){
