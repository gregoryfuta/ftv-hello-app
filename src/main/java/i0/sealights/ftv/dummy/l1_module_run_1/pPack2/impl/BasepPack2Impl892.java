...
public class BasepPack2Impl892 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl892.class);
    private static BasepPack2Impl892 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl892 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl892();
        }
        return INSTANCE;
    }

    private BasepPack2Impl892(){
