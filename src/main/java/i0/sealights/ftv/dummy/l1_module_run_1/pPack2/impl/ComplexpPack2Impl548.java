...
public class ComplexpPack2Impl548 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl548.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl548 INSTANCE;

    public static ComplexpPack2Impl548 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl548();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl548(){
