...
public class ComplexpPack1Impl258 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl258.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl258 INSTANCE;

    public static ComplexpPack1Impl258 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl258();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl258(){
