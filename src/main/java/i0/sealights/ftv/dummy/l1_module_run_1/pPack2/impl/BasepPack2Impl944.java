...
public class BasepPack2Impl944 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl944.class);
    private static BasepPack2Impl944 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl944 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl944();
        }
        return INSTANCE;
    }

    private BasepPack2Impl944(){
