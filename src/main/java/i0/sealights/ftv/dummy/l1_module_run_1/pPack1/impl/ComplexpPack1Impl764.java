...
public class ComplexpPack1Impl764 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl764.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl764 INSTANCE;

    public static ComplexpPack1Impl764 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl764();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl764(){
