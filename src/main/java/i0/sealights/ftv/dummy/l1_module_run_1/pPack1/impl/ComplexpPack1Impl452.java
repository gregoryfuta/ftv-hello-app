...
public class ComplexpPack1Impl452 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl452.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl452 INSTANCE;

    public static ComplexpPack1Impl452 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl452();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl452(){
