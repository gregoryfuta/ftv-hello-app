...
public class BasepPack2Impl424 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl424.class);
    private static BasepPack2Impl424 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl424 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl424();
        }
        return INSTANCE;
    }

    private BasepPack2Impl424(){
