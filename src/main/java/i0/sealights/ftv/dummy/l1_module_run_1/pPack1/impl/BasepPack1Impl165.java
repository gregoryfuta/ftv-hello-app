...
public class BasepPack1Impl165 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl165.class);
    private static BasepPack1Impl165 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl165 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl165();
        }
        return INSTANCE;
    }

    private BasepPack1Impl165(){
