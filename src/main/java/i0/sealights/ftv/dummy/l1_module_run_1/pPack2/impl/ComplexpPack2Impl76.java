...
public class ComplexpPack2Impl76 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl76.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl76 INSTANCE;

    public static ComplexpPack2Impl76 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl76();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl76(){
