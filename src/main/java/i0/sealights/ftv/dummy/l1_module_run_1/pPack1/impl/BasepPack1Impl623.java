...
public class BasepPack1Impl623 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl623.class);
    private static BasepPack1Impl623 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl623 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl623();
        }
        return INSTANCE;
    }

    private BasepPack1Impl623(){
