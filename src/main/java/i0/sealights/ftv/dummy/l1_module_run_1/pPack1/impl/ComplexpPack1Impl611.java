...
public class ComplexpPack1Impl611 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl611.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl611 INSTANCE;

    public static ComplexpPack1Impl611 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl611();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl611(){
