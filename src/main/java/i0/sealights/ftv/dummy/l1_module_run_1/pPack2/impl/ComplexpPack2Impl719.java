...
public class ComplexpPack2Impl719 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl719.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl719 INSTANCE;

    public static ComplexpPack2Impl719 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl719();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl719(){
