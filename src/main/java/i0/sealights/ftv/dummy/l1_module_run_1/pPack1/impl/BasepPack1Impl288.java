...
public class BasepPack1Impl288 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl288.class);
    private static BasepPack1Impl288 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl288 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl288();
        }
        return INSTANCE;
    }

    private BasepPack1Impl288(){
