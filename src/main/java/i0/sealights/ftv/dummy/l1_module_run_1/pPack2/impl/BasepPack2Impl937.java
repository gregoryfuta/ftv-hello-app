...
public class BasepPack2Impl937 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl937.class);
    private static BasepPack2Impl937 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl937 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl937();
        }
        return INSTANCE;
    }

    private BasepPack2Impl937(){
