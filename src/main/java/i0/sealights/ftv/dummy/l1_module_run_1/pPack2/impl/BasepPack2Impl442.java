...
public class BasepPack2Impl442 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl442.class);
    private static BasepPack2Impl442 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl442 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl442();
        }
        return INSTANCE;
    }

    private BasepPack2Impl442(){
