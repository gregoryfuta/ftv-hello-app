...
public class ComplexpPack1Impl660 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl660.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl660 INSTANCE;

    public static ComplexpPack1Impl660 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl660();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl660(){
