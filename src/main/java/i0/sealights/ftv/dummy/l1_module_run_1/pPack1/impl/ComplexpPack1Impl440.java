...
public class ComplexpPack1Impl440 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl440.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl440 INSTANCE;

    public static ComplexpPack1Impl440 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl440();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl440(){
