...
public class BasepPack1Impl376 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl376.class);
    private static BasepPack1Impl376 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl376 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl376();
        }
        return INSTANCE;
    }

    private BasepPack1Impl376(){
