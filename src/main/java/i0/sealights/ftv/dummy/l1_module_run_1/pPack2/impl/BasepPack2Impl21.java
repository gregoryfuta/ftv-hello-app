...
public class BasepPack2Impl21 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl21.class);
    private static BasepPack2Impl21 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl21 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl21();
        }
        return INSTANCE;
    }

    private BasepPack2Impl21(){
