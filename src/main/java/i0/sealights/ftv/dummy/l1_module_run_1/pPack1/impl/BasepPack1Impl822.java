...
public class BasepPack1Impl822 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl822.class);
    private static BasepPack1Impl822 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl822 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl822();
        }
        return INSTANCE;
    }

    private BasepPack1Impl822(){
