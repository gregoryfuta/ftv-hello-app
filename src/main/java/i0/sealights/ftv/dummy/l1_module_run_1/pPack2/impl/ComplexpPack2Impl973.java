...
public class ComplexpPack2Impl973 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl973.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl973 INSTANCE;

    public static ComplexpPack2Impl973 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl973();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl973(){
