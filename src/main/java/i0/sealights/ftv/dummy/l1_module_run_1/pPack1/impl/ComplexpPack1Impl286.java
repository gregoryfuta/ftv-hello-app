...
public class ComplexpPack1Impl286 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl286.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl286 INSTANCE;

    public static ComplexpPack1Impl286 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl286();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl286(){
