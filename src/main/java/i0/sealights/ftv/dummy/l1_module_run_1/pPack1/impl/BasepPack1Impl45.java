...
public class BasepPack1Impl45 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl45.class);
    private static BasepPack1Impl45 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl45 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl45();
        }
        return INSTANCE;
    }

    private BasepPack1Impl45(){
