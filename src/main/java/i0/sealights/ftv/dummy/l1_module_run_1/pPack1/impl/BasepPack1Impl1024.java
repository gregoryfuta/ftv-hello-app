...
public class BasepPack1Impl1024 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1024.class);
    private static BasepPack1Impl1024 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1024 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1024();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1024(){
