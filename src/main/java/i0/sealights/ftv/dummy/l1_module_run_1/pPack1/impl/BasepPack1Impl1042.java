...
public class BasepPack1Impl1042 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1042.class);
    private static BasepPack1Impl1042 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1042 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1042();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1042(){
