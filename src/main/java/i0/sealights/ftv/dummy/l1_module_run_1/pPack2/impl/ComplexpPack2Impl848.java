...
public class ComplexpPack2Impl848 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl848.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl848 INSTANCE;

    public static ComplexpPack2Impl848 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl848();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl848(){
