...
public class ComplexpPack2Impl336 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl336.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl336 INSTANCE;

    public static ComplexpPack2Impl336 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl336();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl336(){
