...
public class ComplexpPack1Impl336 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl336.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl336 INSTANCE;

    public static ComplexpPack1Impl336 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl336();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl336(){
