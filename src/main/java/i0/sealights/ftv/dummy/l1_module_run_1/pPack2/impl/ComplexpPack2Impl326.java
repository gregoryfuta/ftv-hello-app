...
public class ComplexpPack2Impl326 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl326.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl326 INSTANCE;

    public static ComplexpPack2Impl326 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl326();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl326(){
