...
public class BasepPack2Impl229 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl229.class);
    private static BasepPack2Impl229 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl229 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl229();
        }
        return INSTANCE;
    }

    private BasepPack2Impl229(){
