...
public class BasepPack1Impl837 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl837.class);
    private static BasepPack1Impl837 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl837 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl837();
        }
        return INSTANCE;
    }

    private BasepPack1Impl837(){
