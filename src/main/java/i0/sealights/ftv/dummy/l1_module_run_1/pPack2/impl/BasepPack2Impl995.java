...
public class BasepPack2Impl995 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl995.class);
    private static BasepPack2Impl995 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl995 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl995();
        }
        return INSTANCE;
    }

    private BasepPack2Impl995(){
