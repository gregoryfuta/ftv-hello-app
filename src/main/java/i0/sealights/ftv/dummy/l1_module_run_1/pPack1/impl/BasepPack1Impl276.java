...
public class BasepPack1Impl276 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl276.class);
    private static BasepPack1Impl276 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl276 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl276();
        }
        return INSTANCE;
    }

    private BasepPack1Impl276(){
