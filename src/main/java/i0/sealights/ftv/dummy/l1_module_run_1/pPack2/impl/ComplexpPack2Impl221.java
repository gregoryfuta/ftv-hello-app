...
public class ComplexpPack2Impl221 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl221.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl221 INSTANCE;

    public static ComplexpPack2Impl221 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl221();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl221(){
