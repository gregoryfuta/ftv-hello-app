...
public class ComplexpPack1Impl878 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl878.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl878 INSTANCE;

    public static ComplexpPack1Impl878 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl878();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl878(){
