...
public class ComplexpPack2Impl801 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl801.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl801 INSTANCE;

    public static ComplexpPack2Impl801 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl801();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl801(){
