...
public class ComplexpPack1Impl174 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl174.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl174 INSTANCE;

    public static ComplexpPack1Impl174 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl174();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl174(){
