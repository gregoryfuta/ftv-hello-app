...
public class BasepPack1Impl39 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl39.class);
    private static BasepPack1Impl39 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl39 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl39();
        }
        return INSTANCE;
    }

    private BasepPack1Impl39(){
