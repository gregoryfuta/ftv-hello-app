...
public class BasepPack1Impl5 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl5.class);
    private static BasepPack1Impl5 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl5 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl5();
        }
        return INSTANCE;
    }

    private BasepPack1Impl5(){
