...
public class ComplexpPack1Impl1019 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1019.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1019 INSTANCE;

    public static ComplexpPack1Impl1019 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1019();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1019(){
