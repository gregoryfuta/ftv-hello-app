...
public class ComplexpPack2Impl80 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl80.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl80 INSTANCE;

    public static ComplexpPack2Impl80 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl80();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl80(){
