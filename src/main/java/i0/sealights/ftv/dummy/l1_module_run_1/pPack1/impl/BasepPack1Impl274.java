...
public class BasepPack1Impl274 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl274.class);
    private static BasepPack1Impl274 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl274 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl274();
        }
        return INSTANCE;
    }

    private BasepPack1Impl274(){
