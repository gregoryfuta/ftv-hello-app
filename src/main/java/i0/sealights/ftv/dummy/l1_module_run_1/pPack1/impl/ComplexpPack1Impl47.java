...
public class ComplexpPack1Impl47 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl47.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl47 INSTANCE;

    public static ComplexpPack1Impl47 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl47();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl47(){
