...
public class ComplexpPack1Impl371 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl371.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl371 INSTANCE;

    public static ComplexpPack1Impl371 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl371();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl371(){
