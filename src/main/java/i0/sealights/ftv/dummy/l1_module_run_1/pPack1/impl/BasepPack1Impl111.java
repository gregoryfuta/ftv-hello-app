...
public class BasepPack1Impl111 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl111.class);
    private static BasepPack1Impl111 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl111 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl111();
        }
        return INSTANCE;
    }

    private BasepPack1Impl111(){
