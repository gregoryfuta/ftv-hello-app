...
public class ComplexpPack2Impl957 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl957.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl957 INSTANCE;

    public static ComplexpPack2Impl957 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl957();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl957(){
