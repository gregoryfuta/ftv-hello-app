...
public class ComplexpPack1Impl748 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl748.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl748 INSTANCE;

    public static ComplexpPack1Impl748 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl748();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl748(){
