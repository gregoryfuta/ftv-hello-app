...
public class ComplexpPack2Impl902 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl902.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl902 INSTANCE;

    public static ComplexpPack2Impl902 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl902();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl902(){
