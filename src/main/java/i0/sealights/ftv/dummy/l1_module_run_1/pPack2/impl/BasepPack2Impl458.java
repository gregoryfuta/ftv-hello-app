...
public class BasepPack2Impl458 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl458.class);
    private static BasepPack2Impl458 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl458 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl458();
        }
        return INSTANCE;
    }

    private BasepPack2Impl458(){
