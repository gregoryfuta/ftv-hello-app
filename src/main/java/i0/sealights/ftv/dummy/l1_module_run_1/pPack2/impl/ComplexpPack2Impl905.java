...
public class ComplexpPack2Impl905 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl905.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl905 INSTANCE;

    public static ComplexpPack2Impl905 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl905();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl905(){
