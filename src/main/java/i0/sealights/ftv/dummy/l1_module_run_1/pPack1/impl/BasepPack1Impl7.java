...
public class BasepPack1Impl7 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl7.class);
    private static BasepPack1Impl7 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl7 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl7();
        }
        return INSTANCE;
    }

    private BasepPack1Impl7(){
