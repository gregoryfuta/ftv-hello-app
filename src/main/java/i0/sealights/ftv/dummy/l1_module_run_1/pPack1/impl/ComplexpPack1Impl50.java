...
public class ComplexpPack1Impl50 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl50.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl50 INSTANCE;

    public static ComplexpPack1Impl50 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl50();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl50(){
