...
public class BasepPack1Impl550 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl550.class);
    private static BasepPack1Impl550 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl550 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl550();
        }
        return INSTANCE;
    }

    private BasepPack1Impl550(){
