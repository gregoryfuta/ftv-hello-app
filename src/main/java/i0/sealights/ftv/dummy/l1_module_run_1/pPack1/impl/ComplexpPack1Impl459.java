...
public class ComplexpPack1Impl459 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl459.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl459 INSTANCE;

    public static ComplexpPack1Impl459 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl459();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl459(){
