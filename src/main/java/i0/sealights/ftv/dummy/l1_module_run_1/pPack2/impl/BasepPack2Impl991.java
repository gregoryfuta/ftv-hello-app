...
public class BasepPack2Impl991 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl991.class);
    private static BasepPack2Impl991 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl991 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl991();
        }
        return INSTANCE;
    }

    private BasepPack2Impl991(){
