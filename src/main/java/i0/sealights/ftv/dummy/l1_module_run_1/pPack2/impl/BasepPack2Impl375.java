...
public class BasepPack2Impl375 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl375.class);
    private static BasepPack2Impl375 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl375 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl375();
        }
        return INSTANCE;
    }

    private BasepPack2Impl375(){
