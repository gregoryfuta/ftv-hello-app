...
public class BasepPack2Impl610 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl610.class);
    private static BasepPack2Impl610 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl610 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl610();
        }
        return INSTANCE;
    }

    private BasepPack2Impl610(){
