...
public class BasepPack2Impl515 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl515.class);
    private static BasepPack2Impl515 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl515 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl515();
        }
        return INSTANCE;
    }

    private BasepPack2Impl515(){
