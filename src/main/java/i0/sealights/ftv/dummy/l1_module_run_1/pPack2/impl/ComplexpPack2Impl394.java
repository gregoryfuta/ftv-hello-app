...
public class ComplexpPack2Impl394 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl394.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl394 INSTANCE;

    public static ComplexpPack2Impl394 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl394();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl394(){
