...
public class ComplexpPack1Impl353 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl353.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl353 INSTANCE;

    public static ComplexpPack1Impl353 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl353();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl353(){
