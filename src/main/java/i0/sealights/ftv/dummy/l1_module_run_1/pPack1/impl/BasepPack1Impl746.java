...
public class BasepPack1Impl746 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl746.class);
    private static BasepPack1Impl746 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl746 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl746();
        }
        return INSTANCE;
    }

    private BasepPack1Impl746(){
