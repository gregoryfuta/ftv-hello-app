...
public class ComplexpPack2Impl682 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl682.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl682 INSTANCE;

    public static ComplexpPack2Impl682 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl682();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl682(){
