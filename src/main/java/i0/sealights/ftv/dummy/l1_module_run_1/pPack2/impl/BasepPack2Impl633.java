...
public class BasepPack2Impl633 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl633.class);
    private static BasepPack2Impl633 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl633 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl633();
        }
        return INSTANCE;
    }

    private BasepPack2Impl633(){
