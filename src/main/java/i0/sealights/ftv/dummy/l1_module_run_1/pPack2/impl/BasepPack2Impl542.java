...
public class BasepPack2Impl542 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl542.class);
    private static BasepPack2Impl542 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl542 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl542();
        }
        return INSTANCE;
    }

    private BasepPack2Impl542(){
