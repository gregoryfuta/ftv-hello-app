...
public class ComplexpPack1Impl941 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl941.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl941 INSTANCE;

    public static ComplexpPack1Impl941 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl941();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl941(){
