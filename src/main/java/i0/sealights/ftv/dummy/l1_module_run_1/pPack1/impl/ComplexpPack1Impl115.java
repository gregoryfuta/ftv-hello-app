...
public class ComplexpPack1Impl115 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl115.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl115 INSTANCE;

    public static ComplexpPack1Impl115 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl115();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl115(){
