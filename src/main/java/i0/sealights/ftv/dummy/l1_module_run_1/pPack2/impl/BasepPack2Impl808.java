...
public class BasepPack2Impl808 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl808.class);
    private static BasepPack2Impl808 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl808 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl808();
        }
        return INSTANCE;
    }

    private BasepPack2Impl808(){
