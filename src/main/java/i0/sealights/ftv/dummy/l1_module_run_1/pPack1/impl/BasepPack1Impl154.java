...
public class BasepPack1Impl154 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl154.class);
    private static BasepPack1Impl154 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl154 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl154();
        }
        return INSTANCE;
    }

    private BasepPack1Impl154(){
