...
public class ComplexpPack2Impl366 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl366.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl366 INSTANCE;

    public static ComplexpPack2Impl366 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl366();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl366(){
