...
public class ComplexpPack2Impl850 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl850.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl850 INSTANCE;

    public static ComplexpPack2Impl850 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl850();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl850(){
