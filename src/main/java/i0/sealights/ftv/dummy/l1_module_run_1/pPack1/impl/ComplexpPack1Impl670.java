...
public class ComplexpPack1Impl670 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl670.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl670 INSTANCE;

    public static ComplexpPack1Impl670 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl670();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl670(){
