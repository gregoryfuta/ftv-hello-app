...
public class ComplexpPack2Impl720 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl720.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl720 INSTANCE;

    public static ComplexpPack2Impl720 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl720();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl720(){
