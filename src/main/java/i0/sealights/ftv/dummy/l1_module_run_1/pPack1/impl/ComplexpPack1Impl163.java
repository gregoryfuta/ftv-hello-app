...
public class ComplexpPack1Impl163 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl163.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl163 INSTANCE;

    public static ComplexpPack1Impl163 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl163();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl163(){
