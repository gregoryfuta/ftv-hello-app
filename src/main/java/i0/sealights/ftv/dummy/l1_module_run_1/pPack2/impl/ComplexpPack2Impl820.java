...
public class ComplexpPack2Impl820 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl820.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl820 INSTANCE;

    public static ComplexpPack2Impl820 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl820();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl820(){
