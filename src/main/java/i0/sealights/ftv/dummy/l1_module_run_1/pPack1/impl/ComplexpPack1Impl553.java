...
public class ComplexpPack1Impl553 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl553.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl553 INSTANCE;

    public static ComplexpPack1Impl553 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl553();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl553(){
