...
public class BasepPack1Impl149 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl149.class);
    private static BasepPack1Impl149 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl149 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl149();
        }
        return INSTANCE;
    }

    private BasepPack1Impl149(){
