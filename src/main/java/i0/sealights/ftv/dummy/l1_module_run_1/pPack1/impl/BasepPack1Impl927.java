...
public class BasepPack1Impl927 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl927.class);
    private static BasepPack1Impl927 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl927 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl927();
        }
        return INSTANCE;
    }

    private BasepPack1Impl927(){
