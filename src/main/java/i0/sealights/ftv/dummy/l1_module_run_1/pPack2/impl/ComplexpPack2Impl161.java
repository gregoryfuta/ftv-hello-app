...
public class ComplexpPack2Impl161 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl161.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl161 INSTANCE;

    public static ComplexpPack2Impl161 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl161();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl161(){
