...
public class BasepPack2Impl506 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl506.class);
    private static BasepPack2Impl506 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl506 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl506();
        }
        return INSTANCE;
    }

    private BasepPack2Impl506(){
