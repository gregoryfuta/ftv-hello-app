...
public class BasepPack1Impl445 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl445.class);
    private static BasepPack1Impl445 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl445 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl445();
        }
        return INSTANCE;
    }

    private BasepPack1Impl445(){
