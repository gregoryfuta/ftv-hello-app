...
public class BasepPack2Impl100 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl100.class);
    private static BasepPack2Impl100 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl100 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl100();
        }
        return INSTANCE;
    }

    private BasepPack2Impl100(){
