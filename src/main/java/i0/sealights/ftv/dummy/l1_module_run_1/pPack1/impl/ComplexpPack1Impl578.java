...
public class ComplexpPack1Impl578 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl578.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl578 INSTANCE;

    public static ComplexpPack1Impl578 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl578();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl578(){
