...
public class ComplexpPack2Impl696 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl696.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl696 INSTANCE;

    public static ComplexpPack2Impl696 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl696();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl696(){
