...
public class ComplexpPack2Impl495 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl495.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl495 INSTANCE;

    public static ComplexpPack2Impl495 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl495();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl495(){
