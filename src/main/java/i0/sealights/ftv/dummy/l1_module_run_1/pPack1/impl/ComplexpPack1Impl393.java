...
public class ComplexpPack1Impl393 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl393.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl393 INSTANCE;

    public static ComplexpPack1Impl393 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl393();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl393(){
