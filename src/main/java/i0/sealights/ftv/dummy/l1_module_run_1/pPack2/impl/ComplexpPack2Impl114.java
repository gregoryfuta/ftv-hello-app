...
public class ComplexpPack2Impl114 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl114.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl114 INSTANCE;

    public static ComplexpPack2Impl114 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl114();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl114(){
