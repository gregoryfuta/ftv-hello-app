...
public class BasepPack2Impl981 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl981.class);
    private static BasepPack2Impl981 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl981 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl981();
        }
        return INSTANCE;
    }

    private BasepPack2Impl981(){
