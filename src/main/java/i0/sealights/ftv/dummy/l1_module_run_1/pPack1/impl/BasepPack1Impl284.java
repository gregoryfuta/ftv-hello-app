...
public class BasepPack1Impl284 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl284.class);
    private static BasepPack1Impl284 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl284 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl284();
        }
        return INSTANCE;
    }

    private BasepPack1Impl284(){
