...
public class BasepPack1Impl6 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl6.class);
    private static BasepPack1Impl6 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl6 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl6();
        }
        return INSTANCE;
    }

    private BasepPack1Impl6(){
