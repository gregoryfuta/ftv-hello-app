...
public class BasepPack2Impl191 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl191.class);
    private static BasepPack2Impl191 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl191 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl191();
        }
        return INSTANCE;
    }

    private BasepPack2Impl191(){
