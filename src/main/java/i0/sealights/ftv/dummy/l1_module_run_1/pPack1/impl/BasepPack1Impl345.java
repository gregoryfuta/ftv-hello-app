...
public class BasepPack1Impl345 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl345.class);
    private static BasepPack1Impl345 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl345 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl345();
        }
        return INSTANCE;
    }

    private BasepPack1Impl345(){
