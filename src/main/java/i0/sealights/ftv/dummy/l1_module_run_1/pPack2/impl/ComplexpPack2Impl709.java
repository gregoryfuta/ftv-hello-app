...
public class ComplexpPack2Impl709 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl709.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl709 INSTANCE;

    public static ComplexpPack2Impl709 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl709();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl709(){
