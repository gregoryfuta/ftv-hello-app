...
public class BasepPack1Impl407 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl407.class);
    private static BasepPack1Impl407 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl407 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl407();
        }
        return INSTANCE;
    }

    private BasepPack1Impl407(){
