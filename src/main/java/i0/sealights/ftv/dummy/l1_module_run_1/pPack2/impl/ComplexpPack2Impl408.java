...
public class ComplexpPack2Impl408 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl408.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl408 INSTANCE;

    public static ComplexpPack2Impl408 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl408();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl408(){
