...
public class ComplexpPack2Impl768 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl768.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl768 INSTANCE;

    public static ComplexpPack2Impl768 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl768();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl768(){
