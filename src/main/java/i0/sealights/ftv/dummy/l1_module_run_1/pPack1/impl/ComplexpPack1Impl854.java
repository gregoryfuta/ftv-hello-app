...
public class ComplexpPack1Impl854 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl854.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl854 INSTANCE;

    public static ComplexpPack1Impl854 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl854();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl854(){
