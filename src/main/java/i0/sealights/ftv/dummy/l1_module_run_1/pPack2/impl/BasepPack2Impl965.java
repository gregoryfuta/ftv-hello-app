...
public class BasepPack2Impl965 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl965.class);
    private static BasepPack2Impl965 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl965 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl965();
        }
        return INSTANCE;
    }

    private BasepPack2Impl965(){
