...
public class BasepPack1Impl690 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl690.class);
    private static BasepPack1Impl690 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl690 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl690();
        }
        return INSTANCE;
    }

    private BasepPack1Impl690(){
