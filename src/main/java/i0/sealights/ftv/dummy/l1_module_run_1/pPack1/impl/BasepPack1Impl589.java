...
public class BasepPack1Impl589 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl589.class);
    private static BasepPack1Impl589 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl589 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl589();
        }
        return INSTANCE;
    }

    private BasepPack1Impl589(){
