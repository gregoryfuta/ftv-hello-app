...
public class BasepPack1Impl726 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl726.class);
    private static BasepPack1Impl726 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl726 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl726();
        }
        return INSTANCE;
    }

    private BasepPack1Impl726(){
