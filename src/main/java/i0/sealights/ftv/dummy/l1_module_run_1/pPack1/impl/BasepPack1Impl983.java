...
public class BasepPack1Impl983 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl983.class);
    private static BasepPack1Impl983 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl983 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl983();
        }
        return INSTANCE;
    }

    private BasepPack1Impl983(){
