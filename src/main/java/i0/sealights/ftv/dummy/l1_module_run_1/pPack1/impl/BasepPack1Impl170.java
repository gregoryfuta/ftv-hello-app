...
public class BasepPack1Impl170 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl170.class);
    private static BasepPack1Impl170 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl170 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl170();
        }
        return INSTANCE;
    }

    private BasepPack1Impl170(){
