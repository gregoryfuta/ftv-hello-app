...
public class ComplexpPack1Impl833 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl833.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl833 INSTANCE;

    public static ComplexpPack1Impl833 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl833();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl833(){
