...
public class BasepPack2Impl484 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl484.class);
    private static BasepPack2Impl484 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl484 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl484();
        }
        return INSTANCE;
    }

    private BasepPack2Impl484(){
