...
public class BasepPack1Impl668 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl668.class);
    private static BasepPack1Impl668 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl668 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl668();
        }
        return INSTANCE;
    }

    private BasepPack1Impl668(){
