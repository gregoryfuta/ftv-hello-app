...
public class BasepPack2Impl637 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl637.class);
    private static BasepPack2Impl637 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl637 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl637();
        }
        return INSTANCE;
    }

    private BasepPack2Impl637(){
