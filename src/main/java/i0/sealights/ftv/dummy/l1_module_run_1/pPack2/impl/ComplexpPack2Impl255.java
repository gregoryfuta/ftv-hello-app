...
public class ComplexpPack2Impl255 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl255.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl255 INSTANCE;

    public static ComplexpPack2Impl255 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl255();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl255(){
