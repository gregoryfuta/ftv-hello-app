...
public class BasepPack2Impl679 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl679.class);
    private static BasepPack2Impl679 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl679 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl679();
        }
        return INSTANCE;
    }

    private BasepPack2Impl679(){
