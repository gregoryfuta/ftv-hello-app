...
public class BasepPack2Impl712 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl712.class);
    private static BasepPack2Impl712 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl712 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl712();
        }
        return INSTANCE;
    }

    private BasepPack2Impl712(){
