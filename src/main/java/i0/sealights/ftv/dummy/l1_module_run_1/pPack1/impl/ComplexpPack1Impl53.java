...
public class ComplexpPack1Impl53 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl53.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl53 INSTANCE;

    public static ComplexpPack1Impl53 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl53();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl53(){
