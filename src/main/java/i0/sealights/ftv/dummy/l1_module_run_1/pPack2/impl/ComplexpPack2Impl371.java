...
public class ComplexpPack2Impl371 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl371.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl371 INSTANCE;

    public static ComplexpPack2Impl371 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl371();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl371(){
