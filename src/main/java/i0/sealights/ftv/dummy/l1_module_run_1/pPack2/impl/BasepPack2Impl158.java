...
public class BasepPack2Impl158 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl158.class);
    private static BasepPack2Impl158 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl158 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl158();
        }
        return INSTANCE;
    }

    private BasepPack2Impl158(){
