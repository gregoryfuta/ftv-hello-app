...
public class ComplexpPack2Impl412 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl412.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl412 INSTANCE;

    public static ComplexpPack2Impl412 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl412();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl412(){
