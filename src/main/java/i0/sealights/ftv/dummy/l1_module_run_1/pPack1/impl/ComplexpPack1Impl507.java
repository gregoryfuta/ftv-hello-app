...
public class ComplexpPack1Impl507 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl507.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl507 INSTANCE;

    public static ComplexpPack1Impl507 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl507();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl507(){
