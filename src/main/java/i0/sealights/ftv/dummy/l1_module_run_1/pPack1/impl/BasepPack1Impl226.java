...
public class BasepPack1Impl226 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl226.class);
    private static BasepPack1Impl226 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl226 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl226();
        }
        return INSTANCE;
    }

    private BasepPack1Impl226(){
