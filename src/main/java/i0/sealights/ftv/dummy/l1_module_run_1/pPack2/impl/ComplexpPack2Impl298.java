...
public class ComplexpPack2Impl298 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl298.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl298 INSTANCE;

    public static ComplexpPack2Impl298 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl298();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl298(){
