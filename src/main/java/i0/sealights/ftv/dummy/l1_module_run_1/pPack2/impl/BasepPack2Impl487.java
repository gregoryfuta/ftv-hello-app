...
public class BasepPack2Impl487 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl487.class);
    private static BasepPack2Impl487 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl487 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl487();
        }
        return INSTANCE;
    }

    private BasepPack2Impl487(){
