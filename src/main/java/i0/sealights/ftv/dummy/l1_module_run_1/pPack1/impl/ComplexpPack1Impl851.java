...
public class ComplexpPack1Impl851 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl851.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl851 INSTANCE;

    public static ComplexpPack1Impl851 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl851();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl851(){
