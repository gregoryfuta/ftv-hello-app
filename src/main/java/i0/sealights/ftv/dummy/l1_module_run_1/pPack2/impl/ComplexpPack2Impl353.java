...
public class ComplexpPack2Impl353 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl353.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl353 INSTANCE;

    public static ComplexpPack2Impl353 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl353();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl353(){
