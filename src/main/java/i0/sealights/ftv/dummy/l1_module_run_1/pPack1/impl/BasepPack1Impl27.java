...
public class BasepPack1Impl27 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl27.class);
    private static BasepPack1Impl27 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl27 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl27();
        }
        return INSTANCE;
    }

    private BasepPack1Impl27(){
