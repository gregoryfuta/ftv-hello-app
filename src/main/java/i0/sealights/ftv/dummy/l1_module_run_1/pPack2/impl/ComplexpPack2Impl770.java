...
public class ComplexpPack2Impl770 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl770.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl770 INSTANCE;

    public static ComplexpPack2Impl770 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl770();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl770(){
