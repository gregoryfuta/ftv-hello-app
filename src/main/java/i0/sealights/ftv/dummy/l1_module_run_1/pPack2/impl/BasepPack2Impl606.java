...
public class BasepPack2Impl606 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl606.class);
    private static BasepPack2Impl606 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl606 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl606();
        }
        return INSTANCE;
    }

    private BasepPack2Impl606(){
