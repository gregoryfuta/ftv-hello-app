...
public class ComplexpPack2Impl415 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl415.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl415 INSTANCE;

    public static ComplexpPack2Impl415 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl415();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl415(){
