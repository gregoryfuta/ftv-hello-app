...
public class BasepPack2Impl999 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl999.class);
    private static BasepPack2Impl999 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl999 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl999();
        }
        return INSTANCE;
    }

    private BasepPack2Impl999(){
