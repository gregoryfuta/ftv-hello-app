...
public class BasepPack2Impl677 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl677.class);
    private static BasepPack2Impl677 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl677 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl677();
        }
        return INSTANCE;
    }

    private BasepPack2Impl677(){
