...
public class ComplexpPack1Impl319 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl319.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl319 INSTANCE;

    public static ComplexpPack1Impl319 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl319();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl319(){
