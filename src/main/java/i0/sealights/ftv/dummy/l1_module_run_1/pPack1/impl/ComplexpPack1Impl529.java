...
public class ComplexpPack1Impl529 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl529.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl529 INSTANCE;

    public static ComplexpPack1Impl529 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl529();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl529(){
