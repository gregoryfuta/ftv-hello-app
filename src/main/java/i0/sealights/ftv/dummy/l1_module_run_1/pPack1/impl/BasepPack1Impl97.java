...
public class BasepPack1Impl97 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl97.class);
    private static BasepPack1Impl97 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl97 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl97();
        }
        return INSTANCE;
    }

    private BasepPack1Impl97(){
