...
public class BasepPack2Impl958 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl958.class);
    private static BasepPack2Impl958 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl958 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl958();
        }
        return INSTANCE;
    }

    private BasepPack2Impl958(){
