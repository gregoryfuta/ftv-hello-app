...
public class BasepPack2Impl291 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl291.class);
    private static BasepPack2Impl291 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl291 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl291();
        }
        return INSTANCE;
    }

    private BasepPack2Impl291(){
