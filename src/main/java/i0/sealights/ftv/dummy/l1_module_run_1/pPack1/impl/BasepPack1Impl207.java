...
public class BasepPack1Impl207 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl207.class);
    private static BasepPack1Impl207 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl207 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl207();
        }
        return INSTANCE;
    }

    private BasepPack1Impl207(){
