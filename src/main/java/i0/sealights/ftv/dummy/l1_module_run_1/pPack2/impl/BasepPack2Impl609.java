...
public class BasepPack2Impl609 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl609.class);
    private static BasepPack2Impl609 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl609 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl609();
        }
        return INSTANCE;
    }

    private BasepPack2Impl609(){
