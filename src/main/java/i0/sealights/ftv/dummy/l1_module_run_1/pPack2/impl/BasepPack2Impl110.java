...
public class BasepPack2Impl110 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl110.class);
    private static BasepPack2Impl110 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl110 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl110();
        }
        return INSTANCE;
    }

    private BasepPack2Impl110(){
