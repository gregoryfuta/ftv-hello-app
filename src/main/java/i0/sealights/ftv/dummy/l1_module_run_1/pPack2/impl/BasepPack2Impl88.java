...
public class BasepPack2Impl88 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl88.class);
    private static BasepPack2Impl88 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl88 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl88();
        }
        return INSTANCE;
    }

    private BasepPack2Impl88(){
