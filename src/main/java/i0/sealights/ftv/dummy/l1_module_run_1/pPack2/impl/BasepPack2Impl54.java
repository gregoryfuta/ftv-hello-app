...
public class BasepPack2Impl54 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl54.class);
    private static BasepPack2Impl54 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl54 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl54();
        }
        return INSTANCE;
    }

    private BasepPack2Impl54(){
