...
public class ComplexpPack1Impl177 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl177.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl177 INSTANCE;

    public static ComplexpPack1Impl177 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl177();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl177(){
