...
public class BasepPack1Impl327 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl327.class);
    private static BasepPack1Impl327 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl327 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl327();
        }
        return INSTANCE;
    }

    private BasepPack1Impl327(){
