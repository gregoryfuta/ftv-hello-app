...
public class ComplexpPack2Impl346 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl346.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl346 INSTANCE;

    public static ComplexpPack2Impl346 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl346();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl346(){
