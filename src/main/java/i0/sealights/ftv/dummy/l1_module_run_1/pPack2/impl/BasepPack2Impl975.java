...
public class BasepPack2Impl975 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl975.class);
    private static BasepPack2Impl975 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl975 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl975();
        }
        return INSTANCE;
    }

    private BasepPack2Impl975(){
