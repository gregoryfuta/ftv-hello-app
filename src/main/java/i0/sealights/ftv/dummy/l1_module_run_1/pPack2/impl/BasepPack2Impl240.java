...
public class BasepPack2Impl240 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl240.class);
    private static BasepPack2Impl240 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl240 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl240();
        }
        return INSTANCE;
    }

    private BasepPack2Impl240(){
