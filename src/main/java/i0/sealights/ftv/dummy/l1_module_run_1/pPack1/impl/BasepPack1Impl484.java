...
public class BasepPack1Impl484 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl484.class);
    private static BasepPack1Impl484 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl484 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl484();
        }
        return INSTANCE;
    }

    private BasepPack1Impl484(){
