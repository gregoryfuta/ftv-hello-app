...
public class BasepPack1Impl987 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl987.class);
    private static BasepPack1Impl987 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl987 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl987();
        }
        return INSTANCE;
    }

    private BasepPack1Impl987(){
