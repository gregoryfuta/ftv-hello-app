...
public class BasepPack1Impl64 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl64.class);
    private static BasepPack1Impl64 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl64 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl64();
        }
        return INSTANCE;
    }

    private BasepPack1Impl64(){
