...
public class ComplexpPack2Impl858 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl858.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl858 INSTANCE;

    public static ComplexpPack2Impl858 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl858();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl858(){
