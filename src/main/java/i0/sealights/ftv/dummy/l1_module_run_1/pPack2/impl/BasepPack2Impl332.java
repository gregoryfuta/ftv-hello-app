...
public class BasepPack2Impl332 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl332.class);
    private static BasepPack2Impl332 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl332 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl332();
        }
        return INSTANCE;
    }

    private BasepPack2Impl332(){
