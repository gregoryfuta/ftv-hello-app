...
public class BasepPack2Impl596 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl596.class);
    private static BasepPack2Impl596 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl596 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl596();
        }
        return INSTANCE;
    }

    private BasepPack2Impl596(){
