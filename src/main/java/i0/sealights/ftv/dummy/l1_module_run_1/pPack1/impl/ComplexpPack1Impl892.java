...
public class ComplexpPack1Impl892 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl892.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl892 INSTANCE;

    public static ComplexpPack1Impl892 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl892();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl892(){
