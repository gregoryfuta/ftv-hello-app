...
public class ComplexpPack2Impl1060 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1060.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1060 INSTANCE;

    public static ComplexpPack2Impl1060 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1060();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1060(){
