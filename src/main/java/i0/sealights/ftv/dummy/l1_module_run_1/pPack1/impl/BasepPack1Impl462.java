...
public class BasepPack1Impl462 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl462.class);
    private static BasepPack1Impl462 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl462 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl462();
        }
        return INSTANCE;
    }

    private BasepPack1Impl462(){
