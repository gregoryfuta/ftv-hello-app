...
public class BasepPack2Impl120 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl120.class);
    private static BasepPack2Impl120 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl120 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl120();
        }
        return INSTANCE;
    }

    private BasepPack2Impl120(){
