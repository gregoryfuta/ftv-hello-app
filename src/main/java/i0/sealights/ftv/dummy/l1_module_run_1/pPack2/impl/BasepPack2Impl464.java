...
public class BasepPack2Impl464 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl464.class);
    private static BasepPack2Impl464 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl464 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl464();
        }
        return INSTANCE;
    }

    private BasepPack2Impl464(){
