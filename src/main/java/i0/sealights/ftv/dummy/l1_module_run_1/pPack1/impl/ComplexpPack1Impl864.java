...
public class ComplexpPack1Impl864 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl864.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl864 INSTANCE;

    public static ComplexpPack1Impl864 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl864();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl864(){
