...
public class BasepPack2Impl310 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl310.class);
    private static BasepPack2Impl310 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl310 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl310();
        }
        return INSTANCE;
    }

    private BasepPack2Impl310(){
