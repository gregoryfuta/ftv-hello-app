...
public class BasepPack1Impl378 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl378.class);
    private static BasepPack1Impl378 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl378 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl378();
        }
        return INSTANCE;
    }

    private BasepPack1Impl378(){
