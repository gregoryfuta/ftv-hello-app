...
public class BasepPack1Impl68 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl68.class);
    private static BasepPack1Impl68 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl68 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl68();
        }
        return INSTANCE;
    }

    private BasepPack1Impl68(){
