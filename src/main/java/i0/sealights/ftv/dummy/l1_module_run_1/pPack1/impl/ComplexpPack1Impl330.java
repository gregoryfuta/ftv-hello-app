...
public class ComplexpPack1Impl330 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl330.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl330 INSTANCE;

    public static ComplexpPack1Impl330 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl330();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl330(){
