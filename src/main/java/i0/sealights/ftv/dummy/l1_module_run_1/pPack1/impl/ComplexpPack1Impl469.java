...
public class ComplexpPack1Impl469 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl469.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl469 INSTANCE;

    public static ComplexpPack1Impl469 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl469();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl469(){
