...
public class ComplexpPack1Impl350 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl350.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl350 INSTANCE;

    public static ComplexpPack1Impl350 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl350();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl350(){
