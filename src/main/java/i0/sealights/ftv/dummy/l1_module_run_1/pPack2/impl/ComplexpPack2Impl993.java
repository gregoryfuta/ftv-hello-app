...
public class ComplexpPack2Impl993 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl993.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl993 INSTANCE;

    public static ComplexpPack2Impl993 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl993();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl993(){
