...
public class BasepPack2Impl485 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl485.class);
    private static BasepPack2Impl485 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl485 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl485();
        }
        return INSTANCE;
    }

    private BasepPack2Impl485(){
