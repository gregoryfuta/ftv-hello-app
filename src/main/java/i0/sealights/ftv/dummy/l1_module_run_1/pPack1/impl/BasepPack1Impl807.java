...
public class BasepPack1Impl807 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl807.class);
    private static BasepPack1Impl807 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl807 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl807();
        }
        return INSTANCE;
    }

    private BasepPack1Impl807(){
