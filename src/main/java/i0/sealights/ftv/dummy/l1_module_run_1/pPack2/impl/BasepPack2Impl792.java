...
public class BasepPack2Impl792 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl792.class);
    private static BasepPack2Impl792 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl792 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl792();
        }
        return INSTANCE;
    }

    private BasepPack2Impl792(){
