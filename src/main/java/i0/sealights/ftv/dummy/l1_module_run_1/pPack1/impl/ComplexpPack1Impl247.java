...
public class ComplexpPack1Impl247 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl247.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl247 INSTANCE;

    public static ComplexpPack1Impl247 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl247();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl247(){
