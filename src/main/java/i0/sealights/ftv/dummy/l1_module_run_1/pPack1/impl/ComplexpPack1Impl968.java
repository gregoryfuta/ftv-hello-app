...
public class ComplexpPack1Impl968 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl968.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl968 INSTANCE;

    public static ComplexpPack1Impl968 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl968();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl968(){
