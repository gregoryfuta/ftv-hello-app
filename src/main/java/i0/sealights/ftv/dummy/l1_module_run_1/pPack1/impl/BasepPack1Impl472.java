...
public class BasepPack1Impl472 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl472.class);
    private static BasepPack1Impl472 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl472 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl472();
        }
        return INSTANCE;
    }

    private BasepPack1Impl472(){
