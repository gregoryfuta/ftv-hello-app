...
public class BasepPack2Impl420 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl420.class);
    private static BasepPack2Impl420 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl420 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl420();
        }
        return INSTANCE;
    }

    private BasepPack2Impl420(){
