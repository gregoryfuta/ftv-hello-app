...
public class ComplexpPack2Impl245 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl245.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl245 INSTANCE;

    public static ComplexpPack2Impl245 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl245();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl245(){
