...
public class BasepPack1Impl524 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl524.class);
    private static BasepPack1Impl524 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl524 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl524();
        }
        return INSTANCE;
    }

    private BasepPack1Impl524(){
