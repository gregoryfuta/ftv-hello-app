...
public class BasepPack1Impl725 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl725.class);
    private static BasepPack1Impl725 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl725 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl725();
        }
        return INSTANCE;
    }

    private BasepPack1Impl725(){
