...
public class ComplexpPack2Impl666 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl666.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl666 INSTANCE;

    public static ComplexpPack2Impl666 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl666();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl666(){
