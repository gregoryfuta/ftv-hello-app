...
public class ComplexpPack2Impl101 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl101.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl101 INSTANCE;

    public static ComplexpPack2Impl101 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl101();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl101(){
