...
public class ComplexpPack1Impl198 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl198.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl198 INSTANCE;

    public static ComplexpPack1Impl198 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl198();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl198(){
