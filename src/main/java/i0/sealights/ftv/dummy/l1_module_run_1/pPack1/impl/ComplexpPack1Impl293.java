...
public class ComplexpPack1Impl293 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl293.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl293 INSTANCE;

    public static ComplexpPack1Impl293 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl293();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl293(){
