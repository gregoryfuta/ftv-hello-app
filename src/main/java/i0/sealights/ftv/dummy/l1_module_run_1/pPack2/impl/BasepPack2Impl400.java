...
public class BasepPack2Impl400 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl400.class);
    private static BasepPack2Impl400 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl400 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl400();
        }
        return INSTANCE;
    }

    private BasepPack2Impl400(){
