...
public class ComplexpPack2Impl437 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl437.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl437 INSTANCE;

    public static ComplexpPack2Impl437 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl437();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl437(){
