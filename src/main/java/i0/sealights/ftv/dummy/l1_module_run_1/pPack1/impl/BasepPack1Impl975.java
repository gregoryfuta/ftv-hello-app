...
public class BasepPack1Impl975 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl975.class);
    private static BasepPack1Impl975 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl975 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl975();
        }
        return INSTANCE;
    }

    private BasepPack1Impl975(){
