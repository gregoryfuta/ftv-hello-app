...
public class BasepPack2Impl676 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl676.class);
    private static BasepPack2Impl676 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl676 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl676();
        }
        return INSTANCE;
    }

    private BasepPack2Impl676(){
