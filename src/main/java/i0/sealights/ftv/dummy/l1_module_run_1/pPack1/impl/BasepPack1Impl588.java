...
public class BasepPack1Impl588 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl588.class);
    private static BasepPack1Impl588 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl588 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl588();
        }
        return INSTANCE;
    }

    private BasepPack1Impl588(){
