...
public class BasepPack1Impl979 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl979.class);
    private static BasepPack1Impl979 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl979 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl979();
        }
        return INSTANCE;
    }

    private BasepPack1Impl979(){
