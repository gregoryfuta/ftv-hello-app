...
public class BasepPack1Impl814 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl814.class);
    private static BasepPack1Impl814 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl814 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl814();
        }
        return INSTANCE;
    }

    private BasepPack1Impl814(){
