...
public class BasepPack2Impl869 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl869.class);
    private static BasepPack2Impl869 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl869 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl869();
        }
        return INSTANCE;
    }

    private BasepPack2Impl869(){
