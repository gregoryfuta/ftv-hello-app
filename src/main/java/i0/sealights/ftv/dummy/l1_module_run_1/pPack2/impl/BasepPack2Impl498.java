...
public class BasepPack2Impl498 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl498.class);
    private static BasepPack2Impl498 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl498 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl498();
        }
        return INSTANCE;
    }

    private BasepPack2Impl498(){
