...
public class ComplexpPack1Impl768 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl768.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl768 INSTANCE;

    public static ComplexpPack1Impl768 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl768();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl768(){
