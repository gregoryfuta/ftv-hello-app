...
public class BasepPack1Impl644 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl644.class);
    private static BasepPack1Impl644 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl644 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl644();
        }
        return INSTANCE;
    }

    private BasepPack1Impl644(){
