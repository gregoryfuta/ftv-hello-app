...
public class BasepPack1Impl98 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl98.class);
    private static BasepPack1Impl98 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl98 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl98();
        }
        return INSTANCE;
    }

    private BasepPack1Impl98(){
