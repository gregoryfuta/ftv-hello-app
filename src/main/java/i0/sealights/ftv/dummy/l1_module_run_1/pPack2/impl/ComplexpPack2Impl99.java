...
public class ComplexpPack2Impl99 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl99.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl99 INSTANCE;

    public static ComplexpPack2Impl99 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl99();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl99(){
