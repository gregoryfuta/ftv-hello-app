...
public class ComplexpPack1Impl460 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl460.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl460 INSTANCE;

    public static ComplexpPack1Impl460 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl460();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl460(){
