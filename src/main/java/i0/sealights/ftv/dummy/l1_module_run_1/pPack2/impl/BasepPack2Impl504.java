...
public class BasepPack2Impl504 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl504.class);
    private static BasepPack2Impl504 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl504 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl504();
        }
        return INSTANCE;
    }

    private BasepPack2Impl504(){
