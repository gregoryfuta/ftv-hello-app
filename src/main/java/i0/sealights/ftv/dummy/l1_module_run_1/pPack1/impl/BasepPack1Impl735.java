...
public class BasepPack1Impl735 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl735.class);
    private static BasepPack1Impl735 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl735 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl735();
        }
        return INSTANCE;
    }

    private BasepPack1Impl735(){
