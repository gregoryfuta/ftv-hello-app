...
public class BasepPack1Impl809 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl809.class);
    private static BasepPack1Impl809 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl809 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl809();
        }
        return INSTANCE;
    }

    private BasepPack1Impl809(){
