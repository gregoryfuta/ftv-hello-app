...
public class BasepPack2Impl914 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl914.class);
    private static BasepPack2Impl914 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl914 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl914();
        }
        return INSTANCE;
    }

    private BasepPack2Impl914(){
