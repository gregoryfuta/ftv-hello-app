...
public class ComplexpPack2Impl843 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl843.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl843 INSTANCE;

    public static ComplexpPack2Impl843 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl843();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl843(){
