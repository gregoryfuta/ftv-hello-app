...
public class BasepPack2Impl340 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl340.class);
    private static BasepPack2Impl340 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl340 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl340();
        }
        return INSTANCE;
    }

    private BasepPack2Impl340(){
