...
public class BasepPack1Impl179 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl179.class);
    private static BasepPack1Impl179 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl179 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl179();
        }
        return INSTANCE;
    }

    private BasepPack1Impl179(){
