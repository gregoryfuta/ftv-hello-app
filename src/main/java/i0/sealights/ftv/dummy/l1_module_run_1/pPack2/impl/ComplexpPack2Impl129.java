...
public class ComplexpPack2Impl129 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl129.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl129 INSTANCE;

    public static ComplexpPack2Impl129 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl129();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl129(){
