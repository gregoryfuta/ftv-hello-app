...
public class ComplexpPack2Impl166 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl166.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl166 INSTANCE;

    public static ComplexpPack2Impl166 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl166();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl166(){
