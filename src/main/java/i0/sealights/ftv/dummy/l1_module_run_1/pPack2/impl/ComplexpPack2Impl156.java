...
public class ComplexpPack2Impl156 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl156.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl156 INSTANCE;

    public static ComplexpPack2Impl156 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl156();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl156(){
