...
public class ComplexpPack2Impl967 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl967.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl967 INSTANCE;

    public static ComplexpPack2Impl967 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl967();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl967(){
