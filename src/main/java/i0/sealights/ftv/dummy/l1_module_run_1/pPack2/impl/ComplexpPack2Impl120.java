...
public class ComplexpPack2Impl120 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl120.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl120 INSTANCE;

    public static ComplexpPack2Impl120 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl120();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl120(){
