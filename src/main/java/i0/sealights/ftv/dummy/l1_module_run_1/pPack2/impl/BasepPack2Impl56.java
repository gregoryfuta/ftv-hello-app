...
public class BasepPack2Impl56 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl56.class);
    private static BasepPack2Impl56 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl56 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl56();
        }
        return INSTANCE;
    }

    private BasepPack2Impl56(){
