...
public class ComplexpPack2Impl737 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl737.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl737 INSTANCE;

    public static ComplexpPack2Impl737 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl737();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl737(){
