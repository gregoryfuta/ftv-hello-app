...
public class ComplexpPack2Impl342 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl342.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl342 INSTANCE;

    public static ComplexpPack2Impl342 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl342();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl342(){
