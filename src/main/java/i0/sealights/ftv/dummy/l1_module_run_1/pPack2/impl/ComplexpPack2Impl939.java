...
public class ComplexpPack2Impl939 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl939.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl939 INSTANCE;

    public static ComplexpPack2Impl939 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl939();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl939(){
