...
public class BasepPack2Impl688 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl688.class);
    private static BasepPack2Impl688 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl688 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl688();
        }
        return INSTANCE;
    }

    private BasepPack2Impl688(){
