...
public class BasepPack2Impl798 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl798.class);
    private static BasepPack2Impl798 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl798 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl798();
        }
        return INSTANCE;
    }

    private BasepPack2Impl798(){
