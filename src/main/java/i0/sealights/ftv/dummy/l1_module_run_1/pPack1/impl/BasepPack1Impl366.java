...
public class BasepPack1Impl366 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl366.class);
    private static BasepPack1Impl366 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl366 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl366();
        }
        return INSTANCE;
    }

    private BasepPack1Impl366(){
