...
public class BasepPack2Impl347 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl347.class);
    private static BasepPack2Impl347 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl347 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl347();
        }
        return INSTANCE;
    }

    private BasepPack2Impl347(){
