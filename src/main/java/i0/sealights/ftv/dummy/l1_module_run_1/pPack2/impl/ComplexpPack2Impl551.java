...
public class ComplexpPack2Impl551 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl551.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl551 INSTANCE;

    public static ComplexpPack2Impl551 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl551();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl551(){
