...
public class ComplexpPack1Impl466 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl466.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl466 INSTANCE;

    public static ComplexpPack1Impl466 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl466();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl466(){
