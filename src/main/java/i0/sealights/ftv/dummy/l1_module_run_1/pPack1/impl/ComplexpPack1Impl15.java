...
public class ComplexpPack1Impl15 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl15.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl15 INSTANCE;

    public static ComplexpPack1Impl15 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl15();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl15(){
