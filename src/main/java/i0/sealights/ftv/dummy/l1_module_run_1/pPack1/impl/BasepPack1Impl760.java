...
public class BasepPack1Impl760 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl760.class);
    private static BasepPack1Impl760 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl760 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl760();
        }
        return INSTANCE;
    }

    private BasepPack1Impl760(){
