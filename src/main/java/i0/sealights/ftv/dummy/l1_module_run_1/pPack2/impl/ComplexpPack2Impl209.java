...
public class ComplexpPack2Impl209 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl209.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl209 INSTANCE;

    public static ComplexpPack2Impl209 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl209();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl209(){
