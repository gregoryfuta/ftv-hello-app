...
public class BasepPack1Impl738 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl738.class);
    private static BasepPack1Impl738 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl738 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl738();
        }
        return INSTANCE;
    }

    private BasepPack1Impl738(){
