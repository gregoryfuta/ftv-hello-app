...
public class ComplexpPack2Impl818 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl818.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl818 INSTANCE;

    public static ComplexpPack2Impl818 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl818();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl818(){
