...
public class ComplexpPack1Impl741 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl741.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl741 INSTANCE;

    public static ComplexpPack1Impl741 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl741();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl741(){
