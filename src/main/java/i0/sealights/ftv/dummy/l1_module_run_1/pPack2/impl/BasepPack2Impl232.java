...
public class BasepPack2Impl232 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl232.class);
    private static BasepPack2Impl232 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl232 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl232();
        }
        return INSTANCE;
    }

    private BasepPack2Impl232(){
