...
public class ComplexpPack2Impl403 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl403.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl403 INSTANCE;

    public static ComplexpPack2Impl403 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl403();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl403(){
