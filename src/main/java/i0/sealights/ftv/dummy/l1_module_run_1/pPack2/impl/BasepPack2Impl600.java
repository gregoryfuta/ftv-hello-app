...
public class BasepPack2Impl600 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl600.class);
    private static BasepPack2Impl600 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl600 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl600();
        }
        return INSTANCE;
    }

    private BasepPack2Impl600(){
