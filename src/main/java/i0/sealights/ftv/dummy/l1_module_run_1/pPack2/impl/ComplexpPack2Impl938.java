...
public class ComplexpPack2Impl938 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl938.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl938 INSTANCE;

    public static ComplexpPack2Impl938 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl938();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl938(){
