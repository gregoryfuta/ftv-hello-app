...
public class BasepPack2Impl904 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl904.class);
    private static BasepPack2Impl904 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl904 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl904();
        }
        return INSTANCE;
    }

    private BasepPack2Impl904(){
