...
public class BasepPack2Impl952 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl952.class);
    private static BasepPack2Impl952 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl952 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl952();
        }
        return INSTANCE;
    }

    private BasepPack2Impl952(){
