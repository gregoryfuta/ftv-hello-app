...
public class ComplexpPack2Impl997 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl997.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl997 INSTANCE;

    public static ComplexpPack2Impl997 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl997();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl997(){
