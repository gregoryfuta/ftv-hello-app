...
public class BasepPack2Impl91 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl91.class);
    private static BasepPack2Impl91 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl91 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl91();
        }
        return INSTANCE;
    }

    private BasepPack2Impl91(){
