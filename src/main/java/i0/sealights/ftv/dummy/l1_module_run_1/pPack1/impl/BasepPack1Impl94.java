...
public class BasepPack1Impl94 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl94.class);
    private static BasepPack1Impl94 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl94 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl94();
        }
        return INSTANCE;
    }

    private BasepPack1Impl94(){
