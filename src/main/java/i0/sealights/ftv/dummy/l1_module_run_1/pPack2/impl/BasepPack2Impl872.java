...
public class BasepPack2Impl872 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl872.class);
    private static BasepPack2Impl872 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl872 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl872();
        }
        return INSTANCE;
    }

    private BasepPack2Impl872(){
