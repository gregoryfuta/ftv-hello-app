...
public class ComplexpPack2Impl833 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl833.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl833 INSTANCE;

    public static ComplexpPack2Impl833 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl833();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl833(){
