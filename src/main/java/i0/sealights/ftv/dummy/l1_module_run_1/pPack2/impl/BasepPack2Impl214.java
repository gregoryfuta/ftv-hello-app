...
public class BasepPack2Impl214 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl214.class);
    private static BasepPack2Impl214 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl214 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl214();
        }
        return INSTANCE;
    }

    private BasepPack2Impl214(){
