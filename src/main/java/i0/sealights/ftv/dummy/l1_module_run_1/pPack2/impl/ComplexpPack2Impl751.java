...
public class ComplexpPack2Impl751 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl751.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl751 INSTANCE;

    public static ComplexpPack2Impl751 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl751();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl751(){
