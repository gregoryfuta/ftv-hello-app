...
public class BasepPack1Impl898 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl898.class);
    private static BasepPack1Impl898 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl898 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl898();
        }
        return INSTANCE;
    }

    private BasepPack1Impl898(){
