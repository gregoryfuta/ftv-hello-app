...
public class ComplexpPack1Impl601 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl601.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl601 INSTANCE;

    public static ComplexpPack1Impl601 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl601();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl601(){
