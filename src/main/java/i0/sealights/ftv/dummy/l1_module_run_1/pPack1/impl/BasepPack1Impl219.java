...
public class BasepPack1Impl219 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl219.class);
    private static BasepPack1Impl219 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl219 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl219();
        }
        return INSTANCE;
    }

    private BasepPack1Impl219(){
