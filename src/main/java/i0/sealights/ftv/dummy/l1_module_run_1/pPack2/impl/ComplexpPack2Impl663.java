...
public class ComplexpPack2Impl663 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl663.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl663 INSTANCE;

    public static ComplexpPack2Impl663 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl663();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl663(){
