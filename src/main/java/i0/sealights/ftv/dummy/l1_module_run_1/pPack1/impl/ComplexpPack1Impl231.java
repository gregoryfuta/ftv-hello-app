...
public class ComplexpPack1Impl231 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl231.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl231 INSTANCE;

    public static ComplexpPack1Impl231 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl231();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl231(){
