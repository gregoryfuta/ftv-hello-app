...
public class BasepPack2Impl79 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl79.class);
    private static BasepPack2Impl79 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl79 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl79();
        }
        return INSTANCE;
    }

    private BasepPack2Impl79(){
