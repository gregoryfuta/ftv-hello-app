...
public class BasepPack1Impl211 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl211.class);
    private static BasepPack1Impl211 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl211 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl211();
        }
        return INSTANCE;
    }

    private BasepPack1Impl211(){
