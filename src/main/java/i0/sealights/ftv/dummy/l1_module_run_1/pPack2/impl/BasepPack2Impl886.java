...
public class BasepPack2Impl886 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl886.class);
    private static BasepPack2Impl886 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl886 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl886();
        }
        return INSTANCE;
    }

    private BasepPack2Impl886(){
