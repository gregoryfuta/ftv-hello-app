...
public class ComplexpPack1Impl939 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl939.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl939 INSTANCE;

    public static ComplexpPack1Impl939 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl939();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl939(){
