...
public class BasepPack1Impl756 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl756.class);
    private static BasepPack1Impl756 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl756 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl756();
        }
        return INSTANCE;
    }

    private BasepPack1Impl756(){
