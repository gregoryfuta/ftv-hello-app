...
public class ComplexpPack1Impl791 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl791.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl791 INSTANCE;

    public static ComplexpPack1Impl791 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl791();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl791(){
