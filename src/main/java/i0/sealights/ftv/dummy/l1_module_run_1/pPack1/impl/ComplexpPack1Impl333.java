...
public class ComplexpPack1Impl333 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl333.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl333 INSTANCE;

    public static ComplexpPack1Impl333 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl333();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl333(){
