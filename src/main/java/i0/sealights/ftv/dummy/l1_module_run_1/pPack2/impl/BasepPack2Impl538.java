...
public class BasepPack2Impl538 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl538.class);
    private static BasepPack2Impl538 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl538 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl538();
        }
        return INSTANCE;
    }

    private BasepPack2Impl538(){
