...
public class BasepPack1Impl757 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl757.class);
    private static BasepPack1Impl757 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl757 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl757();
        }
        return INSTANCE;
    }

    private BasepPack1Impl757(){
