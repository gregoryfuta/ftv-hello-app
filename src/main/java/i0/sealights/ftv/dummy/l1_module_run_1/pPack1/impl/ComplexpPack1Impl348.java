...
public class ComplexpPack1Impl348 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl348.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl348 INSTANCE;

    public static ComplexpPack1Impl348 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl348();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl348(){
