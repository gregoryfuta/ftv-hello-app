...
public class ComplexpPack2Impl995 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl995.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl995 INSTANCE;

    public static ComplexpPack2Impl995 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl995();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl995(){
