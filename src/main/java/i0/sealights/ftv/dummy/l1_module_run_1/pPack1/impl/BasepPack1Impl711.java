...
public class BasepPack1Impl711 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl711.class);
    private static BasepPack1Impl711 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl711 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl711();
        }
        return INSTANCE;
    }

    private BasepPack1Impl711(){
