...
public class ComplexpPack2Impl514 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl514.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl514 INSTANCE;

    public static ComplexpPack2Impl514 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl514();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl514(){
