...
public class ComplexpPack1Impl43 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl43.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl43 INSTANCE;

    public static ComplexpPack1Impl43 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl43();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl43(){
