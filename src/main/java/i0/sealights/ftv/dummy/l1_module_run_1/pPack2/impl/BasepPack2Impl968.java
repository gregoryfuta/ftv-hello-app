...
public class BasepPack2Impl968 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl968.class);
    private static BasepPack2Impl968 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl968 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl968();
        }
        return INSTANCE;
    }

    private BasepPack2Impl968(){
