...
public class ComplexpPack2Impl562 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl562.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl562 INSTANCE;

    public static ComplexpPack2Impl562 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl562();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl562(){
