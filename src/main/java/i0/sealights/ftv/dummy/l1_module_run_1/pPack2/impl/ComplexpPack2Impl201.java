...
public class ComplexpPack2Impl201 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl201.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl201 INSTANCE;

    public static ComplexpPack2Impl201 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl201();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl201(){
