...
public class BasepPack2Impl66 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl66.class);
    private static BasepPack2Impl66 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl66 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl66();
        }
        return INSTANCE;
    }

    private BasepPack2Impl66(){
