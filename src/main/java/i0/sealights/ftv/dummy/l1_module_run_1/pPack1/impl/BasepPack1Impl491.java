...
public class BasepPack1Impl491 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl491.class);
    private static BasepPack1Impl491 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl491 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl491();
        }
        return INSTANCE;
    }

    private BasepPack1Impl491(){
