...
public class BasepPack2Impl133 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl133.class);
    private static BasepPack2Impl133 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl133 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl133();
        }
        return INSTANCE;
    }

    private BasepPack2Impl133(){
