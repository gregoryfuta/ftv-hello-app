...
public class ComplexpPack2Impl21 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl21.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl21 INSTANCE;

    public static ComplexpPack2Impl21 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl21();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl21(){
