...
public class ComplexpPack2Impl20 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl20.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl20 INSTANCE;

    public static ComplexpPack2Impl20 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl20();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl20(){
