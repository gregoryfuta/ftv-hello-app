...
public class BasepPack2Impl750 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl750.class);
    private static BasepPack2Impl750 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl750 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl750();
        }
        return INSTANCE;
    }

    private BasepPack2Impl750(){
