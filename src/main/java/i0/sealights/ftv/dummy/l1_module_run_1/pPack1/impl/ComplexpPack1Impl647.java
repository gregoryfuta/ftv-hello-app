...
public class ComplexpPack1Impl647 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl647.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl647 INSTANCE;

    public static ComplexpPack1Impl647 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl647();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl647(){
