...
public class BasepPack2Impl257 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl257.class);
    private static BasepPack2Impl257 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl257 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl257();
        }
        return INSTANCE;
    }

    private BasepPack2Impl257(){
