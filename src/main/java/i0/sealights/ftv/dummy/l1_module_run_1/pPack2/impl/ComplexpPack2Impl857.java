...
public class ComplexpPack2Impl857 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl857.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl857 INSTANCE;

    public static ComplexpPack2Impl857 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl857();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl857(){
