...
public class BasepPack2Impl266 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl266.class);
    private static BasepPack2Impl266 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl266 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl266();
        }
        return INSTANCE;
    }

    private BasepPack2Impl266(){
