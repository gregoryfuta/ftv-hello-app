...
public class ComplexpPack2Impl589 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl589.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl589 INSTANCE;

    public static ComplexpPack2Impl589 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl589();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl589(){
