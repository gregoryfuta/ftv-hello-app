...
public class BasepPack2Impl267 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl267.class);
    private static BasepPack2Impl267 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl267 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl267();
        }
        return INSTANCE;
    }

    private BasepPack2Impl267(){
