...
public class BasepPack1Impl742 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl742.class);
    private static BasepPack1Impl742 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl742 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl742();
        }
        return INSTANCE;
    }

    private BasepPack1Impl742(){
