...
public class ComplexpPack1Impl628 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl628.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl628 INSTANCE;

    public static ComplexpPack1Impl628 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl628();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl628(){
