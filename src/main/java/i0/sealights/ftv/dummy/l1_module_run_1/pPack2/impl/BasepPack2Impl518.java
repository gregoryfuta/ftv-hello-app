...
public class BasepPack2Impl518 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl518.class);
    private static BasepPack2Impl518 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl518 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl518();
        }
        return INSTANCE;
    }

    private BasepPack2Impl518(){
