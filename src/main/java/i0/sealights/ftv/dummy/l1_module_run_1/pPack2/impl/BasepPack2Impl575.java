...
public class BasepPack2Impl575 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl575.class);
    private static BasepPack2Impl575 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl575 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl575();
        }
        return INSTANCE;
    }

    private BasepPack2Impl575(){
