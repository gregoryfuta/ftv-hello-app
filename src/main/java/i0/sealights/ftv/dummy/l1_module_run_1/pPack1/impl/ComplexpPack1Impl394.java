...
public class ComplexpPack1Impl394 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl394.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl394 INSTANCE;

    public static ComplexpPack1Impl394 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl394();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl394(){
