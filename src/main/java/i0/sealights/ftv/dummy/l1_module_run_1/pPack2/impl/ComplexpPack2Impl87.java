...
public class ComplexpPack2Impl87 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl87.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl87 INSTANCE;

    public static ComplexpPack2Impl87 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl87();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl87(){
