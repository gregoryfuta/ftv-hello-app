...
public class BasepPack1Impl728 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl728.class);
    private static BasepPack1Impl728 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl728 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl728();
        }
        return INSTANCE;
    }

    private BasepPack1Impl728(){
