...
public class BasepPack2Impl540 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl540.class);
    private static BasepPack2Impl540 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl540 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl540();
        }
        return INSTANCE;
    }

    private BasepPack2Impl540(){
