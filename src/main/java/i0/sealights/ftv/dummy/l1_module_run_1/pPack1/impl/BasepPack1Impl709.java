...
public class BasepPack1Impl709 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl709.class);
    private static BasepPack1Impl709 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl709 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl709();
        }
        return INSTANCE;
    }

    private BasepPack1Impl709(){
