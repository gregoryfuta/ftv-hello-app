...
public class ComplexpPack2Impl794 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl794.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl794 INSTANCE;

    public static ComplexpPack2Impl794 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl794();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl794(){
