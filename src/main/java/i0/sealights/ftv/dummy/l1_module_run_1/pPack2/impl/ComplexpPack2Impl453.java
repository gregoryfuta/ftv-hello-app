...
public class ComplexpPack2Impl453 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl453.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl453 INSTANCE;

    public static ComplexpPack2Impl453 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl453();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl453(){
