...
public class BasepPack1Impl999 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl999.class);
    private static BasepPack1Impl999 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl999 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl999();
        }
        return INSTANCE;
    }

    private BasepPack1Impl999(){
