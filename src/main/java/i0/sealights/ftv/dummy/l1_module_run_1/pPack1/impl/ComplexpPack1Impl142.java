...
public class ComplexpPack1Impl142 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl142.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl142 INSTANCE;

    public static ComplexpPack1Impl142 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl142();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl142(){
