...
public class BasepPack1Impl466 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl466.class);
    private static BasepPack1Impl466 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl466 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl466();
        }
        return INSTANCE;
    }

    private BasepPack1Impl466(){
