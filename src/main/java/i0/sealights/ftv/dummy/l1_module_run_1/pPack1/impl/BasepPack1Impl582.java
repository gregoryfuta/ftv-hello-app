...
public class BasepPack1Impl582 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl582.class);
    private static BasepPack1Impl582 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl582 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl582();
        }
        return INSTANCE;
    }

    private BasepPack1Impl582(){
