...
public class BasepPack2Impl83 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl83.class);
    private static BasepPack2Impl83 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl83 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl83();
        }
        return INSTANCE;
    }

    private BasepPack2Impl83(){
