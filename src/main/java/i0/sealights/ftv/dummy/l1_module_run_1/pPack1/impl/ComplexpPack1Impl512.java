...
public class ComplexpPack1Impl512 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl512.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl512 INSTANCE;

    public static ComplexpPack1Impl512 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl512();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl512(){
