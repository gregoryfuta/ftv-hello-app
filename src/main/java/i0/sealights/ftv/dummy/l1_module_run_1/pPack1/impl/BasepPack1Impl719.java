...
public class BasepPack1Impl719 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl719.class);
    private static BasepPack1Impl719 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl719 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl719();
        }
        return INSTANCE;
    }

    private BasepPack1Impl719(){
