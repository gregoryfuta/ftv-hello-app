...
public class BasepPack1Impl314 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl314.class);
    private static BasepPack1Impl314 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl314 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl314();
        }
        return INSTANCE;
    }

    private BasepPack1Impl314(){
