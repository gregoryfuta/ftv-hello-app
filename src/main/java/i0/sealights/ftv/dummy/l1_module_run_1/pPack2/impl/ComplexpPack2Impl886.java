...
public class ComplexpPack2Impl886 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl886.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl886 INSTANCE;

    public static ComplexpPack2Impl886 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl886();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl886(){
