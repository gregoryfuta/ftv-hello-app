...
public class BasepPack2Impl341 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl341.class);
    private static BasepPack2Impl341 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl341 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl341();
        }
        return INSTANCE;
    }

    private BasepPack2Impl341(){
