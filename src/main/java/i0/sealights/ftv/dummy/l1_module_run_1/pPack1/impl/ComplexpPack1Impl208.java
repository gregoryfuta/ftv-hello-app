...
public class ComplexpPack1Impl208 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl208.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl208 INSTANCE;

    public static ComplexpPack1Impl208 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl208();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl208(){
