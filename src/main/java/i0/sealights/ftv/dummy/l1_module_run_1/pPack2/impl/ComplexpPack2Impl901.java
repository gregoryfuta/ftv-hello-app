...
public class ComplexpPack2Impl901 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl901.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl901 INSTANCE;

    public static ComplexpPack2Impl901 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl901();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl901(){
