...
public class BasepPack1Impl62 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl62.class);
    private static BasepPack1Impl62 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl62 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl62();
        }
        return INSTANCE;
    }

    private BasepPack1Impl62(){
