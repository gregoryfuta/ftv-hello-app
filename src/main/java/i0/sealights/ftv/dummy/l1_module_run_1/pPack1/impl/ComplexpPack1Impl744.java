...
public class ComplexpPack1Impl744 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl744.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl744 INSTANCE;

    public static ComplexpPack1Impl744 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl744();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl744(){
