...
public class ComplexpPack1Impl367 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl367.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl367 INSTANCE;

    public static ComplexpPack1Impl367 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl367();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl367(){
