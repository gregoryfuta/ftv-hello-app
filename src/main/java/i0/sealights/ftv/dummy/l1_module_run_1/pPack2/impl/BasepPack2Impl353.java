...
public class BasepPack2Impl353 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl353.class);
    private static BasepPack2Impl353 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl353 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl353();
        }
        return INSTANCE;
    }

    private BasepPack2Impl353(){
