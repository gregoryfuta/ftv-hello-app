...
public class ComplexpPack1Impl1028 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1028.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1028 INSTANCE;

    public static ComplexpPack1Impl1028 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1028();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1028(){
