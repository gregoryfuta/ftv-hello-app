...
public class BasepPack1Impl611 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl611.class);
    private static BasepPack1Impl611 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl611 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl611();
        }
        return INSTANCE;
    }

    private BasepPack1Impl611(){
