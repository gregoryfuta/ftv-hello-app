...
public class ComplexpPack1Impl763 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl763.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl763 INSTANCE;

    public static ComplexpPack1Impl763 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl763();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl763(){
