...
public class ComplexpPack2Impl567 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl567.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl567 INSTANCE;

    public static ComplexpPack2Impl567 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl567();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl567(){
