...
public class BasepPack1Impl474 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl474.class);
    private static BasepPack1Impl474 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl474 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl474();
        }
        return INSTANCE;
    }

    private BasepPack1Impl474(){
