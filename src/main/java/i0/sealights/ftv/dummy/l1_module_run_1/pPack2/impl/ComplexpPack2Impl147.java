...
public class ComplexpPack2Impl147 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl147.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl147 INSTANCE;

    public static ComplexpPack2Impl147 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl147();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl147(){
