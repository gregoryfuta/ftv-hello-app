...
public class ComplexpPack1Impl587 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl587.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl587 INSTANCE;

    public static ComplexpPack1Impl587 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl587();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl587(){
