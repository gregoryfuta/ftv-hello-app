...
public class ComplexpPack1Impl646 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl646.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl646 INSTANCE;

    public static ComplexpPack1Impl646 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl646();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl646(){
