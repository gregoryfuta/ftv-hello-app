...
public class BasepPack1Impl636 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl636.class);
    private static BasepPack1Impl636 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl636 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl636();
        }
        return INSTANCE;
    }

    private BasepPack1Impl636(){
