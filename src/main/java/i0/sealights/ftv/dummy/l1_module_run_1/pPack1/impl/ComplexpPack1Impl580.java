...
public class ComplexpPack1Impl580 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl580.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl580 INSTANCE;

    public static ComplexpPack1Impl580 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl580();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl580(){
