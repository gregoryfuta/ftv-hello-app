...
public class ComplexpPack1Impl1038 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1038.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1038 INSTANCE;

    public static ComplexpPack1Impl1038 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1038();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1038(){
