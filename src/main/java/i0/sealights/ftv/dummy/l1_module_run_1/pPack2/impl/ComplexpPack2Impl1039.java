...
public class ComplexpPack2Impl1039 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1039.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1039 INSTANCE;

    public static ComplexpPack2Impl1039 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1039();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1039(){
