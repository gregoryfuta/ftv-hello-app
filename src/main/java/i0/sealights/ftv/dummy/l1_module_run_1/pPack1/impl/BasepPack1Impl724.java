...
public class BasepPack1Impl724 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl724.class);
    private static BasepPack1Impl724 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl724 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl724();
        }
        return INSTANCE;
    }

    private BasepPack1Impl724(){
