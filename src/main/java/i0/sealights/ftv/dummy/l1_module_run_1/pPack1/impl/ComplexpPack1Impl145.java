...
public class ComplexpPack1Impl145 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl145.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl145 INSTANCE;

    public static ComplexpPack1Impl145 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl145();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl145(){
