...
public class BasepPack1Impl369 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl369.class);
    private static BasepPack1Impl369 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl369 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl369();
        }
        return INSTANCE;
    }

    private BasepPack1Impl369(){
