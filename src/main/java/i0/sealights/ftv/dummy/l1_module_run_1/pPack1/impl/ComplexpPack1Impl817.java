...
public class ComplexpPack1Impl817 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl817.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl817 INSTANCE;

    public static ComplexpPack1Impl817 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl817();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl817(){
