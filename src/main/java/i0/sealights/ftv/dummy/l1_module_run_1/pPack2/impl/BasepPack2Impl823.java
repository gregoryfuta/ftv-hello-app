...
public class BasepPack2Impl823 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl823.class);
    private static BasepPack2Impl823 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl823 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl823();
        }
        return INSTANCE;
    }

    private BasepPack2Impl823(){
