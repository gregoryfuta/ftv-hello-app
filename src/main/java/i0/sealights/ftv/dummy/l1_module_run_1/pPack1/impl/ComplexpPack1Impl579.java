...
public class ComplexpPack1Impl579 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl579.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl579 INSTANCE;

    public static ComplexpPack1Impl579 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl579();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl579(){
