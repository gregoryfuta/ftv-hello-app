...
public class BasepPack1Impl47 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl47.class);
    private static BasepPack1Impl47 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl47 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl47();
        }
        return INSTANCE;
    }

    private BasepPack1Impl47(){
