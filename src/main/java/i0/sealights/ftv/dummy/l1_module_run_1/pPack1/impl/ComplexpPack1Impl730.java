...
public class ComplexpPack1Impl730 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl730.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl730 INSTANCE;

    public static ComplexpPack1Impl730 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl730();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl730(){
