...
public class ComplexpPack2Impl723 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl723.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl723 INSTANCE;

    public static ComplexpPack2Impl723 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl723();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl723(){
