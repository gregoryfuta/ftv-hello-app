...
public class BasepPack2Impl513 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl513.class);
    private static BasepPack2Impl513 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl513 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl513();
        }
        return INSTANCE;
    }

    private BasepPack2Impl513(){
