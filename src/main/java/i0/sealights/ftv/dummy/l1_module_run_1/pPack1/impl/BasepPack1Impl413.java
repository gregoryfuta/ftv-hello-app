...
public class BasepPack1Impl413 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl413.class);
    private static BasepPack1Impl413 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl413 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl413();
        }
        return INSTANCE;
    }

    private BasepPack1Impl413(){
