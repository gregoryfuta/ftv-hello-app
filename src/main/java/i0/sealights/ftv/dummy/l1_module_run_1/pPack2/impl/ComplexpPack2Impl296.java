...
public class ComplexpPack2Impl296 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl296.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl296 INSTANCE;

    public static ComplexpPack2Impl296 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl296();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl296(){
