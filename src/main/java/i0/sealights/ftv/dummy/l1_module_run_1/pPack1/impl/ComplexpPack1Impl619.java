...
public class ComplexpPack1Impl619 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl619.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl619 INSTANCE;

    public static ComplexpPack1Impl619 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl619();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl619(){
