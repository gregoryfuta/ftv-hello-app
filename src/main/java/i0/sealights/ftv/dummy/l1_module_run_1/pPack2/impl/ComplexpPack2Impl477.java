...
public class ComplexpPack2Impl477 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl477.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl477 INSTANCE;

    public static ComplexpPack2Impl477 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl477();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl477(){
