...
public class BasepPack1Impl315 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl315.class);
    private static BasepPack1Impl315 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl315 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl315();
        }
        return INSTANCE;
    }

    private BasepPack1Impl315(){
