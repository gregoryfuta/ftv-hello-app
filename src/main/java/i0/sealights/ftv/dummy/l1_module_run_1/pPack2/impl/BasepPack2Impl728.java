...
public class BasepPack2Impl728 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl728.class);
    private static BasepPack2Impl728 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl728 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl728();
        }
        return INSTANCE;
    }

    private BasepPack2Impl728(){
