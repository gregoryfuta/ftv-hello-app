...
public class BasepPack1Impl148 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl148.class);
    private static BasepPack1Impl148 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl148 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl148();
        }
        return INSTANCE;
    }

    private BasepPack1Impl148(){
