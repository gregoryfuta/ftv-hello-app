...
public class ComplexpPack2Impl302 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl302.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl302 INSTANCE;

    public static ComplexpPack2Impl302 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl302();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl302(){
