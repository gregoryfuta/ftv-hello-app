...
public class ComplexpPack1Impl135 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl135.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl135 INSTANCE;

    public static ComplexpPack1Impl135 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl135();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl135(){
