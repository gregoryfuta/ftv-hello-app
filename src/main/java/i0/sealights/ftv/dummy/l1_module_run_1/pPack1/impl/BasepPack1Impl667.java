...
public class BasepPack1Impl667 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl667.class);
    private static BasepPack1Impl667 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl667 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl667();
        }
        return INSTANCE;
    }

    private BasepPack1Impl667(){
