...
public class BasepPack1Impl590 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl590.class);
    private static BasepPack1Impl590 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl590 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl590();
        }
        return INSTANCE;
    }

    private BasepPack1Impl590(){
