...
public class BasepPack2Impl760 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl760.class);
    private static BasepPack2Impl760 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl760 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl760();
        }
        return INSTANCE;
    }

    private BasepPack2Impl760(){
