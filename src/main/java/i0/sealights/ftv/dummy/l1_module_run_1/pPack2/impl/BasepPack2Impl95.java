...
public class BasepPack2Impl95 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl95.class);
    private static BasepPack2Impl95 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl95 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl95();
        }
        return INSTANCE;
    }

    private BasepPack2Impl95(){
