...
public class ComplexpPack2Impl628 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl628.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl628 INSTANCE;

    public static ComplexpPack2Impl628 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl628();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl628(){
