...
public class BasepPack2Impl926 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl926.class);
    private static BasepPack2Impl926 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl926 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl926();
        }
        return INSTANCE;
    }

    private BasepPack2Impl926(){
