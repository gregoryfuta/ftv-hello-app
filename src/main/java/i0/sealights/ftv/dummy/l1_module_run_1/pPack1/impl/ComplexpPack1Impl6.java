...
public class ComplexpPack1Impl6 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl6.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl6 INSTANCE;

    public static ComplexpPack1Impl6 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl6();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl6(){
