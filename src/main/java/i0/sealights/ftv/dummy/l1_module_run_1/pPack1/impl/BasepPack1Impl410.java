...
public class BasepPack1Impl410 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl410.class);
    private static BasepPack1Impl410 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl410 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl410();
        }
        return INSTANCE;
    }

    private BasepPack1Impl410(){
