...
public class BasepPack1Impl297 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl297.class);
    private static BasepPack1Impl297 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl297 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl297();
        }
        return INSTANCE;
    }

    private BasepPack1Impl297(){
