...
public class ComplexpPack1Impl951 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl951.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl951 INSTANCE;

    public static ComplexpPack1Impl951 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl951();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl951(){
