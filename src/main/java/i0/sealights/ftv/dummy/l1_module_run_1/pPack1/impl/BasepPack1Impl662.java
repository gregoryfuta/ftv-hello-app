...
public class BasepPack1Impl662 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl662.class);
    private static BasepPack1Impl662 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl662 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl662();
        }
        return INSTANCE;
    }

    private BasepPack1Impl662(){
