...
public class BasepPack2Impl686 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl686.class);
    private static BasepPack2Impl686 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl686 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl686();
        }
        return INSTANCE;
    }

    private BasepPack2Impl686(){
