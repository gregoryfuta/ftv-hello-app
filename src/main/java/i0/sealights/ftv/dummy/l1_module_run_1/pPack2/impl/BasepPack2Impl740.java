...
public class BasepPack2Impl740 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl740.class);
    private static BasepPack2Impl740 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl740 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl740();
        }
        return INSTANCE;
    }

    private BasepPack2Impl740(){
