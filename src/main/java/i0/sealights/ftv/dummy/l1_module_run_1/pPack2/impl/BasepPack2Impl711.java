...
public class BasepPack2Impl711 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl711.class);
    private static BasepPack2Impl711 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl711 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl711();
        }
        return INSTANCE;
    }

    private BasepPack2Impl711(){
