...
public class ComplexpPack2Impl976 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl976.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl976 INSTANCE;

    public static ComplexpPack2Impl976 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl976();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl976(){
