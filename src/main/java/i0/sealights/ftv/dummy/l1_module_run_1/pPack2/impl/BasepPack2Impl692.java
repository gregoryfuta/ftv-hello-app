...
public class BasepPack2Impl692 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl692.class);
    private static BasepPack2Impl692 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl692 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl692();
        }
        return INSTANCE;
    }

    private BasepPack2Impl692(){
