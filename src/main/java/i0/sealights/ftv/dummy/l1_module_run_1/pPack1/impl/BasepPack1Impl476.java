...
public class BasepPack1Impl476 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl476.class);
    private static BasepPack1Impl476 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl476 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl476();
        }
        return INSTANCE;
    }

    private BasepPack1Impl476(){
