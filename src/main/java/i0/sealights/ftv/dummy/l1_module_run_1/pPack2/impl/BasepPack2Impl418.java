...
public class BasepPack2Impl418 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl418.class);
    private static BasepPack2Impl418 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl418 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl418();
        }
        return INSTANCE;
    }

    private BasepPack2Impl418(){
