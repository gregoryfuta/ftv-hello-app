...
public class ComplexpPack2Impl218 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl218.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl218 INSTANCE;

    public static ComplexpPack2Impl218 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl218();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl218(){
