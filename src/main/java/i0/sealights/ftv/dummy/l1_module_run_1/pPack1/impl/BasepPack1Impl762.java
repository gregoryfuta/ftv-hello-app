...
public class BasepPack1Impl762 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl762.class);
    private static BasepPack1Impl762 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl762 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl762();
        }
        return INSTANCE;
    }

    private BasepPack1Impl762(){
