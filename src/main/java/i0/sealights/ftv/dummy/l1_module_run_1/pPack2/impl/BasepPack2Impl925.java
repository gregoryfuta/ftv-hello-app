...
public class BasepPack2Impl925 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl925.class);
    private static BasepPack2Impl925 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl925 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl925();
        }
        return INSTANCE;
    }

    private BasepPack2Impl925(){
