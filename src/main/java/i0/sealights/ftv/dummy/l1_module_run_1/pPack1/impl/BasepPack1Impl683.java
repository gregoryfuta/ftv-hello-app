...
public class BasepPack1Impl683 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl683.class);
    private static BasepPack1Impl683 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl683 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl683();
        }
        return INSTANCE;
    }

    private BasepPack1Impl683(){
