...
public class BasepPack2Impl530 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl530.class);
    private static BasepPack2Impl530 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl530 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl530();
        }
        return INSTANCE;
    }

    private BasepPack2Impl530(){
