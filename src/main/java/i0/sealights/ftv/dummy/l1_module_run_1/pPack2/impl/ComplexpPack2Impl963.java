...
public class ComplexpPack2Impl963 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl963.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl963 INSTANCE;

    public static ComplexpPack2Impl963 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl963();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl963(){
