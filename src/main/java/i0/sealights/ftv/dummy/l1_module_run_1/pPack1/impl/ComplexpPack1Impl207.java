...
public class ComplexpPack1Impl207 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl207.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl207 INSTANCE;

    public static ComplexpPack1Impl207 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl207();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl207(){
