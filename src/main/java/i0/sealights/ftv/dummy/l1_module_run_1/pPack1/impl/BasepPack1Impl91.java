...
public class BasepPack1Impl91 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl91.class);
    private static BasepPack1Impl91 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl91 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl91();
        }
        return INSTANCE;
    }

    private BasepPack1Impl91(){
