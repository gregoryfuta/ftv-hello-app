...
public class ComplexpPack2Impl126 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl126.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl126 INSTANCE;

    public static ComplexpPack2Impl126 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl126();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl126(){
