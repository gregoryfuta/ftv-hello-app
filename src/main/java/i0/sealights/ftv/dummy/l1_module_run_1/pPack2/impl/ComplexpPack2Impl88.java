...
public class ComplexpPack2Impl88 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl88.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl88 INSTANCE;

    public static ComplexpPack2Impl88 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl88();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl88(){
