...
public class BasepPack2Impl903 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl903.class);
    private static BasepPack2Impl903 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl903 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl903();
        }
        return INSTANCE;
    }

    private BasepPack2Impl903(){
