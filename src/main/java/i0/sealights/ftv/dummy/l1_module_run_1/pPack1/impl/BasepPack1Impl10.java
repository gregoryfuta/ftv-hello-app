...
public class BasepPack1Impl10 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl10.class);
    private static BasepPack1Impl10 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl10 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl10();
        }
        return INSTANCE;
    }

    private BasepPack1Impl10(){
