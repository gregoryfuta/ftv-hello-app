...
public class ComplexpPack1Impl927 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl927.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl927 INSTANCE;

    public static ComplexpPack1Impl927 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl927();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl927(){
