...
public class BasepPack2Impl969 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl969.class);
    private static BasepPack2Impl969 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl969 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl969();
        }
        return INSTANCE;
    }

    private BasepPack2Impl969(){
