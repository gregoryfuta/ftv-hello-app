...
public class ComplexpPack2Impl292 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl292.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl292 INSTANCE;

    public static ComplexpPack2Impl292 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl292();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl292(){
