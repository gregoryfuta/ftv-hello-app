...
public class ComplexpPack2Impl335 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl335.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl335 INSTANCE;

    public static ComplexpPack2Impl335 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl335();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl335(){
