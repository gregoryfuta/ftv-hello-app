...
public class ComplexpPack2Impl593 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl593.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl593 INSTANCE;

    public static ComplexpPack2Impl593 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl593();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl593(){
