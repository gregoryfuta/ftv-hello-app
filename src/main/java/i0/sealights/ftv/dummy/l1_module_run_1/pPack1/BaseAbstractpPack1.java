...
public class BaseAbstractpPack1 {

    private static BaseAbstractpPack1 INSTANCE;
    static final Logger LOGGER = LogManager.getLogger(BaseAbstractpPack1.class);
    ...
    public static BaseAbstractpPack1 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BaseAbstractpPack1();
        }
        return INSTANCE;
    }
