...
public class BasepPack2Impl722 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl722.class);
    private static BasepPack2Impl722 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl722 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl722();
        }
        return INSTANCE;
    }

    private BasepPack2Impl722(){
