...
public class BasepPack1Impl539 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl539.class);
    private static BasepPack1Impl539 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl539 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl539();
        }
        return INSTANCE;
    }

    private BasepPack1Impl539(){
