...
public class ComplexpPack2Impl829 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl829.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl829 INSTANCE;

    public static ComplexpPack2Impl829 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl829();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl829(){
