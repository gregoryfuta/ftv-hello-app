...
public class BasepPack2Impl980 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl980.class);
    private static BasepPack2Impl980 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl980 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl980();
        }
        return INSTANCE;
    }

    private BasepPack2Impl980(){
