...
public class ComplexpPack1Impl230 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl230.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl230 INSTANCE;

    public static ComplexpPack1Impl230 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl230();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl230(){
