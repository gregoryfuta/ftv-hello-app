...
public class ComplexpPack2Impl846 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl846.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl846 INSTANCE;

    public static ComplexpPack2Impl846 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl846();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl846(){
