...
public class BasepPack1Impl557 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl557.class);
    private static BasepPack1Impl557 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl557 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl557();
        }
        return INSTANCE;
    }

    private BasepPack1Impl557(){
