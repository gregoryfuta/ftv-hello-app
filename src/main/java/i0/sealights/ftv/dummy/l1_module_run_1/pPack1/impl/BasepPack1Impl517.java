...
public class BasepPack1Impl517 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl517.class);
    private static BasepPack1Impl517 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl517 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl517();
        }
        return INSTANCE;
    }

    private BasepPack1Impl517(){
