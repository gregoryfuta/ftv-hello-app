...
public class ComplexpPack2Impl867 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl867.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl867 INSTANCE;

    public static ComplexpPack2Impl867 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl867();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl867(){
