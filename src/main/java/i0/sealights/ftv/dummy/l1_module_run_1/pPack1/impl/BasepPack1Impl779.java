...
public class BasepPack1Impl779 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl779.class);
    private static BasepPack1Impl779 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl779 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl779();
        }
        return INSTANCE;
    }

    private BasepPack1Impl779(){
