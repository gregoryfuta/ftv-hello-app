...
public class ComplexpPack2Impl904 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl904.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl904 INSTANCE;

    public static ComplexpPack2Impl904 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl904();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl904(){
