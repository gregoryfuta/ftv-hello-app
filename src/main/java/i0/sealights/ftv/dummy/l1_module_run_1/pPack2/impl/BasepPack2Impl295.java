...
public class BasepPack2Impl295 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl295.class);
    private static BasepPack2Impl295 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl295 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl295();
        }
        return INSTANCE;
    }

    private BasepPack2Impl295(){
