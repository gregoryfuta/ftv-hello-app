...
public class ComplexpPack1Impl196 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl196.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl196 INSTANCE;

    public static ComplexpPack1Impl196 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl196();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl196(){
