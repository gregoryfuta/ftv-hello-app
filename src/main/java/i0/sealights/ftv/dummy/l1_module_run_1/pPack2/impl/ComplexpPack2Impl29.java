...
public class ComplexpPack2Impl29 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl29.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl29 INSTANCE;

    public static ComplexpPack2Impl29 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl29();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl29(){
