...
public class ComplexpPack2Impl817 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl817.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl817 INSTANCE;

    public static ComplexpPack2Impl817 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl817();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl817(){
