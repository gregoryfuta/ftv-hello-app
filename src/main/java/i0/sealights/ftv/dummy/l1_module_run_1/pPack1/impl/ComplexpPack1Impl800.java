...
public class ComplexpPack1Impl800 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl800.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl800 INSTANCE;

    public static ComplexpPack1Impl800 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl800();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl800(){
