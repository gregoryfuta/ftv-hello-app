...
public class BasepPack2Impl849 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl849.class);
    private static BasepPack2Impl849 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl849 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl849();
        }
        return INSTANCE;
    }

    private BasepPack2Impl849(){
