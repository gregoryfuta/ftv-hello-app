...
public class ComplexpPack1Impl581 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl581.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl581 INSTANCE;

    public static ComplexpPack1Impl581 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl581();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl581(){
