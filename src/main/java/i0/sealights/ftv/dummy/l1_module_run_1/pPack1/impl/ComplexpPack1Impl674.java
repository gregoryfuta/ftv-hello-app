...
public class ComplexpPack1Impl674 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl674.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl674 INSTANCE;

    public static ComplexpPack1Impl674 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl674();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl674(){
