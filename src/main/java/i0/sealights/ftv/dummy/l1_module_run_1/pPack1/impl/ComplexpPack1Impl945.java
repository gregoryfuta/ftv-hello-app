...
public class ComplexpPack1Impl945 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl945.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl945 INSTANCE;

    public static ComplexpPack1Impl945 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl945();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl945(){
