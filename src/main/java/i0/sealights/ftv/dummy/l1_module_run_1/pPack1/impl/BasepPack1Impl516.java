...
public class BasepPack1Impl516 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl516.class);
    private static BasepPack1Impl516 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl516 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl516();
        }
        return INSTANCE;
    }

    private BasepPack1Impl516(){
