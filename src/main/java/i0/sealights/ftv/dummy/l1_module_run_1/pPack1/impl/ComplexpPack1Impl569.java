...
public class ComplexpPack1Impl569 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl569.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl569 INSTANCE;

    public static ComplexpPack1Impl569 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl569();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl569(){
