...
public class ComplexpPack2Impl452 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl452.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl452 INSTANCE;

    public static ComplexpPack2Impl452 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl452();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl452(){
