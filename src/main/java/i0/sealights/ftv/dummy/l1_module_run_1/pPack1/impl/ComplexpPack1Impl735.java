...
public class ComplexpPack1Impl735 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl735.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl735 INSTANCE;

    public static ComplexpPack1Impl735 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl735();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl735(){
