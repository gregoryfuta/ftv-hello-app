...
public class ComplexpPack2Impl47 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl47.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl47 INSTANCE;

    public static ComplexpPack2Impl47 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl47();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl47(){
