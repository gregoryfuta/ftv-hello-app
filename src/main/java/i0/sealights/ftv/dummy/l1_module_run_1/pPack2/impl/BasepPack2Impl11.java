...
public class BasepPack2Impl11 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl11.class);
    private static BasepPack2Impl11 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl11 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl11();
        }
        return INSTANCE;
    }

    private BasepPack2Impl11(){
