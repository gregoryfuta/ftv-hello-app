...
public class ComplexpPack2Impl925 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl925.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl925 INSTANCE;

    public static ComplexpPack2Impl925 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl925();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl925(){
