...
public class BasepPack2Impl641 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl641.class);
    private static BasepPack2Impl641 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl641 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl641();
        }
        return INSTANCE;
    }

    private BasepPack2Impl641(){
