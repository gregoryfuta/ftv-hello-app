...
public class ComplexpPack1Impl583 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl583.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl583 INSTANCE;

    public static ComplexpPack1Impl583 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl583();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl583(){
