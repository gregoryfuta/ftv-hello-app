...
public class ComplexpPack1Impl76 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl76.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl76 INSTANCE;

    public static ComplexpPack1Impl76 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl76();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl76(){
