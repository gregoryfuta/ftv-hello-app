...
public class BasepPack1Impl461 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl461.class);
    private static BasepPack1Impl461 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl461 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl461();
        }
        return INSTANCE;
    }

    private BasepPack1Impl461(){
