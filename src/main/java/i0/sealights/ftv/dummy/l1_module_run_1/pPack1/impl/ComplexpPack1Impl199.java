...
public class ComplexpPack1Impl199 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl199.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl199 INSTANCE;

    public static ComplexpPack1Impl199 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl199();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl199(){
