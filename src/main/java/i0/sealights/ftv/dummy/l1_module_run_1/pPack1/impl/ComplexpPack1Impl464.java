...
public class ComplexpPack1Impl464 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl464.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl464 INSTANCE;

    public static ComplexpPack1Impl464 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl464();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl464(){
