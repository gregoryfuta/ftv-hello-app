...
public class ComplexpPack2Impl260 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl260.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl260 INSTANCE;

    public static ComplexpPack2Impl260 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl260();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl260(){
