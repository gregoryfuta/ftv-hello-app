...
public class ComplexpPack1Impl511 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl511.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl511 INSTANCE;

    public static ComplexpPack1Impl511 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl511();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl511(){
