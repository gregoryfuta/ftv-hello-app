...
public class BasepPack1Impl22 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl22.class);
    private static BasepPack1Impl22 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl22 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl22();
        }
        return INSTANCE;
    }

    private BasepPack1Impl22(){
