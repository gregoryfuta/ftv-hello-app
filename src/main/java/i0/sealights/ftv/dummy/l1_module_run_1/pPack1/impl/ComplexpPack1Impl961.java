...
public class ComplexpPack1Impl961 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl961.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl961 INSTANCE;

    public static ComplexpPack1Impl961 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl961();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl961(){
