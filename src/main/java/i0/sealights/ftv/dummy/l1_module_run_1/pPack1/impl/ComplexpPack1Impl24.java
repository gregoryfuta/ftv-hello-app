...
public class ComplexpPack1Impl24 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl24.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl24 INSTANCE;

    public static ComplexpPack1Impl24 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl24();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl24(){
