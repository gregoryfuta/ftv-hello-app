...
public class BasepPack2Impl809 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl809.class);
    private static BasepPack2Impl809 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl809 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl809();
        }
        return INSTANCE;
    }

    private BasepPack2Impl809(){
