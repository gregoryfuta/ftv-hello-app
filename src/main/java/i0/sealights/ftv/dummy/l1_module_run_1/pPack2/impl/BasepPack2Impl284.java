...
public class BasepPack2Impl284 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl284.class);
    private static BasepPack2Impl284 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl284 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl284();
        }
        return INSTANCE;
    }

    private BasepPack2Impl284(){
