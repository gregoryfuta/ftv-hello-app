...
public class BasepPack2Impl328 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl328.class);
    private static BasepPack2Impl328 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl328 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl328();
        }
        return INSTANCE;
    }

    private BasepPack2Impl328(){
