...
public class ComplexpPack2Impl948 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl948.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl948 INSTANCE;

    public static ComplexpPack2Impl948 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl948();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl948(){
