...
public class BasepPack2Impl201 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl201.class);
    private static BasepPack2Impl201 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl201 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl201();
        }
        return INSTANCE;
    }

    private BasepPack2Impl201(){
