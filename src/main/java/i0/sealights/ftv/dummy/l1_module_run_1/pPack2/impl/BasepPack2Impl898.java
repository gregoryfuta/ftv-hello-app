...
public class BasepPack2Impl898 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl898.class);
    private static BasepPack2Impl898 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl898 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl898();
        }
        return INSTANCE;
    }

    private BasepPack2Impl898(){
