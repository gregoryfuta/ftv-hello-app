...
public class ComplexpPack1Impl423 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl423.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl423 INSTANCE;

    public static ComplexpPack1Impl423 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl423();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl423(){
