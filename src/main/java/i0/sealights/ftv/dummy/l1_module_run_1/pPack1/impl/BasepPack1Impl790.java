...
public class BasepPack1Impl790 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl790.class);
    private static BasepPack1Impl790 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl790 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl790();
        }
        return INSTANCE;
    }

    private BasepPack1Impl790(){
