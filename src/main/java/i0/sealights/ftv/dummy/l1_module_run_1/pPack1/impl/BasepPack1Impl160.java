...
public class BasepPack1Impl160 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl160.class);
    private static BasepPack1Impl160 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl160 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl160();
        }
        return INSTANCE;
    }

    private BasepPack1Impl160(){
