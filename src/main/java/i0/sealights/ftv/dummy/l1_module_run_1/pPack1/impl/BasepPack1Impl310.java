...
public class BasepPack1Impl310 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl310.class);
    private static BasepPack1Impl310 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl310 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl310();
        }
        return INSTANCE;
    }

    private BasepPack1Impl310(){
