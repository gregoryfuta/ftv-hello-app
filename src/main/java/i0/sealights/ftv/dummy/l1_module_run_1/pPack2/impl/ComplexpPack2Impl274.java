...
public class ComplexpPack2Impl274 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl274.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl274 INSTANCE;

    public static ComplexpPack2Impl274 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl274();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl274(){
