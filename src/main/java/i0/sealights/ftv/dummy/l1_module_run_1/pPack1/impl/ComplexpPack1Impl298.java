...
public class ComplexpPack1Impl298 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl298.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl298 INSTANCE;

    public static ComplexpPack1Impl298 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl298();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl298(){
