...
public class ComplexpPack1Impl533 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl533.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl533 INSTANCE;

    public static ComplexpPack1Impl533 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl533();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl533(){
