...
public class BasepPack2Impl482 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl482.class);
    private static BasepPack2Impl482 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl482 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl482();
        }
        return INSTANCE;
    }

    private BasepPack2Impl482(){
