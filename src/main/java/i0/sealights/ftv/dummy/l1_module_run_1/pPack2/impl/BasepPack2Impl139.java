...
public class BasepPack2Impl139 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl139.class);
    private static BasepPack2Impl139 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl139 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl139();
        }
        return INSTANCE;
    }

    private BasepPack2Impl139(){
