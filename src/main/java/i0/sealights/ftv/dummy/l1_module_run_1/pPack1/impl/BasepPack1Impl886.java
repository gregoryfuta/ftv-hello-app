...
public class BasepPack1Impl886 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl886.class);
    private static BasepPack1Impl886 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl886 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl886();
        }
        return INSTANCE;
    }

    private BasepPack1Impl886(){
