...
public class BasepPack2Impl778 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl778.class);
    private static BasepPack2Impl778 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl778 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl778();
        }
        return INSTANCE;
    }

    private BasepPack2Impl778(){
