...
public class BasepPack2Impl323 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl323.class);
    private static BasepPack2Impl323 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl323 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl323();
        }
        return INSTANCE;
    }

    private BasepPack2Impl323(){
