...
public class BasepPack1Impl395 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl395.class);
    private static BasepPack1Impl395 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl395 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl395();
        }
        return INSTANCE;
    }

    private BasepPack1Impl395(){
