...
public class ComplexpPack2Impl729 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl729.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl729 INSTANCE;

    public static ComplexpPack2Impl729 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl729();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl729(){
