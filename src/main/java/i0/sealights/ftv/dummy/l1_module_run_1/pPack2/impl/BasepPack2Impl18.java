...
public class BasepPack2Impl18 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl18.class);
    private static BasepPack2Impl18 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl18 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl18();
        }
        return INSTANCE;
    }

    private BasepPack2Impl18(){
