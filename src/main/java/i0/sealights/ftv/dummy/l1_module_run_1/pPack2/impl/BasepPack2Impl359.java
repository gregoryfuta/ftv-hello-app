...
public class BasepPack2Impl359 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl359.class);
    private static BasepPack2Impl359 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl359 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl359();
        }
        return INSTANCE;
    }

    private BasepPack2Impl359(){
