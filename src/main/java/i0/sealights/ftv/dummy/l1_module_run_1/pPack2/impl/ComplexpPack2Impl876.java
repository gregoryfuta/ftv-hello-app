...
public class ComplexpPack2Impl876 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl876.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl876 INSTANCE;

    public static ComplexpPack2Impl876 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl876();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl876(){
