...
public class ComplexpPack1Impl928 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl928.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl928 INSTANCE;

    public static ComplexpPack1Impl928 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl928();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl928(){
