...
public class ComplexpPack1Impl397 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl397.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl397 INSTANCE;

    public static ComplexpPack1Impl397 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl397();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl397(){
