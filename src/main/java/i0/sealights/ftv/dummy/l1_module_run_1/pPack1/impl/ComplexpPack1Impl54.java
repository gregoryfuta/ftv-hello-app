...
public class ComplexpPack1Impl54 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl54.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl54 INSTANCE;

    public static ComplexpPack1Impl54 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl54();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl54(){
