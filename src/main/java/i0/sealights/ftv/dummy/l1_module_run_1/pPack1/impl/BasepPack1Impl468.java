...
public class BasepPack1Impl468 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl468.class);
    private static BasepPack1Impl468 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl468 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl468();
        }
        return INSTANCE;
    }

    private BasepPack1Impl468(){
