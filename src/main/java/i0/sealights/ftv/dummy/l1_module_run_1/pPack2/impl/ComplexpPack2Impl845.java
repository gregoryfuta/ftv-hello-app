...
public class ComplexpPack2Impl845 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl845.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl845 INSTANCE;

    public static ComplexpPack2Impl845 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl845();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl845(){
