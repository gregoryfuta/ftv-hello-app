...
public class ComplexpPack2Impl285 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl285.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl285 INSTANCE;

    public static ComplexpPack2Impl285 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl285();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl285(){
