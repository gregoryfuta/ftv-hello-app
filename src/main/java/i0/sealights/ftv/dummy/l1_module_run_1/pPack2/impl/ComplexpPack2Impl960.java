...
public class ComplexpPack2Impl960 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl960.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl960 INSTANCE;

    public static ComplexpPack2Impl960 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl960();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl960(){
