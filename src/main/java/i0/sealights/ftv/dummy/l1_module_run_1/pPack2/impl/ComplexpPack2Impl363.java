...
public class ComplexpPack2Impl363 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl363.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl363 INSTANCE;

    public static ComplexpPack2Impl363 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl363();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl363(){
