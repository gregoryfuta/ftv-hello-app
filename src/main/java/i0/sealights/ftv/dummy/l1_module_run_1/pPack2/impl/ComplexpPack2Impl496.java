...
public class ComplexpPack2Impl496 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl496.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl496 INSTANCE;

    public static ComplexpPack2Impl496 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl496();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl496(){
