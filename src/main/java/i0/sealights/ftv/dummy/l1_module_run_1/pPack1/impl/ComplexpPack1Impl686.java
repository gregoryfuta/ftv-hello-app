...
public class ComplexpPack1Impl686 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl686.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl686 INSTANCE;

    public static ComplexpPack1Impl686 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl686();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl686(){
