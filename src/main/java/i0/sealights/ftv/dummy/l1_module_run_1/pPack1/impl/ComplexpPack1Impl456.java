...
public class ComplexpPack1Impl456 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl456.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl456 INSTANCE;

    public static ComplexpPack1Impl456 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl456();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl456(){
