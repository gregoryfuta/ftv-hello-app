...
public class ComplexpPack2Impl814 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl814.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl814 INSTANCE;

    public static ComplexpPack2Impl814 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl814();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl814(){
