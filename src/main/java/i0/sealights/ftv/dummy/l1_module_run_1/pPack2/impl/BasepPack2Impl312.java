...
public class BasepPack2Impl312 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl312.class);
    private static BasepPack2Impl312 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl312 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl312();
        }
        return INSTANCE;
    }

    private BasepPack2Impl312(){
