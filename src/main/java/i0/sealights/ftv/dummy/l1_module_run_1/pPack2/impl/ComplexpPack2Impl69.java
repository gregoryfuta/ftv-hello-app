...
public class ComplexpPack2Impl69 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl69.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl69 INSTANCE;

    public static ComplexpPack2Impl69 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl69();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl69(){
