...
public class BasepPack1Impl454 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl454.class);
    private static BasepPack1Impl454 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl454 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl454();
        }
        return INSTANCE;
    }

    private BasepPack1Impl454(){
