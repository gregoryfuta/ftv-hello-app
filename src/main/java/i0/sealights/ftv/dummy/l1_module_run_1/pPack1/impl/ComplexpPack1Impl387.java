...
public class ComplexpPack1Impl387 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl387.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl387 INSTANCE;

    public static ComplexpPack1Impl387 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl387();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl387(){
