...
public class ComplexpPack2Impl707 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl707.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl707 INSTANCE;

    public static ComplexpPack2Impl707 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl707();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl707(){
