...
public class ComplexpPack1Impl986 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl986.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl986 INSTANCE;

    public static ComplexpPack1Impl986 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl986();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl986(){
