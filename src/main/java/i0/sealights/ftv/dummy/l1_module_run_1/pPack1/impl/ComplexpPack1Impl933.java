...
public class ComplexpPack1Impl933 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl933.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl933 INSTANCE;

    public static ComplexpPack1Impl933 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl933();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl933(){
