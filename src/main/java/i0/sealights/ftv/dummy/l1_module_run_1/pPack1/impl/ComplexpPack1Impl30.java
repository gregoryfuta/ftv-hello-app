...
public class ComplexpPack1Impl30 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl30.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl30 INSTANCE;

    public static ComplexpPack1Impl30 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl30();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl30(){
