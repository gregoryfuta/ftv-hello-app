...
public class BasepPack2Impl477 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl477.class);
    private static BasepPack2Impl477 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl477 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl477();
        }
        return INSTANCE;
    }

    private BasepPack2Impl477(){
