...
public class ComplexpPack1Impl659 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl659.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl659 INSTANCE;

    public static ComplexpPack1Impl659 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl659();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl659(){
