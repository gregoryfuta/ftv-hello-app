...
public class ComplexpPack1Impl402 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl402.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl402 INSTANCE;

    public static ComplexpPack1Impl402 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl402();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl402(){
