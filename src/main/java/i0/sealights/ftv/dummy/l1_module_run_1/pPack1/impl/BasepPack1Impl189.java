...
public class BasepPack1Impl189 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl189.class);
    private static BasepPack1Impl189 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl189 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl189();
        }
        return INSTANCE;
    }

    private BasepPack1Impl189(){
