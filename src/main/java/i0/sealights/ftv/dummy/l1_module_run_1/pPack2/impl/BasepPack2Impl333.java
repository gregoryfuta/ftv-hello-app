...
public class BasepPack2Impl333 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl333.class);
    private static BasepPack2Impl333 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl333 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl333();
        }
        return INSTANCE;
    }

    private BasepPack2Impl333(){
