...
public class ComplexpPack2Impl614 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl614.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl614 INSTANCE;

    public static ComplexpPack2Impl614 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl614();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl614(){
