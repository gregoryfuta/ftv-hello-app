...
public class ComplexpPack1Impl617 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl617.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl617 INSTANCE;

    public static ComplexpPack1Impl617 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl617();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl617(){
