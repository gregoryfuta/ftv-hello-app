...
public class BasepPack2Impl15 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl15.class);
    private static BasepPack2Impl15 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl15 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl15();
        }
        return INSTANCE;
    }

    private BasepPack2Impl15(){
