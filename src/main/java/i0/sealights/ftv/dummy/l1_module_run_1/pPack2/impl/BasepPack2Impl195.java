...
public class BasepPack2Impl195 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl195.class);
    private static BasepPack2Impl195 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl195 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl195();
        }
        return INSTANCE;
    }

    private BasepPack2Impl195(){
