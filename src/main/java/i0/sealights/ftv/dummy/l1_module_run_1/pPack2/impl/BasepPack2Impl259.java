...
public class BasepPack2Impl259 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl259.class);
    private static BasepPack2Impl259 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl259 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl259();
        }
        return INSTANCE;
    }

    private BasepPack2Impl259(){
