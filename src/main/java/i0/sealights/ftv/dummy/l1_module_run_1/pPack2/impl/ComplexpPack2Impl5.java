...
public class ComplexpPack2Impl5 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl5.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl5 INSTANCE;

    public static ComplexpPack2Impl5 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl5();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl5(){
