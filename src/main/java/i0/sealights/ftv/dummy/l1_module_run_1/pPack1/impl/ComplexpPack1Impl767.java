...
public class ComplexpPack1Impl767 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl767.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl767 INSTANCE;

    public static ComplexpPack1Impl767 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl767();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl767(){
