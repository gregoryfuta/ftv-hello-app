...
public class BasepPack2Impl576 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl576.class);
    private static BasepPack2Impl576 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl576 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl576();
        }
        return INSTANCE;
    }

    private BasepPack2Impl576(){
