...
public class ComplexpPack2Impl758 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl758.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl758 INSTANCE;

    public static ComplexpPack2Impl758 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl758();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl758(){
