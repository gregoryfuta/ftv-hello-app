...
public class BasepPack1Impl67 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl67.class);
    private static BasepPack1Impl67 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl67 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl67();
        }
        return INSTANCE;
    }

    private BasepPack1Impl67(){
