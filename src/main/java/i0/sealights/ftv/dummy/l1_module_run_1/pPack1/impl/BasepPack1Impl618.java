...
public class BasepPack1Impl618 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl618.class);
    private static BasepPack1Impl618 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl618 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl618();
        }
        return INSTANCE;
    }

    private BasepPack1Impl618(){
