...
public class ComplexpPack1Impl79 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl79.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl79 INSTANCE;

    public static ComplexpPack1Impl79 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl79();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl79(){
