...
public class BasepPack1Impl409 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl409.class);
    private static BasepPack1Impl409 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl409 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl409();
        }
        return INSTANCE;
    }

    private BasepPack1Impl409(){
