...
public class BasepPack1Impl180 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl180.class);
    private static BasepPack1Impl180 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl180 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl180();
        }
        return INSTANCE;
    }

    private BasepPack1Impl180(){
