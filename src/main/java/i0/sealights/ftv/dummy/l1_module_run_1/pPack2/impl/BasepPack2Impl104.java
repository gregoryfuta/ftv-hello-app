...
public class BasepPack2Impl104 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl104.class);
    private static BasepPack2Impl104 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl104 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl104();
        }
        return INSTANCE;
    }

    private BasepPack2Impl104(){
