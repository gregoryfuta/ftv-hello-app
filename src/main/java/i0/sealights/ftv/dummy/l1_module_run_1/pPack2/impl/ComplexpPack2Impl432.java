...
public class ComplexpPack2Impl432 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl432.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl432 INSTANCE;

    public static ComplexpPack2Impl432 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl432();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl432(){
