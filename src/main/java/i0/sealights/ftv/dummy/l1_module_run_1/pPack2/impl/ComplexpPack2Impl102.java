...
public class ComplexpPack2Impl102 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl102.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl102 INSTANCE;

    public static ComplexpPack2Impl102 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl102();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl102(){
