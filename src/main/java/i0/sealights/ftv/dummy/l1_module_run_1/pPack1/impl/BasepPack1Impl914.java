...
public class BasepPack1Impl914 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl914.class);
    private static BasepPack1Impl914 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl914 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl914();
        }
        return INSTANCE;
    }

    private BasepPack1Impl914(){
