...
public class BasepPack2Impl392 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl392.class);
    private static BasepPack2Impl392 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl392 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl392();
        }
        return INSTANCE;
    }

    private BasepPack2Impl392(){
