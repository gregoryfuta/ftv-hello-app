...
public class BasepPack2Impl387 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl387.class);
    private static BasepPack2Impl387 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl387 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl387();
        }
        return INSTANCE;
    }

    private BasepPack2Impl387(){
