...
public class ComplexpPack2Impl822 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl822.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl822 INSTANCE;

    public static ComplexpPack2Impl822 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl822();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl822(){
