...
public class ComplexpPack1Impl308 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl308.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl308 INSTANCE;

    public static ComplexpPack1Impl308 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl308();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl308(){
