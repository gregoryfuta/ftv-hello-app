...
public class ComplexpPack1Impl228 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl228.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl228 INSTANCE;

    public static ComplexpPack1Impl228 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl228();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl228(){
