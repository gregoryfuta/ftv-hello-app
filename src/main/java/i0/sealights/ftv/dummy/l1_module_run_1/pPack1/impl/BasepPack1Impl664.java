...
public class BasepPack1Impl664 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl664.class);
    private static BasepPack1Impl664 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl664 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl664();
        }
        return INSTANCE;
    }

    private BasepPack1Impl664(){
