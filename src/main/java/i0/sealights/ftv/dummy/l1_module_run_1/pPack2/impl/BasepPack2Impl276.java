...
public class BasepPack2Impl276 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl276.class);
    private static BasepPack2Impl276 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl276 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl276();
        }
        return INSTANCE;
    }

    private BasepPack2Impl276(){
