...
public class ComplexpPack2Impl669 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl669.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl669 INSTANCE;

    public static ComplexpPack2Impl669 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl669();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl669(){
