...
public class ComplexpPack2Impl840 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl840.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl840 INSTANCE;

    public static ComplexpPack2Impl840 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl840();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl840(){
