...
public class ComplexpPack1Impl523 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl523.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl523 INSTANCE;

    public static ComplexpPack1Impl523 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl523();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl523(){
