...
public class BasepPack1Impl43 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl43.class);
    private static BasepPack1Impl43 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl43 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl43();
        }
        return INSTANCE;
    }

    private BasepPack1Impl43(){
