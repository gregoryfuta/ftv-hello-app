...
public class BasepPack2Impl629 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl629.class);
    private static BasepPack2Impl629 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl629 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl629();
        }
        return INSTANCE;
    }

    private BasepPack2Impl629(){
