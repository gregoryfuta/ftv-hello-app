...
public class BasepPack2Impl448 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl448.class);
    private static BasepPack2Impl448 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl448 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl448();
        }
        return INSTANCE;
    }

    private BasepPack2Impl448(){
