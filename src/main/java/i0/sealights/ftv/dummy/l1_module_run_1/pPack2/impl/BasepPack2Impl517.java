...
public class BasepPack2Impl517 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl517.class);
    private static BasepPack2Impl517 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl517 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl517();
        }
        return INSTANCE;
    }

    private BasepPack2Impl517(){
