...
public class ComplexpPack2Impl574 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl574.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl574 INSTANCE;

    public static ComplexpPack2Impl574 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl574();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl574(){
