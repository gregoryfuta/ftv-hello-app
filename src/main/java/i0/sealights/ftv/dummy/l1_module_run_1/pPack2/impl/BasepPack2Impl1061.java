...
public class BasepPack2Impl1061 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl1061.class);
    private static BasepPack2Impl1061 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl1061 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl1061();
        }
        return INSTANCE;
    }

    private BasepPack2Impl1061(){
