...
public class ComplexpPack2Impl60 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl60.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl60 INSTANCE;

    public static ComplexpPack2Impl60 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl60();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl60(){
