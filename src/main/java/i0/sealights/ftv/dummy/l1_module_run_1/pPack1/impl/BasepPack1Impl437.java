...
public class BasepPack1Impl437 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl437.class);
    private static BasepPack1Impl437 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl437 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl437();
        }
        return INSTANCE;
    }

    private BasepPack1Impl437(){
