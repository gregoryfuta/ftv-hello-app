...
public class ComplexpPack2Impl690 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl690.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl690 INSTANCE;

    public static ComplexpPack2Impl690 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl690();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl690(){
