...
public class BasepPack2Impl480 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl480.class);
    private static BasepPack2Impl480 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl480 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl480();
        }
        return INSTANCE;
    }

    private BasepPack2Impl480(){
