...
public class ComplexpPack2Impl230 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl230.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl230 INSTANCE;

    public static ComplexpPack2Impl230 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl230();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl230(){
