...
public class ComplexpPack1Impl218 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl218.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl218 INSTANCE;

    public static ComplexpPack1Impl218 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl218();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl218(){
