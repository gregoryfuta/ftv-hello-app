...
public class BasepPack2Impl747 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl747.class);
    private static BasepPack2Impl747 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl747 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl747();
        }
        return INSTANCE;
    }

    private BasepPack2Impl747(){
