...
public class BasepPack1Impl351 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl351.class);
    private static BasepPack1Impl351 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl351 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl351();
        }
        return INSTANCE;
    }

    private BasepPack1Impl351(){
