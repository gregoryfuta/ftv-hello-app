...
public class ComplexpPack1Impl1017 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1017.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1017 INSTANCE;

    public static ComplexpPack1Impl1017 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1017();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1017(){
