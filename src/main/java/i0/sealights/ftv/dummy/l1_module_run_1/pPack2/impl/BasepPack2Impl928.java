...
public class BasepPack2Impl928 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl928.class);
    private static BasepPack2Impl928 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl928 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl928();
        }
        return INSTANCE;
    }

    private BasepPack2Impl928(){
