...
public class ComplexpPack2Impl603 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl603.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl603 INSTANCE;

    public static ComplexpPack2Impl603 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl603();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl603(){
