...
public class ComplexpPack2Impl760 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl760.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl760 INSTANCE;

    public static ComplexpPack2Impl760 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl760();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl760(){
