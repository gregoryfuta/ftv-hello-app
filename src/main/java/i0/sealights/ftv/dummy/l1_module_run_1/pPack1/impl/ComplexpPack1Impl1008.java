...
public class ComplexpPack1Impl1008 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1008.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1008 INSTANCE;

    public static ComplexpPack1Impl1008 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1008();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1008(){
