...
public class ComplexpPack2Impl100 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl100.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl100 INSTANCE;

    public static ComplexpPack2Impl100 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl100();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl100(){
