...
public class ComplexpPack1Impl916 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl916.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl916 INSTANCE;

    public static ComplexpPack1Impl916 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl916();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl916(){
