...
public class BasepPack1Impl818 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl818.class);
    private static BasepPack1Impl818 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl818 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl818();
        }
        return INSTANCE;
    }

    private BasepPack1Impl818(){
