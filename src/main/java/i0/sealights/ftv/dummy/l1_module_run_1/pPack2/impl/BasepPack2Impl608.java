...
public class BasepPack2Impl608 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl608.class);
    private static BasepPack2Impl608 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl608 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl608();
        }
        return INSTANCE;
    }

    private BasepPack2Impl608(){
