...
public class ComplexpPack1Impl631 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl631.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl631 INSTANCE;

    public static ComplexpPack1Impl631 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl631();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl631(){
