...
public class BasepPack2Impl234 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl234.class);
    private static BasepPack2Impl234 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl234 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl234();
        }
        return INSTANCE;
    }

    private BasepPack2Impl234(){
