...
public class ComplexpPack1Impl838 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl838.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl838 INSTANCE;

    public static ComplexpPack1Impl838 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl838();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl838(){
