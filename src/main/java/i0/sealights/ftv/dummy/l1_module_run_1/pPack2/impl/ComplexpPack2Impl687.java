...
public class ComplexpPack2Impl687 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl687.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl687 INSTANCE;

    public static ComplexpPack2Impl687 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl687();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl687(){
