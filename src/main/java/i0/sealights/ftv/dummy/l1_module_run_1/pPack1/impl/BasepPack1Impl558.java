...
public class BasepPack1Impl558 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl558.class);
    private static BasepPack1Impl558 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl558 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl558();
        }
        return INSTANCE;
    }

    private BasepPack1Impl558(){
