...
public class BasepPack2Impl263 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl263.class);
    private static BasepPack2Impl263 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl263 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl263();
        }
        return INSTANCE;
    }

    private BasepPack2Impl263(){
