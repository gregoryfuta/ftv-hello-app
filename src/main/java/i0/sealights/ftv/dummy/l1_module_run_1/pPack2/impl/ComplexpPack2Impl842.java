...
public class ComplexpPack2Impl842 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl842.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl842 INSTANCE;

    public static ComplexpPack2Impl842 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl842();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl842(){
