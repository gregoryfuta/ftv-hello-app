...
public class ComplexpPack2Impl167 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl167.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl167 INSTANCE;

    public static ComplexpPack2Impl167 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl167();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl167(){
