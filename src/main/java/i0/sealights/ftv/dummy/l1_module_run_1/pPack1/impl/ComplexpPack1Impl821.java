...
public class ComplexpPack1Impl821 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl821.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl821 INSTANCE;

    public static ComplexpPack1Impl821 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl821();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl821(){
