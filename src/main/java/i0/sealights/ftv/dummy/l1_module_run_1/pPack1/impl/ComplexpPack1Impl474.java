...
public class ComplexpPack1Impl474 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl474.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl474 INSTANCE;

    public static ComplexpPack1Impl474 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl474();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl474(){
