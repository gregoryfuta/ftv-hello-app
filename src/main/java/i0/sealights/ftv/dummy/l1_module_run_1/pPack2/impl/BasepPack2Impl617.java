...
public class BasepPack2Impl617 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl617.class);
    private static BasepPack2Impl617 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl617 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl617();
        }
        return INSTANCE;
    }

    private BasepPack2Impl617(){
