...
public class ComplexpPack1Impl168 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl168.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl168 INSTANCE;

    public static ComplexpPack1Impl168 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl168();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl168(){
