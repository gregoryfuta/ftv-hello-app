...
public class ComplexpPack1Impl453 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl453.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl453 INSTANCE;

    public static ComplexpPack1Impl453 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl453();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl453(){
