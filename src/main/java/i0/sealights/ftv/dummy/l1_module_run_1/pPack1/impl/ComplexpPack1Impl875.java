...
public class ComplexpPack1Impl875 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl875.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl875 INSTANCE;

    public static ComplexpPack1Impl875 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl875();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl875(){
