...
public class ComplexpPack2Impl878 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl878.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl878 INSTANCE;

    public static ComplexpPack2Impl878 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl878();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl878(){
