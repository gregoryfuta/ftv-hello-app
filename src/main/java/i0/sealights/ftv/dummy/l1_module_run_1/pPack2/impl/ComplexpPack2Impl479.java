...
public class ComplexpPack2Impl479 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl479.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl479 INSTANCE;

    public static ComplexpPack2Impl479 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl479();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl479(){
