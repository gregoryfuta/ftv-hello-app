...
public class BasepPack2Impl775 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl775.class);
    private static BasepPack2Impl775 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl775 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl775();
        }
        return INSTANCE;
    }

    private BasepPack2Impl775(){
