...
public class BasepPack1Impl312 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl312.class);
    private static BasepPack1Impl312 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl312 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl312();
        }
        return INSTANCE;
    }

    private BasepPack1Impl312(){
