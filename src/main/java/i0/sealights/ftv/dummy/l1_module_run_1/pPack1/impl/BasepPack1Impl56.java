...
public class BasepPack1Impl56 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl56.class);
    private static BasepPack1Impl56 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl56 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl56();
        }
        return INSTANCE;
    }

    private BasepPack1Impl56(){
