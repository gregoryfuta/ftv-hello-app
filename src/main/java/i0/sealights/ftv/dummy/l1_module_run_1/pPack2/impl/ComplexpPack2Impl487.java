...
public class ComplexpPack2Impl487 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl487.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl487 INSTANCE;

    public static ComplexpPack2Impl487 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl487();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl487(){
