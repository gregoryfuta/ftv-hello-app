...
public class ComplexpPack1Impl493 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl493.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl493 INSTANCE;

    public static ComplexpPack1Impl493 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl493();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl493(){
