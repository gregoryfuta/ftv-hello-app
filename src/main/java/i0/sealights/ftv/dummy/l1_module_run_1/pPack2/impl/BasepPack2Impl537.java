...
public class BasepPack2Impl537 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl537.class);
    private static BasepPack2Impl537 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl537 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl537();
        }
        return INSTANCE;
    }

    private BasepPack2Impl537(){
