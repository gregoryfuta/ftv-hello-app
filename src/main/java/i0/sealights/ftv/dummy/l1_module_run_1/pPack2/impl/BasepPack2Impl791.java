...
public class BasepPack2Impl791 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl791.class);
    private static BasepPack2Impl791 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl791 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl791();
        }
        return INSTANCE;
    }

    private BasepPack2Impl791(){
