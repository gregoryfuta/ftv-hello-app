...
public class ComplexpPack1Impl427 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl427.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl427 INSTANCE;

    public static ComplexpPack1Impl427 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl427();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl427(){
