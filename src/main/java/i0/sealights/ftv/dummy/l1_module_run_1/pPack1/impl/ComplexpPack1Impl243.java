...
public class ComplexpPack1Impl243 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl243.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl243 INSTANCE;

    public static ComplexpPack1Impl243 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl243();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl243(){
