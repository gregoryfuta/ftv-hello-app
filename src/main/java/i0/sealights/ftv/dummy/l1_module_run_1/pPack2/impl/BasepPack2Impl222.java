...
public class BasepPack2Impl222 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl222.class);
    private static BasepPack2Impl222 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl222 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl222();
        }
        return INSTANCE;
    }

    private BasepPack2Impl222(){
