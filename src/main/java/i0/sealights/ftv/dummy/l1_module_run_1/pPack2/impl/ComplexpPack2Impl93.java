...
public class ComplexpPack2Impl93 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl93.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl93 INSTANCE;

    public static ComplexpPack2Impl93 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl93();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl93(){
