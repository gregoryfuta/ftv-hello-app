...
public class ComplexpPack2Impl347 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl347.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl347 INSTANCE;

    public static ComplexpPack2Impl347 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl347();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl347(){
