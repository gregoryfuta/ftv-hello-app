...
public class ComplexpPack2Impl881 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl881.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl881 INSTANCE;

    public static ComplexpPack2Impl881 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl881();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl881(){
