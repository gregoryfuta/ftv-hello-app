...
public class BasepPack1Impl26 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl26.class);
    private static BasepPack1Impl26 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl26 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl26();
        }
        return INSTANCE;
    }

    private BasepPack1Impl26(){
