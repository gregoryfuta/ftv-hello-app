...
public class BasepPack2Impl411 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl411.class);
    private static BasepPack2Impl411 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl411 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl411();
        }
        return INSTANCE;
    }

    private BasepPack2Impl411(){
