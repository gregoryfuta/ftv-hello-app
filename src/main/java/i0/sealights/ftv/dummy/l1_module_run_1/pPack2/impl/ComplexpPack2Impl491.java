...
public class ComplexpPack2Impl491 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl491.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl491 INSTANCE;

    public static ComplexpPack2Impl491 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl491();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl491(){
