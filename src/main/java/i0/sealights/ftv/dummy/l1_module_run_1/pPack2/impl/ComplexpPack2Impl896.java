...
public class ComplexpPack2Impl896 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl896.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl896 INSTANCE;

    public static ComplexpPack2Impl896 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl896();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl896(){
