...
public class ComplexpPack1Impl532 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl532.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl532 INSTANCE;

    public static ComplexpPack1Impl532 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl532();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl532(){
