...
public class ComplexpPack2Impl113 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl113.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl113 INSTANCE;

    public static ComplexpPack2Impl113 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl113();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl113(){
