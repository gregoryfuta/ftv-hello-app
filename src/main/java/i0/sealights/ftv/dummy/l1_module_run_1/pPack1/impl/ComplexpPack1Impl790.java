...
public class ComplexpPack1Impl790 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl790.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl790 INSTANCE;

    public static ComplexpPack1Impl790 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl790();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl790(){
