...
public class ComplexpPack2Impl405 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl405.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl405 INSTANCE;

    public static ComplexpPack2Impl405 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl405();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl405(){
