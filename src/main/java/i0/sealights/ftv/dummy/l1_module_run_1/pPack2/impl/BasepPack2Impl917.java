...
public class BasepPack2Impl917 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl917.class);
    private static BasepPack2Impl917 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl917 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl917();
        }
        return INSTANCE;
    }

    private BasepPack2Impl917(){
