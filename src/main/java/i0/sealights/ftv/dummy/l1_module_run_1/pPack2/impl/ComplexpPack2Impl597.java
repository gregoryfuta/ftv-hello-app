...
public class ComplexpPack2Impl597 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl597.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl597 INSTANCE;

    public static ComplexpPack2Impl597 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl597();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl597(){
