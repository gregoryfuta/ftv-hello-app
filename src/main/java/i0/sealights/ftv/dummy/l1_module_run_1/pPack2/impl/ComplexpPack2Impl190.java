...
public class ComplexpPack2Impl190 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl190.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl190 INSTANCE;

    public static ComplexpPack2Impl190 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl190();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl190(){
