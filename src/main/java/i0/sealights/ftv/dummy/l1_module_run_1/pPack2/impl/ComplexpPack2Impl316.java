...
public class ComplexpPack2Impl316 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl316.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl316 INSTANCE;

    public static ComplexpPack2Impl316 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl316();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl316(){
