...
public class ComplexpPack2Impl558 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl558.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl558 INSTANCE;

    public static ComplexpPack2Impl558 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl558();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl558(){
