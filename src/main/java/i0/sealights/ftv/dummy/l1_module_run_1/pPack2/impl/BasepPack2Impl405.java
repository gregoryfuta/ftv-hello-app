...
public class BasepPack2Impl405 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl405.class);
    private static BasepPack2Impl405 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl405 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl405();
        }
        return INSTANCE;
    }

    private BasepPack2Impl405(){
