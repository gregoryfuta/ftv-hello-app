...
public class ComplexpPack1Impl946 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl946.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl946 INSTANCE;

    public static ComplexpPack1Impl946 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl946();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl946(){
