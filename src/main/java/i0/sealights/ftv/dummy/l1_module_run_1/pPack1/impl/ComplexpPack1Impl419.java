...
public class ComplexpPack1Impl419 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl419.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl419 INSTANCE;

    public static ComplexpPack1Impl419 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl419();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl419(){
