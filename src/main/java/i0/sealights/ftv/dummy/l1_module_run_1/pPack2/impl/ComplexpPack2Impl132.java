...
public class ComplexpPack2Impl132 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl132.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl132 INSTANCE;

    public static ComplexpPack2Impl132 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl132();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl132(){
