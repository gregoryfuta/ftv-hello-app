...
public class ComplexpPack2Impl578 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl578.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl578 INSTANCE;

    public static ComplexpPack2Impl578 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl578();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl578(){
