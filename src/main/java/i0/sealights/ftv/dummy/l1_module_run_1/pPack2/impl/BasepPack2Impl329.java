...
public class BasepPack2Impl329 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl329.class);
    private static BasepPack2Impl329 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl329 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl329();
        }
        return INSTANCE;
    }

    private BasepPack2Impl329(){
