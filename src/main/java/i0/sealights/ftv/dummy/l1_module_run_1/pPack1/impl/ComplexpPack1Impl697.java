...
public class ComplexpPack1Impl697 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl697.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl697 INSTANCE;

    public static ComplexpPack1Impl697 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl697();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl697(){
