...
public class ComplexpPack2Impl345 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl345.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl345 INSTANCE;

    public static ComplexpPack2Impl345 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl345();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl345(){
