...
public class ComplexpPack1Impl219 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl219.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl219 INSTANCE;

    public static ComplexpPack1Impl219 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl219();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl219(){
