...
public class BasepPack2Impl109 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl109.class);
    private static BasepPack2Impl109 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl109 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl109();
        }
        return INSTANCE;
    }

    private BasepPack2Impl109(){
