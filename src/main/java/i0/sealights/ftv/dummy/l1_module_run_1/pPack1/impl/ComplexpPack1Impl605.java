...
public class ComplexpPack1Impl605 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl605.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl605 INSTANCE;

    public static ComplexpPack1Impl605 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl605();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl605(){
