...
public class ComplexpPack2Impl875 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl875.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl875 INSTANCE;

    public static ComplexpPack2Impl875 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl875();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl875(){
