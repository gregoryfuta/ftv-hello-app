...
public class BasepPack2Impl345 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl345.class);
    private static BasepPack2Impl345 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl345 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl345();
        }
        return INSTANCE;
    }

    private BasepPack2Impl345(){
