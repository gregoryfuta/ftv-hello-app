...
public class BasepPack2Impl173 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl173.class);
    private static BasepPack2Impl173 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl173 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl173();
        }
        return INSTANCE;
    }

    private BasepPack2Impl173(){
