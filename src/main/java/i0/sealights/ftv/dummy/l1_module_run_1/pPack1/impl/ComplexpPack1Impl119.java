...
public class ComplexpPack1Impl119 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl119.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl119 INSTANCE;

    public static ComplexpPack1Impl119 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl119();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl119(){
