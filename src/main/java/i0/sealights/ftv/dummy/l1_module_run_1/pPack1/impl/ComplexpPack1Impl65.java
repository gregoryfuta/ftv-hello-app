...
public class ComplexpPack1Impl65 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl65.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl65 INSTANCE;

    public static ComplexpPack1Impl65 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl65();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl65(){
