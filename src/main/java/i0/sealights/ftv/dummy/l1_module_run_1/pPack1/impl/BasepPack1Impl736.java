...
public class BasepPack1Impl736 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl736.class);
    private static BasepPack1Impl736 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl736 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl736();
        }
        return INSTANCE;
    }

    private BasepPack1Impl736(){
