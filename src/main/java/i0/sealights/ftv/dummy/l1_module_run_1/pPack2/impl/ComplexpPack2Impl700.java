...
public class ComplexpPack2Impl700 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl700.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl700 INSTANCE;

    public static ComplexpPack2Impl700 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl700();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl700(){
