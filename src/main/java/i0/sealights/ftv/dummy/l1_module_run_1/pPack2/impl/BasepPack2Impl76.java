...
public class BasepPack2Impl76 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl76.class);
    private static BasepPack2Impl76 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl76 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl76();
        }
        return INSTANCE;
    }

    private BasepPack2Impl76(){
