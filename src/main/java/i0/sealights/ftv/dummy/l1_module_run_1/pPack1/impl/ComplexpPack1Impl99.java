...
public class ComplexpPack1Impl99 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl99.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl99 INSTANCE;

    public static ComplexpPack1Impl99 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl99();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl99(){
