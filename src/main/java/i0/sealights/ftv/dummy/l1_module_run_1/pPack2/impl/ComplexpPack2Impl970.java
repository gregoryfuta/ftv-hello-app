...
public class ComplexpPack2Impl970 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl970.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl970 INSTANCE;

    public static ComplexpPack2Impl970 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl970();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl970(){
