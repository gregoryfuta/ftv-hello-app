...
public class ComplexpPack1Impl275 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl275.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl275 INSTANCE;

    public static ComplexpPack1Impl275 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl275();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl275(){
