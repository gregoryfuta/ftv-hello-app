...
public class ComplexpPack2Impl9 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl9.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl9 INSTANCE;

    public static ComplexpPack2Impl9 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl9();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl9(){
