...
public class ComplexpPack2Impl899 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl899.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl899 INSTANCE;

    public static ComplexpPack2Impl899 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl899();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl899(){
