...
public class ComplexpPack1Impl16 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl16.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl16 INSTANCE;

    public static ComplexpPack1Impl16 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl16();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl16(){
