...
public class ComplexpPack2Impl764 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl764.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl764 INSTANCE;

    public static ComplexpPack2Impl764 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl764();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl764(){
