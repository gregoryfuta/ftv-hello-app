...
public class ComplexpPack1Impl252 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl252.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl252 INSTANCE;

    public static ComplexpPack1Impl252 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl252();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl252(){
