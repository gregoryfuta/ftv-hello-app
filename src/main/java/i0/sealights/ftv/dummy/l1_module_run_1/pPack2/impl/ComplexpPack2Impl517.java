...
public class ComplexpPack2Impl517 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl517.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl517 INSTANCE;

    public static ComplexpPack2Impl517 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl517();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl517(){
