...
public class BasepPack2Impl474 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl474.class);
    private static BasepPack2Impl474 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl474 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl474();
        }
        return INSTANCE;
    }

    private BasepPack2Impl474(){
