...
public class ComplexpPack1Impl446 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl446.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl446 INSTANCE;

    public static ComplexpPack1Impl446 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl446();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl446(){
