...
public class BasepPack1Impl961 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl961.class);
    private static BasepPack1Impl961 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl961 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl961();
        }
        return INSTANCE;
    }

    private BasepPack1Impl961(){
