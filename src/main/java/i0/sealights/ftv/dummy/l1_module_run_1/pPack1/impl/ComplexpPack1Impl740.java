...
public class ComplexpPack1Impl740 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl740.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl740 INSTANCE;

    public static ComplexpPack1Impl740 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl740();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl740(){
