...
public class BasepPack2Impl811 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl811.class);
    private static BasepPack2Impl811 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl811 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl811();
        }
        return INSTANCE;
    }

    private BasepPack2Impl811(){
