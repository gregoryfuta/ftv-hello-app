...
public class BasepPack2Impl877 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl877.class);
    private static BasepPack2Impl877 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl877 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl877();
        }
        return INSTANCE;
    }

    private BasepPack2Impl877(){
