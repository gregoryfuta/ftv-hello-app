...
public class BasepPack2Impl671 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl671.class);
    private static BasepPack2Impl671 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl671 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl671();
        }
        return INSTANCE;
    }

    private BasepPack2Impl671(){
