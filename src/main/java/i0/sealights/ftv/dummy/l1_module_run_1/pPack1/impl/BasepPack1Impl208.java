...
public class BasepPack1Impl208 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl208.class);
    private static BasepPack1Impl208 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl208 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl208();
        }
        return INSTANCE;
    }

    private BasepPack1Impl208(){
