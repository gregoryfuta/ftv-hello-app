...
public class BasepPack1Impl984 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl984.class);
    private static BasepPack1Impl984 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl984 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl984();
        }
        return INSTANCE;
    }

    private BasepPack1Impl984(){
