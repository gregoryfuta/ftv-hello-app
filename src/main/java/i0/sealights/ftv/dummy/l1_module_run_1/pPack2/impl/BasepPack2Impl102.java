...
public class BasepPack2Impl102 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl102.class);
    private static BasepPack2Impl102 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl102 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl102();
        }
        return INSTANCE;
    }

    private BasepPack2Impl102(){
