...
public class ComplexpPack2Impl222 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl222.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl222 INSTANCE;

    public static ComplexpPack2Impl222 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl222();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl222(){
