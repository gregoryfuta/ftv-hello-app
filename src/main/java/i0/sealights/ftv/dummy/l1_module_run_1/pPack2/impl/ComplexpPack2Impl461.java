...
public class ComplexpPack2Impl461 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl461.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl461 INSTANCE;

    public static ComplexpPack2Impl461 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl461();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl461(){
