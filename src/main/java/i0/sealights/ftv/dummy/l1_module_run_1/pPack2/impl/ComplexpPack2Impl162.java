...
public class ComplexpPack2Impl162 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl162.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl162 INSTANCE;

    public static ComplexpPack2Impl162 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl162();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl162(){
