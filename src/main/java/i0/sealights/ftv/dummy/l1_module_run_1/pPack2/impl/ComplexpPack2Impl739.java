...
public class ComplexpPack2Impl739 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl739.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl739 INSTANCE;

    public static ComplexpPack2Impl739 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl739();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl739(){
