...
public class BasepPack1Impl903 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl903.class);
    private static BasepPack1Impl903 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl903 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl903();
        }
        return INSTANCE;
    }

    private BasepPack1Impl903(){
