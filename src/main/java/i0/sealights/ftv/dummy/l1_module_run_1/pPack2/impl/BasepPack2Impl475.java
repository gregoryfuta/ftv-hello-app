...
public class BasepPack2Impl475 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl475.class);
    private static BasepPack2Impl475 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl475 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl475();
        }
        return INSTANCE;
    }

    private BasepPack2Impl475(){
