...
public class ComplexpPack1Impl544 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl544.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl544 INSTANCE;

    public static ComplexpPack1Impl544 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl544();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl544(){
