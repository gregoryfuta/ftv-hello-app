...
public class ComplexpPack1Impl151 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl151.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl151 INSTANCE;

    public static ComplexpPack1Impl151 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl151();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl151(){
