...
public class BasepPack1Impl872 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl872.class);
    private static BasepPack1Impl872 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl872 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl872();
        }
        return INSTANCE;
    }

    private BasepPack1Impl872(){
