...
public class BasepPack1Impl956 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl956.class);
    private static BasepPack1Impl956 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl956 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl956();
        }
        return INSTANCE;
    }

    private BasepPack1Impl956(){
