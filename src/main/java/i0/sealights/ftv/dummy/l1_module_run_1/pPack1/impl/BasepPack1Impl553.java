...
public class BasepPack1Impl553 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl553.class);
    private static BasepPack1Impl553 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl553 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl553();
        }
        return INSTANCE;
    }

    private BasepPack1Impl553(){
