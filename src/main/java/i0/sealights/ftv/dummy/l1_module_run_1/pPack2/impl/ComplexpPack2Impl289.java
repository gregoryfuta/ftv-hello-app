...
public class ComplexpPack2Impl289 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl289.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl289 INSTANCE;

    public static ComplexpPack2Impl289 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl289();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl289(){
