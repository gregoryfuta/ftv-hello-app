...
public class ComplexpPack2Impl63 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl63.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl63 INSTANCE;

    public static ComplexpPack2Impl63 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl63();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl63(){
