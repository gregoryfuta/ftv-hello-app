...
public class ComplexpPack1Impl707 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl707.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl707 INSTANCE;

    public static ComplexpPack1Impl707 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl707();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl707(){
