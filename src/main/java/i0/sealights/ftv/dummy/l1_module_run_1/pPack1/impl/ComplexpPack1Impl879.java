...
public class ComplexpPack1Impl879 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl879.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl879 INSTANCE;

    public static ComplexpPack1Impl879 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl879();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl879(){
