...
public class BasepPack1Impl880 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl880.class);
    private static BasepPack1Impl880 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl880 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl880();
        }
        return INSTANCE;
    }

    private BasepPack1Impl880(){
