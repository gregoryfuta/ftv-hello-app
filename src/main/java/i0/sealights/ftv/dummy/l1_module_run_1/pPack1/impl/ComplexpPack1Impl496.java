...
public class ComplexpPack1Impl496 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl496.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl496 INSTANCE;

    public static ComplexpPack1Impl496 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl496();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl496(){
