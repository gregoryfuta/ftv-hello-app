...
public class ComplexpPack2Impl283 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl283.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl283 INSTANCE;

    public static ComplexpPack2Impl283 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl283();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl283(){
