...
public class ComplexpPack2Impl377 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl377.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl377 INSTANCE;

    public static ComplexpPack2Impl377 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl377();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl377(){
