...
public class BasepPack2Impl149 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl149.class);
    private static BasepPack2Impl149 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl149 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl149();
        }
        return INSTANCE;
    }

    private BasepPack2Impl149(){
