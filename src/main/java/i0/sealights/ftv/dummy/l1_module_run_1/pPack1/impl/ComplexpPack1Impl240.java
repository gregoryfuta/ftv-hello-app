...
public class ComplexpPack1Impl240 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl240.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl240 INSTANCE;

    public static ComplexpPack1Impl240 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl240();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl240(){
