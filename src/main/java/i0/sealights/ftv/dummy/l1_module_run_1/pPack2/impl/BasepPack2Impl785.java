...
public class BasepPack2Impl785 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl785.class);
    private static BasepPack2Impl785 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl785 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl785();
        }
        return INSTANCE;
    }

    private BasepPack2Impl785(){
