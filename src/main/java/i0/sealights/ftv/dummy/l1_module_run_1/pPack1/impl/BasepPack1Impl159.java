...
public class BasepPack1Impl159 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl159.class);
    private static BasepPack1Impl159 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl159 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl159();
        }
        return INSTANCE;
    }

    private BasepPack1Impl159(){
