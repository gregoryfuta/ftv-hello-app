...
public class BasepPack1Impl480 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl480.class);
    private static BasepPack1Impl480 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl480 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl480();
        }
        return INSTANCE;
    }

    private BasepPack1Impl480(){
