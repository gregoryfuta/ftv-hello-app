...
public class BasepPack2Impl51 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl51.class);
    private static BasepPack2Impl51 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl51 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl51();
        }
        return INSTANCE;
    }

    private BasepPack2Impl51(){
