...
public class BasepPack1Impl158 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl158.class);
    private static BasepPack1Impl158 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl158 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl158();
        }
        return INSTANCE;
    }

    private BasepPack1Impl158(){
