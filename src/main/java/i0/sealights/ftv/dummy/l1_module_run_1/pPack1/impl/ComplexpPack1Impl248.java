...
public class ComplexpPack1Impl248 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl248.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl248 INSTANCE;

    public static ComplexpPack1Impl248 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl248();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl248(){
