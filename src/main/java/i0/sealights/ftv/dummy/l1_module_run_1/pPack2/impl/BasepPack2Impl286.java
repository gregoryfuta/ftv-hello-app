...
public class BasepPack2Impl286 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl286.class);
    private static BasepPack2Impl286 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl286 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl286();
        }
        return INSTANCE;
    }

    private BasepPack2Impl286(){
