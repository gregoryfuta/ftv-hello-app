...
public class BasepPack1Impl850 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl850.class);
    private static BasepPack1Impl850 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl850 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl850();
        }
        return INSTANCE;
    }

    private BasepPack1Impl850(){
