...
public class ComplexpPack2Impl106 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl106.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl106 INSTANCE;

    public static ComplexpPack2Impl106 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl106();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl106(){
