...
public class BasepPack2Impl666 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl666.class);
    private static BasepPack2Impl666 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl666 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl666();
        }
        return INSTANCE;
    }

    private BasepPack2Impl666(){
