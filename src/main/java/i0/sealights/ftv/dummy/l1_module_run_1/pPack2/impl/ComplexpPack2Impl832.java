...
public class ComplexpPack2Impl832 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl832.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl832 INSTANCE;

    public static ComplexpPack2Impl832 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl832();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl832(){
