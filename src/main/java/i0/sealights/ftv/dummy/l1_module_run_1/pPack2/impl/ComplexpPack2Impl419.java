...
public class ComplexpPack2Impl419 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl419.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl419 INSTANCE;

    public static ComplexpPack2Impl419 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl419();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl419(){
