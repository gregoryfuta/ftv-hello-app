...
public class ComplexpPack2Impl991 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl991.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl991 INSTANCE;

    public static ComplexpPack2Impl991 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl991();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl991(){
