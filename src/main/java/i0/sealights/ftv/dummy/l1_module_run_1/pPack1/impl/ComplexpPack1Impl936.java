...
public class ComplexpPack1Impl936 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl936.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl936 INSTANCE;

    public static ComplexpPack1Impl936 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl936();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl936(){
