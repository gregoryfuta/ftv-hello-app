...
public class ComplexpPack2Impl746 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl746.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl746 INSTANCE;

    public static ComplexpPack2Impl746 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl746();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl746(){
