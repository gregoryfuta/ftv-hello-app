...
public class ComplexpPack1Impl873 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl873.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl873 INSTANCE;

    public static ComplexpPack1Impl873 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl873();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl873(){
