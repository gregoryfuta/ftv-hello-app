...
public class BasepPack2Impl589 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl589.class);
    private static BasepPack2Impl589 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl589 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl589();
        }
        return INSTANCE;
    }

    private BasepPack2Impl589(){
