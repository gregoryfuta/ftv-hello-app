...
public class ComplexpPack2Impl12 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl12.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl12 INSTANCE;

    public static ComplexpPack2Impl12 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl12();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl12(){
