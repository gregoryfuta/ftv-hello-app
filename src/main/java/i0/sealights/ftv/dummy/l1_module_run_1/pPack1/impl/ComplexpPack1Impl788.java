...
public class ComplexpPack1Impl788 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl788.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl788 INSTANCE;

    public static ComplexpPack1Impl788 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl788();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl788(){
