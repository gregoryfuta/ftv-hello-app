...
public class ComplexpPack2Impl228 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl228.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl228 INSTANCE;

    public static ComplexpPack2Impl228 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl228();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl228(){
