...
public class ComplexpPack1Impl992 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl992.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl992 INSTANCE;

    public static ComplexpPack1Impl992 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl992();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl992(){
