...
public class ComplexpPack2Impl264 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl264.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl264 INSTANCE;

    public static ComplexpPack2Impl264 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl264();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl264(){
