...
public class ComplexpPack1Impl876 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl876.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl876 INSTANCE;

    public static ComplexpPack1Impl876 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl876();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl876(){
