...
public class BasepPack2Impl404 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl404.class);
    private static BasepPack2Impl404 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl404 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl404();
        }
        return INSTANCE;
    }

    private BasepPack2Impl404(){
