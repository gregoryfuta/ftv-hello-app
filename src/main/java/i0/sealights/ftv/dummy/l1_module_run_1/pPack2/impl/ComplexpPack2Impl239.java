...
public class ComplexpPack2Impl239 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl239.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl239 INSTANCE;

    public static ComplexpPack2Impl239 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl239();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl239(){
