...
public class ComplexpPack2Impl273 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl273.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl273 INSTANCE;

    public static ComplexpPack2Impl273 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl273();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl273(){
