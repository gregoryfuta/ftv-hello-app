...
public class ComplexpPack1Impl159 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl159.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl159 INSTANCE;

    public static ComplexpPack1Impl159 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl159();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl159(){
