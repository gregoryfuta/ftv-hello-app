...
public class BasepPack1Impl672 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl672.class);
    private static BasepPack1Impl672 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl672 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl672();
        }
        return INSTANCE;
    }

    private BasepPack1Impl672(){
