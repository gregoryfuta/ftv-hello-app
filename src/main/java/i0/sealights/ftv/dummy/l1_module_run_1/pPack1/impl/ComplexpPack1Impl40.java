...
public class ComplexpPack1Impl40 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl40.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl40 INSTANCE;

    public static ComplexpPack1Impl40 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl40();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl40(){
