...
public class ComplexpPack1Impl721 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl721.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl721 INSTANCE;

    public static ComplexpPack1Impl721 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl721();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl721(){
