...
public class BasepPack2Impl946 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl946.class);
    private static BasepPack2Impl946 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl946 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl946();
        }
        return INSTANCE;
    }

    private BasepPack2Impl946(){
