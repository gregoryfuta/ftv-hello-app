...
public class BasepPack2Impl153 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl153.class);
    private static BasepPack2Impl153 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl153 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl153();
        }
        return INSTANCE;
    }

    private BasepPack2Impl153(){
