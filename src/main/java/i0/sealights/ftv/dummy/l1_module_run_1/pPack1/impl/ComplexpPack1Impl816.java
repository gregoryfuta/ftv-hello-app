...
public class ComplexpPack1Impl816 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl816.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl816 INSTANCE;

    public static ComplexpPack1Impl816 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl816();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl816(){
