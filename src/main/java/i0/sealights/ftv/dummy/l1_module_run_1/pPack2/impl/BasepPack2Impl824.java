...
public class BasepPack2Impl824 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl824.class);
    private static BasepPack2Impl824 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl824 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl824();
        }
        return INSTANCE;
    }

    private BasepPack2Impl824(){
