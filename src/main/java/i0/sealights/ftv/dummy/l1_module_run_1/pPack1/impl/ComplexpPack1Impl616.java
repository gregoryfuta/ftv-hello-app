...
public class ComplexpPack1Impl616 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl616.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl616 INSTANCE;

    public static ComplexpPack1Impl616 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl616();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl616(){
