...
public class ComplexpPack1Impl22 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl22.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl22 INSTANCE;

    public static ComplexpPack1Impl22 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl22();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl22(){
