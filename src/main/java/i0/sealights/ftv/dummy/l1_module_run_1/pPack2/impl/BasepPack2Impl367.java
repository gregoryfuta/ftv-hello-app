...
public class BasepPack2Impl367 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl367.class);
    private static BasepPack2Impl367 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl367 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl367();
        }
        return INSTANCE;
    }

    private BasepPack2Impl367(){
