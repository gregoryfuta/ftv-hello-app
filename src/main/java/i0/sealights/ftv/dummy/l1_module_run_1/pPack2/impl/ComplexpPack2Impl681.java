...
public class ComplexpPack2Impl681 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl681.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl681 INSTANCE;

    public static ComplexpPack2Impl681 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl681();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl681(){
