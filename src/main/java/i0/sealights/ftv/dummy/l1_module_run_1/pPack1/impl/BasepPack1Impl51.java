...
public class BasepPack1Impl51 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl51.class);
    private static BasepPack1Impl51 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl51 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl51();
        }
        return INSTANCE;
    }

    private BasepPack1Impl51(){
