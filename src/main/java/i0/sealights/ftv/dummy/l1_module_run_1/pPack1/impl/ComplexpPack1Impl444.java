...
public class ComplexpPack1Impl444 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl444.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl444 INSTANCE;

    public static ComplexpPack1Impl444 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl444();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl444(){
