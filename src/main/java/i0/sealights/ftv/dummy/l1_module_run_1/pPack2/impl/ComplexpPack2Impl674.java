...
public class ComplexpPack2Impl674 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl674.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl674 INSTANCE;

    public static ComplexpPack2Impl674 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl674();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl674(){
