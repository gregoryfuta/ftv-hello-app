...
public class ComplexpPack2Impl736 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl736.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl736 INSTANCE;

    public static ComplexpPack2Impl736 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl736();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl736(){
