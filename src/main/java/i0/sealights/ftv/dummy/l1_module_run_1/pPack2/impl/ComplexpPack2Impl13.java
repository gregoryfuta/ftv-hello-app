...
public class ComplexpPack2Impl13 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl13.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl13 INSTANCE;

    public static ComplexpPack2Impl13 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl13();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl13(){
