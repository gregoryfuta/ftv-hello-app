...
public class BasepPack2Impl512 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl512.class);
    private static BasepPack2Impl512 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl512 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl512();
        }
        return INSTANCE;
    }

    private BasepPack2Impl512(){
