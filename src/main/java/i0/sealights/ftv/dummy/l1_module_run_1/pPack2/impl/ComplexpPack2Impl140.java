...
public class ComplexpPack2Impl140 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl140.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl140 INSTANCE;

    public static ComplexpPack2Impl140 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl140();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl140(){
