...
public class ComplexpPack2Impl46 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl46.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl46 INSTANCE;

    public static ComplexpPack2Impl46 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl46();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl46(){
