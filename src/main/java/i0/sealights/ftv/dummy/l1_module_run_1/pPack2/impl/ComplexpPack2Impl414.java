...
public class ComplexpPack2Impl414 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl414.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl414 INSTANCE;

    public static ComplexpPack2Impl414 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl414();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl414(){
