...
public class BasepPack2Impl454 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl454.class);
    private static BasepPack2Impl454 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl454 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl454();
        }
        return INSTANCE;
    }

    private BasepPack2Impl454(){
