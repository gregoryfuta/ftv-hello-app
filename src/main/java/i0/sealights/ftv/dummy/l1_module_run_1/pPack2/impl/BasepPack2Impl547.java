...
public class BasepPack2Impl547 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl547.class);
    private static BasepPack2Impl547 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl547 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl547();
        }
        return INSTANCE;
    }

    private BasepPack2Impl547(){
