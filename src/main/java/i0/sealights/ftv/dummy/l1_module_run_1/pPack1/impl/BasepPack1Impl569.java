...
public class BasepPack1Impl569 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl569.class);
    private static BasepPack1Impl569 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl569 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl569();
        }
        return INSTANCE;
    }

    private BasepPack1Impl569(){
