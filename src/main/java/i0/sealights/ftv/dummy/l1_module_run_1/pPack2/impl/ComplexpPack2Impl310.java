...
public class ComplexpPack2Impl310 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl310.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl310 INSTANCE;

    public static ComplexpPack2Impl310 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl310();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl310(){
