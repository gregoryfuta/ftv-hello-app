...
public class ComplexpPack2Impl631 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl631.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl631 INSTANCE;

    public static ComplexpPack2Impl631 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl631();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl631(){
