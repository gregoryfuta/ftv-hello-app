...
public class ComplexpPack1Impl508 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl508.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl508 INSTANCE;

    public static ComplexpPack1Impl508 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl508();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl508(){
