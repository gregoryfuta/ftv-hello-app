...
public class ComplexpPack1Impl69 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl69.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl69 INSTANCE;

    public static ComplexpPack1Impl69 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl69();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl69(){
