...
public class ComplexpPack2Impl870 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl870.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl870 INSTANCE;

    public static ComplexpPack2Impl870 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl870();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl870(){
