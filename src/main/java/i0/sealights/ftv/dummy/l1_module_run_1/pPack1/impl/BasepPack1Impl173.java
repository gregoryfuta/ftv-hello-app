...
public class BasepPack1Impl173 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl173.class);
    private static BasepPack1Impl173 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl173 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl173();
        }
        return INSTANCE;
    }

    private BasepPack1Impl173(){
