...
public class ComplexpPack1Impl1014 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1014.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1014 INSTANCE;

    public static ComplexpPack1Impl1014 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1014();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1014(){
