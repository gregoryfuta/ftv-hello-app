...
public class BasepPack2Impl368 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl368.class);
    private static BasepPack2Impl368 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl368 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl368();
        }
        return INSTANCE;
    }

    private BasepPack2Impl368(){
