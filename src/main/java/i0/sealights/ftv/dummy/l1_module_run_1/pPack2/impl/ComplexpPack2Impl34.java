...
public class ComplexpPack2Impl34 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl34.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl34 INSTANCE;

    public static ComplexpPack2Impl34 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl34();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl34(){
