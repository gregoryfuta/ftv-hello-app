...
public class BasepPack2Impl460 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl460.class);
    private static BasepPack2Impl460 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl460 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl460();
        }
        return INSTANCE;
    }

    private BasepPack2Impl460(){
