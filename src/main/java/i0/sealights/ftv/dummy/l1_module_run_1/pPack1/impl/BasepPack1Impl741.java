...
public class BasepPack1Impl741 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl741.class);
    private static BasepPack1Impl741 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl741 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl741();
        }
        return INSTANCE;
    }

    private BasepPack1Impl741(){
