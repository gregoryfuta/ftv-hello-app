...
public class BasepPack1Impl919 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl919.class);
    private static BasepPack1Impl919 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl919 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl919();
        }
        return INSTANCE;
    }

    private BasepPack1Impl919(){
