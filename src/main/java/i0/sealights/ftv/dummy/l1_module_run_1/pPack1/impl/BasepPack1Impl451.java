...
public class BasepPack1Impl451 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl451.class);
    private static BasepPack1Impl451 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl451 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl451();
        }
        return INSTANCE;
    }

    private BasepPack1Impl451(){
