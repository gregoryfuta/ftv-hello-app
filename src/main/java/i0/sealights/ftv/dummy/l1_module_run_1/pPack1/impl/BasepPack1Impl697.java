...
public class BasepPack1Impl697 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl697.class);
    private static BasepPack1Impl697 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl697 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl697();
        }
        return INSTANCE;
    }

    private BasepPack1Impl697(){
