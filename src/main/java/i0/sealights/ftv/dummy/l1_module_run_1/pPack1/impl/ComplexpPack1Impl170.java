...
public class ComplexpPack1Impl170 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl170.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl170 INSTANCE;

    public static ComplexpPack1Impl170 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl170();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl170(){
