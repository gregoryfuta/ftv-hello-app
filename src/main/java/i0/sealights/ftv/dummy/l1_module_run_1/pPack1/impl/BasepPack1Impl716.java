...
public class BasepPack1Impl716 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl716.class);
    private static BasepPack1Impl716 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl716 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl716();
        }
        return INSTANCE;
    }

    private BasepPack1Impl716(){
