...
public class ComplexpPack2Impl266 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl266.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl266 INSTANCE;

    public static ComplexpPack2Impl266 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl266();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl266(){
