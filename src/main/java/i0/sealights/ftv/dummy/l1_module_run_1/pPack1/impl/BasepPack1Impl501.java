...
public class BasepPack1Impl501 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl501.class);
    private static BasepPack1Impl501 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl501 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl501();
        }
        return INSTANCE;
    }

    private BasepPack1Impl501(){
