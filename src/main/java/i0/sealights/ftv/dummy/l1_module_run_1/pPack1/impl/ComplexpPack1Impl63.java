...
public class ComplexpPack1Impl63 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl63.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl63 INSTANCE;

    public static ComplexpPack1Impl63 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl63();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl63(){
