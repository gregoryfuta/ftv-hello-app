...
public class ComplexpPack1Impl92 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl92.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl92 INSTANCE;

    public static ComplexpPack1Impl92 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl92();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl92(){
