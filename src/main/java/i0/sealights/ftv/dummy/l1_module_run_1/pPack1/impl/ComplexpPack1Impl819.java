...
public class ComplexpPack1Impl819 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl819.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl819 INSTANCE;

    public static ComplexpPack1Impl819 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl819();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl819(){
