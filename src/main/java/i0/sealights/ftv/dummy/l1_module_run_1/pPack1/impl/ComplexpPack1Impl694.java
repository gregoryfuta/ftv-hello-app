...
public class ComplexpPack1Impl694 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl694.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl694 INSTANCE;

    public static ComplexpPack1Impl694 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl694();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl694(){
