...
public class BasepPack1Impl538 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl538.class);
    private static BasepPack1Impl538 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl538 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl538();
        }
        return INSTANCE;
    }

    private BasepPack1Impl538(){
