...
public class BasepPack1Impl693 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl693.class);
    private static BasepPack1Impl693 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl693 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl693();
        }
        return INSTANCE;
    }

    private BasepPack1Impl693(){
