...
public class ComplexpPack1Impl195 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl195.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl195 INSTANCE;

    public static ComplexpPack1Impl195 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl195();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl195(){
