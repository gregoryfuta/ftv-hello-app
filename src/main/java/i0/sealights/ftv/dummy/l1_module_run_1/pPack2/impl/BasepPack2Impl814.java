...
public class BasepPack2Impl814 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl814.class);
    private static BasepPack2Impl814 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl814 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl814();
        }
        return INSTANCE;
    }

    private BasepPack2Impl814(){
