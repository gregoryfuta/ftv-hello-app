...
public class BasepPack1Impl412 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl412.class);
    private static BasepPack1Impl412 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl412 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl412();
        }
        return INSTANCE;
    }

    private BasepPack1Impl412(){
