...
public class ComplexpPack2Impl176 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl176.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl176 INSTANCE;

    public static ComplexpPack2Impl176 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl176();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl176(){
