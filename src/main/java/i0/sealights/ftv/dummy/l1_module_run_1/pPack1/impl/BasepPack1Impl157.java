...
public class BasepPack1Impl157 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl157.class);
    private static BasepPack1Impl157 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl157 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl157();
        }
        return INSTANCE;
    }

    private BasepPack1Impl157(){
