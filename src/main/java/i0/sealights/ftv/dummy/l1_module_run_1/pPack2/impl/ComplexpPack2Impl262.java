...
public class ComplexpPack2Impl262 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl262.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl262 INSTANCE;

    public static ComplexpPack2Impl262 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl262();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl262(){
