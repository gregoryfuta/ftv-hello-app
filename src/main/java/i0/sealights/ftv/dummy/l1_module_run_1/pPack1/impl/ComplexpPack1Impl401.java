...
public class ComplexpPack1Impl401 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl401.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl401 INSTANCE;

    public static ComplexpPack1Impl401 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl401();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl401(){
