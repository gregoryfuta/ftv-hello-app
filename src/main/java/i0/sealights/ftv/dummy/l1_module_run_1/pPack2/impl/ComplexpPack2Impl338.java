...
public class ComplexpPack2Impl338 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl338.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl338 INSTANCE;

    public static ComplexpPack2Impl338 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl338();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl338(){
