...
public class ComplexpPack2Impl428 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl428.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl428 INSTANCE;

    public static ComplexpPack2Impl428 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl428();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl428(){
