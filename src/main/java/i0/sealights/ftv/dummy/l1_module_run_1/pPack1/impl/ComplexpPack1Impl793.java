...
public class ComplexpPack1Impl793 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl793.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl793 INSTANCE;

    public static ComplexpPack1Impl793 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl793();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl793(){
