...
public class ComplexpPack1Impl39 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl39.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl39 INSTANCE;

    public static ComplexpPack1Impl39 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl39();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl39(){
