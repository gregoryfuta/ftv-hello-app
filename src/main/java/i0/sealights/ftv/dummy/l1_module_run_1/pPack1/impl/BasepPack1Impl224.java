...
public class BasepPack1Impl224 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl224.class);
    private static BasepPack1Impl224 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl224 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl224();
        }
        return INSTANCE;
    }

    private BasepPack1Impl224(){
