...
public class BasepPack1Impl523 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl523.class);
    private static BasepPack1Impl523 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl523 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl523();
        }
        return INSTANCE;
    }

    private BasepPack1Impl523(){
