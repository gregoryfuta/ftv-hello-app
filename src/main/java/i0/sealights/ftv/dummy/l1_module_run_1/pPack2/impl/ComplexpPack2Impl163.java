...
public class ComplexpPack2Impl163 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl163.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl163 INSTANCE;

    public static ComplexpPack2Impl163 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl163();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl163(){
