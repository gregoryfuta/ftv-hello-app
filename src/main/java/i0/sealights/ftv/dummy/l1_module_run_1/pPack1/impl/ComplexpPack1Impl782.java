...
public class ComplexpPack1Impl782 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl782.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl782 INSTANCE;

    public static ComplexpPack1Impl782 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl782();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl782(){
