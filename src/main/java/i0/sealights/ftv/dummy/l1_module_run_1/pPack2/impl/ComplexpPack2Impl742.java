...
public class ComplexpPack2Impl742 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl742.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl742 INSTANCE;

    public static ComplexpPack2Impl742 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl742();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl742(){
