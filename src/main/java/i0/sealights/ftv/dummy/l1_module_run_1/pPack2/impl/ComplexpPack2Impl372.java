...
public class ComplexpPack2Impl372 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl372.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl372 INSTANCE;

    public static ComplexpPack2Impl372 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl372();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl372(){
