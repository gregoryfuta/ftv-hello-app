...
public class BasepPack1Impl236 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl236.class);
    private static BasepPack1Impl236 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl236 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl236();
        }
        return INSTANCE;
    }

    private BasepPack1Impl236(){
