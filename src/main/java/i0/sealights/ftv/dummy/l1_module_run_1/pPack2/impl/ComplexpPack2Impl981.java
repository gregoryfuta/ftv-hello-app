...
public class ComplexpPack2Impl981 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl981.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl981 INSTANCE;

    public static ComplexpPack2Impl981 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl981();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl981(){
