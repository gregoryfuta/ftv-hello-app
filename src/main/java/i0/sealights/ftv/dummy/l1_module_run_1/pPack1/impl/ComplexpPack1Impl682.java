...
public class ComplexpPack1Impl682 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl682.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl682 INSTANCE;

    public static ComplexpPack1Impl682 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl682();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl682(){
