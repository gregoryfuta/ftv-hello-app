...
public class BasepPack1Impl734 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl734.class);
    private static BasepPack1Impl734 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl734 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl734();
        }
        return INSTANCE;
    }

    private BasepPack1Impl734(){
