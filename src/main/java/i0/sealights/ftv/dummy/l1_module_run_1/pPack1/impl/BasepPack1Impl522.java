...
public class BasepPack1Impl522 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl522.class);
    private static BasepPack1Impl522 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl522 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl522();
        }
        return INSTANCE;
    }

    private BasepPack1Impl522(){
