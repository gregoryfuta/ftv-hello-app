...
public class ComplexpPack1Impl480 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl480.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl480 INSTANCE;

    public static ComplexpPack1Impl480 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl480();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl480(){
