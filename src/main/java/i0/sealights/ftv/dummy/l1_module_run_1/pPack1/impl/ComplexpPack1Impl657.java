...
public class ComplexpPack1Impl657 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl657.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl657 INSTANCE;

    public static ComplexpPack1Impl657 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl657();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl657(){
