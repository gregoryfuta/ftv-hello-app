...
public class ComplexpPack1Impl322 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl322.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl322 INSTANCE;

    public static ComplexpPack1Impl322 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl322();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl322(){
