...
public class BasepPack1Impl387 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl387.class);
    private static BasepPack1Impl387 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl387 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl387();
        }
        return INSTANCE;
    }

    private BasepPack1Impl387(){
