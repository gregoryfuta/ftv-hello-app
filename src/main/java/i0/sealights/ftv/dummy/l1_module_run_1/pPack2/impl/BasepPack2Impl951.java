...
public class BasepPack2Impl951 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl951.class);
    private static BasepPack2Impl951 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl951 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl951();
        }
        return INSTANCE;
    }

    private BasepPack2Impl951(){
