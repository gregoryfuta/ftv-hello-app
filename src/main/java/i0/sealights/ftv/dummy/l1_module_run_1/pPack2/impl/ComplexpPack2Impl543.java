...
public class ComplexpPack2Impl543 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl543.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl543 INSTANCE;

    public static ComplexpPack2Impl543 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl543();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl543(){
