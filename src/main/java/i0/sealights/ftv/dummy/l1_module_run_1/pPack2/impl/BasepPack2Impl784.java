...
public class BasepPack2Impl784 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl784.class);
    private static BasepPack2Impl784 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl784 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl784();
        }
        return INSTANCE;
    }

    private BasepPack2Impl784(){
