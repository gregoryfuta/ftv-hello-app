...
public class ComplexpPack1Impl964 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl964.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl964 INSTANCE;

    public static ComplexpPack1Impl964 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl964();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl964(){
