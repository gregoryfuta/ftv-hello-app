...
public class ComplexpPack2Impl242 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl242.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl242 INSTANCE;

    public static ComplexpPack2Impl242 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl242();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl242(){
