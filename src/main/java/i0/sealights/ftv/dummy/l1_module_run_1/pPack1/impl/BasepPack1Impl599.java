...
public class BasepPack1Impl599 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl599.class);
    private static BasepPack1Impl599 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl599 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl599();
        }
        return INSTANCE;
    }

    private BasepPack1Impl599(){
