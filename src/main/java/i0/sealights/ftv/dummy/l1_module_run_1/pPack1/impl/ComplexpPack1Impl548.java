...
public class ComplexpPack1Impl548 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl548.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl548 INSTANCE;

    public static ComplexpPack1Impl548 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl548();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl548(){
