...
public class ComplexpPack1Impl291 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl291.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl291 INSTANCE;

    public static ComplexpPack1Impl291 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl291();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl291(){
