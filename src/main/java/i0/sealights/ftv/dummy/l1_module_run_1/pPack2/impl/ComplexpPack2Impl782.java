...
public class ComplexpPack2Impl782 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl782.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl782 INSTANCE;

    public static ComplexpPack2Impl782 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl782();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl782(){
