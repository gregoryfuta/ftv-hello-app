...
public class BasepPack1Impl422 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl422.class);
    private static BasepPack1Impl422 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl422 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl422();
        }
        return INSTANCE;
    }

    private BasepPack1Impl422(){
