...
public class BasepPack2Impl247 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl247.class);
    private static BasepPack2Impl247 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl247 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl247();
        }
        return INSTANCE;
    }

    private BasepPack2Impl247(){
