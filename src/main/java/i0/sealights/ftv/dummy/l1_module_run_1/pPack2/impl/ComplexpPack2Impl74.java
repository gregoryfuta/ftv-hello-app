...
public class ComplexpPack2Impl74 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl74.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl74 INSTANCE;

    public static ComplexpPack2Impl74 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl74();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl74(){
