...
public class BasepPack1Impl656 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl656.class);
    private static BasepPack1Impl656 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl656 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl656();
        }
        return INSTANCE;
    }

    private BasepPack1Impl656(){
