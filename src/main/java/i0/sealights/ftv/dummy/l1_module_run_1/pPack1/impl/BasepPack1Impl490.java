...
public class BasepPack1Impl490 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl490.class);
    private static BasepPack1Impl490 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl490 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl490();
        }
        return INSTANCE;
    }

    private BasepPack1Impl490(){
