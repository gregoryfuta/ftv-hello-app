...
public class ComplexpPack2Impl127 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl127.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl127 INSTANCE;

    public static ComplexpPack2Impl127 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl127();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl127(){
