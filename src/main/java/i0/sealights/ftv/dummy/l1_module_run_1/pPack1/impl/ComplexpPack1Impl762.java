...
public class ComplexpPack1Impl762 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl762.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl762 INSTANCE;

    public static ComplexpPack1Impl762 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl762();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl762(){
