...
public class BasepPack2Impl92 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl92.class);
    private static BasepPack2Impl92 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl92 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl92();
        }
        return INSTANCE;
    }

    private BasepPack2Impl92(){
