...
public class ComplexpPack1Impl677 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl677.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl677 INSTANCE;

    public static ComplexpPack1Impl677 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl677();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl677(){
