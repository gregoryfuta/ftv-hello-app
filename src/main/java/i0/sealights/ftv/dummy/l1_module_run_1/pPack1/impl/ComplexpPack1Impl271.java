...
public class ComplexpPack1Impl271 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl271.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl271 INSTANCE;

    public static ComplexpPack1Impl271 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl271();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl271(){
