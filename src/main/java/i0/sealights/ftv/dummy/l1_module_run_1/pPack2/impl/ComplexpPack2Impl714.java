...
public class ComplexpPack2Impl714 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl714.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl714 INSTANCE;

    public static ComplexpPack2Impl714 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl714();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl714(){
