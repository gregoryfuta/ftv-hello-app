...
public class BasepPack2Impl178 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl178.class);
    private static BasepPack2Impl178 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl178 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl178();
        }
        return INSTANCE;
    }

    private BasepPack2Impl178(){
