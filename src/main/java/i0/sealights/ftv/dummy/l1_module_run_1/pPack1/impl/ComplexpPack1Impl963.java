...
public class ComplexpPack1Impl963 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl963.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl963 INSTANCE;

    public static ComplexpPack1Impl963 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl963();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl963(){
