...
public class ComplexpPack1Impl709 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl709.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl709 INSTANCE;

    public static ComplexpPack1Impl709 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl709();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl709(){
