...
public class ComplexpPack2Impl800 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl800.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl800 INSTANCE;

    public static ComplexpPack2Impl800 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl800();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl800(){
