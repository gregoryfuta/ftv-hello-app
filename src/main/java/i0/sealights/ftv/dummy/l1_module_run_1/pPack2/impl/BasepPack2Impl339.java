...
public class BasepPack2Impl339 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl339.class);
    private static BasepPack2Impl339 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl339 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl339();
        }
        return INSTANCE;
    }

    private BasepPack2Impl339(){
