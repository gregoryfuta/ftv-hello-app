...
public class BasepPack2Impl171 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl171.class);
    private static BasepPack2Impl171 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl171 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl171();
        }
        return INSTANCE;
    }

    private BasepPack2Impl171(){
