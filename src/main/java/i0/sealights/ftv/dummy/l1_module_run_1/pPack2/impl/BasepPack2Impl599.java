...
public class BasepPack2Impl599 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl599.class);
    private static BasepPack2Impl599 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl599 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl599();
        }
        return INSTANCE;
    }

    private BasepPack2Impl599(){
