...
public class BasepPack2Impl255 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl255.class);
    private static BasepPack2Impl255 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl255 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl255();
        }
        return INSTANCE;
    }

    private BasepPack2Impl255(){
