...
public class ComplexpPack1Impl651 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl651.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl651 INSTANCE;

    public static ComplexpPack1Impl651 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl651();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl651(){
