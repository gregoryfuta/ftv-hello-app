...
public class ComplexpPack1Impl713 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl713.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl713 INSTANCE;

    public static ComplexpPack1Impl713 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl713();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl713(){
