...
public class ComplexpPack1Impl783 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl783.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl783 INSTANCE;

    public static ComplexpPack1Impl783 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl783();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl783(){
