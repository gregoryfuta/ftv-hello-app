...
public class BasepPack1Impl788 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl788.class);
    private static BasepPack1Impl788 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl788 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl788();
        }
        return INSTANCE;
    }

    private BasepPack1Impl788(){
