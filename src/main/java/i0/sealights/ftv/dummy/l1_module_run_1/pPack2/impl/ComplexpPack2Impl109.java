...
public class ComplexpPack2Impl109 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl109.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl109 INSTANCE;

    public static ComplexpPack2Impl109 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl109();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl109(){
