...
public class BasepPack2Impl588 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl588.class);
    private static BasepPack2Impl588 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl588 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl588();
        }
        return INSTANCE;
    }

    private BasepPack2Impl588(){
