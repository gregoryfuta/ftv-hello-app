...
public class BasepPack1Impl442 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl442.class);
    private static BasepPack1Impl442 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl442 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl442();
        }
        return INSTANCE;
    }

    private BasepPack1Impl442(){
