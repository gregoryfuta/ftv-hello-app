...
public class ComplexpPack2Impl546 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl546.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl546 INSTANCE;

    public static ComplexpPack2Impl546 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl546();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl546(){
