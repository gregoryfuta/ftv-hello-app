...
public class BasepPack2Impl812 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl812.class);
    private static BasepPack2Impl812 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl812 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl812();
        }
        return INSTANCE;
    }

    private BasepPack2Impl812(){
