...
public class ComplexpPack2Impl397 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl397.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl397 INSTANCE;

    public static ComplexpPack2Impl397 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl397();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl397(){
