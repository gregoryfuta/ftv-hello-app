...
public class BasepPack1Impl620 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl620.class);
    private static BasepPack1Impl620 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl620 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl620();
        }
        return INSTANCE;
    }

    private BasepPack1Impl620(){
