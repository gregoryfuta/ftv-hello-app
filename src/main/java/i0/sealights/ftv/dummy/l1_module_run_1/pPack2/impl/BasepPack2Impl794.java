...
public class BasepPack2Impl794 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl794.class);
    private static BasepPack2Impl794 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl794 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl794();
        }
        return INSTANCE;
    }

    private BasepPack2Impl794(){
