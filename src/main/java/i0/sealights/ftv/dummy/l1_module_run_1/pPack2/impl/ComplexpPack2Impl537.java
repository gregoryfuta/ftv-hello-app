...
public class ComplexpPack2Impl537 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl537.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl537 INSTANCE;

    public static ComplexpPack2Impl537 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl537();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl537(){
