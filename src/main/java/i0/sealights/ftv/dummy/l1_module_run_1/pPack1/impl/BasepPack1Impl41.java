...
public class BasepPack1Impl41 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl41.class);
    private static BasepPack1Impl41 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl41 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl41();
        }
        return INSTANCE;
    }

    private BasepPack1Impl41(){
