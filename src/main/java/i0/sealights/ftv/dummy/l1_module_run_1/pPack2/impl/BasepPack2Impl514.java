...
public class BasepPack2Impl514 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl514.class);
    private static BasepPack2Impl514 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl514 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl514();
        }
        return INSTANCE;
    }

    private BasepPack2Impl514(){
