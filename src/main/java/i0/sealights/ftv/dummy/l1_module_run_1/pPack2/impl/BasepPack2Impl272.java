...
public class BasepPack2Impl272 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl272.class);
    private static BasepPack2Impl272 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl272 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl272();
        }
        return INSTANCE;
    }

    private BasepPack2Impl272(){
