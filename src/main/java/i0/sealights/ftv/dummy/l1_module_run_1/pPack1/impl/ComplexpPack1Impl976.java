...
public class ComplexpPack1Impl976 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl976.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl976 INSTANCE;

    public static ComplexpPack1Impl976 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl976();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl976(){
