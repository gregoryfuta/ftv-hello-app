...
public class ComplexpPack1Impl960 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl960.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl960 INSTANCE;

    public static ComplexpPack1Impl960 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl960();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl960(){
