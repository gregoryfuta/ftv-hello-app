...
public class BasepPack2Impl215 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl215.class);
    private static BasepPack2Impl215 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl215 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl215();
        }
        return INSTANCE;
    }

    private BasepPack2Impl215(){
