...
public class BasepPack1Impl792 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl792.class);
    private static BasepPack1Impl792 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl792 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl792();
        }
        return INSTANCE;
    }

    private BasepPack1Impl792(){
