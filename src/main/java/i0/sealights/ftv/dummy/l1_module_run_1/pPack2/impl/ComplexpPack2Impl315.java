...
public class ComplexpPack2Impl315 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl315.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl315 INSTANCE;

    public static ComplexpPack2Impl315 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl315();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl315(){
