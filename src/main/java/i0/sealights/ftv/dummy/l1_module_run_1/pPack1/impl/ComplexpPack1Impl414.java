...
public class ComplexpPack1Impl414 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl414.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl414 INSTANCE;

    public static ComplexpPack1Impl414 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl414();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl414(){
