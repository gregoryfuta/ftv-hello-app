...
public class ComplexpPack2Impl630 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl630.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl630 INSTANCE;

    public static ComplexpPack2Impl630 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl630();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl630(){
