...
public class ComplexpPack1Impl356 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl356.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl356 INSTANCE;

    public static ComplexpPack1Impl356 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl356();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl356(){
