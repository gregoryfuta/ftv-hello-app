...
public class BasepPack1Impl99 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl99.class);
    private static BasepPack1Impl99 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl99 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl99();
        }
        return INSTANCE;
    }

    private BasepPack1Impl99(){
