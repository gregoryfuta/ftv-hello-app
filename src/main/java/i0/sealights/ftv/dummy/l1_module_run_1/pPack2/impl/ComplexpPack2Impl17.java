...
public class ComplexpPack2Impl17 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl17.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl17 INSTANCE;

    public static ComplexpPack2Impl17 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl17();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl17(){
