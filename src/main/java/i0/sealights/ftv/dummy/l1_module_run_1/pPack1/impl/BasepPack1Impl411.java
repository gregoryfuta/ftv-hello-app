...
public class BasepPack1Impl411 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl411.class);
    private static BasepPack1Impl411 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl411 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl411();
        }
        return INSTANCE;
    }

    private BasepPack1Impl411(){
