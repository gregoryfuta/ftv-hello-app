...
public class ComplexpPack2Impl726 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl726.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl726 INSTANCE;

    public static ComplexpPack2Impl726 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl726();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl726(){
