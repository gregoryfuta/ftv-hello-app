...
public class ComplexpPack2Impl618 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl618.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl618 INSTANCE;

    public static ComplexpPack2Impl618 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl618();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl618(){
