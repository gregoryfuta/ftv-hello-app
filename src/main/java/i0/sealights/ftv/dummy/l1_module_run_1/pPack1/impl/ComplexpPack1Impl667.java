...
public class ComplexpPack1Impl667 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl667.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl667 INSTANCE;

    public static ComplexpPack1Impl667 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl667();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl667(){
