...
public class BasepPack2Impl69 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl69.class);
    private static BasepPack2Impl69 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl69 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl69();
        }
        return INSTANCE;
    }

    private BasepPack2Impl69(){
