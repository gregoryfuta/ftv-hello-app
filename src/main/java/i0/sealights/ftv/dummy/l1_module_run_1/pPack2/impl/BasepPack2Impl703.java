...
public class BasepPack2Impl703 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl703.class);
    private static BasepPack2Impl703 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl703 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl703();
        }
        return INSTANCE;
    }

    private BasepPack2Impl703(){
