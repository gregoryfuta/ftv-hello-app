...
public class BasepPack1Impl166 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl166.class);
    private static BasepPack1Impl166 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl166 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl166();
        }
        return INSTANCE;
    }

    private BasepPack1Impl166(){
