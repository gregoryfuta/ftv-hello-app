...
public class BasepPack2Impl945 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl945.class);
    private static BasepPack2Impl945 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl945 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl945();
        }
        return INSTANCE;
    }

    private BasepPack2Impl945(){
