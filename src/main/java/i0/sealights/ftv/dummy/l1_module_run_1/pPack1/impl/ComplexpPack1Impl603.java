...
public class ComplexpPack1Impl603 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl603.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl603 INSTANCE;

    public static ComplexpPack1Impl603 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl603();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl603(){
