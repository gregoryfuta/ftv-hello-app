...
public class BasepPack2Impl933 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl933.class);
    private static BasepPack2Impl933 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl933 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl933();
        }
        return INSTANCE;
    }

    private BasepPack2Impl933(){
