...
public class ComplexpPack2Impl505 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl505.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl505 INSTANCE;

    public static ComplexpPack2Impl505 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl505();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl505(){
