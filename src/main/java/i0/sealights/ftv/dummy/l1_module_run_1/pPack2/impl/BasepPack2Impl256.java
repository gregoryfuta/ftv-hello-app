...
public class BasepPack2Impl256 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl256.class);
    private static BasepPack2Impl256 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl256 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl256();
        }
        return INSTANCE;
    }

    private BasepPack2Impl256(){
