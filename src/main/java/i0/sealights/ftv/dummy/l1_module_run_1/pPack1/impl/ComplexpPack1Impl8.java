...
public class ComplexpPack1Impl8 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl8.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl8 INSTANCE;

    public static ComplexpPack1Impl8 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl8();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl8(){
