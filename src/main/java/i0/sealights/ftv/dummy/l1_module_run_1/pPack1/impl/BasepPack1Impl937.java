...
public class BasepPack1Impl937 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl937.class);
    private static BasepPack1Impl937 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl937 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl937();
        }
        return INSTANCE;
    }

    private BasepPack1Impl937(){
