...
public class BasepPack2Impl237 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl237.class);
    private static BasepPack2Impl237 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl237 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl237();
        }
        return INSTANCE;
    }

    private BasepPack2Impl237(){
