...
public class BasepPack2Impl283 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl283.class);
    private static BasepPack2Impl283 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl283 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl283();
        }
        return INSTANCE;
    }

    private BasepPack2Impl283(){
