...
public class ComplexpPack1Impl137 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl137.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl137 INSTANCE;

    public static ComplexpPack1Impl137 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl137();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl137(){
