...
public class ComplexpPack1Impl185 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl185.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl185 INSTANCE;

    public static ComplexpPack1Impl185 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl185();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl185(){
