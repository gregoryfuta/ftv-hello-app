...
public class ComplexpPack2Impl928 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl928.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl928 INSTANCE;

    public static ComplexpPack2Impl928 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl928();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl928(){
