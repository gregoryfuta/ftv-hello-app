...
public class BasepPack2Impl113 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl113.class);
    private static BasepPack2Impl113 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl113 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl113();
        }
        return INSTANCE;
    }

    private BasepPack2Impl113(){
