...
public class ComplexpPack1Impl64 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl64.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl64 INSTANCE;

    public static ComplexpPack1Impl64 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl64();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl64(){
