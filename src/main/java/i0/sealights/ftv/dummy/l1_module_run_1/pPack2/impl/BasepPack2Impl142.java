...
public class BasepPack2Impl142 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl142.class);
    private static BasepPack2Impl142 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl142 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl142();
        }
        return INSTANCE;
    }

    private BasepPack2Impl142(){
