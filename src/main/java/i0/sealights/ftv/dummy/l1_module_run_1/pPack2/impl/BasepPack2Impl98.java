...
public class BasepPack2Impl98 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl98.class);
    private static BasepPack2Impl98 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl98 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl98();
        }
        return INSTANCE;
    }

    private BasepPack2Impl98(){
