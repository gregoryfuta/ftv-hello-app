...
public class ComplexpPack1Impl797 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl797.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl797 INSTANCE;

    public static ComplexpPack1Impl797 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl797();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl797(){
