...
public class BasepPack1Impl25 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl25.class);
    private static BasepPack1Impl25 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl25 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl25();
        }
        return INSTANCE;
    }

    private BasepPack1Impl25(){
