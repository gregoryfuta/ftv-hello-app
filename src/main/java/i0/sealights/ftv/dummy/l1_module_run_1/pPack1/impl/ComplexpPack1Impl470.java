...
public class ComplexpPack1Impl470 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl470.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl470 INSTANCE;

    public static ComplexpPack1Impl470 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl470();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl470(){
