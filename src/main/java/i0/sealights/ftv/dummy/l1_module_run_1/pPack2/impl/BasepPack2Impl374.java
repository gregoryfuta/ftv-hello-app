...
public class BasepPack2Impl374 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl374.class);
    private static BasepPack2Impl374 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl374 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl374();
        }
        return INSTANCE;
    }

    private BasepPack2Impl374(){
