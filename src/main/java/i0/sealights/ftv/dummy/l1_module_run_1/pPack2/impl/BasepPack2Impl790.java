...
public class BasepPack2Impl790 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl790.class);
    private static BasepPack2Impl790 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl790 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl790();
        }
        return INSTANCE;
    }

    private BasepPack2Impl790(){
