...
public class BasepPack1Impl871 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl871.class);
    private static BasepPack1Impl871 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl871 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl871();
        }
        return INSTANCE;
    }

    private BasepPack1Impl871(){
