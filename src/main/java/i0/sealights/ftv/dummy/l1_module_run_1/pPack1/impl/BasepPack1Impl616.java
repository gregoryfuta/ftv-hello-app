...
public class BasepPack1Impl616 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl616.class);
    private static BasepPack1Impl616 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl616 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl616();
        }
        return INSTANCE;
    }

    private BasepPack1Impl616(){
