...
public class BasepPack2Impl704 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl704.class);
    private static BasepPack2Impl704 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl704 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl704();
        }
        return INSTANCE;
    }

    private BasepPack2Impl704(){
