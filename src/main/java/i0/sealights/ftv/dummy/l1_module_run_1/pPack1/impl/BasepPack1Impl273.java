...
public class BasepPack1Impl273 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl273.class);
    private static BasepPack1Impl273 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl273 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl273();
        }
        return INSTANCE;
    }

    private BasepPack1Impl273(){
