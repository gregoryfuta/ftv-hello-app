...
public class BasepPack1Impl225 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl225.class);
    private static BasepPack1Impl225 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl225 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl225();
        }
        return INSTANCE;
    }

    private BasepPack1Impl225(){
