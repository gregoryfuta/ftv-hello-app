...
public class BasepPack2Impl770 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl770.class);
    private static BasepPack2Impl770 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl770 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl770();
        }
        return INSTANCE;
    }

    private BasepPack2Impl770(){
