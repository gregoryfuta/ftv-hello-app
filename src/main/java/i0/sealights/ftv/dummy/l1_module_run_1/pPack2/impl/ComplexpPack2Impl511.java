...
public class ComplexpPack2Impl511 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl511.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl511 INSTANCE;

    public static ComplexpPack2Impl511 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl511();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl511(){
