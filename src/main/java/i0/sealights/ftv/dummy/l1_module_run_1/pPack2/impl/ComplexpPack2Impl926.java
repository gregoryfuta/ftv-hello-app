...
public class ComplexpPack2Impl926 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl926.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl926 INSTANCE;

    public static ComplexpPack2Impl926 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl926();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl926(){
