...
public class BasepPack2Impl363 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl363.class);
    private static BasepPack2Impl363 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl363 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl363();
        }
        return INSTANCE;
    }

    private BasepPack2Impl363(){
