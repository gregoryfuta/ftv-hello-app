...
public class ComplexpPack2Impl43 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl43.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl43 INSTANCE;

    public static ComplexpPack2Impl43 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl43();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl43(){
