...
public class BasepPack1Impl161 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl161.class);
    private static BasepPack1Impl161 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl161 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl161();
        }
        return INSTANCE;
    }

    private BasepPack1Impl161(){
