...
public class ComplexpPack2Impl816 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl816.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl816 INSTANCE;

    public static ComplexpPack2Impl816 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl816();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl816(){
