...
public class BasepPack2Impl406 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl406.class);
    private static BasepPack2Impl406 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl406 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl406();
        }
        return INSTANCE;
    }

    private BasepPack2Impl406(){
