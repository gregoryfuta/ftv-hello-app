...
public class ComplexpPack2Impl249 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl249.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl249 INSTANCE;

    public static ComplexpPack2Impl249 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl249();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl249(){
