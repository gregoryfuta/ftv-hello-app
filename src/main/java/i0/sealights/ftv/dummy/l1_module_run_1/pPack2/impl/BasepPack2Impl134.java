...
public class BasepPack2Impl134 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl134.class);
    private static BasepPack2Impl134 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl134 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl134();
        }
        return INSTANCE;
    }

    private BasepPack2Impl134(){
