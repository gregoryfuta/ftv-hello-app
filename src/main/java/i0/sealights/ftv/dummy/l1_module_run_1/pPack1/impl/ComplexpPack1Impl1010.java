...
public class ComplexpPack1Impl1010 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1010.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1010 INSTANCE;

    public static ComplexpPack1Impl1010 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1010();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1010(){
