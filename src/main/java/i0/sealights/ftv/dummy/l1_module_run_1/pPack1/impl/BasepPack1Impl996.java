...
public class BasepPack1Impl996 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl996.class);
    private static BasepPack1Impl996 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl996 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl996();
        }
        return INSTANCE;
    }

    private BasepPack1Impl996(){
