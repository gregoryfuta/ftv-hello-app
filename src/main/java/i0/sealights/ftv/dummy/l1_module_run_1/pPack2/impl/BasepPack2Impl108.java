...
public class BasepPack2Impl108 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl108.class);
    private static BasepPack2Impl108 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl108 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl108();
        }
        return INSTANCE;
    }

    private BasepPack2Impl108(){
