...
public class BasepPack1Impl421 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl421.class);
    private static BasepPack1Impl421 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl421 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl421();
        }
        return INSTANCE;
    }

    private BasepPack1Impl421(){
