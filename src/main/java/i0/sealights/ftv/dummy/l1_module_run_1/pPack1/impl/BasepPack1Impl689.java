...
public class BasepPack1Impl689 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl689.class);
    private static BasepPack1Impl689 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl689 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl689();
        }
        return INSTANCE;
    }

    private BasepPack1Impl689(){
