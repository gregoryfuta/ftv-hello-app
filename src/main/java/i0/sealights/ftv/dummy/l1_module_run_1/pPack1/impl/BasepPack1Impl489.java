...
public class BasepPack1Impl489 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl489.class);
    private static BasepPack1Impl489 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl489 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl489();
        }
        return INSTANCE;
    }

    private BasepPack1Impl489(){
