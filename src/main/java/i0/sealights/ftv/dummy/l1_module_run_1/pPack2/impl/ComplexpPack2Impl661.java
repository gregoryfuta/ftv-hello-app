...
public class ComplexpPack2Impl661 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl661.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl661 INSTANCE;

    public static ComplexpPack2Impl661 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl661();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl661(){
