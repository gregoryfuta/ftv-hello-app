...
public class BasepPack1Impl163 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl163.class);
    private static BasepPack1Impl163 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl163 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl163();
        }
        return INSTANCE;
    }

    private BasepPack1Impl163(){
