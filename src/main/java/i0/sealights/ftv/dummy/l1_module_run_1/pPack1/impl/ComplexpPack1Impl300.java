...
public class ComplexpPack1Impl300 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl300.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl300 INSTANCE;

    public static ComplexpPack1Impl300 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl300();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl300(){
