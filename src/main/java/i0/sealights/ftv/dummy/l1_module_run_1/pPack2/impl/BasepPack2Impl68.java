...
public class BasepPack2Impl68 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl68.class);
    private static BasepPack2Impl68 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl68 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl68();
        }
        return INSTANCE;
    }

    private BasepPack2Impl68(){
