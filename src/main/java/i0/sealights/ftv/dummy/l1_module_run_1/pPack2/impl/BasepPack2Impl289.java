...
public class BasepPack2Impl289 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl289.class);
    private static BasepPack2Impl289 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl289 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl289();
        }
        return INSTANCE;
    }

    private BasepPack2Impl289(){
