...
public class ComplexAbstractpPack2 {

    private static ComplexAbstractpPack2 INSTANCE;
    static final Logger LOGGER = LogManager.getLogger(ComplexAbstractpPack2.class);
    ...
    public static ComplexAbstractpPack2 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexAbstractpPack2();
        }
        return INSTANCE;
    }
