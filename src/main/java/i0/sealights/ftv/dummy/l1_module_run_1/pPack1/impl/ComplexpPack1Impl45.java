...
public class ComplexpPack1Impl45 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl45.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl45 INSTANCE;

    public static ComplexpPack1Impl45 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl45();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl45(){
