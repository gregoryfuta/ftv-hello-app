...
public class BasepPack1Impl218 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl218.class);
    private static BasepPack1Impl218 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl218 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl218();
        }
        return INSTANCE;
    }

    private BasepPack1Impl218(){
