...
public class BasepPack2Impl325 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl325.class);
    private static BasepPack2Impl325 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl325 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl325();
        }
        return INSTANCE;
    }

    private BasepPack2Impl325(){
