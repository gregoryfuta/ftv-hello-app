...
public class BasepPack2Impl761 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl761.class);
    private static BasepPack2Impl761 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl761 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl761();
        }
        return INSTANCE;
    }

    private BasepPack2Impl761(){
