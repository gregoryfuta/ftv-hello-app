...
public class ComplexpPack1Impl702 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl702.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl702 INSTANCE;

    public static ComplexpPack1Impl702 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl702();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl702(){
