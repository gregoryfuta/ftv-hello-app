...
public class ComplexpPack1Impl73 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl73.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl73 INSTANCE;

    public static ComplexpPack1Impl73 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl73();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl73(){
