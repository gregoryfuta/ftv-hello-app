...
public class ComplexpPack2Impl733 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl733.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl733 INSTANCE;

    public static ComplexpPack2Impl733 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl733();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl733(){
