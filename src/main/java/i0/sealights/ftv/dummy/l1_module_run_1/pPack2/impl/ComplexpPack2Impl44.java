...
public class ComplexpPack2Impl44 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl44.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl44 INSTANCE;

    public static ComplexpPack2Impl44 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl44();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl44(){
