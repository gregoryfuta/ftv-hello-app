...
public class ComplexpPack1Impl947 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl947.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl947 INSTANCE;

    public static ComplexpPack1Impl947 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl947();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl947(){
