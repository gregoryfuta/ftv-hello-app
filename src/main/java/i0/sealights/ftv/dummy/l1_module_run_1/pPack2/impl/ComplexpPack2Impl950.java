...
public class ComplexpPack2Impl950 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl950.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl950 INSTANCE;

    public static ComplexpPack2Impl950 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl950();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl950(){
