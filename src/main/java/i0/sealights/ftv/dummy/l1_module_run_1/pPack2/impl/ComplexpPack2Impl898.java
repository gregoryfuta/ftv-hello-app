...
public class ComplexpPack2Impl898 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl898.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl898 INSTANCE;

    public static ComplexpPack2Impl898 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl898();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl898(){
