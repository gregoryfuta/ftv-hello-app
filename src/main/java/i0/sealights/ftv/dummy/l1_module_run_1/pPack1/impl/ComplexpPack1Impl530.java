...
public class ComplexpPack1Impl530 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl530.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl530 INSTANCE;

    public static ComplexpPack1Impl530 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl530();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl530(){
