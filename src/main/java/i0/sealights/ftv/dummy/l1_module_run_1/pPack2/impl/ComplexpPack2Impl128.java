...
public class ComplexpPack2Impl128 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl128.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl128 INSTANCE;

    public static ComplexpPack2Impl128 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl128();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl128(){
