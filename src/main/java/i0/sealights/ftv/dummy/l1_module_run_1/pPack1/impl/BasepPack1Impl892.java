...
public class BasepPack1Impl892 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl892.class);
    private static BasepPack1Impl892 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl892 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl892();
        }
        return INSTANCE;
    }

    private BasepPack1Impl892(){
