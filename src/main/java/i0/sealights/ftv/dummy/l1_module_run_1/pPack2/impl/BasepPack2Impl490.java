...
public class BasepPack2Impl490 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl490.class);
    private static BasepPack2Impl490 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl490 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl490();
        }
        return INSTANCE;
    }

    private BasepPack2Impl490(){
