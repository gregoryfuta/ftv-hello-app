...
public class ComplexpPack2Impl79 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl79.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl79 INSTANCE;

    public static ComplexpPack2Impl79 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl79();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl79(){
