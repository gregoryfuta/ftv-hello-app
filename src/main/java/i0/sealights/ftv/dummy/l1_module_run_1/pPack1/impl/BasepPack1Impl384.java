...
public class BasepPack1Impl384 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl384.class);
    private static BasepPack1Impl384 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl384 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl384();
        }
        return INSTANCE;
    }

    private BasepPack1Impl384(){
