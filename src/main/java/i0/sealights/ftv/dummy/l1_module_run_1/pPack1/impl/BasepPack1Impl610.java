...
public class BasepPack1Impl610 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl610.class);
    private static BasepPack1Impl610 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl610 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl610();
        }
        return INSTANCE;
    }

    private BasepPack1Impl610(){
