...
public class ComplexpPack2Impl573 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl573.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl573 INSTANCE;

    public static ComplexpPack2Impl573 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl573();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl573(){
