...
public class ComplexpPack1Impl943 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl943.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl943 INSTANCE;

    public static ComplexpPack1Impl943 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl943();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl943(){
