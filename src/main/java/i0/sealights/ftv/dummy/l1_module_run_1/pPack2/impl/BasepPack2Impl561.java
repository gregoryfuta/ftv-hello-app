...
public class BasepPack2Impl561 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl561.class);
    private static BasepPack2Impl561 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl561 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl561();
        }
        return INSTANCE;
    }

    private BasepPack2Impl561(){
