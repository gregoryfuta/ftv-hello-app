...
public class BasepPack1Impl464 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl464.class);
    private static BasepPack1Impl464 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl464 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl464();
        }
        return INSTANCE;
    }

    private BasepPack1Impl464(){
