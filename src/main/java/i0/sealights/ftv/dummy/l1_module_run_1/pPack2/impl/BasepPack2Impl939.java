...
public class BasepPack2Impl939 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl939.class);
    private static BasepPack2Impl939 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl939 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl939();
        }
        return INSTANCE;
    }

    private BasepPack2Impl939(){
