...
public class BasepPack1Impl527 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl527.class);
    private static BasepPack1Impl527 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl527 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl527();
        }
        return INSTANCE;
    }

    private BasepPack1Impl527(){
