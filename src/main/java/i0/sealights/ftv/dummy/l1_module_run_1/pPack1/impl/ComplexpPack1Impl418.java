...
public class ComplexpPack1Impl418 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl418.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl418 INSTANCE;

    public static ComplexpPack1Impl418 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl418();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl418(){
