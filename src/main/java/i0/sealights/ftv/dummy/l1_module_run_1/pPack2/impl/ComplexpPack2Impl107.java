...
public class ComplexpPack2Impl107 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl107.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl107 INSTANCE;

    public static ComplexpPack2Impl107 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl107();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl107(){
