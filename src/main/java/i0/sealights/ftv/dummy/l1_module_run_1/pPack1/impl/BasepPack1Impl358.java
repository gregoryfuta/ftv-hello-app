...
public class BasepPack1Impl358 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl358.class);
    private static BasepPack1Impl358 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl358 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl358();
        }
        return INSTANCE;
    }

    private BasepPack1Impl358(){
