...
public class ComplexpPack1Impl506 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl506.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl506 INSTANCE;

    public static ComplexpPack1Impl506 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl506();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl506(){
