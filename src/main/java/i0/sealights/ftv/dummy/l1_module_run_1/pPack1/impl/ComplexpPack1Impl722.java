...
public class ComplexpPack1Impl722 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl722.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl722 INSTANCE;

    public static ComplexpPack1Impl722 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl722();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl722(){
