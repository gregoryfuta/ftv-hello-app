...
public class ComplexpPack2Impl267 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl267.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl267 INSTANCE;

    public static ComplexpPack2Impl267 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl267();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl267(){
