...
public class BasepPack2Impl8 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl8.class);
    private static BasepPack2Impl8 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl8 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl8();
        }
        return INSTANCE;
    }

    private BasepPack2Impl8(){
