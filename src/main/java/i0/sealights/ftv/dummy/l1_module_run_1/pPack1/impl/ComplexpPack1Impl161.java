...
public class ComplexpPack1Impl161 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl161.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl161 INSTANCE;

    public static ComplexpPack1Impl161 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl161();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl161(){
