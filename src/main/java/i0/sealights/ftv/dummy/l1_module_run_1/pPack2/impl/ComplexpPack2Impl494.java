...
public class ComplexpPack2Impl494 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl494.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl494 INSTANCE;

    public static ComplexpPack2Impl494 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl494();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl494(){
