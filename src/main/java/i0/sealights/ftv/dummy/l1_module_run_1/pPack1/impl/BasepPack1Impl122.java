...
public class BasepPack1Impl122 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl122.class);
    private static BasepPack1Impl122 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl122 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl122();
        }
        return INSTANCE;
    }

    private BasepPack1Impl122(){
