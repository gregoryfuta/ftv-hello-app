...
public class ComplexpPack1Impl487 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl487.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl487 INSTANCE;

    public static ComplexpPack1Impl487 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl487();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl487(){
