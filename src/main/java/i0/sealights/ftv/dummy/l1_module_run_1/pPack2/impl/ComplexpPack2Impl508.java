...
public class ComplexpPack2Impl508 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl508.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl508 INSTANCE;

    public static ComplexpPack2Impl508 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl508();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl508(){
