...
public class BasepPack1Impl60 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl60.class);
    private static BasepPack1Impl60 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl60 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl60();
        }
        return INSTANCE;
    }

    private BasepPack1Impl60(){
