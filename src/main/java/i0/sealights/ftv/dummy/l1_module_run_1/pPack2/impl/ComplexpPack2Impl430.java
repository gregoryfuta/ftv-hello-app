...
public class ComplexpPack2Impl430 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl430.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl430 INSTANCE;

    public static ComplexpPack2Impl430 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl430();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl430(){
