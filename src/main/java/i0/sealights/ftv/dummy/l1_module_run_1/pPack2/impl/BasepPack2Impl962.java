...
public class BasepPack2Impl962 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl962.class);
    private static BasepPack2Impl962 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl962 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl962();
        }
        return INSTANCE;
    }

    private BasepPack2Impl962(){
