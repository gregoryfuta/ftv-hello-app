...
public class ComplexpPack1Impl509 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl509.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl509 INSTANCE;

    public static ComplexpPack1Impl509 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl509();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl509(){
