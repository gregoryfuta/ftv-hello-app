...
public class ComplexpPack2Impl838 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl838.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl838 INSTANCE;

    public static ComplexpPack2Impl838 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl838();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl838(){
