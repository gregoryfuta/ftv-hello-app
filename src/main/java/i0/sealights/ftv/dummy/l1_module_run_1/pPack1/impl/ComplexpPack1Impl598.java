...
public class ComplexpPack1Impl598 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl598.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl598 INSTANCE;

    public static ComplexpPack1Impl598 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl598();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl598(){
