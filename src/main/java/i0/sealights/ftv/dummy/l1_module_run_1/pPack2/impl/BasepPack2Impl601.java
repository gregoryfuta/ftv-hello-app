...
public class BasepPack2Impl601 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl601.class);
    private static BasepPack2Impl601 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl601 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl601();
        }
        return INSTANCE;
    }

    private BasepPack2Impl601(){
