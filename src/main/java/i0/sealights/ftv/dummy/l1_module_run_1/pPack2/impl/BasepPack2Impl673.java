...
public class BasepPack2Impl673 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl673.class);
    private static BasepPack2Impl673 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl673 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl673();
        }
        return INSTANCE;
    }

    private BasepPack2Impl673(){
