...
public class BasepPack2Impl338 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl338.class);
    private static BasepPack2Impl338 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl338 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl338();
        }
        return INSTANCE;
    }

    private BasepPack2Impl338(){
