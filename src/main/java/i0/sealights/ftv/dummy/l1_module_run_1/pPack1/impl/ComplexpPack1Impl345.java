...
public class ComplexpPack1Impl345 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl345.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl345 INSTANCE;

    public static ComplexpPack1Impl345 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl345();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl345(){
