...
public class ComplexpPack1Impl435 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl435.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl435 INSTANCE;

    public static ComplexpPack1Impl435 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl435();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl435(){
