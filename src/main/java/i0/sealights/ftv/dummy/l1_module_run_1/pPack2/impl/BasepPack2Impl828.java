...
public class BasepPack2Impl828 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl828.class);
    private static BasepPack2Impl828 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl828 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl828();
        }
        return INSTANCE;
    }

    private BasepPack2Impl828(){
