...
public class ComplexpPack1Impl463 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl463.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl463 INSTANCE;

    public static ComplexpPack1Impl463 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl463();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl463(){
