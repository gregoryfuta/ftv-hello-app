...
public class BasepPack1Impl231 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl231.class);
    private static BasepPack1Impl231 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl231 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl231();
        }
        return INSTANCE;
    }

    private BasepPack1Impl231(){
