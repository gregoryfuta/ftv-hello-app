...
public class ComplexpPack2Impl3 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl3.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl3 INSTANCE;

    public static ComplexpPack2Impl3 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl3();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl3(){
