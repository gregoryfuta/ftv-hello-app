...
public class BasepPack2Impl389 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl389.class);
    private static BasepPack2Impl389 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl389 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl389();
        }
        return INSTANCE;
    }

    private BasepPack2Impl389(){
