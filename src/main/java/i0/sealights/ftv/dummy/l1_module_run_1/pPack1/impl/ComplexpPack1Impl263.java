...
public class ComplexpPack1Impl263 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl263.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl263 INSTANCE;

    public static ComplexpPack1Impl263 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl263();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl263(){
