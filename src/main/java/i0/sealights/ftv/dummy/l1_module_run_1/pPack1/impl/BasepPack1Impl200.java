...
public class BasepPack1Impl200 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl200.class);
    private static BasepPack1Impl200 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl200 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl200();
        }
        return INSTANCE;
    }

    private BasepPack1Impl200(){
