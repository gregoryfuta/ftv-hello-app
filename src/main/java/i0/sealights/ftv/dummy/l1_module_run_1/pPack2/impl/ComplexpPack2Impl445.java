...
public class ComplexpPack2Impl445 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl445.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl445 INSTANCE;

    public static ComplexpPack2Impl445 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl445();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl445(){
