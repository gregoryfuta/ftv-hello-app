...
public class BasepPack2Impl309 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl309.class);
    private static BasepPack2Impl309 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl309 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl309();
        }
        return INSTANCE;
    }

    private BasepPack2Impl309(){
