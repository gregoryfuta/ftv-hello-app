...
public class ComplexpPack1Impl188 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl188.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl188 INSTANCE;

    public static ComplexpPack1Impl188 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl188();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl188(){
