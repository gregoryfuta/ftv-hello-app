...
public class ComplexpPack2Impl168 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl168.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl168 INSTANCE;

    public static ComplexpPack2Impl168 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl168();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl168(){
