...
public class ComplexpPack2Impl985 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl985.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl985 INSTANCE;

    public static ComplexpPack2Impl985 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl985();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl985(){
