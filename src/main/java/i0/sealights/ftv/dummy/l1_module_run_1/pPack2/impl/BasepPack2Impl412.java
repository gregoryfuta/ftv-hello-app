...
public class BasepPack2Impl412 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl412.class);
    private static BasepPack2Impl412 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl412 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl412();
        }
        return INSTANCE;
    }

    private BasepPack2Impl412(){
