...
public class BasepPack1Impl311 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl311.class);
    private static BasepPack1Impl311 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl311 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl311();
        }
        return INSTANCE;
    }

    private BasepPack1Impl311(){
