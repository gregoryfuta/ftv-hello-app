...
public class ComplexpPack1Impl919 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl919.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl919 INSTANCE;

    public static ComplexpPack1Impl919 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl919();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl919(){
