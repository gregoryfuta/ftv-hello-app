...
public class ComplexpPack1Impl733 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl733.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl733 INSTANCE;

    public static ComplexpPack1Impl733 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl733();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl733(){
