...
public class BasepPack1Impl17 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl17.class);
    private static BasepPack1Impl17 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl17 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl17();
        }
        return INSTANCE;
    }

    private BasepPack1Impl17(){
