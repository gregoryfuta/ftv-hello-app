...
public class ComplexpPack2Impl410 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl410.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl410 INSTANCE;

    public static ComplexpPack2Impl410 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl410();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl410(){
