...
public class ComplexpPack1Impl653 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl653.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl653 INSTANCE;

    public static ComplexpPack1Impl653 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl653();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl653(){
