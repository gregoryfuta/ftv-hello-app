...
public class BasepPack1Impl628 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl628.class);
    private static BasepPack1Impl628 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl628 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl628();
        }
        return INSTANCE;
    }

    private BasepPack1Impl628(){
