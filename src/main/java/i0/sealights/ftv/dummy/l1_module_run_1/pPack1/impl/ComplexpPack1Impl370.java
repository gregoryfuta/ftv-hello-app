...
public class ComplexpPack1Impl370 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl370.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl370 INSTANCE;

    public static ComplexpPack1Impl370 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl370();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl370(){
