...
public class BasepPack2Impl111 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl111.class);
    private static BasepPack2Impl111 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl111 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl111();
        }
        return INSTANCE;
    }

    private BasepPack2Impl111(){
