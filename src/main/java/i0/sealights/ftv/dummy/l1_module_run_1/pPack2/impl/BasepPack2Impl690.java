...
public class BasepPack2Impl690 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl690.class);
    private static BasepPack2Impl690 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl690 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl690();
        }
        return INSTANCE;
    }

    private BasepPack2Impl690(){
