...
public class ComplexpPack1Impl60 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl60.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl60 INSTANCE;

    public static ComplexpPack1Impl60 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl60();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl60(){
