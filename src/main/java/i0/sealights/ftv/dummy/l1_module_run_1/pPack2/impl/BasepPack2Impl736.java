...
public class BasepPack2Impl736 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl736.class);
    private static BasepPack2Impl736 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl736 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl736();
        }
        return INSTANCE;
    }

    private BasepPack2Impl736(){
