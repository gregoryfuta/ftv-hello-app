...
public class BasepPack1Impl953 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl953.class);
    private static BasepPack1Impl953 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl953 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl953();
        }
        return INSTANCE;
    }

    private BasepPack1Impl953(){
