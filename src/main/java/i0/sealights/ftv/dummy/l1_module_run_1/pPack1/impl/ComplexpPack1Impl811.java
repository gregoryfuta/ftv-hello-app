...
public class ComplexpPack1Impl811 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl811.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl811 INSTANCE;

    public static ComplexpPack1Impl811 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl811();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl811(){
