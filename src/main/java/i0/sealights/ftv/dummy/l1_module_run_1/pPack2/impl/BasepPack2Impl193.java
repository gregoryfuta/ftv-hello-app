...
public class BasepPack2Impl193 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl193.class);
    private static BasepPack2Impl193 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl193 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl193();
        }
        return INSTANCE;
    }

    private BasepPack2Impl193(){
