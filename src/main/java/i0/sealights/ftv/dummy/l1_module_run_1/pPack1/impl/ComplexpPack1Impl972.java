...
public class ComplexpPack1Impl972 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl972.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl972 INSTANCE;

    public static ComplexpPack1Impl972 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl972();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl972(){
