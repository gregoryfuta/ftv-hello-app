...
public class BasepPack2Impl303 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl303.class);
    private static BasepPack2Impl303 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl303 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl303();
        }
        return INSTANCE;
    }

    private BasepPack2Impl303(){
