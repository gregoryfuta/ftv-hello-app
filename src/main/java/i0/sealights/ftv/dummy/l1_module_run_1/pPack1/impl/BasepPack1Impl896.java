...
public class BasepPack1Impl896 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl896.class);
    private static BasepPack1Impl896 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl896 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl896();
        }
        return INSTANCE;
    }

    private BasepPack1Impl896(){
