...
public class BasepPack2Impl177 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl177.class);
    private static BasepPack2Impl177 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl177 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl177();
        }
        return INSTANCE;
    }

    private BasepPack2Impl177(){
