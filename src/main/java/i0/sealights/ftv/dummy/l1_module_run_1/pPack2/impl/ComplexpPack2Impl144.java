...
public class ComplexpPack2Impl144 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl144.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl144 INSTANCE;

    public static ComplexpPack2Impl144 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl144();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl144(){
