...
public class BasepPack1Impl969 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl969.class);
    private static BasepPack1Impl969 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl969 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl969();
        }
        return INSTANCE;
    }

    private BasepPack1Impl969(){
