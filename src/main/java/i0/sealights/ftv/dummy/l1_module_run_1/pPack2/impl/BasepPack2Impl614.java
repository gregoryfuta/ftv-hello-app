...
public class BasepPack2Impl614 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl614.class);
    private static BasepPack2Impl614 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl614 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl614();
        }
        return INSTANCE;
    }

    private BasepPack2Impl614(){
