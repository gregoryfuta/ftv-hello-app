...
public class ComplexpPack2Impl683 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl683.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl683 INSTANCE;

    public static ComplexpPack2Impl683 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl683();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl683(){
