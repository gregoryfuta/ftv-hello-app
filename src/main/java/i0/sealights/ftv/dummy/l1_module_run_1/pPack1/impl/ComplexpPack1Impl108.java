...
public class ComplexpPack1Impl108 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl108.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl108 INSTANCE;

    public static ComplexpPack1Impl108 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl108();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl108(){
