...
public class ComplexpPack2Impl633 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl633.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl633 INSTANCE;

    public static ComplexpPack2Impl633 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl633();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl633(){
