...
public class ComplexpPack1Impl824 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl824.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl824 INSTANCE;

    public static ComplexpPack1Impl824 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl824();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl824(){
