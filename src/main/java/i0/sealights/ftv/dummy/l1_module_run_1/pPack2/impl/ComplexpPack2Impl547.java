...
public class ComplexpPack2Impl547 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl547.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl547 INSTANCE;

    public static ComplexpPack2Impl547 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl547();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl547(){
