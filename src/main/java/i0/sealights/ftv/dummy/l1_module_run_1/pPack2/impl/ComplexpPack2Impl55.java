...
public class ComplexpPack2Impl55 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl55.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl55 INSTANCE;

    public static ComplexpPack2Impl55 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl55();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl55(){
