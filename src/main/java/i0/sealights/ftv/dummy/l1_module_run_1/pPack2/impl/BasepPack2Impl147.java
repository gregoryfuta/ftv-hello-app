...
public class BasepPack2Impl147 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl147.class);
    private static BasepPack2Impl147 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl147 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl147();
        }
        return INSTANCE;
    }

    private BasepPack2Impl147(){
