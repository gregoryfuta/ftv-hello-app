...
public class ComplexpPack2Impl796 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl796.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl796 INSTANCE;

    public static ComplexpPack2Impl796 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl796();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl796(){
