...
public class ComplexpPack1Impl1026 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1026.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1026 INSTANCE;

    public static ComplexpPack1Impl1026 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1026();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1026(){
