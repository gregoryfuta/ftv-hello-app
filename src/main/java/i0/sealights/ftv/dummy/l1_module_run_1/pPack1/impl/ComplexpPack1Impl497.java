...
public class ComplexpPack1Impl497 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl497.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl497 INSTANCE;

    public static ComplexpPack1Impl497 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl497();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl497(){
