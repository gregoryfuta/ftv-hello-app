...
public class ComplexpPack2Impl195 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl195.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl195 INSTANCE;

    public static ComplexpPack2Impl195 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl195();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl195(){
