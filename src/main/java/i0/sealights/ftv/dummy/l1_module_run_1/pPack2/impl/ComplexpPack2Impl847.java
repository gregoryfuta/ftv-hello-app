...
public class ComplexpPack2Impl847 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl847.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl847 INSTANCE;

    public static ComplexpPack2Impl847 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl847();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl847(){
