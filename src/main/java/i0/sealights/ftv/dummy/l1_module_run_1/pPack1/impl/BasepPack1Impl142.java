...
public class BasepPack1Impl142 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl142.class);
    private static BasepPack1Impl142 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl142 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl142();
        }
        return INSTANCE;
    }

    private BasepPack1Impl142(){
