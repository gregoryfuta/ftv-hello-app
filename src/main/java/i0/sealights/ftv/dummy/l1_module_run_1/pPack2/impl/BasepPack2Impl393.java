...
public class BasepPack2Impl393 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl393.class);
    private static BasepPack2Impl393 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl393 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl393();
        }
        return INSTANCE;
    }

    private BasepPack2Impl393(){
