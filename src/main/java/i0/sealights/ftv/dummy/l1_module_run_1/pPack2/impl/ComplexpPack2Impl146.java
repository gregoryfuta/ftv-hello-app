...
public class ComplexpPack2Impl146 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl146.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl146 INSTANCE;

    public static ComplexpPack2Impl146 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl146();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl146(){
