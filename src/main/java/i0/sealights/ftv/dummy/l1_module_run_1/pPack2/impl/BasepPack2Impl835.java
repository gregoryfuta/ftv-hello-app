...
public class BasepPack2Impl835 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl835.class);
    private static BasepPack2Impl835 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl835 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl835();
        }
        return INSTANCE;
    }

    private BasepPack2Impl835(){
