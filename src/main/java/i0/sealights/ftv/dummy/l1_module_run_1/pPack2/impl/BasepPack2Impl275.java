...
public class BasepPack2Impl275 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl275.class);
    private static BasepPack2Impl275 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl275 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl275();
        }
        return INSTANCE;
    }

    private BasepPack2Impl275(){
