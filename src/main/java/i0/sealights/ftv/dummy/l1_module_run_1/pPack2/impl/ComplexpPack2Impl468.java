...
public class ComplexpPack2Impl468 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl468.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl468 INSTANCE;

    public static ComplexpPack2Impl468 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl468();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl468(){
