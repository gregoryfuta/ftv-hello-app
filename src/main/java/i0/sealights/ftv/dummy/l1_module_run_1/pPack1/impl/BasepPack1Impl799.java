...
public class BasepPack1Impl799 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl799.class);
    private static BasepPack1Impl799 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl799 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl799();
        }
        return INSTANCE;
    }

    private BasepPack1Impl799(){
