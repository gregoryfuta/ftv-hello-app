...
public class BasepPack1Impl333 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl333.class);
    private static BasepPack1Impl333 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl333 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl333();
        }
        return INSTANCE;
    }

    private BasepPack1Impl333(){
