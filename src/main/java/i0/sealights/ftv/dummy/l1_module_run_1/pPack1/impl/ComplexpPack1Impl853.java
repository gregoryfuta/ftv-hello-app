...
public class ComplexpPack1Impl853 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl853.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl853 INSTANCE;

    public static ComplexpPack1Impl853 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl853();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl853(){
