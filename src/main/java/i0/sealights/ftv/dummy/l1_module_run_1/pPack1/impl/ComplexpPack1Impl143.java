...
public class ComplexpPack1Impl143 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl143.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl143 INSTANCE;

    public static ComplexpPack1Impl143 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl143();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl143(){
