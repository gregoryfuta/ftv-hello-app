...
public class BasepPack1Impl998 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl998.class);
    private static BasepPack1Impl998 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl998 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl998();
        }
        return INSTANCE;
    }

    private BasepPack1Impl998(){
