...
public class BasepPack2Impl218 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl218.class);
    private static BasepPack2Impl218 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl218 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl218();
        }
        return INSTANCE;
    }

    private BasepPack2Impl218(){
