...
public class ComplexpPack1Impl676 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl676.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl676 INSTANCE;

    public static ComplexpPack1Impl676 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl676();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl676(){
