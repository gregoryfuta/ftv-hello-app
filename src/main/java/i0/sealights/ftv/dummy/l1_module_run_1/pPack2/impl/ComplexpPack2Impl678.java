...
public class ComplexpPack2Impl678 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl678.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl678 INSTANCE;

    public static ComplexpPack2Impl678 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl678();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl678(){
