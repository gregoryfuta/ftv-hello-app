...
public class ComplexpPack1Impl755 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl755.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl755 INSTANCE;

    public static ComplexpPack1Impl755 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl755();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl755(){
