...
public class ComplexpPack1Impl719 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl719.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl719 INSTANCE;

    public static ComplexpPack1Impl719 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl719();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl719(){
