...
public class BasepPack1Impl152 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl152.class);
    private static BasepPack1Impl152 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl152 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl152();
        }
        return INSTANCE;
    }

    private BasepPack1Impl152(){
