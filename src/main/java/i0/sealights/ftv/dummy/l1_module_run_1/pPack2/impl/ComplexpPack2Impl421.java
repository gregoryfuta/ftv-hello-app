...
public class ComplexpPack2Impl421 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl421.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl421 INSTANCE;

    public static ComplexpPack2Impl421 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl421();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl421(){
