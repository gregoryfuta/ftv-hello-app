...
public class ComplexpPack1Impl312 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl312.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl312 INSTANCE;

    public static ComplexpPack1Impl312 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl312();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl312(){
