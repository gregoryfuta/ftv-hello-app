...
public class BasepPack1Impl216 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl216.class);
    private static BasepPack1Impl216 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl216 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl216();
        }
        return INSTANCE;
    }

    private BasepPack1Impl216(){
