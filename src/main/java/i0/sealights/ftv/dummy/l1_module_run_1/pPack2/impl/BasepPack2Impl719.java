...
public class BasepPack2Impl719 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl719.class);
    private static BasepPack2Impl719 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl719 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl719();
        }
        return INSTANCE;
    }

    private BasepPack2Impl719(){
