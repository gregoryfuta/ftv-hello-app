...
public class BasepPack1Impl175 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl175.class);
    private static BasepPack1Impl175 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl175 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl175();
        }
        return INSTANCE;
    }

    private BasepPack1Impl175(){
