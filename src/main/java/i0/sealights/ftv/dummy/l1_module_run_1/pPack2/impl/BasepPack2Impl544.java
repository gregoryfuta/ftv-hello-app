...
public class BasepPack2Impl544 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl544.class);
    private static BasepPack2Impl544 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl544 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl544();
        }
        return INSTANCE;
    }

    private BasepPack2Impl544(){
