...
public class ComplexpPack1Impl575 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl575.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl575 INSTANCE;

    public static ComplexpPack1Impl575 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl575();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl575(){
