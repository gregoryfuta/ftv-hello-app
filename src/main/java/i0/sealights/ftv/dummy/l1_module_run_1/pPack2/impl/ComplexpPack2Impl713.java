...
public class ComplexpPack2Impl713 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl713.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl713 INSTANCE;

    public static ComplexpPack2Impl713 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl713();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl713(){
