...
public class BasepPack1Impl909 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl909.class);
    private static BasepPack1Impl909 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl909 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl909();
        }
        return INSTANCE;
    }

    private BasepPack1Impl909(){
