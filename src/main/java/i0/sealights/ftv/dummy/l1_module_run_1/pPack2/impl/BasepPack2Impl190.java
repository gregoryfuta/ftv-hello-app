...
public class BasepPack2Impl190 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl190.class);
    private static BasepPack2Impl190 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl190 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl190();
        }
        return INSTANCE;
    }

    private BasepPack2Impl190(){
