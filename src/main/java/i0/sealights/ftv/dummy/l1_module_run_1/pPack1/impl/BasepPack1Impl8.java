...
public class BasepPack1Impl8 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl8.class);
    private static BasepPack1Impl8 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl8 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl8();
        }
        return INSTANCE;
    }

    private BasepPack1Impl8(){
