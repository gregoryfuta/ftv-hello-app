...
public class ComplexpPack1Impl561 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl561.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl561 INSTANCE;

    public static ComplexpPack1Impl561 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl561();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl561(){
