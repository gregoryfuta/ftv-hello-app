...
public class ComplexpPack1Impl373 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl373.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl373 INSTANCE;

    public static ComplexpPack1Impl373 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl373();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl373(){
