...
public class ComplexpPack1Impl948 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl948.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl948 INSTANCE;

    public static ComplexpPack1Impl948 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl948();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl948(){
