...
public class BasepPack2Impl889 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl889.class);
    private static BasepPack2Impl889 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl889 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl889();
        }
        return INSTANCE;
    }

    private BasepPack2Impl889(){
