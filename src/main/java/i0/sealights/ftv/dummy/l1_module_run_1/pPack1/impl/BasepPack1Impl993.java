...
public class BasepPack1Impl993 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl993.class);
    private static BasepPack1Impl993 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl993 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl993();
        }
        return INSTANCE;
    }

    private BasepPack1Impl993(){
