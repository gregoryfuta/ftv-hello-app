...
public class ComplexpPack2Impl988 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl988.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl988 INSTANCE;

    public static ComplexpPack2Impl988 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl988();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl988(){
