...
public class BasepPack2Impl20 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl20.class);
    private static BasepPack2Impl20 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl20 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl20();
        }
        return INSTANCE;
    }

    private BasepPack2Impl20(){
