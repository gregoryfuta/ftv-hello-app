...
public class ComplexpPack2Impl980 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl980.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl980 INSTANCE;

    public static ComplexpPack2Impl980 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl980();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl980(){
