...
public class BasepPack2Impl292 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl292.class);
    private static BasepPack2Impl292 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl292 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl292();
        }
        return INSTANCE;
    }

    private BasepPack2Impl292(){
