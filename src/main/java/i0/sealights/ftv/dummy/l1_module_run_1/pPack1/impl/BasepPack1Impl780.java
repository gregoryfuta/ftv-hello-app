...
public class BasepPack1Impl780 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl780.class);
    private static BasepPack1Impl780 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl780 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl780();
        }
        return INSTANCE;
    }

    private BasepPack1Impl780(){
