...
public class ComplexpPack1Impl908 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl908.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl908 INSTANCE;

    public static ComplexpPack1Impl908 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl908();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl908(){
