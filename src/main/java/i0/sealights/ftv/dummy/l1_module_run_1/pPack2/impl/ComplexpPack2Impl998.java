...
public class ComplexpPack2Impl998 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl998.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl998 INSTANCE;

    public static ComplexpPack2Impl998 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl998();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl998(){
