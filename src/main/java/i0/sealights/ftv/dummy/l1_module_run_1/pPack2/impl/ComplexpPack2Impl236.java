...
public class ComplexpPack2Impl236 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl236.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl236 INSTANCE;

    public static ComplexpPack2Impl236 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl236();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl236(){
