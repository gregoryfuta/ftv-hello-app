...
public class BasepPack2Impl539 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl539.class);
    private static BasepPack2Impl539 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl539 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl539();
        }
        return INSTANCE;
    }

    private BasepPack2Impl539(){
