...
public class ComplexpPack1Impl520 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl520.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl520 INSTANCE;

    public static ComplexpPack1Impl520 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl520();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl520(){
