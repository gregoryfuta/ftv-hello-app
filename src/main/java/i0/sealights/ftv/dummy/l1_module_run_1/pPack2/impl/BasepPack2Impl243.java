...
public class BasepPack2Impl243 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl243.class);
    private static BasepPack2Impl243 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl243 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl243();
        }
        return INSTANCE;
    }

    private BasepPack2Impl243(){
