...
public class ComplexpPack2Impl261 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl261.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl261 INSTANCE;

    public static ComplexpPack2Impl261 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl261();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl261(){
