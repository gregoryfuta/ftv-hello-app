...
public class ComplexpPack1Impl607 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl607.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl607 INSTANCE;

    public static ComplexpPack1Impl607 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl607();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl607(){
