...
public class BasepPack1Impl89 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl89.class);
    private static BasepPack1Impl89 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl89 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl89();
        }
        return INSTANCE;
    }

    private BasepPack1Impl89(){
