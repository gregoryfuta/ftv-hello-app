...
public class BasepPack1Impl131 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl131.class);
    private static BasepPack1Impl131 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl131 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl131();
        }
        return INSTANCE;
    }

    private BasepPack1Impl131(){
