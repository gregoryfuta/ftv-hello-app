...
public class ComplexpPack1Impl850 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl850.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl850 INSTANCE;

    public static ComplexpPack1Impl850 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl850();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl850(){
