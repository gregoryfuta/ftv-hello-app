...
public class ComplexpPack2Impl581 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl581.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl581 INSTANCE;

    public static ComplexpPack2Impl581 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl581();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl581(){
