...
public class ComplexpPack1Impl77 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl77.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl77 INSTANCE;

    public static ComplexpPack1Impl77 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl77();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl77(){
