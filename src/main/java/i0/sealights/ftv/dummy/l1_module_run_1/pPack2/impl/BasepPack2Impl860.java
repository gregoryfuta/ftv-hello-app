...
public class BasepPack2Impl860 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl860.class);
    private static BasepPack2Impl860 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl860 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl860();
        }
        return INSTANCE;
    }

    private BasepPack2Impl860(){
