...
public class ComplexpPack1Impl810 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl810.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl810 INSTANCE;

    public static ComplexpPack1Impl810 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl810();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl810(){
