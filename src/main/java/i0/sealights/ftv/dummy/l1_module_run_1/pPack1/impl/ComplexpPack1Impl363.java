...
public class ComplexpPack1Impl363 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl363.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl363 INSTANCE;

    public static ComplexpPack1Impl363 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl363();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl363(){
