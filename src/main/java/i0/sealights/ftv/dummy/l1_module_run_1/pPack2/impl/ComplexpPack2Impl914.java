...
public class ComplexpPack2Impl914 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl914.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl914 INSTANCE;

    public static ComplexpPack2Impl914 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl914();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl914(){
