...
public class BasepPack2Impl121 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl121.class);
    private static BasepPack2Impl121 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl121 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl121();
        }
        return INSTANCE;
    }

    private BasepPack2Impl121(){
