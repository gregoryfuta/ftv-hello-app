...
public class BasepPack2Impl96 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl96.class);
    private static BasepPack2Impl96 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl96 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl96();
        }
        return INSTANCE;
    }

    private BasepPack2Impl96(){
