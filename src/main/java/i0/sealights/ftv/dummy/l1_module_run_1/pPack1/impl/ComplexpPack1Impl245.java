...
public class ComplexpPack1Impl245 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl245.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl245 INSTANCE;

    public static ComplexpPack1Impl245 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl245();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl245(){
