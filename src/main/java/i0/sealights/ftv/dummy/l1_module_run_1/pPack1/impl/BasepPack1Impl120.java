...
public class BasepPack1Impl120 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl120.class);
    private static BasepPack1Impl120 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl120 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl120();
        }
        return INSTANCE;
    }

    private BasepPack1Impl120(){
