...
public class BasepPack2Impl114 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl114.class);
    private static BasepPack2Impl114 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl114 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl114();
        }
        return INSTANCE;
    }

    private BasepPack2Impl114(){
