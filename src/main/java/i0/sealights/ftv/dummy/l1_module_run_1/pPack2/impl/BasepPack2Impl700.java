...
public class BasepPack2Impl700 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl700.class);
    private static BasepPack2Impl700 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl700 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl700();
        }
        return INSTANCE;
    }

    private BasepPack2Impl700(){
