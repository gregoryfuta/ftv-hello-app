...
public class ComplexpPack1Impl341 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl341.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl341 INSTANCE;

    public static ComplexpPack1Impl341 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl341();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl341(){
