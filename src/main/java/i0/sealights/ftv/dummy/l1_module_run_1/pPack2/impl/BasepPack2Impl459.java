...
public class BasepPack2Impl459 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl459.class);
    private static BasepPack2Impl459 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl459 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl459();
        }
        return INSTANCE;
    }

    private BasepPack2Impl459(){
