...
public class ComplexpPack2Impl30 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl30.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl30 INSTANCE;

    public static ComplexpPack2Impl30 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl30();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl30(){
