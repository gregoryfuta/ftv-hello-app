...
public class BasepPack2Impl129 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl129.class);
    private static BasepPack2Impl129 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl129 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl129();
        }
        return INSTANCE;
    }

    private BasepPack2Impl129(){
