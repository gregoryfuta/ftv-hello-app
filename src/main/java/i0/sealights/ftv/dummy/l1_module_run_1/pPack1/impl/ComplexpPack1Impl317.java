...
public class ComplexpPack1Impl317 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl317.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl317 INSTANCE;

    public static ComplexpPack1Impl317 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl317();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl317(){
