...
public class ComplexpPack1Impl776 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl776.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl776 INSTANCE;

    public static ComplexpPack1Impl776 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl776();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl776(){
