...
public class BasepPack2Impl680 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl680.class);
    private static BasepPack2Impl680 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl680 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl680();
        }
        return INSTANCE;
    }

    private BasepPack2Impl680(){
