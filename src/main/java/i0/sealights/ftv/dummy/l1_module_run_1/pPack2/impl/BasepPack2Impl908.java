...
public class BasepPack2Impl908 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl908.class);
    private static BasepPack2Impl908 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl908 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl908();
        }
        return INSTANCE;
    }

    private BasepPack2Impl908(){
