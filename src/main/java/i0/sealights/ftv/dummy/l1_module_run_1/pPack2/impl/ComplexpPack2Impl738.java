...
public class ComplexpPack2Impl738 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl738.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl738 INSTANCE;

    public static ComplexpPack2Impl738 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl738();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl738(){
