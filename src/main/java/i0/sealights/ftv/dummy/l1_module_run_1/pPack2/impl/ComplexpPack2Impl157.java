...
public class ComplexpPack2Impl157 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl157.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl157 INSTANCE;

    public static ComplexpPack2Impl157 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl157();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl157(){
