...
public class BasepPack1Impl885 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl885.class);
    private static BasepPack1Impl885 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl885 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl885();
        }
        return INSTANCE;
    }

    private BasepPack1Impl885(){
