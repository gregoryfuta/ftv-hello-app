...
public class BasepPack1Impl511 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl511.class);
    private static BasepPack1Impl511 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl511 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl511();
        }
        return INSTANCE;
    }

    private BasepPack1Impl511(){
