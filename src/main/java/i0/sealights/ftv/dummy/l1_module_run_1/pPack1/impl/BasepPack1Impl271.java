...
public class BasepPack1Impl271 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl271.class);
    private static BasepPack1Impl271 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl271 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl271();
        }
        return INSTANCE;
    }

    private BasepPack1Impl271(){
