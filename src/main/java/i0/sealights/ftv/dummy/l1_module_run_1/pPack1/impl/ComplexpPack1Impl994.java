...
public class ComplexpPack1Impl994 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl994.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl994 INSTANCE;

    public static ComplexpPack1Impl994 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl994();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl994(){
