...
public class BasepPack2Impl604 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl604.class);
    private static BasepPack2Impl604 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl604 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl604();
        }
        return INSTANCE;
    }

    private BasepPack2Impl604(){
