...
public class ComplexpPack1Impl351 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl351.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl351 INSTANCE;

    public static ComplexpPack1Impl351 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl351();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl351(){
