...
public class BasepPack1Impl282 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl282.class);
    private static BasepPack1Impl282 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl282 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl282();
        }
        return INSTANCE;
    }

    private BasepPack1Impl282(){
