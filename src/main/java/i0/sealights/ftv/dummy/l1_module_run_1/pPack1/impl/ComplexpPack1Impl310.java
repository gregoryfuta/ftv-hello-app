...
public class ComplexpPack1Impl310 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl310.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl310 INSTANCE;

    public static ComplexpPack1Impl310 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl310();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl310(){
