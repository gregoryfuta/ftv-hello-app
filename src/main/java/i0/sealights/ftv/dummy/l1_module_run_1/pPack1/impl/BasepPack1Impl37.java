...
public class BasepPack1Impl37 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl37.class);
    private static BasepPack1Impl37 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl37 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl37();
        }
        return INSTANCE;
    }

    private BasepPack1Impl37(){
