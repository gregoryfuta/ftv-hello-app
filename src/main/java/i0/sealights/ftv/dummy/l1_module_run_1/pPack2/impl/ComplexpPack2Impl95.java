...
public class ComplexpPack2Impl95 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl95.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl95 INSTANCE;

    public static ComplexpPack2Impl95 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl95();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl95(){
