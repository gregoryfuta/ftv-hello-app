...
public class BasepPack1Impl543 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl543.class);
    private static BasepPack1Impl543 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl543 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl543();
        }
        return INSTANCE;
    }

    private BasepPack1Impl543(){
