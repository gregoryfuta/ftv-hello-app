...
public class BasepPack1Impl650 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl650.class);
    private static BasepPack1Impl650 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl650 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl650();
        }
        return INSTANCE;
    }

    private BasepPack1Impl650(){
