...
public class ComplexpPack1Impl912 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl912.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl912 INSTANCE;

    public static ComplexpPack1Impl912 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl912();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl912(){
