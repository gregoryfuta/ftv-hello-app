...
public class BasepPack2Impl818 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl818.class);
    private static BasepPack2Impl818 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl818 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl818();
        }
        return INSTANCE;
    }

    private BasepPack2Impl818(){
