...
public class ComplexpPack2Impl212 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl212.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl212 INSTANCE;

    public static ComplexpPack2Impl212 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl212();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl212(){
