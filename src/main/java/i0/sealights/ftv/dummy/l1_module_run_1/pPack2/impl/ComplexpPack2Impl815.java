...
public class ComplexpPack2Impl815 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl815.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl815 INSTANCE;

    public static ComplexpPack2Impl815 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl815();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl815(){
