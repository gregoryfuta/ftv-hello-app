...
public class ComplexpPack2Impl344 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl344.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl344 INSTANCE;

    public static ComplexpPack2Impl344 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl344();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl344(){
