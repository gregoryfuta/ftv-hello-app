...
public class BasepPack1Impl253 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl253.class);
    private static BasepPack1Impl253 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl253 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl253();
        }
        return INSTANCE;
    }

    private BasepPack1Impl253(){
