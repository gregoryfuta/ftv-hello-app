...
public class BasepPack1Impl371 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl371.class);
    private static BasepPack1Impl371 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl371 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl371();
        }
        return INSTANCE;
    }

    private BasepPack1Impl371(){
