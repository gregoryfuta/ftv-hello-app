...
public class BasepPack1Impl229 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl229.class);
    private static BasepPack1Impl229 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl229 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl229();
        }
        return INSTANCE;
    }

    private BasepPack1Impl229(){
