...
public class BasepPack2Impl852 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl852.class);
    private static BasepPack2Impl852 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl852 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl852();
        }
        return INSTANCE;
    }

    private BasepPack2Impl852(){
