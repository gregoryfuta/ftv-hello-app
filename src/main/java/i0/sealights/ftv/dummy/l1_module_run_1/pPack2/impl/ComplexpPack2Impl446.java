...
public class ComplexpPack2Impl446 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl446.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl446 INSTANCE;

    public static ComplexpPack2Impl446 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl446();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl446(){
