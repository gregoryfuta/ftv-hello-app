...
public class BasepPack2Impl242 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl242.class);
    private static BasepPack2Impl242 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl242 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl242();
        }
        return INSTANCE;
    }

    private BasepPack2Impl242(){
