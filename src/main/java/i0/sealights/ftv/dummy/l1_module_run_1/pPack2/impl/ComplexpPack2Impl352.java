...
public class ComplexpPack2Impl352 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl352.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl352 INSTANCE;

    public static ComplexpPack2Impl352 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl352();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl352(){
