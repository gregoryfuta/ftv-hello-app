...
public class ComplexpPack2Impl677 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl677.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl677 INSTANCE;

    public static ComplexpPack2Impl677 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl677();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl677(){
