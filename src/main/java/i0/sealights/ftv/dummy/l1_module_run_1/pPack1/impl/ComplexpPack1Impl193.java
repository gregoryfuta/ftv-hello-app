...
public class ComplexpPack1Impl193 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl193.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl193 INSTANCE;

    public static ComplexpPack1Impl193 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl193();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl193(){
