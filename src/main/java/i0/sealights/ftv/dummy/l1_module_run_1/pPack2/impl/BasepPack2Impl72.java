...
public class BasepPack2Impl72 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl72.class);
    private static BasepPack2Impl72 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl72 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl72();
        }
        return INSTANCE;
    }

    private BasepPack2Impl72(){
