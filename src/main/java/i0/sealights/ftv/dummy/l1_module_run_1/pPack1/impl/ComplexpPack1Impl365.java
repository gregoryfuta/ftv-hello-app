...
public class ComplexpPack1Impl365 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl365.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl365 INSTANCE;

    public static ComplexpPack1Impl365 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl365();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl365(){
