...
public class BasepPack1Impl162 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl162.class);
    private static BasepPack1Impl162 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl162 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl162();
        }
        return INSTANCE;
    }

    private BasepPack1Impl162(){
