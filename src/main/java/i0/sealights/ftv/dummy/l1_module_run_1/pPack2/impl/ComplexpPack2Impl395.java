...
public class ComplexpPack2Impl395 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl395.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl395 INSTANCE;

    public static ComplexpPack2Impl395 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl395();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl395(){
