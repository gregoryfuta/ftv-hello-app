...
public class ComplexpPack1Impl422 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl422.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl422 INSTANCE;

    public static ComplexpPack1Impl422 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl422();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl422(){
