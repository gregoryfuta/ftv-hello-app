...
public class ComplexpPack2Impl439 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl439.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl439 INSTANCE;

    public static ComplexpPack2Impl439 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl439();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl439(){
