...
public class BasepPack2Impl822 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl822.class);
    private static BasepPack2Impl822 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl822 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl822();
        }
        return INSTANCE;
    }

    private BasepPack2Impl822(){
