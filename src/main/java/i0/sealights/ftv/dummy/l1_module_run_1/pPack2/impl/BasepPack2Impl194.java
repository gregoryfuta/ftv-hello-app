...
public class BasepPack2Impl194 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl194.class);
    private static BasepPack2Impl194 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl194 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl194();
        }
        return INSTANCE;
    }

    private BasepPack2Impl194(){
