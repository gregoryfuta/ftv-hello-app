...
public class ComplexpPack2Impl183 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl183.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl183 INSTANCE;

    public static ComplexpPack2Impl183 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl183();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl183(){
