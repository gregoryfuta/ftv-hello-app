...
public class BasepPack1Impl123 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl123.class);
    private static BasepPack1Impl123 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl123 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl123();
        }
        return INSTANCE;
    }

    private BasepPack1Impl123(){
