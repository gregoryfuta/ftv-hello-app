...
public class ComplexpPack2Impl165 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl165.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl165 INSTANCE;

    public static ComplexpPack2Impl165 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl165();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl165(){
