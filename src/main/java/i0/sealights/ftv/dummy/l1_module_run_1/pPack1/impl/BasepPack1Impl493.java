...
public class BasepPack1Impl493 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl493.class);
    private static BasepPack1Impl493 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl493 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl493();
        }
        return INSTANCE;
    }

    private BasepPack1Impl493(){
