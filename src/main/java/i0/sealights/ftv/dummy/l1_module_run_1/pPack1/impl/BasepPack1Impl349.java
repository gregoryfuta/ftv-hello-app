...
public class BasepPack1Impl349 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl349.class);
    private static BasepPack1Impl349 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl349 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl349();
        }
        return INSTANCE;
    }

    private BasepPack1Impl349(){
