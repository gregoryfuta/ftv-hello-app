...
public class BasepPack1Impl939 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl939.class);
    private static BasepPack1Impl939 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl939 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl939();
        }
        return INSTANCE;
    }

    private BasepPack1Impl939(){
