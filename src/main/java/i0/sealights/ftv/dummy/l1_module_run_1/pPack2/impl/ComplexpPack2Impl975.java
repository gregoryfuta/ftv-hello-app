...
public class ComplexpPack2Impl975 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl975.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl975 INSTANCE;

    public static ComplexpPack2Impl975 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl975();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl975(){
