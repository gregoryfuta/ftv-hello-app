...
public class ComplexpPack2Impl759 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl759.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl759 INSTANCE;

    public static ComplexpPack2Impl759 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl759();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl759(){
