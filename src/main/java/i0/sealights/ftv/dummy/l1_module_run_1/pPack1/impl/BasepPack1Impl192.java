...
public class BasepPack1Impl192 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl192.class);
    private static BasepPack1Impl192 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl192 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl192();
        }
        return INSTANCE;
    }

    private BasepPack1Impl192(){
