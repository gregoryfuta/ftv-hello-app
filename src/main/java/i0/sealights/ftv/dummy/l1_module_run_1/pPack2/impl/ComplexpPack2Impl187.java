...
public class ComplexpPack2Impl187 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl187.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl187 INSTANCE;

    public static ComplexpPack2Impl187 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl187();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl187(){
