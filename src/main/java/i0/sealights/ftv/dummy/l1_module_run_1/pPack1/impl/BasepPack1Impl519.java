...
public class BasepPack1Impl519 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl519.class);
    private static BasepPack1Impl519 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl519 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl519();
        }
        return INSTANCE;
    }

    private BasepPack1Impl519(){
