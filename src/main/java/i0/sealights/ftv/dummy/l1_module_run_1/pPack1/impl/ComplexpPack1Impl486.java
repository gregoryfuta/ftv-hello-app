...
public class ComplexpPack1Impl486 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl486.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl486 INSTANCE;

    public static ComplexpPack1Impl486 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl486();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl486(){
