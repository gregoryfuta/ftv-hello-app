...
public class BasepPack1Impl275 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl275.class);
    private static BasepPack1Impl275 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl275 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl275();
        }
        return INSTANCE;
    }

    private BasepPack1Impl275(){
