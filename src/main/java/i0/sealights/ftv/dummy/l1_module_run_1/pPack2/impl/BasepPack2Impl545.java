...
public class BasepPack2Impl545 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl545.class);
    private static BasepPack2Impl545 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl545 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl545();
        }
        return INSTANCE;
    }

    private BasepPack2Impl545(){
