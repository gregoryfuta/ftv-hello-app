...
public class ComplexpPack1Impl201 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl201.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl201 INSTANCE;

    public static ComplexpPack1Impl201 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl201();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl201(){
