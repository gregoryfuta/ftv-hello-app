...
public class ComplexpPack2Impl745 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl745.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl745 INSTANCE;

    public static ComplexpPack2Impl745 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl745();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl745(){
