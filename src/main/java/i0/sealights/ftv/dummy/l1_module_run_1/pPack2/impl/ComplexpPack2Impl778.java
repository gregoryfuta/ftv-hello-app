...
public class ComplexpPack2Impl778 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl778.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl778 INSTANCE;

    public static ComplexpPack2Impl778 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl778();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl778(){
