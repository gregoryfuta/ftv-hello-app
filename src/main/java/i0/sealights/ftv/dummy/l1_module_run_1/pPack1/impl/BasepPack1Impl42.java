...
public class BasepPack1Impl42 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl42.class);
    private static BasepPack1Impl42 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl42 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl42();
        }
        return INSTANCE;
    }

    private BasepPack1Impl42(){
