...
public class BasepPack2Impl655 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl655.class);
    private static BasepPack2Impl655 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl655 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl655();
        }
        return INSTANCE;
    }

    private BasepPack2Impl655(){
