...
public class ComplexpPack1Impl36 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl36.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl36 INSTANCE;

    public static ComplexpPack1Impl36 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl36();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl36(){
