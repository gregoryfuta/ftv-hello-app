...
public class ComplexpPack2Impl290 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl290.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl290 INSTANCE;

    public static ComplexpPack2Impl290 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl290();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl290(){
