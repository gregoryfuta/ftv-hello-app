...
public class BasepPack1Impl840 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl840.class);
    private static BasepPack1Impl840 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl840 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl840();
        }
        return INSTANCE;
    }

    private BasepPack1Impl840(){
