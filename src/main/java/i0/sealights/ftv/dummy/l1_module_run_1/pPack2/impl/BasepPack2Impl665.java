...
public class BasepPack2Impl665 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl665.class);
    private static BasepPack2Impl665 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl665 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl665();
        }
        return INSTANCE;
    }

    private BasepPack2Impl665(){
