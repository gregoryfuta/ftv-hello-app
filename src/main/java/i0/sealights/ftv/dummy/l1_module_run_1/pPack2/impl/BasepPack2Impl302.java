...
public class BasepPack2Impl302 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl302.class);
    private static BasepPack2Impl302 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl302 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl302();
        }
        return INSTANCE;
    }

    private BasepPack2Impl302(){
