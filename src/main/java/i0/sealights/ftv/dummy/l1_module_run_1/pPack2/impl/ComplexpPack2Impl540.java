...
public class ComplexpPack2Impl540 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl540.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl540 INSTANCE;

    public static ComplexpPack2Impl540 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl540();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl540(){
