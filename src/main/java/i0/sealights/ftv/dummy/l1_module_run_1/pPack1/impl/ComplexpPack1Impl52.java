...
public class ComplexpPack1Impl52 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl52.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl52 INSTANCE;

    public static ComplexpPack1Impl52 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl52();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl52(){
