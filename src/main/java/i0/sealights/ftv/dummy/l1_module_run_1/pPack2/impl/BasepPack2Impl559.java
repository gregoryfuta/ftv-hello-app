...
public class BasepPack2Impl559 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl559.class);
    private static BasepPack2Impl559 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl559 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl559();
        }
        return INSTANCE;
    }

    private BasepPack2Impl559(){
