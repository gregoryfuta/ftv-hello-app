...
public class BasepPack1Impl945 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl945.class);
    private static BasepPack1Impl945 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl945 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl945();
        }
        return INSTANCE;
    }

    private BasepPack1Impl945(){
