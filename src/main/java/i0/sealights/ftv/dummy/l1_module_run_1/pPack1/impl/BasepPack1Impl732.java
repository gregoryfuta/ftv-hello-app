...
public class BasepPack1Impl732 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl732.class);
    private static BasepPack1Impl732 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl732 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl732();
        }
        return INSTANCE;
    }

    private BasepPack1Impl732(){
