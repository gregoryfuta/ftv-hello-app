...
public class ComplexpPack1Impl743 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl743.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl743 INSTANCE;

    public static ComplexpPack1Impl743 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl743();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl743(){
