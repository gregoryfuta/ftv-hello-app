...
public class BasepPack1Impl486 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl486.class);
    private static BasepPack1Impl486 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl486 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl486();
        }
        return INSTANCE;
    }

    private BasepPack1Impl486(){
