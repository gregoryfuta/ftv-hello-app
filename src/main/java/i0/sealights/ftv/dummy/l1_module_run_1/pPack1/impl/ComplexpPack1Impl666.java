...
public class ComplexpPack1Impl666 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl666.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl666 INSTANCE;

    public static ComplexpPack1Impl666 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl666();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl666(){
