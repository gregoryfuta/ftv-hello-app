...
public class BasepPack2Impl45 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl45.class);
    private static BasepPack2Impl45 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl45 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl45();
        }
        return INSTANCE;
    }

    private BasepPack2Impl45(){
