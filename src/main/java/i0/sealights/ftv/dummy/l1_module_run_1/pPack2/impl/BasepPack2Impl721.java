...
public class BasepPack2Impl721 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl721.class);
    private static BasepPack2Impl721 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl721 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl721();
        }
        return INSTANCE;
    }

    private BasepPack2Impl721(){
