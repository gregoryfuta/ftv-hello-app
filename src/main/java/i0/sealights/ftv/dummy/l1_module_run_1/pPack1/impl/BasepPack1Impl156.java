...
public class BasepPack1Impl156 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl156.class);
    private static BasepPack1Impl156 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl156 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl156();
        }
        return INSTANCE;
    }

    private BasepPack1Impl156(){
