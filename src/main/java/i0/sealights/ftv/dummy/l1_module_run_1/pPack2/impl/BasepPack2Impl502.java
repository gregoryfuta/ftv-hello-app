...
public class BasepPack2Impl502 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl502.class);
    private static BasepPack2Impl502 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl502 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl502();
        }
        return INSTANCE;
    }

    private BasepPack2Impl502(){
