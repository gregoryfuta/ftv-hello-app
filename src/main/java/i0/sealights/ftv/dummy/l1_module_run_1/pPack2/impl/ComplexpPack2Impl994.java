...
public class ComplexpPack2Impl994 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl994.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl994 INSTANCE;

    public static ComplexpPack2Impl994 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl994();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl994(){
