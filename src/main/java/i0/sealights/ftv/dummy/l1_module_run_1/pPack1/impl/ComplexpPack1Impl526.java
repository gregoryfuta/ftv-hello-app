...
public class ComplexpPack1Impl526 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl526.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl526 INSTANCE;

    public static ComplexpPack1Impl526 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl526();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl526(){
