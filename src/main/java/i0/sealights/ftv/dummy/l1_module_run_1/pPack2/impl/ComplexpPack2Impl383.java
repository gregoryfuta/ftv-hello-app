...
public class ComplexpPack2Impl383 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl383.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl383 INSTANCE;

    public static ComplexpPack2Impl383 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl383();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl383(){
