...
public class BasepPack2Impl94 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl94.class);
    private static BasepPack2Impl94 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl94 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl94();
        }
        return INSTANCE;
    }

    private BasepPack2Impl94(){
