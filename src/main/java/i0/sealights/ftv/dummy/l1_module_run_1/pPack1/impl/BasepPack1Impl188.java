...
public class BasepPack1Impl188 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl188.class);
    private static BasepPack1Impl188 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl188 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl188();
        }
        return INSTANCE;
    }

    private BasepPack1Impl188(){
