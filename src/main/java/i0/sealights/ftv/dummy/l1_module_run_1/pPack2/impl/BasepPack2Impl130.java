...
public class BasepPack2Impl130 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl130.class);
    private static BasepPack2Impl130 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl130 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl130();
        }
        return INSTANCE;
    }

    private BasepPack2Impl130(){
