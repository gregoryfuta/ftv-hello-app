...
public class BasepPack2Impl364 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl364.class);
    private static BasepPack2Impl364 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl364 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl364();
        }
        return INSTANCE;
    }

    private BasepPack2Impl364(){
