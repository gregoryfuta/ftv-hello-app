...
public class ComplexpPack1Impl937 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl937.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl937 INSTANCE;

    public static ComplexpPack1Impl937 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl937();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl937(){
