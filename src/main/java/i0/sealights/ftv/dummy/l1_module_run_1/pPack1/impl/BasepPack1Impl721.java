...
public class BasepPack1Impl721 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl721.class);
    private static BasepPack1Impl721 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl721 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl721();
        }
        return INSTANCE;
    }

    private BasepPack1Impl721(){
