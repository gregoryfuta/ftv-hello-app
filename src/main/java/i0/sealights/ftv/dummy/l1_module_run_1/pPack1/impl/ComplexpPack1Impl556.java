...
public class ComplexpPack1Impl556 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl556.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl556 INSTANCE;

    public static ComplexpPack1Impl556 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl556();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl556(){
