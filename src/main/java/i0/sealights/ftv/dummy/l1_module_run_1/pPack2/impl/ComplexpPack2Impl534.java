...
public class ComplexpPack2Impl534 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl534.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl534 INSTANCE;

    public static ComplexpPack2Impl534 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl534();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl534(){
