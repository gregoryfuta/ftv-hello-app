...
public class ComplexpPack1Impl270 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl270.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl270 INSTANCE;

    public static ComplexpPack1Impl270 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl270();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl270(){
