...
public class BasepPack1Impl654 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl654.class);
    private static BasepPack1Impl654 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl654 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl654();
        }
        return INSTANCE;
    }

    private BasepPack1Impl654(){
