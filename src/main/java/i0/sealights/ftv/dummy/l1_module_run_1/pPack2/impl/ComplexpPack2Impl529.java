...
public class ComplexpPack2Impl529 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl529.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl529 INSTANCE;

    public static ComplexpPack2Impl529 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl529();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl529(){
