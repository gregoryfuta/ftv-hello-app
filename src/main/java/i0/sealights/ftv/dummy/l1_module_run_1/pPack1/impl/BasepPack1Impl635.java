...
public class BasepPack1Impl635 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl635.class);
    private static BasepPack1Impl635 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl635 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl635();
        }
        return INSTANCE;
    }

    private BasepPack1Impl635(){
