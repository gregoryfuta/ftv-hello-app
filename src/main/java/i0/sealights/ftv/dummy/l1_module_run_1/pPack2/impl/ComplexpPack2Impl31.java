...
public class ComplexpPack2Impl31 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl31.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl31 INSTANCE;

    public static ComplexpPack2Impl31 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl31();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl31(){
