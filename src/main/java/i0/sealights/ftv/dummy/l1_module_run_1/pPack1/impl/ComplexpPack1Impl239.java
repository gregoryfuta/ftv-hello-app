...
public class ComplexpPack1Impl239 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl239.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl239 INSTANCE;

    public static ComplexpPack1Impl239 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl239();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl239(){
