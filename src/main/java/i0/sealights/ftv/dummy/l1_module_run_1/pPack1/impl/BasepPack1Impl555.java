...
public class BasepPack1Impl555 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl555.class);
    private static BasepPack1Impl555 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl555 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl555();
        }
        return INSTANCE;
    }

    private BasepPack1Impl555(){
