...
public class ComplexpPack2Impl393 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl393.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl393 INSTANCE;

    public static ComplexpPack2Impl393 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl393();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl393(){
