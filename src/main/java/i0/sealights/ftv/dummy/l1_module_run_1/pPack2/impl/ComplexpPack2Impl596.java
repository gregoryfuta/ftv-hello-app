...
public class ComplexpPack2Impl596 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl596.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl596 INSTANCE;

    public static ComplexpPack2Impl596 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl596();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl596(){
