...
public class BasepPack1Impl257 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl257.class);
    private static BasepPack1Impl257 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl257 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl257();
        }
        return INSTANCE;
    }

    private BasepPack1Impl257(){
