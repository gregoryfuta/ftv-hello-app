...
public class ComplexpPack2Impl174 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl174.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl174 INSTANCE;

    public static ComplexpPack2Impl174 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl174();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl174(){
