...
public class ComplexpPack1Impl560 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl560.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl560 INSTANCE;

    public static ComplexpPack1Impl560 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl560();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl560(){
