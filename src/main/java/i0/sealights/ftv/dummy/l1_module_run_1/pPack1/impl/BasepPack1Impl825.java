...
public class BasepPack1Impl825 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl825.class);
    private static BasepPack1Impl825 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl825 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl825();
        }
        return INSTANCE;
    }

    private BasepPack1Impl825(){
