...
public class BasepPack2Impl543 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl543.class);
    private static BasepPack2Impl543 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl543 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl543();
        }
        return INSTANCE;
    }

    private BasepPack2Impl543(){
