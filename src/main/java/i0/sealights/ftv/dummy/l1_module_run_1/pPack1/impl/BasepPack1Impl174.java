...
public class BasepPack1Impl174 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl174.class);
    private static BasepPack1Impl174 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl174 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl174();
        }
        return INSTANCE;
    }

    private BasepPack1Impl174(){
