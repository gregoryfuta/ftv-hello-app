...
public class ComplexpPack1Impl618 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl618.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl618 INSTANCE;

    public static ComplexpPack1Impl618 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl618();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl618(){
