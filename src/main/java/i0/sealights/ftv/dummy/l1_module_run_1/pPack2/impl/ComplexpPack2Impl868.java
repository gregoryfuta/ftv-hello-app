...
public class ComplexpPack2Impl868 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl868.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl868 INSTANCE;

    public static ComplexpPack2Impl868 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl868();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl868(){
