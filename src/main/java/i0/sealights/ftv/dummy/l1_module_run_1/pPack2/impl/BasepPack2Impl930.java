...
public class BasepPack2Impl930 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl930.class);
    private static BasepPack2Impl930 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl930 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl930();
        }
        return INSTANCE;
    }

    private BasepPack2Impl930(){
