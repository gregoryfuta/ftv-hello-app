...
public class BasepPack1Impl186 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl186.class);
    private static BasepPack1Impl186 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl186 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl186();
        }
        return INSTANCE;
    }

    private BasepPack1Impl186(){
