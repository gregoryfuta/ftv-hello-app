...
public class ComplexpPack1Impl525 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl525.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl525 INSTANCE;

    public static ComplexpPack1Impl525 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl525();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl525(){
