...
public class BasepPack2Impl949 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl949.class);
    private static BasepPack2Impl949 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl949 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl949();
        }
        return INSTANCE;
    }

    private BasepPack2Impl949(){
