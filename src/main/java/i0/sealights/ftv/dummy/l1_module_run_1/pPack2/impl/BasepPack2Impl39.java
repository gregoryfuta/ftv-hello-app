...
public class BasepPack2Impl39 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl39.class);
    private static BasepPack2Impl39 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl39 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl39();
        }
        return INSTANCE;
    }

    private BasepPack2Impl39(){
