...
public class ComplexpPack1Impl980 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl980.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl980 INSTANCE;

    public static ComplexpPack1Impl980 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl980();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl980(){
