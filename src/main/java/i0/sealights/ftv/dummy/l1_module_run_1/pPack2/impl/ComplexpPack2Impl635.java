...
public class ComplexpPack2Impl635 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl635.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl635 INSTANCE;

    public static ComplexpPack2Impl635 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl635();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl635(){
