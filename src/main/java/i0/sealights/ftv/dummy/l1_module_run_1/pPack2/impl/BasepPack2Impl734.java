...
public class BasepPack2Impl734 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl734.class);
    private static BasepPack2Impl734 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl734 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl734();
        }
        return INSTANCE;
    }

    private BasepPack2Impl734(){
