...
public class BasepPack2Impl827 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl827.class);
    private static BasepPack2Impl827 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl827 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl827();
        }
        return INSTANCE;
    }

    private BasepPack2Impl827(){
