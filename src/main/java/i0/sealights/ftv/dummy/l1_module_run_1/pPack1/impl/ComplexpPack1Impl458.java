...
public class ComplexpPack1Impl458 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl458.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl458 INSTANCE;

    public static ComplexpPack1Impl458 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl458();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl458(){
