...
public class ComplexpPack2Impl955 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl955.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl955 INSTANCE;

    public static ComplexpPack2Impl955 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl955();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl955(){
