...
public class BasepPack1Impl796 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl796.class);
    private static BasepPack1Impl796 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl796 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl796();
        }
        return INSTANCE;
    }

    private BasepPack1Impl796(){
