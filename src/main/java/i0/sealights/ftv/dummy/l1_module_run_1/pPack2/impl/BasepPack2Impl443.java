...
public class BasepPack2Impl443 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl443.class);
    private static BasepPack2Impl443 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl443 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl443();
        }
        return INSTANCE;
    }

    private BasepPack2Impl443(){
