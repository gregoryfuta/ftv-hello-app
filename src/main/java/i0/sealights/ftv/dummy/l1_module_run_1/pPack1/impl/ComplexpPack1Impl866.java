...
public class ComplexpPack1Impl866 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl866.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl866 INSTANCE;

    public static ComplexpPack1Impl866 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl866();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl866(){
