...
public class ComplexpPack1Impl549 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl549.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl549 INSTANCE;

    public static ComplexpPack1Impl549 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl549();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl549(){
