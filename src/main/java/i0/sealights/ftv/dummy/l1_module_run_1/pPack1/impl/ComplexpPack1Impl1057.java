...
public class ComplexpPack1Impl1057 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1057.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1057 INSTANCE;

    public static ComplexpPack1Impl1057 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1057();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1057(){
