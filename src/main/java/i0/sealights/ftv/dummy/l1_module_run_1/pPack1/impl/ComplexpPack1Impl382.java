...
public class ComplexpPack1Impl382 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl382.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl382 INSTANCE;

    public static ComplexpPack1Impl382 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl382();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl382(){
