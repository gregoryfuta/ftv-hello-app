...
public class BasepPack2Impl768 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl768.class);
    private static BasepPack2Impl768 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl768 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl768();
        }
        return INSTANCE;
    }

    private BasepPack2Impl768(){
