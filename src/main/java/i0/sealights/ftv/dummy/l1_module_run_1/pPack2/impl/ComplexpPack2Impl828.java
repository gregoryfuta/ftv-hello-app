...
public class ComplexpPack2Impl828 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl828.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl828 INSTANCE;

    public static ComplexpPack2Impl828 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl828();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl828(){
