...
public class ComplexpPack1Impl75 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl75.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl75 INSTANCE;

    public static ComplexpPack1Impl75 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl75();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl75(){
