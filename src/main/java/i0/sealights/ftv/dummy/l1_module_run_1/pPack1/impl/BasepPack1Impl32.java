...
public class BasepPack1Impl32 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl32.class);
    private static BasepPack1Impl32 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl32 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl32();
        }
        return INSTANCE;
    }

    private BasepPack1Impl32(){
