...
public class ComplexpPack2Impl644 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl644.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl644 INSTANCE;

    public static ComplexpPack2Impl644 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl644();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl644(){
