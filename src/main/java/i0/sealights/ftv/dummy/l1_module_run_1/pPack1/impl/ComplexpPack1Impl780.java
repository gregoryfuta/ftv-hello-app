...
public class ComplexpPack1Impl780 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl780.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl780 INSTANCE;

    public static ComplexpPack1Impl780 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl780();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl780(){
