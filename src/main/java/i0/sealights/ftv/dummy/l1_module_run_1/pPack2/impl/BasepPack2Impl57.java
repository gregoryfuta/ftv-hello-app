...
public class BasepPack2Impl57 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl57.class);
    private static BasepPack2Impl57 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl57 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl57();
        }
        return INSTANCE;
    }

    private BasepPack2Impl57(){
