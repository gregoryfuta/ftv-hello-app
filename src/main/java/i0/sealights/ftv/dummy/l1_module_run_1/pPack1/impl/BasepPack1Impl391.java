...
public class BasepPack1Impl391 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl391.class);
    private static BasepPack1Impl391 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl391 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl391();
        }
        return INSTANCE;
    }

    private BasepPack1Impl391(){
