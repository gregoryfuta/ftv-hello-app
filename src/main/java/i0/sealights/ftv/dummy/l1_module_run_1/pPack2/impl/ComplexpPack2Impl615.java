...
public class ComplexpPack2Impl615 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl615.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl615 INSTANCE;

    public static ComplexpPack2Impl615 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl615();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl615(){
