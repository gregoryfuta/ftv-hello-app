...
public class BasepPack1Impl831 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl831.class);
    private static BasepPack1Impl831 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl831 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl831();
        }
        return INSTANCE;
    }

    private BasepPack1Impl831(){
