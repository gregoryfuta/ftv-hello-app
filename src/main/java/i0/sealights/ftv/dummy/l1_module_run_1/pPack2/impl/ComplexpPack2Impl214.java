...
public class ComplexpPack2Impl214 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl214.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl214 INSTANCE;

    public static ComplexpPack2Impl214 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl214();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl214(){
