...
public class BasepPack2Impl672 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl672.class);
    private static BasepPack2Impl672 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl672 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl672();
        }
        return INSTANCE;
    }

    private BasepPack2Impl672(){
