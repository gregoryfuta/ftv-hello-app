...
public class BasepPack2Impl118 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl118.class);
    private static BasepPack2Impl118 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl118 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl118();
        }
        return INSTANCE;
    }

    private BasepPack2Impl118(){
