...
public class ComplexpPack2Impl232 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl232.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl232 INSTANCE;

    public static ComplexpPack2Impl232 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl232();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl232(){
