...
public class ComplexpPack1Impl996 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl996.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl996 INSTANCE;

    public static ComplexpPack1Impl996 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl996();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl996(){
