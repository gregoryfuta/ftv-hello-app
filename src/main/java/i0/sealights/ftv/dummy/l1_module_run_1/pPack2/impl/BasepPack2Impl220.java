...
public class BasepPack2Impl220 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl220.class);
    private static BasepPack2Impl220 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl220 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl220();
        }
        return INSTANCE;
    }

    private BasepPack2Impl220(){
