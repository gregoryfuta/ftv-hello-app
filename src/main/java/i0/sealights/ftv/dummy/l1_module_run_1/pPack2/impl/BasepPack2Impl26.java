...
public class BasepPack2Impl26 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl26.class);
    private static BasepPack2Impl26 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl26 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl26();
        }
        return INSTANCE;
    }

    private BasepPack2Impl26(){
