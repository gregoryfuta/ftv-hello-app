...
public class BasepPack2Impl467 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl467.class);
    private static BasepPack2Impl467 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl467 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl467();
        }
        return INSTANCE;
    }

    private BasepPack2Impl467(){
