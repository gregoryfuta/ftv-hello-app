...
public class ComplexpPack1Impl189 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl189.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl189 INSTANCE;

    public static ComplexpPack1Impl189 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl189();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl189(){
