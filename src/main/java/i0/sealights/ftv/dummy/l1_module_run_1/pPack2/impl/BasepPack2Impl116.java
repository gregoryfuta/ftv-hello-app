...
public class BasepPack2Impl116 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl116.class);
    private static BasepPack2Impl116 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl116 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl116();
        }
        return INSTANCE;
    }

    private BasepPack2Impl116(){
