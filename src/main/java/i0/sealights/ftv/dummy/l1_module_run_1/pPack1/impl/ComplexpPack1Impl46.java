...
public class ComplexpPack1Impl46 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl46.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl46 INSTANCE;

    public static ComplexpPack1Impl46 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl46();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl46(){
