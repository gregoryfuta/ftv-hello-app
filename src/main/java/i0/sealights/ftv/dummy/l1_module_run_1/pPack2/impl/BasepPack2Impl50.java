...
public class BasepPack2Impl50 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl50.class);
    private static BasepPack2Impl50 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl50 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl50();
        }
        return INSTANCE;
    }

    private BasepPack2Impl50(){
