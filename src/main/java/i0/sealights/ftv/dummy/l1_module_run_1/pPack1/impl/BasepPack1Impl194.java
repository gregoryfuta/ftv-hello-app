...
public class BasepPack1Impl194 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl194.class);
    private static BasepPack1Impl194 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl194 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl194();
        }
        return INSTANCE;
    }

    private BasepPack1Impl194(){
