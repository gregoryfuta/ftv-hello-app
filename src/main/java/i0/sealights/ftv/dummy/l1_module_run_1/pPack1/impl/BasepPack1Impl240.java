...
public class BasepPack1Impl240 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl240.class);
    private static BasepPack1Impl240 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl240 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl240();
        }
        return INSTANCE;
    }

    private BasepPack1Impl240(){
