...
public class ComplexpPack2Impl90 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl90.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl90 INSTANCE;

    public static ComplexpPack2Impl90 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl90();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl90(){
