...
public class BasepPack1Impl396 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl396.class);
    private static BasepPack1Impl396 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl396 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl396();
        }
        return INSTANCE;
    }

    private BasepPack1Impl396(){
