...
public class BasepPack1Impl959 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl959.class);
    private static BasepPack1Impl959 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl959 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl959();
        }
        return INSTANCE;
    }

    private BasepPack1Impl959(){
