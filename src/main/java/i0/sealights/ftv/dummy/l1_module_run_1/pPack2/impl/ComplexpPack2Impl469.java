...
public class ComplexpPack2Impl469 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl469.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl469 INSTANCE;

    public static ComplexpPack2Impl469 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl469();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl469(){
