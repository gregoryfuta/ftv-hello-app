...
public class ComplexpPack1Impl287 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl287.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl287 INSTANCE;

    public static ComplexpPack1Impl287 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl287();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl287(){
