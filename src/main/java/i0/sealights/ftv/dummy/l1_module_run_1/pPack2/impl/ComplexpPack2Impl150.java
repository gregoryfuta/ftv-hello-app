...
public class ComplexpPack2Impl150 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl150.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl150 INSTANCE;

    public static ComplexpPack2Impl150 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl150();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl150(){
