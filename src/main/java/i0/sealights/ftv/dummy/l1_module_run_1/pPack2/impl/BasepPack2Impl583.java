...
public class BasepPack2Impl583 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl583.class);
    private static BasepPack2Impl583 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl583 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl583();
        }
        return INSTANCE;
    }

    private BasepPack2Impl583(){
