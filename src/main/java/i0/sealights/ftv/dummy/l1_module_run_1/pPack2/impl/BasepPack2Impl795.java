...
public class BasepPack2Impl795 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl795.class);
    private static BasepPack2Impl795 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl795 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl795();
        }
        return INSTANCE;
    }

    private BasepPack2Impl795(){
