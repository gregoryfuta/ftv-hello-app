...
public class ComplexpPack1Impl428 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl428.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl428 INSTANCE;

    public static ComplexpPack1Impl428 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl428();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl428(){
