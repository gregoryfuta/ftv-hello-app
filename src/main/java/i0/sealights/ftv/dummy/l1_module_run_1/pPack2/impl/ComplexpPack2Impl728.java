...
public class ComplexpPack2Impl728 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl728.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl728 INSTANCE;

    public static ComplexpPack2Impl728 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl728();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl728(){
