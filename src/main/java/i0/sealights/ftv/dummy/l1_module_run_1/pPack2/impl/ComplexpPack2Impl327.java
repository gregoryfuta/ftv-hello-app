...
public class ComplexpPack2Impl327 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl327.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl327 INSTANCE;

    public static ComplexpPack2Impl327 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl327();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl327(){
