...
public class ComplexpPack2Impl378 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl378.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl378 INSTANCE;

    public static ComplexpPack2Impl378 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl378();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl378(){
