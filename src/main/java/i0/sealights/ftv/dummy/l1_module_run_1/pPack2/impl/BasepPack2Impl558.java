...
public class BasepPack2Impl558 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl558.class);
    private static BasepPack2Impl558 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl558 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl558();
        }
        return INSTANCE;
    }

    private BasepPack2Impl558(){
