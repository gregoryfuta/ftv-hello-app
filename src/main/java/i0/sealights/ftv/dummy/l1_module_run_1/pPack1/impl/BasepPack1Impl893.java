...
public class BasepPack1Impl893 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl893.class);
    private static BasepPack1Impl893 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl893 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl893();
        }
        return INSTANCE;
    }

    private BasepPack1Impl893(){
