...
public class BasepPack2Impl166 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl166.class);
    private static BasepPack2Impl166 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl166 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl166();
        }
        return INSTANCE;
    }

    private BasepPack2Impl166(){
