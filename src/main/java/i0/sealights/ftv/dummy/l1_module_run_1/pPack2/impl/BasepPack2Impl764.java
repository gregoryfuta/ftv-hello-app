...
public class BasepPack2Impl764 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl764.class);
    private static BasepPack2Impl764 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl764 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl764();
        }
        return INSTANCE;
    }

    private BasepPack2Impl764(){
