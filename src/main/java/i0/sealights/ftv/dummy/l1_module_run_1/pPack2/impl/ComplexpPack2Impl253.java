...
public class ComplexpPack2Impl253 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl253.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl253 INSTANCE;

    public static ComplexpPack2Impl253 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl253();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl253(){
