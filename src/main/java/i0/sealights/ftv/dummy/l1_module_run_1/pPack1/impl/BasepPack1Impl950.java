...
public class BasepPack1Impl950 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl950.class);
    private static BasepPack1Impl950 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl950 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl950();
        }
        return INSTANCE;
    }

    private BasepPack1Impl950(){
