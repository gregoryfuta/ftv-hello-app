...
public class ComplexpPack1Impl430 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl430.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl430 INSTANCE;

    public static ComplexpPack1Impl430 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl430();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl430(){
