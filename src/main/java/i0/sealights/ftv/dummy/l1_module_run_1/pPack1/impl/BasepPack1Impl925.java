...
public class BasepPack1Impl925 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl925.class);
    private static BasepPack1Impl925 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl925 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl925();
        }
        return INSTANCE;
    }

    private BasepPack1Impl925(){
