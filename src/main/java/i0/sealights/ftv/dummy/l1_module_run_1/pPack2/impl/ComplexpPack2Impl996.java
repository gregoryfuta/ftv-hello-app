...
public class ComplexpPack2Impl996 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl996.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl996 INSTANCE;

    public static ComplexpPack2Impl996 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl996();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl996(){
