...
public class ComplexpPack2Impl303 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl303.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl303 INSTANCE;

    public static ComplexpPack2Impl303 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl303();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl303(){
