...
public class BasepPack2Impl30 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl30.class);
    private static BasepPack2Impl30 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl30 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl30();
        }
        return INSTANCE;
    }

    private BasepPack2Impl30(){
