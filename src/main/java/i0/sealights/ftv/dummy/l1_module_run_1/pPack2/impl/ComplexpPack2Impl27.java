...
public class ComplexpPack2Impl27 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl27.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl27 INSTANCE;

    public static ComplexpPack2Impl27 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl27();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl27(){
