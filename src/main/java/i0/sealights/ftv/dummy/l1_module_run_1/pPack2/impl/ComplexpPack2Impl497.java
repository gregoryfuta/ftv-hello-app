...
public class ComplexpPack2Impl497 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl497.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl497 INSTANCE;

    public static ComplexpPack2Impl497 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl497();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl497(){
