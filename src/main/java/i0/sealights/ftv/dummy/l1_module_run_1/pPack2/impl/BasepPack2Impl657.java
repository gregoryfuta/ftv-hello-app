...
public class BasepPack2Impl657 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl657.class);
    private static BasepPack2Impl657 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl657 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl657();
        }
        return INSTANCE;
    }

    private BasepPack2Impl657(){
