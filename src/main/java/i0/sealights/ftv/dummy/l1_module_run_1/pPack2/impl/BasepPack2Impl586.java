...
public class BasepPack2Impl586 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl586.class);
    private static BasepPack2Impl586 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl586 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl586();
        }
        return INSTANCE;
    }

    private BasepPack2Impl586(){
