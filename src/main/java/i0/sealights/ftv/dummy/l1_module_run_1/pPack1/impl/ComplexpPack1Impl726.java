...
public class ComplexpPack1Impl726 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl726.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl726 INSTANCE;

    public static ComplexpPack1Impl726 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl726();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl726(){
