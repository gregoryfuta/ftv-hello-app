...
public class BasepPack1Impl299 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl299.class);
    private static BasepPack1Impl299 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl299 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl299();
        }
        return INSTANCE;
    }

    private BasepPack1Impl299(){
