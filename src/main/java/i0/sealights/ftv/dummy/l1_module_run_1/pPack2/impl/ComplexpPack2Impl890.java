...
public class ComplexpPack2Impl890 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl890.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl890 INSTANCE;

    public static ComplexpPack2Impl890 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl890();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl890(){
