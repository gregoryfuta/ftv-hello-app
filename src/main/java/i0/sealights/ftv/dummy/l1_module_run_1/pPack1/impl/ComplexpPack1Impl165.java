...
public class ComplexpPack1Impl165 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl165.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl165 INSTANCE;

    public static ComplexpPack1Impl165 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl165();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl165(){
