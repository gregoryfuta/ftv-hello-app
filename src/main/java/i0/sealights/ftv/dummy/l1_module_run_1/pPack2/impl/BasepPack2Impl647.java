...
public class BasepPack2Impl647 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl647.class);
    private static BasepPack2Impl647 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl647 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl647();
        }
        return INSTANCE;
    }

    private BasepPack2Impl647(){
