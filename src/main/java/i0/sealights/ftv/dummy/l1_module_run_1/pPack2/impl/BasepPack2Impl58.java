...
public class BasepPack2Impl58 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl58.class);
    private static BasepPack2Impl58 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl58 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl58();
        }
        return INSTANCE;
    }

    private BasepPack2Impl58(){
