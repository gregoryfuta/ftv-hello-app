...
public class ComplexpPack1Impl268 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl268.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl268 INSTANCE;

    public static ComplexpPack1Impl268 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl268();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl268(){
