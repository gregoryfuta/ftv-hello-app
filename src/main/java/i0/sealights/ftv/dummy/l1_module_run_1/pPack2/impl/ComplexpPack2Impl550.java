...
public class ComplexpPack2Impl550 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl550.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl550 INSTANCE;

    public static ComplexpPack2Impl550 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl550();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl550(){
