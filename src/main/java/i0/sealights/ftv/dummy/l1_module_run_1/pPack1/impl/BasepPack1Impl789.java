...
public class BasepPack1Impl789 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl789.class);
    private static BasepPack1Impl789 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl789 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl789();
        }
        return INSTANCE;
    }

    private BasepPack1Impl789(){
