...
public class BasepPack1Impl133 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl133.class);
    private static BasepPack1Impl133 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl133 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl133();
        }
        return INSTANCE;
    }

    private BasepPack1Impl133(){
