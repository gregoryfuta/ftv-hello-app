...
public class BasepPack1Impl692 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl692.class);
    private static BasepPack1Impl692 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl692 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl692();
        }
        return INSTANCE;
    }

    private BasepPack1Impl692(){
