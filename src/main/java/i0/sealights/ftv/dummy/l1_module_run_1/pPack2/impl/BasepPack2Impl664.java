...
public class BasepPack2Impl664 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl664.class);
    private static BasepPack2Impl664 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl664 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl664();
        }
        return INSTANCE;
    }

    private BasepPack2Impl664(){
