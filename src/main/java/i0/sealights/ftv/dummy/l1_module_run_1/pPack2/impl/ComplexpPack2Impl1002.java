...
public class ComplexpPack2Impl1002 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1002.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1002 INSTANCE;

    public static ComplexpPack2Impl1002 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1002();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1002(){
