...
public class ComplexpPack2Impl566 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl566.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl566 INSTANCE;

    public static ComplexpPack2Impl566 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl566();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl566(){
