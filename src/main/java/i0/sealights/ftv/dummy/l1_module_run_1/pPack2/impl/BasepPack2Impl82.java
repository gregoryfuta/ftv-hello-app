...
public class BasepPack2Impl82 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl82.class);
    private static BasepPack2Impl82 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl82 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl82();
        }
        return INSTANCE;
    }

    private BasepPack2Impl82(){
