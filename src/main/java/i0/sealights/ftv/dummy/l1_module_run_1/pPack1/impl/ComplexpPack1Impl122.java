...
public class ComplexpPack1Impl122 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl122.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl122 INSTANCE;

    public static ComplexpPack1Impl122 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl122();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl122(){
