...
public class BasepPack1Impl140 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl140.class);
    private static BasepPack1Impl140 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl140 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl140();
        }
        return INSTANCE;
    }

    private BasepPack1Impl140(){
