...
public class BasepPack2Impl979 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl979.class);
    private static BasepPack2Impl979 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl979 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl979();
        }
        return INSTANCE;
    }

    private BasepPack2Impl979(){
