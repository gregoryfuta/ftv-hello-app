...
public class ComplexpPack1Impl535 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl535.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl535 INSTANCE;

    public static ComplexpPack1Impl535 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl535();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl535(){
