...
public class BasepPack1Impl353 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl353.class);
    private static BasepPack1Impl353 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl353 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl353();
        }
        return INSTANCE;
    }

    private BasepPack1Impl353(){
