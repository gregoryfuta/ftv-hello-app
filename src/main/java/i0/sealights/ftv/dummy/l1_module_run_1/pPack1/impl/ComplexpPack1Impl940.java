...
public class ComplexpPack1Impl940 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl940.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl940 INSTANCE;

    public static ComplexpPack1Impl940 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl940();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl940(){
