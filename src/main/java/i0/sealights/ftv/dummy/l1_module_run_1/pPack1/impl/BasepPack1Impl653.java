...
public class BasepPack1Impl653 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl653.class);
    private static BasepPack1Impl653 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl653 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl653();
        }
        return INSTANCE;
    }

    private BasepPack1Impl653(){
