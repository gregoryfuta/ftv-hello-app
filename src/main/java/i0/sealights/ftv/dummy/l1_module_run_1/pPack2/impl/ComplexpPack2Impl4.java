...
public class ComplexpPack2Impl4 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl4.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl4 INSTANCE;

    public static ComplexpPack2Impl4 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl4();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl4(){
