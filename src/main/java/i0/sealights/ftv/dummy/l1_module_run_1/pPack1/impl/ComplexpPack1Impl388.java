...
public class ComplexpPack1Impl388 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl388.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl388 INSTANCE;

    public static ComplexpPack1Impl388 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl388();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl388(){
