...
public class BasepPack1Impl15 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl15.class);
    private static BasepPack1Impl15 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl15 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl15();
        }
        return INSTANCE;
    }

    private BasepPack1Impl15(){
