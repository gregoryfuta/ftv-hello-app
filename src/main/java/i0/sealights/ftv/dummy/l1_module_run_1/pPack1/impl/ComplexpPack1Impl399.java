...
public class ComplexpPack1Impl399 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl399.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl399 INSTANCE;

    public static ComplexpPack1Impl399 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl399();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl399(){
