...
public class ComplexpPack2Impl557 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl557.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl557 INSTANCE;

    public static ComplexpPack2Impl557 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl557();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl557(){
