...
public class ComplexpPack2Impl509 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl509.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl509 INSTANCE;

    public static ComplexpPack2Impl509 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl509();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl509(){
