...
public class ComplexpPack2Impl97 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl97.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl97 INSTANCE;

    public static ComplexpPack2Impl97 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl97();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl97(){
