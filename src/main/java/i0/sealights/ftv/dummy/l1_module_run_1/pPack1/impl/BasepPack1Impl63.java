...
public class BasepPack1Impl63 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl63.class);
    private static BasepPack1Impl63 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl63 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl63();
        }
        return INSTANCE;
    }

    private BasepPack1Impl63(){
