...
public class BasepPack2Impl132 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl132.class);
    private static BasepPack2Impl132 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl132 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl132();
        }
        return INSTANCE;
    }

    private BasepPack2Impl132(){
