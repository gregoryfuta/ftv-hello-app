...
public class ComplexpPack1Impl844 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl844.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl844 INSTANCE;

    public static ComplexpPack1Impl844 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl844();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl844(){
