...
public class ComplexpPack2Impl26 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl26.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl26 INSTANCE;

    public static ComplexpPack2Impl26 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl26();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl26(){
