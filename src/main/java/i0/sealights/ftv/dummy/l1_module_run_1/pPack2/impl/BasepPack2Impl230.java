...
public class BasepPack2Impl230 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl230.class);
    private static BasepPack2Impl230 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl230 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl230();
        }
        return INSTANCE;
    }

    private BasepPack2Impl230(){
