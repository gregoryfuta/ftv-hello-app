...
public class ComplexpPack1Impl855 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl855.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl855 INSTANCE;

    public static ComplexpPack1Impl855 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl855();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl855(){
