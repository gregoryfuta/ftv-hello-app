...
public class ComplexpPack2Impl636 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl636.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl636 INSTANCE;

    public static ComplexpPack2Impl636 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl636();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl636(){
