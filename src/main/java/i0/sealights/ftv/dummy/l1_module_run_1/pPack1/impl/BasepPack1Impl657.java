...
public class BasepPack1Impl657 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl657.class);
    private static BasepPack1Impl657 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl657 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl657();
        }
        return INSTANCE;
    }

    private BasepPack1Impl657(){
