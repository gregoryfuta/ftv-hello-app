...
public class ComplexpPack2Impl685 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl685.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl685 INSTANCE;

    public static ComplexpPack2Impl685 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl685();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl685(){
