...
public class ComplexpPack2Impl645 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl645.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl645 INSTANCE;

    public static ComplexpPack2Impl645 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl645();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl645(){
