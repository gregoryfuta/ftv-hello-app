...
public class ComplexpPack2Impl148 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl148.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl148 INSTANCE;

    public static ComplexpPack2Impl148 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl148();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl148(){
