...
public class BasepPack2Impl801 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl801.class);
    private static BasepPack2Impl801 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl801 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl801();
        }
        return INSTANCE;
    }

    private BasepPack2Impl801(){
