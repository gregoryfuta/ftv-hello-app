...
public class BasepPack1Impl433 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl433.class);
    private static BasepPack1Impl433 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl433 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl433();
        }
        return INSTANCE;
    }

    private BasepPack1Impl433(){
