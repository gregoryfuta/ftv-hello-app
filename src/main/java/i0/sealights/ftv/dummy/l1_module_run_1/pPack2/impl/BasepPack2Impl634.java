...
public class BasepPack2Impl634 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl634.class);
    private static BasepPack2Impl634 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl634 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl634();
        }
        return INSTANCE;
    }

    private BasepPack2Impl634(){
