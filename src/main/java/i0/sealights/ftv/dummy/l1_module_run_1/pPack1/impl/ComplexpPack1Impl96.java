...
public class ComplexpPack1Impl96 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl96.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl96 INSTANCE;

    public static ComplexpPack1Impl96 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl96();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl96(){
