...
public class BasepPack2Impl527 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl527.class);
    private static BasepPack2Impl527 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl527 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl527();
        }
        return INSTANCE;
    }

    private BasepPack2Impl527(){
