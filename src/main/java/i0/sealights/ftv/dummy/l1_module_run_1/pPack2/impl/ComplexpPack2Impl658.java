...
public class ComplexpPack2Impl658 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl658.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl658 INSTANCE;

    public static ComplexpPack2Impl658 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl658();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl658(){
