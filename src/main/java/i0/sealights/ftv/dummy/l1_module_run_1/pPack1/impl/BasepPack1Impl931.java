...
public class BasepPack1Impl931 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl931.class);
    private static BasepPack1Impl931 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl931 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl931();
        }
        return INSTANCE;
    }

    private BasepPack1Impl931(){
