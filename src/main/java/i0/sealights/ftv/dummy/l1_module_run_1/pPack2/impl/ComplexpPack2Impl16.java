...
public class ComplexpPack2Impl16 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl16.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl16 INSTANCE;

    public static ComplexpPack2Impl16 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl16();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl16(){
