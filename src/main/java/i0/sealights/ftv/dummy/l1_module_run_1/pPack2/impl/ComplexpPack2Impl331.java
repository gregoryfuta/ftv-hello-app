...
public class ComplexpPack2Impl331 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl331.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl331 INSTANCE;

    public static ComplexpPack2Impl331 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl331();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl331(){
