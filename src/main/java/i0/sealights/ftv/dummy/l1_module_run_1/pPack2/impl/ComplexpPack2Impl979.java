...
public class ComplexpPack2Impl979 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl979.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl979 INSTANCE;

    public static ComplexpPack2Impl979 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl979();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl979(){
