...
public class ComplexpPack1Impl123 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl123.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl123 INSTANCE;

    public static ComplexpPack1Impl123 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl123();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl123(){
