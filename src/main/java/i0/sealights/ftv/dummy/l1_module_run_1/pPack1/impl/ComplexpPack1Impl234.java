...
public class ComplexpPack1Impl234 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl234.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl234 INSTANCE;

    public static ComplexpPack1Impl234 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl234();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl234(){
