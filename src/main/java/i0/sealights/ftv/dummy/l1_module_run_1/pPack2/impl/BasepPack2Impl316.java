...
public class BasepPack2Impl316 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl316.class);
    private static BasepPack2Impl316 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl316 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl316();
        }
        return INSTANCE;
    }

    private BasepPack2Impl316(){
