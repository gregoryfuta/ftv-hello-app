...
public class BasepPack1Impl585 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl585.class);
    private static BasepPack1Impl585 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl585 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl585();
        }
        return INSTANCE;
    }

    private BasepPack1Impl585(){
