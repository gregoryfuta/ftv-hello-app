...
public class ComplexpPack1Impl136 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl136.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl136 INSTANCE;

    public static ComplexpPack1Impl136 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl136();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl136(){
