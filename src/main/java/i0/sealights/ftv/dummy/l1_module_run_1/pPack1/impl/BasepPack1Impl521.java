...
public class BasepPack1Impl521 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl521.class);
    private static BasepPack1Impl521 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl521 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl521();
        }
        return INSTANCE;
    }

    private BasepPack1Impl521(){
