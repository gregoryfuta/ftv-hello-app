...
public class BasepPack2Impl206 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl206.class);
    private static BasepPack2Impl206 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl206 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl206();
        }
        return INSTANCE;
    }

    private BasepPack2Impl206(){
