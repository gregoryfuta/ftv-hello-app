...
public class ComplexpPack1Impl256 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl256.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl256 INSTANCE;

    public static ComplexpPack1Impl256 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl256();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl256(){
