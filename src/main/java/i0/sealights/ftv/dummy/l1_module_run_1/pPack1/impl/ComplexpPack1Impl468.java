...
public class ComplexpPack1Impl468 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl468.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl468 INSTANCE;

    public static ComplexpPack1Impl468 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl468();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl468(){
