...
public class ComplexpPack2Impl625 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl625.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl625 INSTANCE;

    public static ComplexpPack2Impl625 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl625();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl625(){
