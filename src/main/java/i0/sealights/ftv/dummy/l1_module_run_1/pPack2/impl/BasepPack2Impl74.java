...
public class BasepPack2Impl74 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl74.class);
    private static BasepPack2Impl74 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl74 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl74();
        }
        return INSTANCE;
    }

    private BasepPack2Impl74(){
