...
public class ComplexpPack2Impl824 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl824.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl824 INSTANCE;

    public static ComplexpPack2Impl824 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl824();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl824(){
