...
public class ComplexpPack2Impl935 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl935.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl935 INSTANCE;

    public static ComplexpPack2Impl935 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl935();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl935(){
