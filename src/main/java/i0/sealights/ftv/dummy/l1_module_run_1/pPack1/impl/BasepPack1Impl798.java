...
public class BasepPack1Impl798 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl798.class);
    private static BasepPack1Impl798 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl798 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl798();
        }
        return INSTANCE;
    }

    private BasepPack1Impl798(){
