...
public class BasepPack2Impl756 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl756.class);
    private static BasepPack2Impl756 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl756 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl756();
        }
        return INSTANCE;
    }

    private BasepPack2Impl756(){
