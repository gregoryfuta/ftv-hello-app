...
public class ComplexpPack2Impl665 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl665.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl665 INSTANCE;

    public static ComplexpPack2Impl665 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl665();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl665(){
