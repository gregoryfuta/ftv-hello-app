...
public class ComplexpPack1Impl186 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl186.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl186 INSTANCE;

    public static ComplexpPack1Impl186 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl186();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl186(){
