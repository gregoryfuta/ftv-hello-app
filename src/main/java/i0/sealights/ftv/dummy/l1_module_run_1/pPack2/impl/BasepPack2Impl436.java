...
public class BasepPack2Impl436 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl436.class);
    private static BasepPack2Impl436 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl436 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl436();
        }
        return INSTANCE;
    }

    private BasepPack2Impl436(){
