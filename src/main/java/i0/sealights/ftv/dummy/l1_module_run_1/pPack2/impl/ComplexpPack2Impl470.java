...
public class ComplexpPack2Impl470 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl470.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl470 INSTANCE;

    public static ComplexpPack2Impl470 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl470();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl470(){
