...
public class BasepPack2Impl891 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl891.class);
    private static BasepPack2Impl891 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl891 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl891();
        }
        return INSTANCE;
    }

    private BasepPack2Impl891(){
