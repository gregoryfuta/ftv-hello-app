...
public class ComplexpPack2Impl859 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl859.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl859 INSTANCE;

    public static ComplexpPack2Impl859 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl859();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl859(){
