...
public class BasepPack2Impl947 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl947.class);
    private static BasepPack2Impl947 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl947 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl947();
        }
        return INSTANCE;
    }

    private BasepPack2Impl947(){
