...
public class BasepPack2Impl510 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl510.class);
    private static BasepPack2Impl510 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl510 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl510();
        }
        return INSTANCE;
    }

    private BasepPack2Impl510(){
