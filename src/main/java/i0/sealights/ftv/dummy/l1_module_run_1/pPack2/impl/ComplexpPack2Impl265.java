...
public class ComplexpPack2Impl265 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl265.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl265 INSTANCE;

    public static ComplexpPack2Impl265 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl265();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl265(){
