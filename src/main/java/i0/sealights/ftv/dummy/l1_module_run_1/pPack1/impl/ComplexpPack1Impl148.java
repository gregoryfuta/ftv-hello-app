...
public class ComplexpPack1Impl148 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl148.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl148 INSTANCE;

    public static ComplexpPack1Impl148 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl148();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl148(){
