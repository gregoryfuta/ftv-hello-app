...
public class BasepPack2Impl524 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl524.class);
    private static BasepPack2Impl524 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl524 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl524();
        }
        return INSTANCE;
    }

    private BasepPack2Impl524(){
