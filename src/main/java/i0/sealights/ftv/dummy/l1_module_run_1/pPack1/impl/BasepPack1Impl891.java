...
public class BasepPack1Impl891 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl891.class);
    private static BasepPack1Impl891 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl891 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl891();
        }
        return INSTANCE;
    }

    private BasepPack1Impl891(){
