...
public class BasepPack1Impl915 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl915.class);
    private static BasepPack1Impl915 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl915 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl915();
        }
        return INSTANCE;
    }

    private BasepPack1Impl915(){
