...
public class ComplexpPack2Impl96 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl96.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl96 INSTANCE;

    public static ComplexpPack2Impl96 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl96();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl96(){
