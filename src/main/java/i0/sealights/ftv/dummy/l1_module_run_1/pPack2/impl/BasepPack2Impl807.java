...
public class BasepPack2Impl807 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl807.class);
    private static BasepPack2Impl807 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl807 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl807();
        }
        return INSTANCE;
    }

    private BasepPack2Impl807(){
