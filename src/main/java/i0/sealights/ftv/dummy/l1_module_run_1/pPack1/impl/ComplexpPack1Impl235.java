...
public class ComplexpPack1Impl235 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl235.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl235 INSTANCE;

    public static ComplexpPack1Impl235 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl235();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl235(){
