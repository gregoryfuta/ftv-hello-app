...
public class BasepPack1Impl177 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl177.class);
    private static BasepPack1Impl177 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl177 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl177();
        }
        return INSTANCE;
    }

    private BasepPack1Impl177(){
