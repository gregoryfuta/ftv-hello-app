...
public class BasepPack1Impl864 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl864.class);
    private static BasepPack1Impl864 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl864 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl864();
        }
        return INSTANCE;
    }

    private BasepPack1Impl864(){
