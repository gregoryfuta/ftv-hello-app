...
public class BasepPack1Impl771 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl771.class);
    private static BasepPack1Impl771 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl771 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl771();
        }
        return INSTANCE;
    }

    private BasepPack1Impl771(){
