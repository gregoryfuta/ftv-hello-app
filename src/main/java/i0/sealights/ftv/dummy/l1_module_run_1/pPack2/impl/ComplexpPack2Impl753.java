...
public class ComplexpPack2Impl753 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl753.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl753 INSTANCE;

    public static ComplexpPack2Impl753 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl753();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl753(){
