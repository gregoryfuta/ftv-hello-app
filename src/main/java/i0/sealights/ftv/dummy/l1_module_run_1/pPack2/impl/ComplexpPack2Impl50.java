...
public class ComplexpPack2Impl50 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl50.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl50 INSTANCE;

    public static ComplexpPack2Impl50 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl50();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl50(){
