...
public class BasepPack1Impl848 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl848.class);
    private static BasepPack1Impl848 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl848 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl848();
        }
        return INSTANCE;
    }

    private BasepPack1Impl848(){
