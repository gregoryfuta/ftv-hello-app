...
public class BasepPack1Impl348 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl348.class);
    private static BasepPack1Impl348 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl348 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl348();
        }
        return INSTANCE;
    }

    private BasepPack1Impl348(){
