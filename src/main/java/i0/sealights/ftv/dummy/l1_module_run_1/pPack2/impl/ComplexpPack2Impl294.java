...
public class ComplexpPack2Impl294 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl294.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl294 INSTANCE;

    public static ComplexpPack2Impl294 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl294();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl294(){
