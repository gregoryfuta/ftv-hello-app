...
public class ComplexpPack2Impl895 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl895.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl895 INSTANCE;

    public static ComplexpPack2Impl895 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl895();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl895(){
