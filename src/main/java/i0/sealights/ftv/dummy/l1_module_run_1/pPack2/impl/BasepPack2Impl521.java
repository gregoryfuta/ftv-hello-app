...
public class BasepPack2Impl521 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl521.class);
    private static BasepPack2Impl521 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl521 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl521();
        }
        return INSTANCE;
    }

    private BasepPack2Impl521(){
