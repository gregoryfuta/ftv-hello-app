...
public class ComplexpPack1Impl881 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl881.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl881 INSTANCE;

    public static ComplexpPack1Impl881 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl881();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl881(){
