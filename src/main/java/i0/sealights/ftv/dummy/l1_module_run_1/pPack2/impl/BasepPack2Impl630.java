...
public class BasepPack2Impl630 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl630.class);
    private static BasepPack2Impl630 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl630 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl630();
        }
        return INSTANCE;
    }

    private BasepPack2Impl630(){
