...
public class ComplexpPack1Impl244 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl244.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl244 INSTANCE;

    public static ComplexpPack1Impl244 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl244();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl244(){
