...
public class BasepPack1Impl685 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl685.class);
    private static BasepPack1Impl685 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl685 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl685();
        }
        return INSTANCE;
    }

    private BasepPack1Impl685(){
