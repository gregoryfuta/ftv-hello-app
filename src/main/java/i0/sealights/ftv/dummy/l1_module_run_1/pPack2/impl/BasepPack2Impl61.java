...
public class BasepPack2Impl61 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl61.class);
    private static BasepPack2Impl61 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl61 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl61();
        }
        return INSTANCE;
    }

    private BasepPack2Impl61(){
