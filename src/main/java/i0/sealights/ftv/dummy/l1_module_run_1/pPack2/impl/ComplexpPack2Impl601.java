...
public class ComplexpPack2Impl601 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl601.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl601 INSTANCE;

    public static ComplexpPack2Impl601 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl601();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl601(){
