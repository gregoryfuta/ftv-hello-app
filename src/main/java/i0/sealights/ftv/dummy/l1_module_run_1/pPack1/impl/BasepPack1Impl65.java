...
public class BasepPack1Impl65 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl65.class);
    private static BasepPack1Impl65 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl65 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl65();
        }
        return INSTANCE;
    }

    private BasepPack1Impl65(){
