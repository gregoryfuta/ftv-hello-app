...
public class BasepPack1Impl918 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl918.class);
    private static BasepPack1Impl918 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl918 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl918();
        }
        return INSTANCE;
    }

    private BasepPack1Impl918(){
