...
public class BasepPack1Impl441 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl441.class);
    private static BasepPack1Impl441 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl441 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl441();
        }
        return INSTANCE;
    }

    private BasepPack1Impl441(){
