...
public class BasepPack2Impl399 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl399.class);
    private static BasepPack2Impl399 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl399 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl399();
        }
        return INSTANCE;
    }

    private BasepPack2Impl399(){
