...
public class ComplexpPack2Impl885 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl885.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl885 INSTANCE;

    public static ComplexpPack2Impl885 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl885();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl885(){
