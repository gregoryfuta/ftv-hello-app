...
public class ComplexpPack1Impl678 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl678.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl678 INSTANCE;

    public static ComplexpPack1Impl678 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl678();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl678(){
