...
public class ComplexpPack2Impl259 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl259.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl259 INSTANCE;

    public static ComplexpPack2Impl259 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl259();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl259(){
