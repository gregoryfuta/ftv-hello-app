...
public class ComplexpPack1Impl1054 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1054.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1054 INSTANCE;

    public static ComplexpPack1Impl1054 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1054();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1054(){
