...
public class ComplexpPack2Impl471 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl471.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl471 INSTANCE;

    public static ComplexpPack2Impl471 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl471();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl471(){
