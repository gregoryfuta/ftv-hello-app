...
public class ComplexpPack1Impl437 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl437.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl437 INSTANCE;

    public static ComplexpPack1Impl437 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl437();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl437(){
