...
public class ComplexpPack2Impl556 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl556.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl556 INSTANCE;

    public static ComplexpPack2Impl556 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl556();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl556(){
