...
public class ComplexpPack1Impl180 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl180.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl180 INSTANCE;

    public static ComplexpPack1Impl180 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl180();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl180(){
