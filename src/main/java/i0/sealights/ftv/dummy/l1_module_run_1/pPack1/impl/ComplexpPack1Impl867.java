...
public class ComplexpPack1Impl867 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl867.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl867 INSTANCE;

    public static ComplexpPack1Impl867 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl867();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl867(){
