...
public class ComplexpPack1Impl582 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl582.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl582 INSTANCE;

    public static ComplexpPack1Impl582 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl582();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl582(){
