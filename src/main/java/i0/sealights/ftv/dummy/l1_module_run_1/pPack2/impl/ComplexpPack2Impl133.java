...
public class ComplexpPack2Impl133 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl133.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl133 INSTANCE;

    public static ComplexpPack2Impl133 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl133();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl133(){
