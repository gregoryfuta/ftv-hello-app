...
public class ComplexpPack1Impl799 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl799.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl799 INSTANCE;

    public static ComplexpPack1Impl799 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl799();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl799(){
