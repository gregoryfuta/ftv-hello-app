...
public class BasepPack1Impl606 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl606.class);
    private static BasepPack1Impl606 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl606 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl606();
        }
        return INSTANCE;
    }

    private BasepPack1Impl606(){
