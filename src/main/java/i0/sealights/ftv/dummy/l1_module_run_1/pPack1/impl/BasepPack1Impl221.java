...
public class BasepPack1Impl221 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl221.class);
    private static BasepPack1Impl221 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl221 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl221();
        }
        return INSTANCE;
    }

    private BasepPack1Impl221(){
