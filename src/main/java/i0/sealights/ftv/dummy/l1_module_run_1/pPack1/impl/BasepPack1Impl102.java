...
public class BasepPack1Impl102 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl102.class);
    private static BasepPack1Impl102 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl102 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl102();
        }
        return INSTANCE;
    }

    private BasepPack1Impl102(){
