...
public class BasepPack2Impl693 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl693.class);
    private static BasepPack2Impl693 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl693 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl693();
        }
        return INSTANCE;
    }

    private BasepPack2Impl693(){
