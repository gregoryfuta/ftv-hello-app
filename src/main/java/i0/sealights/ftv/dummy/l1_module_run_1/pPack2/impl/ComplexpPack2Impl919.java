...
public class ComplexpPack2Impl919 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl919.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl919 INSTANCE;

    public static ComplexpPack2Impl919 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl919();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl919(){
