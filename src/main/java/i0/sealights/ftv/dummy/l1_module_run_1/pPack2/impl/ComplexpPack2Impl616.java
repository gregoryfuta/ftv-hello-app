...
public class ComplexpPack2Impl616 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl616.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl616 INSTANCE;

    public static ComplexpPack2Impl616 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl616();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl616(){
