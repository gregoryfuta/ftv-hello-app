...
public class ComplexpPack2Impl570 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl570.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl570 INSTANCE;

    public static ComplexpPack2Impl570 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl570();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl570(){
