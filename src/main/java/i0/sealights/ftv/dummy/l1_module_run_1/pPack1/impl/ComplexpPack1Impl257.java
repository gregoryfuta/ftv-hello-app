...
public class ComplexpPack1Impl257 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl257.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl257 INSTANCE;

    public static ComplexpPack1Impl257 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl257();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl257(){
