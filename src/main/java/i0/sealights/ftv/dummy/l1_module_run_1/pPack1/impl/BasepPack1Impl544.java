...
public class BasepPack1Impl544 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl544.class);
    private static BasepPack1Impl544 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl544 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl544();
        }
        return INSTANCE;
    }

    private BasepPack1Impl544(){
