...
public class BasepPack1Impl769 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl769.class);
    private static BasepPack1Impl769 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl769 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl769();
        }
        return INSTANCE;
    }

    private BasepPack1Impl769(){
