...
public class ComplexpPack2Impl392 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl392.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl392 INSTANCE;

    public static ComplexpPack2Impl392 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl392();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl392(){
