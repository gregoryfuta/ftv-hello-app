...
public class ComplexpPack2Impl108 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl108.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl108 INSTANCE;

    public static ComplexpPack2Impl108 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl108();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl108(){
