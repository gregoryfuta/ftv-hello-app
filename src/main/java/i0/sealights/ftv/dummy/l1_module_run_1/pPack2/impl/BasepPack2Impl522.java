...
public class BasepPack2Impl522 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl522.class);
    private static BasepPack2Impl522 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl522 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl522();
        }
        return INSTANCE;
    }

    private BasepPack2Impl522(){
