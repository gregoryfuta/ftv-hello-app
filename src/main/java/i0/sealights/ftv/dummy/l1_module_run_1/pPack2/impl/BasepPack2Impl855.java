...
public class BasepPack2Impl855 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl855.class);
    private static BasepPack2Impl855 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl855 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl855();
        }
        return INSTANCE;
    }

    private BasepPack2Impl855(){
