...
public class ComplexpPack2Impl673 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl673.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl673 INSTANCE;

    public static ComplexpPack2Impl673 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl673();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl673(){
