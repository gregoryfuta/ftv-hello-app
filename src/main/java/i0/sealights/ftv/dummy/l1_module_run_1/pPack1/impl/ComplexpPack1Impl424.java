...
public class ComplexpPack1Impl424 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl424.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl424 INSTANCE;

    public static ComplexpPack1Impl424 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl424();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl424(){
