...
public class ComplexpPack2Impl466 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl466.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl466 INSTANCE;

    public static ComplexpPack2Impl466 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl466();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl466(){
