...
public class BasepPack1Impl881 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl881.class);
    private static BasepPack1Impl881 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl881 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl881();
        }
        return INSTANCE;
    }

    private BasepPack1Impl881(){
