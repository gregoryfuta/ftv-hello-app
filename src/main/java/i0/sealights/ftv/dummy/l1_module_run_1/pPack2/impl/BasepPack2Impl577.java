...
public class BasepPack2Impl577 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl577.class);
    private static BasepPack2Impl577 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl577 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl577();
        }
        return INSTANCE;
    }

    private BasepPack2Impl577(){
