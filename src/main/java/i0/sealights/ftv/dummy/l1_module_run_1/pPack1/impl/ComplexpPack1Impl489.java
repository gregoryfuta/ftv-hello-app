...
public class ComplexpPack1Impl489 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl489.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl489 INSTANCE;

    public static ComplexpPack1Impl489 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl489();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl489(){
