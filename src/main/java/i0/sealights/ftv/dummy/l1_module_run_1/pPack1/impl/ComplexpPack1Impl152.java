...
public class ComplexpPack1Impl152 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl152.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl152 INSTANCE;

    public static ComplexpPack1Impl152 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl152();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl152(){
