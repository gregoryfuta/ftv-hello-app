...
public class ComplexpPack2Impl365 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl365.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl365 INSTANCE;

    public static ComplexpPack2Impl365 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl365();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl365(){
