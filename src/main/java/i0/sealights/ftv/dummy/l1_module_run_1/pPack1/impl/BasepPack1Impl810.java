...
public class BasepPack1Impl810 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl810.class);
    private static BasepPack1Impl810 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl810 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl810();
        }
        return INSTANCE;
    }

    private BasepPack1Impl810(){
