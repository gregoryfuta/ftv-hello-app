...
public class BasepPack1Impl639 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl639.class);
    private static BasepPack1Impl639 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl639 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl639();
        }
        return INSTANCE;
    }

    private BasepPack1Impl639(){
