...
public class ComplexpPack1Impl156 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl156.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl156 INSTANCE;

    public static ComplexpPack1Impl156 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl156();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl156(){
