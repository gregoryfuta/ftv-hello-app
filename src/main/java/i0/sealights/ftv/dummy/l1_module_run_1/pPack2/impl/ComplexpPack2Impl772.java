...
public class ComplexpPack2Impl772 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl772.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl772 INSTANCE;

    public static ComplexpPack2Impl772 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl772();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl772(){
