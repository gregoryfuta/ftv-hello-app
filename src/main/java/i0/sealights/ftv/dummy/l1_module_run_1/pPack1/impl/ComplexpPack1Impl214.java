...
public class ComplexpPack1Impl214 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl214.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl214 INSTANCE;

    public static ComplexpPack1Impl214 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl214();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl214(){
