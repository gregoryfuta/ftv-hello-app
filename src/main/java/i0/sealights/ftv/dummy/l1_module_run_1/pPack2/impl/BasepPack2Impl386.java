...
public class BasepPack2Impl386 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl386.class);
    private static BasepPack2Impl386 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl386 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl386();
        }
        return INSTANCE;
    }

    private BasepPack2Impl386(){
