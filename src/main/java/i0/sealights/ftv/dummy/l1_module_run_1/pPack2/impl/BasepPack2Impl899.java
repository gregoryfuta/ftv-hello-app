...
public class BasepPack2Impl899 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl899.class);
    private static BasepPack2Impl899 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl899 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl899();
        }
        return INSTANCE;
    }

    private BasepPack2Impl899(){
