...
public class BasepPack1Impl794 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl794.class);
    private static BasepPack1Impl794 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl794 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl794();
        }
        return INSTANCE;
    }

    private BasepPack1Impl794(){
