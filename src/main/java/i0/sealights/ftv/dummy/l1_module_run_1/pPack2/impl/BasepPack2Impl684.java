...
public class BasepPack2Impl684 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl684.class);
    private static BasepPack2Impl684 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl684 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl684();
        }
        return INSTANCE;
    }

    private BasepPack2Impl684(){
