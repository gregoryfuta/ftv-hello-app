...
public class ComplexpPack2Impl724 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl724.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl724 INSTANCE;

    public static ComplexpPack2Impl724 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl724();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl724(){
