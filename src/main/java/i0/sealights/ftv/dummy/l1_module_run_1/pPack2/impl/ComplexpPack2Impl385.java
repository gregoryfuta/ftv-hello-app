...
public class ComplexpPack2Impl385 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl385.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl385 INSTANCE;

    public static ComplexpPack2Impl385 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl385();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl385(){
