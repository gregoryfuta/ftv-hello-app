...
public class ComplexpPack1Impl639 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl639.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl639 INSTANCE;

    public static ComplexpPack1Impl639 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl639();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl639(){
