...
public class ComplexpPack1Impl307 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl307.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl307 INSTANCE;

    public static ComplexpPack1Impl307 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl307();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl307(){
