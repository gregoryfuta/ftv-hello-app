...
public class ComplexpPack1Impl267 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl267.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl267 INSTANCE;

    public static ComplexpPack1Impl267 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl267();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl267(){
