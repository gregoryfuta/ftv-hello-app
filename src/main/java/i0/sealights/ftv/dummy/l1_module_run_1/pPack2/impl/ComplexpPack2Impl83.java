...
public class ComplexpPack2Impl83 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl83.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl83 INSTANCE;

    public static ComplexpPack2Impl83 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl83();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl83(){
