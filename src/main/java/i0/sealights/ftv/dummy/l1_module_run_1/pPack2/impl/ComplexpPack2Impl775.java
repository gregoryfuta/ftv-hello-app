...
public class ComplexpPack2Impl775 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl775.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl775 INSTANCE;

    public static ComplexpPack2Impl775 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl775();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl775(){
