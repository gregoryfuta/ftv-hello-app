...
public class ComplexpPack2Impl450 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl450.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl450 INSTANCE;

    public static ComplexpPack2Impl450 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl450();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl450(){
