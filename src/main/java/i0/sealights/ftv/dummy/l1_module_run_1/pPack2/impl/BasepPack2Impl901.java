...
public class BasepPack2Impl901 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl901.class);
    private static BasepPack2Impl901 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl901 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl901();
        }
        return INSTANCE;
    }

    private BasepPack2Impl901(){
