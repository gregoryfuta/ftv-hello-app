...
public class BasepPack2Impl437 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl437.class);
    private static BasepPack2Impl437 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl437 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl437();
        }
        return INSTANCE;
    }

    private BasepPack2Impl437(){
