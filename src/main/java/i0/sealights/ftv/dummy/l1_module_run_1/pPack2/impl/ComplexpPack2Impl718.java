...
public class ComplexpPack2Impl718 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl718.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl718 INSTANCE;

    public static ComplexpPack2Impl718 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl718();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl718(){
