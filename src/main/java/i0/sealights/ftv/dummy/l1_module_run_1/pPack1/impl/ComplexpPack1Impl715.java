...
public class ComplexpPack1Impl715 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl715.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl715 INSTANCE;

    public static ComplexpPack1Impl715 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl715();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl715(){
