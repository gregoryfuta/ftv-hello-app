...
public class ComplexpPack2Impl41 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl41.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl41 INSTANCE;

    public static ComplexpPack2Impl41 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl41();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl41(){
