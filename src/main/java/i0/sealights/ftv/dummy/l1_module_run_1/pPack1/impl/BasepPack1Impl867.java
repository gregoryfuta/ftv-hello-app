...
public class BasepPack1Impl867 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl867.class);
    private static BasepPack1Impl867 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl867 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl867();
        }
        return INSTANCE;
    }

    private BasepPack1Impl867(){
