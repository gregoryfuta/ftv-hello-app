...
public class BasepPack2Impl850 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl850.class);
    private static BasepPack2Impl850 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl850 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl850();
        }
        return INSTANCE;
    }

    private BasepPack2Impl850(){
