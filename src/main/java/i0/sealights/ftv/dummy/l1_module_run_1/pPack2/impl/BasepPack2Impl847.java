...
public class BasepPack2Impl847 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl847.class);
    private static BasepPack2Impl847 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl847 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl847();
        }
        return INSTANCE;
    }

    private BasepPack2Impl847(){
