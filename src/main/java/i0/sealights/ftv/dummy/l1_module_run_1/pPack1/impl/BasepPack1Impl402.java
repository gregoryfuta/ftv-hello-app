...
public class BasepPack1Impl402 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl402.class);
    private static BasepPack1Impl402 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl402 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl402();
        }
        return INSTANCE;
    }

    private BasepPack1Impl402(){
