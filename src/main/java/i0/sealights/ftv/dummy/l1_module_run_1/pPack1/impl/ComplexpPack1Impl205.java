...
public class ComplexpPack1Impl205 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl205.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl205 INSTANCE;

    public static ComplexpPack1Impl205 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl205();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl205(){
