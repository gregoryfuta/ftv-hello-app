...
public class BasepPack2Impl80 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl80.class);
    private static BasepPack2Impl80 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl80 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl80();
        }
        return INSTANCE;
    }

    private BasepPack2Impl80(){
