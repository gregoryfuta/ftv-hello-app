...
public class BasepPack2Impl831 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl831.class);
    private static BasepPack2Impl831 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl831 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl831();
        }
        return INSTANCE;
    }

    private BasepPack2Impl831(){
