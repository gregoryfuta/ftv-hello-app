...
public class ComplexpPack2Impl317 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl317.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl317 INSTANCE;

    public static ComplexpPack2Impl317 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl317();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl317(){
