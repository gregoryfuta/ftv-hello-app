...
public class ComplexpPack2Impl660 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl660.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl660 INSTANCE;

    public static ComplexpPack2Impl660 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl660();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl660(){
