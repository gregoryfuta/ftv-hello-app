...
public class BasepPack1Impl823 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl823.class);
    private static BasepPack1Impl823 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl823 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl823();
        }
        return INSTANCE;
    }

    private BasepPack1Impl823(){
