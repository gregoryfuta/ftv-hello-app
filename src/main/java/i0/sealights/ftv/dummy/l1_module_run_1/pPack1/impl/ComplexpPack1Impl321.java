...
public class ComplexpPack1Impl321 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl321.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl321 INSTANCE;

    public static ComplexpPack1Impl321 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl321();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl321(){
