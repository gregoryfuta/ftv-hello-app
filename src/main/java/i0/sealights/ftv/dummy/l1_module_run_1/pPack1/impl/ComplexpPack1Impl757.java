...
public class ComplexpPack1Impl757 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl757.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl757 INSTANCE;

    public static ComplexpPack1Impl757 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl757();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl757(){
