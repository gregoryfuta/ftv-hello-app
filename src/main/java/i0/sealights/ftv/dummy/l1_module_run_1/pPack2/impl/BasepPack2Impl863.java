...
public class BasepPack2Impl863 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl863.class);
    private static BasepPack2Impl863 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl863 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl863();
        }
        return INSTANCE;
    }

    private BasepPack2Impl863(){
