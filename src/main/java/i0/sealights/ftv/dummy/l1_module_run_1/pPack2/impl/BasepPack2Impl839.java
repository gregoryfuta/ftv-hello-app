...
public class BasepPack2Impl839 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl839.class);
    private static BasepPack2Impl839 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl839 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl839();
        }
        return INSTANCE;
    }

    private BasepPack2Impl839(){
