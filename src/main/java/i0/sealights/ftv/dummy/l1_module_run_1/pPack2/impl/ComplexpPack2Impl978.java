...
public class ComplexpPack2Impl978 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl978.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl978 INSTANCE;

    public static ComplexpPack2Impl978 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl978();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl978(){
