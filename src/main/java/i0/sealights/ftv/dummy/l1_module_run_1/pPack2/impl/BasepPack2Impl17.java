...
public class BasepPack2Impl17 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl17.class);
    private static BasepPack2Impl17 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl17 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl17();
        }
        return INSTANCE;
    }

    private BasepPack2Impl17(){
