...
public class BasepPack1Impl960 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl960.class);
    private static BasepPack1Impl960 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl960 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl960();
        }
        return INSTANCE;
    }

    private BasepPack1Impl960(){
