...
public class BasepPack1Impl752 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl752.class);
    private static BasepPack1Impl752 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl752 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl752();
        }
        return INSTANCE;
    }

    private BasepPack1Impl752(){
