...
public class BasepPack2Impl38 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl38.class);
    private static BasepPack2Impl38 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl38 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl38();
        }
        return INSTANCE;
    }

    private BasepPack2Impl38(){
