...
public class ComplexpPack2Impl1050 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl1050.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl1050 INSTANCE;

    public static ComplexpPack2Impl1050 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl1050();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl1050(){
