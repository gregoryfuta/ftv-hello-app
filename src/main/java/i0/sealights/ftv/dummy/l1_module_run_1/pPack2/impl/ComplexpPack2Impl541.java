...
public class ComplexpPack2Impl541 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl541.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl541 INSTANCE;

    public static ComplexpPack2Impl541 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl541();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl541(){
