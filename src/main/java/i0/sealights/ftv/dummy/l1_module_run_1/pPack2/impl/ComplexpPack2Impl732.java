...
public class ComplexpPack2Impl732 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl732.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl732 INSTANCE;

    public static ComplexpPack2Impl732 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl732();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl732(){
