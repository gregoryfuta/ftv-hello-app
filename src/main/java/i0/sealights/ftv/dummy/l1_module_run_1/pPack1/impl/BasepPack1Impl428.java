...
public class BasepPack1Impl428 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl428.class);
    private static BasepPack1Impl428 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl428 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl428();
        }
        return INSTANCE;
    }

    private BasepPack1Impl428(){
