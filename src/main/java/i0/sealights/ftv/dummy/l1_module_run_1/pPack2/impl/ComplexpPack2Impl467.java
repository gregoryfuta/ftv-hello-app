...
public class ComplexpPack2Impl467 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl467.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl467 INSTANCE;

    public static ComplexpPack2Impl467 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl467();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl467(){
