...
public class BasepPack2Impl776 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl776.class);
    private static BasepPack2Impl776 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl776 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl776();
        }
        return INSTANCE;
    }

    private BasepPack2Impl776(){
