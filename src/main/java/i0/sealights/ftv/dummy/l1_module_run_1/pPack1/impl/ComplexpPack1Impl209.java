...
public class ComplexpPack1Impl209 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl209.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl209 INSTANCE;

    public static ComplexpPack1Impl209 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl209();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl209(){
