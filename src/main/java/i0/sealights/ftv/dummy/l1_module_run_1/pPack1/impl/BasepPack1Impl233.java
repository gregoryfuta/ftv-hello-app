...
public class BasepPack1Impl233 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl233.class);
    private static BasepPack1Impl233 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl233 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl233();
        }
        return INSTANCE;
    }

    private BasepPack1Impl233(){
