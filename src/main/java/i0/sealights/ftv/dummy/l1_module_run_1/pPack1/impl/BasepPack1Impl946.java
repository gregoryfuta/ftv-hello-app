...
public class BasepPack1Impl946 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl946.class);
    private static BasepPack1Impl946 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl946 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl946();
        }
        return INSTANCE;
    }

    private BasepPack1Impl946(){
