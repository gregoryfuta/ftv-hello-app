...
public class BasepPack1Impl776 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl776.class);
    private static BasepPack1Impl776 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl776 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl776();
        }
        return INSTANCE;
    }

    private BasepPack1Impl776(){
