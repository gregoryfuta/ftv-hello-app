...
public class BasepPack1Impl828 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl828.class);
    private static BasepPack1Impl828 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl828 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl828();
        }
        return INSTANCE;
    }

    private BasepPack1Impl828(){
