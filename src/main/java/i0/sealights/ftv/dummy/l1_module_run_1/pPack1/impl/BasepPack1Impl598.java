...
public class BasepPack1Impl598 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl598.class);
    private static BasepPack1Impl598 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl598 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl598();
        }
        return INSTANCE;
    }

    private BasepPack1Impl598(){
