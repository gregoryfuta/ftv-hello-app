...
public class ComplexpPack1Impl61 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl61.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl61 INSTANCE;

    public static ComplexpPack1Impl61 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl61();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl61(){
