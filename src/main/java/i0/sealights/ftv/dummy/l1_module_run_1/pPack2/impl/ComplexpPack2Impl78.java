...
public class ComplexpPack2Impl78 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl78.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl78 INSTANCE;

    public static ComplexpPack2Impl78 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl78();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl78(){
