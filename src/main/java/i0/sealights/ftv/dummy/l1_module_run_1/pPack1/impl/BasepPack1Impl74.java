...
public class BasepPack1Impl74 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl74.class);
    private static BasepPack1Impl74 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl74 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl74();
        }
        return INSTANCE;
    }

    private BasepPack1Impl74(){
