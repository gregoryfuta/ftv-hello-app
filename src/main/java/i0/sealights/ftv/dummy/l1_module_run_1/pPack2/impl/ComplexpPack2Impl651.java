...
public class ComplexpPack2Impl651 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl651.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl651 INSTANCE;

    public static ComplexpPack2Impl651 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl651();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl651(){
