...
public class ComplexpPack1Impl364 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl364.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl364 INSTANCE;

    public static ComplexpPack1Impl364 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl364();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl364(){
