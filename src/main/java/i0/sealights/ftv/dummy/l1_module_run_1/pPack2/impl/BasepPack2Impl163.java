...
public class BasepPack2Impl163 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl163.class);
    private static BasepPack2Impl163 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl163 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl163();
        }
        return INSTANCE;
    }

    private BasepPack2Impl163(){
