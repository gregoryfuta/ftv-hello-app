...
public class ComplexpPack2Impl364 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl364.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl364 INSTANCE;

    public static ComplexpPack2Impl364 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl364();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl364(){
