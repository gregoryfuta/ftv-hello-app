...
public class ComplexpPack2Impl670 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl670.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl670 INSTANCE;

    public static ComplexpPack2Impl670 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl670();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl670(){
