...
public class ComplexpPack1Impl993 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl993.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl993 INSTANCE;

    public static ComplexpPack1Impl993 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl993();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl993(){
