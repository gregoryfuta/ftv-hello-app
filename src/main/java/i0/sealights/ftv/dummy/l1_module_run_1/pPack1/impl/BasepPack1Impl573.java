...
public class BasepPack1Impl573 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl573.class);
    private static BasepPack1Impl573 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl573 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl573();
        }
        return INSTANCE;
    }

    private BasepPack1Impl573(){
