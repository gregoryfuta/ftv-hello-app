...
public class BasepPack1Impl155 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl155.class);
    private static BasepPack1Impl155 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl155 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl155();
        }
        return INSTANCE;
    }

    private BasepPack1Impl155(){
