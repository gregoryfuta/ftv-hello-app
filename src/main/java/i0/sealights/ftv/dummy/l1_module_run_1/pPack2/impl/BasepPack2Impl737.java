...
public class BasepPack2Impl737 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl737.class);
    private static BasepPack2Impl737 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl737 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl737();
        }
        return INSTANCE;
    }

    private BasepPack2Impl737(){
