...
public class BasepPack2Impl468 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl468.class);
    private static BasepPack2Impl468 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl468 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl468();
        }
        return INSTANCE;
    }

    private BasepPack2Impl468(){
