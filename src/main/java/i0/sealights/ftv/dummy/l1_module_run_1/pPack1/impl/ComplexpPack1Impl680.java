...
public class ComplexpPack1Impl680 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl680.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl680 INSTANCE;

    public static ComplexpPack1Impl680 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl680();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl680(){
