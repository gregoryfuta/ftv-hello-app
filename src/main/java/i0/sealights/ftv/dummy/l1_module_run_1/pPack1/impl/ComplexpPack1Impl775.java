...
public class ComplexpPack1Impl775 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl775.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl775 INSTANCE;

    public static ComplexpPack1Impl775 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl775();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl775(){
