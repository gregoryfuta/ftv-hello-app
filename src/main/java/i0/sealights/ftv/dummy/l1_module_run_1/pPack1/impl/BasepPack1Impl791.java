...
public class BasepPack1Impl791 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl791.class);
    private static BasepPack1Impl791 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl791 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl791();
        }
        return INSTANCE;
    }

    private BasepPack1Impl791(){
