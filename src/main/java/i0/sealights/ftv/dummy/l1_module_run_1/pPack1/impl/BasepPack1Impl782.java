...
public class BasepPack1Impl782 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl782.class);
    private static BasepPack1Impl782 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl782 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl782();
        }
        return INSTANCE;
    }

    private BasepPack1Impl782(){
