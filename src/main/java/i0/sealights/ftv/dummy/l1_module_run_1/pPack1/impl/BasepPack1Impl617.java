...
public class BasepPack1Impl617 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl617.class);
    private static BasepPack1Impl617 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl617 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl617();
        }
        return INSTANCE;
    }

    private BasepPack1Impl617(){
