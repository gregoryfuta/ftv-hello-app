...
public class BasepPack2Impl273 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl273.class);
    private static BasepPack2Impl273 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl273 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl273();
        }
        return INSTANCE;
    }

    private BasepPack2Impl273(){
