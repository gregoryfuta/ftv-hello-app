...
public class ComplexpPack1Impl415 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl415.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl415 INSTANCE;

    public static ComplexpPack1Impl415 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl415();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl415(){
