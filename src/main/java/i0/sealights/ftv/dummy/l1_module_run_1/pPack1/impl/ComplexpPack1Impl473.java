...
public class ComplexpPack1Impl473 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl473.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl473 INSTANCE;

    public static ComplexpPack1Impl473 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl473();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl473(){
