...
public class BasepPack2Impl742 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl742.class);
    private static BasepPack2Impl742 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl742 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl742();
        }
        return INSTANCE;
    }

    private BasepPack2Impl742(){
