...
public class ComplexpPack1Impl126 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl126.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl126 INSTANCE;

    public static ComplexpPack1Impl126 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl126();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl126(){
