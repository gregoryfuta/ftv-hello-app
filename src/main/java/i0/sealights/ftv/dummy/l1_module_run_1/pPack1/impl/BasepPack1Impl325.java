...
public class BasepPack1Impl325 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl325.class);
    private static BasepPack1Impl325 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl325 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl325();
        }
        return INSTANCE;
    }

    private BasepPack1Impl325(){
