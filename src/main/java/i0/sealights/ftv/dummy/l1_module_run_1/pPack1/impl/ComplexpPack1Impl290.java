...
public class ComplexpPack1Impl290 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl290.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl290 INSTANCE;

    public static ComplexpPack1Impl290 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl290();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl290(){
