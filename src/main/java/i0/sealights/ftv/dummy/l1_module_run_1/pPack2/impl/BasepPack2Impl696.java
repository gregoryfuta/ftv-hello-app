...
public class BasepPack2Impl696 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl696.class);
    private static BasepPack2Impl696 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl696 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl696();
        }
        return INSTANCE;
    }

    private BasepPack2Impl696(){
