...
public class ComplexpPack1Impl329 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl329.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl329 INSTANCE;

    public static ComplexpPack1Impl329 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl329();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl329(){
