...
public class ComplexpPack1Impl806 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl806.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl806 INSTANCE;

    public static ComplexpPack1Impl806 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl806();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl806(){
