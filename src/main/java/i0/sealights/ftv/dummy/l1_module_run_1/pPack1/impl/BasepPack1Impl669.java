...
public class BasepPack1Impl669 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl669.class);
    private static BasepPack1Impl669 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl669 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl669();
        }
        return INSTANCE;
    }

    private BasepPack1Impl669(){
