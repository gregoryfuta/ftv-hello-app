...
public class ComplexpPack1Impl376 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl376.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl376 INSTANCE;

    public static ComplexpPack1Impl376 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl376();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl376(){
