...
public class BasepPack1Impl309 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl309.class);
    private static BasepPack1Impl309 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl309 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl309();
        }
        return INSTANCE;
    }

    private BasepPack1Impl309(){
