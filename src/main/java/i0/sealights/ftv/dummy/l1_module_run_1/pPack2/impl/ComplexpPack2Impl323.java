...
public class ComplexpPack2Impl323 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl323.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl323 INSTANCE;

    public static ComplexpPack2Impl323 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl323();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl323(){
