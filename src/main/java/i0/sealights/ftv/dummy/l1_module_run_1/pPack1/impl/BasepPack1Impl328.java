...
public class BasepPack1Impl328 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl328.class);
    private static BasepPack1Impl328 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl328 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl328();
        }
        return INSTANCE;
    }

    private BasepPack1Impl328(){
