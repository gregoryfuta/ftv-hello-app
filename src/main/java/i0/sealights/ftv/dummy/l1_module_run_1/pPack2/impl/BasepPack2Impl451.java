...
public class BasepPack2Impl451 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl451.class);
    private static BasepPack2Impl451 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl451 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl451();
        }
        return INSTANCE;
    }

    private BasepPack2Impl451(){
