...
public class ComplexpPack1Impl750 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl750.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl750 INSTANCE;

    public static ComplexpPack1Impl750 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl750();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl750(){
