...
public class ComplexpPack2Impl71 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl71.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl71 INSTANCE;

    public static ComplexpPack2Impl71 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl71();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl71(){
