...
public class BasepPack1Impl362 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl362.class);
    private static BasepPack1Impl362 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl362 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl362();
        }
        return INSTANCE;
    }

    private BasepPack1Impl362(){
