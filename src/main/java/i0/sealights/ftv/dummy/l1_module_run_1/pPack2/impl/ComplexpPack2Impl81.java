...
public class ComplexpPack2Impl81 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl81.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl81 INSTANCE;

    public static ComplexpPack2Impl81 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl81();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl81(){
