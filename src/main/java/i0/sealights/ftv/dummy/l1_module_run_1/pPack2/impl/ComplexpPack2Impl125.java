...
public class ComplexpPack2Impl125 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl125.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl125 INSTANCE;

    public static ComplexpPack2Impl125 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl125();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl125(){
