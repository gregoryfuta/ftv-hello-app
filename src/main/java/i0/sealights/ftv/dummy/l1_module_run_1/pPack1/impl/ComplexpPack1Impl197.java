...
public class ComplexpPack1Impl197 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl197.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl197 INSTANCE;

    public static ComplexpPack1Impl197 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl197();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl197(){
