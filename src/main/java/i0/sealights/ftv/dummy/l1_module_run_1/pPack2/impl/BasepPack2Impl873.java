...
public class BasepPack2Impl873 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl873.class);
    private static BasepPack2Impl873 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl873 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl873();
        }
        return INSTANCE;
    }

    private BasepPack2Impl873(){
