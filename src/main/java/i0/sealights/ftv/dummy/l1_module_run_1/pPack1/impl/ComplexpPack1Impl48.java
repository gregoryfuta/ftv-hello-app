...
public class ComplexpPack1Impl48 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl48.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl48 INSTANCE;

    public static ComplexpPack1Impl48 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl48();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl48(){
