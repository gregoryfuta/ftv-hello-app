...
public class BasepPack1Impl459 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl459.class);
    private static BasepPack1Impl459 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl459 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl459();
        }
        return INSTANCE;
    }

    private BasepPack1Impl459(){
