...
public class BasepPack1Impl337 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl337.class);
    private static BasepPack1Impl337 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl337 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl337();
        }
        return INSTANCE;
    }

    private BasepPack1Impl337(){
