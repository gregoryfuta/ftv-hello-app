...
public class BasepPack2Impl93 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl93.class);
    private static BasepPack2Impl93 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl93 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl93();
        }
        return INSTANCE;
    }

    private BasepPack2Impl93(){
