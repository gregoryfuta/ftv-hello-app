...
public class ComplexpPack2Impl791 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl791.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl791 INSTANCE;

    public static ComplexpPack2Impl791 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl791();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl791(){
