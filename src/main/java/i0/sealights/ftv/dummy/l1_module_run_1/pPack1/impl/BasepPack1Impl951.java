...
public class BasepPack1Impl951 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl951.class);
    private static BasepPack1Impl951 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl951 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl951();
        }
        return INSTANCE;
    }

    private BasepPack1Impl951(){
