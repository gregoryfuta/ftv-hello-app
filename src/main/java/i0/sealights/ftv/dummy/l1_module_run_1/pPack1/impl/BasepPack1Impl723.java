...
public class BasepPack1Impl723 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl723.class);
    private static BasepPack1Impl723 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl723 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl723();
        }
        return INSTANCE;
    }

    private BasepPack1Impl723(){
