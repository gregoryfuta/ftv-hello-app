...
public class BasepPack2Impl81 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl81.class);
    private static BasepPack2Impl81 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl81 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl81();
        }
        return INSTANCE;
    }

    private BasepPack2Impl81(){
