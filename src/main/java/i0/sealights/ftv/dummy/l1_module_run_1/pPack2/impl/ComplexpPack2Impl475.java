...
public class ComplexpPack2Impl475 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl475.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl475 INSTANCE;

    public static ComplexpPack2Impl475 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl475();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl475(){
