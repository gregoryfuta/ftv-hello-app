...
public class ComplexpPack2Impl807 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl807.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl807 INSTANCE;

    public static ComplexpPack2Impl807 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl807();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl807(){
