...
public class BasepPack2Impl689 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl689.class);
    private static BasepPack2Impl689 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl689 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl689();
        }
        return INSTANCE;
    }

    private BasepPack2Impl689(){
