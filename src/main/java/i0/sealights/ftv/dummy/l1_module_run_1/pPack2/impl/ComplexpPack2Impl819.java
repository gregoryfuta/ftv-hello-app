...
public class ComplexpPack2Impl819 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl819.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl819 INSTANCE;

    public static ComplexpPack2Impl819 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl819();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl819(){
