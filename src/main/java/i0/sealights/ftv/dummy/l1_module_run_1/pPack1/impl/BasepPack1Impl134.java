...
public class BasepPack1Impl134 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl134.class);
    private static BasepPack1Impl134 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl134 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl134();
        }
        return INSTANCE;
    }

    private BasepPack1Impl134(){
