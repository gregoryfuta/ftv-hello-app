...
public class ComplexpPack2Impl67 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl67.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl67 INSTANCE;

    public static ComplexpPack2Impl67 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl67();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl67(){
