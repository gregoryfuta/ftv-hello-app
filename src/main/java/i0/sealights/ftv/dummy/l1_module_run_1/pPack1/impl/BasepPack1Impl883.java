...
public class BasepPack1Impl883 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl883.class);
    private static BasepPack1Impl883 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl883 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl883();
        }
        return INSTANCE;
    }

    private BasepPack1Impl883(){
