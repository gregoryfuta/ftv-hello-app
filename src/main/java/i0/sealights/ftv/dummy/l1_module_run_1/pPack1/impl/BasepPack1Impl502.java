...
public class BasepPack1Impl502 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl502.class);
    private static BasepPack1Impl502 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl502 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl502();
        }
        return INSTANCE;
    }

    private BasepPack1Impl502(){
