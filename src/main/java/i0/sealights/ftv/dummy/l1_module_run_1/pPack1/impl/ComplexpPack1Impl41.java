...
public class ComplexpPack1Impl41 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl41.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl41 INSTANCE;

    public static ComplexpPack1Impl41 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl41();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl41(){
