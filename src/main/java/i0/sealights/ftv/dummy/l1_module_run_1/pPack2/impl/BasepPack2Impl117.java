...
public class BasepPack2Impl117 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl117.class);
    private static BasepPack2Impl117 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl117 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl117();
        }
        return INSTANCE;
    }

    private BasepPack2Impl117(){
