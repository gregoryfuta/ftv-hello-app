...
public class BasepPack2Impl799 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl799.class);
    private static BasepPack2Impl799 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl799 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl799();
        }
        return INSTANCE;
    }

    private BasepPack2Impl799(){
