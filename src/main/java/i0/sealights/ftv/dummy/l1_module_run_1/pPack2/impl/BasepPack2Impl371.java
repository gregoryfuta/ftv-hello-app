...
public class BasepPack2Impl371 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl371.class);
    private static BasepPack2Impl371 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl371 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl371();
        }
        return INSTANCE;
    }

    private BasepPack2Impl371(){
