...
public class BasepPack2Impl865 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl865.class);
    private static BasepPack2Impl865 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl865 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl865();
        }
        return INSTANCE;
    }

    private BasepPack2Impl865(){
