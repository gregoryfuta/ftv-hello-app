...
public class ComplexpPack1Impl436 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl436.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl436 INSTANCE;

    public static ComplexpPack1Impl436 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl436();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl436(){
