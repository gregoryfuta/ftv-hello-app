...
public class ComplexpPack1Impl289 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl289.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl289 INSTANCE;

    public static ComplexpPack1Impl289 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl289();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl289(){
