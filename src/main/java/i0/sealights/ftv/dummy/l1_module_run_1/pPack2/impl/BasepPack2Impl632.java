...
public class BasepPack2Impl632 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl632.class);
    private static BasepPack2Impl632 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl632 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl632();
        }
        return INSTANCE;
    }

    private BasepPack2Impl632(){
