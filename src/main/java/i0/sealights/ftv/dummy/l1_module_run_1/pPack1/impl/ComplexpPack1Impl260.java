...
public class ComplexpPack1Impl260 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl260.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl260 INSTANCE;

    public static ComplexpPack1Impl260 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl260();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl260(){
