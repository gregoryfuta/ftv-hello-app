...
public class BasepPack2Impl192 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl192.class);
    private static BasepPack2Impl192 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl192 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl192();
        }
        return INSTANCE;
    }

    private BasepPack2Impl192(){
