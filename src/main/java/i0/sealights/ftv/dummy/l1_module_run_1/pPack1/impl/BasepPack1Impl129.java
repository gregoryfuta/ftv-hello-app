...
public class BasepPack1Impl129 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl129.class);
    private static BasepPack1Impl129 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl129 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl129();
        }
        return INSTANCE;
    }

    private BasepPack1Impl129(){
