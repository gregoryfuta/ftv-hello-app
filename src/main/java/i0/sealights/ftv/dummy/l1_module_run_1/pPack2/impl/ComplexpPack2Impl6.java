...
public class ComplexpPack2Impl6 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl6.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl6 INSTANCE;

    public static ComplexpPack2Impl6 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl6();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl6(){
