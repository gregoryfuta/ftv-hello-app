...
public class BasepPack2Impl924 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl924.class);
    private static BasepPack2Impl924 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl924 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl924();
        }
        return INSTANCE;
    }

    private BasepPack2Impl924(){
