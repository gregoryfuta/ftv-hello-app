...
public class ComplexpPack2Impl749 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl749.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl749 INSTANCE;

    public static ComplexpPack2Impl749 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl749();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl749(){
