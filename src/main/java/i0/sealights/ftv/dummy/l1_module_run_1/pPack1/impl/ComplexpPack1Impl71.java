...
public class ComplexpPack1Impl71 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl71.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl71 INSTANCE;

    public static ComplexpPack1Impl71 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl71();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl71(){
