...
public class BasepPack1Impl594 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl594.class);
    private static BasepPack1Impl594 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl594 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl594();
        }
        return INSTANCE;
    }

    private BasepPack1Impl594(){
