...
public class ComplexpPack2Impl676 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl676.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl676 INSTANCE;

    public static ComplexpPack2Impl676 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl676();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl676(){
