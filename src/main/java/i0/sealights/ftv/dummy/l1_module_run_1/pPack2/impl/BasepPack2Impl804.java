...
public class BasepPack2Impl804 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl804.class);
    private static BasepPack2Impl804 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl804 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl804();
        }
        return INSTANCE;
    }

    private BasepPack2Impl804(){
