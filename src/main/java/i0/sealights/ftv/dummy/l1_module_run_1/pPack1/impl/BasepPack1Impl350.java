...
public class BasepPack1Impl350 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl350.class);
    private static BasepPack1Impl350 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl350 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl350();
        }
        return INSTANCE;
    }

    private BasepPack1Impl350(){
