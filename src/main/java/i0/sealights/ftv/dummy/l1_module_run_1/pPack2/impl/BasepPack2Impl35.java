...
public class BasepPack2Impl35 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl35.class);
    private static BasepPack2Impl35 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl35 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl35();
        }
        return INSTANCE;
    }

    private BasepPack2Impl35(){
