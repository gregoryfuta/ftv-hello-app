...
public class ComplexpPack2Impl771 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl771.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl771 INSTANCE;

    public static ComplexpPack2Impl771 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl771();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl771(){
