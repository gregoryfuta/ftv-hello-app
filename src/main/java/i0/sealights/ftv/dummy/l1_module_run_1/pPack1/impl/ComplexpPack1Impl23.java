...
public class ComplexpPack1Impl23 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl23.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl23 INSTANCE;

    public static ComplexpPack1Impl23 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl23();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl23(){
