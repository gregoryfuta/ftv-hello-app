...
public class ComplexpPack1Impl837 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl837.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl837 INSTANCE;

    public static ComplexpPack1Impl837 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl837();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl837(){
