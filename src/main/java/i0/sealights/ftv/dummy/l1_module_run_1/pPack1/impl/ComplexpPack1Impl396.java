...
public class ComplexpPack1Impl396 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl396.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl396 INSTANCE;

    public static ComplexpPack1Impl396 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl396();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl396(){
