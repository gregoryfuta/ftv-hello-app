...
public class ComplexpPack1Impl242 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl242.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl242 INSTANCE;

    public static ComplexpPack1Impl242 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl242();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl242(){
