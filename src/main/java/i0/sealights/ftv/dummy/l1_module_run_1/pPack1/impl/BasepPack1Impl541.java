...
public class BasepPack1Impl541 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl541.class);
    private static BasepPack1Impl541 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl541 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl541();
        }
        return INSTANCE;
    }

    private BasepPack1Impl541(){
