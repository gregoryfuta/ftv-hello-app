...
public class BasepPack2Impl281 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl281.class);
    private static BasepPack2Impl281 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl281 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl281();
        }
        return INSTANCE;
    }

    private BasepPack2Impl281(){
