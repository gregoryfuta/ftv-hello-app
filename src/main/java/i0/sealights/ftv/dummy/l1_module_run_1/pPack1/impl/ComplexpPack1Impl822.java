...
public class ComplexpPack1Impl822 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl822.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl822 INSTANCE;

    public static ComplexpPack1Impl822 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl822();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl822(){
