...
public class BasepPack2Impl270 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl270.class);
    private static BasepPack2Impl270 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl270 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl270();
        }
        return INSTANCE;
    }

    private BasepPack2Impl270(){
