...
public class BasepPack1Impl772 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl772.class);
    private static BasepPack1Impl772 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl772 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl772();
        }
        return INSTANCE;
    }

    private BasepPack1Impl772(){
