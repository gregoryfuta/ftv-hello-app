...
public class ComplexpPack1Impl921 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl921.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl921 INSTANCE;

    public static ComplexpPack1Impl921 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl921();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl921(){
