...
public class ComplexpPack1Impl377 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl377.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl377 INSTANCE;

    public static ComplexpPack1Impl377 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl377();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl377(){
