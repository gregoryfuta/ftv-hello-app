...
public class ComplexpPack1Impl950 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl950.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl950 INSTANCE;

    public static ComplexpPack1Impl950 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl950();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl950(){
