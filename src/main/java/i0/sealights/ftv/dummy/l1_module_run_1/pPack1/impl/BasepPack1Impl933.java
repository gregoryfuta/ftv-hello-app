...
public class BasepPack1Impl933 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl933.class);
    private static BasepPack1Impl933 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl933 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl933();
        }
        return INSTANCE;
    }

    private BasepPack1Impl933(){
