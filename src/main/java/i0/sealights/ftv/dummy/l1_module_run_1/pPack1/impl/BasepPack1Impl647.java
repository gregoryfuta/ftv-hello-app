...
public class BasepPack1Impl647 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl647.class);
    private static BasepPack1Impl647 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl647 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl647();
        }
        return INSTANCE;
    }

    private BasepPack1Impl647(){
