...
public class ComplexpPack2Impl227 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl227.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl227 INSTANCE;

    public static ComplexpPack2Impl227 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl227();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl227(){
