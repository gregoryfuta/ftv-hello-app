...
public class ComplexpPack1Impl35 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl35.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl35 INSTANCE;

    public static ComplexpPack1Impl35 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl35();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl35(){
