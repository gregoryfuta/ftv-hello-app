...
public class BasepPack1Impl388 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl388.class);
    private static BasepPack1Impl388 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl388 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl388();
        }
        return INSTANCE;
    }

    private BasepPack1Impl388(){
