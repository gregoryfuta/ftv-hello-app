...
public class BasepPack2Impl911 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl911.class);
    private static BasepPack2Impl911 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl911 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl911();
        }
        return INSTANCE;
    }

    private BasepPack2Impl911(){
