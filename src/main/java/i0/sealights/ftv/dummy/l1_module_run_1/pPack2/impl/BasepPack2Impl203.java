...
public class BasepPack2Impl203 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl203.class);
    private static BasepPack2Impl203 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl203 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl203();
        }
        return INSTANCE;
    }

    private BasepPack2Impl203(){
