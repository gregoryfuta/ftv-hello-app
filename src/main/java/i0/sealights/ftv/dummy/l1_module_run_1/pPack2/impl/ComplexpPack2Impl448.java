...
public class ComplexpPack2Impl448 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl448.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl448 INSTANCE;

    public static ComplexpPack2Impl448 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl448();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl448(){
