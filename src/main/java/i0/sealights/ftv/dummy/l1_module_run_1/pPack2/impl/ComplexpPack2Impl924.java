...
public class ComplexpPack2Impl924 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl924.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl924 INSTANCE;

    public static ComplexpPack2Impl924 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl924();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl924(){
