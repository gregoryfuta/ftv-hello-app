...
public class ComplexpPack1Impl758 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl758.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl758 INSTANCE;

    public static ComplexpPack1Impl758 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl758();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl758(){
