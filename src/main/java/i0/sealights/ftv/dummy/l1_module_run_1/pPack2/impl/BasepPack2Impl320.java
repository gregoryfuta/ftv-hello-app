...
public class BasepPack2Impl320 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl320.class);
    private static BasepPack2Impl320 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl320 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl320();
        }
        return INSTANCE;
    }

    private BasepPack2Impl320(){
