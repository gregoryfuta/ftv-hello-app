...
public class ComplexpPack1Impl645 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl645.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl645 INSTANCE;

    public static ComplexpPack1Impl645 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl645();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl645(){
