...
public class ComplexpPack1Impl253 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl253.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl253 INSTANCE;

    public static ComplexpPack1Impl253 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl253();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl253(){
