...
public class ComplexpPack1Impl787 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl787.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl787 INSTANCE;

    public static ComplexpPack1Impl787 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl787();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl787(){
