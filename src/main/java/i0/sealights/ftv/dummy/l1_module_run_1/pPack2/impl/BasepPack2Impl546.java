...
public class BasepPack2Impl546 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl546.class);
    private static BasepPack2Impl546 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl546 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl546();
        }
        return INSTANCE;
    }

    private BasepPack2Impl546(){
