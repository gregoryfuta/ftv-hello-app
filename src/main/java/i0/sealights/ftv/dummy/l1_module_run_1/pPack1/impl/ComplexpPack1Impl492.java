...
public class ComplexpPack1Impl492 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl492.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl492 INSTANCE;

    public static ComplexpPack1Impl492 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl492();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl492(){
