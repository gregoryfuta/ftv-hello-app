...
public class BasepPack2Impl555 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl555.class);
    private static BasepPack2Impl555 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl555 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl555();
        }
        return INSTANCE;
    }

    private BasepPack2Impl555(){
