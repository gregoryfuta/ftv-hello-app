...
public class ComplexpPack2Impl237 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl237.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl237 INSTANCE;

    public static ComplexpPack2Impl237 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl237();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl237(){
