...
public class ComplexpPack1Impl929 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl929.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl929 INSTANCE;

    public static ComplexpPack1Impl929 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl929();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl929(){
