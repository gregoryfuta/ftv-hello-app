...
public class ComplexpPack1Impl675 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl675.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl675 INSTANCE;

    public static ComplexpPack1Impl675 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl675();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl675(){
