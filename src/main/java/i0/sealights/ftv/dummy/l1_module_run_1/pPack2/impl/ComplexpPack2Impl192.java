...
public class ComplexpPack2Impl192 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl192.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl192 INSTANCE;

    public static ComplexpPack2Impl192 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl192();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl192(){
