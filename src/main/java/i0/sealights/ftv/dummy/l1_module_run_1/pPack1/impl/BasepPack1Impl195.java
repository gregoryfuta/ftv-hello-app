...
public class BasepPack1Impl195 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl195.class);
    private static BasepPack1Impl195 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl195 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl195();
        }
        return INSTANCE;
    }

    private BasepPack1Impl195(){
