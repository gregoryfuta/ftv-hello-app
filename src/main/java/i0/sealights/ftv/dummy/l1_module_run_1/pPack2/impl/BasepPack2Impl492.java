...
public class BasepPack2Impl492 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl492.class);
    private static BasepPack2Impl492 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl492 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl492();
        }
        return INSTANCE;
    }

    private BasepPack2Impl492(){
