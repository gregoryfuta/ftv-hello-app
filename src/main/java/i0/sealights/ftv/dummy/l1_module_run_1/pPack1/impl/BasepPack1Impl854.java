...
public class BasepPack1Impl854 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl854.class);
    private static BasepPack1Impl854 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl854 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl854();
        }
        return INSTANCE;
    }

    private BasepPack1Impl854(){
