...
public class ComplexpPack2Impl519 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl519.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl519 INSTANCE;

    public static ComplexpPack2Impl519 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl519();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl519(){
