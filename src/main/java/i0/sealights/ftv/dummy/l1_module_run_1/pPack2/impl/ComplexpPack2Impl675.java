...
public class ComplexpPack2Impl675 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl675.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl675 INSTANCE;

    public static ComplexpPack2Impl675 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl675();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl675(){
