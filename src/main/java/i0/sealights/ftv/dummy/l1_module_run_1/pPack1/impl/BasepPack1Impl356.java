...
public class BasepPack1Impl356 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl356.class);
    private static BasepPack1Impl356 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl356 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl356();
        }
        return INSTANCE;
    }

    private BasepPack1Impl356(){
