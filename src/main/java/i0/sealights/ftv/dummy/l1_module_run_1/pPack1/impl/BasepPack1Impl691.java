...
public class BasepPack1Impl691 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl691.class);
    private static BasepPack1Impl691 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl691 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl691();
        }
        return INSTANCE;
    }

    private BasepPack1Impl691(){
