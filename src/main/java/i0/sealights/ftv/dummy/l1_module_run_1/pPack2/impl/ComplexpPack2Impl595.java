...
public class ComplexpPack2Impl595 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl595.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl595 INSTANCE;

    public static ComplexpPack2Impl595 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl595();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl595(){
