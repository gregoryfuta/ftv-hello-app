...
public class ComplexpPack1Impl134 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl134.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl134 INSTANCE;

    public static ComplexpPack1Impl134 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl134();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl134(){
