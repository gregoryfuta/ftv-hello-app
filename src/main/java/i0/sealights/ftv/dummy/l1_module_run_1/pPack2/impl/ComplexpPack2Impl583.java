...
public class ComplexpPack2Impl583 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl583.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl583 INSTANCE;

    public static ComplexpPack2Impl583 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl583();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl583(){
