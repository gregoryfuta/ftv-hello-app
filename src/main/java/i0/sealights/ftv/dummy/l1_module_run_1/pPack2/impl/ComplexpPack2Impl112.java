...
public class ComplexpPack2Impl112 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl112.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl112 INSTANCE;

    public static ComplexpPack2Impl112 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl112();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl112(){
