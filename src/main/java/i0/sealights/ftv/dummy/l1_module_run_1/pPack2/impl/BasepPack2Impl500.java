...
public class BasepPack2Impl500 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl500.class);
    private static BasepPack2Impl500 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl500 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl500();
        }
        return INSTANCE;
    }

    private BasepPack2Impl500(){
