...
public class ComplexpPack2Impl2 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl2.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl2 INSTANCE;

    public static ComplexpPack2Impl2 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl2();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl2(){
