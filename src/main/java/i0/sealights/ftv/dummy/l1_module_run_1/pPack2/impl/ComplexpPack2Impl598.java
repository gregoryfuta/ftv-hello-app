...
public class ComplexpPack2Impl598 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl598.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl598 INSTANCE;

    public static ComplexpPack2Impl598 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl598();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl598(){
