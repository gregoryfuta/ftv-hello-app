...
public class BasepPack1Impl117 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl117.class);
    private static BasepPack1Impl117 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl117 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl117();
        }
        return INSTANCE;
    }

    private BasepPack1Impl117(){
