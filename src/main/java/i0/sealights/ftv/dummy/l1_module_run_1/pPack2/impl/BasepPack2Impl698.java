...
public class BasepPack2Impl698 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl698.class);
    private static BasepPack2Impl698 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl698 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl698();
        }
        return INSTANCE;
    }

    private BasepPack2Impl698(){
