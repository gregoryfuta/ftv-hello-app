...
public class ComplexpPack1Impl93 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl93.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl93 INSTANCE;

    public static ComplexpPack1Impl93 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl93();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl93(){
