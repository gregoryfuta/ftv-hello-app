...
public class BasepPack1Impl580 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl580.class);
    private static BasepPack1Impl580 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl580 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl580();
        }
        return INSTANCE;
    }

    private BasepPack1Impl580(){
