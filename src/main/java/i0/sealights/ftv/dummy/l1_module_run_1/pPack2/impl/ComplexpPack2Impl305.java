...
public class ComplexpPack2Impl305 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl305.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl305 INSTANCE;

    public static ComplexpPack2Impl305 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl305();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl305(){
