...
public class BasepPack2Impl706 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl706.class);
    private static BasepPack2Impl706 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl706 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl706();
        }
        return INSTANCE;
    }

    private BasepPack2Impl706(){
