...
public class ComplexpPack1Impl339 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl339.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl339 INSTANCE;

    public static ComplexpPack1Impl339 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl339();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl339(){
