...
public class BasepPack1Impl478 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl478.class);
    private static BasepPack1Impl478 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl478 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl478();
        }
        return INSTANCE;
    }

    private BasepPack1Impl478(){
