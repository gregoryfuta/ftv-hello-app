...
public class ComplexpPack2Impl765 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl765.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl765 INSTANCE;

    public static ComplexpPack2Impl765 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl765();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl765(){
