...
public class BasepPack1Impl151 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl151.class);
    private static BasepPack1Impl151 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl151 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl151();
        }
        return INSTANCE;
    }

    private BasepPack1Impl151(){
