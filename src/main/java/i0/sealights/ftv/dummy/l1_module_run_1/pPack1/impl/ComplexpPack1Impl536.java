...
public class ComplexpPack1Impl536 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl536.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl536 INSTANCE;

    public static ComplexpPack1Impl536 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl536();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl536(){
