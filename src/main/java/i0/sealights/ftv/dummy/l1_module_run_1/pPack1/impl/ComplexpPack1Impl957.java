...
public class ComplexpPack1Impl957 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl957.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl957 INSTANCE;

    public static ComplexpPack1Impl957 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl957();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl957(){
