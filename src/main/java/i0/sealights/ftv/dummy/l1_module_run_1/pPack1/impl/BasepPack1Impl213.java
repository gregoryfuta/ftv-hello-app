...
public class BasepPack1Impl213 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl213.class);
    private static BasepPack1Impl213 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl213 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl213();
        }
        return INSTANCE;
    }

    private BasepPack1Impl213(){
