...
public class ComplexpPack1Impl320 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl320.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl320 INSTANCE;

    public static ComplexpPack1Impl320 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl320();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl320(){
