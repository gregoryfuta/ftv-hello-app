...
public class BasepPack1Impl658 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl658.class);
    private static BasepPack1Impl658 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl658 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl658();
        }
        return INSTANCE;
    }

    private BasepPack1Impl658(){
