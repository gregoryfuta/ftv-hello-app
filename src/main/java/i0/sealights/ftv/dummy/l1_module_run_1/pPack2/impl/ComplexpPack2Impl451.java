...
public class ComplexpPack2Impl451 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl451.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl451 INSTANCE;

    public static ComplexpPack2Impl451 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl451();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl451(){
