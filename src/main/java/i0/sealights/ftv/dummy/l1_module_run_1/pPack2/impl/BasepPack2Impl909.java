...
public class BasepPack2Impl909 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl909.class);
    private static BasepPack2Impl909 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl909 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl909();
        }
        return INSTANCE;
    }

    private BasepPack2Impl909(){
