...
public class ComplexpPack2Impl181 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl181.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl181 INSTANCE;

    public static ComplexpPack2Impl181 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl181();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl181(){
