...
public class ComplexpPack1Impl303 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl303.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl303 INSTANCE;

    public static ComplexpPack1Impl303 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl303();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl303(){
