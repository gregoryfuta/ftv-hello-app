...
public class ComplexpPack2Impl422 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl422.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl422 INSTANCE;

    public static ComplexpPack2Impl422 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl422();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl422(){
