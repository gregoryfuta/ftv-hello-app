...
public class BasepPack2Impl355 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl355.class);
    private static BasepPack2Impl355 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl355 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl355();
        }
        return INSTANCE;
    }

    private BasepPack2Impl355(){
