...
public class ComplexpPack2Impl974 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl974.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl974 INSTANCE;

    public static ComplexpPack2Impl974 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl974();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl974(){
