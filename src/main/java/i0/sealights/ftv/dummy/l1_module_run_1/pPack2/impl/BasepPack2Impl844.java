...
public class BasepPack2Impl844 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl844.class);
    private static BasepPack2Impl844 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl844 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl844();
        }
        return INSTANCE;
    }

    private BasepPack2Impl844(){
