...
public class BasepPack2Impl208 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl208.class);
    private static BasepPack2Impl208 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl208 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl208();
        }
        return INSTANCE;
    }

    private BasepPack2Impl208(){
