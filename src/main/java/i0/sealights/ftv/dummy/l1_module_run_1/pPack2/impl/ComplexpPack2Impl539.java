...
public class ComplexpPack2Impl539 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl539.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl539 INSTANCE;

    public static ComplexpPack2Impl539 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl539();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl539(){
