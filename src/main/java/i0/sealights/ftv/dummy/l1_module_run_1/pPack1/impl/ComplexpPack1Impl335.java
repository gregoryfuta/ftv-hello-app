...
public class ComplexpPack1Impl335 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl335.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl335 INSTANCE;

    public static ComplexpPack1Impl335 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl335();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl335(){
