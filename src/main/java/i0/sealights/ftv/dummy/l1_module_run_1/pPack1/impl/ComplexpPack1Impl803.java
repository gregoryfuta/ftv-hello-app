...
public class ComplexpPack1Impl803 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl803.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl803 INSTANCE;

    public static ComplexpPack1Impl803 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl803();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl803(){
