...
public class ComplexpPack2Impl234 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl234.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl234 INSTANCE;

    public static ComplexpPack2Impl234 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl234();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl234(){
