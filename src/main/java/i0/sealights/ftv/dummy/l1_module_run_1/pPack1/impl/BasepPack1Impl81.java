...
public class BasepPack1Impl81 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl81.class);
    private static BasepPack1Impl81 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl81 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl81();
        }
        return INSTANCE;
    }

    private BasepPack1Impl81(){
