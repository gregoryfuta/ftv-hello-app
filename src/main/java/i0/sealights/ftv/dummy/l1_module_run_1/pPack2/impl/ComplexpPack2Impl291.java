...
public class ComplexpPack2Impl291 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl291.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl291 INSTANCE;

    public static ComplexpPack2Impl291 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl291();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl291(){
