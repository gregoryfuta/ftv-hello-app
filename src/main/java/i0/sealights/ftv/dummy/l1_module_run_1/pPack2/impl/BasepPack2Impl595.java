...
public class BasepPack2Impl595 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl595.class);
    private static BasepPack2Impl595 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl595 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl595();
        }
        return INSTANCE;
    }

    private BasepPack2Impl595(){
