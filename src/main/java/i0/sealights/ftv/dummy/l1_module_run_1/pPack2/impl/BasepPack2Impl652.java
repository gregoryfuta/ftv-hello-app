...
public class BasepPack2Impl652 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl652.class);
    private static BasepPack2Impl652 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl652 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl652();
        }
        return INSTANCE;
    }

    private BasepPack2Impl652(){
