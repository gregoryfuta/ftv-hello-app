...
public class ComplexpPack1Impl306 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl306.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl306 INSTANCE;

    public static ComplexpPack1Impl306 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl306();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl306(){
