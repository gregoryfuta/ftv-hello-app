...
public class ComplexpPack2Impl250 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl250.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl250 INSTANCE;

    public static ComplexpPack2Impl250 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl250();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl250(){
