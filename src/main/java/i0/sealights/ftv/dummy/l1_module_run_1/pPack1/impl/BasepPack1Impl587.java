...
public class BasepPack1Impl587 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl587.class);
    private static BasepPack1Impl587 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl587 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl587();
        }
        return INSTANCE;
    }

    private BasepPack1Impl587(){
