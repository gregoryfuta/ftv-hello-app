...
public class ComplexpPack1Impl710 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl710.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl710 INSTANCE;

    public static ComplexpPack1Impl710 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl710();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl710(){
