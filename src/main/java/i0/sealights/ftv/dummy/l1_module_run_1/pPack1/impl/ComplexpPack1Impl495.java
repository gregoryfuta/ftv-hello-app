...
public class ComplexpPack1Impl495 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl495.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl495 INSTANCE;

    public static ComplexpPack1Impl495 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl495();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl495(){
