...
public class BasepPack2Impl160 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl160.class);
    private static BasepPack2Impl160 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl160 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl160();
        }
        return INSTANCE;
    }

    private BasepPack2Impl160(){
