...
public class BasepPack2Impl28 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl28.class);
    private static BasepPack2Impl28 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl28 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl28();
        }
        return INSTANCE;
    }

    private BasepPack2Impl28(){
