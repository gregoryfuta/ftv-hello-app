...
public class ComplexpPack2Impl883 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl883.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl883 INSTANCE;

    public static ComplexpPack2Impl883 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl883();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl883(){
