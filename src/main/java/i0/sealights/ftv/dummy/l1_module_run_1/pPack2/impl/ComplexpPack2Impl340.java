...
public class ComplexpPack2Impl340 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl340.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl340 INSTANCE;

    public static ComplexpPack2Impl340 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl340();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl340(){
