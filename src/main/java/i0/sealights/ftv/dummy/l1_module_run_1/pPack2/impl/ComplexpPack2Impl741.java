...
public class ComplexpPack2Impl741 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl741.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl741 INSTANCE;

    public static ComplexpPack2Impl741 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl741();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl741(){
