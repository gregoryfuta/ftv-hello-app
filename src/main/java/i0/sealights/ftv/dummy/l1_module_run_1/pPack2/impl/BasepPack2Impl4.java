...
public class BasepPack2Impl4 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl4.class);
    private static BasepPack2Impl4 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl4 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl4();
        }
        return INSTANCE;
    }

    private BasepPack2Impl4(){
