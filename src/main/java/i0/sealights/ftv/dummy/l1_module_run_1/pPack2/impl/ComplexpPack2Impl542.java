...
public class ComplexpPack2Impl542 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl542.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl542 INSTANCE;

    public static ComplexpPack2Impl542 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl542();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl542(){
