...
public class BasepPack2Impl127 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl127.class);
    private static BasepPack2Impl127 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl127 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl127();
        }
        return INSTANCE;
    }

    private BasepPack2Impl127(){
