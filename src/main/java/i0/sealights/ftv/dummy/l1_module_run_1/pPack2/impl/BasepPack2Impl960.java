...
public class BasepPack2Impl960 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl960.class);
    private static BasepPack2Impl960 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl960 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl960();
        }
        return INSTANCE;
    }

    private BasepPack2Impl960(){
