...
public class ComplexpPack2Impl458 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl458.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl458 INSTANCE;

    public static ComplexpPack2Impl458 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl458();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl458(){
