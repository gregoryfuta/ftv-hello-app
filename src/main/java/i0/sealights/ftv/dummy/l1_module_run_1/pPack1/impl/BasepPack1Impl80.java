...
public class BasepPack1Impl80 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl80.class);
    private static BasepPack1Impl80 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl80 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl80();
        }
        return INSTANCE;
    }

    private BasepPack1Impl80(){
