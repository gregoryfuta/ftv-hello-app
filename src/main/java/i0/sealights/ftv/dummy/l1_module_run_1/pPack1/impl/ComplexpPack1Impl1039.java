...
public class ComplexpPack1Impl1039 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1039.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1039 INSTANCE;

    public static ComplexpPack1Impl1039 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1039();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1039(){
