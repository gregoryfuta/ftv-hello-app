...
public class ComplexpPack2Impl910 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl910.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl910 INSTANCE;

    public static ComplexpPack2Impl910 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl910();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl910(){
