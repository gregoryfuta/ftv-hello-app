...
public class BasepPack2Impl239 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl239.class);
    private static BasepPack2Impl239 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl239 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl239();
        }
        return INSTANCE;
    }

    private BasepPack2Impl239(){
