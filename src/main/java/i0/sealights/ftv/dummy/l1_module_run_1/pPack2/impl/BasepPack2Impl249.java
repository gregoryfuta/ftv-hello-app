...
public class BasepPack2Impl249 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl249.class);
    private static BasepPack2Impl249 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl249 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl249();
        }
        return INSTANCE;
    }

    private BasepPack2Impl249(){
