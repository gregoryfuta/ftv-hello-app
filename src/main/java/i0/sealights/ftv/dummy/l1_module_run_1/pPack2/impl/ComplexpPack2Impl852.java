...
public class ComplexpPack2Impl852 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl852.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl852 INSTANCE;

    public static ComplexpPack2Impl852 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl852();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl852(){
