...
public class ComplexpPack2Impl492 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl492.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl492 INSTANCE;

    public static ComplexpPack2Impl492 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl492();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl492(){
