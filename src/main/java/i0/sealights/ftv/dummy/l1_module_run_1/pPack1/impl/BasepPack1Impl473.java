...
public class BasepPack1Impl473 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl473.class);
    private static BasepPack1Impl473 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl473 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl473();
        }
        return INSTANCE;
    }

    private BasepPack1Impl473(){
