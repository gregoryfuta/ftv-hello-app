...
public class ComplexpPack1Impl903 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl903.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl903 INSTANCE;

    public static ComplexpPack1Impl903 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl903();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl903(){
