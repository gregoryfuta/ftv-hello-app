...
public class BasepPack1Impl513 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl513.class);
    private static BasepPack1Impl513 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl513 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl513();
        }
        return INSTANCE;
    }

    private BasepPack1Impl513(){
