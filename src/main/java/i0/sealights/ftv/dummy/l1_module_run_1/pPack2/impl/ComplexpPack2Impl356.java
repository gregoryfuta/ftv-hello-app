...
public class ComplexpPack2Impl356 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl356.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl356 INSTANCE;

    public static ComplexpPack2Impl356 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl356();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl356(){
