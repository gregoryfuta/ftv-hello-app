...
public class BasepPack1Impl583 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl583.class);
    private static BasepPack1Impl583 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl583 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl583();
        }
        return INSTANCE;
    }

    private BasepPack1Impl583(){
