...
public class ComplexpPack2Impl554 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl554.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl554 INSTANCE;

    public static ComplexpPack2Impl554 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl554();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl554(){
