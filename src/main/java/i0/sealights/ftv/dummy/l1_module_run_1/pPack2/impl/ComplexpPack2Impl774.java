...
public class ComplexpPack2Impl774 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl774.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl774 INSTANCE;

    public static ComplexpPack2Impl774 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl774();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl774(){
