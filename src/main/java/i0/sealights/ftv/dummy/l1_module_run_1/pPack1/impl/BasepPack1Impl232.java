...
public class BasepPack1Impl232 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl232.class);
    private static BasepPack1Impl232 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl232 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl232();
        }
        return INSTANCE;
    }

    private BasepPack1Impl232(){
