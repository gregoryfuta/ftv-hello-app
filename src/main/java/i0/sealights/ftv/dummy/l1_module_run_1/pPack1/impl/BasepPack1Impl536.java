...
public class BasepPack1Impl536 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl536.class);
    private static BasepPack1Impl536 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl536 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl536();
        }
        return INSTANCE;
    }

    private BasepPack1Impl536(){
