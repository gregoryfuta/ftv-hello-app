...
public class BasepPack1Impl1058 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1058.class);
    private static BasepPack1Impl1058 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1058 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1058();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1058(){
