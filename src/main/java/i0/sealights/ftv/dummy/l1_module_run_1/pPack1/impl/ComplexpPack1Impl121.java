...
public class ComplexpPack1Impl121 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl121.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl121 INSTANCE;

    public static ComplexpPack1Impl121 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl121();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl121(){
