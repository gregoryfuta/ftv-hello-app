...
public class BasepPack1Impl904 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl904.class);
    private static BasepPack1Impl904 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl904 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl904();
        }
        return INSTANCE;
    }

    private BasepPack1Impl904(){
