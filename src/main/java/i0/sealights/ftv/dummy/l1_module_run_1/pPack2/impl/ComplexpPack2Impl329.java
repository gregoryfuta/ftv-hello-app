...
public class ComplexpPack2Impl329 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl329.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl329 INSTANCE;

    public static ComplexpPack2Impl329 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl329();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl329(){
