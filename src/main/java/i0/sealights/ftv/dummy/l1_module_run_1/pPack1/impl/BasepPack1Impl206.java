...
public class BasepPack1Impl206 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl206.class);
    private static BasepPack1Impl206 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl206 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl206();
        }
        return INSTANCE;
    }

    private BasepPack1Impl206(){
