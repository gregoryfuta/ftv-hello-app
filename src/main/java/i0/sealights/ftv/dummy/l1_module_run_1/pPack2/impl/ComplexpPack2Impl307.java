...
public class ComplexpPack2Impl307 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl307.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl307 INSTANCE;

    public static ComplexpPack2Impl307 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl307();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl307(){
