...
public class BasepPack1Impl420 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl420.class);
    private static BasepPack1Impl420 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl420 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl420();
        }
        return INSTANCE;
    }

    private BasepPack1Impl420(){
