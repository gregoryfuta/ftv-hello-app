...
public class ComplexpPack2Impl964 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl964.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl964 INSTANCE;

    public static ComplexpPack2Impl964 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl964();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl964(){
