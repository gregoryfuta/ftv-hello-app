...
public class BasepPack2Impl581 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl581.class);
    private static BasepPack2Impl581 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl581 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl581();
        }
        return INSTANCE;
    }

    private BasepPack2Impl581(){
