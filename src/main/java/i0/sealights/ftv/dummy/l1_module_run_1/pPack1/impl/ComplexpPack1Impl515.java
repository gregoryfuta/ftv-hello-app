...
public class ComplexpPack1Impl515 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl515.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl515 INSTANCE;

    public static ComplexpPack1Impl515 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl515();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl515(){
