...
public class ComplexpPack1Impl586 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl586.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl586 INSTANCE;

    public static ComplexpPack1Impl586 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl586();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl586(){
