...
public class BasepPack1Impl244 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl244.class);
    private static BasepPack1Impl244 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl244 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl244();
        }
        return INSTANCE;
    }

    private BasepPack1Impl244(){
