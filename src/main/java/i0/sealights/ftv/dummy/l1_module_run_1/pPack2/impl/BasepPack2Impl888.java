...
public class BasepPack2Impl888 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl888.class);
    private static BasepPack2Impl888 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl888 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl888();
        }
        return INSTANCE;
    }

    private BasepPack2Impl888(){
