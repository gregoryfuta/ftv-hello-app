...
public class ComplexpPack1Impl200 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl200.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl200 INSTANCE;

    public static ComplexpPack1Impl200 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl200();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl200(){
