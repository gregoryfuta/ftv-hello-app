...
public class BasepPack2Impl729 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl729.class);
    private static BasepPack2Impl729 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl729 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl729();
        }
        return INSTANCE;
    }

    private BasepPack2Impl729(){
