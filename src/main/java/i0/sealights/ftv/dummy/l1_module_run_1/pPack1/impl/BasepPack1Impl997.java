...
public class BasepPack1Impl997 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl997.class);
    private static BasepPack1Impl997 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl997 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl997();
        }
        return INSTANCE;
    }

    private BasepPack1Impl997(){
