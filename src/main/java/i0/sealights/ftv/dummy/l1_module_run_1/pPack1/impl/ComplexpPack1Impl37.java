...
public class ComplexpPack1Impl37 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl37.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl37 INSTANCE;

    public static ComplexpPack1Impl37 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl37();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl37(){
