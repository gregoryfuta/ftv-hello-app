...
public class BasepPack1Impl923 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl923.class);
    private static BasepPack1Impl923 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl923 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl923();
        }
        return INSTANCE;
    }

    private BasepPack1Impl923(){
