...
public class ComplexpPack1Impl983 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl983.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl983 INSTANCE;

    public static ComplexpPack1Impl983 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl983();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl983(){
