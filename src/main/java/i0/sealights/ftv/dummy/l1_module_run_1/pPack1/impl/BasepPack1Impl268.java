...
public class BasepPack1Impl268 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl268.class);
    private static BasepPack1Impl268 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl268 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl268();
        }
        return INSTANCE;
    }

    private BasepPack1Impl268(){
