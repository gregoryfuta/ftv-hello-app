...
public class BasepPack1Impl577 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl577.class);
    private static BasepPack1Impl577 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl577 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl577();
        }
        return INSTANCE;
    }

    private BasepPack1Impl577(){
