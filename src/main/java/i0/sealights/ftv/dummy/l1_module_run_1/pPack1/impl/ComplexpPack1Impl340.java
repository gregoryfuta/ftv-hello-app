...
public class ComplexpPack1Impl340 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl340.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl340 INSTANCE;

    public static ComplexpPack1Impl340 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl340();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl340(){
