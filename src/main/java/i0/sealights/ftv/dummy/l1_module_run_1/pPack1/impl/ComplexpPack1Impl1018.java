...
public class ComplexpPack1Impl1018 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1018.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1018 INSTANCE;

    public static ComplexpPack1Impl1018 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1018();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1018(){
