...
public class BasepPack1Impl130 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl130.class);
    private static BasepPack1Impl130 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl130 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl130();
        }
        return INSTANCE;
    }

    private BasepPack1Impl130(){
