...
public class ComplexpPack1Impl1016 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1016.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1016 INSTANCE;

    public static ComplexpPack1Impl1016 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1016();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1016(){
