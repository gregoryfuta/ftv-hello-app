...
public class BasepPack2Impl509 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl509.class);
    private static BasepPack2Impl509 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl509 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl509();
        }
        return INSTANCE;
    }

    private BasepPack2Impl509(){
