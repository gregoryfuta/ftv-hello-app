...
public class ComplexpPack1Impl861 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl861.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl861 INSTANCE;

    public static ComplexpPack1Impl861 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl861();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl861(){
