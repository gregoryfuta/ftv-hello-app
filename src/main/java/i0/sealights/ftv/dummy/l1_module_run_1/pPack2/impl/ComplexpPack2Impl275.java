...
public class ComplexpPack2Impl275 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl275.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl275 INSTANCE;

    public static ComplexpPack2Impl275 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl275();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl275(){
