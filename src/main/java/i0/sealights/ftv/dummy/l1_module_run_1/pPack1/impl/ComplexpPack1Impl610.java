...
public class ComplexpPack1Impl610 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl610.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl610 INSTANCE;

    public static ComplexpPack1Impl610 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl610();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl610(){
