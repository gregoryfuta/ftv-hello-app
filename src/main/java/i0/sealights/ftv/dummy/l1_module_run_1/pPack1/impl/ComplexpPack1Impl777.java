...
public class ComplexpPack1Impl777 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl777.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl777 INSTANCE;

    public static ComplexpPack1Impl777 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl777();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl777(){
