...
public class ComplexpPack1Impl829 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl829.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl829 INSTANCE;

    public static ComplexpPack1Impl829 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl829();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl829(){
