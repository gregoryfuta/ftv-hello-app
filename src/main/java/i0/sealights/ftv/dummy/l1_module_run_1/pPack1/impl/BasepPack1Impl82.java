...
public class BasepPack1Impl82 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl82.class);
    private static BasepPack1Impl82 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl82 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl82();
        }
        return INSTANCE;
    }

    private BasepPack1Impl82(){
