...
public class BasepPack2Impl245 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl245.class);
    private static BasepPack2Impl245 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl245 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl245();
        }
        return INSTANCE;
    }

    private BasepPack2Impl245(){
