...
public class BasepPack1Impl127 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl127.class);
    private static BasepPack1Impl127 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl127 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl127();
        }
        return INSTANCE;
    }

    private BasepPack1Impl127(){
