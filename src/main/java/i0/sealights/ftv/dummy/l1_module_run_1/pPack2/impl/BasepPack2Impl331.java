...
public class BasepPack2Impl331 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl331.class);
    private static BasepPack2Impl331 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl331 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl331();
        }
        return INSTANCE;
    }

    private BasepPack2Impl331(){
