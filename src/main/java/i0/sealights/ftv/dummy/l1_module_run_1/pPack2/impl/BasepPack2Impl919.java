...
public class BasepPack2Impl919 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl919.class);
    private static BasepPack2Impl919 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl919 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl919();
        }
        return INSTANCE;
    }

    private BasepPack2Impl919(){
