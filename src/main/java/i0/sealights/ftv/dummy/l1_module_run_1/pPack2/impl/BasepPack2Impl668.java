...
public class BasepPack2Impl668 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl668.class);
    private static BasepPack2Impl668 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl668 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl668();
        }
        return INSTANCE;
    }

    private BasepPack2Impl668(){
