...
public class ComplexpPack1Impl378 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl378.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl378 INSTANCE;

    public static ComplexpPack1Impl378 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl378();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl378(){
