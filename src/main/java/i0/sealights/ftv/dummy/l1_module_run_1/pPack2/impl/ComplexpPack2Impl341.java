...
public class ComplexpPack2Impl341 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl341.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl341 INSTANCE;

    public static ComplexpPack2Impl341 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl341();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl341(){
