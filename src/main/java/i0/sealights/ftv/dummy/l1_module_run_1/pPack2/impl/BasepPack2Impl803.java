...
public class BasepPack2Impl803 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl803.class);
    private static BasepPack2Impl803 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl803 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl803();
        }
        return INSTANCE;
    }

    private BasepPack2Impl803(){
