...
public class BasepPack2Impl560 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl560.class);
    private static BasepPack2Impl560 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl560 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl560();
        }
        return INSTANCE;
    }

    private BasepPack2Impl560(){
