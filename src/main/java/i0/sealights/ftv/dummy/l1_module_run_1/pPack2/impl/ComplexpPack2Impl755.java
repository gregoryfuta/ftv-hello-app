...
public class ComplexpPack2Impl755 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl755.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl755 INSTANCE;

    public static ComplexpPack2Impl755 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl755();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl755(){
