...
public class BasepPack1Impl191 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl191.class);
    private static BasepPack1Impl191 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl191 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl191();
        }
        return INSTANCE;
    }

    private BasepPack1Impl191(){
