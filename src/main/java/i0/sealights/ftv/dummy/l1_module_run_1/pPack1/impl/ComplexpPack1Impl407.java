...
public class ComplexpPack1Impl407 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl407.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl407 INSTANCE;

    public static ComplexpPack1Impl407 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl407();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl407(){
