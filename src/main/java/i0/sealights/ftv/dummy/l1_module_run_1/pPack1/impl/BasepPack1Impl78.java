...
public class BasepPack1Impl78 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl78.class);
    private static BasepPack1Impl78 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl78 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl78();
        }
        return INSTANCE;
    }

    private BasepPack1Impl78(){
