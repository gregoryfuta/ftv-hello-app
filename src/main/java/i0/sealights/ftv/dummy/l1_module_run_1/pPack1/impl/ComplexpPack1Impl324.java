...
public class ComplexpPack1Impl324 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl324.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl324 INSTANCE;

    public static ComplexpPack1Impl324 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl324();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl324(){
