...
public class BasepPack1Impl659 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl659.class);
    private static BasepPack1Impl659 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl659 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl659();
        }
        return INSTANCE;
    }

    private BasepPack1Impl659(){
