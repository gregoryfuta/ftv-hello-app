...
public class ComplexpPack2Impl986 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl986.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl986 INSTANCE;

    public static ComplexpPack2Impl986 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl986();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl986(){
