...
public class BasepPack2Impl936 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl936.class);
    private static BasepPack2Impl936 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl936 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl936();
        }
        return INSTANCE;
    }

    private BasepPack2Impl936(){
