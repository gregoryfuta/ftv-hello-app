...
public class ComplexpPack1Impl604 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl604.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl604 INSTANCE;

    public static ComplexpPack1Impl604 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl604();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl604(){
