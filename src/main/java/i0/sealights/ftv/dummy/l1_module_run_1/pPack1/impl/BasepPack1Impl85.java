...
public class BasepPack1Impl85 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl85.class);
    private static BasepPack1Impl85 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl85 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl85();
        }
        return INSTANCE;
    }

    private BasepPack1Impl85(){
