...
public class BasepPack2Impl907 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl907.class);
    private static BasepPack2Impl907 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl907 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl907();
        }
        return INSTANCE;
    }

    private BasepPack2Impl907(){
