...
public class BasepPack2Impl124 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl124.class);
    private static BasepPack2Impl124 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl124 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl124();
        }
        return INSTANCE;
    }

    private BasepPack2Impl124(){
