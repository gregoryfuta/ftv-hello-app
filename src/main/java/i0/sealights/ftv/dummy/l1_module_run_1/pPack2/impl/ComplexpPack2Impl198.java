...
public class ComplexpPack2Impl198 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl198.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl198 INSTANCE;

    public static ComplexpPack2Impl198 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl198();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl198(){
