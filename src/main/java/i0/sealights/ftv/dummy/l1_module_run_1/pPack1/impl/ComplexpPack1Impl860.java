...
public class ComplexpPack1Impl860 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl860.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl860 INSTANCE;

    public static ComplexpPack1Impl860 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl860();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl860(){
