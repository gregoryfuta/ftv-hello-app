...
public class ComplexpPack2Impl343 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl343.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl343 INSTANCE;

    public static ComplexpPack2Impl343 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl343();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl343(){
