...
public class BasepPack2Impl265 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl265.class);
    private static BasepPack2Impl265 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl265 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl265();
        }
        return INSTANCE;
    }

    private BasepPack2Impl265(){
