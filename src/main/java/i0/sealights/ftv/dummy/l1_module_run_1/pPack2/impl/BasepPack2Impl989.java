...
public class BasepPack2Impl989 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl989.class);
    private static BasepPack2Impl989 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl989 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl989();
        }
        return INSTANCE;
    }

    private BasepPack2Impl989(){
