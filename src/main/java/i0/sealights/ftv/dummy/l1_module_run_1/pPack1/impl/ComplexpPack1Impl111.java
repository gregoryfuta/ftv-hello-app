...
public class ComplexpPack1Impl111 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl111.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl111 INSTANCE;

    public static ComplexpPack1Impl111 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl111();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl111(){
