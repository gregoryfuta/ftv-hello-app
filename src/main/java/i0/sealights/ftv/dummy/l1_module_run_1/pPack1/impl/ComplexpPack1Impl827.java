...
public class ComplexpPack1Impl827 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl827.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl827 INSTANCE;

    public static ComplexpPack1Impl827 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl827();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl827(){
