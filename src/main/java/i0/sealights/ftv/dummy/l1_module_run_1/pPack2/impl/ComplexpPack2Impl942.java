...
public class ComplexpPack2Impl942 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl942.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl942 INSTANCE;

    public static ComplexpPack2Impl942 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl942();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl942(){
