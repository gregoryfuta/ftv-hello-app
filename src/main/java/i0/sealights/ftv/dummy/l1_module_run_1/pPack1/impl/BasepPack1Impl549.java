...
public class BasepPack1Impl549 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl549.class);
    private static BasepPack1Impl549 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl549 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl549();
        }
        return INSTANCE;
    }

    private BasepPack1Impl549(){
