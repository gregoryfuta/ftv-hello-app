...
public class ComplexpPack2Impl999 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl999.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl999 INSTANCE;

    public static ComplexpPack2Impl999 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl999();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl999(){
