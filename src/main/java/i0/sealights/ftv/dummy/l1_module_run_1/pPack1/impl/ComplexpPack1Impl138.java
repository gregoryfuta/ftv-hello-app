...
public class ComplexpPack1Impl138 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl138.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl138 INSTANCE;

    public static ComplexpPack1Impl138 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl138();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl138(){
