...
public class BasepPack2Impl456 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl456.class);
    private static BasepPack2Impl456 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl456 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl456();
        }
        return INSTANCE;
    }

    private BasepPack2Impl456(){
