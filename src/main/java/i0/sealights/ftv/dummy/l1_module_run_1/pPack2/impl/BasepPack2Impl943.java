...
public class BasepPack2Impl943 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl943.class);
    private static BasepPack2Impl943 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl943 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl943();
        }
        return INSTANCE;
    }

    private BasepPack2Impl943(){
