...
public class ComplexpPack2Impl923 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl923.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl923 INSTANCE;

    public static ComplexpPack2Impl923 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl923();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl923(){
