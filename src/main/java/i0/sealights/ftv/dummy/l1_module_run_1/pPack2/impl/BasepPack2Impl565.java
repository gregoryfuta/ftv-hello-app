...
public class BasepPack2Impl565 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl565.class);
    private static BasepPack2Impl565 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl565 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl565();
        }
        return INSTANCE;
    }

    private BasepPack2Impl565(){
