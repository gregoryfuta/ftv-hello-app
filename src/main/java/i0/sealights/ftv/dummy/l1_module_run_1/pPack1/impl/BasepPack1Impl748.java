...
public class BasepPack1Impl748 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl748.class);
    private static BasepPack1Impl748 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl748 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl748();
        }
        return INSTANCE;
    }

    private BasepPack1Impl748(){
