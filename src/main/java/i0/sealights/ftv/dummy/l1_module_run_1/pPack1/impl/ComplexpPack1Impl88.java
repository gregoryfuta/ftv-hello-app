...
public class ComplexpPack1Impl88 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl88.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl88 INSTANCE;

    public static ComplexpPack1Impl88 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl88();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl88(){
