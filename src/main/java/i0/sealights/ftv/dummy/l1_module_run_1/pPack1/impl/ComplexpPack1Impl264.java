...
public class ComplexpPack1Impl264 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl264.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl264 INSTANCE;

    public static ComplexpPack1Impl264 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl264();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl264(){
