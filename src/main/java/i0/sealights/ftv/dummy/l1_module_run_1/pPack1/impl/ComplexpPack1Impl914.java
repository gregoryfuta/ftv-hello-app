...
public class ComplexpPack1Impl914 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl914.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl914 INSTANCE;

    public static ComplexpPack1Impl914 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl914();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl914(){
