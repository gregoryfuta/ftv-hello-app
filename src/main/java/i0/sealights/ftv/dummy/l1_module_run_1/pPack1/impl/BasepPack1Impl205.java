...
public class BasepPack1Impl205 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl205.class);
    private static BasepPack1Impl205 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl205 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl205();
        }
        return INSTANCE;
    }

    private BasepPack1Impl205(){
