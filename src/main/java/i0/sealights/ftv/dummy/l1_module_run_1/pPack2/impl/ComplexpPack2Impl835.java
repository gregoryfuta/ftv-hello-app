...
public class ComplexpPack2Impl835 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl835.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl835 INSTANCE;

    public static ComplexpPack2Impl835 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl835();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl835(){
