...
public class BasepPack2Impl536 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl536.class);
    private static BasepPack2Impl536 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl536 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl536();
        }
        return INSTANCE;
    }

    private BasepPack2Impl536(){
