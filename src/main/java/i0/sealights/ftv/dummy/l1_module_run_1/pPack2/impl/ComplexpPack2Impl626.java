...
public class ComplexpPack2Impl626 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl626.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl626 INSTANCE;

    public static ComplexpPack2Impl626 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl626();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl626(){
