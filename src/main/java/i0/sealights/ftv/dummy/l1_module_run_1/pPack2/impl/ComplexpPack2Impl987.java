...
public class ComplexpPack2Impl987 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl987.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl987 INSTANCE;

    public static ComplexpPack2Impl987 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl987();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl987(){
