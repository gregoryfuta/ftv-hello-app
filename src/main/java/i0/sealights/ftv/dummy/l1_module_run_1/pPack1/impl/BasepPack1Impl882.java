...
public class BasepPack1Impl882 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl882.class);
    private static BasepPack1Impl882 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl882 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl882();
        }
        return INSTANCE;
    }

    private BasepPack1Impl882(){
