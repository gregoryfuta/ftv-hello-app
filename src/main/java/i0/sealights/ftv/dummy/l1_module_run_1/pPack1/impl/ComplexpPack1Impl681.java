...
public class ComplexpPack1Impl681 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl681.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl681 INSTANCE;

    public static ComplexpPack1Impl681 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl681();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl681(){
