...
public class ComplexpPack1Impl911 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl911.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl911 INSTANCE;

    public static ComplexpPack1Impl911 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl911();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl911(){
