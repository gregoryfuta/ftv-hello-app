...
public class BasepPack1Impl615 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl615.class);
    private static BasepPack1Impl615 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl615 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl615();
        }
        return INSTANCE;
    }

    private BasepPack1Impl615(){
