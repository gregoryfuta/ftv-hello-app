...
public class ComplexpPack2Impl286 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl286.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl286 INSTANCE;

    public static ComplexpPack2Impl286 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl286();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl286(){
