...
public class BasepPack2Impl62 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl62.class);
    private static BasepPack2Impl62 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl62 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl62();
        }
        return INSTANCE;
    }

    private BasepPack2Impl62(){
