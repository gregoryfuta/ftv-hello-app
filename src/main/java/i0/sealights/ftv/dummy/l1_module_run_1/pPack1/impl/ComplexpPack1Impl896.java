...
public class ComplexpPack1Impl896 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl896.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl896 INSTANCE;

    public static ComplexpPack1Impl896 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl896();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl896(){
