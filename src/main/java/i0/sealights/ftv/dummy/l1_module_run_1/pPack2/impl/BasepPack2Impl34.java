...
public class BasepPack2Impl34 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl34.class);
    private static BasepPack2Impl34 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl34 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl34();
        }
        return INSTANCE;
    }

    private BasepPack2Impl34(){
