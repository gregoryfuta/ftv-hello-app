...
public class BasepPack1Impl913 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl913.class);
    private static BasepPack1Impl913 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl913 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl913();
        }
        return INSTANCE;
    }

    private BasepPack1Impl913(){
