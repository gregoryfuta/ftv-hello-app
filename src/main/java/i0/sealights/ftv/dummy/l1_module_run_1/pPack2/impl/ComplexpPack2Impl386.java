...
public class ComplexpPack2Impl386 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl386.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl386 INSTANCE;

    public static ComplexpPack2Impl386 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl386();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl386(){
