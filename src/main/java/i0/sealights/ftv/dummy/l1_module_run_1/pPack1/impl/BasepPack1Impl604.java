...
public class BasepPack1Impl604 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl604.class);
    private static BasepPack1Impl604 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl604 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl604();
        }
        return INSTANCE;
    }

    private BasepPack1Impl604(){
