...
public class BasepPack1Impl643 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl643.class);
    private static BasepPack1Impl643 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl643 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl643();
        }
        return INSTANCE;
    }

    private BasepPack1Impl643(){
