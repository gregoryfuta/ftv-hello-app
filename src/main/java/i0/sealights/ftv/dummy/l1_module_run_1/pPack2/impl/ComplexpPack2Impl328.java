...
public class ComplexpPack2Impl328 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl328.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl328 INSTANCE;

    public static ComplexpPack2Impl328 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl328();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl328(){
