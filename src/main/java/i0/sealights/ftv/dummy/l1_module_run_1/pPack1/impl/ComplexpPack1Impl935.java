...
public class ComplexpPack1Impl935 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl935.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl935 INSTANCE;

    public static ComplexpPack1Impl935 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl935();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl935(){
