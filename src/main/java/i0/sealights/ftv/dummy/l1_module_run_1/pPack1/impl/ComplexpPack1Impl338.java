...
public class ComplexpPack1Impl338 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl338.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl338 INSTANCE;

    public static ComplexpPack1Impl338 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl338();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl338(){
