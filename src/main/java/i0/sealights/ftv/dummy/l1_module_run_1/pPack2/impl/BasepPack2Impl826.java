...
public class BasepPack2Impl826 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl826.class);
    private static BasepPack2Impl826 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl826 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl826();
        }
        return INSTANCE;
    }

    private BasepPack2Impl826(){
