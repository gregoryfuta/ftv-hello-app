...
public class BasepPack1Impl930 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl930.class);
    private static BasepPack1Impl930 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl930 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl930();
        }
        return INSTANCE;
    }

    private BasepPack1Impl930(){
