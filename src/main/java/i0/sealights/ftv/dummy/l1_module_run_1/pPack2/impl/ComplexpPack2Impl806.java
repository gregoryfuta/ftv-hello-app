...
public class ComplexpPack2Impl806 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl806.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl806 INSTANCE;

    public static ComplexpPack2Impl806 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl806();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl806(){
