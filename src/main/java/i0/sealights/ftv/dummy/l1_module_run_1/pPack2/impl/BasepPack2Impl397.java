...
public class BasepPack2Impl397 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl397.class);
    private static BasepPack2Impl397 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl397 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl397();
        }
        return INSTANCE;
    }

    private BasepPack2Impl397(){
