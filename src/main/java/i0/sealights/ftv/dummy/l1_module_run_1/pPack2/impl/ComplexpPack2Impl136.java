...
public class ComplexpPack2Impl136 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl136.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl136 INSTANCE;

    public static ComplexpPack2Impl136 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl136();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl136(){
