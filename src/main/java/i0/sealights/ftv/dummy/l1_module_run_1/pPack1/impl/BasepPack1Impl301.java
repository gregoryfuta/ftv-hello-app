...
public class BasepPack1Impl301 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl301.class);
    private static BasepPack1Impl301 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl301 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl301();
        }
        return INSTANCE;
    }

    private BasepPack1Impl301(){
