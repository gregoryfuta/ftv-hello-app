...
public class BasepPack2Impl708 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl708.class);
    private static BasepPack2Impl708 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl708 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl708();
        }
        return INSTANCE;
    }

    private BasepPack2Impl708(){
