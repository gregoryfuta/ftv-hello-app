...
public class ComplexpPack1Impl327 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl327.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl327 INSTANCE;

    public static ComplexpPack1Impl327 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl327();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl327(){
