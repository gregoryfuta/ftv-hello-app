...
public class ComplexpPack2Impl277 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl277.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl277 INSTANCE;

    public static ComplexpPack2Impl277 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl277();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl277(){
