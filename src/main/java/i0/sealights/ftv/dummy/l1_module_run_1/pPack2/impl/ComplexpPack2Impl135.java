...
public class ComplexpPack2Impl135 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl135.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl135 INSTANCE;

    public static ComplexpPack2Impl135 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl135();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl135(){
