...
public class BasepPack1Impl106 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl106.class);
    private static BasepPack1Impl106 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl106 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl106();
        }
        return INSTANCE;
    }

    private BasepPack1Impl106(){
