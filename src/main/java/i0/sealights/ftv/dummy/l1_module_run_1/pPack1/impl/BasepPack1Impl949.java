...
public class BasepPack1Impl949 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl949.class);
    private static BasepPack1Impl949 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl949 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl949();
        }
        return INSTANCE;
    }

    private BasepPack1Impl949(){
