...
public class BasepPack1Impl562 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl562.class);
    private static BasepPack1Impl562 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl562 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl562();
        }
        return INSTANCE;
    }

    private BasepPack1Impl562(){
