...
public class BasepPack1Impl243 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl243.class);
    private static BasepPack1Impl243 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl243 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl243();
        }
        return INSTANCE;
    }

    private BasepPack1Impl243(){
