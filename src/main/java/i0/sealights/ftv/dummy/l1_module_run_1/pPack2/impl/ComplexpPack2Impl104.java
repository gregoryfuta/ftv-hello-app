...
public class ComplexpPack2Impl104 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl104.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl104 INSTANCE;

    public static ComplexpPack2Impl104 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl104();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl104(){
