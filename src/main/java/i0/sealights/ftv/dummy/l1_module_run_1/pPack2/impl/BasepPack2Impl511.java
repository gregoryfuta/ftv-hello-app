...
public class BasepPack2Impl511 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl511.class);
    private static BasepPack2Impl511 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl511 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl511();
        }
        return INSTANCE;
    }

    private BasepPack2Impl511(){
