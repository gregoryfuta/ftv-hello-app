...
public class BasepPack2Impl348 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl348.class);
    private static BasepPack2Impl348 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl348 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl348();
        }
        return INSTANCE;
    }

    private BasepPack2Impl348(){
