...
public class BasepPack2Impl32 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl32.class);
    private static BasepPack2Impl32 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl32 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl32();
        }
        return INSTANCE;
    }

    private BasepPack2Impl32(){
