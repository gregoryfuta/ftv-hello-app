...
public class BasepPack2Impl755 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl755.class);
    private static BasepPack2Impl755 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl755 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl755();
        }
        return INSTANCE;
    }

    private BasepPack2Impl755(){
