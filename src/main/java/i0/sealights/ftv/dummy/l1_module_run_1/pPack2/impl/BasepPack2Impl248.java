...
public class BasepPack2Impl248 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl248.class);
    private static BasepPack2Impl248 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl248 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl248();
        }
        return INSTANCE;
    }

    private BasepPack2Impl248(){
