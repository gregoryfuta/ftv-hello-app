...
public class BasepPack2Impl138 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl138.class);
    private static BasepPack2Impl138 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl138 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl138();
        }
        return INSTANCE;
    }

    private BasepPack2Impl138(){
