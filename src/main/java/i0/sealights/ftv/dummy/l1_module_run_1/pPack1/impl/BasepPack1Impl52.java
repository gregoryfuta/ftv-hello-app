...
public class BasepPack1Impl52 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl52.class);
    private static BasepPack1Impl52 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl52 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl52();
        }
        return INSTANCE;
    }

    private BasepPack1Impl52(){
