...
public class ComplexpPack2Impl936 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl936.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl936 INSTANCE;

    public static ComplexpPack2Impl936 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl936();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl936(){
