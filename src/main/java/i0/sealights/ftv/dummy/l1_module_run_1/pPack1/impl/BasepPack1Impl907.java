...
public class BasepPack1Impl907 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl907.class);
    private static BasepPack1Impl907 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl907 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl907();
        }
        return INSTANCE;
    }

    private BasepPack1Impl907(){
