...
public class BasepPack1Impl574 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl574.class);
    private static BasepPack1Impl574 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl574 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl574();
        }
        return INSTANCE;
    }

    private BasepPack1Impl574(){
