...
public class ComplexpPack1Impl59 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl59.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl59 INSTANCE;

    public static ComplexpPack1Impl59 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl59();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl59(){
