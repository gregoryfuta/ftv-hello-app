...
public class ComplexpPack2Impl903 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl903.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl903 INSTANCE;

    public static ComplexpPack2Impl903 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl903();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl903(){
