...
public class BasepPack1Impl352 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl352.class);
    private static BasepPack1Impl352 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl352 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl352();
        }
        return INSTANCE;
    }

    private BasepPack1Impl352(){
