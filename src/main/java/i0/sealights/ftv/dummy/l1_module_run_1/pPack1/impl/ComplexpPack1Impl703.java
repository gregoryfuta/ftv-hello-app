...
public class ComplexpPack1Impl703 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl703.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl703 INSTANCE;

    public static ComplexpPack1Impl703 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl703();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl703(){
