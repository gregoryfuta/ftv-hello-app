...
public class ComplexpPack1Impl153 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl153.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl153 INSTANCE;

    public static ComplexpPack1Impl153 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl153();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl153(){
