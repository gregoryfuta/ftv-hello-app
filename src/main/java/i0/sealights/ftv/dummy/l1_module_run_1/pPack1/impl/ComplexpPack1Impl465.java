...
public class ComplexpPack1Impl465 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl465.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl465 INSTANCE;

    public static ComplexpPack1Impl465 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl465();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl465(){
