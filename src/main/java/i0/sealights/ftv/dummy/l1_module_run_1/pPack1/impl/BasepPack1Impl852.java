...
public class BasepPack1Impl852 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl852.class);
    private static BasepPack1Impl852 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl852 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl852();
        }
        return INSTANCE;
    }

    private BasepPack1Impl852(){
