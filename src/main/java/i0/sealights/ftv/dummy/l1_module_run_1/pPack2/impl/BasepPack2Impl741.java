...
public class BasepPack2Impl741 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl741.class);
    private static BasepPack2Impl741 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl741 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl741();
        }
        return INSTANCE;
    }

    private BasepPack2Impl741(){
