...
public class BasepPack2Impl385 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl385.class);
    private static BasepPack2Impl385 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl385 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl385();
        }
        return INSTANCE;
    }

    private BasepPack2Impl385(){
