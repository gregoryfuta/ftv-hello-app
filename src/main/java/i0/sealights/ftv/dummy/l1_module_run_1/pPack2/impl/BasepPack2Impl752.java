...
public class BasepPack2Impl752 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl752.class);
    private static BasepPack2Impl752 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl752 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl752();
        }
        return INSTANCE;
    }

    private BasepPack2Impl752(){
