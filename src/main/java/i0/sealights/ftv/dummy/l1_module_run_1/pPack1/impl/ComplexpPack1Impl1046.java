...
public class ComplexpPack1Impl1046 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl1046.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl1046 INSTANCE;

    public static ComplexpPack1Impl1046 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl1046();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl1046(){
