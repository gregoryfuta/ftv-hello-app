...
public class BasepPack1Impl609 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl609.class);
    private static BasepPack1Impl609 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl609 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl609();
        }
        return INSTANCE;
    }

    private BasepPack1Impl609(){
