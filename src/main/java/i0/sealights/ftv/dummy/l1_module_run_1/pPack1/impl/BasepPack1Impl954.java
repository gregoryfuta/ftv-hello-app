...
public class BasepPack1Impl954 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl954.class);
    private static BasepPack1Impl954 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl954 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl954();
        }
        return INSTANCE;
    }

    private BasepPack1Impl954(){
