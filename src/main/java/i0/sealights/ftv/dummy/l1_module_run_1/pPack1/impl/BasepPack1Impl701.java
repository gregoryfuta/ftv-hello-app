...
public class BasepPack1Impl701 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl701.class);
    private static BasepPack1Impl701 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl701 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl701();
        }
        return INSTANCE;
    }

    private BasepPack1Impl701(){
