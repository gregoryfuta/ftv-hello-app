...
public class ComplexpPack2Impl435 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl435.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl435 INSTANCE;

    public static ComplexpPack2Impl435 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl435();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl435(){
