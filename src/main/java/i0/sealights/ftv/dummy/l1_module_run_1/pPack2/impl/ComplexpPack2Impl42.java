...
public class ComplexpPack2Impl42 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl42.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl42 INSTANCE;

    public static ComplexpPack2Impl42 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl42();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl42(){
