...
public class BasepPack2Impl14 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl14.class);
    private static BasepPack2Impl14 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl14 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl14();
        }
        return INSTANCE;
    }

    private BasepPack2Impl14(){
