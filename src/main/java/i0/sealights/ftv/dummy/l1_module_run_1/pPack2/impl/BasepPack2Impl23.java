...
public class BasepPack2Impl23 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl23.class);
    private static BasepPack2Impl23 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl23 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl23();
        }
        return INSTANCE;
    }

    private BasepPack2Impl23(){
