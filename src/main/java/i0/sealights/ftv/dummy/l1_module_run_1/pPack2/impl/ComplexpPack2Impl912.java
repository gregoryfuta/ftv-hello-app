...
public class ComplexpPack2Impl912 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl912.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl912 INSTANCE;

    public static ComplexpPack2Impl912 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl912();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl912(){
