...
public class ComplexpPack2Impl254 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl254.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl254 INSTANCE;

    public static ComplexpPack2Impl254 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl254();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl254(){
