...
public class BasepPack1Impl566 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl566.class);
    private static BasepPack1Impl566 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl566 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl566();
        }
        return INSTANCE;
    }

    private BasepPack1Impl566(){
