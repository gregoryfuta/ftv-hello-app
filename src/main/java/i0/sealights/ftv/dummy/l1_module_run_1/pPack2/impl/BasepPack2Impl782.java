...
public class BasepPack2Impl782 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl782.class);
    private static BasepPack2Impl782 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl782 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl782();
        }
        return INSTANCE;
    }

    private BasepPack2Impl782(){
