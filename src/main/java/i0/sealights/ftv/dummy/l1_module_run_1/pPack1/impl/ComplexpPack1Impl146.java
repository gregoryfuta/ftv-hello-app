...
public class ComplexpPack1Impl146 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl146.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl146 INSTANCE;

    public static ComplexpPack1Impl146 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl146();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl146(){
