...
public class ComplexpPack2Impl501 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl501.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl501 INSTANCE;

    public static ComplexpPack2Impl501 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl501();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl501(){
