...
public class BasepPack2Impl913 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl913.class);
    private static BasepPack2Impl913 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl913 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl913();
        }
        return INSTANCE;
    }

    private BasepPack2Impl913(){
