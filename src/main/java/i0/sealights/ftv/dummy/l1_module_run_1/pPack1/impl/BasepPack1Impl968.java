...
public class BasepPack1Impl968 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl968.class);
    private static BasepPack1Impl968 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl968 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl968();
        }
        return INSTANCE;
    }

    private BasepPack1Impl968(){
