...
public class BasepPack1Impl248 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl248.class);
    private static BasepPack1Impl248 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl248 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl248();
        }
        return INSTANCE;
    }

    private BasepPack1Impl248(){
