...
public class BasepPack1Impl432 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl432.class);
    private static BasepPack1Impl432 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl432 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl432();
        }
        return INSTANCE;
    }

    private BasepPack1Impl432(){
