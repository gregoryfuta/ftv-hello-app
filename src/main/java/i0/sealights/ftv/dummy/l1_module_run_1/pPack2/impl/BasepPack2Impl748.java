...
public class BasepPack2Impl748 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl748.class);
    private static BasepPack2Impl748 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl748 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl748();
        }
        return INSTANCE;
    }

    private BasepPack2Impl748(){
