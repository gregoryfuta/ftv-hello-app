...
public class ComplexpPack2Impl761 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl761.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl761 INSTANCE;

    public static ComplexpPack2Impl761 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl761();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl761(){
