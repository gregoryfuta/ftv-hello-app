...
public class BasepPack2Impl150 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl150.class);
    private static BasepPack2Impl150 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl150 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl150();
        }
        return INSTANCE;
    }

    private BasepPack2Impl150(){
