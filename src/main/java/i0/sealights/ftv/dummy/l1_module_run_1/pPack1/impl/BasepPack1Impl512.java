...
public class BasepPack1Impl512 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl512.class);
    private static BasepPack1Impl512 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl512 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl512();
        }
        return INSTANCE;
    }

    private BasepPack1Impl512(){
