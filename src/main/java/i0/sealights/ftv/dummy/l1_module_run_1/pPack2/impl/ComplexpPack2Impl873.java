...
public class ComplexpPack2Impl873 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl873.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl873 INSTANCE;

    public static ComplexpPack2Impl873 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl873();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl873(){
