...
public class BasepPack2Impl343 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl343.class);
    private static BasepPack2Impl343 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl343 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl343();
        }
        return INSTANCE;
    }

    private BasepPack2Impl343(){
