...
public class BasepPack2Impl207 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl207.class);
    private static BasepPack2Impl207 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl207 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl207();
        }
        return INSTANCE;
    }

    private BasepPack2Impl207(){
