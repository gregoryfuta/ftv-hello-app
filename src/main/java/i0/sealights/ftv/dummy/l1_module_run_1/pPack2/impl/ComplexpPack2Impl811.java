...
public class ComplexpPack2Impl811 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl811.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl811 INSTANCE;

    public static ComplexpPack2Impl811 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl811();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl811(){
