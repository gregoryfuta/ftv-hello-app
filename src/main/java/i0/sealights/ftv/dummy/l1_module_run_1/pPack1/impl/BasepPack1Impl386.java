...
public class BasepPack1Impl386 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl386.class);
    private static BasepPack1Impl386 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl386 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl386();
        }
        return INSTANCE;
    }

    private BasepPack1Impl386(){
