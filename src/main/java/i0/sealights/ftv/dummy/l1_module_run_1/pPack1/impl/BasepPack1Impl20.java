...
public class BasepPack1Impl20 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl20.class);
    private static BasepPack1Impl20 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl20 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl20();
        }
        return INSTANCE;
    }

    private BasepPack1Impl20(){
