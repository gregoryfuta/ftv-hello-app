...
public class BasepPack2Impl246 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl246.class);
    private static BasepPack2Impl246 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl246 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl246();
        }
        return INSTANCE;
    }

    private BasepPack2Impl246(){
