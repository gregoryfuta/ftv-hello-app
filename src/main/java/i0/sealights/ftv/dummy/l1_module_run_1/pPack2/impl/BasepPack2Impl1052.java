...
public class BasepPack2Impl1052 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl1052.class);
    private static BasepPack2Impl1052 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl1052 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl1052();
        }
        return INSTANCE;
    }

    private BasepPack2Impl1052(){
