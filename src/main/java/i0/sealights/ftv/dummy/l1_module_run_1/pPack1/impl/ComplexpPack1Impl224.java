...
public class ComplexpPack1Impl224 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl224.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl224 INSTANCE;

    public static ComplexpPack1Impl224 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl224();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl224(){
