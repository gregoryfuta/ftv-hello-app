...
public class ComplexpPack2Impl330 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl330.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl330 INSTANCE;

    public static ComplexpPack2Impl330 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl330();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl330(){
