...
public class ComplexpPack2Impl731 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl731.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl731 INSTANCE;

    public static ComplexpPack2Impl731 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl731();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl731(){
