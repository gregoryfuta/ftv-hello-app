...
public class BasepPack1Impl832 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl832.class);
    private static BasepPack1Impl832 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl832 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl832();
        }
        return INSTANCE;
    }

    private BasepPack1Impl832(){
