...
public class BasepPack1Impl135 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl135.class);
    private static BasepPack1Impl135 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl135 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl135();
        }
        return INSTANCE;
    }

    private BasepPack1Impl135(){
