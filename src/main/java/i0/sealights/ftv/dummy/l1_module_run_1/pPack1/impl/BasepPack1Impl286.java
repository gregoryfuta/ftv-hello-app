...
public class BasepPack1Impl286 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl286.class);
    private static BasepPack1Impl286 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl286 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl286();
        }
        return INSTANCE;
    }

    private BasepPack1Impl286(){
