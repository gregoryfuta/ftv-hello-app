...
public class ComplexpPack1Impl796 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl796.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl796 INSTANCE;

    public static ComplexpPack1Impl796 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl796();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl796(){
