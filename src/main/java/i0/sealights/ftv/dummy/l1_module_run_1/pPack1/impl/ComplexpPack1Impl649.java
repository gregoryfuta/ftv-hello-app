...
public class ComplexpPack1Impl649 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl649.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl649 INSTANCE;

    public static ComplexpPack1Impl649 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl649();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl649(){
