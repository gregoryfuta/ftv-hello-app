...
public class ComplexpPack2Impl370 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl370.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl370 INSTANCE;

    public static ComplexpPack2Impl370 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl370();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl370(){
