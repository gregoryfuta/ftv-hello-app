...
public class BasepPack1Impl458 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl458.class);
    private static BasepPack1Impl458 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl458 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl458();
        }
        return INSTANCE;
    }

    private BasepPack1Impl458(){
