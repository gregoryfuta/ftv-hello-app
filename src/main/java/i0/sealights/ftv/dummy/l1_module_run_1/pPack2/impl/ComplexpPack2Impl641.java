...
public class ComplexpPack2Impl641 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl641.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl641 INSTANCE;

    public static ComplexpPack2Impl641 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl641();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl641(){
