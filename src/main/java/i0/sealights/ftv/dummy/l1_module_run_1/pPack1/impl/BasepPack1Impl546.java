...
public class BasepPack1Impl546 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl546.class);
    private static BasepPack1Impl546 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl546 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl546();
        }
        return INSTANCE;
    }

    private BasepPack1Impl546(){
