...
public class ComplexpPack2Impl662 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl662.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl662 INSTANCE;

    public static ComplexpPack2Impl662 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl662();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl662(){
