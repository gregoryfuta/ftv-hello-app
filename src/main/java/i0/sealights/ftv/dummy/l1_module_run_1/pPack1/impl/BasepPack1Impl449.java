...
public class BasepPack1Impl449 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl449.class);
    private static BasepPack1Impl449 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl449 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl449();
        }
        return INSTANCE;
    }

    private BasepPack1Impl449(){
