...
public class ComplexpPack1Impl501 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl501.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl501 INSTANCE;

    public static ComplexpPack1Impl501 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl501();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl501(){
