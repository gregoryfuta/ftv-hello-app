...
public class BasepPack2Impl457 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl457.class);
    private static BasepPack2Impl457 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl457 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl457();
        }
        return INSTANCE;
    }

    private BasepPack2Impl457(){
