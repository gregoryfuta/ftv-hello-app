...
public class ComplexpPack2Impl747 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl747.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl747 INSTANCE;

    public static ComplexpPack2Impl747 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl747();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl747(){
