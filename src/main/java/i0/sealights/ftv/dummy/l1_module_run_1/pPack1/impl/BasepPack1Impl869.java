...
public class BasepPack1Impl869 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl869.class);
    private static BasepPack1Impl869 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl869 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl869();
        }
        return INSTANCE;
    }

    private BasepPack1Impl869(){
