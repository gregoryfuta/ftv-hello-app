...
public class BasepPack2Impl434 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl434.class);
    private static BasepPack2Impl434 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl434 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl434();
        }
        return INSTANCE;
    }

    private BasepPack2Impl434(){
