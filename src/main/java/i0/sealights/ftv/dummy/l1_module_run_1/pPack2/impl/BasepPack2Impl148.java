...
public class BasepPack2Impl148 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl148.class);
    private static BasepPack2Impl148 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl148 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl148();
        }
        return INSTANCE;
    }

    private BasepPack2Impl148(){
