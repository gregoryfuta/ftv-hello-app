...
public class ComplexpPack1Impl954 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl954.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl954 INSTANCE;

    public static ComplexpPack1Impl954 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl954();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl954(){
