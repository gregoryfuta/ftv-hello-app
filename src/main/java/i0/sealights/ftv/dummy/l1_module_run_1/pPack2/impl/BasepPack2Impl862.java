...
public class BasepPack2Impl862 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl862.class);
    private static BasepPack2Impl862 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl862 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl862();
        }
        return INSTANCE;
    }

    private BasepPack2Impl862(){
