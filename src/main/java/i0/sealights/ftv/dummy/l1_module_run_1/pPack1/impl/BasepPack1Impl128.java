...
public class BasepPack1Impl128 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl128.class);
    private static BasepPack1Impl128 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl128 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl128();
        }
        return INSTANCE;
    }

    private BasepPack1Impl128(){
