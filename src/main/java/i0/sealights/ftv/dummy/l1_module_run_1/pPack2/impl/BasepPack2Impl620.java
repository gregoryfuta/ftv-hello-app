...
public class BasepPack2Impl620 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl620.class);
    private static BasepPack2Impl620 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl620 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl620();
        }
        return INSTANCE;
    }

    private BasepPack2Impl620(){
