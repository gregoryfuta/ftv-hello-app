...
public class ComplexpPack1Impl685 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl685.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl685 INSTANCE;

    public static ComplexpPack1Impl685 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl685();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl685(){
