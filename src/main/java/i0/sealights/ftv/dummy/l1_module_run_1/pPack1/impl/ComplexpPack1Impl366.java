...
public class ComplexpPack1Impl366 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl366.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl366 INSTANCE;

    public static ComplexpPack1Impl366 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl366();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl366(){
