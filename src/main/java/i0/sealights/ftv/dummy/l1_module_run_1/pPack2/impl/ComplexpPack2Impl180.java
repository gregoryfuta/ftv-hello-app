...
public class ComplexpPack2Impl180 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl180.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl180 INSTANCE;

    public static ComplexpPack2Impl180 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl180();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl180(){
