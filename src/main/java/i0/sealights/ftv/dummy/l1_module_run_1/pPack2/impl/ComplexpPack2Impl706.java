...
public class ComplexpPack2Impl706 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl706.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl706 INSTANCE;

    public static ComplexpPack2Impl706 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl706();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl706(){
