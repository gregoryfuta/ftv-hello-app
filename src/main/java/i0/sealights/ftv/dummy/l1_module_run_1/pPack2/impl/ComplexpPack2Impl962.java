...
public class ComplexpPack2Impl962 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl962.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl962 INSTANCE;

    public static ComplexpPack2Impl962 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl962();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl962(){
