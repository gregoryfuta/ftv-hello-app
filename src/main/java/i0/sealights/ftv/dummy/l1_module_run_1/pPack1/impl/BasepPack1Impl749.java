...
public class BasepPack1Impl749 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl749.class);
    private static BasepPack1Impl749 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl749 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl749();
        }
        return INSTANCE;
    }

    private BasepPack1Impl749(){
