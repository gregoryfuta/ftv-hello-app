...
public class BasepPack1Impl289 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl289.class);
    private static BasepPack1Impl289 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl289 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl289();
        }
        return INSTANCE;
    }

    private BasepPack1Impl289(){
