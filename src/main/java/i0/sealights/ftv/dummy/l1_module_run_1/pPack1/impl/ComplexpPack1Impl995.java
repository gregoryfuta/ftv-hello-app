...
public class ComplexpPack1Impl995 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl995.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl995 INSTANCE;

    public static ComplexpPack1Impl995 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl995();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl995(){
