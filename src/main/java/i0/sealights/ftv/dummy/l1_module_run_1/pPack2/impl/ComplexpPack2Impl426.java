...
public class ComplexpPack2Impl426 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl426.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl426 INSTANCE;

    public static ComplexpPack2Impl426 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl426();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl426(){
