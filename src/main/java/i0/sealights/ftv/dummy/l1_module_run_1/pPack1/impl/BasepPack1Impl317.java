...
public class BasepPack1Impl317 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl317.class);
    private static BasepPack1Impl317 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl317 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl317();
        }
        return INSTANCE;
    }

    private BasepPack1Impl317(){
