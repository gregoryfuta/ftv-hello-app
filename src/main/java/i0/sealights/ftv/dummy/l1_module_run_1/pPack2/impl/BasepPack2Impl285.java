...
public class BasepPack2Impl285 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl285.class);
    private static BasepPack2Impl285 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl285 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl285();
        }
        return INSTANCE;
    }

    private BasepPack2Impl285(){
