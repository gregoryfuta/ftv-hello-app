...
public class ComplexpPack1Impl700 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl700.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl700 INSTANCE;

    public static ComplexpPack1Impl700 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl700();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl700(){
