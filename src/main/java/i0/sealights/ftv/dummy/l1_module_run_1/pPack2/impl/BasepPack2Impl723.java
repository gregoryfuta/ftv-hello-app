...
public class BasepPack2Impl723 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl723.class);
    private static BasepPack2Impl723 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl723 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl723();
        }
        return INSTANCE;
    }

    private BasepPack2Impl723(){
