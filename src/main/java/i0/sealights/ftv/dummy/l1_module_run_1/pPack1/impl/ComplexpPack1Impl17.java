...
public class ComplexpPack1Impl17 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl17.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl17 INSTANCE;

    public static ComplexpPack1Impl17 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl17();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl17(){
