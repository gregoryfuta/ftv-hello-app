...
public class BasepPack2Impl720 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl720.class);
    private static BasepPack2Impl720 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl720 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl720();
        }
        return INSTANCE;
    }

    private BasepPack2Impl720(){
