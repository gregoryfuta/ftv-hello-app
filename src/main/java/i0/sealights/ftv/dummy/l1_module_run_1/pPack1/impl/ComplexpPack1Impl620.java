...
public class ComplexpPack1Impl620 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl620.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl620 INSTANCE;

    public static ComplexpPack1Impl620 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl620();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl620(){
