...
public class ComplexpPack2Impl655 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl655.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl655 INSTANCE;

    public static ComplexpPack2Impl655 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl655();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl655(){
