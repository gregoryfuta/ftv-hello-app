...
public class BasepPack2Impl549 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl549.class);
    private static BasepPack2Impl549 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl549 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl549();
        }
        return INSTANCE;
    }

    private BasepPack2Impl549(){
