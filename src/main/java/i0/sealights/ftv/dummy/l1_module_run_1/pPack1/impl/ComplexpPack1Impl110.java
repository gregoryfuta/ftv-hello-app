...
public class ComplexpPack1Impl110 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl110.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl110 INSTANCE;

    public static ComplexpPack1Impl110 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl110();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl110(){
