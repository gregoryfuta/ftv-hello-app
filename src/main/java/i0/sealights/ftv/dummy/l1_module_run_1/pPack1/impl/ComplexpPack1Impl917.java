...
public class ComplexpPack1Impl917 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl917.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl917 INSTANCE;

    public static ComplexpPack1Impl917 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl917();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl917(){
