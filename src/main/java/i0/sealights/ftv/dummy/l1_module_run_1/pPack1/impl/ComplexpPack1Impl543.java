...
public class ComplexpPack1Impl543 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl543.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl543 INSTANCE;

    public static ComplexpPack1Impl543 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl543();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl543(){
