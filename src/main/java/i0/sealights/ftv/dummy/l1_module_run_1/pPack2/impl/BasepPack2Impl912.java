...
public class BasepPack2Impl912 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl912.class);
    private static BasepPack2Impl912 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl912 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl912();
        }
        return INSTANCE;
    }

    private BasepPack2Impl912(){
