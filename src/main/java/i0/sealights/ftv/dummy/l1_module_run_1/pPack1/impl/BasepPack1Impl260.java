...
public class BasepPack1Impl260 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl260.class);
    private static BasepPack1Impl260 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl260 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl260();
        }
        return INSTANCE;
    }

    private BasepPack1Impl260(){
