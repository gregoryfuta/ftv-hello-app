...
public class ComplexpPack1Impl828 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl828.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl828 INSTANCE;

    public static ComplexpPack1Impl828 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl828();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl828(){
