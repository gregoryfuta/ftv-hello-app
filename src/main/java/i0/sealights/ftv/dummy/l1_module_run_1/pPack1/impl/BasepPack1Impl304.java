...
public class BasepPack1Impl304 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl304.class);
    private static BasepPack1Impl304 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl304 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl304();
        }
        return INSTANCE;
    }

    private BasepPack1Impl304(){
