...
public class ComplexpPack2Impl605 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl605.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl605 INSTANCE;

    public static ComplexpPack2Impl605 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl605();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl605(){
