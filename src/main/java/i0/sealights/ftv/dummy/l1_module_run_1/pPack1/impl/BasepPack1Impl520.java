...
public class BasepPack1Impl520 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl520.class);
    private static BasepPack1Impl520 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl520 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl520();
        }
        return INSTANCE;
    }

    private BasepPack1Impl520(){
