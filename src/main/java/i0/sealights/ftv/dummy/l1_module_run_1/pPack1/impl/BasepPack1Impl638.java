...
public class BasepPack1Impl638 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl638.class);
    private static BasepPack1Impl638 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl638 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl638();
        }
        return INSTANCE;
    }

    private BasepPack1Impl638(){
