...
public class BasepPack2Impl977 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl977.class);
    private static BasepPack2Impl977 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl977 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl977();
        }
        return INSTANCE;
    }

    private BasepPack2Impl977(){
