...
public class ComplexpPack2Impl861 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl861.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl861 INSTANCE;

    public static ComplexpPack2Impl861 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl861();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl861(){
