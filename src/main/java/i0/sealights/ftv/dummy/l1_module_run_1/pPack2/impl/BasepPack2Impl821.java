...
public class BasepPack2Impl821 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl821.class);
    private static BasepPack2Impl821 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl821 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl821();
        }
        return INSTANCE;
    }

    private BasepPack2Impl821(){
