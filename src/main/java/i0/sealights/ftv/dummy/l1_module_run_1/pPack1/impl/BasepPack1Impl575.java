...
public class BasepPack1Impl575 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl575.class);
    private static BasepPack1Impl575 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl575 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl575();
        }
        return INSTANCE;
    }

    private BasepPack1Impl575(){
