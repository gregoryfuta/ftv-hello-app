...
public class ComplexpPack2Impl304 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl304.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl304 INSTANCE;

    public static ComplexpPack2Impl304 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl304();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl304(){
