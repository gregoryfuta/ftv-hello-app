...
public class ComplexpPack2Impl627 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl627.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl627 INSTANCE;

    public static ComplexpPack2Impl627 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl627();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl627(){
