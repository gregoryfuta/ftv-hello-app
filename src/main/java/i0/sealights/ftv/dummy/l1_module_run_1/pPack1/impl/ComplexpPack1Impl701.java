...
public class ComplexpPack1Impl701 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl701.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl701 INSTANCE;

    public static ComplexpPack1Impl701 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl701();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl701(){
