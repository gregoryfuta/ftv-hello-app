...
public class BasepPack2Impl906 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl906.class);
    private static BasepPack2Impl906 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl906 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl906();
        }
        return INSTANCE;
    }

    private BasepPack2Impl906(){
