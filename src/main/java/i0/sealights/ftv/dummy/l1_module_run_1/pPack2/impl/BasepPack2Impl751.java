...
public class BasepPack2Impl751 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl751.class);
    private static BasepPack2Impl751 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl751 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl751();
        }
        return INSTANCE;
    }

    private BasepPack2Impl751(){
