...
public class ComplexpPack1Impl661 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl661.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl661 INSTANCE;

    public static ComplexpPack1Impl661 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl661();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl661(){
