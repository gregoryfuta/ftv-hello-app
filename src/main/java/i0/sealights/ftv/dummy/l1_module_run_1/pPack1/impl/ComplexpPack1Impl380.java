...
public class ComplexpPack1Impl380 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl380.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl380 INSTANCE;

    public static ComplexpPack1Impl380 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl380();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl380(){
