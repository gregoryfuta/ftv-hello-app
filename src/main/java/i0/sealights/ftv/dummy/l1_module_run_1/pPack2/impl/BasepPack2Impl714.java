...
public class BasepPack2Impl714 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl714.class);
    private static BasepPack2Impl714 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl714 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl714();
        }
        return INSTANCE;
    }

    private BasepPack2Impl714(){
