...
public class BasepPack1Impl303 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl303.class);
    private static BasepPack1Impl303 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl303 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl303();
        }
        return INSTANCE;
    }

    private BasepPack1Impl303(){
