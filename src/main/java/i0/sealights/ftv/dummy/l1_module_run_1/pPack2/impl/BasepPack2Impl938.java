...
public class BasepPack2Impl938 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl938.class);
    private static BasepPack2Impl938 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl938 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl938();
        }
        return INSTANCE;
    }

    private BasepPack2Impl938(){
