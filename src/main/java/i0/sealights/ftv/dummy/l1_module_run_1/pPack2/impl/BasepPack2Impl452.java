...
public class BasepPack2Impl452 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl452.class);
    private static BasepPack2Impl452 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl452 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl452();
        }
        return INSTANCE;
    }

    private BasepPack2Impl452(){
