...
public class BasepPack2Impl145 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl145.class);
    private static BasepPack2Impl145 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl145 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl145();
        }
        return INSTANCE;
    }

    private BasepPack2Impl145(){
