...
public class BasepPack1Impl855 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl855.class);
    private static BasepPack1Impl855 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl855 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl855();
        }
        return INSTANCE;
    }

    private BasepPack1Impl855(){
