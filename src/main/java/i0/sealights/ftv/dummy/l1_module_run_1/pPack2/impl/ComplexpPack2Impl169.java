...
public class ComplexpPack2Impl169 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl169.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl169 INSTANCE;

    public static ComplexpPack2Impl169 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl169();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl169(){
