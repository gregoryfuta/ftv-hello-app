...
public class ComplexpPack2Impl362 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl362.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl362 INSTANCE;

    public static ComplexpPack2Impl362 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl362();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl362(){
