...
public class ComplexpPack2Impl295 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl295.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl295 INSTANCE;

    public static ComplexpPack2Impl295 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl295();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl295(){
