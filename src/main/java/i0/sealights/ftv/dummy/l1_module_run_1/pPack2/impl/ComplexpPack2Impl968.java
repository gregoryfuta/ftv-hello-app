...
public class ComplexpPack2Impl968 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl968.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl968 INSTANCE;

    public static ComplexpPack2Impl968 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl968();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl968(){
