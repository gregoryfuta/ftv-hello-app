...
public class BasepPack1Impl365 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl365.class);
    private static BasepPack1Impl365 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl365 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl365();
        }
        return INSTANCE;
    }

    private BasepPack1Impl365(){
