...
public class BasepPack1Impl153 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl153.class);
    private static BasepPack1Impl153 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl153 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl153();
        }
        return INSTANCE;
    }

    private BasepPack1Impl153(){
