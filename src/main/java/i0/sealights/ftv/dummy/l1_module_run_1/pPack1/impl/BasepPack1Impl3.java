...
public class BasepPack1Impl3 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl3.class);
    private static BasepPack1Impl3 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl3 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl3();
        }
        return INSTANCE;
    }

    private BasepPack1Impl3(){
