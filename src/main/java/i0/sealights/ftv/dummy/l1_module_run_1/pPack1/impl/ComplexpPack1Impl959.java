...
public class ComplexpPack1Impl959 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl959.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl959 INSTANCE;

    public static ComplexpPack1Impl959 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl959();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl959(){
