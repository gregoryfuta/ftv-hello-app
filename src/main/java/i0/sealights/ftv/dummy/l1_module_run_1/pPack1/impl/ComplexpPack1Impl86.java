...
public class ComplexpPack1Impl86 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl86.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl86 INSTANCE;

    public static ComplexpPack1Impl86 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl86();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl86(){
