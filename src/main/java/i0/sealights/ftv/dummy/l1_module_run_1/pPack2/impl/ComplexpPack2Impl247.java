...
public class ComplexpPack2Impl247 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl247.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl247 INSTANCE;

    public static ComplexpPack2Impl247 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl247();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl247(){
