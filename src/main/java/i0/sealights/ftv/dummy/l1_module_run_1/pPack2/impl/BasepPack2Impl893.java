...
public class BasepPack2Impl893 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl893.class);
    private static BasepPack2Impl893 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl893 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl893();
        }
        return INSTANCE;
    }

    private BasepPack2Impl893(){
