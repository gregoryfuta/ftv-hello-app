...
public class BasepPack1Impl655 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl655.class);
    private static BasepPack1Impl655 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl655 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl655();
        }
        return INSTANCE;
    }

    private BasepPack1Impl655(){
