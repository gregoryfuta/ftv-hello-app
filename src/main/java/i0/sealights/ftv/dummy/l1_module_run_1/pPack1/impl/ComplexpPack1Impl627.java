...
public class ComplexpPack1Impl627 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl627.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl627 INSTANCE;

    public static ComplexpPack1Impl627 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl627();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl627(){
