...
public class ComplexpPack2Impl785 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl785.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl785 INSTANCE;

    public static ComplexpPack2Impl785 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl785();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl785(){
