...
public class ComplexpPack2Impl536 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl536.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl536 INSTANCE;

    public static ComplexpPack2Impl536 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl536();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl536(){
