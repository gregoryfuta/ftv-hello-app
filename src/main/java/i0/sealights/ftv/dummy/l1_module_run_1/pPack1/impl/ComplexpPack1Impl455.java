...
public class ComplexpPack1Impl455 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl455.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl455 INSTANCE;

    public static ComplexpPack1Impl455 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl455();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl455(){
