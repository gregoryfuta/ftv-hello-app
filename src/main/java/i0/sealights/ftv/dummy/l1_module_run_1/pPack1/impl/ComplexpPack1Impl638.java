...
public class ComplexpPack1Impl638 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl638.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl638 INSTANCE;

    public static ComplexpPack1Impl638 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl638();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl638(){
