...
public class BasepPack2Impl567 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl567.class);
    private static BasepPack2Impl567 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl567 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl567();
        }
        return INSTANCE;
    }

    private BasepPack2Impl567(){
