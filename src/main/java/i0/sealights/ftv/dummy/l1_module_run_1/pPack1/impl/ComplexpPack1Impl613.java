...
public class ComplexpPack1Impl613 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl613.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl613 INSTANCE;

    public static ComplexpPack1Impl613 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl613();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl613(){
