...
public class ComplexpPack2Impl692 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl692.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl692 INSTANCE;

    public static ComplexpPack2Impl692 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl692();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl692(){
