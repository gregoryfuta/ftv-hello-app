...
public class ComplexpPack1Impl773 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl773.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl773 INSTANCE;

    public static ComplexpPack1Impl773 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl773();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl773(){
