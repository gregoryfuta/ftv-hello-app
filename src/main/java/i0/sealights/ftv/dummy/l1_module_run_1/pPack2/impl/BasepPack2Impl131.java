...
public class BasepPack2Impl131 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl131.class);
    private static BasepPack2Impl131 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl131 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl131();
        }
        return INSTANCE;
    }

    private BasepPack2Impl131(){
