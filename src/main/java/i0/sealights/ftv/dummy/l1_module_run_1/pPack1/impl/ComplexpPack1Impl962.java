...
public class ComplexpPack1Impl962 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl962.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl962 INSTANCE;

    public static ComplexpPack1Impl962 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl962();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl962(){
