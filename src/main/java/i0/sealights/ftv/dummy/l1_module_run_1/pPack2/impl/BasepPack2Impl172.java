...
public class BasepPack2Impl172 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl172.class);
    private static BasepPack2Impl172 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl172 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl172();
        }
        return INSTANCE;
    }

    private BasepPack2Impl172(){
