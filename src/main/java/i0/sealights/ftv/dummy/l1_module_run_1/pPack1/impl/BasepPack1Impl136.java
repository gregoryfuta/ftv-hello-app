...
public class BasepPack1Impl136 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl136.class);
    private static BasepPack1Impl136 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl136 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl136();
        }
        return INSTANCE;
    }

    private BasepPack1Impl136(){
