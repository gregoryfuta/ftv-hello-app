...
public class ComplexpPack2Impl756 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl756.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl756 INSTANCE;

    public static ComplexpPack2Impl756 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl756();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl756(){
