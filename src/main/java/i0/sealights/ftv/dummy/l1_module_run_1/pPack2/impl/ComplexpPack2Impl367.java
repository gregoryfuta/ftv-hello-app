...
public class ComplexpPack2Impl367 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl367.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl367 INSTANCE;

    public static ComplexpPack2Impl367 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl367();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl367(){
