...
public class BasepPack1Impl171 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl171.class);
    private static BasepPack1Impl171 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl171 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl171();
        }
        return INSTANCE;
    }

    private BasepPack1Impl171(){
