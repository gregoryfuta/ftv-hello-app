...
public class ComplexpPack2Impl276 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl276.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl276 INSTANCE;

    public static ComplexpPack2Impl276 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl276();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl276(){
