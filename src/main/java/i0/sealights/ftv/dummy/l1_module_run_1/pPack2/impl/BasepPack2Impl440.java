...
public class BasepPack2Impl440 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl440.class);
    private static BasepPack2Impl440 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl440 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl440();
        }
        return INSTANCE;
    }

    private BasepPack2Impl440(){
