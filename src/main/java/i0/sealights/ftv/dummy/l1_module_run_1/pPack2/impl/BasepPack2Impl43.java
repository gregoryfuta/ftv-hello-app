...
public class BasepPack2Impl43 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl43.class);
    private static BasepPack2Impl43 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl43 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl43();
        }
        return INSTANCE;
    }

    private BasepPack2Impl43(){
