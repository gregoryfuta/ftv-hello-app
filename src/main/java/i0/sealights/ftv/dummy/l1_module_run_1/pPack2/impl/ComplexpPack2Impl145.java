...
public class ComplexpPack2Impl145 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl145.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl145 INSTANCE;

    public static ComplexpPack2Impl145 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl145();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl145(){
