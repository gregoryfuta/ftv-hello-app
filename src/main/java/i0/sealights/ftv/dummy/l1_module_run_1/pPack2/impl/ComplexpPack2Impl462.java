...
public class ComplexpPack2Impl462 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl462.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl462 INSTANCE;

    public static ComplexpPack2Impl462 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl462();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl462(){
