...
public class BasepPack2Impl48 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl48.class);
    private static BasepPack2Impl48 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl48 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl48();
        }
        return INSTANCE;
    }

    private BasepPack2Impl48(){
