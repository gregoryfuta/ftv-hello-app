...
public class ComplexpPack2Impl908 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl908.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl908 INSTANCE;

    public static ComplexpPack2Impl908 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl908();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl908(){
