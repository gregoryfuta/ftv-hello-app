...
public class ComplexpPack2Impl934 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl934.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl934 INSTANCE;

    public static ComplexpPack2Impl934 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl934();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl934(){
