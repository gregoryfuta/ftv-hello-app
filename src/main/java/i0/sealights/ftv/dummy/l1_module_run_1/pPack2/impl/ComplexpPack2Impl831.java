...
public class ComplexpPack2Impl831 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl831.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl831 INSTANCE;

    public static ComplexpPack2Impl831 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl831();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl831(){
