...
public class BasepPack2Impl998 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl998.class);
    private static BasepPack2Impl998 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl998 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl998();
        }
        return INSTANCE;
    }

    private BasepPack2Impl998(){
