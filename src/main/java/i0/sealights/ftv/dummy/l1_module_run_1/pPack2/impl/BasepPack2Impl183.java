...
public class BasepPack2Impl183 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl183.class);
    private static BasepPack2Impl183 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl183 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl183();
        }
        return INSTANCE;
    }

    private BasepPack2Impl183(){
