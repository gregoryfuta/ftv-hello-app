...
public class BasepPack2Impl461 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl461.class);
    private static BasepPack2Impl461 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl461 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl461();
        }
        return INSTANCE;
    }

    private BasepPack2Impl461(){
