...
public class ComplexpPack1Impl621 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl621.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl621 INSTANCE;

    public static ComplexpPack1Impl621 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl621();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl621(){
