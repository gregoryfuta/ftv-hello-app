...
public class ComplexpPack1Impl34 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl34.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl34 INSTANCE;

    public static ComplexpPack1Impl34 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl34();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl34(){
