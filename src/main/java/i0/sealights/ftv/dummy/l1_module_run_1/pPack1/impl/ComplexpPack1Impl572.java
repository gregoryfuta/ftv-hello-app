...
public class ComplexpPack1Impl572 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl572.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl572 INSTANCE;

    public static ComplexpPack1Impl572 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl572();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl572(){
