...
public class BasepPack2Impl593 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl593.class);
    private static BasepPack2Impl593 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl593 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl593();
        }
        return INSTANCE;
    }

    private BasepPack2Impl593(){
