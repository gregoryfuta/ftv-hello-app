...
public class BasepPack2Impl642 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl642.class);
    private static BasepPack2Impl642 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl642 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl642();
        }
        return INSTANCE;
    }

    private BasepPack2Impl642(){
