...
public class ComplexpPack2Impl355 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl355.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl355 INSTANCE;

    public static ComplexpPack2Impl355 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl355();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl355(){
