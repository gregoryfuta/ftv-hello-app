...
public class ComplexpPack2Impl398 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl398.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl398 INSTANCE;

    public static ComplexpPack2Impl398 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl398();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl398(){
