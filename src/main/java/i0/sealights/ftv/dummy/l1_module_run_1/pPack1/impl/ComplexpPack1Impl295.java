...
public class ComplexpPack1Impl295 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl295.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl295 INSTANCE;

    public static ComplexpPack1Impl295 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl295();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl295(){
