...
public class BasepPack1Impl834 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl834.class);
    private static BasepPack1Impl834 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl834 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl834();
        }
        return INSTANCE;
    }

    private BasepPack1Impl834(){
