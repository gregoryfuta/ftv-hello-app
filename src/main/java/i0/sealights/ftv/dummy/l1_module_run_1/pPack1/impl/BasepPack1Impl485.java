...
public class BasepPack1Impl485 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl485.class);
    private static BasepPack1Impl485 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl485 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl485();
        }
        return INSTANCE;
    }

    private BasepPack1Impl485(){
