...
public class ComplexpPack1Impl361 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl361.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl361 INSTANCE;

    public static ComplexpPack1Impl361 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl361();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl361(){
