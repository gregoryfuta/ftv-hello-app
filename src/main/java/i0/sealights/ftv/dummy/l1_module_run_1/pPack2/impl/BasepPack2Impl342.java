...
public class BasepPack2Impl342 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl342.class);
    private static BasepPack2Impl342 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl342 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl342();
        }
        return INSTANCE;
    }

    private BasepPack2Impl342(){
