...
public class BasepPack1Impl460 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl460.class);
    private static BasepPack1Impl460 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl460 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl460();
        }
        return INSTANCE;
    }

    private BasepPack1Impl460(){
