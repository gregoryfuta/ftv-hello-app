...
public class BasepPack1Impl920 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl920.class);
    private static BasepPack1Impl920 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl920 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl920();
        }
        return INSTANCE;
    }

    private BasepPack1Impl920(){
