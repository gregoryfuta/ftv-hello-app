...
public class ComplexpPack2Impl989 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl989.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl989 INSTANCE;

    public static ComplexpPack2Impl989 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl989();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl989(){
