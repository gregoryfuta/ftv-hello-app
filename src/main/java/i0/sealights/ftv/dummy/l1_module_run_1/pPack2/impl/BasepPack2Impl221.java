...
public class BasepPack2Impl221 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl221.class);
    private static BasepPack2Impl221 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl221 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl221();
        }
        return INSTANCE;
    }

    private BasepPack2Impl221(){
