...
public class BasepPack2Impl859 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl859.class);
    private static BasepPack2Impl859 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl859 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl859();
        }
        return INSTANCE;
    }

    private BasepPack2Impl859(){
