...
public class ComplexpPack1Impl331 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl331.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl331 INSTANCE;

    public static ComplexpPack1Impl331 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl331();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl331(){
