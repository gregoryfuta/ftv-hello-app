...
public class ComplexpPack1Impl246 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl246.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl246 INSTANCE;

    public static ComplexpPack1Impl246 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl246();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl246(){
