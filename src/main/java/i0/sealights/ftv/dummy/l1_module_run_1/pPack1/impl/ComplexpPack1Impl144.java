...
public class ComplexpPack1Impl144 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl144.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl144 INSTANCE;

    public static ComplexpPack1Impl144 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl144();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl144(){
