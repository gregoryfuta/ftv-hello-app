...
public class BasepPack2Impl682 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl682.class);
    private static BasepPack2Impl682 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl682 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl682();
        }
        return INSTANCE;
    }

    private BasepPack2Impl682(){
