...
public class BasepPack2Impl941 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl941.class);
    private static BasepPack2Impl941 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl941 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl941();
        }
        return INSTANCE;
    }

    private BasepPack2Impl941(){
