...
public class ComplexpPack2Impl900 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl900.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl900 INSTANCE;

    public static ComplexpPack2Impl900 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl900();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl900(){
