...
public class ComplexpPack2Impl544 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl544.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl544 INSTANCE;

    public static ComplexpPack2Impl544 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl544();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl544(){
