...
public class ComplexpPack1Impl178 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl178.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl178 INSTANCE;

    public static ComplexpPack1Impl178 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl178();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl178(){
