...
public class ComplexpPack1Impl285 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl285.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl285 INSTANCE;

    public static ComplexpPack1Impl285 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl285();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl285(){
