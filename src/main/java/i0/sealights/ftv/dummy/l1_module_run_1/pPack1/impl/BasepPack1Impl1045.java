...
public class BasepPack1Impl1045 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl1045.class);
    private static BasepPack1Impl1045 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl1045 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl1045();
        }
        return INSTANCE;
    }

    private BasepPack1Impl1045(){
