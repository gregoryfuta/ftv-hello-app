...
public class BasepPack1Impl567 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl567.class);
    private static BasepPack1Impl567 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl567 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl567();
        }
        return INSTANCE;
    }

    private BasepPack1Impl567(){
