...
public class BasepPack2Impl427 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl427.class);
    private static BasepPack2Impl427 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl427 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl427();
        }
        return INSTANCE;
    }

    private BasepPack2Impl427(){
