...
public class ComplexpPack2Impl809 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl809.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl809 INSTANCE;

    public static ComplexpPack2Impl809 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl809();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl809(){
