...
public class ComplexpPack1Impl725 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl725.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl725 INSTANCE;

    public static ComplexpPack1Impl725 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl725();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl725(){
