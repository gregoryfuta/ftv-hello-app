...
public class ComplexpPack2Impl124 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl124.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl124 INSTANCE;

    public static ComplexpPack2Impl124 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl124();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl124(){
