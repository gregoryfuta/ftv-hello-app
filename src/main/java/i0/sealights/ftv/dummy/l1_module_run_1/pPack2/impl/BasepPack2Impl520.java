...
public class BasepPack2Impl520 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl520.class);
    private static BasepPack2Impl520 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl520 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl520();
        }
        return INSTANCE;
    }

    private BasepPack2Impl520(){
