...
public class BasepPack2Impl455 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl455.class);
    private static BasepPack2Impl455 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl455 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl455();
        }
        return INSTANCE;
    }

    private BasepPack2Impl455(){
