...
public class BasepPack2Impl505 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl505.class);
    private static BasepPack2Impl505 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl505 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl505();
        }
        return INSTANCE;
    }

    private BasepPack2Impl505(){
