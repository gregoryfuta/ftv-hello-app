...
public class ComplexpPack1Impl770 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl770.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl770 INSTANCE;

    public static ComplexpPack1Impl770 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl770();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl770(){
