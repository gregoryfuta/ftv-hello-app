...
public class ComplexpPack2Impl940 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl940.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl940 INSTANCE;

    public static ComplexpPack2Impl940 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl940();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl940(){
