...
public class ComplexpPack2Impl584 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl584.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl584 INSTANCE;

    public static ComplexpPack2Impl584 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl584();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl584(){
