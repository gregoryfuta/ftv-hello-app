...
public class ComplexpPack1Impl831 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl831.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl831 INSTANCE;

    public static ComplexpPack1Impl831 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl831();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl831(){
