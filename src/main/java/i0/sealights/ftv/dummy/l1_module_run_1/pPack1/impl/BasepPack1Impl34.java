...
public class BasepPack1Impl34 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl34.class);
    private static BasepPack1Impl34 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl34 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl34();
        }
        return INSTANCE;
    }

    private BasepPack1Impl34(){
