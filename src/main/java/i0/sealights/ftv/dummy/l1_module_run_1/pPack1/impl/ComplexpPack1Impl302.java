...
public class ComplexpPack1Impl302 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl302.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl302 INSTANCE;

    public static ComplexpPack1Impl302 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl302();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl302(){
