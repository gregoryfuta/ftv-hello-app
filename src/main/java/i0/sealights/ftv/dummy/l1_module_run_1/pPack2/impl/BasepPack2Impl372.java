...
public class BasepPack2Impl372 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl372.class);
    private static BasepPack2Impl372 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl372 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl372();
        }
        return INSTANCE;
    }

    private BasepPack2Impl372(){
