...
public class ComplexpPack2Impl532 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl532.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl532 INSTANCE;

    public static ComplexpPack2Impl532 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl532();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl532(){
