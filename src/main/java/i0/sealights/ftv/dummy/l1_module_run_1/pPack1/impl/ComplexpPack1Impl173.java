...
public class ComplexpPack1Impl173 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl173.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl173 INSTANCE;

    public static ComplexpPack1Impl173 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl173();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl173(){
