...
public class ComplexpPack2Impl500 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl500.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl500 INSTANCE;

    public static ComplexpPack2Impl500 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl500();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl500(){
