...
public class BasepPack2Impl253 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl253.class);
    private static BasepPack2Impl253 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl253 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl253();
        }
        return INSTANCE;
    }

    private BasepPack2Impl253(){
