...
public class BasepPack1Impl784 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl784.class);
    private static BasepPack1Impl784 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl784 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl784();
        }
        return INSTANCE;
    }

    private BasepPack1Impl784(){
