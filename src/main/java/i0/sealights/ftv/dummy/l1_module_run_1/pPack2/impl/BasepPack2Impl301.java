...
public class BasepPack2Impl301 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl301.class);
    private static BasepPack2Impl301 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl301 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl301();
        }
        return INSTANCE;
    }

    private BasepPack2Impl301(){
