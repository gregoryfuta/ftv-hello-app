...
public class BasepPack1Impl627 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl627.class);
    private static BasepPack1Impl627 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl627 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl627();
        }
        return INSTANCE;
    }

    private BasepPack1Impl627(){
