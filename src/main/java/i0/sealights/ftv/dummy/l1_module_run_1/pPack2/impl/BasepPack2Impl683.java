...
public class BasepPack2Impl683 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl683.class);
    private static BasepPack2Impl683 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl683 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl683();
        }
        return INSTANCE;
    }

    private BasepPack2Impl683(){
