...
public class BasepPack2Impl825 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl825.class);
    private static BasepPack2Impl825 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl825 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl825();
        }
        return INSTANCE;
    }

    private BasepPack2Impl825(){
