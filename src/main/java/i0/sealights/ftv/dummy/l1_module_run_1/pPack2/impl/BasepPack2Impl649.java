...
public class BasepPack2Impl649 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl649.class);
    private static BasepPack2Impl649 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl649 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl649();
        }
        return INSTANCE;
    }

    private BasepPack2Impl649(){
