...
public class ComplexpPack1Impl900 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl900.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl900 INSTANCE;

    public static ComplexpPack1Impl900 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl900();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl900(){
