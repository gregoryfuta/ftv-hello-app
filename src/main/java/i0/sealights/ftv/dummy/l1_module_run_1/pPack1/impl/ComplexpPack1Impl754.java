...
public class ComplexpPack1Impl754 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl754.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl754 INSTANCE;

    public static ComplexpPack1Impl754 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl754();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl754(){
