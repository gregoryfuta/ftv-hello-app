...
public class ComplexpPack2Impl531 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl531.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl531 INSTANCE;

    public static ComplexpPack2Impl531 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl531();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl531(){
