...
public class BasepPack2Impl959 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl959.class);
    private static BasepPack2Impl959 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl959 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl959();
        }
        return INSTANCE;
    }

    private BasepPack2Impl959(){
