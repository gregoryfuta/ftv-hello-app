...
public class ComplexpPack1Impl183 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl183.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl183 INSTANCE;

    public static ComplexpPack1Impl183 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl183();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl183(){
