...
public class ComplexpPack2Impl440 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl440.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl440 INSTANCE;

    public static ComplexpPack2Impl440 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl440();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl440(){
