...
public class BasepPack2Impl681 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl681.class);
    private static BasepPack2Impl681 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl681 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl681();
        }
        return INSTANCE;
    }

    private BasepPack2Impl681(){
