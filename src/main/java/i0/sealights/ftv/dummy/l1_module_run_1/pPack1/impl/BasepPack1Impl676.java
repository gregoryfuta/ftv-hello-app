...
public class BasepPack1Impl676 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl676.class);
    private static BasepPack1Impl676 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl676 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl676();
        }
        return INSTANCE;
    }

    private BasepPack1Impl676(){
