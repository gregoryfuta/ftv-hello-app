...
public class BasepPack2Impl204 implements BaseInterfacepPack2{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack2Impl204.class);
    private static BasepPack2Impl204 INSTANCE;
    private BaseAbstractpPack2 parent;

    public static BasepPack2Impl204 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack2Impl204();
        }
        return INSTANCE;
    }

    private BasepPack2Impl204(){
