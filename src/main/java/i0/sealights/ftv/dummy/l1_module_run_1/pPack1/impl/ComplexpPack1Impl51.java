...
public class ComplexpPack1Impl51 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl51.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl51 INSTANCE;

    public static ComplexpPack1Impl51 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl51();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl51(){
