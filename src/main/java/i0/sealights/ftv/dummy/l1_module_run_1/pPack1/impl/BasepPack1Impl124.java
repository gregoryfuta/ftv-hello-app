...
public class BasepPack1Impl124 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl124.class);
    private static BasepPack1Impl124 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl124 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl124();
        }
        return INSTANCE;
    }

    private BasepPack1Impl124(){
