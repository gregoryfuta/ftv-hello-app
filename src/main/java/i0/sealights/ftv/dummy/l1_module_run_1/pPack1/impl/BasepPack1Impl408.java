...
public class BasepPack1Impl408 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl408.class);
    private static BasepPack1Impl408 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl408 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl408();
        }
        return INSTANCE;
    }

    private BasepPack1Impl408(){
