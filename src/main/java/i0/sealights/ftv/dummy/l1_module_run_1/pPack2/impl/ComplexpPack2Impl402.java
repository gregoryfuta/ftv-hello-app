...
public class ComplexpPack2Impl402 implements ComplexInterfacepPack2{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack2Impl402.class);
    private ComplexAbstractpPack2 parent;
    private static ComplexpPack2Impl402 INSTANCE;

    public static ComplexpPack2Impl402 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack2Impl402();
        }
        return INSTANCE;
    }

    private ComplexpPack2Impl402(){
