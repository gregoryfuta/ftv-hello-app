...
public class BasepPack1Impl144 implements BaseInterfacepPack1{
    private static final Logger LOGGER = LogManager.getLogger(BasepPack1Impl144.class);
    private static BasepPack1Impl144 INSTANCE;
    private BaseAbstractpPack1 parent;

    public static BasepPack1Impl144 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new BasepPack1Impl144();
        }
        return INSTANCE;
    }

    private BasepPack1Impl144(){
