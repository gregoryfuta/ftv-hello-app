...
public class ComplexpPack1Impl269 implements ComplexInterfacepPack1{
    static final Logger LOGGER = LogManager.getLogger(ComplexpPack1Impl269.class);
    private ComplexAbstractpPack1 parent;
    private static ComplexpPack1Impl269 INSTANCE;

    public static ComplexpPack1Impl269 getInstance(){
        if( INSTANCE == null){
            INSTANCE = new ComplexpPack1Impl269();
        }
        return INSTANCE;
    }

    private ComplexpPack1Impl269(){
