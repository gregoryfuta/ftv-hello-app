...
rem java -jar sl-test-listener.jar start -token %SL_TOKEN% -buildsessionid bfe69862-3964-44cb-ba2b-383d57008b0e -testStage "Runner Stage" -labid %SL_LABID%
...
java -jar sl-test-listener.jar end -token %SL_TOKEN% -buildsessionid bfe69862-3964-44cb-ba2b-383d57008b0e -labid %SL_LABID%