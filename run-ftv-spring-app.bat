...
java -javaagent:java-agent-ftv-4.0.0-SNAPSHOT.jar=appname=%SL_APPNAME%,labId=%SL_LABID%,packagesincluded=%PACKAGES%,workspacepath=.,token=%SL_TOKEN% -Dsl.includes=%PACKAGES% -jar .\target\%APPLICATION_JAR%
